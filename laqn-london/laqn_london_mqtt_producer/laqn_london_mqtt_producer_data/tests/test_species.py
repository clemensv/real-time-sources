...
from laqn_london_mqtt_producer_data.uk.kcl.laqn.species import Species
...
class Test_Species(unittest.TestCase):
    ...
    def test_species_code_property(self):
        ...
        """
        test_value = 'oddetshfwfnwtvpgfqpn'
    ...
    def test_species_name_property(self):
        ...
        """
        test_value = 'wmadqhbsfjouwhfovaqd'
    ...
    def test_description_property(self):
        ...
        """
        test_value = 'ertkxolxhfeqagoqhjki'
    ...
    def test_health_effect_property(self):
        ...
        """
        test_value = 'gdolsztkfqcfpmgrcmkc'
    ...
    def test_link_property(self):
        ...
        Test link property
        """
        test_value = 'uzvkhgkxkvtlnmrmrfwj'

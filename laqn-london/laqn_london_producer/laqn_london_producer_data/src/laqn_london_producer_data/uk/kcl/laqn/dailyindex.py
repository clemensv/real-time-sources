...
class DailyIndex:
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"DailyIndex\", \"namespace\": \"uk.kcl.laqn\", \"doc\": \"Daily Air Quality Index bulletin record for a LAQN site and pollutant species within the latest London-wide index publication.\", \"fields\": [{\"name\": \"site_code\", \"type\": \"string\", \"doc\": \"Stable LAQN site code for the monitoring site to which the daily index applies.\", \"description\": \"Reference details for one station, monitoring site, or forecast area in the London Air Quality Network source.\"}, {\"name\": \"bulletin_date\", \"type\": \"string\", \"doc\": \"Bulletin date and time published by LAQN for the daily index, encoded as YYYY-MM-DD HH:MM:SS.\", \"description\": \"Measurement payload for pollutant concentration measurements in the London Air Quality Network source.\"}, {\"name\": \"species_code\", \"type\": \"string\", \"doc\": \"Stable LAQN pollutant code for the species to which the daily index applies.\", \"description\": \"Measurement payload for pollutant concentration measurements in the London Air Quality Network source.\"}, {\"name\": \"air_quality_index\", \"type\": \"int\", \"doc\": \"LAQN Daily Air Quality Index value from 1 to 10.\", \"description\": \"Measurement payload for pollutant concentration measurements in the London Air Quality Network source.\"}, {\"name\": \"air_quality_band\", \"type\": \"string\", \"doc\": \"Textual Daily Air Quality Index band published by LAQN: Low, Moderate, High, or Very High.\", \"description\": \"Measurement payload for pollutant concentration measurements in the London Air Quality Network source.\"}, {\"name\": \"index_source\", \"type\": \"string\", \"doc\": \"Origin of the daily index published by LAQN, typically Measurement or Forecast.\", \"description\": \"Measurement payload for pollutant concentration measurements in the London Air Quality Network source.\"}], \"description\": \"Measurement payload for pollutant concentration measurements in the London Air Quality Network source.\"}"), avro.name.Names()
    )

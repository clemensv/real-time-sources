...
class Measurement:
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"Measurement\", \"namespace\": \"uk.kcl.laqn\", \"doc\": \"Hourly air quality measurement for a LAQN site and pollutant species at a GMT timestamp.\", \"fields\": [{\"name\": \"site_code\", \"type\": \"string\", \"doc\": \"Stable LAQN site code for the monitoring site that produced the measurement.\"}, {\"name\": \"species_code\", \"type\": \"string\", \"doc\": \"Stable LAQN pollutant code for the measured species.\"}, {\"name\": \"measurement_date_gmt\", \"type\": \"string\", \"doc\": \"Measurement timestamp in GMT, encoded by LAQN as YYYY-MM-DD HH:MM:SS.\"}, {\"name\": \"value\", \"type\": \"double\", \"doc\": \"Measured pollutant concentration as a decimal number. The bridge omits records for timestamps where the upstream API reports an empty value.\"}]}"), avro.name.Names()
    )

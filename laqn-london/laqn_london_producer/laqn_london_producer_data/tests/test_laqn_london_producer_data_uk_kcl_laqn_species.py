...
class Test_Species(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Species(
            species_code='ojxmbxokpjeejxetdgux',
            species_name='nvajcpcmwihpcpeixsed',
            description='hinaibexjayyjuckmfkk',
            health_effect='xfebrgdpgslvnxjnskgu',
            link='frfbauhmjpakwgfhaepz'
        )
        return instance
    ...
    def test_species_code_property(self):
        ...
        """
        test_value = 'ojxmbxokpjeejxetdgux'
    ...
    def test_species_name_property(self):
        ...
        """
        test_value = 'nvajcpcmwihpcpeixsed'
    ...
    def test_description_property(self):
        ...
        """
        test_value = 'hinaibexjayyjuckmfkk'
    ...
    def test_health_effect_property(self):
        ...
        """
        test_value = 'xfebrgdpgslvnxjnskgu'
    ...
    def test_link_property(self):
        ...
        Test link property
        """
        test_value = 'frfbauhmjpakwgfhaepz'

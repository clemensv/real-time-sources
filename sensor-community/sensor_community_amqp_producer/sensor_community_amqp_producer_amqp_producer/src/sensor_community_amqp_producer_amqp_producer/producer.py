...
class IoSensorCommunityAmqpProducer:
    """
    Producer class to send messages in the `io.sensor.community.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_sensor_info(self,
        ...
        """
        Send the `io.sensor.community.amqp.SensorInfo` message
    ...
    def send_sensor_info_batch(self,
        data_array: typing.List[SensorInfo],
        _feedurl: str,
        _sensor_id: str,
        _country: str,
        _geohash5: str,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `io.sensor.community.amqp.SensorInfo` messages
        
        Args:
            data_array (typing.List[SensorInfo]): Array of message data objects
            _feedurl (str): Value for placeholder feedurl in attribute source
            _sensor_id (str): Value for placeholder sensor_id in attribute subject
            _country (str): Value for AMQP protocol option placeholder country
            _geohash5 (str): Value for AMQP protocol option placeholder geohash5
    ...
    def send_sensor_reading(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `io.sensor.community.amqp.SensorReading` message
    ...
    def send_sensor_reading_batch(self,
        data_array: typing.List[SensorReading],
        _feedurl: str,
        _sensor_id: str,
        _country: str,
        _geohash5: str,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `io.sensor.community.amqp.SensorReading` messages
        
        Args:
            data_array (typing.List[SensorReading]): Array of message data objects
            _feedurl (str): Value for placeholder feedurl in attribute source
            _sensor_id (str): Value for placeholder sensor_id in attribute subject
            _country (str): Value for AMQP protocol option placeholder country
            _geohash5 (str): Value for AMQP protocol option placeholder geohash5

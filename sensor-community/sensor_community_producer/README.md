...
# Sensor_community_producer Kafka Producer# Sensor_community_producer Event Dispatcher for Apache Kafka
...
- **Scales horizontally** across multiple brokers and partitions### IoSensorCommunityEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`IoSensorCommunityEventDispatcher` handles events for the io.sensor.community message group.
...
The IoSensorCommunityEventDispatcher defines the following event handler hooks.
...
producer = IoSensorCommunityProducer(
    ...
    security_protocol='SASL_SSL',##### `io_sensor_community_sensor_info_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'io_sensor_community_sensor_info_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `io.sensor.community.SensorInfo`: Reference data for a Sensor.Community sensor node
...
io_sensor_community_dispatcher.io_sensor_community_sensor_info_async = io_sensor_community_sensor_info_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `io_sensor_community_sensor_reading_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'io_sensor_community_sensor_reading_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `io.sensor.community.SensorReading`: Latest Sensor.Community telemetry reading for one
sensor at a specific timestamp, normalized across particulate, climate, pressure, and noise measurements.
...
##### `send_io_sensor_community_sensor_info`Dispatchers have the following protected methods:



```python### Methods:

async def send_io_sensor_community_sensor_info(
...
Send a single `io.sensor.community.SensorInfo` message. Reference data for a Sensor.Community sensor node including its
hardware type and last known location metadata.Args:
...
await producer.send_io_sensor_community_sensor_info(
...
Send multiple `io.sensor.community.SensorInfo` messages in a batch.
...
await producer.send_io_sensor_community_sensor_info_batch(```
...
##### `send_io_sensor_community_sensor_reading`Dispatchers have the following protected methods:



```python### Methods:

async def send_io_sensor_community_sensor_reading(
...
Send a single `io.sensor.community.SensorReading` message. Latest Sensor.Community telemetry reading for one sensor at a
specific timestamp, normalized across particulate, climate, pressure, and noise measurements.Args:
...
await producer.send_io_sensor_community_sensor_reading(
...
Send multiple `io.sensor.community.SensorReading` messages in a batch.

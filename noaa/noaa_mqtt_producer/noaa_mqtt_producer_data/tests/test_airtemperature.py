...
from noaa_mqtt_producer_data.microsoft.opendata.us.noaa.airtemperature import AirTemperature
...
class Test_AirTemperature(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = AirTemperature(
            station_id='lbsqiszdbrecdflafjax',
            timestamp='kdjzspryiechhdttyeie',
            value=float(43.893186357332624),
            max_temp_exceeded=True,
            min_temp_exceeded=False,
            rate_of_change_exceeded=False,
            region='euiqclsyfssqgcrlkjsh'
        )
        return instance
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'lbsqiszdbrecdflafjax'
    ...
    def test_timestamp_property(self):
        ...
        """
        test_value = 'kdjzspryiechhdttyeie'
    ...
    def test_value_property(self):
        ...
        Test value property
        """
        test_value = float(43.893186357332624)
    ...
    def test_region_property(self):
        ...
        """
        test_value = 'euiqclsyfssqgcrlkjsh'

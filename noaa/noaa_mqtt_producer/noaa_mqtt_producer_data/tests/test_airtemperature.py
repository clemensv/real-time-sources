...
class Test_AirTemperature(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = AirTemperature(
            station_id='ccnyzrftihcchbzvshvk',
            timestamp='dluymscwejvtojzzttcn',
            value=float(86.94726768789994),
            max_temp_exceeded=True,
            min_temp_exceeded=True,
            rate_of_change_exceeded=True,
            region='dcdpxppmlgtsvkttssrt'
        )
        return instance
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'ccnyzrftihcchbzvshvk'
    ...
    def test_timestamp_property(self):
        ...
        """
        test_value = 'dluymscwejvtojzzttcn'
    ...
    def test_value_property(self):
        ...
        Test value property
        """
        test_value = float(86.94726768789994)
    ...
    def test_region_property(self):
        ...
        """
        test_value = 'dcdpxppmlgtsvkttssrt'

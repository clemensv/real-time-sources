...
from noaa_mqtt_producer_data.microsoft.opendata.us.noaa.stationtypes.tidepredoffsets import TidePredOffsets
...
class Test_TidePredOffsets(unittest.TestCase):
    ...
    def test_self__property(self):
        ...
        Test self_ property
        """
        test_value = 'rjhggvervtjcpwtsodas'
    ...
    def test_to_json(self):
        ...
        new_instance = TidePredOffsets.from_json(json_data)

...
- **Scales horizontally** across multiple brokers and partitions### MicrosoftOpenDataUSNOAAEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`MicrosoftOpenDataUSNOAAEventDispatcher` handles events for the Microsoft.OpenData.US.NOAA message group.
...
The MicrosoftOpenDataUSNOAAEventDispatcher defines the following event handler hooks.
...
producer = MicrosoftOpenDataUSNOAAProducer(
    ...
    security_protocol='SASL_SSL',##### `microsoft_open_data_us_noaa_water_level_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'microsoft_open_data_us_noaa_water_level_async:  Callable[[ConsumerRecord, CloudEvent,
WaterLevel], Awaitable[None]]

)```

```

Asynchronous handler hook for `Microsoft.OpenData.US.NOAA.WaterLevel`:
...
microsoft_open_data_us_noaa_dispatcher.microsoft_open_data_us_noaa_water_level_async =
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `microsoft_open_data_us_noaa_predictions_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'microsoft_open_data_us_noaa_predictions_async:  Callable[[ConsumerRecord, CloudEvent,
Predictions], Awaitable[None]]

)```

```

Asynchronous handler hook for `Microsoft.OpenData.US.NOAA.Predictions`:
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `microsoft_open_data_us_noaa_air_pressure_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'microsoft_open_data_us_noaa_air_pressure_async:  Callable[[ConsumerRecord, CloudEvent,
AirPressure], Awaitable[None]]

)```

```

Asynchronous handler hook for `Microsoft.OpenData.US.NOAA.AirPressure`:
...
microsoft_open_data_us_noaa_dispatcher.microsoft_open_data_us_noaa_air_pressure_async =
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `microsoft_open_data_us_noaa_air_temperature_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'microsoft_open_data_us_noaa_air_temperature_async:  Callable[[ConsumerRecord,
...
Asynchronous handler hook for `Microsoft.OpenData.US.NOAA.AirTemperature`:
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `microsoft_open_data_us_noaa_water_temperature_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'microsoft_open_data_us_noaa_water_temperature_async:  Callable[[ConsumerRecord,
...
Asynchronous handler hook for `Microsoft.OpenData.US.NOAA.WaterTemperature`:
...
microsoft_open_data_us_noaa_dispatcher.microsoft_open_data_us_noaa_water_temperature_async =
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `microsoft_open_data_us_noaa_wind_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'microsoft_open_data_us_noaa_wind_async:  Callable[[ConsumerRecord, CloudEvent, Wind],
Awaitable[None]]
...
Asynchronous handler hook for `Microsoft.OpenData.US.NOAA.Wind`:
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `microsoft_open_data_us_noaa_humidity_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'microsoft_open_data_us_noaa_humidity_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `Microsoft.OpenData.US.NOAA.Humidity`:
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `microsoft_open_data_us_noaa_conductivity_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'microsoft_open_data_us_noaa_conductivity_async:  Callable[[ConsumerRecord, CloudEvent,
Conductivity], Awaitable[None]]

)```

```

Asynchronous handler hook for `Microsoft.OpenData.US.NOAA.Conductivity`:
...
microsoft_open_data_us_noaa_dispatcher.microsoft_open_data_us_noaa_conductivity_async =
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `microsoft_open_data_us_noaa_salinity_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'microsoft_open_data_us_noaa_salinity_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `Microsoft.OpenData.US.NOAA.Salinity`:
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `microsoft_open_data_us_noaa_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'microsoft_open_data_us_noaa_station_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `Microsoft.OpenData.US.NOAA.Station`:
...
microsoft_open_data_us_noaa_dispatcher.microsoft_open_data_us_noaa_station_async =
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `microsoft_open_data_us_noaa_visibility_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'microsoft_open_data_us_noaa_visibility_async:  Callable[[ConsumerRecord, CloudEvent,
Visibility], Awaitable[None]]

)```

```

Asynchronous handler hook for `Microsoft.OpenData.US.NOAA.Visibility`:
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `microsoft_open_data_us_noaa_currents_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'microsoft_open_data_us_noaa_currents_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `Microsoft.OpenData.US.NOAA.Currents`:
...
microsoft_open_data_us_noaa_dispatcher.microsoft_open_data_us_noaa_currents_async =
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `microsoft_open_data_us_noaa_current_predictions_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'microsoft_open_data_us_noaa_current_predictions_async:  Callable[[ConsumerRecord,
...
Asynchronous handler hook for `Microsoft.OpenData.US.NOAA.CurrentPredictions`:
...
##### `send_microsoft_open_data_us_noaa_water_level`Dispatchers have the following protected methods:



```python### Methods:

async def send_microsoft_open_data_us_noaa_water_level(
...
Send a single `Microsoft.OpenData.US.NOAA.WaterLevel` message.Args:
...
await producer.send_microsoft_open_data_us_noaa_water_level(
...
Send multiple `Microsoft.OpenData.US.NOAA.WaterLevel` messages in a batch.
...
await producer.send_microsoft_open_data_us_noaa_water_level_batch(```
...
##### `send_microsoft_open_data_us_noaa_predictions`Dispatchers have the following protected methods:



```python### Methods:

async def send_microsoft_open_data_us_noaa_predictions(
...
Send a single `Microsoft.OpenData.US.NOAA.Predictions` message.Args:
...
await producer.send_microsoft_open_data_us_noaa_predictions(
...
Send multiple `Microsoft.OpenData.US.NOAA.Predictions` messages in a batch.
...
await producer.send_microsoft_open_data_us_noaa_predictions_batch(```
...
##### `send_microsoft_open_data_us_noaa_air_pressure`Dispatchers have the following protected methods:



```python### Methods:

async def send_microsoft_open_data_us_noaa_air_pressure(
...
Send a single `Microsoft.OpenData.US.NOAA.AirPressure` message.Args:
...
await producer.send_microsoft_open_data_us_noaa_air_pressure(
...
Send multiple `Microsoft.OpenData.US.NOAA.AirPressure` messages in a batch.
...
await producer.send_microsoft_open_data_us_noaa_air_pressure_batch(```
...
##### `send_microsoft_open_data_us_noaa_air_temperature`Dispatchers have the following protected methods:



```python### Methods:

async def send_microsoft_open_data_us_noaa_air_temperature(
...
Send a single `Microsoft.OpenData.US.NOAA.AirTemperature` message.Args:
...
await producer.send_microsoft_open_data_us_noaa_air_temperature(
...
Send multiple `Microsoft.OpenData.US.NOAA.AirTemperature` messages in a batch.
...
await producer.send_microsoft_open_data_us_noaa_air_temperature_batch(```
...
##### `send_microsoft_open_data_us_noaa_water_temperature`Dispatchers have the following protected methods:



```python### Methods:

async def send_microsoft_open_data_us_noaa_water_temperature(
...
Send a single `Microsoft.OpenData.US.NOAA.WaterTemperature` message.Args:
...
await producer.send_microsoft_open_data_us_noaa_water_temperature(
...
Send multiple `Microsoft.OpenData.US.NOAA.WaterTemperature` messages in a batch.
...
await producer.send_microsoft_open_data_us_noaa_water_temperature_batch(```
...
##### `send_microsoft_open_data_us_noaa_wind`Dispatchers have the following protected methods:



```python### Methods:

async def send_microsoft_open_data_us_noaa_wind(
...
Send a single `Microsoft.OpenData.US.NOAA.Wind` message.Args:
...
await producer.send_microsoft_open_data_us_noaa_wind(
...
Send multiple `Microsoft.OpenData.US.NOAA.Wind` messages in a batch.
...
await producer.send_microsoft_open_data_us_noaa_wind_batch(```
...
##### `send_microsoft_open_data_us_noaa_humidity`Dispatchers have the following protected methods:



```python### Methods:

async def send_microsoft_open_data_us_noaa_humidity(
...
Send a single `Microsoft.OpenData.US.NOAA.Humidity` message.Args:
...
await producer.send_microsoft_open_data_us_noaa_humidity(
...
Send multiple `Microsoft.OpenData.US.NOAA.Humidity` messages in a batch.
...
await producer.send_microsoft_open_data_us_noaa_humidity_batch(```
...
##### `send_microsoft_open_data_us_noaa_conductivity`Dispatchers have the following protected methods:



```python### Methods:

async def send_microsoft_open_data_us_noaa_conductivity(
...
Send a single `Microsoft.OpenData.US.NOAA.Conductivity` message.Args:
...
await producer.send_microsoft_open_data_us_noaa_conductivity(
...
Send multiple `Microsoft.OpenData.US.NOAA.Conductivity` messages in a batch.
...
await producer.send_microsoft_open_data_us_noaa_conductivity_batch(```
...
##### `send_microsoft_open_data_us_noaa_salinity`Dispatchers have the following protected methods:



```python### Methods:

async def send_microsoft_open_data_us_noaa_salinity(
...
Send a single `Microsoft.OpenData.US.NOAA.Salinity` message.Args:
...
await producer.send_microsoft_open_data_us_noaa_salinity(
...
Send multiple `Microsoft.OpenData.US.NOAA.Salinity` messages in a batch.
...
await producer.send_microsoft_open_data_us_noaa_salinity_batch(```
...
##### `send_microsoft_open_data_us_noaa_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_microsoft_open_data_us_noaa_station(
...
Send a single `Microsoft.OpenData.US.NOAA.Station` message.Args:
...
await producer.send_microsoft_open_data_us_noaa_station(
...
Send multiple `Microsoft.OpenData.US.NOAA.Station` messages in a batch.
...
await producer.send_microsoft_open_data_us_noaa_station_batch(```
...
##### `send_microsoft_open_data_us_noaa_visibility`Dispatchers have the following protected methods:



```python### Methods:

async def send_microsoft_open_data_us_noaa_visibility(
...
Send a single `Microsoft.OpenData.US.NOAA.Visibility` message.Args:
...
await producer.send_microsoft_open_data_us_noaa_visibility(
...
Send multiple `Microsoft.OpenData.US.NOAA.Visibility` messages in a batch.
...
await producer.send_microsoft_open_data_us_noaa_visibility_batch(```
...
##### `send_microsoft_open_data_us_noaa_currents`Dispatchers have the following protected methods:



```python### Methods:

async def send_microsoft_open_data_us_noaa_currents(
...
Send a single `Microsoft.OpenData.US.NOAA.Currents` message.Args:
...
await producer.send_microsoft_open_data_us_noaa_currents(
...
Send multiple `Microsoft.OpenData.US.NOAA.Currents` messages in a batch.
...
await producer.send_microsoft_open_data_us_noaa_currents_batch(```
...
##### `send_microsoft_open_data_us_noaa_current_predictions`Dispatchers have the following protected methods:



```python### Methods:

async def send_microsoft_open_data_us_noaa_current_predictions(
...
Send a single `Microsoft.OpenData.US.NOAA.CurrentPredictions` message.Args:
...
await producer.send_microsoft_open_data_us_noaa_current_predictions(
...
Send multiple `Microsoft.OpenData.US.NOAA.CurrentPredictions` messages in a batch.

...
from test_noaa-producer_data_microsoft_opendata_us_noaa_stationtypes_notices import Test_Notices
from test_noaa-producer_data_microsoft_opendata_us_noaa_stationtypes_details import Test_Details
from test_noaa-producer_data_microsoft_opendata_us_noaa_stationtypes_tidepredoffsets import Test_TidePredOffsets
from test_noaa-producer_data_microsoft_opendata_us_noaa_stationtypes_ofsmapoffsets import Test_OfsMapOffsets
from test_noaa-producer_data_microsoft_opendata_us_noaa_stationtypes_datums import Test_Datums
from test_noaa-producer_data_microsoft_opendata_us_noaa_stationtypes_sensors import Test_Sensors
from test_noaa-producer_data_microsoft_opendata_us_noaa_stationtypes_nearby import Test_Nearby
from test_noaa-producer_data_microsoft_opendata_us_noaa_stationtypes_disclaimers import Test_Disclaimers
from test_noaa-producer_data_microsoft_opendata_us_noaa_stationtypes_floodlevels import Test_Floodlevels
from test_noaa-producer_data_microsoft_opendata_us_noaa_stationtypes_supersededdatums import Test_Supersededdatums
from test_noaa-producer_data_microsoft_opendata_us_noaa_stationtypes_benchmarks import Test_Benchmarks
from test_noaa-producer_data_microsoft_opendata_us_noaa_stationtypes_harmonicconstituents import Test_HarmonicConstituents
from test_noaa-producer_data_microsoft_opendata_us_noaa_stationtypes_products import Test_Products
...
class Test_Station(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Station(
            ...
            state='twuetvmhsnnpijziipiy',
            timezone='alkuueosvhmbujihmirz',
            timezonecorr=int(54),
            observedst=False,
            stormsurge=True,
            ...
            id='wxaamomwxwfxelhsglbq',
            name='srqadwlwchvhxweuybgd',
            lat=float(13.917438996179754),
            lng=float(10.495417081975855),
            affiliations='plcsmrtecijlwpcbwlhk',
            portscode='veoypfsciwvxhcxvvwri',
            products=Test_Products.create_instance(),
            disclaimers=Test_Disclaimers.create_instance(),
            notices=Test_Notices.create_instance(),
            self_='vzpasncdgxchixhqcnxn',
            expand='phrnpwbkzevfcpnxzzim',
            tideType='xzyvbbdoetzwmykhytqf'
        )
        return instance
    ...
    def test_shefcode_property(self):
        ...
        """
        test_value = 'jadswwvijieihffgehvb'
    ...
    def test_state_property(self):
        ...
        Test state property
        """
        test_value = 'twuetvmhsnnpijziipiy'
    ...
    def test_timezone_property(self):
        ...
        """
        test_value = 'alkuueosvhmbujihmirz'
    ...
    def test_id_property(self):
        ...
        Test id property
        """
        test_value = 'wxaamomwxwfxelhsglbq'
    ...
    def test_name_property(self):
        ...
        Test name property
        """
        test_value = 'srqadwlwchvhxweuybgd'
    ...
    def test_lat_property(self):
        ...
        Test lat property
        """
        test_value = float(13.917438996179754)
    ...
    def test_lng_property(self):
        ...
        Test lng property
        """
        test_value = float(10.495417081975855)
    ...
    def test_affiliations_property(self):
        ...
        """
        test_value = 'plcsmrtecijlwpcbwlhk'
    ...
    def test_portscode_property(self):
        ...
        """
        test_value = 'veoypfsciwvxhcxvvwri'
    ...
    def test_self__property(self):
        ...
        Test self_ property
        """
        test_value = 'vzpasncdgxchixhqcnxn'
    ...
    def test_expand_property(self):
        ...
        """
        test_value = 'phrnpwbkzevfcpnxzzim'
    ...
    def test_tideType_property(self):
        ...
        """
        test_value = 'xzyvbbdoetzwmykhytqf'

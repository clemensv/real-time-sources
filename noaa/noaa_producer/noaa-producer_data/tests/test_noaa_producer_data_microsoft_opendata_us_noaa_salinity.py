...
class Test_Salinity(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Salinity(
            station_id='fvhmjstaiyabjrshowqz',
            timestamp='pkuogvyjffjbqxsdmzlw',
            salinity=float(86.34387739318221),
            grams_per_kg=float(31.589163692503774)
        )
        return instance
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'fvhmjstaiyabjrshowqz'
    ...
    def test_timestamp_property(self):
        ...
        """
        test_value = 'pkuogvyjffjbqxsdmzlw'
    ...
    def test_salinity_property(self):
        ...
        """
        test_value = float(86.34387739318221)
    ...
    def test_grams_per_kg_property(self):
        ...
        """
        test_value = float(31.589163692503774)

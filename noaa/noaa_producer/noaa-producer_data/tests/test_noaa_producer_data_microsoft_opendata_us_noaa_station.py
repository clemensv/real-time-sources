...
class Test_Station(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Station(
            ...
            state='oknczodmwrgowoziqgrz',
            timezone='hgrxvosoobfyglxrkodu',
            timezonecorr=int(30),
            observedst=False,
            stormsurge=True,
            ...
            id='jmjqoqgzibqkzhciptqk',
            name='nldrwipvatqehmcqnanl',
            lat=float(62.65558032331013),
            lng=float(33.6612291144586),
            affiliations='mntjuilemkowwyxszeap',
            portscode='ichzhwggutfinagnbwyq',
            products=Test_Products.create_instance(),
            disclaimers=Test_Disclaimers.create_instance(),
            notices=Test_Notices.create_instance(),
            self_='zeabbxhupejcozepfsaj',
            expand='pxvwayybhopcjxgfxkgd',
            tideType='enrebjgjmzdsgnwdoawy'
        )
        return instance
    ...
    def test_shefcode_property(self):
        ...
        """
        test_value = 'khstdbjjoxqctcyzlkcu'
    ...
    def test_state_property(self):
        ...
        Test state property
        """
        test_value = 'oknczodmwrgowoziqgrz'
    ...
    def test_timezone_property(self):
        ...
        """
        test_value = 'hgrxvosoobfyglxrkodu'
    ...
    def test_id_property(self):
        ...
        Test id property
        """
        test_value = 'jmjqoqgzibqkzhciptqk'
    ...
    def test_name_property(self):
        ...
        Test name property
        """
        test_value = 'nldrwipvatqehmcqnanl'
    ...
    def test_lat_property(self):
        ...
        Test lat property
        """
        test_value = float(62.65558032331013)
    ...
    def test_lng_property(self):
        ...
        Test lng property
        """
        test_value = float(33.6612291144586)
    ...
    def test_affiliations_property(self):
        ...
        """
        test_value = 'mntjuilemkowwyxszeap'
    ...
    def test_portscode_property(self):
        ...
        """
        test_value = 'ichzhwggutfinagnbwyq'
    ...
    def test_self__property(self):
        ...
        Test self_ property
        """
        test_value = 'zeabbxhupejcozepfsaj'
    ...
    def test_expand_property(self):
        ...
        """
        test_value = 'pxvwayybhopcjxgfxkgd'
    ...
    def test_tideType_property(self):
        ...
        """
        test_value = 'enrebjgjmzdsgnwdoawy'

...
class Test_Visibility(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Visibility(
            timestamp='oartokufqdhdryhzjdlw',
            value=float(88.86574562179499),
            max_visibility_exceeded=False,
            min_visibility_exceeded=False,
            rate_of_change_exceeded=False,
            station_id='xfrfigcqqmukzbbzdnes'
        )
        return instance
    ...
    def test_timestamp_property(self):
        ...
        """
        test_value = 'oartokufqdhdryhzjdlw'
    ...
    def test_value_property(self):
        ...
        Test value property
        """
        test_value = float(88.86574562179499)
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'xfrfigcqqmukzbbzdnes'

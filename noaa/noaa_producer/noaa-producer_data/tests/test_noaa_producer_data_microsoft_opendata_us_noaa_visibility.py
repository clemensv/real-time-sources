...
class Test_Visibility(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Visibility(
            timestamp='trxupcadpwpxxwxcvzlx',
            value=float(87.46795037632776),
            max_visibility_exceeded=True,
            min_visibility_exceeded=False,
            rate_of_change_exceeded=False,
            station_id='ssbsljyczexdyywxpkhx'
        )
        return instance
    ...
    def test_timestamp_property(self):
        ...
        """
        test_value = 'trxupcadpwpxxwxcvzlx'
    ...
    def test_value_property(self):
        ...
        Test value property
        """
        test_value = float(87.46795037632776)
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'ssbsljyczexdyywxpkhx'

...
class Test_Wind(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Wind(
            station_id='mquuvurljfefmtjxyism',
            timestamp='xsrpnlmxjaoshdbxzgak',
            speed=float(9.824438610608755),
            direction_degrees='xusbfzrtdrhiuqsnemwz',
            direction_text='fbgwcwfsikqppiundfkc',
            gusts=float(62.11924918972597),
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'mquuvurljfefmtjxyism'
    ...
    def test_timestamp_property(self):
        ...
        """
        test_value = 'xsrpnlmxjaoshdbxzgak'
    ...
    def test_speed_property(self):
        ...
        Test speed property
        """
        test_value = float(9.824438610608755)
    ...
    def test_direction_degrees_property(self):
        ...
        """
        test_value = 'xusbfzrtdrhiuqsnemwz'
    ...
    def test_direction_text_property(self):
        ...
        """
        test_value = 'fbgwcwfsikqppiundfkc'
    ...
    def test_gusts_property(self):
        ...
        Test gusts property
        """
        test_value = float(62.11924918972597)

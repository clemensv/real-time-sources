...
class Station:
    ...
    Attributes:
        ...
        greatlakes (bool)
        shefcode (str)
        details (UnnamedClass)
        sensors (UnnamedClass)
        floodlevels (UnnamedClass)
        datums (UnnamedClass)
        supersededdatums (UnnamedClass)
        harmonicConstituents (UnnamedClass)
        benchmarks (UnnamedClass)
        tidePredOffsets (UnnamedClass)
        ofsMapOffsets (UnnamedClass)
        state (str)
        timezone (str)
        timezonecorr (int)
        observedst (bool)
        ...
        affiliations (str)
        portscode (str)
        products (UnnamedClass)
        disclaimers (UnnamedClass)
        notices (UnnamedClass)
        self_ (str)
        expand (str)
        tideType (str)
    """
    ...
    details: UnnamedClass=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="details"))
    sensors: UnnamedClass=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="sensors"))
    floodlevels: UnnamedClass=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="floodlevels"))
    datums: UnnamedClass=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="datums"))
    supersededdatums: UnnamedClass=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="supersededdatums"))
    harmonicConstituents: UnnamedClass=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="harmonicConstituents"))
    benchmarks: UnnamedClass=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="benchmarks"))
    tidePredOffsets: UnnamedClass=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="tidePredOffsets"))
    ofsMapOffsets: UnnamedClass=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="ofsMapOffsets"))
    ...
    nearby: UnnamedClass=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="nearby"))
    ...
    products: UnnamedClass=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="products"))
    disclaimers: UnnamedClass=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="disclaimers"))
    notices: UnnamedClass=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="notices"))
    ...
    def create_instance(cls) -> 'Station':
        ...
        return cls(
            ...
            ofsMapOffsets=None,
            state='rmfnxnvcfmamkqilreca',
            timezone='vypbdmppviqngcjghlrv',
            timezonecorr=int(53),
            observedst=False,
            stormsurge=False,
            nearby=None,
            ...
            station_id='vemjgxutvxkpkqasolmv',
            name='ryvyibsqvteijjyndhhy',
            lat=float(11.325742250708737),
            lng=float(60.078895871166516),
            affiliations='rnvpyvetuhdzelbwjumu',
            portscode='krxofbmaofzriklfdryj',
            products=None,
            disclaimers=None,
            notices=None,
            self_='jybvgkmfljrhdohdbqzs',
            expand='oribnnufalklieycovhg',
            tideType='ddjdbopgvlpysonhnxul'
        )
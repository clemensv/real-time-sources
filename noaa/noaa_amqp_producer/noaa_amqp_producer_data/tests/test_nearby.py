...
from noaa_amqp_producer_data.microsoft.opendata.us.noaa.stationtypes.nearby import Nearby
...
class Test_Nearby(unittest.TestCase):
    ...
    def test_self__property(self):
        ...
        Test self_ property
        """
        test_value = 'vsvlyhbhzwanpljtltxj'
    ...
    def test_to_json(self):
        ...
        new_instance = Nearby.from_json(json_data)

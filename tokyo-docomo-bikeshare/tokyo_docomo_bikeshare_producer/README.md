...
# Tokyo_docomo_bikeshare_producer Kafka Producer# Tokyo_docomo_bikeshare_producer Event Dispatcher for Apache Kafka
...
Asynchronous handler hook for `JP.ODPT.DocomoBikeshare.BikeshareSystem`: A transport update from Docomo Bike Share open
feeds. It carries station status and availability updates for Tokyo bike-share stations.
...
Send a single `JP.ODPT.DocomoBikeshare.BikeshareSystem` message. A transport update from Docomo Bike Share open feeds.
It carries station status and availability updates for Tokyo bike-share stations.Args:

...
# Tokyo-docomo-bikeshare-producer Kafka Producer# Tokyo-docomo-bikeshare-producer Event Dispatcher for Apache Kafka
...
- **Scales horizontally** across multiple brokers and partitions### JPODPTDocomoBikeshareSystemEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`JPODPTDocomoBikeshareSystemEventDispatcher` handles events for the JP.ODPT.DocomoBikeshare.System message group.
...
from tokyo-docomo-bikeshare-producer import JPODPTDocomoBikeshareSystemProducer```python
...
The JPODPTDocomoBikeshareSystemEventDispatcher defines the following event handler hooks.
...
producer = JPODPTDocomoBikeshareSystemProducer(
    ...
    security_protocol='SASL_SSL',##### `jp_odpt_docomo_bikeshare_bikeshare_system_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'jp_odpt_docomo_bikeshare_bikeshare_system_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `JP.ODPT.DocomoBikeshare.BikeshareSystem`:
...
jp_odpt_docomo_bikeshare_system_dispatcher.jp_odpt_docomo_bikeshare_bikeshare_system_async =
...
##### `send_jp_odpt_docomo_bikeshare_bikeshare_system`Dispatchers have the following protected methods:



```python### Methods:

async def send_jp_odpt_docomo_bikeshare_bikeshare_system(
...
Send a single `JP.ODPT.DocomoBikeshare.BikeshareSystem` message.Args:
...
await producer.send_jp_odpt_docomo_bikeshare_bikeshare_system(
...
Send multiple `JP.ODPT.DocomoBikeshare.BikeshareSystem` messages in a batch.
...
await producer.send_jp_odpt_docomo_bikeshare_bikeshare_system_batch(```
...
Asynchronous handler hook for `JP.ODPT.DocomoBikeshare.BikeshareStation`:
...
Asynchronous handler hook for `JP.ODPT.DocomoBikeshare.BikeshareStationStatus`:
...
Send a single `JP.ODPT.DocomoBikeshare.BikeshareStation` message.Args:
...
Send a single `JP.ODPT.DocomoBikeshare.BikeshareStationStatus` message.Args:

...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../tokyo_docomo_bikeshare_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../tokyo_docomo_bikeshare_amqp_producer_amqp_producer/src')))
...
class TestJPODPTDocomoBikeshareSystemAmqpProducer:
    """Test cases for JPODPTDocomoBikeshareSystemAmqpProducer"""
...
class TestJPODPTDocomoBikeshareStationsAmqpProducer:
    """Test cases for JPODPTDocomoBikeshareStationsAmqpProducer"""

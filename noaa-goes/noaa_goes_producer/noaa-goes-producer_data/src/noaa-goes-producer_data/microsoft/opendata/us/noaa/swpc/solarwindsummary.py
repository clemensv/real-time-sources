...
class SolarWindSummary:
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"SolarWindSummary\", \"namespace\": \"Microsoft.OpenData.US.NOAA.SWPC\", \"fields\": [{\"name\": \"timestamp\", \"type\": \"string\"}, {\"name\": \"wind_speed\", \"type\": \"double\"}, {\"name\": \"bt\", \"type\": \"double\"}, {\"name\": \"bz\", \"type\": \"double\"}]}"), avro.name.Names()
    )

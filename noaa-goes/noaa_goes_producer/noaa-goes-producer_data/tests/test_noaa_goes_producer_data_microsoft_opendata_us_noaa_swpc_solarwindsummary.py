...
class Test_SolarWindSummary(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = SolarWindSummary(
            timestamp='zxarfqzbsehgtvhzjnfy',
            wind_speed=float(42.00455012720848),
            bt=float(67.22801637475465),
            bz=float(89.28218897055247)
        )
        return instance
    ...
    def test_timestamp_property(self):
        ...
        """
        test_value = 'zxarfqzbsehgtvhzjnfy'
    ...
    def test_wind_speed_property(self):
        ...
        """
        test_value = float(42.00455012720848)
    ...
    def test_bt_property(self):
        ...
        Test bt property
        """
        test_value = float(67.22801637475465)
    ...
    def test_bz_property(self):
        ...
        Test bz property
        """
        test_value = float(89.28218897055247)

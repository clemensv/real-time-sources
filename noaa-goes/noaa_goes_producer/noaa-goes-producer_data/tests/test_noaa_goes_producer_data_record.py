...
from noaa_goes_producer_data.record import Record
...
class Test_Record(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Record(
            product_id='unwjgaamnegqrvejrtlz',
            issue_datetime='kizvugehqcctwtvofvty',
            message='kxewqvqttmajtkrmyicr'
        )
        return instance
    ...
    def test_product_id_property(self):
        ...
        """
        test_value = 'unwjgaamnegqrvejrtlz'
    ...
    def test_issue_datetime_property(self):
        ...
        """
        test_value = 'kizvugehqcctwtvofvty'
    ...
    def test_message_property(self):
        ...
        """
        test_value = 'kxewqvqttmajtkrmyicr'

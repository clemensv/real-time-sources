...
class Test_PlanetaryKIndex(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = PlanetaryKIndex(
            time_tag='nvkmxflecyacalgqwsap',
            kp=float(38.28008935196207),
            a_running=float(93.29484686964516),
            station_count=float(27.9446043190827)
        )
        return instance
    ...
    def test_time_tag_property(self):
        ...
        """
        test_value = 'nvkmxflecyacalgqwsap'
    ...
    def test_kp_property(self):
        ...
        Test kp property
        """
        test_value = float(38.28008935196207)
    ...
    def test_a_running_property(self):
        ...
        """
        test_value = float(93.29484686964516)
    ...
    def test_station_count_property(self):
        ...
        """
        test_value = float(27.9446043190827)

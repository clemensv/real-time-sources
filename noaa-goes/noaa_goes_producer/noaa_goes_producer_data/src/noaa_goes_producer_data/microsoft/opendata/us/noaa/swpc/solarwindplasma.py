...
class SolarWindPlasma:
    """
    One-minute DSCOVR solar wind plasma measurement: density, speed, temperature.
    Attributes:
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"SolarWindPlasma\", \"namespace\": \"Microsoft.OpenData.US.NOAA.SWPC\", \"doc\": \"One-minute DSCOVR solar wind plasma measurement: density, speed, temperature.\", \"fields\": [{\"name\": \"observation_time\", \"type\": \"string\"}, {\"name\": \"density\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"speed\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"temperature\", \"type\": [\"null\", \"double\"], \"default\": null}]}"), avro.name.Names()
    )

    def __post_init__(self):
        """ Initializes the dataclass with the provided keyword arguments."""
        self.observation_time=str(self.observation_time)
        self.density=float(self.density) if self.density else None

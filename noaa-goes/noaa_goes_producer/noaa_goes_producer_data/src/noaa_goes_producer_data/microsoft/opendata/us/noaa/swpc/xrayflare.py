...
class XrayFlare:
    """
    Individual solar X-ray flare event with onset, peak, and end classifications.
    Attributes:
        time_tag (str): 
        begin_time (str): 
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"XrayFlare\", \"namespace\": \"Microsoft.OpenData.US.NOAA.SWPC\", \"doc\": \"Individual solar X-ray flare event with onset, peak, and end classifications.\", \"fields\": [{\"name\": \"time_tag\", \"type\": \"string\"}, {\"name\": \"begin_time\", \"type\": \"string\"}, {\"name\": \"begin_class\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"max_time\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"max_class\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"max_xrlong\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"max_ratio\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"max_ratio_time\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"current_int_xrlong\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"end_time\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"end_class\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"satellite\", \"type\": \"int\"}]}"), avro.name.Names()
    )

    def __post_init__(self):
        """ Initializes the dataclass with the provided keyword arguments."""
        self.time_tag=str(self.time_tag)
        self.begin_time=str(self.begin_time)
        self.begin_class=str(self.begin_class) if self.begin_class else None
        self.max_time=str(self.max_time) if self.max_time else None
        self.max_class=str(self.max_class) if self.max_class else None
        self.max_xrlong=float(self.max_xrlong) if self.max_xrlong else None
        self.max_ratio=float(self.max_ratio) if self.max_ratio else None
        self.max_ratio_time=str(self.max_ratio_time) if self.max_ratio_time else None
        self.current_int_xrlong=float(self.current_int_xrlong) if self.current_int_xrlong else None
        self.end_time=str(self.end_time) if self.end_time else None
        self.end_class=str(self.end_class) if self.end_class else None

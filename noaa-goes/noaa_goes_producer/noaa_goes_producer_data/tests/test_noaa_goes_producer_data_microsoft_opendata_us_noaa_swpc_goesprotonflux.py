...
class Test_GoesProtonFlux(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = GoesProtonFlux(
            time_tag='ofhnymhmmlvsckjhrklf',
            satellite=int(94),
            flux=float(51.38989432667786),
            energy='twdsntiqwobdmbhxmmvw'
        )
        return instance
    ...
    def test_time_tag_property(self):
        ...
        """
        test_value = 'ofhnymhmmlvsckjhrklf'
    ...
    def test_flux_property(self):
        ...
        Test flux property
        """
        test_value = float(51.38989432667786)
    ...
    def test_energy_property(self):
        ...
        """
        test_value = 'twdsntiqwobdmbhxmmvw'

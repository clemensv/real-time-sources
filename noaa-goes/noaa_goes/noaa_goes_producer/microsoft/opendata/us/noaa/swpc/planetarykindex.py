...
class PlanetaryKIndex:
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"PlanetaryKIndex\", \"namespace\": \"Microsoft.OpenData.US.NOAA.SWPC\", \"fields\": [{\"name\": \"time_tag\", \"type\": \"string\"}, {\"name\": \"kp\", \"type\": \"double\"}, {\"name\": \"a_running\", \"type\": \"double\"}, {\"name\": \"station_count\", \"type\": \"double\"}]}"), avro.name.Names()
    )

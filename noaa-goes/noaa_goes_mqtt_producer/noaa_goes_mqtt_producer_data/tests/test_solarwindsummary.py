...
from noaa_goes_mqtt_producer_data.solarwindsummary import SolarWindSummary
...
class Test_SolarWindSummary(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = SolarWindSummary(
            observation_time='dgryegzxrcgvodvamcqz',
            wind_speed=float(22.068131898022315),
            bt=float(70.28181898153382),
            bz=float(98.70219947955809)
        )
        return instance
    ...
    def test_observation_time_property(self):
        ...
        """
        test_value = 'dgryegzxrcgvodvamcqz'
    ...
    def test_wind_speed_property(self):
        ...
        """
        test_value = float(22.068131898022315)
    ...
    def test_bt_property(self):
        ...
        Test bt property
        """
        test_value = float(70.28181898153382)
    ...
    def test_bz_property(self):
        ...
        Test bz property
        """
        test_value = float(98.70219947955809)

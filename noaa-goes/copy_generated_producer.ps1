# Copy generated producer files to the main noaa_goes package

$scriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$generatedProducerSrc = Join-Path $scriptDir "noaa_goes_producer\noaa-goes-producer_kafka_producer\src\noaa-goes-producer_kafka_producer"
$generatedDataSrc = Join-Path $scriptDir "noaa_goes_producer\noaa-goes-producer_data\src\noaa-goes-producer_data"
$targetProducerDir = Join-Path $scriptDir "noaa_goes\noaa_goes_producer"

...
Asynchronous handler hook for `BE.Vlaanderen.Waterinfo.VMM.Station`:
...
Asynchronous handler hook for `BE.Vlaanderen.Waterinfo.VMM.WaterLevelReading`:
...
Send a single `BE.Vlaanderen.Waterinfo.VMM.Station` message.Args:
...
Send a single `BE.Vlaanderen.Waterinfo.VMM.WaterLevelReading` message.Args:

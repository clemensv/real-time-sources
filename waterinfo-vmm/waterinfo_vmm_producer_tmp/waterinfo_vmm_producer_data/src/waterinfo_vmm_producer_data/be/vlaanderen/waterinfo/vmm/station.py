...
class Station:
    ...
    def __post_init__(self):
        ...
        self.stationparameter_name=str(self.stationparameter_name) if self.stationparameter_name else None
        self.ts_id=str(self.ts_id) if self.ts_id else None
        self.ts_unitname=str(self.ts_unitname) if self.ts_unitname else None

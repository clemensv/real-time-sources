...
class WaterLevelReading:
    ...
    def __post_init__(self):
        ...
        self.station_name=str(self.station_name) if self.station_name else None
        value_timestamp = self.timestamp
        self.timestamp = value_timestamp
        self.value=float(self.value)
        self.unit_name=str(self.unit_name) if self.unit_name else None
        self.parameter_name=str(self.parameter_name) if self.parameter_name else None

...
"""
Sample usage of madrid_traffic_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # TODO: Create a MeasurementPoint instance with actual data
        ...
        # Send Amqp message
        print("Sending Amqp message...")
        # TODO: Create a TrafficReading instance with actual data
        # data = TrafficReading(...)
        # producer.send_amqp(
        #     data=data,
        #     content_type="application/json"

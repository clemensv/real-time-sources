# Copy generated producer files to usgs_earthquakes/usgs_earthquakes_producer

Write-Host "Copying generated producer files..." -ForegroundColor Cyan

$scriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$sourceDir = Join-Path $scriptDir "usgs_earthquakes_producer" "usgs-earthquakes-producer_kafka_producer" "src" "usgs-earthquakes-producer_kafka_producer"
$dataSourceDir = Join-Path $scriptDir "usgs_earthquakes_producer" "usgs-earthquakes-producer_data" "src" "usgs-earthquakes-producer_data"

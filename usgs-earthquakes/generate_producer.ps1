...
$xregFile = Join-Path $scriptDir "xreg" "usgs_earthquakes.xreg.json"
...
xregistry generate --style kafkaproducer --language py --projectname usgs-earthquakes-producer --definitions $xregFile --output $outputDir

...
"""
Sample usage of fienta_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send EventSaleStatus message
        print("Sending EventSaleStatus message...")
        # TODO: Create a EventSaleStatus instance with actual data
        # data = EventSaleStatus(...)
        # producer.send_event_sale_status(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("EventSaleStatus message sent successfully!")

...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../fienta_producer_data/src')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../fienta_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../fienta_producer_kafka_producer/src')))
...
def test_com_fienta_comfientaevent(kafka_emulator):
    """Test the ComFientaEvent event from the Com.Fienta message group"""
    ...
    consumer = Consumer({
        ...
        'group.id': 'test_com_fienta_comfientaevent',  # Unique group per test
...
def test_com_fienta_comfientaeventsalestatus(kafka_emulator):
    """Test the ComFientaEventSaleStatus event from the Com.Fienta message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_com_fienta_comfientaeventsalestatus',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_com_fienta_mqtt_comfientamqttevent(kafka_emulator):
    """Test the ComFientaMqttEvent event from the Com.Fienta.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_com_fienta_mqtt_comfientamqttevent',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_com_fienta_mqtt_comfientamqtteventsalestatus(kafka_emulator):
    """Test the ComFientaMqttEventSaleStatus event from the Com.Fienta.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_com_fienta_mqtt_comfientamqtteventsalestatus',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_com_fienta_amqp_comfientaamqpevent(kafka_emulator):
    """Test the ComFientaAmqpEvent event from the Com.Fienta.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_com_fienta_amqp_comfientaamqpevent',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_com_fienta_amqp_comfientaamqpeventsalestatus(kafka_emulator):
    """Test the ComFientaAmqpEventSaleStatus event from the Com.Fienta.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_com_fienta_amqp_comfientaamqpeventsalestatus',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_com_fienta_cross_event_type_kafka_key(kafka_emulator):
    """Test that different event types in Com.Fienta produce the same Kafka key for the same placeholder values"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_com_fienta_cross_key',
    ...
    data1 = Test_Event.create_instance()
    data2 = Test_EventSaleStatus.create_instance()

    producer_instance.send_com_fienta_event(_event_id = shared_key_value, data = data1)
    producer_instance.send_com_fienta_event_sale_status(_event_id = shared_key_value, data = data2)
    kafka_producer.flush(timeout=5.0)
    ...
    while len(collected_keys) < 2 and time.time() < timeout:
        ...
        if msg is None or msg.error():
            continue
        cloudevent = parse_cloudevent(msg)
        if cloudevent['type'] in ["Com.Fienta.Event", "Com.Fienta.EventSaleStatus"]:
    ...
    expected_key = "{event_id}".format(event_id=shared_key_value)

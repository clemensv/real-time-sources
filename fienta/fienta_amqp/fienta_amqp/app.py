"""AMQP companion feeder for fienta. Publishes mock/sample CloudEvents for Docker E2E and auth-blocked upstreams."""
from __future__ import annotations
import argparse, inspect, json, os, pathlib, re
from datetime import datetime, timezone
from urllib.parse import urlparse
from proton import symbol
from fienta_amqp_producer_amqp_producer import producer as producer_mod
import fienta_amqp_producer_data as data_mod
...
def _val(name, typ):
    ...
    if 'country' in n: return 'gb' if 'fienta'=='elexon-bmrs' else ('jp' if 'fienta'=='tepco-denkiyoho' else 'dk' if 'fienta'=='energidataservice-dk' else 'de' if 'fienta'=='energy-charts' else 'nl')

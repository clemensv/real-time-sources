...
"""
Sample usage of noaa_nws_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send WeatherAlert message
        print("Sending WeatherAlert message...")
        ...
        # )
        # print("WeatherAlert message sent successfully!")
    ...
    try:
        ...
        # Send ObservationStation message
        print("Sending ObservationStation message...")
        # TODO: Create a ObservationStation instance with actual data
        # data = ObservationStation(...)
        # producer.send_observation_station(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("ObservationStation message sent successfully!")

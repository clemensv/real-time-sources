# Generate the NOAA NWS Weather Alerts producer using xregistry
...
xregistry generate --style kafkaproducer --language py --projectname noaa-nws-producer --definitions $xregFile --output $outputDir

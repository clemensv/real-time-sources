...
class Zone:
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"Zone\", \"doc\": \"Zone\", \"fields\": [{\"name\": \"zone_id\", \"type\": \"string\"}, {\"name\": \"name\", \"type\": \"string\"}, {\"name\": \"type\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"state\", \"type\": \"string\"}, {\"name\": \"forecast_office\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"timezone\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"radar_station\", \"type\": [\"null\", \"string\"], \"default\": null}], \"namespace\": \"Microsoft.OpenData.US.NOAA.NWS\"}"), avro.name.Names()
    )
    ...
    def __post_init__(self):
        ...
        self.forecast_office=str(self.forecast_office) if self.forecast_office else None
        self.timezone=str(self.timezone) if self.timezone else None
        self.radar_station=str(self.radar_station) if self.radar_station else None

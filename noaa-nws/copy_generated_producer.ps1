# Copy generated producer files to the main noaa_nws package

$scriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$generatedProducerSrc = Join-Path $scriptDir "noaa_nws_producer\noaa-nws-producer_kafka_producer\src\noaa-nws-producer_kafka_producer"
$generatedDataSrc = Join-Path $scriptDir "noaa_nws_producer\noaa-nws-producer_data\src\noaa-nws-producer_data"
$targetProducerDir = Join-Path $scriptDir "noaa_nws\noaa_nws_producer"

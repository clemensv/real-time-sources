...
`tools/deploy-fabric/deploy-feeder-notebook.ps1 -Source french-road-traffic -WorkspaceId <id> -CapacityId <id>`
...
`tools/deploy-fabric/deploy-fabric-aci.ps1 -Source french-road-traffic -WorkspaceId <id> -CapacityId <id>`

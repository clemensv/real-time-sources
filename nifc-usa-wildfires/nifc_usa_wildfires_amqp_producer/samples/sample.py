...
"""
Sample usage of nifc_usa_wildfires_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send WildfireIncident message
        print("Sending WildfireIncident message...")
        # TODO: Create a WildfireIncident instance with actual data
        # data = WildfireIncident(...)
        # producer.send_wildfire_incident(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("WildfireIncident message sent successfully!")

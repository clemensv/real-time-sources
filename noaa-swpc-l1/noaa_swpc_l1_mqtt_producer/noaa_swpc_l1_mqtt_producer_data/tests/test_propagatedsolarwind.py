...
class Test_PropagatedSolarWind(unittest.TestCase):
    ...
    def test_speed_property(self):
        ...
        Test speed property
        """
        test_value = float(5.558668437398506)
    ...
    def test_density_property(self):
        ...
        """
        test_value = float(62.94574797362339)
    ...
    def test_temperature_property(self):
        ...
        """
        test_value = float(0.7914285355932194)
    ...
    def test_bx_property(self):
        ...
        Test bx property
        """
        test_value = float(44.69680497856778)
    ...
    def test_by_property(self):
        ...
        Test by property
        """
        test_value = float(61.99502183512816)
    ...
    def test_bz_property(self):
        ...
        Test bz property
        """
        test_value = float(78.94089671800664)
    ...
    def test_bt_property(self):
        ...
        Test bt property
        """
        test_value = float(0.3098683041697692)
    ...
    def test_vx_property(self):
        ...
        Test vx property
        """
        test_value = float(70.76053083900699)
    ...
    def test_vy_property(self):
        ...
        Test vy property
        """
        test_value = float(59.38954904468948)
    ...
    def test_vz_property(self):
        ...
        Test vz property
        """
        test_value = float(36.41199377039281)

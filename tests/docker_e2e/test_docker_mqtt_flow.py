...
class TestJmaBosaiWarningMqttDockerFlow:
    def test_emits_mqtt_uns_topics(self, mosquitto_jma_bosai_warning, jma_bosai_warning_mqtt_image):
        _run_mqtt_contract_flow('jma-bosai-warning', jma_bosai_warning_mqtt_image, mosquitto_jma_bosai_warning, extra_env={'JMA_BOSAI_WARNING_MOCK': 'true'}, timeout=900, min_messages=3)
...
class TestJmaBosaiQuakeMqttDockerFlow:
    def test_emits_mqtt_uns_topics(self, mosquitto_jma_bosai_quake, jma_bosai_quake_mqtt_image):
        _run_mqtt_contract_flow('jma-bosai-quake', jma_bosai_quake_mqtt_image, mosquitto_jma_bosai_quake, extra_env={'JMA_BOSAI_QUAKE_MOCK': 'true'}, timeout=900)

...
class Station:
    """
    Metadata for a BfS ODL gamma dose rate monitoring station in the IMIS network.
    Attributes:
        station_id (str): Nine-digit station identifier (Kennziffer) assigned by BfS.
        station_code (str): Short alphanumeric station code (DEZ prefix + four digits).
        name (str): Human-readable station location name.
        postal_code (str): German postal code (PLZ) of the station location.
        site_status (int): Numeric operational status code. 1 = in operation.
        site_status_text (str): Human-readable German operational status text.
    ...
    kid: int=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="kid"))
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"Station\", \"namespace\": \"de.bfs.odl\", \"doc\": \"Metadata for a BfS ODL gamma dose rate monitoring station in the IMIS network.\", \"fields\": [{\"name\": \"station_id\", \"type\": \"string\", \"doc\": \"Nine-digit station identifier (Kennziffer) assigned by BfS.\"}, {\"name\": \"station_code\", \"type\": \"string\", \"doc\": \"Short alphanumeric station code (DEZ prefix + four digits).\"}, {\"name\": \"name\", \"type\": \"string\", \"doc\": \"Human-readable station location name.\"}, {\"name\": \"postal_code\", \"type\": \"string\", \"doc\": \"German postal code (PLZ) of the station location.\"}, {\"name\": \"site_status\", \"type\": \"int\", \"doc\": \"Numeric operational status code. 1 = in operation.\"}, {\"name\": \"site_status_text\", \"type\": \"string\", \"doc\": \"Human-readable German operational status text.\"}, {\"name\": \"kid\", \"type\": \"int\", \"doc\": \"Numeric region identifier (Kreis-ID).\"}, {\"name\": \"height_above_sea\", \"type\": [\"null\", \"double\"], \"doc\": \"Elevation above sea level in meters. Null if unknown.\", \"default\": null}, {\"name\": \"longitude\", \"type\": \"double\", \"doc\": \"Longitude in WGS84 decimal degrees.\"}, {\"name\": \"latitude\", \"type\": \"double\", \"doc\": \"Latitude in WGS84 decimal degrees.\"}]}"), avro.name.Names()
    )

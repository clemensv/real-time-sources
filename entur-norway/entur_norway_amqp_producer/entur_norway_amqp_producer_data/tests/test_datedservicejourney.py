...
from entur_norway_amqp_producer_data.no.entur.datedservicejourney import DatedServiceJourney
...
class Test_DatedServiceJourney(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = DatedServiceJourney(
            service_journey_id='aqamoouwxrhbupffneay',
            operating_day='ixrgxvpblmzivhddyxyh',
            line_ref='cqckhqzrucponumflnnp',
            operator_ref='qzyknuxvhzpwqppofjsi',
            direction_ref='spdnagzhwvwwcfzimwpx',
            vehicle_mode='abpoygvgkvifbyomxnam',
            route_ref='jlwegsnxpwbbwfgptgfr',
            published_line_name='ukjrdarwrcymftaxmlfb',
            external_line_ref='ktrborhxattqakbzqhxz',
            origin_name='iytqgiggxenpwrkraaoq',
            destination_name='vblvkebbllwgviuzwlkj',
            data_source='pcreggbowtyyvtvvgfmv'
        )
        return instance
    ...
    def test_service_journey_id_property(self):
        ...
        """
        test_value = 'aqamoouwxrhbupffneay'
    ...
    def test_operating_day_property(self):
        ...
        """
        test_value = 'ixrgxvpblmzivhddyxyh'
    ...
    def test_line_ref_property(self):
        ...
        """
        test_value = 'cqckhqzrucponumflnnp'
    ...
    def test_operator_ref_property(self):
        ...
        """
        test_value = 'qzyknuxvhzpwqppofjsi'
    ...
    def test_direction_ref_property(self):
        ...
        """
        test_value = 'spdnagzhwvwwcfzimwpx'
    ...
    def test_vehicle_mode_property(self):
        ...
        """
        test_value = 'abpoygvgkvifbyomxnam'
    ...
    def test_route_ref_property(self):
        ...
        """
        test_value = 'jlwegsnxpwbbwfgptgfr'
    ...
    def test_published_line_name_property(self):
        ...
        """
        test_value = 'ukjrdarwrcymftaxmlfb'
    ...
    def test_external_line_ref_property(self):
        ...
        """
        test_value = 'ktrborhxattqakbzqhxz'
    ...
    def test_origin_name_property(self):
        ...
        """
        test_value = 'iytqgiggxenpwrkraaoq'
    ...
    def test_destination_name_property(self):
        ...
        """
        test_value = 'vblvkebbllwgviuzwlkj'
    ...
    def test_data_source_property(self):
        ...
        """
        test_value = 'pcreggbowtyyvtvvgfmv'

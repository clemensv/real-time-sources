...
from entur_norway_mqtt_producer_data.no.entur.estimatedvehiclejourney import EstimatedVehicleJourney
...
class Test_EstimatedVehicleJourney(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = EstimatedVehicleJourney(
            service_journey_id='hvabrtafreeruqkaaemv',
            operating_day='uqirsywvyajqpbribsgr',
            line_ref='szkbczqwhodaafrizypv',
            operator_ref='toexudmvfqaxgmazhduu',
            direction_ref='ofnxxsocvxwkwxprdzrm',
            vehicle_mode='kjnjdessqmichohgicjq',
            published_line_name='izjwcibmoeaaysuvdxme',
            route_ref='ihjnvqmnbapjpkwxpxpw',
            origin_name='umccpusoubmxonjbbcmi',
            destination_name='lpgbwayjgrwwsjbswoog',
            is_cancellation=False,
            is_extra_journey=False,
            is_complete_stop_sequence=False,
            monitored=False,
            data_source='evaaavpuliwhmphehbta',
            recorded_at_time=datetime.datetime.now(datetime.timezone.utc),
            estimated_calls=[EstimatedCall(stop_point_ref='NSR:Quay:1', order=1, stop_point_name=None, aimed_arrival_time=None, expected_arrival_time=None, aimed_departure_time=None, expected_departure_time=None, arrival_status=None, departure_status=None, departure_platform_name=None, arrival_boarding_activity=None, departure_boarding_activity=None, is_cancellation=None, is_extra_stop=None), EstimatedCall(stop_point_ref='NSR:Quay:2', order=2, stop_point_name=None, aimed_arrival_time=None, expected_arrival_time=None, aimed_departure_time=None, expected_departure_time=None, arrival_status=None, departure_status=None, departure_platform_name=None, arrival_boarding_activity=None, departure_boarding_activity=None, is_cancellation=None, is_extra_stop=None)]
        )
        return instance
    ...
    def test_service_journey_id_property(self):
        ...
        """
        test_value = 'hvabrtafreeruqkaaemv'
    ...
    def test_operating_day_property(self):
        ...
        """
        test_value = 'uqirsywvyajqpbribsgr'
    ...
    def test_line_ref_property(self):
        ...
        """
        test_value = 'szkbczqwhodaafrizypv'
    ...
    def test_operator_ref_property(self):
        ...
        """
        test_value = 'toexudmvfqaxgmazhduu'
    ...
    def test_direction_ref_property(self):
        ...
        """
        test_value = 'ofnxxsocvxwkwxprdzrm'
    ...
    def test_vehicle_mode_property(self):
        ...
        """
        test_value = 'kjnjdessqmichohgicjq'
    ...
    def test_published_line_name_property(self):
        ...
        """
        test_value = 'izjwcibmoeaaysuvdxme'
    ...
    def test_route_ref_property(self):
        ...
        """
        test_value = 'ihjnvqmnbapjpkwxpxpw'
    ...
    def test_origin_name_property(self):
        ...
        """
        test_value = 'umccpusoubmxonjbbcmi'
    ...
    def test_destination_name_property(self):
        ...
        """
        test_value = 'lpgbwayjgrwwsjbswoog'
    ...
    def test_data_source_property(self):
        ...
        """
        test_value = 'evaaavpuliwhmphehbta'

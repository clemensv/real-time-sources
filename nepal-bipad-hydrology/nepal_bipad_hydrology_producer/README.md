...
# Nepal_bipad_hydrology_producer Kafka Producer# Nepal_bipad_hydrology_producer Event Dispatcher for Apache Kafka
...
- **Scales horizontally** across multiple brokers and partitions### NpGovBipadHydrologyEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`NpGovBipadHydrologyEventDispatcher` handles events for the np.gov.bipad.hydrology message group.
...
The NpGovBipadHydrologyEventDispatcher defines the following event handler hooks.
...
producer = NpGovBipadHydrologyProducer(
    ...
    security_protocol='SASL_SSL',##### `np_gov_bipad_hydrology_river_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'np_gov_bipad_hydrology_river_station_async:  Callable[[ConsumerRecord, CloudEvent,
...
np_gov_bipad_hydrology_dispatcher.np_gov_bipad_hydrology_river_station_async =
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `np_gov_bipad_hydrology_water_level_reading_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'np_gov_bipad_hydrology_water_level_reading_async:  Callable[[ConsumerRecord,
...
np_gov_bipad_hydrology_dispatcher.np_gov_bipad_hydrology_water_level_reading_async =
...
##### `send_np_gov_bipad_hydrology_river_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_np_gov_bipad_hydrology_river_station(
...
await producer.send_np_gov_bipad_hydrology_river_station(
...
Send multiple `np.gov.bipad.hydrology.RiverStation` messages in a batch.
...
await producer.send_np_gov_bipad_hydrology_river_station_batch(```
...
##### `send_np_gov_bipad_hydrology_water_level_reading`Dispatchers have the following protected methods:



```python### Methods:

async def send_np_gov_bipad_hydrology_water_level_reading(
...
await producer.send_np_gov_bipad_hydrology_water_level_reading(
...
Send multiple `np.gov.bipad.hydrology.WaterLevelReading` messages in a batch.

"""MQTT companion feeder for billetto. Publishes mock/sample CloudEvents for Docker E2E and auth-blocked upstreams."""
...
from billetto_mqtt_producer_mqtt_client import client as client_mod
import billetto_mqtt_producer_data as data_mod

# Billetto Public Events container images
...
| `BILLETTO_API_KEYPAIR` | Core configuration for this image variant. |
...
| `BILLETTO_MACROREGION` | Core configuration for this image variant. |
| `BILLETTO_POSTAL_CODE` | Core configuration for this image variant. |
| `BILLETTO_ORGANIZER_ID` | Core configuration for this image variant. |

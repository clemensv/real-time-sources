...
from chmi_hydro_amqp_producer_data.waterlevelobservation import WaterLevelObservation
import datetime
...
class Test_WaterLevelObservation(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = WaterLevelObservation(
            station_id='sdlfklcsagmsgbxfrowl',
            station_name='jbftxynilacoachtxpzr',
            stream_name='hsjlyerqlhvczwwhbxao',
            water_level=float(79.116689294649),
            water_level_timestamp=datetime.datetime.now(datetime.timezone.utc),
            discharge=float(37.15958235528175),
            discharge_timestamp=datetime.datetime.now(datetime.timezone.utc),
            water_temperature=float(29.709823798448408),
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'sdlfklcsagmsgbxfrowl'
    ...
    def test_station_name_property(self):
        ...
        """
        test_value = 'jbftxynilacoachtxpzr'
    ...
    def test_stream_name_property(self):
        ...
        """
        test_value = 'hsjlyerqlhvczwwhbxao'
    ...
    def test_water_level_property(self):
        ...
        """
        test_value = float(79.116689294649)
    ...
    def test_discharge_property(self):
        ...
        """
        test_value = float(37.15958235528175)
    ...
    def test_water_temperature_property(self):
        ...
        """
        test_value = float(29.709823798448408)

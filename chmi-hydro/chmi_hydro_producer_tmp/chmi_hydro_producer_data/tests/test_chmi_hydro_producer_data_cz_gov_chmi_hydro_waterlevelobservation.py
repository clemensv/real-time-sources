...
class Test_WaterLevelObservation(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = WaterLevelObservation(
            station_id='qboserlhfnumzpgfyjfm',
            station_name='hqrfwrtznilslnvnvuyb',
            stream_name='fjtxztsejgkeulzauflz',
            water_level=float(38.405966911715474),
            water_level_timestamp=datetime.datetime.now(datetime.timezone.utc),
            discharge=float(84.58200614632891),
            discharge_timestamp=datetime.datetime.now(datetime.timezone.utc),
            water_temperature=float(96.02495802759664),
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'qboserlhfnumzpgfyjfm'
    ...
    def test_station_name_property(self):
        ...
        """
        test_value = 'hqrfwrtznilslnvnvuyb'
    ...
    def test_stream_name_property(self):
        ...
        """
        test_value = 'fjtxztsejgkeulzauflz'
    ...
    def test_water_level_property(self):
        ...
        """
        test_value = float(38.405966911715474)
    ...
    def test_discharge_property(self):
        ...
        """
        test_value = float(84.58200614632891)
    ...
    def test_water_temperature_property(self):
        ...
        """
        test_value = float(96.02495802759664)

...
from chmi_hydro_mqtt_producer_data.waterlevelobservation import WaterLevelObservation
import datetime
...
class Test_WaterLevelObservation(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = WaterLevelObservation(
            station_id='qoefpfbseilalzsertef',
            station_name='lfsbvjwgazfnayaaaihb',
            stream_name='ejhinixxstugfwtmpjnm',
            water_level=float(29.45895158983237),
            water_level_timestamp=datetime.datetime.now(datetime.timezone.utc),
            discharge=float(91.57446272712626),
            discharge_timestamp=datetime.datetime.now(datetime.timezone.utc),
            water_temperature=float(72.39303830977241),
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'qoefpfbseilalzsertef'
    ...
    def test_station_name_property(self):
        ...
        """
        test_value = 'lfsbvjwgazfnayaaaihb'
    ...
    def test_stream_name_property(self):
        ...
        """
        test_value = 'ejhinixxstugfwtmpjnm'
    ...
    def test_water_level_property(self):
        ...
        """
        test_value = float(29.45895158983237)
    ...
    def test_discharge_property(self):
        ...
        """
        test_value = float(91.57446272712626)
    ...
    def test_water_temperature_property(self):
        ...
        """
        test_value = float(72.39303830977241)

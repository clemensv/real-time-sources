...
from chmi_hydro.chmi_hydro_producer import Station
from chmi_hydro.chmi_hydro_producer import WaterLevelObservation
...
class CZGovCHMIHydroEventProducer:
    ...
    def send_cz_gov_chmi_hydro_station(self,data: Station, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
    ...
    def send_cz_gov_chmi_hydro_water_level_observation(self,data: WaterLevelObservation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, WaterLevelObservation], str]=None) -> None:
        """

...
class Station:
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"Station\", \"namespace\": \"CZ.Gov.CHMI.Hydro\", \"fields\": [{\"name\": \"station_id\", \"type\": \"string\"}, {\"name\": \"dbc\", \"type\": \"string\"}, {\"name\": \"station_name\", \"type\": \"string\"}, {\"name\": \"stream_name\", \"type\": \"string\"}, {\"name\": \"latitude\", \"type\": \"double\"}, {\"name\": \"longitude\", \"type\": \"double\"}, {\"name\": \"flood_level_1\", \"type\": \"double\"}, {\"name\": \"flood_level_2\", \"type\": \"double\"}, {\"name\": \"flood_level_3\", \"type\": \"double\"}, {\"name\": \"flood_level_4\", \"type\": \"double\"}, {\"name\": \"has_forecast\", \"type\": \"boolean\"}]}"), avro.name.Names()
    )
    ...
    def __post_init__(self):
        ...
        self.flood_level_1=float(self.flood_level_1) if self.flood_level_1 is not None else None
        self.flood_level_2=float(self.flood_level_2) if self.flood_level_2 is not None else None
        self.flood_level_3=float(self.flood_level_3) if self.flood_level_3 is not None else None
        self.flood_level_4=float(self.flood_level_4) if self.flood_level_4 is not None else None

...
const SOURCES = [
  ...
  { id: "uk-bods-siri", name: "UK BODS SIRI", cat: "Transport", key: true, desc: "England — 28,000+ buses, BODS AVL (requires free API key)", notebook: true, kql: true, mqtt: true, amqp: true },
  ...
  { id: "taipei-youbike", name: "YouBike 2.0 Taiwan", cat: "Transport", key: false, desc: "Taiwan — YouBike 2.0 island-wide bikeshare, ~9,348 stations", kql: true, notebook: true, mqtt: true, amqp: true },

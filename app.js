...
const SOURCES = [
  ...
  { id: "canada-eccc-wateroffice", name: "Canada ECCC Water Office", cat: "Hydrology", key: false, desc: "Canada — ~2,100 hydrometric stations, ECCC/WSC", notebook: true, mqtt: true, amqp: true },
  ...
  { id: "german-waters", name: "German Waters", cat: "Hydrology", key: false, desc: "Germany — 12 state portals, ~2,724 stations", notebook: true, mqtt: true, amqp: true, mqttBasic: false, mqttEg: false },
  ...
  { id: "dwd", name: "DWD", cat: "Weather", key: false, desc: "Germany — ~1,450 stations, observations and CAP alerts", notebook: true, mqtt: true, amqp: true },
  ...
  { id: "wallonia-issep", name: "Wallonia ISSeP", cat: "Air Quality", key: false, desc: "Belgium / Wallonia — low-cost air quality sensors", notebook: true, mqtt: true, amqp: true, mqttBasic: false, mqttEg: false },
  ...
  { id: "nextbus", name: "Nextbus", cat: "Transport", key: true, desc: "North America — public transit arrivals", notebook: true, mqtt: true, amqp: true, amqpSb: false },
  ...
  { id: "tfl-road-traffic", name: "TfL Road Traffic", cat: "Transport", key: false, desc: "London, UK — road corridor status and disruptions", mqtt: true, amqp: true, kafka: false },
  { id: "tokyo-docomo-bikeshare", name: "Tokyo Docomo Bikeshare", cat: "Transport", key: false, desc: "Tokyo, Japan — 1,794 stations, GBFS 2.3 via ODPT", mqtt: true, amqp: true, kafka: false, amqpSb: false },
  ...
  { id: "xceed", name: "Xceed", cat: "Nightlife", key: false, desc: "Europe — clubs, bars, parties, festivals — event schedules", notebook: true, mqtt: true, amqp: true },
  ...
  // ── Public Events ──
  { id: "billetto", name: "Billetto", cat: "Public Events", key: false, desc: "Europe — pan-European ticketed public events", notebook: true, mqtt: true, amqp: true },

...
|---|---|
| Earthquake bulletins (hypocenter / magnitude / JMA intensity) | `feeders/jma-bosai-quake` |
| Tsunami alerts + per-prefecture weather warnings | `feeders/jma-bosai-warning` |
| Volcano (111 volcanoes, alert levels, eruption obs) | `feeders/jma-bosai-volcano` |
| AMeDAS 10-min weather observations (~1,300 stations) | `feeders/jma-bosai-amedas` |
| Weather bulletins / warnings / forecasts | `feeders/jma-japan` |

Korea's earthquake/tsunami data (KMA) is real-time but **key-gated**
(`apihub.kma.go.kr` → 401) and **not yet implemented** — it remains a build
candidate, documented within [`weather/kma-south-korea.md`](../weather/kma-south-korea.md).
Full reconciliation in [`_research-rounds/2026-06-japan-korea-realtime-sweep.md`](../_research-rounds/2026-06-japan-korea-realtime-sweep.md).

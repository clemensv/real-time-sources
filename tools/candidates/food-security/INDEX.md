# Food Security — Candidate Sources

Scouted: 2026-04-06 (Africa research round)

## Candidates Evaluated

| # | Candidate | File | Score | Coverage | Verdict |
|---|-----------|------|-------|----------|---------|
| 1 | **FEWS NET Food Prices** | [fewsnet-food-prices.md](fewsnet-food-prices.md) | **14/18** | Sub-Saharan Africa (20+ countries) | ✅ **Build** — Weekly market prices, hundreds of markets, rich metadata |
| 2 | **FEWS NET IPC Classifications** | [fewsnet-ipc-classification.md](fewsnet-ipc-classification.md) | **13/18** | Sub-Saharan Africa (20+ countries) | ✅ **Build** — Quarterly food security phases, humanitarian gold standard |

...
@pytest.mark.asyncio
async def test_nws_alerts_mqtt_nws_weather_alert_mqtt_py(mosquitto_broker):
    """Test publishing and receiving NWS.WeatherAlert.mqtt message via MQTT."""
    ...
    async def on_nws_weather_alert_mqtt(mqtt_msg, cloud_event, data: nws_alerts_mqtt_producer_data.WeatherAlert, topic_params: dict):
        """Handler for NWS.WeatherAlert.mqtt messages."""
    ...
    # Register handler
    subscriber_client.nws_weather_alert_mqtt_async = on_nws_weather_alert_mqtt
    ...
    # Subscribe to topic
    test_topic = "test/nws_alerts_mqtt/nws_weather_alert_mqtt"
    ...
    for i in range(5):
        await publisher_client.publish_nws_weather_alert_mqtt(
            topic=test_topic,

...
"""
Tests for jma_bosai_amedas_amqp_producer_amqp_producer
"""
import base64
import json
import os
...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../jma_bosai_amedas_amqp_producer_data/src')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../jma_bosai_amedas_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../jma_bosai_amedas_amqp_producer_amqp_producer/src')))

from jma_bosai_amedas_amqp_producer_amqp_producer import *
from jma_bosai_amedas_amqp_producer_data import Station
from test_jma_bosai_amedas_amqp_producer_data_station import Test_Station
from jma_bosai_amedas_amqp_producer_data import Observation
from test_jma_bosai_amedas_amqp_producer_data_observation import Test_Observation
...
class TestJPJMAAmedasAmqpProducer:
    """Test cases for JPJMAAmedasAmqpProducer"""

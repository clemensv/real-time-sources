...
class JPJMAAmedasAmqpProducer:
    """
    Producer class to send messages in the `JP.JMA.Amedas.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_station(self,
        ...
        amqp_msg.subject = "jp.jma.amedas/{station_code}".format(station_code=_station_code)

...
class Wind10Min:
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"Wind10Min\", \"namespace\": \"DE.DWD.CDC\", \"fields\": [{\"name\": \"station_id\", \"type\": \"string\"}, {\"name\": \"timestamp\", \"type\": \"string\"}, {\"name\": \"quality_level\", \"type\": \"long\"}, {\"name\": \"wind_speed\", \"type\": \"double\"}, {\"name\": \"wind_direction\", \"type\": \"double\"}]}"), avro.name.Names()
    )
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['Wind10Min']:
        """
        ...
        if base_content_type in ['avro/binary', 'application/vnd.apache.avro+avro', 'avro/json', 'application/vnd.apache.avro+json']:
            ...
            return Wind10Min.from_serializer_dict(_record)
        if base_content_type == 'application/json':

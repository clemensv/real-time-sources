...
class Wind10Min:
    ...
    def create_instance(cls) -> 'Wind10Min':
        ...
        """
        return cls(
            station_id='hqljbaqelpfidvmauwkk',
            timestamp='zembpukdtxvmgpzuqgbf',
            quality_level=int(59),
            wind_speed=float(93.00134826220956),
            wind_direction=float(81.56684843761933)
        )
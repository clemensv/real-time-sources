...
@pytest.mark.asyncio
async def test_uk_gov_tfl_road_mqtt_uk_gov_tfl_road_mqtt_roads_py(mosquitto_broker):
    """Test publishing and receiving uk.gov.tfl.road.mqtt.Roads message via MQTT."""
    ...
    async def on_uk_gov_tfl_road_mqtt_roads(mqtt_msg, cloud_event, data: tfl_road_traffic_mqtt_producer_data.RoadStatus, topic_params: dict):
        """Handler for uk.gov.tfl.road.mqtt.Roads messages."""
    ...
    # Register handler
    subscriber_client.uk_gov_tfl_road_mqtt_roads_async = on_uk_gov_tfl_road_mqtt_roads
    ...
    # Subscribe to topic
    test_topic = "test/uk_gov_tfl_road_mqtt/uk_gov_tfl_road_mqtt_roads"
    ...
    for i in range(5):
        await publisher_client.publish_uk_gov_tfl_road_mqtt_roads(
            topic=test_topic,

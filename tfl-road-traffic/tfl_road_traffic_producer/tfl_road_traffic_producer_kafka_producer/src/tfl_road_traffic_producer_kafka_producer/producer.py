...
class UkGovTflRoadCorridorsEventProducer:
    ...
    def send_uk_gov_tfl_road_road_corridor(self,_road_id : str, data: RoadCorridor, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadCorridor], str]=None) -> None:
        """
    ...
    def send_uk_gov_tfl_road_road_status(self,_road_id : str, data: RoadStatus, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadStatus], str]=None) -> None:
        """
...
class UkGovTflRoadDisruptionsEventProducer:
    ...
    def send_uk_gov_tfl_road_road_disruption(self,_road_id : str, _severity : str, _disruption_id : str, data: RoadDisruption, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadDisruption], str]=None) -> None:
        """
...
class UkGovTflRoadMqttEventProducer:
    ...
    def send_uk_gov_tfl_road_mqtt_road_disruption_serious(self,_road_id : str, _severity : str, _disruption_id : str, data: RoadDisruption, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadDisruption], str]=None) -> None:
        """
    ...
    def send_uk_gov_tfl_road_mqtt_road_disruption_severe(self,_road_id : str, _severity : str, _disruption_id : str, data: RoadDisruption, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadDisruption], str]=None) -> None:
        """
    ...
    def send_uk_gov_tfl_road_mqtt_road_disruption_moderate(self,_road_id : str, _severity : str, _disruption_id : str, data: RoadDisruption, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadDisruption], str]=None) -> None:
        """
    ...
    def send_uk_gov_tfl_road_mqtt_road_disruption_minor(self,_road_id : str, _severity : str, _disruption_id : str, data: RoadDisruption, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadDisruption], str]=None) -> None:
        """
    ...
    def send_uk_gov_tfl_road_mqtt_road_disruption_information(self,_road_id : str, _severity : str, _disruption_id : str, data: RoadDisruption, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadDisruption], str]=None) -> None:
        """
    ...
    def send_uk_gov_tfl_road_mqtt_road_disruption_closure(self,_road_id : str, _severity : str, _disruption_id : str, data: RoadDisruption, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadDisruption], str]=None) -> None:
        """

...
from cdec_reservoirs_producer_data.reservoirreading import ReservoirReading
...
async def main(connection_string: Optional[str], producer_config: Optional[str], topic: Optional[str]):
    ...
    if connection_string:
        ...
        gov_ca_water_cdec_event_producer = GovCaWaterCdecEventProducer.from_connection_string(connection_string, topic, 'binary')
    else:
        # use a Kafka producer configuration provided as JSON text
        kafka_producer = KafkaProducer(json.loads(producer_config))
        gov_ca_water_cdec_event_producer = GovCaWaterCdecEventProducer(kafka_producer, topic, 'binary')

    # ---- gov.ca.water.cdec.ReservoirReading ----
    # TODO: Supply event data for the gov.ca.water.cdec.ReservoirReading event

...
"""
Sample usage of cdec_reservoirs_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send ReservoirReading message
        print("Sending ReservoirReading message...")
        # TODO: Create a ReservoirReading instance with actual data
        # data = ReservoirReading(...)
        # producer.send_reservoir_reading(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("ReservoirReading message sent successfully!")

...
async def main(connection_string: Optional[str], producer_config: Optional[str], topic: Optional[str]):
    ...
    if connection_string:
        ...
        meteoalarm_warnings_event_producer = MeteoalarmWarningsEventProducer.from_connection_string(connection_string, topic, 'binary')
    else:
        # use a Kafka producer configuration provided as JSON text
        kafka_producer = KafkaProducer(json.loads(producer_config))
        meteoalarm_warnings_event_producer = MeteoalarmWarningsEventProducer(kafka_producer, topic, 'binary')

    # ---- Meteoalarm.WeatherWarning ----
    # TODO: Supply event data for the Meteoalarm.WeatherWarning event

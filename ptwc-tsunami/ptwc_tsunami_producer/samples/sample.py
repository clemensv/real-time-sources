...
async def main(connection_string: Optional[str], producer_config: Optional[str], topic: Optional[str]):
    ...
    if connection_string:
        ...
        ptwcbulletins_event_producer = PTWCBulletinsEventProducer.from_connection_string(connection_string, topic, 'binary')
    else:
        # use a Kafka producer configuration provided as JSON text
        kafka_producer = KafkaProducer(json.loads(producer_config))
        ptwcbulletins_event_producer = PTWCBulletinsEventProducer(kafka_producer, topic, 'binary')

    # ---- PTWC.TsunamiBulletin ----
    # TODO: Supply event data for the PTWC.TsunamiBulletin event

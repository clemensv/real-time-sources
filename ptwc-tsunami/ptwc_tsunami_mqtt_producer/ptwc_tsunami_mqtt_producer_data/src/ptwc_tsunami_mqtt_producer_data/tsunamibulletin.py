...
class TsunamiBulletin:
    ...
    basin: BasinEnum=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="basin"))
    ptwc_level: PtwcLevelenum=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="ptwc_level"))

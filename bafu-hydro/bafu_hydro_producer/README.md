...
Asynchronous handler hook for `CH.BAFU.Hydrology.Station`:
...
Asynchronous handler hook for `CH.BAFU.Hydrology.WaterLevelObservation`:
...
Send a single `CH.BAFU.Hydrology.Station` message.Args:
...
Send a single `CH.BAFU.Hydrology.WaterLevelObservation` message.Args:
...
Asynchronous handler hook for `CH.BAFU.Hydrology.mqtt.Station`:
...
Asynchronous handler hook for `CH.BAFU.Hydrology.mqtt.WaterLevelObservation`:
...
Send a single `CH.BAFU.Hydrology.mqtt.Station` message.Args:
...
Send a single `CH.BAFU.Hydrology.mqtt.WaterLevelObservation` message.Args:

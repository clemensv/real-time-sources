...
class WaterLevelObservation:
    ...
    water_temperature_unit: str=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="water_temperature_unit"))
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"WaterLevelObservation\", \"namespace\": \"CH.BAFU.Hydrology\", \"fields\": [{\"name\": \"station_id\", \"type\": \"string\"}, {\"name\": \"water_level\", \"type\": \"double\"}, {\"name\": \"water_level_unit\", \"type\": \"string\"}, {\"name\": \"water_level_timestamp\", \"type\": \"string\"}, {\"name\": \"discharge\", \"type\": \"double\"}, {\"name\": \"discharge_unit\", \"type\": \"string\"}, {\"name\": \"discharge_timestamp\", \"type\": \"string\"}, {\"name\": \"water_temperature\", \"type\": \"double\"}, {\"name\": \"water_temperature_unit\", \"type\": \"string\"}, {\"name\": \"water_temperature_timestamp\", \"type\": \"string\"}]}"), avro.name.Names()
    )
    ...
    def __post_init__(self):
        ...
        self.water_temperature_unit=str(self.water_temperature_unit)

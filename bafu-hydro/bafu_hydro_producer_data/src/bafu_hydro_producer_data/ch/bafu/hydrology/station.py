...
class Station:
    ...
    water_body_type: str=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="water_body_type"))
    latitude: float=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="latitude"))
    longitude: float=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="longitude"))
    
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"Station\", \"namespace\": \"CH.BAFU.Hydrology\", \"fields\": [{\"name\": \"station_id\", \"type\": \"string\"}, {\"name\": \"name\", \"type\": \"string\"}, {\"name\": \"water_body_name\", \"type\": \"string\"}, {\"name\": \"water_body_type\", \"type\": \"string\"}, {\"name\": \"latitude\", \"type\": \"double\"}, {\"name\": \"longitude\", \"type\": \"double\"}]}"), avro.name.Names()
    )
    ...
    def __post_init__(self):
        ...
        self.water_body_type=str(self.water_body_type)

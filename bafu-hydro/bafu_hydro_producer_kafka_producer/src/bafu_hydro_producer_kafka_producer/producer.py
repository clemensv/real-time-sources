...
class CHBAFUHydrologyEventProducer:
    ...
    def send_ch_bafu_hydrology_station(self,data: Station, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
    ...
    def send_ch_bafu_hydrology_water_level_observation(self,data: WaterLevelObservation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, WaterLevelObservation], str]=None) -> None:
        """

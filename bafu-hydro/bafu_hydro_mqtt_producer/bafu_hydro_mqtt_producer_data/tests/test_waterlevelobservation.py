...
from bafu_hydro_mqtt_producer_data.waterlevelobservation import WaterLevelObservation
import datetime
...
class Test_WaterLevelObservation(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = WaterLevelObservation(
            station_id='tbsgypxhjczaawkgwsxt',
            water_body_name='kchhoaksplroatqrfktt',
            water_level=float(41.59434535852867),
            water_level_unit='oslmvvwxdhcwvcpnsqsu',
            water_level_timestamp=datetime.datetime.now(datetime.timezone.utc),
            discharge=float(9.2059900111914),
            discharge_unit='dgafjreskiilxcdodzam',
            discharge_timestamp=datetime.datetime.now(datetime.timezone.utc),
            water_temperature=float(4.276288605635015),
            water_temperature_unit='zlzmjvsobwdwuzthudxp',
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'tbsgypxhjczaawkgwsxt'
    ...
    def test_water_body_name_property(self):
        ...
        """
        test_value = 'kchhoaksplroatqrfktt'
    ...
    def test_water_level_property(self):
        ...
        """
        test_value = float(41.59434535852867)
    ...
    def test_water_level_unit_property(self):
        ...
        """
        test_value = 'oslmvvwxdhcwvcpnsqsu'
    ...
    def test_discharge_property(self):
        ...
        """
        test_value = float(9.2059900111914)
    ...
    def test_discharge_unit_property(self):
        ...
        """
        test_value = 'dgafjreskiilxcdodzam'
    ...
    def test_water_temperature_property(self):
        ...
        """
        test_value = float(4.276288605635015)
    ...
    def test_water_temperature_unit_property(self):
        ...
        """
        test_value = 'zlzmjvsobwdwuzthudxp'

...
# Irceline_belgium_producer Kafka Producer# Irceline_belgium_producer Event Dispatcher for Apache Kafka
...
- BeIrcelineStationsProducersolution for event-driven applications.
...
- **Scales horizontally** across multiple brokers and partitions### BeIrcelineStationsEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`BeIrcelineStationsEventDispatcher` handles events for the be.irceline.Stations message group.
...
The BeIrcelineStationsEventDispatcher defines the following event handler hooks.
...
producer = BeIrcelineStationsProducer(
    ...
    security_protocol='SASL_SSL',##### `be_irceline_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'be_irceline_station_async:  Callable[[ConsumerRecord, CloudEvent, Station],
Awaitable[None]]
...
be_irceline_stations_dispatcher.be_irceline_station_async = be_irceline_station_event
...
be_irceline_timeseries_dispatcher.be_irceline_station_async = be_irceline_station_event
...
##### `send_be_irceline_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_be_irceline_station(
...
await producer.send_be_irceline_station(
...
Send multiple `be.irceline.Station` messages in a batch.
...
await producer.send_be_irceline_station_batch(```
...
- **Scales horizontally** across multiple brokers and partitions### BeIrcelineTimeseriesEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`BeIrcelineTimeseriesEventDispatcher` handles events for the be.irceline.Timeseries message group.
...
The BeIrcelineTimeseriesEventDispatcher defines the following event handler hooks.
...
producer = BeIrcelineStationsProducer(
    ...
    security_protocol='SASL_SSL',##### `be_irceline_timeseries_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'be_irceline_timeseries_async:  Callable[[ConsumerRecord, CloudEvent, Timeseries],
Awaitable[None]]
...
be_irceline_stations_dispatcher.be_irceline_timeseries_async = be_irceline_timeseries_event
...
be_irceline_timeseries_dispatcher.be_irceline_timeseries_async = be_irceline_timeseries_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `be_irceline_observation_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'be_irceline_observation_async:  Callable[[ConsumerRecord, CloudEvent, Observation],
Awaitable[None]]
...
be_irceline_stations_dispatcher.be_irceline_observation_async = be_irceline_observation_event
...
be_irceline_timeseries_dispatcher.be_irceline_observation_async = be_irceline_observation_event
...
##### `send_be_irceline_timeseries`Dispatchers have the following protected methods:



```python### Methods:

async def send_be_irceline_timeseries(
...
await producer.send_be_irceline_timeseries(
...
Send multiple `be.irceline.Timeseries` messages in a batch.
...
await producer.send_be_irceline_timeseries_batch(```
...
##### `send_be_irceline_observation`Dispatchers have the following protected methods:



```python### Methods:

async def send_be_irceline_observation(
...
await producer.send_be_irceline_observation(
...
Send multiple `be.irceline.Observation` messages in a batch.

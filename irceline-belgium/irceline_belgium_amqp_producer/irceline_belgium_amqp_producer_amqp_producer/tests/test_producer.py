...
"""
Tests for irceline_belgium_amqp_producer_amqp_producer
"""
import base64
import json
import os
...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../irceline_belgium_amqp_producer_data/src')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../irceline_belgium_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../irceline_belgium_amqp_producer_amqp_producer/src')))

from irceline_belgium_amqp_producer_amqp_producer import *
from irceline_belgium_amqp_producer_data import Station
from test_irceline_belgium_amqp_producer_data_station import Test_Station
from irceline_belgium_amqp_producer_data import Timeseries
from test_irceline_belgium_amqp_producer_data_timeseries import Test_Timeseries
from irceline_belgium_amqp_producer_data import Observation
from test_irceline_belgium_amqp_producer_data_observation import Test_Observation
...
class TestBeIrcelineStationsAmqpProducer:
    """Test cases for BeIrcelineStationsAmqpProducer"""
...
class TestBeIrcelineTimeseriesAmqpProducer:
    """Test cases for BeIrcelineTimeseriesAmqpProducer"""

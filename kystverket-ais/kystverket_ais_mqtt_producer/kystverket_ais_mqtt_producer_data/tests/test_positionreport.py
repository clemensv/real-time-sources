...
class Test_PositionReport(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = PositionReport(
            mmsi='zmweqxvuqvrxdfgsuwfb',
            flag='mmnsqegivcmfkczgldnr',
            ship_type='psxjweckywkmddkxukmf',
            geohash5='pfljpielklruyvwirzph',
            msg_type=MsgTypeenum.position_report,
            latitude=float(61.43895011961693),
            longitude=float(0.7701191180473299),
            speed_over_ground=float(84.50511904972227),
            course_over_ground=float(15.071170676173617),
            true_heading=int(38),
            navigation_status=int(79),
            rate_of_turn=float(62.24551866264343),
            position_accuracy=int(55),
            timestamp='mjdiqfpbknbvlyprjlao',
            station_id='onfpzqqijqipeqdgsvbu',
            ais_msg_type=int(17)
        )
        return instance
    ...
    def test_mmsi_property(self):
        ...
        Test mmsi property
        """
        test_value = 'zmweqxvuqvrxdfgsuwfb'
    ...
    def test_flag_property(self):
        ...
        Test flag property
        """
        test_value = 'mmnsqegivcmfkczgldnr'
    ...
    def test_ship_type_property(self):
        ...
        """
        test_value = 'psxjweckywkmddkxukmf'
    ...
    def test_geohash5_property(self):
        ...
        """
        test_value = 'pfljpielklruyvwirzph'
    ...
    def test_latitude_property(self):
        ...
        """
        test_value = float(61.43895011961693)
    ...
    def test_longitude_property(self):
        ...
        """
        test_value = float(0.7701191180473299)
    ...
    def test_speed_over_ground_property(self):
        ...
        """
        test_value = float(84.50511904972227)
    ...
    def test_course_over_ground_property(self):
        ...
        """
        test_value = float(15.071170676173617)
    ...
    def test_rate_of_turn_property(self):
        ...
        """
        test_value = float(62.24551866264343)
    ...
    def test_timestamp_property(self):
        ...
        """
        test_value = 'mjdiqfpbknbvlyprjlao'
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'onfpzqqijqipeqdgsvbu'

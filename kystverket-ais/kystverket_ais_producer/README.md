...
- **Scales horizontally** across multiple brokers and partitions### NOKystverketAISEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`NOKystverketAISEventDispatcher` handles events for the NO.Kystverket.AIS message group.
...
The NOKystverketAISEventDispatcher defines the following event handler hooks.
...
producer = NOKystverketAISProducer(
    ...
    security_protocol='SASL_SSL',##### `no_kystverket_ais_position_report_class_a_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'no_kystverket_ais_position_report_class_a_async:  Callable[[ConsumerRecord, CloudEvent,
PositionReportClassA], Awaitable[None]]
...
no_kystverket_ais_dispatcher.no_kystverket_ais_position_report_class_a_async =
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `no_kystverket_ais_static_voyage_data_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'no_kystverket_ais_static_voyage_data_async:  Callable[[ConsumerRecord, CloudEvent,
StaticVoyageData], Awaitable[None]]
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `no_kystverket_ais_position_report_class_b_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'no_kystverket_ais_position_report_class_b_async:  Callable[[ConsumerRecord, CloudEvent,
PositionReportClassB], Awaitable[None]]
...
no_kystverket_ais_dispatcher.no_kystverket_ais_position_report_class_b_async =
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `no_kystverket_ais_static_data_class_b_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'no_kystverket_ais_static_data_class_b_async:  Callable[[ConsumerRecord, CloudEvent,
StaticDataClassB], Awaitable[None]]
...
no_kystverket_ais_dispatcher.no_kystverket_ais_static_data_class_b_async = no_kystverket_ais_static_data_class_b_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `no_kystverket_ais_aid_to_navigation_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'no_kystverket_ais_aid_to_navigation_async:  Callable[[ConsumerRecord, CloudEvent,
...
##### `send_no_kystverket_ais_position_report_class_a`Dispatchers have the following protected methods:



```python### Methods:

async def send_no_kystverket_ais_position_report_class_a(

    self,##### `_process_event`

    data: PositionReportClassA,
...
- `data`: Message data of type `PositionReportClassA`
...
await producer.send_no_kystverket_ais_position_report_class_a(

    data=PositionReportClassA(...),Args:
...
Send multiple `NO.Kystverket.AIS.PositionReportClassA` messages in a batch.
...
await producer.send_no_kystverket_ais_position_report_class_a_batch(```

    messages=[

        PositionReportClassA(...),Initializes the runner with a Kafka consumer.

        PositionReportClassA(...),

        PositionReportClassA(...)Args:
...
##### `send_no_kystverket_ais_static_voyage_data`Dispatchers have the following protected methods:



```python### Methods:

async def send_no_kystverket_ais_static_voyage_data(

    self,##### `_process_event`

    data: StaticVoyageData,
...
- `data`: Message data of type `StaticVoyageData`
...
await producer.send_no_kystverket_ais_static_voyage_data(

    data=StaticVoyageData(...),Args:
...
Send multiple `NO.Kystverket.AIS.StaticVoyageData` messages in a batch.
...
await producer.send_no_kystverket_ais_static_voyage_data_batch(```

    messages=[

        StaticVoyageData(...),Initializes the runner with a Kafka consumer.

        StaticVoyageData(...),

        StaticVoyageData(...)Args:
...
##### `send_no_kystverket_ais_position_report_class_b`Dispatchers have the following protected methods:



```python### Methods:

async def send_no_kystverket_ais_position_report_class_b(

    self,##### `_process_event`

    data: PositionReportClassB,
...
- `data`: Message data of type `PositionReportClassB`
...
await producer.send_no_kystverket_ais_position_report_class_b(

    data=PositionReportClassB(...),Args:
...
Send multiple `NO.Kystverket.AIS.PositionReportClassB` messages in a batch.
...
await producer.send_no_kystverket_ais_position_report_class_b_batch(```

    messages=[

        PositionReportClassB(...),Initializes the runner with a Kafka consumer.

        PositionReportClassB(...),

        PositionReportClassB(...)Args:
...
##### `send_no_kystverket_ais_static_data_class_b`Dispatchers have the following protected methods:



```python### Methods:

async def send_no_kystverket_ais_static_data_class_b(

    self,##### `_process_event`

    data: StaticDataClassB,
...
- `data`: Message data of type `StaticDataClassB`
...
await producer.send_no_kystverket_ais_static_data_class_b(

    data=StaticDataClassB(...),Args:
...
Send multiple `NO.Kystverket.AIS.StaticDataClassB` messages in a batch.
...
await producer.send_no_kystverket_ais_static_data_class_b_batch(```

    messages=[

        StaticDataClassB(...),Initializes the runner with a Kafka consumer.

        StaticDataClassB(...),

        StaticDataClassB(...)Args:
...
##### `send_no_kystverket_ais_aid_to_navigation`Dispatchers have the following protected methods:



```python### Methods:

async def send_no_kystverket_ais_aid_to_navigation(
...
await producer.send_no_kystverket_ais_aid_to_navigation(
...
Send multiple `NO.Kystverket.AIS.AidToNavigation` messages in a batch.

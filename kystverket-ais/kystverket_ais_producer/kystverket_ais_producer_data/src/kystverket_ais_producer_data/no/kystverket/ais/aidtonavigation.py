...
class AidToNavigation:
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"AidToNavigation\", \"namespace\": \"NO.Kystverket.AIS\", \"fields\": [{\"name\": \"mmsi\", \"type\": \"long\"}, {\"name\": \"aid_type\", \"type\": \"long\"}, {\"name\": \"name\", \"type\": \"string\"}, {\"name\": \"position_accuracy\", \"type\": \"long\"}, {\"name\": \"longitude\", \"type\": \"double\"}, {\"name\": \"latitude\", \"type\": \"double\"}, {\"name\": \"timestamp\", \"type\": \"string\"}, {\"name\": \"station_id\", \"type\": \"string\"}]}"), avro.name.Names()
    )

    def __post_init__(self):
        """ Initializes the dataclass with the provided keyword arguments."""
        self.mmsi=int(self.mmsi)
        self.aid_type=int(self.aid_type)

...
- [NO.Kystverket.AIS](#message-group-nokystverketais)
  ...
  - [NO.Kystverket.AIS.PositionReport](#message-nokystverketaispositionreport)
  - [NO.Kystverket.AIS.ShipStatic](#message-nokystverketaisshipstatic)
...
| **Name**    | **Description** | **Type**     | **Required** | **Value** |
|-------------|-----------------|--------------|--------------|-----------|
| `type` |  | `` | `False` | `NO.Kystverket.AIS.PositionReport` |
| `source` |  | `` | `False` | `urn:ais:kystverket:tcp` |
| `subject` |  | `uritemplate` | `False` | `{mmsi}` |
...
| **Name**    | **Description** | **Type**     | **Required** | **Value** |
|-------------|-----------------|--------------|--------------|-----------|
| `type` |  | `` | `False` | `NO.Kystverket.AIS.ShipStatic` |
| `source` |  | `` | `False` | `urn:ais:kystverket:tcp` |
| `subject` |  | `uritemplate` | `False` | `{mmsi}` |

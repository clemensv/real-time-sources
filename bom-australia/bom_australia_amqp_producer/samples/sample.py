...
"""
Sample usage of bom_australia_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send WarningBulletin message
        print("Sending WarningBulletin message...")
        # TODO: Create a WarningBulletin instance with actual data
        # data = WarningBulletin(...)
        # producer.send_warning_bulletin(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("WarningBulletin message sent successfully!")

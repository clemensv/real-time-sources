...
# Bom_australia_producer Kafka Producer# Bom_australia_producer Event Dispatcher for Apache Kafka
...
- AUGovBOMWeatherProducersolution for event-driven applications.
...
- **Scales horizontally** across multiple brokers and partitions### AUGovBOMWeatherEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`AUGovBOMWeatherEventDispatcher` handles events for the AU.Gov.BOM.Weather message group.
...
The AUGovBOMWeatherEventDispatcher defines the following event handler hooks.
...
producer = AUGovBOMWeatherProducer(
    ...
    security_protocol='SASL_SSL',##### `au_gov_bom_weather_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'au_gov_bom_weather_station_async:  Callable[[ConsumerRecord, CloudEvent, Station],
Awaitable[None]]
...
Asynchronous handler hook for `AU.Gov.BOM.Weather.Station`:
...
au_gov_bom_weather_dispatcher.au_gov_bom_weather_station_async = au_gov_bom_weather_station_event
...
au_gov_bom_warning_dispatcher.au_gov_bom_weather_station_async = au_gov_bom_weather_station_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `au_gov_bom_weather_weather_observation_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'au_gov_bom_weather_weather_observation_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `AU.Gov.BOM.Weather.WeatherObservation`:
...
au_gov_bom_weather_dispatcher.au_gov_bom_weather_weather_observation_async =
...
##### `send_au_gov_bom_weather_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_au_gov_bom_weather_station(
...
Send a single `AU.Gov.BOM.Weather.Station` message.Args:
...
await producer.send_au_gov_bom_weather_station(
...
Send multiple `AU.Gov.BOM.Weather.Station` messages in a batch.
...
await producer.send_au_gov_bom_weather_station_batch(```
...
##### `send_au_gov_bom_weather_weather_observation`Dispatchers have the following protected methods:



```python### Methods:

async def send_au_gov_bom_weather_weather_observation(
...
Send a single `AU.Gov.BOM.Weather.WeatherObservation` message.Args:
...
await producer.send_au_gov_bom_weather_weather_observation(
...
Send multiple `AU.Gov.BOM.Weather.WeatherObservation` messages in a batch.
...
await producer.send_au_gov_bom_weather_weather_observation_batch(```
...
- **Scales horizontally** across multiple brokers and partitions### AUGovBOMWarningEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`AUGovBOMWarningEventDispatcher` handles events for the AU.Gov.BOM.Warning message group.
...
The AUGovBOMWarningEventDispatcher defines the following event handler hooks.
...
producer = AUGovBOMWeatherProducer(
    ...
    security_protocol='SASL_SSL',##### `au_gov_bom_warning_warning_bulletin_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'au_gov_bom_warning_warning_bulletin_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `AU.Gov.BOM.Warning.WarningBulletin`:
...
au_gov_bom_weather_dispatcher.au_gov_bom_warning_warning_bulletin_async = au_gov_bom_warning_warning_bulletin_event
...
au_gov_bom_warning_dispatcher.au_gov_bom_warning_warning_bulletin_async = au_gov_bom_warning_warning_bulletin_event
...
##### `send_au_gov_bom_warning_warning_bulletin`Dispatchers have the following protected methods:



```python### Methods:

async def send_au_gov_bom_warning_warning_bulletin(
...
Send a single `AU.Gov.BOM.Warning.WarningBulletin` message.Args:
...
await producer.send_au_gov_bom_warning_warning_bulletin(
...
Send multiple `AU.Gov.BOM.Warning.WarningBulletin` messages in a batch.

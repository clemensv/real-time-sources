...
class Site:
    """
    Reference record for an AirQo air quality monitoring site, describing its human-readable name, geocoded address, GPS coordinates, administrative area, and current online status. Sourced from the AirQo grids summary API.
    ...
    formatted_name: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="formatted_name"))

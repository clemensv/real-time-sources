...
class Measurement:
    """
    Near-real-time air quality measurement from an AirQo low-cost sensor deployed in the AirQo network. Includes raw and calibrated PM2.5 and PM10 concentrations, ambient temperature, humidity, and device location. Measurements are typically published at hourly intervals.
    ...
    Attributes:
        ...
        pm2_5_raw (typing.Optional[float])
        pm2_5_calibrated (typing.Optional[float])
        pm10_raw (typing.Optional[float])
        pm10_calibrated (typing.Optional[float])
    ...
    device: str=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="device"))
    device_id: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="device_id"))
    ...
    pm2_5_raw: typing.Optional[float]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="pm2_5_raw"))
    pm2_5_calibrated: typing.Optional[float]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="pm2_5_calibrated"))
    pm10_raw: typing.Optional[float]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="pm10_raw"))
    pm10_calibrated: typing.Optional[float]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="pm10_calibrated"))
    ...
    frequency: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="frequency"))

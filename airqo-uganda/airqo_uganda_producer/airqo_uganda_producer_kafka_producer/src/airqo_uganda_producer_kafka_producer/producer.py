...
class NetAirqoUgandaEventProducer:
    ...
    def send_net_airqo_uganda_site(self,_site_id : str, data: Site, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Site], str]=None) -> None:
        """
        Sends the 'net.airqo.uganda.Site' event to the Kafka topic
        ...
        attributes = {
             "type":"net.airqo.uganda.Site",
             "source":"https://api.airqo.net",
    ...
    def send_net_airqo_uganda_measurement(self,_site_id : str, data: Measurement, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Measurement], str]=None) -> None:
        """
        Sends the 'net.airqo.uganda.Measurement' event to the Kafka topic
        ...
        kafka_key = "{site_id}".format(site_id=_site_id)
        attributes = {
             "type":"net.airqo.uganda.Measurement",
             "source":"https://api.airqo.net",
             "subject":"{site_id}".format(site_id = _site_id)
        }
        attributes["datacontenttype"] = content_type
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'NetAirqoUgandaEventProducer':
        """

...
"""
Sample usage of inpe_deter_brazil_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send DeforestationAlert message
        print("Sending DeforestationAlert message...")
        # TODO: Create a DeforestationAlert instance with actual data
        # data = DeforestationAlert(...)
        # producer.send_deforestation_alert(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("DeforestationAlert message sent successfully!")

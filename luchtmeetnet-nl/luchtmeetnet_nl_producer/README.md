...
# Luchtmeetnet_nl_producer Kafka Producer# Luchtmeetnet_nl_producer Event Dispatcher for Apache Kafka
...
- NlRivmLuchtmeetnetProducersolution for event-driven applications.
...
- **Scales horizontally** across multiple brokers and partitions### NlRivmLuchtmeetnetEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`NlRivmLuchtmeetnetEventDispatcher` handles events for the nl.rivm.luchtmeetnet message group.
...
The NlRivmLuchtmeetnetEventDispatcher defines the following event handler hooks.
...
producer = NlRivmLuchtmeetnetProducer(
    ...
    security_protocol='SASL_SSL',##### `nl_rivm_luchtmeetnet_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'nl_rivm_luchtmeetnet_station_async:  Callable[[ConsumerRecord, CloudEvent, Station],
Awaitable[None]]
...
Asynchronous handler hook for `nl.rivm.luchtmeetnet.Station`: Luchtmeetnet station metadata with location, operator,
coordinates, and the formulas measured at the station.
...
nl_rivm_luchtmeetnet_dispatcher.nl_rivm_luchtmeetnet_station_async = nl_rivm_luchtmeetnet_station_event
...
nl_rivm_luchtmeetnet_components_dispatcher.nl_rivm_luchtmeetnet_station_async = nl_rivm_luchtmeetnet_station_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `nl_rivm_luchtmeetnet_measurement_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'nl_rivm_luchtmeetnet_measurement_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `nl.rivm.luchtmeetnet.Measurement`: Hourly Luchtmeetnet measurement for a station and
component formula.
...
nl_rivm_luchtmeetnet_dispatcher.nl_rivm_luchtmeetnet_measurement_async = nl_rivm_luchtmeetnet_measurement_event
...
nl_rivm_luchtmeetnet_components_dispatcher.nl_rivm_luchtmeetnet_measurement_async =
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `nl_rivm_luchtmeetnet_lki_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'nl_rivm_luchtmeetnet_lki_async:  Callable[[ConsumerRecord, CloudEvent, LKI],
Awaitable[None]]
...
Asynchronous handler hook for `nl.rivm.luchtmeetnet.LKI`: Hourly Dutch Luchtkwaliteitsindex value for a station.
...
nl_rivm_luchtmeetnet_dispatcher.nl_rivm_luchtmeetnet_lki_async = nl_rivm_luchtmeetnet_lki_event
...
##### `send_nl_rivm_luchtmeetnet_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_nl_rivm_luchtmeetnet_station(
...
Send a single `nl.rivm.luchtmeetnet.Station` message. Luchtmeetnet station metadata with location, operator,
...
await producer.send_nl_rivm_luchtmeetnet_station(
...
Send multiple `nl.rivm.luchtmeetnet.Station` messages in a batch.
...
await producer.send_nl_rivm_luchtmeetnet_station_batch(```
...
##### `send_nl_rivm_luchtmeetnet_measurement`Dispatchers have the following protected methods:



```python### Methods:

async def send_nl_rivm_luchtmeetnet_measurement(
...
Send a single `nl.rivm.luchtmeetnet.Measurement` message. Hourly Luchtmeetnet measurement for a station and component
formula.Args:
...
await producer.send_nl_rivm_luchtmeetnet_measurement(
...
Send multiple `nl.rivm.luchtmeetnet.Measurement` messages in a batch.
...
await producer.send_nl_rivm_luchtmeetnet_measurement_batch(```
...
##### `send_nl_rivm_luchtmeetnet_lki`Dispatchers have the following protected methods:



```python### Methods:

async def send_nl_rivm_luchtmeetnet_lki(
...
Send a single `nl.rivm.luchtmeetnet.LKI` message. Hourly Dutch Luchtkwaliteitsindex value for a station.Args:
...
await producer.send_nl_rivm_luchtmeetnet_lki(
...
Send multiple `nl.rivm.luchtmeetnet.LKI` messages in a batch.
...
await producer.send_nl_rivm_luchtmeetnet_lki_batch(```
...
- **Scales horizontally** across multiple brokers and partitions### NlRivmLuchtmeetnetComponentsEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`NlRivmLuchtmeetnetComponentsEventDispatcher` handles events for the nl.rivm.luchtmeetnet.components message group.
...
The NlRivmLuchtmeetnetComponentsEventDispatcher defines the following event handler hooks.
...
producer = NlRivmLuchtmeetnetProducer(
    ...
    security_protocol='SASL_SSL',##### `nl_rivm_luchtmeetnet_components_component_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'nl_rivm_luchtmeetnet_components_component_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `nl.rivm.luchtmeetnet.components.Component`: Reference definition for a monitored
...
nl_rivm_luchtmeetnet_dispatcher.nl_rivm_luchtmeetnet_components_component_async =
...
nl_rivm_luchtmeetnet_components_dispatcher.nl_rivm_luchtmeetnet_components_component_async =
nl_rivm_luchtmeetnet_components_component_event
...
##### `send_nl_rivm_luchtmeetnet_components_component`Dispatchers have the following protected methods:



```python### Methods:

async def send_nl_rivm_luchtmeetnet_components_component(
...
Send a single `nl.rivm.luchtmeetnet.components.Component` message. Reference definition for a monitored component
...
await producer.send_nl_rivm_luchtmeetnet_components_component(
...
Send multiple `nl.rivm.luchtmeetnet.components.Component` messages in a batch.

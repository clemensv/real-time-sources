...
class Measurement:
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"Measurement\", \"namespace\": \"nl.rivm.luchtmeetnet\", \"doc\": \"Hourly Luchtmeetnet measurement for a station and a single component formula.\", \"fields\": [{\"name\": \"station_number\", \"type\": \"string\", \"doc\": \"Stable Luchtmeetnet station code identifying where the measurement was taken.\"}, {\"name\": \"formula\", \"type\": \"string\", \"doc\": \"Component formula code identifying what was measured, for example NO2, O3, PM10, or FN.\"}, {\"name\": \"value\", \"type\": \"double\", \"doc\": \"Numeric measurement value published by the API for the station and formula at the given timestamp.\"}, {\"name\": \"timestamp_measured\", \"type\": \"string\", \"doc\": \"Timestamp at which the value was measured, encoded as an ISO 8601 date-time string with timezone offset.\"}]}"), avro.name.Names()
    )

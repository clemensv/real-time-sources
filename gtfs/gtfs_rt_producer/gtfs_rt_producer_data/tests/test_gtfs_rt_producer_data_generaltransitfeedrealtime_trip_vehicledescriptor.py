...
class Test_VehicleDescriptor(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = VehicleDescriptor(
            id='wyjfrunbvoajxbyazwdm',
            label='hylqisrdtaosaxlxxrbd',
            license_plate='cckslqwlmkhrdeywtnil'
        )
        return instance
    ...
    def test_id_property(self):
        ...
        Test id property
        """
        test_value = 'wyjfrunbvoajxbyazwdm'
    ...
    def test_label_property(self):
        ...
        Test label property
        """
        test_value = 'hylqisrdtaosaxlxxrbd'
    ...
    def test_license_plate_property(self):
        ...
        """
        test_value = 'cckslqwlmkhrdeywtnil'

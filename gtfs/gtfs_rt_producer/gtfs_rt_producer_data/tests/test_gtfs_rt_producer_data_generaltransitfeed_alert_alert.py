...
from test_gtfs_rt_producer_data_generaltransitfeed_alert_alert_types_cause import Test_Cause
from test_gtfs_rt_producer_data_generaltransitfeed_alert_translatedstring import Test_TranslatedString
from test_gtfs_rt_producer_data_generaltransitfeed_alert_entityselector import Test_EntitySelector
from test_gtfs_rt_producer_data_generaltransitfeed_alert_alert_types_effect import Test_Effect
from test_gtfs_rt_producer_data_generaltransitfeed_alert_timerange import Test_TimeRange
...
class Test_Alert(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Alert(
            active_period=[Test_TimeRange.create_instance(), Test_TimeRange.create_instance(), Test_TimeRange.create_instance(), Test_TimeRange.create_instance()],
            informed_entity=[Test_EntitySelector.create_instance(), Test_EntitySelector.create_instance(), Test_EntitySelector.create_instance(), Test_EntitySelector.create_instance(), Test_EntitySelector.create_instance()],
    ...
    def test_active_period_property(self):
        ...
        """
        test_value = [Test_TimeRange.create_instance(), Test_TimeRange.create_instance(), Test_TimeRange.create_instance(), Test_TimeRange.create_instance()]
    ...
    def test_informed_entity_property(self):
        ...
        """
        test_value = [Test_EntitySelector.create_instance(), Test_EntitySelector.create_instance(), Test_EntitySelector.create_instance(), Test_EntitySelector.create_instance(), Test_EntitySelector.create_instance()]

...
from gtfs_rt_producer_data.generaltransitfeedrealtime.translatedstring_types.translation import Translation
...
class Test_Translation(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Translation(
            text='eftkbnbmkadcxeugliyy',
            language='cvtohipyddnklzhbuaie'
        )
        return instance
    ...
    def test_text_property(self):
        ...
        Test text property
        """
        test_value = 'eftkbnbmkadcxeugliyy'
    ...
    def test_language_property(self):
        ...
        """
        test_value = 'cvtohipyddnklzhbuaie'

...
from test_gtfs_rt_producer_data_generaltransitfeed_alert_tripdescriptor import Test_TripDescriptor
...
class Test_EntitySelector(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = EntitySelector(
            agency_id='ssdnlhzpqtprzyllncsg',
            route_id='ongxbtitefrktbscshmo',
            route_type=int(100),
            trip=Test_TripDescriptor.create_instance(),
            stop_id='udgwxmlgyopdgnlcdlfa'
        )
        return instance
    ...
    def test_agency_id_property(self):
        ...
        """
        test_value = 'ssdnlhzpqtprzyllncsg'
    ...
    def test_route_id_property(self):
        ...
        """
        test_value = 'ongxbtitefrktbscshmo'
    ...
    def test_stop_id_property(self):
        ...
        """
        test_value = 'udgwxmlgyopdgnlcdlfa'

...
class Test_LocationGeoJson(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = LocationGeoJson(
            locationGeoJsonId='wextpdtuaislgujmvqqp',
            locationGeoJsonType='axeuundtcqgryruwcphm',
            locationGeoJsonData='uxlrxghdlqxqrsauussx'
        )
        return instance
    ...
    def test_locationGeoJsonId_property(self):
        ...
        """
        test_value = 'wextpdtuaislgujmvqqp'
    ...
    def test_locationGeoJsonType_property(self):
        ...
        """
        test_value = 'axeuundtcqgryruwcphm'
    ...
    def test_locationGeoJsonData_property(self):
        ...
        """
        test_value = 'uxlrxghdlqxqrsauussx'

...
class Test_BookingRules(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = BookingRules(
            bookingRuleId='vppjrwdninbaeqpeafpp',
            bookingRuleName='bquzgtwwlamkqduobcki',
            bookingRuleDesc='jjlmibeuaekqpolknxnb',
            bookingRuleUrl='eqfxhyueqdvtwusoktic'
        )
        return instance
    ...
    def test_bookingRuleId_property(self):
        ...
        """
        test_value = 'vppjrwdninbaeqpeafpp'
    ...
    def test_bookingRuleName_property(self):
        ...
        """
        test_value = 'bquzgtwwlamkqduobcki'
    ...
    def test_bookingRuleDesc_property(self):
        ...
        """
        test_value = 'jjlmibeuaekqpolknxnb'
    ...
    def test_bookingRuleUrl_property(self):
        ...
        """
        test_value = 'eqfxhyueqdvtwusoktic'

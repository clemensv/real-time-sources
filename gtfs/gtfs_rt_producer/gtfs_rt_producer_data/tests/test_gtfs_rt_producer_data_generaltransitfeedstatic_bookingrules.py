...
class Test_BookingRules(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = BookingRules(
            bookingRuleId='anuyakcaulrdsukavjnl',
            bookingRuleName='wmfabanrfqonobpohhxg',
            bookingRuleDesc='daixuoxazaubuyvsgzpf',
            bookingRuleUrl='nrblfonkbxxykozkwvsw'
        )
        return instance
    ...
    def test_bookingRuleId_property(self):
        ...
        """
        test_value = 'anuyakcaulrdsukavjnl'
    ...
    def test_bookingRuleName_property(self):
        ...
        """
        test_value = 'wmfabanrfqonobpohhxg'
    ...
    def test_bookingRuleDesc_property(self):
        ...
        """
        test_value = 'daixuoxazaubuyvsgzpf'
    ...
    def test_bookingRuleUrl_property(self):
        ...
        """
        test_value = 'nrblfonkbxxykozkwvsw'

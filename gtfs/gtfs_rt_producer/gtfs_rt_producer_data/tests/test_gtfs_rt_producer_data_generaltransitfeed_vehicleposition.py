...
from gtfs_rt_producer_data.generaltransitfeed.vehicleposition import VehiclePosition
from test_gtfs_rt_producer_data_generaltransitfeed_position import Test_Position
from test_gtfs_rt_producer_data_generaltransitfeed_tripdescriptor import Test_TripDescriptor
from test_gtfs_rt_producer_data_generaltransitfeed_vehicledescriptor import Test_VehicleDescriptor
from test_gtfs_rt_producer_data_generaltransitfeed_vehicleposition_types_vehiclestopstatus import Test_VehicleStopStatus
from test_gtfs_rt_producer_data_generaltransitfeed_vehicleposition_types_occupancystatus import Test_OccupancyStatus
from test_gtfs_rt_producer_data_generaltransitfeed_vehicleposition_types_congestionlevel import Test_CongestionLevel
...
class Test_VehiclePosition(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = VehiclePosition(
            ...
            current_stop_sequence=int(41),
            stop_id='efbqimqogiyyyqppwilz',
    ...
    def test_stop_id_property(self):
        ...
        """
        test_value = 'efbqimqogiyyyqppwilz'

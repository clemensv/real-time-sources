...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='owoepuqnqchanftrsivy',
            stopId='rlzzcxehpzwhktozsoha',
            areaId='fmnqjgzjdupegxkyhwha'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'owoepuqnqchanftrsivy'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'rlzzcxehpzwhktozsoha'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'fmnqjgzjdupegxkyhwha'

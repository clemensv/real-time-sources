...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='jwjharfhadxrocoqisbj',
            stopId='myepywoxpuckzzkucltk',
            areaId='vcbxnbkjxnrdbdpelyfm'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'jwjharfhadxrocoqisbj'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'myepywoxpuckzzkucltk'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'vcbxnbkjxnrdbdpelyfm'

...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='mfdycfcpckvirkktpjzk',
            stopId='fzrqhzupmmkyeedomzye',
            areaId='jzxcjlkpnvsvbhbvpdfc'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'mfdycfcpckvirkktpjzk'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'fzrqhzupmmkyeedomzye'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'jzxcjlkpnvsvbhbvpdfc'

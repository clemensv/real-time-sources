...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='icfrmlkkvtokttivyuxa',
            stopId='ahhuzclbyiccqwtyhggp',
            areaId='twzvszmorhwnnqveeiwi'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'icfrmlkkvtokttivyuxa'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'ahhuzclbyiccqwtyhggp'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'twzvszmorhwnnqveeiwi'

...
from gtfs_rt_producer_data.generaltransitfeed.tripupdate_types.stoptimeupdate import StopTimeUpdate
from test_gtfs_rt_producer_data_generaltransitfeed_tripupdate_types_stoptimeevent import Test_StopTimeEvent
from test_gtfs_rt_producer_data_generaltransitfeed_tripupdate_types_stoptimeupdate_types_schedulerelationship import Test_ScheduleRelationship
...
class Test_StopTimeUpdate(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = StopTimeUpdate(
            stop_sequence=int(16),
            stop_id='puyfjlvhbskpozbajypv',
    ...
    def test_stop_id_property(self):
        ...
        """
        test_value = 'puyfjlvhbskpozbajypv'

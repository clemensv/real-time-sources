...
class Test_Alert(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Alert(
            active_period=[Test_TimeRange.create_instance(), Test_TimeRange.create_instance(), Test_TimeRange.create_instance()],
    ...
    def test_active_period_property(self):
        ...
        """
        test_value = [Test_TimeRange.create_instance(), Test_TimeRange.create_instance(), Test_TimeRange.create_instance()]

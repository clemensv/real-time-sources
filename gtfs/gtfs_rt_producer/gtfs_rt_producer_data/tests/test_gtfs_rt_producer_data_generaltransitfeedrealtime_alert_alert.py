...
class Test_Alert(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Alert(
            ...
            informed_entity=[Test_EntitySelector.create_instance(), Test_EntitySelector.create_instance(), Test_EntitySelector.create_instance()],
    ...
    def test_informed_entity_property(self):
        ...
        """
        test_value = [Test_EntitySelector.create_instance(), Test_EntitySelector.create_instance(), Test_EntitySelector.create_instance()]

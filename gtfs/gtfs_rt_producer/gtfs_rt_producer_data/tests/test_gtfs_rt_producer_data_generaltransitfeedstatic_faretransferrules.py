...
class Test_FareTransferRules(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = FareTransferRules(
            fareTransferRuleId='earpeeklmiuzcrvmsfgi',
            fareProductId='oijqisrdzfmwgcgcnaox',
            transferCount=int(62),
            fromLegGroupId='hxtxlsvjyrjfzshbqrhz',
            toLegGroupId='exemykuzbcmetwltevtr',
            duration=int(39),
            durationType='zsgthumyfjwdyouwblhz'
        )
        return instance
    ...
    def test_fareTransferRuleId_property(self):
        ...
        """
        test_value = 'earpeeklmiuzcrvmsfgi'
    ...
    def test_fareProductId_property(self):
        ...
        """
        test_value = 'oijqisrdzfmwgcgcnaox'
    ...
    def test_fromLegGroupId_property(self):
        ...
        """
        test_value = 'hxtxlsvjyrjfzshbqrhz'
    ...
    def test_toLegGroupId_property(self):
        ...
        """
        test_value = 'exemykuzbcmetwltevtr'
    ...
    def test_durationType_property(self):
        ...
        """
        test_value = 'zsgthumyfjwdyouwblhz'

...
class Test_FareTransferRules(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = FareTransferRules(
            fareTransferRuleId='acraangirxanjstuakko',
            fareProductId='utdjfokhprirzxajughq',
            transferCount=int(85),
            fromLegGroupId='sgyztuyoahqubigoazde',
            toLegGroupId='dhvsxwcvdphvsvevkwvx',
            duration=int(1),
            durationType='uhdzvrtrzmvrtsrbcpqy'
        )
        return instance
    ...
    def test_fareTransferRuleId_property(self):
        ...
        """
        test_value = 'acraangirxanjstuakko'
    ...
    def test_fareProductId_property(self):
        ...
        """
        test_value = 'utdjfokhprirzxajughq'
    ...
    def test_fromLegGroupId_property(self):
        ...
        """
        test_value = 'sgyztuyoahqubigoazde'
    ...
    def test_toLegGroupId_property(self):
        ...
        """
        test_value = 'dhvsxwcvdphvsvevkwvx'
    ...
    def test_durationType_property(self):
        ...
        """
        test_value = 'uhdzvrtrzmvrtsrbcpqy'

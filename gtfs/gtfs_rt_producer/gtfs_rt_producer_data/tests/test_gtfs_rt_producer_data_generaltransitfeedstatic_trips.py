...
class Test_Trips(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Trips(
            routeId='nzkrtfcdzvptbnvkbnyf',
            serviceDates=Test_Calendar.create_instance(),
            serviceExceptions=[Test_CalendarDates.create_instance()],
            tripId='pfdqthdswfdogjhzrpzc',
            tripHeadsign='vjpxxagskhgylrggmujr',
            tripShortName='xqvqqysflqggqdfnszhl',
            directionId=Test_DirectionId.create_instance(),
            blockId='chutvdzckuywrxkgkqgb',
            shapeId='cfyegiatrvgjamgjpuoz',
    ...
    def test_routeId_property(self):
        ...
        """
        test_value = 'nzkrtfcdzvptbnvkbnyf'
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'pfdqthdswfdogjhzrpzc'
    ...
    def test_tripHeadsign_property(self):
        ...
        """
        test_value = 'vjpxxagskhgylrggmujr'
    ...
    def test_tripShortName_property(self):
        ...
        """
        test_value = 'xqvqqysflqggqdfnszhl'
    ...
    def test_blockId_property(self):
        ...
        """
        test_value = 'chutvdzckuywrxkgkqgb'
    ...
    def test_shapeId_property(self):
        ...
        """
        test_value = 'cfyegiatrvgjamgjpuoz'

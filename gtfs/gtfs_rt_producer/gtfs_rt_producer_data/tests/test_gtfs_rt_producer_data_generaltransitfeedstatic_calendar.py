...
class Test_Calendar(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Calendar(
            serviceId='mvondncvhbrzsiwwyusg',
            ...
            startDate='ucfhinlhykbonylxkmmg',
            endDate='dqnzmhyopanpffzbfhmn'
        )
        return instance
    ...
    def test_serviceId_property(self):
        ...
        """
        test_value = 'mvondncvhbrzsiwwyusg'
    ...
    def test_startDate_property(self):
        ...
        """
        test_value = 'ucfhinlhykbonylxkmmg'
    ...
    def test_endDate_property(self):
        ...
        """
        test_value = 'dqnzmhyopanpffzbfhmn'

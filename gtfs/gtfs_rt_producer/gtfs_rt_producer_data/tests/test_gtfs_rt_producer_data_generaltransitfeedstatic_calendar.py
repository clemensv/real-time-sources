...
class Test_Calendar(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Calendar(
            serviceId='sacajznfpvihwtswtfeh',
            ...
            startDate='qpeagxmngflogzdbhtfy',
            endDate='bfdzegnpokfjllnnzpyn'
        )
        return instance
    ...
    def test_serviceId_property(self):
        ...
        """
        test_value = 'sacajznfpvihwtswtfeh'
    ...
    def test_startDate_property(self):
        ...
        """
        test_value = 'qpeagxmngflogzdbhtfy'
    ...
    def test_endDate_property(self):
        ...
        """
        test_value = 'bfdzegnpokfjllnnzpyn'

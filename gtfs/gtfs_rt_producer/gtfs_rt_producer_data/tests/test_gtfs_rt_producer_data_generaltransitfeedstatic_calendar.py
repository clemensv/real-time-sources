...
class Test_Calendar(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Calendar(
            serviceId='hcjvwabziasynylfizrf',
            ...
            startDate='aujyajwhjtxesowcjazu',
            endDate='plqczkzcbzvtkuimnubf'
        )
        return instance
    ...
    def test_serviceId_property(self):
        ...
        """
        test_value = 'hcjvwabziasynylfizrf'
    ...
    def test_startDate_property(self):
        ...
        """
        test_value = 'aujyajwhjtxesowcjazu'
    ...
    def test_endDate_property(self):
        ...
        """
        test_value = 'plqczkzcbzvtkuimnubf'

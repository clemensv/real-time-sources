...
class Test_Frequencies(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Frequencies(
            tripId='jykjpjsxdccsddsvnxid',
            startTime='rgazwduzdivffnxbepab',
            endTime='mkqtgyzohogalqeejkii',
            headwaySecs=int(80),
            exactTimes=int(63)
        )
        return instance
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'jykjpjsxdccsddsvnxid'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'rgazwduzdivffnxbepab'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'mkqtgyzohogalqeejkii'

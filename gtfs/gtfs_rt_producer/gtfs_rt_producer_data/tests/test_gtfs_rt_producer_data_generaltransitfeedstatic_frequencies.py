...
class Test_Frequencies(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Frequencies(
            tripId='cgnbghyixzgmzwxvofga',
            startTime='qyrpjhpxygpvrtdoomlk',
            endTime='tloyukavypanmrnbiwmb',
            headwaySecs=int(27),
            exactTimes=int(86)
        )
        return instance
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'cgnbghyixzgmzwxvofga'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'qyrpjhpxygpvrtdoomlk'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'tloyukavypanmrnbiwmb'

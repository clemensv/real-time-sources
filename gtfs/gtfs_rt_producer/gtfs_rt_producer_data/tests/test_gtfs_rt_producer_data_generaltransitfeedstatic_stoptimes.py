...
class Test_StopTimes(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopTimes(
            tripId='olokpmxltuqmgnorypol',
            arrivalTime='bzabjotolsaehqsgrisf',
            departureTime='ryidcdvcpxlltqpmxfex',
            stopId='zvcqtwohjbwbvymmbdxs',
            stopSequence=int(4),
            stopHeadsign='wtvnpnxewzrmjiphmirg',
            ...
            shapeDistTraveled=float(89.36932786763916),
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'olokpmxltuqmgnorypol'
    ...
    def test_arrivalTime_property(self):
        ...
        """
        test_value = 'bzabjotolsaehqsgrisf'
    ...
    def test_departureTime_property(self):
        ...
        """
        test_value = 'ryidcdvcpxlltqpmxfex'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'zvcqtwohjbwbvymmbdxs'
    ...
    def test_stopHeadsign_property(self):
        ...
        """
        test_value = 'wtvnpnxewzrmjiphmirg'
    ...
    def test_shapeDistTraveled_property(self):
        ...
        """
        test_value = float(89.36932786763916)

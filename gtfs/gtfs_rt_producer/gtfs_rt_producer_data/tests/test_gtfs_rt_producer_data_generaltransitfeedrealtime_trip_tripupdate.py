...
class Test_TripUpdate(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = TripUpdate(
            ...
            stop_time_update=[Test_StopTimeUpdate.create_instance(), Test_StopTimeUpdate.create_instance(), Test_StopTimeUpdate.create_instance()],
            timestamp=int(13),
            delay=int(35)
        )
        return instance
    ...
    def test_stop_time_update_property(self):
        ...
        """
        test_value = [Test_StopTimeUpdate.create_instance(), Test_StopTimeUpdate.create_instance(), Test_StopTimeUpdate.create_instance()]

...
from gtfs_rt_producer_data.generaltransitfeed.tripdescriptor import TripDescriptor
from test_gtfs_rt_producer_data_generaltransitfeed_tripdescriptor_types_schedulerelationship import Test_ScheduleRelationship
...
class Test_TripDescriptor(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = TripDescriptor(
            trip_id='acjncyojyjzztehmrpwn',
            route_id='kydfsdvsvsjczqopsbam',
            direction_id=int(85),
            start_time='gxuuytfimoiegtqnduoq',
            start_date='thvsxozcitaeoahwkoro',
    ...
    def test_trip_id_property(self):
        ...
        """
        test_value = 'acjncyojyjzztehmrpwn'
    ...
    def test_route_id_property(self):
        ...
        """
        test_value = 'kydfsdvsvsjczqopsbam'
    ...
    def test_start_time_property(self):
        ...
        """
        test_value = 'gxuuytfimoiegtqnduoq'
    ...
    def test_start_date_property(self):
        ...
        """
        test_value = 'thvsxozcitaeoahwkoro'

...
class Translation:
    ...
    Attributes:
        text (str): A UTF-8 string containing the message.
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'Translation':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['Translation']:
        """
        ...
        if base_content_type in ['avro/binary', 'application/vnd.apache.avro+avro', 'avro/json', 'application/vnd.apache.avro+json']:
            ...
            return Translation.from_serializer_dict(_record)
        if base_content_type == 'application/json':

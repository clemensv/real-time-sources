...
class Test_Calendar(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Calendar(
            serviceId='phjawljlkzjuunolbzrv',
            monday=None,
            tuesday=None,
            wednesday=None,
            thursday=None,
            ...
            saturday=None,
            sunday=None,
            startDate='livucefulggbdxopmjdk',
            endDate='pzjwvxxpcbgceqxekemh'
        )
        return instance
    ...
    def test_serviceId_property(self):
        ...
        """
        test_value = 'phjawljlkzjuunolbzrv'
    ...
    def test_startDate_property(self):
        ...
        """
        test_value = 'livucefulggbdxopmjdk'
    ...
    def test_endDate_property(self):
        ...
        """
        test_value = 'pzjwvxxpcbgceqxekemh'

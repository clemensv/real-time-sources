...
class Test_LocationGroupStores(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = LocationGroupStores(
            locationGroupStoreId='ufvqmucfuuhrkuafctgj',
            locationGroupId='eetzqagpgcwpvjntuzju',
            storeId='rlswvtdcromknsxoibkk'
        )
        return instance
    ...
    def test_locationGroupStoreId_property(self):
        ...
        """
        test_value = 'ufvqmucfuuhrkuafctgj'
    ...
    def test_locationGroupId_property(self):
        ...
        """
        test_value = 'eetzqagpgcwpvjntuzju'
    ...
    def test_storeId_property(self):
        ...
        """
        test_value = 'rlswvtdcromknsxoibkk'

...
class Test_Trips(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Trips(
            routeId='kplysbvpdpzvjdatmhtx',
            serviceDates=None,
            serviceExceptions=[None],
            tripId='drwmyketposyvjwveyse',
            tripHeadsign='fouqgtxucdzpzowcvhmt',
            tripShortName='obijgdjkuaxrggklujad',
            directionId=None,
            blockId='ieogxddfplwmebpnbfib',
            shapeId='serltryclkjgrwzjpvby',
    ...
    def test_routeId_property(self):
        ...
        """
        test_value = 'kplysbvpdpzvjdatmhtx'
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'drwmyketposyvjwveyse'
    ...
    def test_tripHeadsign_property(self):
        ...
        """
        test_value = 'fouqgtxucdzpzowcvhmt'
    ...
    def test_tripShortName_property(self):
        ...
        """
        test_value = 'obijgdjkuaxrggklujad'
    ...
    def test_blockId_property(self):
        ...
        """
        test_value = 'ieogxddfplwmebpnbfib'
    ...
    def test_shapeId_property(self):
        ...
        """
        test_value = 'serltryclkjgrwzjpvby'

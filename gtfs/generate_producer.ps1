...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedRealTime" --id "GeneralTransitFeedRealTime.Vehicle.VehiclePosition" --schemaformat Avro --schemagroup "GeneralTransitFeedRealTime" --schemaid "GeneralTransitFeedRealTime.Vehicle.VehiclePosition" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedRealTime" --id "GeneralTransitFeedRealTime.Trip.TripUpdate" --schemaformat Avro --schemagroup "GeneralTransitFeedRealTime" --schemaid "GeneralTransitFeedRealTime.Trip.TripUpdate" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedRealTime" --id "GeneralTransitFeedRealTime.Alert.Alert" --schemaformat Avro --schemagroup "GeneralTransitFeedRealTime" --schemaid "GeneralTransitFeedRealTime.Alert.Alert" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.Agency" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.Agency" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.Areas" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.Areas" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.Attributions" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.Attributions" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeed.BookingRules" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeed.BookingRules" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.FareAttributes" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.FareAttributes" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.FareLegRules" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.FareLegRules" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.FareMedia" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.FareMedia" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.FareProducts" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.FareProducts" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.FareRules" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.FareRules" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.FareTransferRules" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.FareTransferRules" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.FeedInfo" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.FeedInfo" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.Frequencies" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.Frequencies" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.Levels" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.Levels" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.LocationGeoJson" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.LocationGeoJson" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.LocationGroups" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.LocationGroups" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.LocationGroupStores" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.LocationGroupStores" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.Networks" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.Networks" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.Pathways" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.Pathways" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.RouteNetworks" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.RouteNetworks" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.Routes" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.Routes" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.Shapes" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.Shapes" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.StopAreas" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.StopAreas" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.Stops" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.Stops" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.StopTimes" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.StopTimes" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.Timeframes" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.Timeframes" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.Transfers" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.Transfers" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.Translations" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.Translations" xreg\gtfs.xreg.json
...
xregistry manifest cloudevent add --groupid "GeneralTransitFeedStatic" --id "GeneralTransitFeedStatic.Trips" --schemaformat Avro --schemagroup "GeneralTransitFeedStatic" --schemaid "GeneralTransitFeedStatic.Trips" xreg\gtfs.xreg.json

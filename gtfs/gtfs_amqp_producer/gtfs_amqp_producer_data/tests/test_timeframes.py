...
class Test_Timeframes(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Timeframes(
            timeframeGroupId='pqoqpgvvfawcyibcfjgq',
            startTime='drpzjeoumfmwsmzacvet',
            endTime='tkvzcenbfdveysbccclg',
            serviceDates=None
        )
        return instance
    ...
    def test_timeframeGroupId_property(self):
        ...
        """
        test_value = 'pqoqpgvvfawcyibcfjgq'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'drpzjeoumfmwsmzacvet'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'tkvzcenbfdveysbccclg'

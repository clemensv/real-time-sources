...
class Test_LocationGroupStores(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = LocationGroupStores(
            locationGroupStoreId='utojukskzspnzdzrummv',
            locationGroupId='lttzsaofvvdqmabdhmau',
            storeId='naoplrikqqxuypgywuyt'
        )
        return instance
    ...
    def test_locationGroupStoreId_property(self):
        ...
        """
        test_value = 'utojukskzspnzdzrummv'
    ...
    def test_locationGroupId_property(self):
        ...
        """
        test_value = 'lttzsaofvvdqmabdhmau'
    ...
    def test_storeId_property(self):
        ...
        """
        test_value = 'naoplrikqqxuypgywuyt'

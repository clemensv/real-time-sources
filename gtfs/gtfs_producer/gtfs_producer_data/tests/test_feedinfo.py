...
class Test_FeedInfo(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = FeedInfo(
            feedPublisherName='ddmndxnnoapyemowrqlb',
            feedPublisherUrl='awodbguvdorsgfrhlgid',
            feedLang='srjfriwuefsdwgzbbsag',
            defaultLang='gajtsfoyzbyifdjozvky',
            feedStartDate='aoigdxdxftarwjyizjfg',
            feedEndDate='qbbvgnkmgzgwifwmcrqm',
            feedVersion='snqmmdqbjbwyybhnnafm',
            feedContactEmail='jexbvchlxsqegzvrihwd',
            feedContactUrl='sqzqkmpfocjecurkzffu'
        )
        return instance
    ...
    def test_feedPublisherName_property(self):
        ...
        """
        test_value = 'ddmndxnnoapyemowrqlb'
    ...
    def test_feedPublisherUrl_property(self):
        ...
        """
        test_value = 'awodbguvdorsgfrhlgid'
    ...
    def test_feedLang_property(self):
        ...
        """
        test_value = 'srjfriwuefsdwgzbbsag'
    ...
    def test_defaultLang_property(self):
        ...
        """
        test_value = 'gajtsfoyzbyifdjozvky'
    ...
    def test_feedStartDate_property(self):
        ...
        """
        test_value = 'aoigdxdxftarwjyizjfg'
    ...
    def test_feedEndDate_property(self):
        ...
        """
        test_value = 'qbbvgnkmgzgwifwmcrqm'
    ...
    def test_feedVersion_property(self):
        ...
        """
        test_value = 'snqmmdqbjbwyybhnnafm'
    ...
    def test_feedContactEmail_property(self):
        ...
        """
        test_value = 'jexbvchlxsqegzvrihwd'
    ...
    def test_feedContactUrl_property(self):
        ...
        """
        test_value = 'sqzqkmpfocjecurkzffu'

...
from gtfs_producer_data.generaltransitfeedstatic.networks import Networks
...
class Test_Networks(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Networks(
            networkId='esxfarjfvioolsdxotlx',
            networkName='jpjlxfvqrygnsgtvvwlz',
            networkDesc='ktcjugrxcvnulmemzypm',
            networkUrl='aeezvhaxncsrjyumkiqb'
        )
        return instance
    ...
    def test_networkId_property(self):
        ...
        """
        test_value = 'esxfarjfvioolsdxotlx'
    ...
    def test_networkName_property(self):
        ...
        """
        test_value = 'jpjlxfvqrygnsgtvvwlz'
    ...
    def test_networkDesc_property(self):
        ...
        """
        test_value = 'ktcjugrxcvnulmemzypm'
    ...
    def test_networkUrl_property(self):
        ...
        """
        test_value = 'aeezvhaxncsrjyumkiqb'

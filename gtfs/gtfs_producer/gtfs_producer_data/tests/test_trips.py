...
class Test_Trips(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Trips(
            routeId='nrrgvsydtppelpiowaca',
            serviceDates=None,
            serviceExceptions=[None, None],
            tripId='fkbudfgxcwoztxowghpy',
            tripHeadsign='azguppfbadroeakfnrxi',
            tripShortName='hracjzluaeaqvmpfqlau',
            directionId=None,
            blockId='dmltjcbupjjzskdruwnc',
            shapeId='ajpmtitvtwdtkrzyhugd',
    ...
    def test_routeId_property(self):
        ...
        """
        test_value = 'nrrgvsydtppelpiowaca'
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'fkbudfgxcwoztxowghpy'
    ...
    def test_tripHeadsign_property(self):
        ...
        """
        test_value = 'azguppfbadroeakfnrxi'
    ...
    def test_tripShortName_property(self):
        ...
        """
        test_value = 'hracjzluaeaqvmpfqlau'
    ...
    def test_blockId_property(self):
        ...
        """
        test_value = 'dmltjcbupjjzskdruwnc'
    ...
    def test_shapeId_property(self):
        ...
        """
        test_value = 'ajpmtitvtwdtkrzyhugd'

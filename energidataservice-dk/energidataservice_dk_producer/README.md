...
# Energidataservice-dk-producer Kafka Producer# Energidataservice-dk-producer Event Dispatcher for Apache Kafka
...
from energidataservice-dk-producer import DkEnerginetEnergidataserviceProducer```python

...
class WaterLevelObservation:
    ...
    water_level_timestamp: datetime.datetime=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="water_level_timestamp"))
    ...
    def __post_init__(self):
        ...
        value_water_level_timestamp = self.water_level_timestamp
        self.water_level_timestamp = value_water_level_timestamp
        ...
        self.ice_phenomenon_code=str(self.ice_phenomenon_code) if self.ice_phenomenon_code else None
        self.overgrowth_code=str(self.overgrowth_code) if self.overgrowth_code else None

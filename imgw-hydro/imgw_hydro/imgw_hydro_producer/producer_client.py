...
from imgw_hydro.imgw_hydro_producer import Station
from imgw_hydro.imgw_hydro_producer import WaterLevelObservation
...
class PLGovIMGWHydroEventProducer:
    ...
    def __resolve_template(template: str, data: typing.Any) -> str:
        ...
        def replace(match: re.Match[str]) -> str:
            ...
            if placeholder.lower() == "station_id" and "id_stacji" in normalized:
                return str(normalized["id_stacji"])

...
class WaterLevelObservation:
    ...
    Attributes:
        ...
        water_temperature_timestamp (str): 
        discharge (float): 
        discharge_timestamp (str): 
        ice_phenomenon_code (str): 
        overgrowth_code (str): """
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"WaterLevelObservation\", \"namespace\": \"PL.Gov.IMGW.Hydro\", \"fields\": [{\"name\": \"station_id\", \"type\": \"string\"}, {\"name\": \"station_name\", \"type\": \"string\"}, {\"name\": \"river\", \"type\": \"string\"}, {\"name\": \"voivodeship\", \"type\": \"string\"}, {\"name\": \"water_level\", \"type\": \"double\"}, {\"name\": \"water_level_timestamp\", \"type\": \"string\"}, {\"name\": \"water_temperature\", \"type\": \"double\"}, {\"name\": \"water_temperature_timestamp\", \"type\": \"string\"}, {\"name\": \"discharge\", \"type\": \"double\"}, {\"name\": \"discharge_timestamp\", \"type\": \"string\"}, {\"name\": \"ice_phenomenon_code\", \"type\": \"string\"}, {\"name\": \"overgrowth_code\", \"type\": \"string\"}]}"), avro.name.Names()
    )
    ...
    def __post_init__(self):
        ...
        self.ice_phenomenon_code=str(self.ice_phenomenon_code) if self.ice_phenomenon_code is not None else None
        self.overgrowth_code=str(self.overgrowth_code) if self.overgrowth_code is not None else None

...
"""
Sample usage of eurdep_radiation_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send DoseRateReading message
        print("Sending DoseRateReading message...")
        # TODO: Create a DoseRateReading instance with actual data
        # data = DoseRateReading(...)
        # producer.send_dose_rate_reading(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("DoseRateReading message sent successfully!")

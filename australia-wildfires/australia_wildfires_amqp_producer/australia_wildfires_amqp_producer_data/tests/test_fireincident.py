...
from australia_wildfires_amqp_producer_data.fireincident import FireIncident
import datetime
...
class Test_FireIncident(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = FireIncident(
            incident_id='vlfakczpmzjqzjyzmlrs',
            state='yomlfyslsmyjenybauls',
            title='cjgefiwifpshsrmsvtod',
            alert_level='nxjgopilhtwpgrwkmqme',
            status='imhhlthublfvjbsfqrrl',
            location='llbfhbwuzsyxpylgkyao',
            latitude=float(26.590237205562374),
            longitude=float(4.261306694545263),
            size_hectares=float(80.63131504134871),
            type='izsyewvqufcwrhvftyqa',
            responsible_agency='jbcerkvkdiqcxgitswld',
            updated=datetime.datetime.now(datetime.timezone.utc),
            source_url='jwrauccaehwpakccgwhi'
        )
        return instance
    ...
    def test_incident_id_property(self):
        ...
        """
        test_value = 'vlfakczpmzjqzjyzmlrs'
    ...
    def test_state_property(self):
        ...
        Test state property
        """
        test_value = 'yomlfyslsmyjenybauls'
    ...
    def test_title_property(self):
        ...
        Test title property
        """
        test_value = 'cjgefiwifpshsrmsvtod'
    ...
    def test_alert_level_property(self):
        ...
        """
        test_value = 'nxjgopilhtwpgrwkmqme'
    ...
    def test_status_property(self):
        ...
        """
        test_value = 'imhhlthublfvjbsfqrrl'
    ...
    def test_location_property(self):
        ...
        """
        test_value = 'llbfhbwuzsyxpylgkyao'
    ...
    def test_latitude_property(self):
        ...
        """
        test_value = float(26.590237205562374)
    ...
    def test_longitude_property(self):
        ...
        """
        test_value = float(4.261306694545263)
    ...
    def test_size_hectares_property(self):
        ...
        """
        test_value = float(80.63131504134871)
    ...
    def test_type_property(self):
        ...
        Test type property
        """
        test_value = 'izsyewvqufcwrhvftyqa'
    ...
    def test_responsible_agency_property(self):
        ...
        """
        test_value = 'jbcerkvkdiqcxgitswld'
    ...
    def test_source_url_property(self):
        ...
        """
        test_value = 'jwrauccaehwpakccgwhi'

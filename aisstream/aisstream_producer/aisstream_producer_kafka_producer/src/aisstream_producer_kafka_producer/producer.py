...
class IOAISstreamEventProducer:
    ...
    def send_io_aisstream_position_report(self,data: PositionReport, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, PositionReport], str]=None) -> None:
        """
    ...
    def send_io_aisstream_ship_static_data(self,data: ShipStaticData, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, ShipStaticData], str]=None) -> None:
        """
    ...
    def send_io_aisstream_standard_class_bposition_report(self,data: StandardClassBPositionReport, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, StandardClassBPositionReport], str]=None) -> None:
        """
    ...
    def send_io_aisstream_extended_class_bposition_report(self,data: ExtendedClassBPositionReport, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, ExtendedClassBPositionReport], str]=None) -> None:
        """
    ...
    def send_io_aisstream_aids_to_navigation_report(self,data: AidsToNavigationReport, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, AidsToNavigationReport], str]=None) -> None:
        """
    ...
    def send_io_aisstream_static_data_report(self,data: StaticDataReport, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, StaticDataReport], str]=None) -> None:
        """
    ...
    def send_io_aisstream_base_station_report(self,data: BaseStationReport, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, BaseStationReport], str]=None) -> None:
        """
    ...
    def send_io_aisstream_safety_broadcast_message(self,data: SafetyBroadcastMessage, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, SafetyBroadcastMessage], str]=None) -> None:
        """
    ...
    def send_io_aisstream_standard_search_and_rescue_aircraft_report(self,data: StandardSearchAndRescueAircraftReport, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, StandardSearchAndRescueAircraftReport], str]=None) -> None:
        """
    ...
    def send_io_aisstream_long_range_ais_broadcast_message(self,data: LongRangeAisBroadcastMessage, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, LongRangeAisBroadcastMessage], str]=None) -> None:
        """
    ...
    def send_io_aisstream_addressed_safety_message(self,data: AddressedSafetyMessage, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, AddressedSafetyMessage], str]=None) -> None:
        """
    ...
    def send_io_aisstream_addressed_binary_message(self,data: AddressedBinaryMessage, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, AddressedBinaryMessage], str]=None) -> None:
        """
    ...
    def send_io_aisstream_assigned_mode_command(self,data: AssignedModeCommand, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, AssignedModeCommand], str]=None) -> None:
        """
    ...
    def send_io_aisstream_binary_acknowledge(self,data: BinaryAcknowledge, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, BinaryAcknowledge], str]=None) -> None:
        """
    ...
    def send_io_aisstream_binary_broadcast_message(self,data: BinaryBroadcastMessage, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, BinaryBroadcastMessage], str]=None) -> None:
        """
    ...
    def send_io_aisstream_channel_management(self,data: ChannelManagement, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, ChannelManagement], str]=None) -> None:
        """
    ...
    def send_io_aisstream_coordinated_utcinquiry(self,data: CoordinatedUTCInquiry, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, CoordinatedUTCInquiry], str]=None) -> None:
        """
    ...
    def send_io_aisstream_data_link_management_message(self,data: DataLinkManagementMessage, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, DataLinkManagementMessage], str]=None) -> None:
        """
    ...
    def send_io_aisstream_gnss_broadcast_binary_message(self,data: GnssBroadcastBinaryMessage, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, GnssBroadcastBinaryMessage], str]=None) -> None:
        """
    ...
    def send_io_aisstream_group_assignment_command(self,data: GroupAssignmentCommand, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, GroupAssignmentCommand], str]=None) -> None:
        """
    ...
    def send_io_aisstream_interrogation(self,data: Interrogation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Interrogation], str]=None) -> None:
        """
    ...
    def send_io_aisstream_multi_slot_binary_message(self,data: MultiSlotBinaryMessage, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, MultiSlotBinaryMessage], str]=None) -> None:
        """
    ...
    def send_io_aisstream_single_slot_binary_message(self,data: SingleSlotBinaryMessage, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, SingleSlotBinaryMessage], str]=None) -> None:
        """

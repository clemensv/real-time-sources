...
xrcg generate --style kafkaproducer --language py --definitions $xregFile --projectname tepco_denkiyoho_producer --output (Join-Path $scriptDir "tepco_denkiyoho_producer")

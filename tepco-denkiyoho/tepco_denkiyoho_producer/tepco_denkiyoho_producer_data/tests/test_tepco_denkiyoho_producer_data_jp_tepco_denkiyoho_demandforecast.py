...
class Test_DemandForecast(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = DemandForecast(
            date='uafvoubukepktujfgdqa',
            time='errcokvvruhxfcyctiwd',
            datetime='ufywkfcnaepxovkubihq',
            datetime_local='hvqarixadpyuxgteisip',
            forecast_demand_mw=float(7.792901338771719),
            forecast_demand_jp_unit_value=int(34),
            usage_pct=float(97.18263175835187),
            supply_capacity_mw=float(18.149090625419394),
            supply_capacity_jp_unit_value=int(83),
            area_code='axxifiwmsprluznwagaa'
        )
        return instance
    ...
    def test_date_property(self):
        ...
        Test date property
        """
        test_value = 'uafvoubukepktujfgdqa'
    ...
    def test_time_property(self):
        ...
        Test time property
        """
        test_value = 'errcokvvruhxfcyctiwd'
    ...
    def test_datetime_property(self):
        ...
        """
        test_value = 'ufywkfcnaepxovkubihq'
    ...
    def test_datetime_local_property(self):
        ...
        """
        test_value = 'hvqarixadpyuxgteisip'
    ...
    def test_forecast_demand_mw_property(self):
        ...
        """
        test_value = float(7.792901338771719)
    ...
    def test_usage_pct_property(self):
        ...
        """
        test_value = float(97.18263175835187)
    ...
    def test_supply_capacity_mw_property(self):
        ...
        """
        test_value = float(18.149090625419394)
    ...
    def test_area_code_property(self):
        ...
        """
        test_value = 'axxifiwmsprluznwagaa'

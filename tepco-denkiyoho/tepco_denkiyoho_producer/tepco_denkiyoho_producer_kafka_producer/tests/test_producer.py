...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../tepco_denkiyoho_producer_data/src')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../tepco_denkiyoho_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../tepco_denkiyoho_producer_kafka_producer/src')))
...
from test_tepco_denkiyoho_producer_data_jp_tepco_denkiyoho_supplycapacity import Test_SupplyCapacity
from tepco_denkiyoho_producer_data import PeakDemandForecast
from test_tepco_denkiyoho_producer_data_jp_tepco_denkiyoho_peakdemandforecast import Test_PeakDemandForecast
from tepco_denkiyoho_producer_data import DemandActual
from test_tepco_denkiyoho_producer_data_jp_tepco_denkiyoho_demandactual import Test_DemandActual
from tepco_denkiyoho_producer_data import DemandForecast
from test_tepco_denkiyoho_producer_data_jp_tepco_denkiyoho_demandforecast import Test_DemandForecast

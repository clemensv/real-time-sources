...
Asynchronous handler hook for `DE.Waters.Hydrology.Station`:
...
Asynchronous handler hook for `DE.Waters.Hydrology.WaterLevelObservation`:
...
Send a single `DE.Waters.Hydrology.Station` message.Args:
...
Send a single `DE.Waters.Hydrology.WaterLevelObservation` message.Args:

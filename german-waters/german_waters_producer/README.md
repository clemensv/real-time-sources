...
# German_waters_producer Kafka Producer# German_waters_producer Event Dispatcher for Apache Kafka
...
4. [Generated Producer Classes](#generated-producer-classes)    DEWatersHydrologyAmqpEventDispatcher
...
- DEWatersHydrologyAmqpProducersolution for event-driven applications.
...
- **Scales horizontally** across multiple brokers and partitions### DEWatersHydrologyEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`DEWatersHydrologyEventDispatcher` handles events for the DE.Waters.Hydrology message group.
...
The DEWatersHydrologyEventDispatcher defines the following event handler hooks.
...
producer = DEWatersHydrologyProducer(
    ...
    security_protocol='SASL_SSL',##### `de_waters_hydrology_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'de_waters_hydrology_station_async:  Callable[[ConsumerRecord, CloudEvent, Station],
Awaitable[None]]
...
Asynchronous handler hook for `DE.Waters.Hydrology.Station`: A reference record for one German state water monitoring
station published by German state open data portals. It fires when the bridge publishes or refreshes the station catalog
...
de_waters_hydrology_dispatcher.de_waters_hydrology_station_async = de_waters_hydrology_station_event
...
### DEWatersHydrologyAmqpProducer- `data`: The event data of type `german_waters_producer_data.Station`.



Producer for `DE.Waters.Hydrology.amqp` message group.Example:
...
DEWatersHydrologyAmqpProducer(    await some_processing_function(record, cloud_event, data)
...
de_waters_hydrology_amqp_dispatcher.de_waters_hydrology_station_async = de_waters_hydrology_station_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `de_waters_hydrology_water_level_observation_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'de_waters_hydrology_water_level_observation_async:  Callable[[ConsumerRecord,
...
Asynchronous handler hook for `DE.Waters.Hydrology.WaterLevelObservation`: A current measurement from German state open
data portals for one monitoring site. It carries water level and discharge observations when the upstream feed reports a
...
### DEWatersHydrologyAmqpProducer- `data`: The event data of type `german_waters_producer_data.WaterLevelObservation`.
...
de_waters_hydrology_amqp_dispatcher.de_waters_hydrology_water_level_observation_async =
de_waters_hydrology_water_level_observation_event
...
##### `send_de_waters_hydrology_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_de_waters_hydrology_station(
...
Send a single `DE.Waters.Hydrology.Station` message. A reference record for one German state water monitoring station
published by German state open data portals. It fires when the bridge publishes or refreshes the station catalog so
...
await producer.send_de_waters_hydrology_station(
...
Send multiple `DE.Waters.Hydrology.Station` messages in a batch.
...
await producer.send_de_waters_hydrology_station_batch(```
...
##### `send_de_waters_hydrology_water_level_observation`Dispatchers have the following protected methods:



```python### Methods:

async def send_de_waters_hydrology_water_level_observation(
...
Send a single `DE.Waters.Hydrology.WaterLevelObservation` message. A current measurement from German state open data
portals for one monitoring site. It carries water level and discharge observations when the upstream feed reports a new
...
await producer.send_de_waters_hydrology_water_level_observation(
...
Send multiple `DE.Waters.Hydrology.WaterLevelObservation` messages in a batch.
...
de_waters_hydrology_amqp_dispatcher.de_waters_hydrology_mqtt_station_async = de_waters_hydrology_mqtt_station_event
...
Asynchronous handler hook for `DE.Waters.Hydrology.mqtt.WaterLevelObservation`: A current measurement from German state
open data portals for one monitoring site. It carries water level and discharge observations when the upstream feed
...
de_waters_hydrology_amqp_dispatcher.de_waters_hydrology_mqtt_water_level_observation_async =
de_waters_hydrology_mqtt_water_level_observation_event
...
Send a single `DE.Waters.Hydrology.mqtt.Station` message. A reference record for one German state water monitoring
station published by German state open data portals. It fires when the bridge publishes or refreshes the station catalog
...
Send a single `DE.Waters.Hydrology.mqtt.WaterLevelObservation` message. A current measurement from German state open
data portals for one monitoring site. It carries water level and discharge observations when the upstream feed reports a
...
- **Scales horizontally** across multiple brokers and partitions### DEWatersHydrologyAmqpEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`DEWatersHydrologyAmqpEventDispatcher` handles events for the DE.Waters.Hydrology.amqp message group.
...
The DEWatersHydrologyAmqpEventDispatcher defines the following event handler hooks.
...
producer = DEWatersHydrologyProducer(
    ...
    security_protocol='SASL_SSL',##### `de_waters_hydrology_amqp_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'de_waters_hydrology_amqp_station_async:  Callable[[ConsumerRecord, CloudEvent,
Station], Awaitable[None]]
...
Asynchronous handler hook for `DE.Waters.Hydrology.amqp.Station`: A reference record for one German state water
monitoring station published by German state open data portals. It fires when the bridge publishes or refreshes the
station catalog so consumers can interpret measurement events.
...
async def de_waters_hydrology_amqp_station_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Station) ->
None:
...
de_waters_hydrology_dispatcher.de_waters_hydrology_amqp_station_async = de_waters_hydrology_amqp_station_event
...
de_waters_hydrology_mqtt_dispatcher.de_waters_hydrology_amqp_station_async = de_waters_hydrology_amqp_station_event
...
de_waters_hydrology_amqp_dispatcher.de_waters_hydrology_amqp_station_async = de_waters_hydrology_amqp_station_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `de_waters_hydrology_amqp_water_level_observation_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'de_waters_hydrology_amqp_water_level_observation_async:  Callable[[ConsumerRecord,
CloudEvent, WaterLevelObservation], Awaitable[None]]
...
Asynchronous handler hook for `DE.Waters.Hydrology.amqp.WaterLevelObservation`: A current measurement from German state
open data portals for one monitoring site. It carries water level and discharge observations when the upstream feed
reports a new or refreshed value.
...
async def de_waters_hydrology_amqp_water_level_observation_event(record: ConsumerRecord, cloud_event: CloudEvent, data:
WaterLevelObservation) -> None:
...
de_waters_hydrology_dispatcher.de_waters_hydrology_amqp_water_level_observation_async =
de_waters_hydrology_amqp_water_level_observation_event
...
de_waters_hydrology_mqtt_dispatcher.de_waters_hydrology_amqp_water_level_observation_async =
de_waters_hydrology_amqp_water_level_observation_event
...
de_waters_hydrology_amqp_dispatcher.de_waters_hydrology_amqp_water_level_observation_async =
de_waters_hydrology_amqp_water_level_observation_event
...
##### `send_de_waters_hydrology_amqp_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_de_waters_hydrology_amqp_station(
...
Send a single `DE.Waters.Hydrology.amqp.Station` message. A reference record for one German state water monitoring
station published by German state open data portals. It fires when the bridge publishes or refreshes the station catalog
so consumers can interpret measurement events.Args:
...
await producer.send_de_waters_hydrology_amqp_station(
...
Send multiple `DE.Waters.Hydrology.amqp.Station` messages in a batch.
...
await producer.send_de_waters_hydrology_amqp_station_batch(```
...
##### `send_de_waters_hydrology_amqp_water_level_observation`Dispatchers have the following protected methods:



```python### Methods:

async def send_de_waters_hydrology_amqp_water_level_observation(
...
Send a single `DE.Waters.Hydrology.amqp.WaterLevelObservation` message. A current measurement from German state open
data portals for one monitoring site. It carries water level and discharge observations when the upstream feed reports a
new or refreshed value.Args:
...
await producer.send_de_waters_hydrology_amqp_water_level_observation(
...
Send multiple `DE.Waters.Hydrology.amqp.WaterLevelObservation` messages in a batch.
...
await producer.send_de_waters_hydrology_amqp_water_level_observation_batch(```

...
Asynchronous handler hook for `DE.Autobahn.RoadworkAppeared`:
...
Asynchronous handler hook for `DE.Autobahn.RoadworkUpdated`:
...
Asynchronous handler hook for `DE.Autobahn.RoadworkResolved`:
...
Asynchronous handler hook for `DE.Autobahn.ShortTermRoadworkAppeared`:
...
Asynchronous handler hook for `DE.Autobahn.ShortTermRoadworkUpdated`:
...
Asynchronous handler hook for `DE.Autobahn.ShortTermRoadworkResolved`:
...
Asynchronous handler hook for `DE.Autobahn.WarningAppeared`:
...
Asynchronous handler hook for `DE.Autobahn.WarningUpdated`:
...
Asynchronous handler hook for `DE.Autobahn.WarningResolved`:
...
Asynchronous handler hook for `DE.Autobahn.ClosureAppeared`:
...
Asynchronous handler hook for `DE.Autobahn.ClosureUpdated`:
...
Asynchronous handler hook for `DE.Autobahn.ClosureResolved`:
...
Asynchronous handler hook for `DE.Autobahn.EntryExitClosureAppeared`:
...
Asynchronous handler hook for `DE.Autobahn.EntryExitClosureUpdated`:
...
Asynchronous handler hook for `DE.Autobahn.EntryExitClosureResolved`:
...
Asynchronous handler hook for `DE.Autobahn.WeightLimit35RestrictionAppeared`:
...
Asynchronous handler hook for `DE.Autobahn.WeightLimit35RestrictionUpdated`:
...
Asynchronous handler hook for `DE.Autobahn.WeightLimit35RestrictionResolved`:
...
Asynchronous handler hook for `DE.Autobahn.ParkingLorryAppeared`:
...
Asynchronous handler hook for `DE.Autobahn.ParkingLorryUpdated`:
...
Asynchronous handler hook for `DE.Autobahn.ParkingLorryResolved`:
...
Asynchronous handler hook for `DE.Autobahn.ElectricChargingStationAppeared`:
...
Asynchronous handler hook for `DE.Autobahn.ElectricChargingStationUpdated`:
...
Asynchronous handler hook for `DE.Autobahn.ElectricChargingStationResolved`:
...
Asynchronous handler hook for `DE.Autobahn.StrongElectricChargingStationAppeared`:
...
Asynchronous handler hook for `DE.Autobahn.StrongElectricChargingStationUpdated`:
...
Asynchronous handler hook for `DE.Autobahn.StrongElectricChargingStationResolved`:
...
Asynchronous handler hook for `DE.Autobahn.WebcamAppeared`:
...
Asynchronous handler hook for `DE.Autobahn.WebcamUpdated`:
...
Asynchronous handler hook for `DE.Autobahn.WebcamResolved`:
...
Send a single `DE.Autobahn.RoadworkAppeared` message.Args:
...
Send a single `DE.Autobahn.RoadworkUpdated` message.Args:
...
Send a single `DE.Autobahn.RoadworkResolved` message.Args:
...
Send a single `DE.Autobahn.ShortTermRoadworkAppeared` message.Args:
...
Send a single `DE.Autobahn.ShortTermRoadworkUpdated` message.Args:
...
Send a single `DE.Autobahn.ShortTermRoadworkResolved` message.Args:
...
Send a single `DE.Autobahn.WarningAppeared` message.Args:
...
Send a single `DE.Autobahn.WarningUpdated` message.Args:
...
Send a single `DE.Autobahn.WarningResolved` message.Args:
...
Send a single `DE.Autobahn.ClosureAppeared` message.Args:
...
Send a single `DE.Autobahn.ClosureUpdated` message.Args:
...
Send a single `DE.Autobahn.ClosureResolved` message.Args:
...
Send a single `DE.Autobahn.EntryExitClosureAppeared` message.Args:
...
Send a single `DE.Autobahn.EntryExitClosureUpdated` message.Args:
...
Send a single `DE.Autobahn.EntryExitClosureResolved` message.Args:
...
Send a single `DE.Autobahn.WeightLimit35RestrictionAppeared` message.Args:
...
Send a single `DE.Autobahn.WeightLimit35RestrictionUpdated` message.Args:
...
Send a single `DE.Autobahn.WeightLimit35RestrictionResolved` message.Args:
...
Send a single `DE.Autobahn.ParkingLorryAppeared` message.Args:
...
Send a single `DE.Autobahn.ParkingLorryUpdated` message.Args:
...
Send a single `DE.Autobahn.ParkingLorryResolved` message.Args:
...
Send a single `DE.Autobahn.ElectricChargingStationAppeared` message.Args:
...
Send a single `DE.Autobahn.ElectricChargingStationUpdated` message.Args:
...
Send a single `DE.Autobahn.ElectricChargingStationResolved` message.Args:
...
Send a single `DE.Autobahn.StrongElectricChargingStationAppeared` message.Args:
...
Send a single `DE.Autobahn.StrongElectricChargingStationUpdated` message.Args:
...
Send a single `DE.Autobahn.StrongElectricChargingStationResolved` message.Args:
...
Send a single `DE.Autobahn.WebcamAppeared` message.Args:
...
Send a single `DE.Autobahn.WebcamUpdated` message.Args:
...
Send a single `DE.Autobahn.WebcamResolved` message.Args:
...
Send a single `DE.Autobahn.RoadworkAppeared.mqtt` message.Args:
...
Send a single `DE.Autobahn.RoadworkUpdated.mqtt` message.Args:
...
Send a single `DE.Autobahn.RoadworkResolved.mqtt` message.Args:
...
Send a single `DE.Autobahn.ShortTermRoadworkAppeared.mqtt` message.Args:
...
Send a single `DE.Autobahn.ShortTermRoadworkUpdated.mqtt` message.Args:
...
Send a single `DE.Autobahn.ShortTermRoadworkResolved.mqtt` message.Args:
...
Send a single `DE.Autobahn.ClosureAppeared.mqtt` message.Args:
...
Send a single `DE.Autobahn.ClosureUpdated.mqtt` message.Args:
...
Send a single `DE.Autobahn.ClosureResolved.mqtt` message.Args:
...
Send a single `DE.Autobahn.EntryExitClosureAppeared.mqtt` message.Args:
...
Send a single `DE.Autobahn.EntryExitClosureUpdated.mqtt` message.Args:
...
Send a single `DE.Autobahn.EntryExitClosureResolved.mqtt` message.Args:
...
Send a single `DE.Autobahn.WarningAppeared.mqtt` message.Args:
...
Send a single `DE.Autobahn.WarningUpdated.mqtt` message.Args:
...
Send a single `DE.Autobahn.WarningResolved.mqtt` message.Args:
...
Send a single `DE.Autobahn.WeightLimit35RestrictionAppeared.mqtt` message.Args:
...
Send a single `DE.Autobahn.WeightLimit35RestrictionUpdated.mqtt` message.Args:
...
Send a single `DE.Autobahn.WeightLimit35RestrictionResolved.mqtt` message.Args:
...
Send a single `DE.Autobahn.WebcamAppeared.mqtt` message.Args:
...
Send a single `DE.Autobahn.WebcamUpdated.mqtt` message.Args:
...
Send a single `DE.Autobahn.WebcamResolved.mqtt` message.Args:
...
Send a single `DE.Autobahn.ParkingLorryAppeared.mqtt` message.Args:
...
Send a single `DE.Autobahn.ParkingLorryUpdated.mqtt` message.Args:
...
Send a single `DE.Autobahn.ParkingLorryResolved.mqtt` message.Args:
...
Send a single `DE.Autobahn.ElectricChargingStationAppeared.mqtt` message.Args:
...
Send a single `DE.Autobahn.ElectricChargingStationUpdated.mqtt` message.Args:
...
Send a single `DE.Autobahn.ElectricChargingStationResolved.mqtt` message.Args:
...
Send a single `DE.Autobahn.StrongElectricChargingStationAppeared.mqtt` message.Args:
...
Send a single `DE.Autobahn.StrongElectricChargingStationUpdated.mqtt` message.Args:
...
Send a single `DE.Autobahn.StrongElectricChargingStationResolved.mqtt` message.Args:

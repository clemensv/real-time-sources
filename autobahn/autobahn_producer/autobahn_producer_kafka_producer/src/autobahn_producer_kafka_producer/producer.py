...
class DEAutobahnMqttEventProducer:
    ...
    def send_de_autobahn_roadwork_appeared_mqtt(self,_identifier : str, _event_time : str, data: RoadEvent, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadEvent], str]=None) -> None:
        """
    ...
    def send_de_autobahn_roadwork_updated_mqtt(self,_identifier : str, _event_time : str, data: RoadEvent, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadEvent], str]=None) -> None:
        """
    ...
    def send_de_autobahn_roadwork_resolved_mqtt(self,_identifier : str, _event_time : str, data: RoadEvent, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadEvent], str]=None) -> None:
        """
    ...
    def send_de_autobahn_short_term_roadwork_appeared_mqtt(self,_identifier : str, _event_time : str, data: RoadEvent, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadEvent], str]=None) -> None:
        """
    ...
    def send_de_autobahn_short_term_roadwork_updated_mqtt(self,_identifier : str, _event_time : str, data: RoadEvent, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadEvent], str]=None) -> None:
        """
    ...
    def send_de_autobahn_short_term_roadwork_resolved_mqtt(self,_identifier : str, _event_time : str, data: RoadEvent, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadEvent], str]=None) -> None:
        """
    ...
    def send_de_autobahn_closure_appeared_mqtt(self,_identifier : str, _event_time : str, data: RoadEvent, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadEvent], str]=None) -> None:
        """
    ...
    def send_de_autobahn_closure_updated_mqtt(self,_identifier : str, _event_time : str, data: RoadEvent, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadEvent], str]=None) -> None:
        """
    ...
    def send_de_autobahn_closure_resolved_mqtt(self,_identifier : str, _event_time : str, data: RoadEvent, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadEvent], str]=None) -> None:
        """
    ...
    def send_de_autobahn_entry_exit_closure_appeared_mqtt(self,_identifier : str, _event_time : str, data: RoadEvent, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadEvent], str]=None) -> None:
        """
    ...
    def send_de_autobahn_entry_exit_closure_updated_mqtt(self,_identifier : str, _event_time : str, data: RoadEvent, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadEvent], str]=None) -> None:
        """
    ...
    def send_de_autobahn_entry_exit_closure_resolved_mqtt(self,_identifier : str, _event_time : str, data: RoadEvent, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadEvent], str]=None) -> None:
        """
    ...
    def send_de_autobahn_warning_appeared_mqtt(self,_identifier : str, _event_time : str, data: WarningEvent, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, WarningEvent], str]=None) -> None:
        """
    ...
    def send_de_autobahn_warning_updated_mqtt(self,_identifier : str, _event_time : str, data: WarningEvent, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, WarningEvent], str]=None) -> None:
        """
    ...
    def send_de_autobahn_warning_resolved_mqtt(self,_identifier : str, _event_time : str, data: WarningEvent, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, WarningEvent], str]=None) -> None:
        """
    ...
    def send_de_autobahn_weight_limit35_restriction_appeared_mqtt(self,_identifier : str, _event_time : str, data: RoadEvent, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadEvent], str]=None) -> None:
        """
    ...
    def send_de_autobahn_weight_limit35_restriction_updated_mqtt(self,_identifier : str, _event_time : str, data: RoadEvent, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadEvent], str]=None) -> None:
        """
    ...
    def send_de_autobahn_weight_limit35_restriction_resolved_mqtt(self,_identifier : str, _event_time : str, data: RoadEvent, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RoadEvent], str]=None) -> None:
        """
    ...
    def send_de_autobahn_webcam_appeared_mqtt(self,_identifier : str, _event_time : str, data: Webcam, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Webcam], str]=None) -> None:
        """
    ...
    def send_de_autobahn_webcam_updated_mqtt(self,_identifier : str, _event_time : str, data: Webcam, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Webcam], str]=None) -> None:
        """
    ...
    def send_de_autobahn_webcam_resolved_mqtt(self,_identifier : str, _event_time : str, data: Webcam, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Webcam], str]=None) -> None:
        """
    ...
    def send_de_autobahn_parking_lorry_appeared_mqtt(self,_identifier : str, _event_time : str, data: ParkingLorry, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, ParkingLorry], str]=None) -> None:
        """
    ...
    def send_de_autobahn_parking_lorry_updated_mqtt(self,_identifier : str, _event_time : str, data: ParkingLorry, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, ParkingLorry], str]=None) -> None:
        """
    ...
    def send_de_autobahn_parking_lorry_resolved_mqtt(self,_identifier : str, _event_time : str, data: ParkingLorry, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, ParkingLorry], str]=None) -> None:
        """
    ...
    def send_de_autobahn_electric_charging_station_appeared_mqtt(self,_identifier : str, _event_time : str, data: ChargingStation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, ChargingStation], str]=None) -> None:
        """
    ...
    def send_de_autobahn_electric_charging_station_updated_mqtt(self,_identifier : str, _event_time : str, data: ChargingStation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, ChargingStation], str]=None) -> None:
        """
    ...
    def send_de_autobahn_electric_charging_station_resolved_mqtt(self,_identifier : str, _event_time : str, data: ChargingStation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, ChargingStation], str]=None) -> None:
        """
    ...
    def send_de_autobahn_strong_electric_charging_station_appeared_mqtt(self,_identifier : str, _event_time : str, data: ChargingStation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, ChargingStation], str]=None) -> None:
        """
    ...
    def send_de_autobahn_strong_electric_charging_station_updated_mqtt(self,_identifier : str, _event_time : str, data: ChargingStation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, ChargingStation], str]=None) -> None:
        """
    ...
    def send_de_autobahn_strong_electric_charging_station_resolved_mqtt(self,_identifier : str, _event_time : str, data: ChargingStation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, ChargingStation], str]=None) -> None:
        """

...
class ParkingLorry:
    ...
    Attributes:
        identifier (str): 
        road (str): Lowercase kebab-case autobahn road designation (e.g. 'a1', 'a2') for the road query that yielded this item. Populated by the bridge from the Autobahn API road id (which is upper-case, e.g. 'A1'). Used as the second-to-last MQTT topic segment so subscribers can wildcard per road (e.g. 'traffic/de/autobahn/autobahn/a1/+/+/+'). The full upstream set is retained on `road_ids` for completeness.
        ...
        amenity_descriptions (typing.Optional[typing.List[str]]): 
        car_space_count (typing.Optional[int]): 
    ...
    amenity_descriptions: typing.Optional[typing.List[str]]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="amenity_descriptions"))
    car_space_count: typing.Optional[int]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="car_space_count"))
    lorry_space_count: typing.Optional[int]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="lorry_space_count"))
    
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"ParkingLorry\", \"namespace\": \"DE.Autobahn\", \"doc\": \"Normalized Autobahn lorry parking payload with parsed amenity and space counts. Source page: https://verkehr.autobahn.de/o/autobahn/A1/services/parking_lorry.\", \"fields\": [{\"name\": \"identifier\", \"type\": \"string\"}, {\"name\": \"road\", \"type\": \"string\", \"doc\": \"Lowercase kebab-case autobahn road designation (e.g. 'a1', 'a2') for the road query that yielded this item. Populated by the bridge from the Autobahn API road id (which is upper-case, e.g. 'A1'). Used as the second-to-last MQTT topic segment so subscribers can wildcard per road (e.g. 'traffic/de/autobahn/autobahn/a1/+/+/+'). The full upstream set is retained on `road_ids` for completeness.\"}, {\"name\": \"road_ids\", \"type\": {\"type\": \"array\", \"items\": \"string\"}}, {\"name\": \"event_time\", \"type\": \"string\"}, {\"name\": \"display_type\", \"type\": \"string\"}, {\"name\": \"title\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"subtitle\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"description_lines\", \"type\": [\"null\", {\"type\": \"array\", \"items\": \"string\"}], \"default\": null}, {\"name\": \"future\", \"type\": [\"null\", \"boolean\"], \"default\": null}, {\"name\": \"is_blocked\", \"type\": [\"null\", \"boolean\"], \"default\": null}, {\"name\": \"icon\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"start_lc_position\", \"type\": [\"null\", \"int\"], \"default\": null}, {\"name\": \"extent\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"point\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"coordinate_lat\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"coordinate_lon\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"route_recommendation_json\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"footer_lines\", \"type\": [\"null\", {\"type\": \"array\", \"items\": \"string\"}], \"default\": null}, {\"name\": \"amenity_descriptions\", \"type\": [\"null\", {\"type\": \"array\", \"items\": \"string\"}], \"default\": null}, {\"name\": \"car_space_count\", \"type\": [\"null\", \"int\"], \"default\": null}, {\"name\": \"lorry_space_count\", \"type\": [\"null\", \"int\"], \"default\": null}]}"), avro.name.Names()
    )

    def __post_init__(self):
        """ Initializes the dataclass with the provided keyword arguments."""
        self.identifier=str(self.identifier)
        self.road=str(self.road)
        ...
        self.amenity_descriptions=self.amenity_descriptions if isinstance(self.amenity_descriptions, list) else [str(v) for v in self.amenity_descriptions] if self.amenity_descriptions else None if self.amenity_descriptions else None
        self.car_space_count=int(self.car_space_count) if self.car_space_count else None
        self.lorry_space_count=int(self.lorry_space_count) if self.lorry_space_count else None

    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'ParkingLorry':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['ParkingLorry']:
        """
        ...
        if base_content_type in ['avro/binary', 'application/vnd.apache.avro+avro', 'avro/json', 'application/vnd.apache.avro+json']:
            ...
            return ParkingLorry.from_serializer_dict(_record)
        if base_content_type == 'application/json':

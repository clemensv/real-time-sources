...
`tools/deploy-fabric/deploy-feeder-notebook.ps1 -Source autobahn -ResourceGroup <rg> -Location <azure-region> -Workspace <fabric-workspace>`
...
`tools/deploy-fabric/deploy-fabric-aci.ps1 -Source autobahn -ResourceGroup <rg> -Location <azure-region> -Workspace <fabric-workspace>`

...
You can deploy the container into Azure Container Instances using the provided
ARM template. The template creates a storage account, a file share for the
state file, and a container instance running the bridge.

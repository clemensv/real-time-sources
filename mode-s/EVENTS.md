...
Events emitted by the Mode-S bridge.

- [Mode_S](#message-group-modes)
  - [Mode_S.ADSB](#message-modesadsb)
  - [Mode_S.AltitudeReply](#message-modesaltitudereply)
  - [Mode_S.IdentityReply](#message-modesidentityreply)
  - [Mode_S.AcquisitionReply](#message-modesacquisitionreply)
  - [Mode_S.CommBAltitude](#message-modescommbaltitude)
  - [Mode_S.CommBIdentity](#message-modescommbidentity)
...
|-------------|-----------------|--------------|--------------|-----------|
| `specversion` |  | `` | `False` | `1.0` |
| `type` |  | `` | `False` | `Mode_S.ADSB` |
...
|-------------|-----------------|--------------|--------------|-----------|
| `specversion` |  | `` | `False` | `1.0` |
| `type` |  | `` | `False` | `Mode_S.AltitudeReply` |
| `source` |  | `uritemplate` | `False` | `{feedurl}` |
| `subject` |  | `uritemplate` | `False` | `{icao24}/{receiver_id}` |
...
|-------------|-----------------|--------------|--------------|-----------|
| `specversion` |  | `` | `False` | `1.0` |
| `type` |  | `` | `False` | `Mode_S.IdentityReply` |
| `source` |  | `uritemplate` | `False` | `{feedurl}` |
| `subject` |  | `uritemplate` | `False` | `{icao24}/{receiver_id}` |
...
|-------------|-----------------|--------------|--------------|-----------|
| `specversion` |  | `` | `False` | `1.0` |
| `type` |  | `` | `False` | `Mode_S.AcquisitionReply` |
| `source` |  | `uritemplate` | `False` | `{feedurl}` |
| `subject` |  | `uritemplate` | `False` | `{icao24}/{receiver_id}` |
...
|-------------|-----------------|--------------|--------------|-----------|
| `specversion` |  | `` | `False` | `1.0` |
| `type` |  | `` | `False` | `Mode_S.CommBAltitude` |
| `source` |  | `uritemplate` | `False` | `{feedurl}` |
| `subject` |  | `uritemplate` | `False` | `{icao24}/{receiver_id}` |
...
|-------------|-----------------|--------------|--------------|-----------|
| `specversion` |  | `` | `False` | `1.0` |
| `type` |  | `` | `False` | `Mode_S.CommBIdentity` |
| `source` |  | `uritemplate` | `False` | `{feedurl}` |
| `subject` |  | `uritemplate` | `False` | `{icao24}/{receiver_id}` |

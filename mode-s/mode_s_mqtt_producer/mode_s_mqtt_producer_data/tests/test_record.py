...
from mode_s_mqtt_producer_data.record import Record
...
class Test_Record(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Record(
            icao24='osufwzdqwyjmojnqcgcf',
            receiver_id='dvcusahihuvcjdpruwtx',
            msg_type='tjjtgnatzxbaszzmjhlg',
            ts=int(65),
            df=int(0),
            tc=int(90),
            bcode='rmuugumyytnvtyifuhwd',
            alt=int(48),
            cs='gklpqasqpinkmsmeptey',
            sq='ebsuzufksroibffgqesk',
            lat=float(65.1276315288745),
            lon=float(74.50080717929085),
            spd=float(76.04866384568633),
            ang=float(57.598309408239665),
            vr=int(49),
            rssi=float(49.51524282557451)
        )
        return instance
    ...
    def test_icao24_property(self):
        ...
        """
        test_value = 'osufwzdqwyjmojnqcgcf'
    ...
    def test_receiver_id_property(self):
        ...
        """
        test_value = 'dvcusahihuvcjdpruwtx'
    ...
    def test_msg_type_property(self):
        ...
        """
        test_value = 'tjjtgnatzxbaszzmjhlg'
    ...
    def test_bcode_property(self):
        ...
        Test bcode property
        """
        test_value = 'rmuugumyytnvtyifuhwd'
    ...
    def test_cs_property(self):
        ...
        Test cs property
        """
        test_value = 'gklpqasqpinkmsmeptey'
    ...
    def test_sq_property(self):
        ...
        Test sq property
        """
        test_value = 'ebsuzufksroibffgqesk'
    ...
    def test_lat_property(self):
        ...
        Test lat property
        """
        test_value = float(65.1276315288745)
    ...
    def test_lon_property(self):
        ...
        Test lon property
        """
        test_value = float(74.50080717929085)
    ...
    def test_spd_property(self):
        ...
        Test spd property
        """
        test_value = float(76.04866384568633)
    ...
    def test_ang_property(self):
        ...
        Test ang property
        """
        test_value = float(57.598309408239665)
    ...
    def test_rssi_property(self):
        ...
        Test rssi property
        """
        test_value = float(49.51524282557451)

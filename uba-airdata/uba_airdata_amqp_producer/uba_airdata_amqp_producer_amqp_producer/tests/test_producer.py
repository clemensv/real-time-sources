...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../uba_airdata_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../uba_airdata_amqp_producer_amqp_producer/src')))
...
class TestDeUbaAirdataAmqpProducer:
    """Test cases for DeUbaAirdataAmqpProducer"""
...
class TestDeUbaAirdataComponentsAmqpProducer:
    """Test cases for DeUbaAirdataComponentsAmqpProducer"""

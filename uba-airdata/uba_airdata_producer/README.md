...
# Uba_airdata_producer Kafka Producer# Uba_airdata_producer Event Dispatcher for Apache Kafka
...
- DeUbaAirdataProducersolution for event-driven applications.
...
- **Scales horizontally** across multiple brokers and partitions### DeUbaAirdataEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`DeUbaAirdataEventDispatcher` handles events for the de.uba.airdata message group.
...
The DeUbaAirdataEventDispatcher defines the following event handler hooks.
...
producer = DeUbaAirdataProducer(
    ...
    security_protocol='SASL_SSL',##### `de_uba_airdata_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'de_uba_airdata_station_async:  Callable[[ConsumerRecord, CloudEvent, Station],
Awaitable[None]]
...
Asynchronous handler hook for `de.uba.airdata.Station`: Reference data for a UBA air quality monitoring station,
...
de_uba_airdata_dispatcher.de_uba_airdata_station_async = de_uba_airdata_station_event
...
de_uba_airdata_components_dispatcher.de_uba_airdata_station_async = de_uba_airdata_station_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `de_uba_airdata_measure_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'de_uba_airdata_measure_async:  Callable[[ConsumerRecord, CloudEvent, Measure],
Awaitable[None]]
...
Asynchronous handler hook for `de.uba.airdata.Measure`: Hourly one-hour-average air quality measurement for a UBA
...
de_uba_airdata_dispatcher.de_uba_airdata_measure_async = de_uba_airdata_measure_event
...
##### `send_de_uba_airdata_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_de_uba_airdata_station(
...
Send a single `de.uba.airdata.Station` message. Reference data for a UBA air quality monitoring station, including
...
await producer.send_de_uba_airdata_station(
...
Send multiple `de.uba.airdata.Station` messages in a batch.
...
await producer.send_de_uba_airdata_station_batch(```
...
##### `send_de_uba_airdata_measure`Dispatchers have the following protected methods:



```python### Methods:

async def send_de_uba_airdata_measure(
...
Send a single `de.uba.airdata.Measure` message. Hourly one-hour-average air quality measurement for a UBA monitoring
station and pollutant component as returned by the air_data/v3 measures endpoint.Args:
...
await producer.send_de_uba_airdata_measure(
...
Send multiple `de.uba.airdata.Measure` messages in a batch.
...
await producer.send_de_uba_airdata_measure_batch(```
...
- **Scales horizontally** across multiple brokers and partitions### DeUbaAirdataComponentsEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`DeUbaAirdataComponentsEventDispatcher` handles events for the de.uba.airdata.components message group.
...
The DeUbaAirdataComponentsEventDispatcher defines the following event handler hooks.
...
producer = DeUbaAirdataProducer(
    ...
    security_protocol='SASL_SSL',##### `de_uba_airdata_components_component_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'de_uba_airdata_components_component_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `de.uba.airdata.components.Component`: Reference data for an air pollutant component
...
de_uba_airdata_dispatcher.de_uba_airdata_components_component_async = de_uba_airdata_components_component_event
...
de_uba_airdata_components_dispatcher.de_uba_airdata_components_component_async =
...
##### `send_de_uba_airdata_components_component`Dispatchers have the following protected methods:



```python### Methods:

async def send_de_uba_airdata_components_component(
...
Send a single `de.uba.airdata.components.Component` message. Reference data for an air pollutant component published by
the UBA air_data/v3 components catalog, including the stable numeric component identifier, code, symbol, unit, and
English display name.Args:
...
await producer.send_de_uba_airdata_components_component(
...
Send multiple `de.uba.airdata.components.Component` messages in a batch.

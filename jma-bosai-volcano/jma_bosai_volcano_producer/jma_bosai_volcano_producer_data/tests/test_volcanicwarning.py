...
class Test_VolcanicWarning(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = VolcanicWarning(
            volcano_code='xcgzywdlrxugbgxzbiwt',
            event_id='crpydpuulhoolpakovht',
            ...
            alert_level_name='ltpcziigktswawhbauby',
            previous_level_code='gttxhgvanxufqxldsrqk',
            condition=ConditionEnum.ISSUED,
            info_type_jp='davclfwsyqyhugnidevg',
            area_codes=['slidjbkwnzsjivpcpxdc', 'htmwsxerqozewjrlasyq', 'gztpxtgyvnveofoavzss', 'jlqpmajlfsrxiohgznhe', 'lctaqscwmhwscfvjnqkv']
        )
        return instance
    ...
    def test_volcano_code_property(self):
        ...
        """
        test_value = 'xcgzywdlrxugbgxzbiwt'
    ...
    def test_event_id_property(self):
        ...
        """
        test_value = 'crpydpuulhoolpakovht'
    ...
    def test_alert_level_name_property(self):
        ...
        """
        test_value = 'ltpcziigktswawhbauby'
    ...
    def test_previous_level_code_property(self):
        ...
        """
        test_value = 'gttxhgvanxufqxldsrqk'
    ...
    def test_info_type_jp_property(self):
        ...
        """
        test_value = 'davclfwsyqyhugnidevg'
    ...
    def test_area_codes_property(self):
        ...
        """
        test_value = ['slidjbkwnzsjivpcpxdc', 'htmwsxerqozewjrlasyq', 'gztpxtgyvnveofoavzss', 'jlqpmajlfsrxiohgznhe', 'lctaqscwmhwscfvjnqkv']

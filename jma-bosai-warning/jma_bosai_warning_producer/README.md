...
# Jma_bosai_warning_producer Kafka Producer# Jma_bosai_warning_producer Event Dispatcher for Apache Kafka
...
- JPJMAWarningProducersolution for event-driven applications.
...
- **Scales horizontally** across multiple brokers and partitions### JPJMAWarningEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`JPJMAWarningEventDispatcher` handles events for the JP.JMA.Warning message group.
...
The JPJMAWarningEventDispatcher defines the following event handler hooks.
...
producer = JPJMAWarningProducer(
    ...
    security_protocol='SASL_SSL',##### `jp_jma_warning_office_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'jp_jma_warning_office_async:  Callable[[ConsumerRecord, CloudEvent, Office],
Awaitable[None]]
...
Asynchronous handler hook for `JP.JMA.Warning.Office`: JMA Bosai warning office reference data from area.json offices.
...
jp_jma_warning_dispatcher.jp_jma_warning_office_async = jp_jma_warning_office_event
...
jp_jma_tsunami_dispatcher.jp_jma_warning_office_async = jp_jma_warning_office_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `jp_jma_warning_weather_warning_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'jp_jma_warning_weather_warning_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `JP.JMA.Warning.WeatherWarning`: JMA Bosai weather warning/advisory telemetry for one
...
jp_jma_warning_dispatcher.jp_jma_warning_weather_warning_async = jp_jma_warning_weather_warning_event
...
##### `send_jp_jma_warning_office`Dispatchers have the following protected methods:



```python### Methods:

async def send_jp_jma_warning_office(
...
Send a single `JP.JMA.Warning.Office` message. JMA Bosai warning office reference data from area.json offices.Args:
...
await producer.send_jp_jma_warning_office(
...
Send multiple `JP.JMA.Warning.Office` messages in a batch.
...
await producer.send_jp_jma_warning_office_batch(```
...
##### `send_jp_jma_warning_weather_warning`Dispatchers have the following protected methods:



```python### Methods:

async def send_jp_jma_warning_weather_warning(
...
Send a single `JP.JMA.Warning.WeatherWarning` message. JMA Bosai weather warning/advisory telemetry for one forecast
area within an office bulletin.Args:
...
await producer.send_jp_jma_warning_weather_warning(
...
Send multiple `JP.JMA.Warning.WeatherWarning` messages in a batch.
...
await producer.send_jp_jma_warning_weather_warning_batch(```
...
- **Scales horizontally** across multiple brokers and partitions### JPJMATsunamiEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`JPJMATsunamiEventDispatcher` handles events for the JP.JMA.Tsunami message group.
...
The JPJMATsunamiEventDispatcher defines the following event handler hooks.
...
producer = JPJMAWarningProducer(
    ...
    security_protocol='SASL_SSL',##### `jp_jma_tsunami_tsunami_alert_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'jp_jma_tsunami_tsunami_alert_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `JP.JMA.Tsunami.TsunamiAlert`: JMA Bosai active tsunami alert telemetry from list.json
enriched with detail bulletin coastal forecasts.
...
jp_jma_warning_dispatcher.jp_jma_tsunami_tsunami_alert_async = jp_jma_tsunami_tsunami_alert_event
...
jp_jma_tsunami_dispatcher.jp_jma_tsunami_tsunami_alert_async = jp_jma_tsunami_tsunami_alert_event
...
##### `send_jp_jma_tsunami_tsunami_alert`Dispatchers have the following protected methods:



```python### Methods:

async def send_jp_jma_tsunami_tsunami_alert(
...
Send a single `JP.JMA.Tsunami.TsunamiAlert` message. JMA Bosai active tsunami alert telemetry from list.json enriched
with detail bulletin coastal forecasts.Args:
...
await producer.send_jp_jma_tsunami_tsunami_alert(
...
Send multiple `JP.JMA.Tsunami.TsunamiAlert` messages in a batch.
...
await producer.send_jp_jma_tsunami_tsunami_alert_batch(```

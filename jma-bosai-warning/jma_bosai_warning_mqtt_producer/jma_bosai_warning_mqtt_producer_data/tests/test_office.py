...
class Test_Office(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Office(
            office_code='ogdjfwpuejyiuugexxkv',
            area_code='crqnhpvfoqagnpuerqow',
            name_jp='njoqbkjoolwlhflghgtv',
            name_en='qhddzglxaadccxyhuvdy',
            parent_office_code='lhglcejdxtbrmnqjjxjp',
            office_type=OfficeTypeenum.PREFECTURE,
            prefecture='lnhwpyizaeasliezftbw',
    ...
    def test_office_code_property(self):
        ...
        """
        test_value = 'ogdjfwpuejyiuugexxkv'
    ...
    def test_area_code_property(self):
        ...
        """
        test_value = 'crqnhpvfoqagnpuerqow'
    ...
    def test_name_jp_property(self):
        ...
        """
        test_value = 'njoqbkjoolwlhflghgtv'
    ...
    def test_name_en_property(self):
        ...
        """
        test_value = 'qhddzglxaadccxyhuvdy'
    ...
    def test_parent_office_code_property(self):
        ...
        """
        test_value = 'lhglcejdxtbrmnqjjxjp'
    ...
    def test_prefecture_property(self):
        ...
        """
        test_value = 'lnhwpyizaeasliezftbw'

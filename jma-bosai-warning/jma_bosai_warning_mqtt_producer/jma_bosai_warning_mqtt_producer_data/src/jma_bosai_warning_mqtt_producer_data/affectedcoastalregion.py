""" AffectedCoastalRegion dataclass. """
...
import json
from jma_bosai_warning_mqtt_producer_data.categoryenum import CategoryEnum
import datetime


@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclass
class AffectedCoastalRegion:
    """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['AffectedCoastalRegion']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return AffectedCoastalRegion.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'AffectedCoastalRegion':
        """
        ...
        """
        return cls(
            code='ivmwaevptjoglpzawoxg',
            name='tthlavvqnkyizjirlpcx',
            category=CategoryEnum.MAJOR_WARNING,
            expected_max_wave_height_m=float(41.903954173848426),

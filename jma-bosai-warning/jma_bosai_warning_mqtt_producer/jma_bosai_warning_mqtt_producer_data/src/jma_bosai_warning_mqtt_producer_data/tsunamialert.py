...
class TsunamiAlert:
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['TsunamiAlert']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return TsunamiAlert.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'TsunamiAlert':
        """
        ...
        return cls(
            ...
            title_jp='babalonahghghxetdziw',
            title_en='ugtlzxekrqvqouykuyak',
            bulletin_type='uknkscnnsvnsopbyucpo',
            detail_url='nvihbhobedzrckitzbin',
            affected_coastal_regions=[None, None, None],
            observations=[None, None],
            prefecture='kxusimiobaxzwmwcxibe',

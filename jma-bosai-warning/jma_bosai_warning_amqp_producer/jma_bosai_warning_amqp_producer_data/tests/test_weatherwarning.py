...
class Test_WeatherWarning(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = WeatherWarning(
            prefecture='srwrtrhpnduexbahztqz',
            severity=SeverityEnum.advisory,
            office_code='iyccvxkmqupzpxljtfuu',
            area_code='bpofozwpcfplyoxzeotz',
            event=EventEnum.warning,
            area_name='tskwrgiaojhizmyywdlt',
            ...
            headline_text='ehuqcbyisfezaidstjsx',
            warnings=[None, None],
    ...
    def test_prefecture_property(self):
        ...
        """
        test_value = 'srwrtrhpnduexbahztqz'
    ...
    def test_office_code_property(self):
        ...
        """
        test_value = 'iyccvxkmqupzpxljtfuu'
    ...
    def test_area_code_property(self):
        ...
        """
        test_value = 'bpofozwpcfplyoxzeotz'
    ...
    def test_area_name_property(self):
        ...
        """
        test_value = 'tskwrgiaojhizmyywdlt'
    ...
    def test_headline_text_property(self):
        ...
        """
        test_value = 'ehuqcbyisfezaidstjsx'

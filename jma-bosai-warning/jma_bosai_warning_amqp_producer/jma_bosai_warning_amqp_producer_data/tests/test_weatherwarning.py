...
class Test_WeatherWarning(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = WeatherWarning(
            prefecture='lijugrbtaeeacfuxecph',
            severity=SeverityEnum.REFERENCE,
            office_code='kvrfumydxpxtexgbujng',
            area_code='xptfdjfywaugxsqxbkxx',
            event=EventEnum.office,
            area_name='dnrdaiusandddijsmbxa',
            ...
            headline_text='oudrkdwojsebhmrtbajj',
    ...
    def test_prefecture_property(self):
        ...
        """
        test_value = 'lijugrbtaeeacfuxecph'
    ...
    def test_office_code_property(self):
        ...
        """
        test_value = 'kvrfumydxpxtexgbujng'
    ...
    def test_area_code_property(self):
        ...
        """
        test_value = 'xptfdjfywaugxsqxbkxx'
    ...
    def test_area_name_property(self):
        ...
        """
        test_value = 'dnrdaiusandddijsmbxa'
    ...
    def test_headline_text_property(self):
        ...
        """
        test_value = 'oudrkdwojsebhmrtbajj'

...
class Test_AvalancheRegion(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = AvalancheRegion(
            region_id='mzuxcotnosqcquskezds',
            lang='ouwiydxldkvbezbxnjwg',
            configured_at=datetime.datetime.now(datetime.timezone.utc),
            bulletin_base_url='txqsascguwjgrcjefmwl'
        )
        return instance
    ...
    def test_region_id_property(self):
        ...
        """
        test_value = 'mzuxcotnosqcquskezds'
    ...
    def test_lang_property(self):
        ...
        Test lang property
        """
        test_value = 'ouwiydxldkvbezbxnjwg'
    ...
    def test_bulletin_base_url_property(self):
        ...
        """
        test_value = 'txqsascguwjgrcjefmwl'

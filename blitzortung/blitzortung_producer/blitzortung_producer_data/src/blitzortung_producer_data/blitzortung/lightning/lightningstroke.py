...
class LightningStroke:
    ...
    Attributes:
        ...
        geohash5 (str): 5-char geohash of the located stroke, derived by the bridge from lat/lon.
        geohash7 (str): 7-char geohash of the located stroke, derived by the bridge from lat/lon.
    ...
    def __post_init__(self):
        ...
        self.geohash5=str(self.geohash5)
        self.geohash7=str(self.geohash7)

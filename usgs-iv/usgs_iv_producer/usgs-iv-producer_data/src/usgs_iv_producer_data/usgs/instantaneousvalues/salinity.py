...
class Salinity:
    ...
    Attributes:
        ...
        value (typing.Optional[float]): {"description": "Salinity value."}
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"Salinity\", \"namespace\": \"USGS.InstantaneousValues\", \"doc\": \"USGS salinity data. Parameter code 00480.\", \"fields\": [{\"name\": \"site_no\", \"type\": \"string\", \"doc\": \"{'description': 'USGS site number.'}\"}, {\"name\": \"datetime\", \"type\": \"string\", \"doc\": \"{'description': 'Date and time of the measurement in ISO-8601 format.'}\"}, {\"name\": \"value\", \"type\": [\"double\", \"null\"], \"unit\": \"parts per thousand\", \"doc\": \"{'description': 'Salinity value.'}\"}, {\"name\": \"exception\", \"type\": [\"string\", \"null\"], \"doc\": \"{'description': 'Exception code when the value is unavailable.'}\"}, {\"name\": \"qualifiers\", \"type\": {\"type\": \"array\", \"items\": \"string\"}, \"doc\": \"{'description': 'Qualifiers for the measurement.'}\"}, {\"name\": \"parameter_cd\", \"type\": \"string\", \"doc\": \"{'description': 'Parameter code.'}\"}, {\"name\": \"timeseries_cd\", \"type\": \"string\", \"doc\": \"{'description': 'Timeseries code.'}\"}]}"), avro.name.Names()
    )

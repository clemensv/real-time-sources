...
class GageHeight:
    ...
    Attributes:
        ...
        value (typing.Optional[float]): {"description": "Gage height value."}
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"GageHeight\", \"doc\": \"USGS gage height data. Parameter code 00065.\", \"namespace\": \"USGS.InstantaneousValues\", \"fields\": [{\"name\": \"site_no\", \"type\": \"string\", \"doc\": \"{'description': 'USGS site number.'}\"}, {\"name\": \"datetime\", \"type\": \"string\", \"logicalType\": \"timestamp-millis\", \"doc\": \"{'description': 'Date and time of the measurement in ISO-8601 format.'}\"}, {\"name\": \"value\", \"type\": [\"double\", \"null\"], \"unit\": \"feet\", \"doc\": \"{'description': 'Gage height value.'}\"}, {\"name\": \"exception\", \"type\": [\"string\", \"null\"], \"doc\": \"{'description': 'Exception code when the value is unavailable.'}\"}, {\"name\": \"qualifiers\", \"type\": {\"type\": \"array\", \"items\": \"string\"}, \"doc\": \"{'description': 'Qualifiers for the measurement.'}\"}, {\"name\": \"parameter_cd\", \"type\": \"string\", \"doc\": \"{'description': 'Parameter code.'}\"}, {\"name\": \"timeseries_cd\", \"type\": \"string\", \"doc\": \"{'description': 'Timeseries code.'}\"}]}"), avro.name.Names()
    )
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'GageHeight':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['GageHeight']:
        """
        ...
        if base_content_type in ['avro/binary', 'application/vnd.apache.avro+avro', 'avro/json', 'application/vnd.apache.avro+json']:
            ...
            return GageHeight.from_serializer_dict(_record)
        if base_content_type == 'application/json':

...
class EquipmentStatus:
    ...
    def create_instance(cls) -> 'EquipmentStatus':
        ...
        """
        return cls(
            site_no='iguhdisstxpharugrwas',
            datetime='czrksexmzhgivgwtoxta',
            status='fujdpwjuqmrcmcxcahze',
            parameter_cd='fjpeetmomsbzvslnqtuc',
            timeseries_cd='mfqqcxgrggauhpxdgotw'
        )
...
class Observation:
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"Observation\", \"namespace\": \"fi.fmi.opendata.airquality\", \"doc\": \"Hourly FMI air quality observation aggregated per station and timestamp.\", \"fields\": [{\"name\": \"fmisid\", \"type\": \"string\", \"doc\": \"Stable FMI station identifier (fmisid) for the observing station.\", \"description\": \"Measurement payload for weather observations in the FMI Finland Weather source.\"}, {\"name\": \"station_name\", \"type\": \"string\", \"doc\": \"Station name resolved from station metadata or, if metadata lookup fails, the station identifier string.\", \"description\": \"Reference details for one station, monitoring site, or forecast area in the FMI Finland Weather source.\"}, {\"name\": \"observation_time\", \"type\": \"string\", \"doc\": \"Observation timestamp in UTC, formatted as an ISO-8601 instant such as 2024-01-15T13:00:00Z.\", \"description\": \"Measurement payload for weather observations in the FMI Finland Weather source.\"}, {\"name\": \"aqindex\", \"type\": [\"null\", \"double\"], \"default\": null, \"doc\": \"Finnish Air Quality Index 1-hour average.\", \"description\": \"Measurement payload for weather observations in the FMI Finland Weather source.\"}, {\"name\": \"pm10_ug_m3\", \"type\": [\"null\", \"double\"], \"default\": null, \"doc\": \"PM10 particulate matter concentration 1-hour average in micrograms per cubic meter.\", \"description\": \"Measurement payload for weather observations in the FMI Finland Weather source.\"}, {\"name\": \"pm2_5_ug_m3\", \"type\": [\"null\", \"double\"], \"default\": null, \"doc\": \"PM2.5 particulate matter concentration 1-hour average in micrograms per cubic meter.\", \"description\": \"Measurement payload for weather observations in the FMI Finland Weather source.\"}, {\"name\": \"no2_ug_m3\", \"type\": [\"null\", \"double\"], \"default\": null, \"doc\": \"Nitrogen dioxide concentration 1-hour average in micrograms per cubic meter.\", \"description\": \"Measurement payload for weather observations in the FMI Finland Weather source.\"}, {\"name\": \"o3_ug_m3\", \"type\": [\"null\", \"double\"], \"default\": null, \"doc\": \"Ozone concentration 1-hour average in micrograms per cubic meter.\", \"description\": \"Measurement payload for weather observations in the FMI Finland Weather source.\"}, {\"name\": \"so2_ug_m3\", \"type\": [\"null\", \"double\"], \"default\": null, \"doc\": \"Sulfur dioxide concentration 1-hour average in micrograms per cubic meter.\", \"description\": \"Measurement payload for weather observations in the FMI Finland Weather source.\"}, {\"name\": \"co_mg_m3\", \"type\": [\"null\", \"double\"], \"default\": null, \"doc\": \"Carbon monoxide concentration 1-hour average in milligrams per cubic meter.\", \"description\": \"Measurement payload for weather observations in the FMI Finland Weather source.\"}], \"description\": \"Measurement payload for weather observations in the FMI Finland Weather source.\"}"), avro.name.Names()
    )

...
class WeatherStation:
    """
    WSDOT weather station metadata.
    Attributes:
        station_id (str): 
        station_name (str): 
        latitude (float): 
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"WeatherStation\", \"namespace\": \"us.wa.wsdot.weather\", \"doc\": \"WSDOT weather station metadata.\", \"fields\": [{\"name\": \"station_id\", \"type\": \"string\"}, {\"name\": \"station_name\", \"type\": \"string\"}, {\"name\": \"latitude\", \"type\": \"double\"}, {\"name\": \"longitude\", \"type\": \"double\"}]}"), avro.name.Names()
    )

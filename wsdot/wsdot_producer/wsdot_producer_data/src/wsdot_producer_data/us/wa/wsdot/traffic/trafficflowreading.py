...
class TrafficFlowReading:
    ...
    flow_reading: str=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="flow_reading"))
    reading_time: str=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="reading_time"))
    
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"TrafficFlowReading\", \"namespace\": \"us.wa.wsdot.traffic\", \"doc\": \"Traffic flow reading.\", \"fields\": [{\"name\": \"flow_data_id\", \"type\": \"string\"}, {\"name\": \"station_name\", \"type\": \"string\"}, {\"name\": \"region\", \"type\": \"string\"}, {\"name\": \"flow_reading\", \"type\": \"string\"}, {\"name\": \"reading_time\", \"type\": \"string\"}]}"), avro.name.Names()
    )
    ...
    def __post_init__(self):
        ...
        self.flow_reading=str(self.flow_reading)

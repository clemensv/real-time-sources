...
class Measurement:
    ...
    sensor_code: str=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="sensor_code"))
    ...
    def create_instance(cls) -> 'Measurement':
        ...
        return cls(
            station_id=int(99),
            sensor_id=int(29),
            sensor_code='esfyhkgxmnvjsgwpnjee',
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            value=float(21.653108951630706)
        )
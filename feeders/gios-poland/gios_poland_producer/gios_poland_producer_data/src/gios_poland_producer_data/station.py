...
class Station:
    ...
    city_id: typing.Optional[int]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="city_id"))
    city_name: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="city_name"))
    commune: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="commune"))
    ...
    def create_instance(cls) -> 'Station':
        ...
        return cls(
            station_id=int(29),
            station_code='qqyjoqxozrxoeapvodaz',
            name='ujxxiqicalqsrcnrgtvp',
            latitude=float(30.610144194259558),
            longitude=float(19.620705809942695),
            city_id=int(94),
            city_name='mczwlzcmhgkblrexaexf',
            commune='mhwicrezzcitddlhbjqi',
            district='qdagnvfxipwyomzkafii',
            voivodeship='ohyluykyqkqydhrhpzbi',
            street='mdyiqcrrvrfhozkahdry'
        )
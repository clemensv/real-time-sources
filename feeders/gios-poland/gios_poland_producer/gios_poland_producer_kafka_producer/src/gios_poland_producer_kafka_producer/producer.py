...
class PlGovGiosAirqualityKafkaEventProducer:
    ...
    def send_pl_gov_gios_airquality_kafka_station(self,_station_id : str, data: Station, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
    ...
    def send_pl_gov_gios_airquality_kafka_air_quality_index(self,_station_id : str, data: AirQualityIndex, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, AirQualityIndex], str]=None) -> None:
        """
    ...
    def send_pl_gov_gios_airquality_kafka_sensor(self,_station_id : str, _sensor_id : str, data: Sensor, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Sensor], str]=None) -> None:
        """
    ...
    def send_pl_gov_gios_airquality_kafka_measurement(self,_station_id : str, _sensor_id : str, data: Measurement, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Measurement], str]=None) -> None:
        """

...
class PlGovGiosAirqualityKafkaEventProducer:
    ...
    def send_pl_gov_gios_airquality_kafka_station(self,_station_id : str, data: Station, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
        Sends the 'pl.gov.gios.airquality.kafka.Station' event to the Kafka topic
    ...
    def send_pl_gov_gios_airquality_kafka_air_quality_index(self,_station_id : str, data: AirQualityIndex, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, AirQualityIndex], str]=None) -> None:
        """
        Sends the 'pl.gov.gios.airquality.kafka.AirQualityIndex' event to the Kafka topic
    ...
    def send_pl_gov_gios_airquality_kafka_sensor(self,_station_id : str, _sensor_id : str, data: Sensor, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Sensor], str]=None) -> None:
        """
        Sends the 'pl.gov.gios.airquality.kafka.Sensor' event to the Kafka topic
    ...
    def send_pl_gov_gios_airquality_kafka_measurement(self,_station_id : str, _sensor_id : str, data: Measurement, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Measurement], str]=None) -> None:
        """
        Sends the 'pl.gov.gios.airquality.kafka.Measurement' event to the Kafka topic
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'PlGovGiosAirqualityKafkaEventProducer':
        """

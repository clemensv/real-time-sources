...
from gios_poland_mqtt_producer_data.measurement import Measurement
import datetime
...
class Test_Measurement(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Measurement(
            station_id=int(40),
            sensor_id=int(63),
            sensor_code='pvqmfzkocgumwbkiztos',
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            value=float(52.83021457444031)
        )
        return instance
    ...
    def test_sensor_code_property(self):
        ...
        """
        test_value = 'pvqmfzkocgumwbkiztos'
    ...
    def test_value_property(self):
        ...
        Test value property
        """
        test_value = float(52.83021457444031)

...
class PlGovGiosAirqualityAmqpProducer:
    """
    Producer class to send messages in the `pl.gov.gios.airquality.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_station(self,
        ...
        """
        Send the `pl.gov.gios.airquality.amqp.Station` message
        ...
        Args:
            ...
            _voivodeship (str): Value for AMQP protocol option placeholder voivodeship
        ...
        app_properties = {}
        app_properties["voivodeship"] = "{voivodeship}".format(voivodeship=_voivodeship)
    ...
    def send_station_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `pl.gov.gios.airquality.amqp.Station` messages
    ...
    def send_sensor(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `pl.gov.gios.airquality.amqp.Sensor` message
    ...
    def send_sensor_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `pl.gov.gios.airquality.amqp.Sensor` messages
    ...
    def send_measurement(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `pl.gov.gios.airquality.amqp.Measurement` message
    ...
    def send_measurement_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `pl.gov.gios.airquality.amqp.Measurement` messages
    ...
    def send_air_quality_index(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `pl.gov.gios.airquality.amqp.AirQualityIndex` message
        ...
        Args:
            ...
            _pollutant (str): Value for AMQP protocol option placeholder pollutant
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            data (AirQualityIndex): The message data object
            content_type (str): The content type of the message data (default: 'application/json')
        """
        # Build CloudEvent attributes
        attributes = {
    ...
    def send_air_quality_index_batch(self,
        data_array: typing.List[AirQualityIndex],
        _station_id: str,
        _voivodeship: str,
        _pollutant: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `pl.gov.gios.airquality.amqp.AirQualityIndex` messages
        
        Args:
            data_array (typing.List[AirQualityIndex]): Array of message data objects
            _station_id (str): Value for placeholder station_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            _voivodeship (str): Value for AMQP protocol option placeholder voivodeship
            _pollutant (str): Value for AMQP protocol option placeholder pollutant

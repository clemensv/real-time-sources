...
class Test_AirQualityIndex(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = AirQualityIndex(
            ...
            index_value=int(97),
            index_category='gerxiaqsasqdgjtbbfrk',
            ...
            so2_index_value=int(91),
            so2_index_category='tyidlaemdadtckgwkqxx',
            ...
            no2_index_value=int(7),
            no2_index_category='rbmtmlschqoutckisapi',
            ...
            pm10_index_value=int(5),
            pm10_index_category='emtrhvmsuwdozgibgdem',
            ...
            pm25_index_value=int(57),
            pm25_index_category='ocvajrxukoclllonrybb',
            ...
            o3_index_value=int(87),
            o3_index_category='pcloilsdnkwtvnobmufc',
            o3_source_data_timestamp=datetime.datetime.now(datetime.timezone.utc),
            overall_status=True,
            critical_pollutant_code='gbvqpyxtbaeclwrdnwpd'
        )
        return instance
    ...
    def test_index_category_property(self):
        ...
        """
        test_value = 'gerxiaqsasqdgjtbbfrk'
    ...
    def test_so2_index_category_property(self):
        ...
        """
        test_value = 'tyidlaemdadtckgwkqxx'
    ...
    def test_no2_index_category_property(self):
        ...
        """
        test_value = 'rbmtmlschqoutckisapi'
    ...
    def test_pm10_index_category_property(self):
        ...
        """
        test_value = 'emtrhvmsuwdozgibgdem'
    ...
    def test_pm25_index_category_property(self):
        ...
        """
        test_value = 'ocvajrxukoclllonrybb'
    ...
    def test_o3_index_category_property(self):
        ...
        """
        test_value = 'pcloilsdnkwtvnobmufc'
    ...
    def test_critical_pollutant_code_property(self):
        ...
        """
        test_value = 'gbvqpyxtbaeclwrdnwpd'

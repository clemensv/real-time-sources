...
from gios_poland_amqp_producer_data.measurement import Measurement
import datetime
...
class Test_Measurement(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Measurement(
            station_id=int(8),
            sensor_id=int(68),
            sensor_code='pxiiatwruomcqwlpecbt',
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            value=float(62.98704574707422)
        )
        return instance
    ...
    def test_sensor_code_property(self):
        ...
        """
        test_value = 'pxiiatwruomcqwlpecbt'
    ...
    def test_value_property(self):
        ...
        Test value property
        """
        test_value = float(62.98704574707422)

...
class NASAFIRMSAmqpProducer:
    """
    Producer class to send messages in the `NASA.FIRMS.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_fire_detection(self,
        ...
        amqp_msg.subject = "{source}/{record_id}".format(source=_source, record_id=_record_id)
    ...
    def send_fire_detection_batch(self,
        ...
        Args:
            data_array (typing.List[FireDetection]): Array of message data objects
            _source_uri (str): Value for placeholder source_uri in attribute source
            _source (str): Value for placeholder source in attribute subject
            _record_id (str): Value for placeholder record_id in attribute subject
            _event_time (str): Value for placeholder event_time in attribute time
    ...
    def send_data_availability(self,
    ...
    def send_data_availability_batch(self,
        ...
        Args:
            data_array (typing.List[DataAvailability]): Array of message data objects
            _source_uri (str): Value for placeholder source_uri in attribute source
            _source (str): Value for placeholder source in attribute subject
            _record_id (str): Value for placeholder record_id in attribute subject
            _event_time (str): Value for placeholder event_time in attribute time

...
"""
Sample usage of snotel_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send SnowObservation message
        print("Sending SnowObservation message...")
        # TODO: Create a SnowObservation instance with actual data
        # data = SnowObservation(...)
        # producer.send_snow_observation(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("SnowObservation message sent successfully!")

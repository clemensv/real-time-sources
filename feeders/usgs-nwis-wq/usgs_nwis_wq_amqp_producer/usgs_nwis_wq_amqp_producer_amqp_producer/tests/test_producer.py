...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../usgs_nwis_wq_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../usgs_nwis_wq_amqp_producer_amqp_producer/src')))
...
class TestUSGSWaterQualitySitesAmqpProducer:
    """Test cases for USGSWaterQualitySitesAmqpProducer"""
...
class TestUSGSWaterQualityReadingsAmqpProducer:
    """Test cases for USGSWaterQualityReadingsAmqpProducer"""

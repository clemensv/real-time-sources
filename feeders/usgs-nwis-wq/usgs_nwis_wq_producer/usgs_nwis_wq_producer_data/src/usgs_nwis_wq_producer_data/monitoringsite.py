...
class MonitoringSite:
    """
    USGS water quality monitoring site. Describes a physical surface-water or groundwater monitoring location equipped with continuous water quality sensors. Site metadata is extracted from the WaterML 2.0 JSON response sourceInfo block returned by the USGS Instantaneous Values Service.
    ...
    Attributes:
        ...
        parameter_code (typing.Optional[str])
    """
    ...
    parameter_code: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="parameter_code"))
    ...
    @classmethod
    def create_instance(cls) -> 'MonitoringSite':
        """
        ...
        """
        return cls(
            site_number='bzmjorvthlvxnolxvjgt',
            site_name='cgydvtgvndnyfsdanomv',
            agency_code='lromncvjejbyiztgozgl',
            latitude=float(57.77344132272001),
            longitude=float(70.59730449416875),
            site_type='nouqdqgthawgvwksrykz',
            state_code='wijrgrbmrkjcaeytuyfi',
            county_code='zbrcifxufvdxejwlbnuq',
            huc_code='gfwzmdqteltmidfhpfrc',
            state='obgmrrqcotltydbgalbg',
            parameter_code='jwjgjdwxbbbgxlbzzaqq'
        )
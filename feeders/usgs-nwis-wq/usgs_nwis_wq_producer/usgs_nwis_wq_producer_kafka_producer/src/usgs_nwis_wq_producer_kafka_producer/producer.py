...
class USGSWaterQualitySitesEventProducer:
    ...
    def send_usgs_water_quality_sites_monitoring_site(self,_source_uri : str, _site_number : str, data: MonitoringSite, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, MonitoringSite], str]=None) -> None:
        ...
        """
        kafka_key = "{site_number}".format(site_number=_site_number)
        attributes = {
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'USGSWaterQualitySitesEventProducer':
        """
...
class USGSWaterQualityReadingsEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    def send_usgs_water_quality_readings_water_quality_reading(self,_source_uri : str, _site_number : str, _parameter_code : str, data: WaterQualityReading, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, WaterQualityReading], str]=None) -> None:
        ...
        """
        kafka_key = "{site_number}/{parameter_code}".format(site_number=_site_number, parameter_code=_parameter_code)
        attributes = {
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'USGSWaterQualityReadingsEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.
...
class USGSWaterQualitySitesMqttEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'USGSWaterQualitySitesMqttEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.
...
class USGSWaterQualitySitesAmqpEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'USGSWaterQualitySitesAmqpEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.
...
class USGSWaterQualityReadingsMqttEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'USGSWaterQualityReadingsMqttEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.
...
class USGSWaterQualityReadingsAmqpEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'USGSWaterQualityReadingsAmqpEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.

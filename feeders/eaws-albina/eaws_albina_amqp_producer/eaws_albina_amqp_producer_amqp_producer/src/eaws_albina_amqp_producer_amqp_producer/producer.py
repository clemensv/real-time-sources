...
class OrgEAWSALBINAAmqpProducer:
    """
    Producer class to send messages in the `org.EAWS.ALBINA.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_avalanche_bulletin(self,
        ...
        """
        Send the `org.EAWS.ALBINA.amqp.AvalancheBulletin` message
        ...
        Args:
            ...
            _danger_level (str): Value for AMQP protocol option placeholder danger_level
        ...
        app_properties["danger_level"] = "{danger_level}".format(danger_level=_danger_level)
        if app_properties:
        ...
        annotations = {}
        annotation_value = "{region_id}".format(region_id=_region_id)
    ...
    def send_avalanche_bulletin_batch(self,
        data_array: typing.List[AvalancheBulletin],
        _region_id: str,
        _country: str,
        _danger_level: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `org.EAWS.ALBINA.amqp.AvalancheBulletin` messages
        
        Args:
            data_array (typing.List[AvalancheBulletin]): Array of message data objects
            _region_id (str): Value for placeholder region_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            _country (str): Value for AMQP protocol option placeholder country
            _danger_level (str): Value for AMQP protocol option placeholder danger_level
        ...
        for data in data_array:
            self.send_avalanche_bulletin(
                data=data,
                _region_id=_region_id,
                _time=_time,
                _country=_country,
                _danger_level=_danger_level,

...
from eaws_albina_amqp_producer_data.avalancheregion import AvalancheRegion
import datetime
...
class Test_AvalancheRegion(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = AvalancheRegion(
            region_id='hidsmuzrhmgwvuqqgyka',
            lang='rbxxyuhfegukyuatgjzg',
            configured_at=datetime.datetime.now(datetime.timezone.utc),
            bulletin_base_url='vphzhlyisukazbjmwesg'
        )
        return instance
    ...
    def test_region_id_property(self):
        ...
        """
        test_value = 'hidsmuzrhmgwvuqqgyka'
    ...
    def test_lang_property(self):
        ...
        Test lang property
        """
        test_value = 'rbxxyuhfegukyuatgjzg'
    ...
    def test_bulletin_base_url_property(self):
        ...
        """
        test_value = 'vphzhlyisukazbjmwesg'

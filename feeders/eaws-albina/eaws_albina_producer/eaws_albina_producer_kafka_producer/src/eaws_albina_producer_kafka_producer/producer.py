...
class OrgEAWSALBINAMqttEventProducer:
    ...
    def send_org_eaws_albina_mqtt_avalanche_bulletin(self,_region_id : str, data: AvalancheBulletin, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, AvalancheBulletin], str]=None) -> None:
        """

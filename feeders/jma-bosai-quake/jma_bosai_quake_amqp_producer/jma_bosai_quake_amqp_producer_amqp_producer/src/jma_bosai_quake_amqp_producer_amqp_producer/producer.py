...
class JPJMAQuakeAmqpProducer:
    """
    Producer class to send messages in the `JP.JMA.Quake.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_earthquake_report(self,
        ...
        attributes = {
            ...
            "subject":
            "jp.jma.quake/{event_id}/{serial}".format(event_id=_event_id, serial=_serial),
        }
    ...
    def send_earthquake_report_batch(self,
        data_array: typing.List[EarthquakeReport],
        _feedurl: str,
        _event_id: str,
        _serial: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        ...
        Args:
            data_array (typing.List[EarthquakeReport]): Array of message data objects
            _feedurl (str): Value for placeholder feedurl in attribute source
            _event_id (str): Value for placeholder event_id in attribute subject
            _serial (str): Value for placeholder serial in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.

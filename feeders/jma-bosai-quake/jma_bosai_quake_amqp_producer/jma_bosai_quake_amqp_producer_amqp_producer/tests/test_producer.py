...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../jma_bosai_quake_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../jma_bosai_quake_amqp_producer_amqp_producer/src')))
...
class TestJPJMAQuakeAmqpProducer:
    """Test cases for JPJMAQuakeAmqpProducer"""
        ...
        try:
            ...
            for i in range(5):
                ...
                if True:
                    ...
                    assert cloud_event_payload.get("type") == "JP.JMA.Quake.EarthquakeReport"
    ...
    def test_send_earthquake_report_single_fresh_connection(self, artemis_container):
        ...
        properties = received.properties or {}
        annotations = received.annotations or {}
        assert properties.get('cloudEvents:type') == 'JP.JMA.Quake.EarthquakeReport'
        assert received.body is not None
        assert received.subject == "jp.jma.quake/{event_id}/{serial}".format(event_id="value", serial="value")

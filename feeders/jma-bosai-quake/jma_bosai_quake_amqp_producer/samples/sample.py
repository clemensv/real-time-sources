...
"""
Sample usage of jma_bosai_quake_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send EarthquakeReport message
        print("Sending EarthquakeReport message...")
        # TODO: Create a EarthquakeReport instance with actual data
        # data = EarthquakeReport(...)
        # producer.send_earthquake_report(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("EarthquakeReport message sent successfully!")

...
class JmaBosaiQuakeAPI:
    ...
    def normalize_report(self, entry: Dict[str, Any], detail: Optional[Dict[str, Any]] = None) -> EarthquakeReport:
        ...
        return EarthquakeReport(
            ...
            report_datetime=datetime.fromisoformat(to_utc_rfc3339(str(entry["rdt"]))),
            report_datetime_local=datetime.fromisoformat(str(entry["rdt"])),
            control_datetime=datetime.fromisoformat(control_datetime),
            control_datetime_local=datetime.fromisoformat(control_datetime_local),
            origin_datetime=datetime.fromisoformat(to_utc_rfc3339(str(entry["at"]))),
            origin_datetime_local=datetime.fromisoformat(str(entry["at"])),

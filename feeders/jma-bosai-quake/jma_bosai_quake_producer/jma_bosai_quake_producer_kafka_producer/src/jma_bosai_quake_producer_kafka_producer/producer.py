...
class JPJMAQuakeEventProducer:
    ...
    def send_jp_jma_quake_earthquake_report(self,_feedurl : str, _event_id : str, _serial : str, data: EarthquakeReport, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, EarthquakeReport], str]=None) -> None:
        """
        Sends the 'JP.JMA.Quake.EarthquakeReport' event to the Kafka topic
        ...
        Args:
            ...
            data: (EarthquakeReport): The event data to be sent
            content_type (str): The content type that the event data shall be sent with
            _time(typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            flush_producer(bool): Whether to flush the producer after sending the event (default: True)
            key_mapper(Callable[[CloudEvent, EarthquakeReport], str]): A function to map the CloudEvent contents to a Kafka key (default: None).
                The default key is derived from the xRegistry Kafka key declaration 'jp.jma.quake/{event_id}/{serial}'
        """
        kafka_key = "jp.jma.quake/{event_id}/{serial}".format(event_id=_event_id, serial=_serial)
        attributes = {
             "type":"JP.JMA.Quake.EarthquakeReport",
             "source":"{feedurl}".format(feedurl = _feedurl),
             "subject":"jp.jma.quake/{event_id}/{serial}".format(event_id = _event_id,serial = _serial)
        }
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'JPJMAQuakeEventProducer':
        """

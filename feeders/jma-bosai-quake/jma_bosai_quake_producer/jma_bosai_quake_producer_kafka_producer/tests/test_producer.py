...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../jma_bosai_quake_producer_data/src')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../jma_bosai_quake_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../jma_bosai_quake_producer_kafka_producer/src')))
...
def test_jp_jma_quake_jpjmaquakeearthquakereport(kafka_emulator):
    """Test the JPJMAQuakeEarthquakeReport event from the JP.JMA.Quake message group"""
    ...
    consumer = Consumer({
        ...
        'group.id': 'test_jp_jma_quake_jpjmaquakeearthquakereport',  # Unique group per test
    ...
    def on_event():
        ...
        while True:
            ...
            if cloudevent['type'] == "JP.JMA.Quake.EarthquakeReport":
                return msg.key().decode('utf-8') if msg.key() else None

    kafka_producer = Producer({'bootstrap.servers': bootstrap_servers})
    producer_instance = JPJMAQuakeEventProducer(kafka_producer, topic, 'binary')

...
class Test_EarthquakeReport(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = EarthquakeReport(
            prefecture='efupvngrlliqeifnpqwr',
            magnitude_bucket='gtjwzwcnbnwvzvoxwwho',
            event_id='dacojksisujnqkvbseya',
            serial=int(21),
            report_id='lucorzoxtsmwbquuaqtj',
            ...
            title_jp='qrdvquddjuoayobcdfjk',
            title_en='isafvunpxkeufgmbsocz',
            epicenter_area_code='moehkyfiknrvspvwgaan',
            epicenter_area_jp='ptbrewippauxbewfybqf',
            epicenter_area_en='dpyfkxqscdgmrhoimlyb',
            latitude=float(27.94821870205618),
            longitude=float(15.377646803451473),
            depth_km=float(49.66615766291521),
            magnitude=float(19.415006460197382),
            max_intensity=MaxIntensityenum.VALUE_1,
            bulletin_type=BulletinTypeenum.VXSE51,
            detail_url='oxvazesycxvvutijmfly',
            affected_prefectures=[None, None, None],
            affected_cities=[None, None, None],
    ...
    def test_prefecture_property(self):
        ...
        """
        test_value = 'efupvngrlliqeifnpqwr'
    ...
    def test_magnitude_bucket_property(self):
        ...
        """
        test_value = 'gtjwzwcnbnwvzvoxwwho'
    ...
    def test_event_id_property(self):
        ...
        """
        test_value = 'dacojksisujnqkvbseya'
    ...
    def test_report_id_property(self):
        ...
        """
        test_value = 'lucorzoxtsmwbquuaqtj'
    ...
    def test_title_jp_property(self):
        ...
        """
        test_value = 'qrdvquddjuoayobcdfjk'
    ...
    def test_title_en_property(self):
        ...
        """
        test_value = 'isafvunpxkeufgmbsocz'
    ...
    def test_epicenter_area_code_property(self):
        ...
        """
        test_value = 'moehkyfiknrvspvwgaan'
    ...
    def test_epicenter_area_jp_property(self):
        ...
        """
        test_value = 'ptbrewippauxbewfybqf'
    ...
    def test_epicenter_area_en_property(self):
        ...
        """
        test_value = 'dpyfkxqscdgmrhoimlyb'
    ...
    def test_latitude_property(self):
        ...
        """
        test_value = float(27.94821870205618)
    ...
    def test_longitude_property(self):
        ...
        """
        test_value = float(15.377646803451473)
    ...
    def test_depth_km_property(self):
        ...
        """
        test_value = float(49.66615766291521)
    ...
    def test_magnitude_property(self):
        ...
        """
        test_value = float(19.415006460197382)
    ...
    def test_detail_url_property(self):
        ...
        """
        test_value = 'oxvazesycxvvutijmfly'

...
class DemandActual:
    ...
    solar_generation_jp_unit_value: typing.Optional[int]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="solar_generation_jp_unit_value"))
    solar_share_pct: typing.Optional[float]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="solar_share_pct"))
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['DemandActual']:
        """
    ...
    def create_instance(cls) -> 'DemandActual':
        ...
        return cls(
            ...
            time='ycnbqsrdvgyjanzlqwmk',
            datetime=datetime.datetime.now(datetime.timezone.utc),
            datetime_local=datetime.datetime.now(datetime.timezone.utc),
            actual_demand_mw=float(35.683973868206465),
            actual_demand_jp_unit_value=int(59),
            solar_generation_mw=float(16.84351000309675),
            solar_generation_jp_unit_value=int(31),
            solar_share_pct=float(63.07988808206002),
            usage_pct=float(27.31721769293066),
            supply_capacity_mw=float(16.72274192366814),
            supply_capacity_jp_unit_value=int(17),
            area_code='ztiurepntbmzivzgbijp'
        )
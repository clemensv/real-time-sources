...
class Test_PeakDemandForecast(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = PeakDemandForecast(
            ...
            time='jtmxctiqgewnhefclbig',
            peak_demand_forecast_mw=float(28.13897948684938),
            peak_demand_forecast_jp_unit_value=int(54),
            peak_time_slot='bycofyujlwbcooteygga',
            ...
            area_code='jhpbmryrhlfqrbfiofam',
            area_name_jp='crxxojgcgxpcaiztzyuh',
            area_name_en='gnugzaduyeyicfcyqhpf'
        )
        return instance
    ...
    def test_time_property(self):
        ...
        Test time property
        """
        test_value = 'jtmxctiqgewnhefclbig'
    ...
    def test_peak_demand_forecast_mw_property(self):
        ...
        """
        test_value = float(28.13897948684938)
    ...
    def test_peak_time_slot_property(self):
        ...
        """
        test_value = 'bycofyujlwbcooteygga'
    ...
    def test_area_code_property(self):
        ...
        """
        test_value = 'jhpbmryrhlfqrbfiofam'
    ...
    def test_area_name_jp_property(self):
        ...
        """
        test_value = 'crxxojgcgxpcaiztzyuh'
    ...
    def test_area_name_en_property(self):
        ...
        """
        test_value = 'gnugzaduyeyicfcyqhpf'

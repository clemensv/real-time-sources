...
class Test_DemandForecast(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = DemandForecast(
            ...
            time='qxuvtlfaipuhtkyaldwb',
            datetime=datetime.datetime.now(datetime.timezone.utc),
            datetime_local=datetime.datetime.now(datetime.timezone.utc),
            forecast_demand_mw=float(24.005216902349822),
            forecast_demand_jp_unit_value=int(34),
            usage_pct=float(98.50544611988799),
            supply_capacity_mw=float(86.98266309910014),
            supply_capacity_jp_unit_value=int(89),
            area_code='illuyndzuymtynshxqro'
        )
        return instance
    ...
    def test_time_property(self):
        ...
        Test time property
        """
        test_value = 'qxuvtlfaipuhtkyaldwb'
    ...
    def test_forecast_demand_mw_property(self):
        ...
        """
        test_value = float(24.005216902349822)
    ...
    def test_usage_pct_property(self):
        ...
        """
        test_value = float(98.50544611988799)
    ...
    def test_supply_capacity_mw_property(self):
        ...
        """
        test_value = float(86.98266309910014)
    ...
    def test_area_code_property(self):
        ...
        """
        test_value = 'illuyndzuymtynshxqro'

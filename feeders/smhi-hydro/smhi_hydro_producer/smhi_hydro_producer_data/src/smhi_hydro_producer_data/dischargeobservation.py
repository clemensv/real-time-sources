...
class DischargeObservation:
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.parse(
        "{\"type\": \"record\", \"name\": \"DischargeObservation\", \"doc\": \"DischargeObservation\", \"fields\": [{\"name\": \"station_id\", \"type\": \"string\"}, {\"name\": \"station_name\", \"type\": \"string\"}, {\"name\": \"catchment_name\", \"type\": \"string\", \"doc\": \"Name of the catchment area the station belongs to (SMHI 'catchmentName' field, e.g. 'Torne\u00e4lven', 'Dal\u00e4lven'). Sourced by the bridge from the SMHI bulk API station catalog and propagated onto every observation so subscribers do not need an out-of-band catalog join to route by catchment. When the catalog has no catchmentName the bridge substitutes the lowercase sentinel 'unknown'. Used as the {catchment_name} segment of the MQTT/UNS topic and normalized to lowercase kebab-case before publishing.\"}, {\"name\": \"timestamp\", \"type\": {\"type\": \"string\", \"logicalType\": \"timestamp-millis\"}}, {\"name\": \"discharge\", \"type\": \"double\"}, {\"name\": \"quality\", \"type\": [\"null\", \"string\"], \"default\": null}]}"
    )
    ...
    def from_serializer_dict(cls, data: dict) -> 'DischargeObservation':
        ...
        return cls(**data)
    @classmethod
    def from_avro_dict(cls, data: dict) -> 'DischargeObservation':
        """
        ...
        if 'quality' in converted and converted['quality'] is not None:
            value = converted['quality']
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['DischargeObservation']:
        """
        ...
        if base_content_type in ['avro/binary', 'application/vnd.apache.avro+avro']:
            if isinstance(data, bytes):
                ...
                with io.BytesIO(data) as stream:
                    ...
                    return DischargeObservation.from_avro_dict(_record)
            else:
    ...
    @classmethod
    def create_instance(cls) -> 'DischargeObservation':
        """

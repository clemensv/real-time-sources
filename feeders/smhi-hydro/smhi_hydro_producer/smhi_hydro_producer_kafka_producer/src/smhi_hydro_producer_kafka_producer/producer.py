...
class SEGovSMHIHydroEventProducer:
    ...
    def send_se_gov_smhi_hydro_station(self,_station_id : str, data: Station, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
    ...
    def send_se_gov_smhi_hydro_discharge_observation(self,_station_id : str, data: DischargeObservation, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, DischargeObservation], str]=None) -> None:
        """
...
class SEGovSMHIHydroMqttEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    def send_se_gov_smhi_hydro_mqtt_station(self,_station_id : str, data: Station, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
        Sends the 'SE.Gov.SMHI.Hydro.mqtt.Station' event to the Kafka topic
    ...
    def send_se_gov_smhi_hydro_mqtt_discharge_observation(self,_station_id : str, data: DischargeObservation, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, DischargeObservation], str]=None) -> None:
        """
        Sends the 'SE.Gov.SMHI.Hydro.mqtt.DischargeObservation' event to the Kafka topic
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'SEGovSMHIHydroMqttEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.
...
class SEGovSMHIHydroAmqpEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    def send_se_gov_smhi_hydro_amqp_station(self,_station_id : str, data: Station, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
        Sends the 'SE.Gov.SMHI.Hydro.amqp.Station' event to the Kafka topic
    ...
    def send_se_gov_smhi_hydro_amqp_discharge_observation(self,_station_id : str, data: DischargeObservation, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, DischargeObservation], str]=None) -> None:
        """
        Sends the 'SE.Gov.SMHI.Hydro.amqp.DischargeObservation' event to the Kafka topic
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'SEGovSMHIHydroAmqpEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.

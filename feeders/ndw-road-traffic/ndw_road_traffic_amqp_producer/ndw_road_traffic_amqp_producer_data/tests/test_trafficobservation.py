...
from ndw_road_traffic_amqp_producer_data.trafficobservation import TrafficObservation
...
class Test_TrafficObservation(unittest.TestCase):
    ...
    def test_measurement_site_id_property(self):
        ...
        """
        test_value = 'zenrxoahhjpljrkzndet'
    ...
    def test_measurement_time_property(self):
        ...
        """
        test_value = 'cmkszofuaoznuljglukq'
    ...
    def test_average_speed_property(self):
        ...
        """
        test_value = float(52.605270228616504)

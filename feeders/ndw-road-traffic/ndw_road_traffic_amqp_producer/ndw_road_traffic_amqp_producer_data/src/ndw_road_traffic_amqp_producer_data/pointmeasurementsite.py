""" PointMeasurementSite dataclass. """
...
class PointMeasurementSite:
    ...
    Attributes:
        ...
        lane_count (typing.Optional[int])
        carriageway_type (typing.Optional[str])
    """
    ...
    lane_count: typing.Optional[int]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="lane_count"))
    carriageway_type: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="carriageway_type"))

    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'PointMeasurementSite':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['PointMeasurementSite']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return PointMeasurementSite.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'PointMeasurementSite':
        """
        ...
        """
        return cls(
            measurement_site_id='yfizfgdhnuqoaffwnzev',
            name='fyzvyuxthohpjgqsgxxw',
            measurement_site_type='jnltmisfskhqbiligljx',
            period=int(57),
            latitude=float(41.813171068322205),
            longitude=float(4.565103635446032),
            road_name='amllgyqgrzdbqrxsmnkc',
            lane_count=int(42),
            carriageway_type='dltdyujhdpnwtkjrfmxc'
        )
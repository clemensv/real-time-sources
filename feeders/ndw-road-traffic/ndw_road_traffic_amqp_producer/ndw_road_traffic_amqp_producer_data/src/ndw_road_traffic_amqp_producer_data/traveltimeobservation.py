""" TravelTimeObservation dataclass. """
...
class TravelTimeObservation:
    ...
    duration: typing.Optional[float]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="duration"))
    reference_duration: typing.Optional[float]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="reference_duration"))
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'TravelTimeObservation':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['TravelTimeObservation']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return TravelTimeObservation.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'TravelTimeObservation':
        """
        ...
        """
        return cls(
            measurement_site_id='vtjctbbbnlsosivlxftq',
            measurement_time='zxqhxqzvnflovahigeco',
            duration=float(17.982182782591703),
            reference_duration=float(64.94572316606492),
            accuracy=float(1.0562428203460206),
            data_quality=float(49.507176229308236),
            number_of_input_values=int(36)
        )
...
class MsiSign:
    ...
    sign_type: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="sign_type"))
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'MsiSign':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['MsiSign']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return MsiSign.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'MsiSign':
        """
        ...
        """
        return cls(
            sign_id='xtjtahfhityewirhxcwg',
            sign_type='vgabsylmuvdsdxickglc',
            latitude=float(58.263100339525195),
            longitude=float(78.51679057374415),
            road_name='sxeuznuvxgqusqcbkchh',
            lane='tjcmwkouokgkaqhggzvt',
            description='stllotfkhnzlgkqwnqjr'
        )
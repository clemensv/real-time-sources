...
xrcg generate --style kafkaproducer --language py --definitions $xregFile --projectname ndw_road_traffic_producer --output (Join-Path $scriptDir 'ndw_road_traffic_producer')

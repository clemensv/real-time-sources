...
def test_nl_ndw_avg_mqtt_nlndwavgpointmeasurementsitemqtt(kafka_emulator):
    """Test the NLNDWAVGPointMeasurementSiteMqtt event from the NL.NDW.AVG.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_avg_mqtt_nlndwavgpointmeasurementsitemqtt',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
    ...
    kafka_producer = Producer({'bootstrap.servers': bootstrap_servers})
    producer_instance = NLNDWAVGMqttEventProducer(kafka_producer, topic, 'binary')
    # Create valid test data using the test helper
    event_data = Test_PointMeasurementSite.create_instance()
...
def test_nl_ndw_avg_mqtt_nlndwavgroutemeasurementsitemqtt(kafka_emulator):
    """Test the NLNDWAVGRouteMeasurementSiteMqtt event from the NL.NDW.AVG.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_avg_mqtt_nlndwavgroutemeasurementsitemqtt',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_nl_ndw_avg_mqtt_nlndwavgtrafficobservationmqtt(kafka_emulator):
    """Test the NLNDWAVGTrafficObservationMqtt event from the NL.NDW.AVG.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_avg_mqtt_nlndwavgtrafficobservationmqtt',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_nl_ndw_avg_mqtt_nlndwavgtraveltimeobservationmqtt(kafka_emulator):
    """Test the NLNDWAVGTravelTimeObservationMqtt event from the NL.NDW.AVG.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_avg_mqtt_nlndwavgtraveltimeobservationmqtt',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_nl_ndw_drip_mqtt_nlndwdripdripsignmqtt(kafka_emulator):
    """Test the NLNDWDRIPDripSignMqtt event from the NL.NDW.DRIP.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_drip_mqtt_nlndwdripdripsignmqtt',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
    ...
    kafka_producer = Producer({'bootstrap.servers': bootstrap_servers})
    producer_instance = NLNDWDRIPMqttEventProducer(kafka_producer, topic, 'binary')
    # Create valid test data using the test helper
    event_data = Test_DripSign.create_instance()
...
def test_nl_ndw_drip_mqtt_nlndwdripdripdisplaystatemqtt(kafka_emulator):
    """Test the NLNDWDRIPDripDisplayStateMqtt event from the NL.NDW.DRIP.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_drip_mqtt_nlndwdripdripdisplaystatemqtt',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_nl_ndw_msi_mqtt_nlndwmsimsisignmqtt(kafka_emulator):
    """Test the NLNDWMSIMsiSignMqtt event from the NL.NDW.MSI.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_msi_mqtt_nlndwmsimsisignmqtt',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
    ...
    kafka_producer = Producer({'bootstrap.servers': bootstrap_servers})
    producer_instance = NLNDWMSIMqttEventProducer(kafka_producer, topic, 'binary')
    # Create valid test data using the test helper
    event_data = Test_MsiSign.create_instance()
...
def test_nl_ndw_msi_mqtt_nlndwmsimsidisplaystatemqtt(kafka_emulator):
    """Test the NLNDWMSIMsiDisplayStateMqtt event from the NL.NDW.MSI.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_msi_mqtt_nlndwmsimsidisplaystatemqtt',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_nl_ndw_situations_mqtt_nlndwsituationsroadworkmqtt(kafka_emulator):
    """Test the NLNDWSituationsRoadworkMqtt event from the NL.NDW.Situations.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_situations_mqtt_nlndwsituationsroadworkmqtt',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
    ...
    kafka_producer = Producer({'bootstrap.servers': bootstrap_servers})
    producer_instance = NLNDWSituationsMqttEventProducer(kafka_producer, topic, 'binary')
    # Create valid test data using the test helper
    event_data = Test_Roadwork.create_instance()
...
def test_nl_ndw_situations_mqtt_nlndwsituationsbridgeopeningmqtt(kafka_emulator):
    """Test the NLNDWSituationsBridgeOpeningMqtt event from the NL.NDW.Situations.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_situations_mqtt_nlndwsituationsbridgeopeningmqtt',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_nl_ndw_situations_mqtt_nlndwsituationstemporaryclosuremqtt(kafka_emulator):
    """Test the NLNDWSituationsTemporaryClosureMqtt event from the NL.NDW.Situations.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_situations_mqtt_nlndwsituationstemporaryclosuremqtt',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_nl_ndw_situations_mqtt_nlndwsituationstemporaryspeedlimitmqtt(kafka_emulator):
    """Test the NLNDWSituationsTemporarySpeedLimitMqtt event from the NL.NDW.Situations.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_situations_mqtt_nlndwsituationstemporaryspeedlimitmqtt',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_nl_ndw_situations_mqtt_nlndwsituationssafetyrelatedmessagemqtt(kafka_emulator):
    """Test the NLNDWSituationsSafetyRelatedMessageMqtt event from the NL.NDW.Situations.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_situations_mqtt_nlndwsituationssafetyrelatedmessagemqtt',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_nl_ndw_avg_amqp_nlndwavgpointmeasurementsiteamqp(kafka_emulator):
    """Test the NLNDWAVGPointMeasurementSiteAmqp event from the NL.NDW.AVG.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_avg_amqp_nlndwavgpointmeasurementsiteamqp',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
    ...
    kafka_producer = Producer({'bootstrap.servers': bootstrap_servers})
    producer_instance = NLNDWAVGAmqpEventProducer(kafka_producer, topic, 'binary')
    # Create valid test data using the test helper
    event_data = Test_PointMeasurementSite.create_instance()
...
def test_nl_ndw_avg_amqp_nlndwavgroutemeasurementsiteamqp(kafka_emulator):
    """Test the NLNDWAVGRouteMeasurementSiteAmqp event from the NL.NDW.AVG.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_avg_amqp_nlndwavgroutemeasurementsiteamqp',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_nl_ndw_avg_amqp_nlndwavgtrafficobservationamqp(kafka_emulator):
    """Test the NLNDWAVGTrafficObservationAmqp event from the NL.NDW.AVG.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_avg_amqp_nlndwavgtrafficobservationamqp',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_nl_ndw_avg_amqp_nlndwavgtraveltimeobservationamqp(kafka_emulator):
    """Test the NLNDWAVGTravelTimeObservationAmqp event from the NL.NDW.AVG.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_avg_amqp_nlndwavgtraveltimeobservationamqp',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_nl_ndw_drip_amqp_nlndwdripdripsignamqp(kafka_emulator):
    """Test the NLNDWDRIPDripSignAmqp event from the NL.NDW.DRIP.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_drip_amqp_nlndwdripdripsignamqp',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
    ...
    kafka_producer = Producer({'bootstrap.servers': bootstrap_servers})
    producer_instance = NLNDWDRIPAmqpEventProducer(kafka_producer, topic, 'binary')
    # Create valid test data using the test helper
    event_data = Test_DripSign.create_instance()
...
def test_nl_ndw_drip_amqp_nlndwdripdripdisplaystateamqp(kafka_emulator):
    """Test the NLNDWDRIPDripDisplayStateAmqp event from the NL.NDW.DRIP.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_drip_amqp_nlndwdripdripdisplaystateamqp',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_nl_ndw_msi_amqp_nlndwmsimsisignamqp(kafka_emulator):
    """Test the NLNDWMSIMsiSignAmqp event from the NL.NDW.MSI.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_msi_amqp_nlndwmsimsisignamqp',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
    ...
    kafka_producer = Producer({'bootstrap.servers': bootstrap_servers})
    producer_instance = NLNDWMSIAmqpEventProducer(kafka_producer, topic, 'binary')
    # Create valid test data using the test helper
    event_data = Test_MsiSign.create_instance()
...
def test_nl_ndw_msi_amqp_nlndwmsimsidisplaystateamqp(kafka_emulator):
    """Test the NLNDWMSIMsiDisplayStateAmqp event from the NL.NDW.MSI.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_msi_amqp_nlndwmsimsidisplaystateamqp',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_nl_ndw_situations_amqp_nlndwsituationsroadworkamqp(kafka_emulator):
    """Test the NLNDWSituationsRoadworkAmqp event from the NL.NDW.Situations.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_situations_amqp_nlndwsituationsroadworkamqp',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
    ...
    kafka_producer = Producer({'bootstrap.servers': bootstrap_servers})
    producer_instance = NLNDWSituationsAmqpEventProducer(kafka_producer, topic, 'binary')
    # Create valid test data using the test helper
    event_data = Test_Roadwork.create_instance()
...
def test_nl_ndw_situations_amqp_nlndwsituationsbridgeopeningamqp(kafka_emulator):
    """Test the NLNDWSituationsBridgeOpeningAmqp event from the NL.NDW.Situations.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_situations_amqp_nlndwsituationsbridgeopeningamqp',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_nl_ndw_situations_amqp_nlndwsituationstemporaryclosureamqp(kafka_emulator):
    """Test the NLNDWSituationsTemporaryClosureAmqp event from the NL.NDW.Situations.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_situations_amqp_nlndwsituationstemporaryclosureamqp',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_nl_ndw_situations_amqp_nlndwsituationstemporaryspeedlimitamqp(kafka_emulator):
    """Test the NLNDWSituationsTemporarySpeedLimitAmqp event from the NL.NDW.Situations.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_situations_amqp_nlndwsituationstemporaryspeedlimitamqp',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_nl_ndw_situations_amqp_nlndwsituationssafetyrelatedmessageamqp(kafka_emulator):
    """Test the NLNDWSituationsSafetyRelatedMessageAmqp event from the NL.NDW.Situations.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_nl_ndw_situations_amqp_nlndwsituationssafetyrelatedmessageamqp',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])

""" SafetyRelatedMessage dataclass. """
...
class SafetyRelatedMessage:
    ...
    message_type: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="message_type"))
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'SafetyRelatedMessage':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['SafetyRelatedMessage']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return SafetyRelatedMessage.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'SafetyRelatedMessage':
        """
        ...
        """
        return cls(
            situation_record_id='fzubuxpmpzldjubtdrer',
            version_time='ramhcmlxgdfcylzozznq',
            validity_status='hvcteatfqyayvstmdzxt',
            start_time='rdvnoyymqianhcqcgdzt',
            end_time='yjswniddihaqozwtjsmo',
            road_name='qgqxvyeejhomnmyeqhwv',
            message_type='dzaoysetvrgjdmxbronv',
            description='qouiupdtcuetqkrtjqli',
            urgency='lqdxreacasufblgvsmqk'
        )
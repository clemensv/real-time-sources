...
class TemporarySpeedLimit:
    ...
    Attributes:
        ...
        speed_limit_kmh (typing.Optional[int])
    ...
    speed_limit_kmh: typing.Optional[int]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="speed_limit_kmh"))
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'TemporarySpeedLimit':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['TemporarySpeedLimit']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return TemporarySpeedLimit.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'TemporarySpeedLimit':
        """
        ...
        """
        return cls(
            situation_record_id='kcdqhxdolxtjuqscnctd',
            version_time='lfxplqtdacrdgstqperh',
            validity_status='asrknhcaizqgwdgzatnm',
            start_time='cfpjzjrhpbksakividxt',
            end_time='huxlibldenrnatjsarcb',
            road_name='iclgopqkqcddhpmtcqbc',
            speed_limit_kmh=int(72),
            description='spixrnjfojioifntcmge',
            location_description='vcpnqfbpnacuuicwlors'
        )
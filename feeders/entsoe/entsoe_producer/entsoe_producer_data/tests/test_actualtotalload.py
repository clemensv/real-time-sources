...
class Test_ActualTotalLoad(unittest.TestCase):
    ...
    def test_inDomain_property(self):
        ...
        """
        test_value = 'phymiuwxxsrbdqeqblcu'
    ...
    def test_quantity_property(self):
        ...
        """
        test_value = float(1.4315380860035476)
    ...
    def test_resolution_property(self):
        ...
        """
        test_value = 'kzimoyepfoexrqaiqzlc'
    ...
    def test_outDomain_property(self):
        ...
        """
        test_value = 'wdhpmttweebiwlrqiwtw'
    ...
    def test_documentType_property(self):
        ...
        """
        test_value = 'ovmswvpjdtetqbmqqlxh'
    ...
    def test_to_json(self):
        ...
        new_instance = ActualTotalLoad.from_json(json_data)

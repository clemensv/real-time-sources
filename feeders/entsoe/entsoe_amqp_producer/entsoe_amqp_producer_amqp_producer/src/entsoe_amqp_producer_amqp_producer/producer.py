...
class EuEntsoeTransparencyByDomainAmqpProducer:
    """
    Producer class to send messages in the `eu.entsoe.transparency.ByDomain.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_day_ahead_prices(self,
        ...
        attributes = {
            ...
            "subject":
            "{inDomain}".format(inDomain=_in_domain),
            "datacontenttype":
            content_type,
        }
...
class EuEntsoeTransparencyByDomainPsrTypeAmqpProducer:
    """
    Producer class to send messages in the `eu.entsoe.transparency.ByDomainPsrType.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_actual_generation_per_type(self,
        ...
        attributes = {
            ...
            "https://transparency.entsoe.eu/api",
            "subject":
            "{inDomain}/{psrType}".format(inDomain=_in_domain, psrType=_psr_type),
            "datacontenttype":
            content_type,
        }
    ...
    def send_actual_generation_per_type_batch(self,
        ...
        """
        for data in data_array:
            self.send_actual_generation_per_type(
                data=data,
                _in_domain=_in_domain,
                _psr_type=_psr_type,
                content_type=content_type)
    ...
    def send_wind_solar_forecast(self,
    ...
    def send_wind_solar_generation(self,
    ...
    def send_wind_solar_generation_batch(self,
        ...
        """
        for data in data_array:
            self.send_wind_solar_generation(
                data=data,
                _in_domain=_in_domain,
                _psr_type=_psr_type,
                content_type=content_type)
    ...
    def send_installed_generation_capacity_per_type(self,
    ...
    def send_installed_generation_capacity_per_type_batch(self,
        ...
        """
        for data in data_array:
            self.send_installed_generation_capacity_per_type(
                data=data,
                _in_domain=_in_domain,
                _psr_type=_psr_type,
                content_type=content_type)
...
class EuEntsoeTransparencyCrossBorderAmqpProducer:
    """
    Producer class to send messages in the `eu.entsoe.transparency.CrossBorder.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_cross_border_physical_flows(self,
        ...
        attributes = {
            ...
            "https://transparency.entsoe.eu/api",
            "subject":
            "{inDomain}/{outDomain}".format(inDomain=_in_domain, outDomain=_out_domain),
            "datacontenttype":
            content_type,
        }
    ...
    def send_cross_border_physical_flows_batch(self,
        ...
        """
        for data in data_array:
            self.send_cross_border_physical_flows(
                data=data,
                _in_domain=_in_domain,

...
class UkGovTflRoadAmqpProducer:
    """
    Producer class to send messages in the `uk.gov.tfl.road.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_road_disruption_serious(self,
        data: RoadDisruption,
        _road_id: str,
        _severity: str,
        _disruption_id: str,
    ...
    def send_road_disruption_serious_batch(self,
        ...
        Args:
            data_array (typing.List[RoadDisruption]): Array of message data objects
            _road_id (str): Value for placeholder road_id in attribute subject
            _severity (str): Value for placeholder severity in attribute subject
            _disruption_id (str): Value for placeholder disruption_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
        ...
        """
        for data in data_array:
            self.send_road_disruption_serious(
                data=data,
                _road_id=_road_id,
                _severity=_severity,
    ...
    def send_road_disruption_severe(self,
        data: RoadDisruption,
        _road_id: str,
        _severity: str,
        _disruption_id: str,
    ...
    def send_road_disruption_severe_batch(self,
        ...
        """
        for data in data_array:
            self.send_road_disruption_severe(
                data=data,
                _road_id=_road_id,
                _severity=_severity,
                _disruption_id=_disruption_id,
    ...
    def send_road_disruption_moderate(self,
        data: RoadDisruption,
        _road_id: str,
        _severity: str,
        _disruption_id: str,
    ...
    def send_road_disruption_moderate_batch(self,
        ...
        """
        for data in data_array:
            self.send_road_disruption_moderate(
                data=data,
                _road_id=_road_id,
                _severity=_severity,
                _disruption_id=_disruption_id,
    ...
    def send_road_disruption_minor(self,
        data: RoadDisruption,
        _road_id: str,
        _severity: str,
        _disruption_id: str,
    ...
    def send_road_disruption_minor_batch(self,
        ...
        """
        for data in data_array:
            self.send_road_disruption_minor(
                data=data,
                _road_id=_road_id,
                _severity=_severity,
                _disruption_id=_disruption_id,
    ...
    def send_road_disruption_information(self,
        data: RoadDisruption,
        _road_id: str,
        _severity: str,
        _disruption_id: str,
    ...
    def send_road_disruption_information_batch(self,
        ...
        """
        for data in data_array:
            self.send_road_disruption_information(
                data=data,
                _road_id=_road_id,
                _severity=_severity,
                _disruption_id=_disruption_id,
    ...
    def send_road_disruption_closure(self,
        data: RoadDisruption,
        _road_id: str,
        _severity: str,
        _disruption_id: str,
    ...
    def send_road_disruption_closure_batch(self,
        ...
        """
        for data in data_array:
            self.send_road_disruption_closure(
                data=data,
                _road_id=_road_id,
                _severity=_severity,
                _disruption_id=_disruption_id,

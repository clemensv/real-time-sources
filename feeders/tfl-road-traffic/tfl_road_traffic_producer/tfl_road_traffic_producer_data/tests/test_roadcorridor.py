...
class Test_RoadCorridor(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = RoadCorridor(
            road_id='wpczaugubipbsqsydsoh',
            display_name='scxupwodwecpnaqwtvsp',
            status_severity='faggvgavtkyaytboamrq',
            status_severity_description='jrzqchzsfpxssbmzdvhk',
            bounds='wpschmlgalszqvmlulot',
            envelope='nfwzpdsuhuxuajijoswo',
            url='hvvvrivbvvahymsddjhb',
    ...
    def test_road_id_property(self):
        ...
        """
        test_value = 'wpczaugubipbsqsydsoh'
    ...
    def test_display_name_property(self):
        ...
        """
        test_value = 'scxupwodwecpnaqwtvsp'
    ...
    def test_status_severity_property(self):
        ...
        """
        test_value = 'faggvgavtkyaytboamrq'
    ...
    def test_status_severity_description_property(self):
        ...
        """
        test_value = 'jrzqchzsfpxssbmzdvhk'
    ...
    def test_bounds_property(self):
        ...
        """
        test_value = 'wpschmlgalszqvmlulot'
    ...
    def test_envelope_property(self):
        ...
        """
        test_value = 'nfwzpdsuhuxuajijoswo'
    ...
    def test_url_property(self):
        ...
        Test url property
        """
        test_value = 'hvvvrivbvvahymsddjhb'

...
from madrid_traffic_mqtt_producer_data.trafficreading import TrafficReading
import datetime
...
class Test_TrafficReading(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = TrafficReading(
            sensor_id='qddqfepziddxknwasebv',
            intensity=int(0),
            occupancy=int(18),
            load=int(73),
            service_level=int(98),
            error_flag='efpdjifctllwjxhchhrm',
    ...
    def test_sensor_id_property(self):
        ...
        """
        test_value = 'qddqfepziddxknwasebv'
    ...
    def test_error_flag_property(self):
        ...
        """
        test_value = 'efpdjifctllwjxhchhrm'

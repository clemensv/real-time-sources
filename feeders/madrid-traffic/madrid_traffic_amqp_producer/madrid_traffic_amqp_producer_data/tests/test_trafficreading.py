...
from madrid_traffic_amqp_producer_data.trafficreading import TrafficReading
import datetime
...
class Test_TrafficReading(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = TrafficReading(
            sensor_id='teufupdyuhyguzfwylqc',
            intensity=int(39),
            occupancy=int(18),
            load=int(9),
            service_level=int(76),
            error_flag='qcrugxgjnjpzeeiveetp',
    ...
    def test_sensor_id_property(self):
        ...
        """
        test_value = 'teufupdyuhyguzfwylqc'
    ...
    def test_error_flag_property(self):
        ...
        """
        test_value = 'qcrugxgjnjpzeeiveetp'

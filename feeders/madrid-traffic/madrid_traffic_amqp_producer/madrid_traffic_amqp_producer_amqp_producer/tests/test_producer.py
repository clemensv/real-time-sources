...
"""
Tests for madrid_traffic_amqp_producer_amqp_producer
"""
import base64
import json
import os
...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../madrid_traffic_amqp_producer_data/src')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../madrid_traffic_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../madrid_traffic_amqp_producer_amqp_producer/src')))

from madrid_traffic_amqp_producer_amqp_producer import *
from madrid_traffic_amqp_producer_data import MeasurementPoint
from test_madrid_traffic_amqp_producer_data_measurementpoint import Test_MeasurementPoint
from madrid_traffic_amqp_producer_data import TrafficReading
from test_madrid_traffic_amqp_producer_data_trafficreading import Test_TrafficReading
...
class TestEsMadridInformoAmqpProducer:
    """Test cases for EsMadridInformoAmqpProducer"""
    ...
    def test_send_amqp(self, artemis_container):
        ...
        payload = Test_MeasurementPoint.create_instance()
    ...
    def test_send_amqp(self, artemis_container):
        """Send and receive a Amqp message via ActiveMQ Artemis."""
        # Create valid test data using the test helper
        payload = Test_TrafficReading.create_instance()

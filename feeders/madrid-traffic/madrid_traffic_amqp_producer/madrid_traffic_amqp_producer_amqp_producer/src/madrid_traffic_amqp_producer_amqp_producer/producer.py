...
class EsMadridInformoAmqpProducer:
    """
    Producer class to send messages in the `es.madrid.informo.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_amqp(self,
        ...
        """
        Send the `es.madrid.informo.MeasurementPoint.amqp` message
        ...
        annotations = {}
        annotation_value = "{sensor_id}".format(sensor_id=_sensor_id)
    ...
    def send_amqp_batch(self,
        data_array: typing.List[MeasurementPoint],
        _sensor_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `es.madrid.informo.MeasurementPoint.amqp` messages
        
        Args:
            data_array (typing.List[MeasurementPoint]): Array of message data objects
            _sensor_id (str): Value for placeholder sensor_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
    ...
    def send_amqp(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `es.madrid.informo.TrafficReading.amqp` message
        A current transport measurement or status update from Madrid open traffic sensor feeds. It carries traffic intensity and occupancy measurements when the upstream feed reports a new or refreshed value.
    ...
    def send_amqp_batch(self,
        data_array: typing.List[TrafficReading],
        _sensor_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `es.madrid.informo.TrafficReading.amqp` messages
        
        Args:
            data_array (typing.List[TrafficReading]): Array of message data objects
            _sensor_id (str): Value for placeholder sensor_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            content_type (str): The content type of the message data
        """

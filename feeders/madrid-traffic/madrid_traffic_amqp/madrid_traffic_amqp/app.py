"""AMQP 1.0 companion feeder for madrid-traffic."""
...
SOURCE_ID = "madrid-traffic"
PY_MODULE = "madrid_traffic"
...
async def _run_live(args: argparse.Namespace, producer) -> None:
    from madrid_traffic_core import MadridTrafficPoller, PM_XML_URL, POLL_INTERVAL_SECONDS, REFERENCE_REFRESH_SECONDS, parse_pm_xml

...
class GenerationMix:
    ...
    def create_instance(cls) -> 'GenerationMix':
        ...
        return cls(
            ...
            biomass_mw=float(27.179766183898877),
            ccgt_mw=float(79.67040410557917),
            coal_mw=float(56.760252044453274),
            nuclear_mw=float(6.992719772775113),
            wind_mw=float(6.326237820878),
            ocgt_mw=float(54.8444049846181),
            oil_mw=float(12.554409868836991),
            npshyd_mw=float(13.184822666625596),
            ps_mw=float(61.10248931177359),
            intfr_mw=float(43.13003856475386),
            intned_mw=float(63.391035313029434),
            intnem_mw=float(79.48057351899102),
            intelec_mw=float(59.30603295029451),
            intifa2_mw=float(83.92231038508825),
            intnsl_mw=float(54.94986354492427),
            intvkl_mw=float(75.4069725592492),
            other_mw=float(59.01973273038232)
        )
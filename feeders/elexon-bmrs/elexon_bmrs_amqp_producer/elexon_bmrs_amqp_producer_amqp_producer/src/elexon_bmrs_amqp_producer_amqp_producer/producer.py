...
class UKCoElexonBMRSAmqpProducer:
    """
    Producer class to send messages in the `UK.Co.Elexon.BMRS.amqp` message group via AMQP 1.0 protocol.
    """

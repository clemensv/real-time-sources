...
class Community:
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"Community\", \"namespace\": \"ca.gc.weather.aqhi\", \"doc\": \"Reference record for an AQHI community from the official ECCC AQHI city lists.\", \"fields\": [{\"name\": \"province\", \"type\": \"string\", \"doc\": \"Two-letter Canadian province or territory abbreviation resolved for the AQHI community.\", \"description\": \"Measurement payload for air-quality health index observations and forecasts in the Canada AQHI source.\"}, {\"name\": \"community_name\", \"type\": \"string\", \"doc\": \"English AQHI community name as published by Environment and Climate Change Canada.\", \"description\": \"Reference details for one station, monitoring site, or forecast area in the Canada AQHI source.\"}, {\"name\": \"cgndb_code\", \"type\": \"string\", \"doc\": \"Five-character CGNDB community identifier published by Natural Resources Canada and referenced by ECCC AQHI feeds.\", \"description\": \"Measurement payload for air-quality health index observations and forecasts in the Canada AQHI source.\"}, {\"name\": \"latitude\", \"type\": \"double\", \"doc\": \"Latitude of the AQHI community reference point in WGS84 decimal degrees.\", \"description\": \"Measurement payload for air-quality health index observations and forecasts in the Canada AQHI source.\"}, {\"name\": \"longitude\", \"type\": \"double\", \"doc\": \"Longitude of the AQHI community reference point in WGS84 decimal degrees.\", \"description\": \"Measurement payload for air-quality health index observations and forecasts in the Canada AQHI source.\"}, {\"name\": \"observation_url\", \"type\": [\"null\", \"string\"], \"default\": null, \"doc\": \"Current XML observation feed URL for the AQHI community, or null when observations are not distributed for that community.\", \"description\": \"Measurement payload for air-quality health index observations and forecasts in the Canada AQHI source.\"}, {\"name\": \"forecast_url\", \"type\": [\"null\", \"string\"], \"default\": null, \"doc\": \"Current XML forecast feed URL for the AQHI community, or null when a public forecast feed is not available.\", \"description\": \"Forecast payload for air-quality health index observations and forecasts in the Canada AQHI source.\"}], \"description\": \"Reference details for one station, monitoring site, or forecast area in the Canada AQHI source.\"}"), avro.name.Names()
    )

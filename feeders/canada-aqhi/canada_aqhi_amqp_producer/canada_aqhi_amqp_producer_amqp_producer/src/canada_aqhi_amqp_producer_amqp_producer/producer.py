...
class CaGcWeatherAqhiAmqpProducer:
    """
    Producer class to send messages in the `ca.gc.weather.aqhi.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_community(self,
        ...
        attributes = {
            ...
            "source":
            "https://dd.weather.gc.ca/today/air_quality/aqhi/",
            "subject":
        ...
        app_properties["community_name"] = "{community_name}".format(community_name=_community_name)
        if app_properties:

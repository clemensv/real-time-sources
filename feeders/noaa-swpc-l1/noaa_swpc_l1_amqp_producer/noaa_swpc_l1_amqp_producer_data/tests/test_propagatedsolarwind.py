...
class Test_PropagatedSolarWind(unittest.TestCase):
    ...
    def test_speed_property(self):
        ...
        Test speed property
        """
        test_value = float(20.57326436625553)
    ...
    def test_density_property(self):
        ...
        """
        test_value = float(27.648281191094746)
    ...
    def test_temperature_property(self):
        ...
        """
        test_value = float(87.58644995300779)
    ...
    def test_bx_property(self):
        ...
        Test bx property
        """
        test_value = float(69.16709557087123)
    ...
    def test_by_property(self):
        ...
        Test by property
        """
        test_value = float(39.299056211106844)
    ...
    def test_bz_property(self):
        ...
        Test bz property
        """
        test_value = float(85.60474500027206)
    ...
    def test_bt_property(self):
        ...
        Test bt property
        """
        test_value = float(75.11027625736658)
    ...
    def test_vx_property(self):
        ...
        Test vx property
        """
        test_value = float(21.559255920280407)
    ...
    def test_vy_property(self):
        ...
        Test vy property
        """
        test_value = float(1.9180177408143706)
    ...
    def test_vz_property(self):
        ...
        Test vz property
        """
        test_value = float(97.1063634752036)

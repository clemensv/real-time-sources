...
"""
Sample usage of noaa_swpc_l1_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send PropagatedSolarWind message
        print("Sending PropagatedSolarWind message...")
        # TODO: Create a PropagatedSolarWind instance with actual data
        # data = PropagatedSolarWind(...)
        # producer.send_propagated_solar_wind(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("PropagatedSolarWind message sent successfully!")

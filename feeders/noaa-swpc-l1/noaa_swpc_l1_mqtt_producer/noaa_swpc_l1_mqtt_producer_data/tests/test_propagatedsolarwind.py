...
class Test_PropagatedSolarWind(unittest.TestCase):
    ...
    def test_speed_property(self):
        ...
        Test speed property
        """
        test_value = float(8.823189008869715)
    ...
    def test_density_property(self):
        ...
        """
        test_value = float(51.474375084457414)
    ...
    def test_temperature_property(self):
        ...
        """
        test_value = float(79.78689455464963)
    ...
    def test_bx_property(self):
        ...
        Test bx property
        """
        test_value = float(14.672562510264186)
    ...
    def test_by_property(self):
        ...
        Test by property
        """
        test_value = float(9.433013600333028)
    ...
    def test_bz_property(self):
        ...
        Test bz property
        """
        test_value = float(84.42431063445126)
    ...
    def test_bt_property(self):
        ...
        Test bt property
        """
        test_value = float(48.64065570803619)
    ...
    def test_vx_property(self):
        ...
        Test vx property
        """
        test_value = float(25.30081911895835)
    ...
    def test_vy_property(self):
        ...
        Test vy property
        """
        test_value = float(11.097632669450242)
    ...
    def test_vz_property(self):
        ...
        Test vz property
        """
        test_value = float(14.961304533050612)

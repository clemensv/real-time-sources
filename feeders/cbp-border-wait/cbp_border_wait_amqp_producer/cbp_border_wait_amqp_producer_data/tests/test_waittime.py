...
class Test_WaitTime(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = WaitTime(
            port_number='tsplxneettpffibavlae',
            port_name='vrlyxkclhlozcbykuivr',
            border='hstotqvrqlgvhyhpuohu',
            crossing_name='kxcgsvyyxxyysdxqjrva',
            port_status='fxefdzuhxolvbmhcgtoi',
            date='bvbnqetljayfuirrrbfg',
            time='hbjvapxpiyojtqovvecw',
            passenger_vehicle_standard_delay=int(21),
            passenger_vehicle_standard_lanes_open=int(10),
            passenger_vehicle_standard_operational_status='wnzgckrofojbwnkpyhrd',
            passenger_vehicle_nexus_sentri_delay=int(82),
            passenger_vehicle_nexus_sentri_lanes_open=int(47),
            passenger_vehicle_nexus_sentri_operational_status='lvvnzwevipyajyaspret',
            passenger_vehicle_ready_delay=int(33),
            passenger_vehicle_ready_lanes_open=int(83),
            passenger_vehicle_ready_operational_status='wkjitozxnwrplsxjvkui',
            pedestrian_standard_delay=int(71),
            pedestrian_standard_lanes_open=int(87),
            pedestrian_standard_operational_status='goddoqntcsdrqdspofwf',
            pedestrian_ready_delay=int(5),
            pedestrian_ready_lanes_open=int(20),
            pedestrian_ready_operational_status='tnnsoqkohbrfvtxloegg',
            commercial_vehicle_standard_delay=int(7),
            commercial_vehicle_standard_lanes_open=int(65),
            commercial_vehicle_standard_operational_status='ajjkwyvebvuqpvvmwzph',
            commercial_vehicle_fast_delay=int(81),
            commercial_vehicle_fast_lanes_open=int(68),
            commercial_vehicle_fast_operational_status='lbsbczzntsnsurzfrdqk',
            construction_notice='vhmitqvdlcuehjmmeywr',
    ...
    def test_port_number_property(self):
        ...
        """
        test_value = 'tsplxneettpffibavlae'
    ...
    def test_port_name_property(self):
        ...
        """
        test_value = 'vrlyxkclhlozcbykuivr'
    ...
    def test_border_property(self):
        ...
        """
        test_value = 'hstotqvrqlgvhyhpuohu'
    ...
    def test_crossing_name_property(self):
        ...
        """
        test_value = 'kxcgsvyyxxyysdxqjrva'
    ...
    def test_port_status_property(self):
        ...
        """
        test_value = 'fxefdzuhxolvbmhcgtoi'
    ...
    def test_date_property(self):
        ...
        Test date property
        """
        test_value = 'bvbnqetljayfuirrrbfg'
    ...
    def test_time_property(self):
        ...
        Test time property
        """
        test_value = 'hbjvapxpiyojtqovvecw'
    ...
    def test_passenger_vehicle_standard_operational_status_property(self):
        ...
        """
        test_value = 'wnzgckrofojbwnkpyhrd'
    ...
    def test_passenger_vehicle_nexus_sentri_operational_status_property(self):
        ...
        """
        test_value = 'lvvnzwevipyajyaspret'
    ...
    def test_passenger_vehicle_ready_operational_status_property(self):
        ...
        """
        test_value = 'wkjitozxnwrplsxjvkui'
    ...
    def test_pedestrian_standard_operational_status_property(self):
        ...
        """
        test_value = 'goddoqntcsdrqdspofwf'
    ...
    def test_pedestrian_ready_operational_status_property(self):
        ...
        """
        test_value = 'tnnsoqkohbrfvtxloegg'
    ...
    def test_commercial_vehicle_standard_operational_status_property(self):
        ...
        """
        test_value = 'ajjkwyvebvuqpvvmwzph'
    ...
    def test_commercial_vehicle_fast_operational_status_property(self):
        ...
        """
        test_value = 'lbsbczzntsnsurzfrdqk'
    ...
    def test_construction_notice_property(self):
        ...
        """
        test_value = 'vhmitqvdlcuehjmmeywr'

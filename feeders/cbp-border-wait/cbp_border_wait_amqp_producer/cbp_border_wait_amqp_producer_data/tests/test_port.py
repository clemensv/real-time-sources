...
class Test_Port(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Port(
            port_number='tdoohafpfhpssviqbehu',
            port_name='nclzckhybznutvlmodvn',
            border='ufrrijyhymdzrzrwdlzz',
            crossing_name='asuaphhtqfeuscxfqmkx',
            hours='xvrmllaomjumvqdufcgz',
            passenger_vehicle_max_lanes=int(73),
            commercial_vehicle_max_lanes=int(48),
            pedestrian_max_lanes=int(35),
    ...
    def test_port_number_property(self):
        ...
        """
        test_value = 'tdoohafpfhpssviqbehu'
    ...
    def test_port_name_property(self):
        ...
        """
        test_value = 'nclzckhybznutvlmodvn'
    ...
    def test_border_property(self):
        ...
        """
        test_value = 'ufrrijyhymdzrzrwdlzz'
    ...
    def test_crossing_name_property(self):
        ...
        """
        test_value = 'asuaphhtqfeuscxfqmkx'
    ...
    def test_hours_property(self):
        ...
        Test hours property
        """
        test_value = 'xvrmllaomjumvqdufcgz'

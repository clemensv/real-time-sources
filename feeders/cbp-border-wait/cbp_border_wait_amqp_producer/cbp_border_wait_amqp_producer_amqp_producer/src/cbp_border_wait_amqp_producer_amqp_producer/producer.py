...
class GovCbpBorderwaitAmqpProducer:
    """
    Producer class to send messages in the `gov.cbp.borderwait.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_port(self,
        ...
        """
        Send the `gov.cbp.borderwait.amqp.Port` message
        ...
        Args:
            ...
            _border_slug (str): Value for AMQP protocol option placeholder border_slug
        ...
        attributes = {
            ...
            "https://bwt.cbp.gov",
            "subject":
            "{port_number}".format(port_number=_port_number),
        }
        ...
        amqp_msg.subject = "{port_number}".format(port_number=_port_number)

        app_properties = {}
        app_properties["border_slug"] = "{border_slug}".format(border_slug=_border_slug)
        if app_properties:
        ...
        annotations = {}
        annotation_value = "{port_number}".format(port_number=_port_number)
    ...
    def send_port_batch(self,
        data_array: typing.List[Port],
        _port_number: str,
        _border_slug: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `gov.cbp.borderwait.amqp.Port` messages
        
        Args:
            data_array (typing.List[Port]): Array of message data objects
            _port_number (str): Value for placeholder port_number in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            _border_slug (str): Value for AMQP protocol option placeholder border_slug
        ...
        for data in data_array:
            self.send_port(
                data=data,
                _port_number=_port_number,
                _time=_time,
                _border_slug=_border_slug,
    ...
    def send_wait_time(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `gov.cbp.borderwait.amqp.WaitTime` message
    ...
    def send_wait_time_batch(self,
        data_array: typing.List[WaitTime],
        _port_number: str,
        _border_slug: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `gov.cbp.borderwait.amqp.WaitTime` messages
        
        Args:
            data_array (typing.List[WaitTime]): Array of message data objects
            _port_number (str): Value for placeholder port_number in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            _border_slug (str): Value for AMQP protocol option placeholder border_slug
            content_type (str): The content type of the message data

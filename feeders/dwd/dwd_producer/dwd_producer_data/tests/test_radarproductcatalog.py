...
class Test_RadarProductCatalog(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = RadarProductCatalog(
            product='cjaldneorymgfdpwzlaf',
            file_url='stjkgejnmdaofjacsdyk',
            description='veysklzierfipkcjzinm',
            state='lavbjpeujavpdmkqfozi',
            kind='kmxitqeeagxwxjutxket'
        )
        return instance
    ...
    def test_product_property(self):
        ...
        """
        test_value = 'cjaldneorymgfdpwzlaf'
    ...
    def test_file_url_property(self):
        ...
        """
        test_value = 'stjkgejnmdaofjacsdyk'
    ...
    def test_description_property(self):
        ...
        """
        test_value = 'veysklzierfipkcjzinm'
    ...
    def test_state_property(self):
        ...
        Test state property
        """
        test_value = 'lavbjpeujavpdmkqfozi'
    ...
    def test_kind_property(self):
        ...
        Test kind property
        """
        test_value = 'kmxitqeeagxwxjutxket'

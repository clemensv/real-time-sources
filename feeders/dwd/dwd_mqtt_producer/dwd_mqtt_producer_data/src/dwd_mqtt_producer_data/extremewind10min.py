...
class ExtremeWind10Min:
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['ExtremeWind10Min']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return ExtremeWind10Min.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'ExtremeWind10Min':
        """
        ...
        """
        return cls(
            station_id='uyouxxbawkpuevxucadc',
            timestamp='wkfmosecpxruuqvfskfw',
            quality_level=int(41),
            wind_speed_maximum=float(47.06998945854487),
            wind_speed_minimum=float(97.3067417652041),
            wind_direction_at_maximum=float(36.321551338218924),
            state='vkzlvccqwddlsxqknlju'
        )
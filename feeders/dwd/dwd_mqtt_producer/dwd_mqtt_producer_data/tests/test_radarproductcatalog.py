...
class Test_RadarProductCatalog(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = RadarProductCatalog(
            product='wjazcviucniivjcvxorv',
            file_url='qzzkrqheusqoxwfbxwfq',
            description='tprruitudxvgemxdqjok',
            state='rtthybocrszhvdohimib',
            kind='kelivqikegpskqkwesvx'
        )
        return instance
    ...
    def test_product_property(self):
        ...
        """
        test_value = 'wjazcviucniivjcvxorv'
    ...
    def test_file_url_property(self):
        ...
        """
        test_value = 'qzzkrqheusqoxwfbxwfq'
    ...
    def test_description_property(self):
        ...
        """
        test_value = 'tprruitudxvgemxdqjok'
    ...
    def test_state_property(self):
        ...
        Test state property
        """
        test_value = 'rtthybocrszhvdohimib'
    ...
    def test_kind_property(self):
        ...
        Test kind property
        """
        test_value = 'kelivqikegpskqkwesvx'

""" ExtremeTemperature10Min dataclass. """
...
class ExtremeTemperature10Min:
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['ExtremeTemperature10Min']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return ExtremeTemperature10Min.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'ExtremeTemperature10Min':
        """
        ...
        """
        return cls(
            station_id='balcstnjtharkpqoepun',
            timestamp='fzvcgsjwftmbbjymbmdl',
            quality_level=int(76),
            air_temperature_maximum_2m=float(19.943273038151865),
            air_temperature_minimum_5cm=float(1.074667179731581),
            state='aazxtirsnaksgyzqnrqk'
        )
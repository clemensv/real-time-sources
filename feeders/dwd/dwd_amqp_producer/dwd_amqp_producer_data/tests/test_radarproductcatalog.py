...
class Test_RadarProductCatalog(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = RadarProductCatalog(
            product='pvqmwiaeddluuconzqqd',
            file_url='krsotydhzrlvfnbbnsbh',
            description='vengnakocoftjrpsygry',
            state='htaxgbtnhijquvmmfwma',
            kind='ewrveqilibqaxsuzrthm'
        )
        return instance
    ...
    def test_product_property(self):
        ...
        """
        test_value = 'pvqmwiaeddluuconzqqd'
    ...
    def test_file_url_property(self):
        ...
        """
        test_value = 'krsotydhzrlvfnbbnsbh'
    ...
    def test_description_property(self):
        ...
        """
        test_value = 'vengnakocoftjrpsygry'
    ...
    def test_state_property(self):
        ...
        Test state property
        """
        test_value = 'htaxgbtnhijquvmmfwma'
    ...
    def test_kind_property(self):
        ...
        Test kind property
        """
        test_value = 'ewrveqilibqaxsuzrthm'

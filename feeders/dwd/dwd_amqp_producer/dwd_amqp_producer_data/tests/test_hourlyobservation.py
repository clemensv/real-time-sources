...
class Test_HourlyObservation(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = HourlyObservation(
            station_id='hrufhprbtheeapzykjtd',
            timestamp='gybmevdsfctuqccwjnuy',
            quality_level=int(64),
            parameter='yrdorwtalqcstquzgonp',
            value=float(20.521921692953647),
            unit='pxwjsuhtvrjhpqwnffmh',
            state='npswywhiwnjrujsywisf'
        )
        return instance
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'hrufhprbtheeapzykjtd'
    ...
    def test_timestamp_property(self):
        ...
        """
        test_value = 'gybmevdsfctuqccwjnuy'
    ...
    def test_parameter_property(self):
        ...
        """
        test_value = 'yrdorwtalqcstquzgonp'
    ...
    def test_value_property(self):
        ...
        Test value property
        """
        test_value = float(20.521921692953647)
    ...
    def test_unit_property(self):
        ...
        Test unit property
        """
        test_value = 'pxwjsuhtvrjhpqwnffmh'
    ...
    def test_state_property(self):
        ...
        Test state property
        """
        test_value = 'npswywhiwnjrujsywisf'

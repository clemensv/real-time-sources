...
from test_dwd_amqp_producer_data_stationmetadata import Test_StationMetadata
from dwd_amqp_producer_data import AirTemperature10Min
from test_dwd_amqp_producer_data_airtemperature10min import Test_AirTemperature10Min
from dwd_amqp_producer_data import Precipitation10Min
from test_dwd_amqp_producer_data_precipitation10min import Test_Precipitation10Min
from dwd_amqp_producer_data import Wind10Min
from test_dwd_amqp_producer_data_wind10min import Test_Wind10Min
from dwd_amqp_producer_data import Solar10Min
from test_dwd_amqp_producer_data_solar10min import Test_Solar10Min
from dwd_amqp_producer_data import HourlyObservation
from test_dwd_amqp_producer_data_hourlyobservation import Test_HourlyObservation
from dwd_amqp_producer_data import ExtremeWind10Min
from test_dwd_amqp_producer_data_extremewind10min import Test_ExtremeWind10Min
from dwd_amqp_producer_data import ExtremeTemperature10Min
from test_dwd_amqp_producer_data_extremetemperature10min import Test_ExtremeTemperature10Min
from dwd_amqp_producer_data import Alert
from test_dwd_amqp_producer_data_alert import Test_Alert
from dwd_amqp_producer_data import RadarProductCatalog
from test_dwd_amqp_producer_data_radarproductcatalog import Test_RadarProductCatalog
from dwd_amqp_producer_data import RadarFileProduct
from test_dwd_amqp_producer_data_radarfileproduct import Test_RadarFileProduct
from dwd_amqp_producer_data import ForecastModelCatalog
from test_dwd_amqp_producer_data_forecastmodelcatalog import Test_ForecastModelCatalog
from dwd_amqp_producer_data import IconD2ForecastFile
from test_dwd_amqp_producer_data_icond2forecastfile import Test_IconD2ForecastFile

...
class DEDWDCDCAmqpProducer:
    """
    Producer class to send messages in the `DE.DWD.CDC.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_air_temperature10_min(self,
    ...
    def send_precipitation10_min(self,
    ...
    def send_hourly_observation(self,
    ...
    def send_extreme_wind10_min(self,
    ...
    def send_extreme_temperature10_min(self,
...
class DEDWDWeatherAmqpProducer:
    """
    Producer class to send messages in the `DE.DWD.Weather.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_alert(self,
        ...
        if amqp_creation_time is not None:
            amqp_msg.creation_time = amqp_creation_time
        # Apply AMQP message properties declared in protocoloptions.properties.
        amqp_msg.subject = "{state}/{severity}/{identifier}".format(state=_state, severity=_severity, identifier=_identifier)
...
class DEDWDRadarAmqpProducer:
    """
    Producer class to send messages in the `DE.DWD.Radar.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_radar_product_catalog(self,
        ...
        if amqp_creation_time is not None:
            amqp_msg.creation_time = amqp_creation_time
        # Apply AMQP message properties declared in protocoloptions.properties.
        amqp_msg.subject = "{kind}".format(kind=_kind)
    ...
    def send_radar_file_product(self,
        ...
        if amqp_creation_time is not None:
            amqp_msg.creation_time = amqp_creation_time
        # Apply AMQP message properties declared in protocoloptions.properties.
        amqp_msg.subject = "{product_type}/{file_id}".format(product_type=_product_type, file_id=_file_id)
...
class DEDWDForecastAmqpProducer:
    """
    Producer class to send messages in the `DE.DWD.Forecast.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_icon_d2_forecast_file(self,
        ...
        if amqp_creation_time is not None:
            amqp_msg.creation_time = amqp_creation_time
        # Apply AMQP message properties declared in protocoloptions.properties.
        amqp_msg.subject = "{variable}/{file_id}".format(variable=_variable, file_id=_file_id)
    ...
    def send_icon_d2_forecast_file_batch(self,
        ...
        """
        for data in data_array:
            self.send_icon_d2_forecast_file(
                data=data,
                _variable=_variable,
                _file_id=_file_id,
                _time=_time,

...
"""
Tests for canada_eccc_wateroffice_amqp_producer_amqp_producer
"""
import base64
import json
import os
...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../canada_eccc_wateroffice_amqp_producer_data/src')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../canada_eccc_wateroffice_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../canada_eccc_wateroffice_amqp_producer_amqp_producer/src')))

from canada_eccc_wateroffice_amqp_producer_amqp_producer import *
from canada_eccc_wateroffice_amqp_producer_data import Station
from test_canada_eccc_wateroffice_amqp_producer_data_station import Test_Station
from canada_eccc_wateroffice_amqp_producer_data import Observation
from test_canada_eccc_wateroffice_amqp_producer_data_observation import Test_Observation
...
class TestCAGovECCCHydroAmqpProducer:
    """Test cases for CAGovECCCHydroAmqpProducer"""

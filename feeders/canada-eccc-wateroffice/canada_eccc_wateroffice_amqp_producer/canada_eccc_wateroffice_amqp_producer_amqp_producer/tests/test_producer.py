...
class TestCAGovECCCHydroAmqpProducer:
    ...
    def test_presettled_send_waits_for_queued_delivery_to_drain(self):
        ...
        producer = object.__new__(CAGovECCCHydroAmqpProducer)
    ...
    def test_send_station(self, artemis_container):
        ...
        try:
            ...
            for i in range(5):
                ...
                assert annotations.get(symbol('x-opt-partition-key')) == str("stations/{station_number}".format(station_number="value"))[:128]
        finally:
            producer.close()

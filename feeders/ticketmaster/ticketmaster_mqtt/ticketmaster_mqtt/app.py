"""MQTT companion feeder for ticketmaster. Publishes mock/sample CloudEvents for Docker E2E and auth-blocked upstreams."""
...
from ticketmaster_mqtt_producer_mqtt_client import client as client_mod
import ticketmaster_mqtt_producer_data as data_mod

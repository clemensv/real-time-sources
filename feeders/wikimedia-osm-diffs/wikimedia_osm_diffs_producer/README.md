...
4. [Generated Producer Classes](#generated-producer-classes)    OrgOpenStreetMapDiffsAmqpEventDispatcher
...
- OrgOpenStreetMapDiffsProducersolution for event-driven applications.
...
- OrgOpenStreetMapDiffsAmqpProducersolution for event-driven applications.
...
- **Scales horizontally** across multiple brokers and partitions### OrgOpenStreetMapDiffsEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`OrgOpenStreetMapDiffsEventDispatcher` handles events for the Org.OpenStreetMap.Diffs message group.
...
The OrgOpenStreetMapDiffsEventDispatcher defines the following event handler hooks.
...
producer = OrgOpenStreetMapDiffsProducer(
    ...
    security_protocol='SASL_SSL',##### `org_open_street_map_diffs_map_change_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'org_open_street_map_diffs_map_change_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `Org.OpenStreetMap.Diffs.MapChange`: An individual element change from the OpenStreetMap
...
org_open_street_map_diffs_dispatcher.org_open_street_map_diffs_map_change_async =
...
### OrgOpenStreetMapDiffsAmqpProducer- `data`: The event data of type `wikimedia_osm_diffs_producer_data.MapChange`.



Producer for `Org.OpenStreetMap.Diffs.amqp` message group.Example:
...
OrgOpenStreetMapDiffsAmqpProducer(    await some_processing_function(record, cloud_event, data)
...
org_open_street_map_diffs_amqp_dispatcher.org_open_street_map_diffs_map_change_async =
org_open_street_map_diffs_map_change_event
...
##### `send_org_open_street_map_diffs_map_change`Dispatchers have the following protected methods:



```python### Methods:

async def send_org_open_street_map_diffs_map_change(
...
Send a single `Org.OpenStreetMap.Diffs.MapChange` message. An individual element change from the OpenStreetMap minutely
...
await producer.send_org_open_street_map_diffs_map_change(
...
Send multiple `Org.OpenStreetMap.Diffs.MapChange` messages in a batch.
...
await producer.send_org_open_street_map_diffs_map_change_batch(```
...
- **Scales horizontally** across multiple brokers and partitions### OrgOpenStreetMapDiffsStateEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`OrgOpenStreetMapDiffsStateEventDispatcher` handles events for the Org.OpenStreetMap.Diffs.State message group.
...
The OrgOpenStreetMapDiffsStateEventDispatcher defines the following event handler hooks.
...
producer = OrgOpenStreetMapDiffsProducer(
    ...
    security_protocol='SASL_SSL',##### `org_open_street_map_diffs_replication_state_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'org_open_street_map_diffs_replication_state_async:  Callable[[ConsumerRecord,
...
Asynchronous handler hook for `Org.OpenStreetMap.Diffs.ReplicationState`: Current replication state from the
...
org_open_street_map_diffs_dispatcher.org_open_street_map_diffs_replication_state_async =
...
org_open_street_map_diffs_state_dispatcher.org_open_street_map_diffs_replication_state_async =
org_open_street_map_diffs_replication_state_event
...
### OrgOpenStreetMapDiffsAmqpProducer- `data`: The event data of type
`wikimedia_osm_diffs_producer_data.ReplicationState`.
...
org_open_street_map_diffs_amqp_dispatcher.org_open_street_map_diffs_replication_state_async =
org_open_street_map_diffs_replication_state_event
...
##### `send_org_open_street_map_diffs_replication_state`Dispatchers have the following protected methods:



```python### Methods:

async def send_org_open_street_map_diffs_replication_state(
...
Send a single `Org.OpenStreetMap.Diffs.ReplicationState` message. Current replication state from the OpenStreetMap
...
await producer.send_org_open_street_map_diffs_replication_state(
...
Send multiple `Org.OpenStreetMap.Diffs.ReplicationState` messages in a batch.
...
org_open_street_map_diffs_amqp_dispatcher.org_open_street_map_diffs_mqtt_node_async =
org_open_street_map_diffs_mqtt_node_event
...
org_open_street_map_diffs_amqp_dispatcher.org_open_street_map_diffs_mqtt_way_async =
org_open_street_map_diffs_mqtt_way_event
...
org_open_street_map_diffs_amqp_dispatcher.org_open_street_map_diffs_mqtt_relation_async =
org_open_street_map_diffs_mqtt_relation_event
...
org_open_street_map_diffs_amqp_dispatcher.org_open_street_map_diffs_mqtt_replication_state_async =
org_open_street_map_diffs_mqtt_replication_state_event
...
- **Scales horizontally** across multiple brokers and partitions### OrgOpenStreetMapDiffsAmqpEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`OrgOpenStreetMapDiffsAmqpEventDispatcher` handles events for the Org.OpenStreetMap.Diffs.amqp message group.
...
The OrgOpenStreetMapDiffsAmqpEventDispatcher defines the following event handler hooks.
...
producer = OrgOpenStreetMapDiffsProducer(
    ...
    security_protocol='SASL_SSL',##### `org_open_street_map_diffs_amqp_map_change_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'org_open_street_map_diffs_amqp_map_change_async:  Callable[[ConsumerRecord, CloudEvent,
MapChange], Awaitable[None]]
...
Asynchronous handler hook for `Org.OpenStreetMap.Diffs.amqp.MapChange`: An individual element change from the
OpenStreetMap minutely replication diff feed. Each event represents a single create, modify, or delete operation on a
node, way, or relation in the OSM database. The diff files are OsmChange XML documents published every 60 seconds at
https://planet.openstreetmap.org/replication/minute/.
...
async def org_open_street_map_diffs_amqp_map_change_event(record: ConsumerRecord, cloud_event: CloudEvent, data:
MapChange) -> None:
...
org_open_street_map_diffs_dispatcher.org_open_street_map_diffs_amqp_map_change_async =
org_open_street_map_diffs_amqp_map_change_event
...
org_open_street_map_diffs_state_dispatcher.org_open_street_map_diffs_amqp_map_change_async =
org_open_street_map_diffs_amqp_map_change_event
...
org_open_street_map_diffs_mqtt_dispatcher.org_open_street_map_diffs_amqp_map_change_async =
org_open_street_map_diffs_amqp_map_change_event
...
org_open_street_map_diffs_amqp_dispatcher.org_open_street_map_diffs_amqp_map_change_async =
org_open_street_map_diffs_amqp_map_change_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `org_open_street_map_diffs_amqp_replication_state_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'org_open_street_map_diffs_amqp_replication_state_async:  Callable[[ConsumerRecord,
CloudEvent, ReplicationState], Awaitable[None]]
...
Asynchronous handler hook for `Org.OpenStreetMap.Diffs.amqp.ReplicationState`: Current replication state from the
OpenStreetMap minutely diff feed. Emitted once per poll cycle to record which replication sequence was just processed.
The state is read from https://planet.openstreetmap.org/replication/minute/state.txt.
...
async def org_open_street_map_diffs_amqp_replication_state_event(record: ConsumerRecord, cloud_event: CloudEvent, data:
ReplicationState) -> None:
...
org_open_street_map_diffs_dispatcher.org_open_street_map_diffs_amqp_replication_state_async =
org_open_street_map_diffs_amqp_replication_state_event
...
org_open_street_map_diffs_state_dispatcher.org_open_street_map_diffs_amqp_replication_state_async =
org_open_street_map_diffs_amqp_replication_state_event
...
org_open_street_map_diffs_mqtt_dispatcher.org_open_street_map_diffs_amqp_replication_state_async =
org_open_street_map_diffs_amqp_replication_state_event
...
org_open_street_map_diffs_amqp_dispatcher.org_open_street_map_diffs_amqp_replication_state_async =
org_open_street_map_diffs_amqp_replication_state_event
...
##### `send_org_open_street_map_diffs_amqp_map_change`Dispatchers have the following protected methods:



```python### Methods:

async def send_org_open_street_map_diffs_amqp_map_change(
...
Send a single `Org.OpenStreetMap.Diffs.amqp.MapChange` message. An individual element change from the OpenStreetMap
minutely replication diff feed. Each event represents a single create, modify, or delete operation on a node, way, or
relation in the OSM database. The diff files are OsmChange XML documents published every 60 seconds at
https://planet.openstreetmap.org/replication/minute/.Args:
...
await producer.send_org_open_street_map_diffs_amqp_map_change(
...
Send multiple `Org.OpenStreetMap.Diffs.amqp.MapChange` messages in a batch.
...
await producer.send_org_open_street_map_diffs_amqp_map_change_batch(```
...
##### `send_org_open_street_map_diffs_amqp_replication_state`Dispatchers have the following protected methods:



```python### Methods:

async def send_org_open_street_map_diffs_amqp_replication_state(
...
Send a single `Org.OpenStreetMap.Diffs.amqp.ReplicationState` message. Current replication state from the OpenStreetMap
minutely diff feed. Emitted once per poll cycle to record which replication sequence was just processed. The state is
read from https://planet.openstreetmap.org/replication/minute/state.txt.Args:
...
await producer.send_org_open_street_map_diffs_amqp_replication_state(
...
Send multiple `Org.OpenStreetMap.Diffs.amqp.ReplicationState` messages in a batch.
...
await producer.send_org_open_street_map_diffs_amqp_replication_state_batch(```

...
from wikimedia_osm_diffs_amqp_producer_data.replicationstate import ReplicationState
import datetime
...
class Test_ReplicationState(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = ReplicationState(
            sequence_number=int(29),
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            source_url='irtrdhpcqvmprebmjgot'
        )
        return instance
    ...
    def test_source_url_property(self):
        ...
        """
        test_value = 'irtrdhpcqvmprebmjgot'

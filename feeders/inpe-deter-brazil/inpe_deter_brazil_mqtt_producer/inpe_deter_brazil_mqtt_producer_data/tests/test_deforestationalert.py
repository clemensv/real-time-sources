...
from inpe_deter_brazil_mqtt_producer_data.br.inpe.deter.deforestationalert import DeforestationAlert
from inpe_deter_brazil_mqtt_producer_data.br.inpe.deter.biomeenum import BiomeEnum
from inpe_deter_brazil_mqtt_producer_data.br.inpe.deter.classslugenum import ClassSlugenum
...
class Test_DeforestationAlert(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = DeforestationAlert(
            alert_id='ybsxabpoqexgbqexvohj',
            biome=BiomeEnum.amazon,
            classname='teftqoknszfhtuilnuno',
            view_date='cmaqcbwxvagvvwboazor',
            satellite='uneflowixxphnlhbhfpo',
            sensor='zoohdcqccuofogssrxpz',
            area_km2=float(42.67696469075619),
            municipality='mavvdrtjgaekocqoviuj',
            state_code='mlsekvgqfkalrhclophs',
            path_row='ervrgwyhvnwgzhemprqn',
            publish_month='lynxmhavocuhllhqboty',
            centroid_latitude=float(48.867735451895115),
            centroid_longitude=float(38.47083766900814),
            state_slug='vbrkewtsfnnbfbqzkhpv',
    ...
    def test_alert_id_property(self):
        ...
        """
        test_value = 'ybsxabpoqexgbqexvohj'
    ...
    def test_classname_property(self):
        ...
        """
        test_value = 'teftqoknszfhtuilnuno'
    ...
    def test_view_date_property(self):
        ...
        """
        test_value = 'cmaqcbwxvagvvwboazor'
    ...
    def test_satellite_property(self):
        ...
        """
        test_value = 'uneflowixxphnlhbhfpo'
    ...
    def test_sensor_property(self):
        ...
        """
        test_value = 'zoohdcqccuofogssrxpz'
    ...
    def test_area_km2_property(self):
        ...
        """
        test_value = float(42.67696469075619)
    ...
    def test_municipality_property(self):
        ...
        """
        test_value = 'mavvdrtjgaekocqoviuj'
    ...
    def test_state_code_property(self):
        ...
        """
        test_value = 'mlsekvgqfkalrhclophs'
    ...
    def test_path_row_property(self):
        ...
        """
        test_value = 'ervrgwyhvnwgzhemprqn'
    ...
    def test_publish_month_property(self):
        ...
        """
        test_value = 'lynxmhavocuhllhqboty'
    ...
    def test_centroid_latitude_property(self):
        ...
        """
        test_value = float(48.867735451895115)
    ...
    def test_centroid_longitude_property(self):
        ...
        """
        test_value = float(38.47083766900814)
    ...
    def test_state_slug_property(self):
        ...
        """
        test_value = 'vbrkewtsfnnbfbqzkhpv'

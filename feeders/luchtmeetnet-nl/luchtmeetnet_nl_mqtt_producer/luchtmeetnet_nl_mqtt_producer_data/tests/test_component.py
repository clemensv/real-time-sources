...
from luchtmeetnet_nl_mqtt_producer_data.nl.rivm.luchtmeetnet.components.component import Component
...
class Test_Component(unittest.TestCase):
    ...
    def test_formula_property(self):
        ...
        """
        test_value = 'jenxaplurrtltcnsgxxf'
    ...
    def test_name_nl_property(self):
        ...
        """
        test_value = 'xnmamsrsxsjairnsmvtg'
    ...
    def test_name_en_property(self):
        ...
        """
        test_value = 'etsghgvfagcfqhhricxw'

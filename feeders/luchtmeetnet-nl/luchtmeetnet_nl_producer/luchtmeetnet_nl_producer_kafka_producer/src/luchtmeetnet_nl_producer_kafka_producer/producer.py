...
class NlRivmLuchtmeetnetMqttEventProducer:
    ...
    def send_nl_rivm_luchtmeetnet_mqtt_station(self,_station_number : str, data: Station, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
    ...
    def send_nl_rivm_luchtmeetnet_mqtt_measurement(self,_station_number : str, data: Measurement, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Measurement], str]=None) -> None:
        """
    ...
    def send_nl_rivm_luchtmeetnet_mqtt_lki(self,_station_number : str, data: LKI, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, LKI], str]=None) -> None:
        """
...
class NlRivmLuchtmeetnetAmqpEventProducer:
    ...
    def send_nl_rivm_luchtmeetnet_amqp_station(self,_station_number : str, data: Station, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
    ...
    def send_nl_rivm_luchtmeetnet_amqp_measurement(self,_station_number : str, data: Measurement, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Measurement], str]=None) -> None:
        """
    ...
    def send_nl_rivm_luchtmeetnet_amqp_lki(self,_station_number : str, data: LKI, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, LKI], str]=None) -> None:
        """
...
class NlRivmLuchtmeetnetComponentsMqttEventProducer:
    ...
    def send_nl_rivm_luchtmeetnet_components_mqtt_component(self,_formula : str, data: Component, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Component], str]=None) -> None:
        """
...
class NlRivmLuchtmeetnetComponentsAmqpEventProducer:
    ...
    def send_nl_rivm_luchtmeetnet_components_amqp_component(self,_formula : str, data: Component, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Component], str]=None) -> None:
        """

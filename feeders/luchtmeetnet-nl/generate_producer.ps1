...
xrcg generate --style kafkaproducer --language py --definitions xreg\luchtmeetnet-nl.xreg.json --projectname luchtmeetnet_nl_producer --output luchtmeetnet_nl_producer

...
class BlitzortungLightningEventProducer:
    ...
    def send_blitzortung_lightning_lightning_stroke(self,_source_id : str, _stroke_id : str, _event_time : str, data: LightningStroke, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, LightningStroke], str]=None) -> None:
        """
...
class BlitzortungLightningMqttEventProducer:
    ...
    def send_blitzortung_lightning_mqtt_lightning_stroke(self,_source_id : str, _stroke_id : str, _event_time : str, data: LightningStroke, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, LightningStroke], str]=None) -> None:
        """

...
class Test_Observation(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Observation(
            code_station='rffrfekvwkgxwupqksby',
            date_obs=datetime.datetime.now(datetime.timezone.utc),
            resultat_obs=float(28.201070408205766),
            grandeur_hydro='ymauvpcsbxbimgiyidlq',
            libelle_methode_obs='fhtthopttyflilcsjxjn',
            libelle_qualification_obs='murkeecpkvnglbekctky',
            basin='ncefpqwkgatoamiqrnnp'
        )
        return instance
    ...
    def test_code_station_property(self):
        ...
        """
        test_value = 'rffrfekvwkgxwupqksby'
    ...
    def test_resultat_obs_property(self):
        ...
        """
        test_value = float(28.201070408205766)
    ...
    def test_grandeur_hydro_property(self):
        ...
        """
        test_value = 'ymauvpcsbxbimgiyidlq'
    ...
    def test_libelle_methode_obs_property(self):
        ...
        """
        test_value = 'fhtthopttyflilcsjxjn'
    ...
    def test_libelle_qualification_obs_property(self):
        ...
        """
        test_value = 'murkeecpkvnglbekctky'
    ...
    def test_basin_property(self):
        ...
        Test basin property
        """
        test_value = 'ncefpqwkgatoamiqrnnp'

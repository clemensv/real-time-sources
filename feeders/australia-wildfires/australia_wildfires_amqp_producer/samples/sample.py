...
"""
Sample usage of australia_wildfires_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send FireIncident message
        print("Sending FireIncident message...")
        # TODO: Create a FireIncident instance with actual data
        # data = FireIncident(...)
        # producer.send_fire_incident(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("FireIncident message sent successfully!")

...
class GridSignal:
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"GridSignal\", \"namespace\": \"info.energy_charts\", \"fields\": [{\"name\": \"country\", \"type\": \"string\"}, {\"name\": \"timestamp\", \"type\": {\"type\": \"long\", \"logicalType\": \"timestamp-millis\"}}, {\"name\": \"unix_seconds\", \"type\": \"long\"}, {\"name\": \"signal\", \"type\": [\"null\", \"int\"], \"default\": null}, {\"name\": \"renewable_share_pct\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"substitute\", \"type\": [\"null\", \"boolean\"], \"default\": null}]}"), avro.name.Names()
    )
    ...
    def __post_init__(self):
        ...
        self.signal=int(self.signal) if self.signal else None
        self.renewable_share_pct=float(self.renewable_share_pct) if self.renewable_share_pct else None
        self.substitute=bool(self.substitute) if self.substitute else None

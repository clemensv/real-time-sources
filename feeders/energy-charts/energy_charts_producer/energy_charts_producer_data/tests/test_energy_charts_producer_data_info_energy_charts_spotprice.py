...
class Test_SpotPrice(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = SpotPrice(
            country='grbcxydoravqjxavjpkj',
            bidding_zone='ljnyoetpbxmkekflluvg',
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            unix_seconds=int(62),
            price_eur_per_mwh=float(82.228060018156),
            unit='elgpnxewyepneiuykpan'
        )
        return instance
    ...
    def test_country_property(self):
        ...
        """
        test_value = 'grbcxydoravqjxavjpkj'
    ...
    def test_bidding_zone_property(self):
        ...
        """
        test_value = 'ljnyoetpbxmkekflluvg'
    ...
    def test_price_eur_per_mwh_property(self):
        ...
        """
        test_value = float(82.228060018156)
    ...
    def test_unit_property(self):
        ...
        Test unit property
        """
        test_value = 'elgpnxewyepneiuykpan'

...
from energy_charts_mqtt_producer_data.gridsignal import GridSignal
import datetime
...
class Test_GridSignal(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = GridSignal(
            country='mkiqalhfkfbpmswpysft',
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            unix_seconds=int(22),
            signal=int(66),
            renewable_share_pct=float(14.323371450407308),
            substitute=True
        )
        return instance
    ...
    def test_country_property(self):
        ...
        """
        test_value = 'mkiqalhfkfbpmswpysft'
    ...
    def test_renewable_share_pct_property(self):
        ...
        """
        test_value = float(14.323371450407308)

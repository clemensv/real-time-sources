...
class Test_SpotPrice(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = SpotPrice(
            country='hkxkvhudzwujixnrcdxq',
            bidding_zone='cbadkbzhahppvmnbpzds',
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            unix_seconds=int(91),
            price_eur_per_mwh=float(72.27985604027602),
            unit='wncclllvsutjrdrxharo'
        )
        return instance
    ...
    def test_country_property(self):
        ...
        """
        test_value = 'hkxkvhudzwujixnrcdxq'
    ...
    def test_bidding_zone_property(self):
        ...
        """
        test_value = 'cbadkbzhahppvmnbpzds'
    ...
    def test_price_eur_per_mwh_property(self):
        ...
        """
        test_value = float(72.27985604027602)
    ...
    def test_unit_property(self):
        ...
        Test unit property
        """
        test_value = 'wncclllvsutjrdrxharo'

...
from energy_charts_mqtt_producer_data.spotprice import SpotPrice
import datetime
...
class Test_SpotPrice(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = SpotPrice(
            country='swgxbgvifhjfrczadrra',
            bidding_zone='nerhudotgxytxtftwptq',
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            unix_seconds=int(12),
            price_eur_per_mwh=float(4.9798014502310695),
            unit='hghjknfwaxlhiuwuzduv'
        )
        return instance
    ...
    def test_country_property(self):
        ...
        """
        test_value = 'swgxbgvifhjfrczadrra'
    ...
    def test_bidding_zone_property(self):
        ...
        """
        test_value = 'nerhudotgxytxtftwptq'
    ...
    def test_price_eur_per_mwh_property(self):
        ...
        """
        test_value = float(4.9798014502310695)
    ...
    def test_unit_property(self):
        ...
        Test unit property
        """
        test_value = 'hghjknfwaxlhiuwuzduv'

...
class Test_SpotPrice(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = SpotPrice(
            country='efnnflhqdzbdszcrkgzn',
            bidding_zone='hlgaakytrrhmbaunatll',
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            unix_seconds=int(92),
            price_eur_per_mwh=float(46.42771482162066),
            unit='mnajhlijrktkzsyurjzr'
        )
        return instance
    ...
    def test_country_property(self):
        ...
        """
        test_value = 'efnnflhqdzbdszcrkgzn'
    ...
    def test_bidding_zone_property(self):
        ...
        """
        test_value = 'hlgaakytrrhmbaunatll'
    ...
    def test_price_eur_per_mwh_property(self):
        ...
        """
        test_value = float(46.42771482162066)
    ...
    def test_unit_property(self):
        ...
        Test unit property
        """
        test_value = 'mnajhlijrktkzsyurjzr'

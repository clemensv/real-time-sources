"""AMQP companion feeder for energy-charts. Publishes mock/sample CloudEvents for Docker E2E and auth-blocked upstreams."""
...
from energy_charts_amqp_producer_amqp_producer import producer as producer_mod
import energy_charts_amqp_producer_data as data_mod

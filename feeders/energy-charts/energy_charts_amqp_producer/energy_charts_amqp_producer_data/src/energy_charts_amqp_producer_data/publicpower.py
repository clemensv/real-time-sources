...
class PublicPower:
    ...
    def create_instance(cls) -> 'PublicPower':
        ...
        """
        return cls(
            country='tgsmslnutbkqsohogkis',
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            unix_seconds=int(54),
            hydro_pumped_storage_consumption_mw=float(32.631043598603604),
            cross_border_electricity_trading_mw=float(94.53936530017944),
            hydro_run_of_river_mw=float(93.29743361988285),
            biomass_mw=float(98.04849210458406),
            fossil_brown_coal_lignite_mw=float(56.99899225403055),
            fossil_hard_coal_mw=float(42.054782796275724),
            fossil_oil_mw=float(0.24704862942453998),
            fossil_coal_derived_gas_mw=float(21.88523039398069),
            fossil_gas_mw=float(15.702051133194617),
            geothermal_mw=float(94.93927155477093),
            hydro_water_reservoir_mw=float(22.605295465099452),
            hydro_pumped_storage_mw=float(41.98280197010059),
            others_mw=float(13.815357677356932),
            waste_mw=float(17.79248750694452),
            wind_offshore_mw=float(27.72854207726494),
            wind_onshore_mw=float(11.610681584217208),
            solar_mw=float(95.6103888290696),
            nuclear_mw=float(99.67299194020262),
            load_mw=float(71.65351875695626),
            residual_load_mw=float(62.209234374334976),
            renewable_share_of_generation_pct=float(66.08171643971136),
            renewable_share_of_load_pct=float(61.24813591476198)
        )
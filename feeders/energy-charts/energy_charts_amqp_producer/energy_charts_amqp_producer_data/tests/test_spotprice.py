...
class Test_SpotPrice(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = SpotPrice(
            country='wlxozffvxisejzqainhs',
            bidding_zone='thpsaxcqnmqrrgxzvcff',
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            unix_seconds=int(75),
            price_eur_per_mwh=float(92.37323644654413),
            unit='ylxbjzxlqbkqoraugoid'
        )
        return instance
    ...
    def test_country_property(self):
        ...
        """
        test_value = 'wlxozffvxisejzqainhs'
    ...
    def test_bidding_zone_property(self):
        ...
        """
        test_value = 'thpsaxcqnmqrrgxzvcff'
    ...
    def test_price_eur_per_mwh_property(self):
        ...
        """
        test_value = float(92.37323644654413)
    ...
    def test_unit_property(self):
        ...
        Test unit property
        """
        test_value = 'ylxbjzxlqbkqoraugoid'

...
from energy_charts_amqp_producer_data.spotprice import SpotPrice
import datetime
...
class Test_SpotPrice(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = SpotPrice(
            country='ieammgoawzuxfetzgnfs',
            bidding_zone='kkpevmutveqdveblflzu',
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            unix_seconds=int(26),
            price_eur_per_mwh=float(18.664107995831547),
            unit='hbkngzbuadnojemyhqio'
        )
        return instance
    ...
    def test_country_property(self):
        ...
        """
        test_value = 'ieammgoawzuxfetzgnfs'
    ...
    def test_bidding_zone_property(self):
        ...
        """
        test_value = 'kkpevmutveqdveblflzu'
    ...
    def test_price_eur_per_mwh_property(self):
        ...
        """
        test_value = float(18.664107995831547)
    ...
    def test_unit_property(self):
        ...
        Test unit property
        """
        test_value = 'hbkngzbuadnojemyhqio'

...
class Test_SpotPrice(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = SpotPrice(
            country='ofxdskgnbfxzvyiiwpfl',
            bidding_zone='wplhtdrvzdweohxvjmlb',
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            unix_seconds=int(80),
            price_eur_per_mwh=float(99.47185929439746),
            unit='vwwncrnjdfzavghixmvd'
        )
        return instance
    ...
    def test_country_property(self):
        ...
        """
        test_value = 'ofxdskgnbfxzvyiiwpfl'
    ...
    def test_bidding_zone_property(self):
        ...
        """
        test_value = 'wplhtdrvzdweohxvjmlb'
    ...
    def test_price_eur_per_mwh_property(self):
        ...
        """
        test_value = float(99.47185929439746)
    ...
    def test_unit_property(self):
        ...
        Test unit property
        """
        test_value = 'vwwncrnjdfzavghixmvd'

...
from carbon_intensity_amqp_producer_data.intensity import Intensity
import datetime
...
class Test_Intensity(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Intensity(
            ...
            forecast=int(49),
            actual=int(26),
            index='wrwctudtsqohcjoxwbse',
            region='fzkwamrclgwbhcfqadxc',
            ce_id='xsurxdnmkiqdhngmnozv'
        )
        return instance
    ...
    def test_index_property(self):
        ...
        Test index property
        """
        test_value = 'wrwctudtsqohcjoxwbse'
    ...
    def test_region_property(self):
        ...
        """
        test_value = 'fzkwamrclgwbhcfqadxc'
    ...
    def test_ce_id_property(self):
        ...
        Test ce_id property
        """
        test_value = 'xsurxdnmkiqdhngmnozv'

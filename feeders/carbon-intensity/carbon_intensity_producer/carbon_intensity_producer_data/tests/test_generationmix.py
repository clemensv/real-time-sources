...
class Test_GenerationMix(unittest.TestCase):
    ...
    def test_biomass_pct_property(self):
        ...
        """
        test_value = float(65.2567880059566)
    ...
    def test_coal_pct_property(self):
        ...
        """
        test_value = float(2.7084585702539465)
    ...
    def test_gas_pct_property(self):
        ...
        """
        test_value = float(90.74376398768476)
    ...
    def test_hydro_pct_property(self):
        ...
        """
        test_value = float(53.58536907009872)
    ...
    def test_imports_pct_property(self):
        ...
        """
        test_value = float(48.63640973978293)
    ...
    def test_nuclear_pct_property(self):
        ...
        """
        test_value = float(89.22678503752289)
    ...
    def test_oil_pct_property(self):
        ...
        """
        test_value = float(33.403495668661655)
    ...
    def test_other_pct_property(self):
        ...
        """
        test_value = float(48.03921012461614)
    ...
    def test_solar_pct_property(self):
        ...
        """
        test_value = float(14.555538361124931)
    ...
    def test_wind_pct_property(self):
        ...
        """
        test_value = float(25.198862938401202)
    ...
    def test_region_property(self):
        ...
        """
        test_value = 'ekptelvmjuuvtpiuwbdr'
    ...
    def test_ce_id_property(self):
        ...
        Test ce_id property
        """
        test_value = 'eidlsxtsyyaqwnhuxrdl'

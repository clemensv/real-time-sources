...
"""
Sample usage of ptwc_tsunami_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send TsunamiBulletin message
        print("Sending TsunamiBulletin message...")
        # TODO: Create a TsunamiBulletin instance with actual data
        # data = TsunamiBulletin(...)
        # producer.send_tsunami_bulletin(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("TsunamiBulletin message sent successfully!")

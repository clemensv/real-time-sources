"""AMQP 1.0 companion feeder for ptwc-tsunami."""
from __future__ import annotations
import argparse, asyncio, importlib, inspect, logging, os
...
SOURCE_ID = "ptwc-tsunami"
PY_MODULE = "ptwc_tsunami"
...
def main() -> None:
    ...
    parser = _add_common_args(argparse.ArgumentParser(description=f"{SOURCE_ID} AMQP 1.0 bridge")); args = parser.parse_args()

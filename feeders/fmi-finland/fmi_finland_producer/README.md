...
# Fmi_finland_producer Kafka Producer# Fmi_finland_producer Event Dispatcher for Apache Kafka
...
3. [Quick Start](#quick-start)    - FiFmiOpendataAirqualityEventDispatcher,

4. [Generated Producer Classes](#generated-producer-classes)    FiFmiOpendataAirqualityMqttEventDispatcher,

4. [Generated Producer Classes](#generated-producer-classes)    FiFmiOpendataAirqualityAmqpEventDispatcher
...
- FiFmiOpendataAirqualityProducersolution for event-driven applications.

It includes both plain Kafka messages and CloudEvents, offering a versatile

- FiFmiOpendataAirqualityMqttProducersolution for event-driven applications.

It includes both plain Kafka messages and CloudEvents, offering a versatile

- FiFmiOpendataAirqualityAmqpProducersolution for event-driven applications.
...
- **Scales horizontally** across multiple brokers and partitions### FiFmiOpendataAirqualityEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`FiFmiOpendataAirqualityEventDispatcher` handles events for the fi.fmi.opendata.airquality message group.
...
from fmi_finland_producer import FiFmiOpendataAirqualityProducer```python

create_processor(self, bootstrap_servers: str, group_id: str, topics: List[str]) -> EventProcessorRunner

# Create producer```

producer = FiFmiOpendataAirqualityProducer(
...
await producer.send_fi_fmi_opendata_airquality_station(```python
...
The FiFmiOpendataAirqualityEventDispatcher defines the following event handler hooks.
...
producer = FiFmiOpendataAirqualityProducer(
    ...
    security_protocol='SASL_SSL',##### `fi_fmi_opendata_airquality_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'fi_fmi_opendata_airquality_station_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `fi.fmi.opendata.airquality.Station`: Reference data for a Finnish Meteorological
Institute air quality monitoring station.
...
### FiFmiOpendataAirqualityProducer- `data`: The event data of type `fmi_finland_producer_data.Station`.



Producer for `fi.fmi.opendata.airquality` message group.Example:



#### Constructor```python

async def fi_fmi_opendata_airquality_station_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Station) ->
None:

```python    # Process the event data

FiFmiOpendataAirqualityProducer(    await some_processing_function(record, cloud_event, data)
...
fi_fmi_opendata_airquality_dispatcher.fi_fmi_opendata_airquality_station_async =
fi_fmi_opendata_airquality_station_event
...
### FiFmiOpendataAirqualityMqttProducer- `data`: The event data of type `fmi_finland_producer_data.Station`.



Producer for `fi.fmi.opendata.airquality.mqtt` message group.Example:
...
FiFmiOpendataAirqualityMqttProducer(    await some_processing_function(record, cloud_event, data)
...
fi_fmi_opendata_airquality_mqtt_dispatcher.fi_fmi_opendata_airquality_station_async =
fi_fmi_opendata_airquality_station_event
...
### FiFmiOpendataAirqualityAmqpProducer- `data`: The event data of type `fmi_finland_producer_data.Station`.



Producer for `fi.fmi.opendata.airquality.amqp` message group.Example:
...
FiFmiOpendataAirqualityAmqpProducer(    await some_processing_function(record, cloud_event, data)
...
fi_fmi_opendata_airquality_amqp_dispatcher.fi_fmi_opendata_airquality_station_async =
fi_fmi_opendata_airquality_station_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `fi_fmi_opendata_airquality_observation_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'fi_fmi_opendata_airquality_observation_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `fi.fmi.opendata.airquality.Observation`: Hourly air quality observation aggregated per
station and timestamp from FMI OGC WFS simple query results.
...
### FiFmiOpendataAirqualityProducer- `data`: The event data of type `fmi_finland_producer_data.Observation`.
...
async def fi_fmi_opendata_airquality_observation_event(record: ConsumerRecord, cloud_event: CloudEvent, data:
Observation) -> None:
...
fi_fmi_opendata_airquality_dispatcher.fi_fmi_opendata_airquality_observation_async =
fi_fmi_opendata_airquality_observation_event
...
### FiFmiOpendataAirqualityMqttProducer- `data`: The event data of type `fmi_finland_producer_data.Observation`.
...
fi_fmi_opendata_airquality_mqtt_dispatcher.fi_fmi_opendata_airquality_observation_async =
fi_fmi_opendata_airquality_observation_event
...
### FiFmiOpendataAirqualityAmqpProducer- `data`: The event data of type `fmi_finland_producer_data.Observation`.
...
fi_fmi_opendata_airquality_amqp_dispatcher.fi_fmi_opendata_airquality_observation_async =
fi_fmi_opendata_airquality_observation_event
...
##### `send_fi_fmi_opendata_airquality_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_fi_fmi_opendata_airquality_station(
...
Send a single `fi.fmi.opendata.airquality.Station` message. Reference data for a Finnish Meteorological Institute air
quality monitoring station.Args:
...
await producer.send_fi_fmi_opendata_airquality_station(
...
Send multiple `fi.fmi.opendata.airquality.Station` messages in a batch.
...
await producer.send_fi_fmi_opendata_airquality_station_batch(```
...
##### `send_fi_fmi_opendata_airquality_observation`Dispatchers have the following protected methods:



```python### Methods:

async def send_fi_fmi_opendata_airquality_observation(
...
Send a single `fi.fmi.opendata.airquality.Observation` message. Hourly air quality observation aggregated per station
and timestamp from FMI OGC WFS simple query results.Args:
...
await producer.send_fi_fmi_opendata_airquality_observation(
...
Send multiple `fi.fmi.opendata.airquality.Observation` messages in a batch.
...
await producer.send_fi_fmi_opendata_airquality_observation_batch(```
...
- **Scales horizontally** across multiple brokers and partitions### FiFmiOpendataAirqualityMqttEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`FiFmiOpendataAirqualityMqttEventDispatcher` handles events for the fi.fmi.opendata.airquality.mqtt message group.
...
The FiFmiOpendataAirqualityMqttEventDispatcher defines the following event handler hooks.
...
producer = FiFmiOpendataAirqualityProducer(
    ...
    security_protocol='SASL_SSL',##### `fi_fmi_opendata_airquality_mqtt_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'fi_fmi_opendata_airquality_mqtt_station_async:  Callable[[ConsumerRecord, CloudEvent,
Station], Awaitable[None]]
...
Asynchronous handler hook for `fi.fmi.opendata.airquality.mqtt.Station`: Reference data for a Finnish Meteorological
Institute air quality monitoring station.
...
async def fi_fmi_opendata_airquality_mqtt_station_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Station)
-> None:
...
fi_fmi_opendata_airquality_dispatcher.fi_fmi_opendata_airquality_mqtt_station_async =
fi_fmi_opendata_airquality_mqtt_station_event
...
fi_fmi_opendata_airquality_mqtt_dispatcher.fi_fmi_opendata_airquality_mqtt_station_async =
fi_fmi_opendata_airquality_mqtt_station_event
...
fi_fmi_opendata_airquality_amqp_dispatcher.fi_fmi_opendata_airquality_mqtt_station_async =
fi_fmi_opendata_airquality_mqtt_station_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `fi_fmi_opendata_airquality_mqtt_observation_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'fi_fmi_opendata_airquality_mqtt_observation_async:  Callable[[ConsumerRecord,
...
Asynchronous handler hook for `fi.fmi.opendata.airquality.mqtt.Observation`: Hourly air quality observation aggregated
per station and timestamp from FMI OGC WFS simple query results.
...
async def fi_fmi_opendata_airquality_mqtt_observation_event(record: ConsumerRecord, cloud_event: CloudEvent, data:
Observation) -> None:
...
fi_fmi_opendata_airquality_dispatcher.fi_fmi_opendata_airquality_mqtt_observation_async =
fi_fmi_opendata_airquality_mqtt_observation_event
...
fi_fmi_opendata_airquality_mqtt_dispatcher.fi_fmi_opendata_airquality_mqtt_observation_async =
fi_fmi_opendata_airquality_mqtt_observation_event
...
fi_fmi_opendata_airquality_amqp_dispatcher.fi_fmi_opendata_airquality_mqtt_observation_async =
fi_fmi_opendata_airquality_mqtt_observation_event
...
##### `send_fi_fmi_opendata_airquality_mqtt_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_fi_fmi_opendata_airquality_mqtt_station(
...
Send a single `fi.fmi.opendata.airquality.mqtt.Station` message. Reference data for a Finnish Meteorological Institute
air quality monitoring station.Args:
...
await producer.send_fi_fmi_opendata_airquality_mqtt_station(
...
Send multiple `fi.fmi.opendata.airquality.mqtt.Station` messages in a batch.
...
await producer.send_fi_fmi_opendata_airquality_mqtt_station_batch(```
...
##### `send_fi_fmi_opendata_airquality_mqtt_observation`Dispatchers have the following protected methods:



```python### Methods:

async def send_fi_fmi_opendata_airquality_mqtt_observation(
...
Send a single `fi.fmi.opendata.airquality.mqtt.Observation` message. Hourly air quality observation aggregated per
station and timestamp from FMI OGC WFS simple query results.Args:
...
await producer.send_fi_fmi_opendata_airquality_mqtt_observation(
...
Send multiple `fi.fmi.opendata.airquality.mqtt.Observation` messages in a batch.
...
await producer.send_fi_fmi_opendata_airquality_mqtt_observation_batch(```
...
- **Scales horizontally** across multiple brokers and partitions### FiFmiOpendataAirqualityAmqpEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`FiFmiOpendataAirqualityAmqpEventDispatcher` handles events for the fi.fmi.opendata.airquality.amqp message group.
...
The FiFmiOpendataAirqualityAmqpEventDispatcher defines the following event handler hooks.
...
producer = FiFmiOpendataAirqualityProducer(
    ...
    security_protocol='SASL_SSL',##### `fi_fmi_opendata_airquality_amqp_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'fi_fmi_opendata_airquality_amqp_station_async:  Callable[[ConsumerRecord, CloudEvent,
Station], Awaitable[None]]
...
Asynchronous handler hook for `fi.fmi.opendata.airquality.amqp.Station`: Reference data for a Finnish Meteorological
Institute air quality monitoring station.
...
async def fi_fmi_opendata_airquality_amqp_station_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Station)
-> None:
...
fi_fmi_opendata_airquality_dispatcher.fi_fmi_opendata_airquality_amqp_station_async =
fi_fmi_opendata_airquality_amqp_station_event
...
fi_fmi_opendata_airquality_mqtt_dispatcher.fi_fmi_opendata_airquality_amqp_station_async =
fi_fmi_opendata_airquality_amqp_station_event
...
fi_fmi_opendata_airquality_amqp_dispatcher.fi_fmi_opendata_airquality_amqp_station_async =
fi_fmi_opendata_airquality_amqp_station_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `fi_fmi_opendata_airquality_amqp_observation_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'fi_fmi_opendata_airquality_amqp_observation_async:  Callable[[ConsumerRecord,
CloudEvent, Observation], Awaitable[None]]
...
Asynchronous handler hook for `fi.fmi.opendata.airquality.amqp.Observation`: Hourly air quality observation aggregated
per station and timestamp from FMI OGC WFS simple query results.
...
async def fi_fmi_opendata_airquality_amqp_observation_event(record: ConsumerRecord, cloud_event: CloudEvent, data:
Observation) -> None:
...
fi_fmi_opendata_airquality_dispatcher.fi_fmi_opendata_airquality_amqp_observation_async =
fi_fmi_opendata_airquality_amqp_observation_event
...
fi_fmi_opendata_airquality_mqtt_dispatcher.fi_fmi_opendata_airquality_amqp_observation_async =
fi_fmi_opendata_airquality_amqp_observation_event
...
fi_fmi_opendata_airquality_amqp_dispatcher.fi_fmi_opendata_airquality_amqp_observation_async =
fi_fmi_opendata_airquality_amqp_observation_event
...
##### `send_fi_fmi_opendata_airquality_amqp_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_fi_fmi_opendata_airquality_amqp_station(
...
Send a single `fi.fmi.opendata.airquality.amqp.Station` message. Reference data for a Finnish Meteorological Institute
air quality monitoring station.Args:
...
await producer.send_fi_fmi_opendata_airquality_amqp_station(
...
Send multiple `fi.fmi.opendata.airquality.amqp.Station` messages in a batch.
...
await producer.send_fi_fmi_opendata_airquality_amqp_station_batch(```
...
##### `send_fi_fmi_opendata_airquality_amqp_observation`Dispatchers have the following protected methods:



```python### Methods:

async def send_fi_fmi_opendata_airquality_amqp_observation(
...
Send a single `fi.fmi.opendata.airquality.amqp.Observation` message. Hourly air quality observation aggregated per
station and timestamp from FMI OGC WFS simple query results.Args:
...
await producer.send_fi_fmi_opendata_airquality_amqp_observation(
...
Send multiple `fi.fmi.opendata.airquality.amqp.Observation` messages in a batch.
...
await producer.send_fi_fmi_opendata_airquality_amqp_observation_batch(```

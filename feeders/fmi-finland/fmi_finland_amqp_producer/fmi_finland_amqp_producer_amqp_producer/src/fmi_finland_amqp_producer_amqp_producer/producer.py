...
class FiFmiOpendataAirqualityAmqpProducer:
    """
    Producer class to send messages in the `fi.fmi.opendata.airquality.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_station(self,
        ...
        """
        Send the `fi.fmi.opendata.airquality.amqp.Station` message
        ...
        amqp_msg.subject = "{fmisid}".format(fmisid=_fmisid)
    ...
    def send_station_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.fmi.opendata.airquality.amqp.Station` messages
    ...
    def send_observation(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.fmi.opendata.airquality.amqp.Observation` message
    ...
    def send_observation_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.fmi.opendata.airquality.amqp.Observation` messages

...
class USGSEarthquakesMqttEventProducer:
    ...
    def send_usgs_earthquakes_mqtt_event(self,_source_uri : str, _net : str, _code : str, _event_time : str, data: Event, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Event], str]=None) -> None:
        """

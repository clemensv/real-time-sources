...
class USGSEarthquakesEventProducer:
    ...
    def send_usgs_earthquakes_event(self,_source_uri : str, _net : str, _code : str, data: Event, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Event], str]=None) -> None:
        """
        ...
        Args:
            ...
            key_mapper(Callable[[CloudEvent, Event], str]): A function to map the CloudEvent contents to a Kafka key (default: None).
                The default key is derived from the xRegistry Kafka key declaration '{net}/{code}'
        """
        kafka_key = "{net}/{code}".format(net=_net, code=_code)
        attributes = {
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'USGSEarthquakesEventProducer':
        """
...
class USGSEarthquakesMqttEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    def send_usgs_earthquakes_mqtt_event(self,_source_uri : str, _net : str, _code : str, data: Event, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Event], str]=None) -> None:
        """
        Sends the 'USGS.Earthquakes.mqtt.Event' event to the Kafka topic
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'USGSEarthquakesMqttEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.
...
class USGSEarthquakesAmqpEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    def send_usgs_earthquakes_amqp_event(self,_source_uri : str, _net : str, _code : str, data: Event, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Event], str]=None) -> None:
        """
        Sends the 'USGS.Earthquakes.amqp.Event' event to the Kafka topic
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'USGSEarthquakesAmqpEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.

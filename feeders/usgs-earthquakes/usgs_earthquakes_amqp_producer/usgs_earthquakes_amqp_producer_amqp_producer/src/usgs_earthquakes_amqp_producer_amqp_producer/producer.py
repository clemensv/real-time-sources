...
class USGSEarthquakesAmqpProducer:
    """
    Producer class to send messages in the `USGS.Earthquakes.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_event(self,
        ...
        """
        Send the `USGS.Earthquakes.amqp.Event` message
        ...
        attributes = {
            ...
            "subject":
            "{net}/{code}".format(net=_net, code=_code),
            "time":
        ...
        amqp_msg.subject = "{net}/{code}".format(net=_net, code=_code)
    ...
    def send_event_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `USGS.Earthquakes.amqp.Event` messages

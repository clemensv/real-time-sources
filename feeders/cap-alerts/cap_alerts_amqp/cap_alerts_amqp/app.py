...
def feed(args):
 alert_producer, zone_producer=_producer(args); mock=getattr(args,"mock",False); client=CapClient(); sources=load_sources(args.cap_sources) if not mock else []

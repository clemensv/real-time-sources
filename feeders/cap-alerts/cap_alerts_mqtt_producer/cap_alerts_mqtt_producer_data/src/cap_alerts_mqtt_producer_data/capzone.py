...
class CapZone:
    ...
    def create_instance(cls) -> 'CapZone':
        ...
        """
        return cls(
            cap_source_id='pqokgqaffjqydgxssjzd',
            zone_id='jjwdhnkfojdtsqkwxegd',
            name='sjwznpqzgeronhxbqtdh',
            zone_type='vyllsbrzogttojrnkowp',
            state='eatifjpdtzusjctrwfpk',
            forecast_office='skwokbbbobpvwripxtrk',
            time_zones=['nqbihuosdtidamuuxwko'],
            geometry='uxbvykvnexpognzuugen',
            provider_url='mruzlyqlctsfpfkjjrkz'
        )
...
class CapZone:
    ...
    zone_type: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="zone_type"))
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'CapZone':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['CapZone']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return CapZone.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'CapZone':
        """
        ...
        """
        return cls(
            cap_source_id='sfhvsmkhaeifzpirhrbn',
            zone_id='derznnsvcrtetbxxebux',
            name='cftalkethwyokfeixhwu',
            zone_type='umjhwgtczuroxfkxahwd',
            state='uxhhqpednhqgzmwouttm',
            forecast_office='oxfabdtqrgpdihjalfyg',
            time_zones=['llqqzttxrnivryjsjvph', 'rolcytoalffosctcugwj', 'lcsygeddpkrrdoedqddh', 'uyhvkeqnyjpmnqmhtfhb', 'jevrxkyauhmnwndrgmoy'],
            geometry='jahwykcsrfpyarwnkznq',
            provider_url='apfdimofrgausebpkbue'
        )
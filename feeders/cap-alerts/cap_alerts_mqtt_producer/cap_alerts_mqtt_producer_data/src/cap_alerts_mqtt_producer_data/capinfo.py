...
import json
from cap_alerts_mqtt_producer_data.certaintyenum import CertaintyEnum
from cap_alerts_mqtt_producer_data.caparea import CapArea
from cap_alerts_mqtt_producer_data.severityenum import SeverityEnum
from cap_alerts_mqtt_producer_data.valuepair import ValuePair
from cap_alerts_mqtt_producer_data.responsetypelistenum import ResponseTypelistenum
from cap_alerts_mqtt_producer_data.categorylistenum import CategoryListEnum
from cap_alerts_mqtt_producer_data.capresource import CapResource
from cap_alerts_mqtt_producer_data.urgencyenum import UrgencyEnum
import datetime
...
class CapInfo:
    ...
    def create_instance(cls) -> 'CapInfo':
        ...
        return cls(
            ...
            sender_name='cvnhzzamtkmhvgoczhis',
            headline='ljmuxjnaxmuijtnphifz',
            description='phwskghyxdwgnixafbej',
            instruction='bwdlcqppfsntthxdmpoo',
            web='pfikgcvjjniopciclikt',
            contact='gwsmztmerdtekvakfvob',
            parameter=[None, None],
            resource=[None, None],

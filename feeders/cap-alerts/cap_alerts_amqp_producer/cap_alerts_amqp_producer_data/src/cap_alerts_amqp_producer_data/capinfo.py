...
import json
from cap_alerts_amqp_producer_data.urgencyenum import UrgencyEnum
from cap_alerts_amqp_producer_data.responsetypelistenum import ResponseTypelistenum
from cap_alerts_amqp_producer_data.severityenum import SeverityEnum
from cap_alerts_amqp_producer_data.valuepair import ValuePair
from cap_alerts_amqp_producer_data.categorylistenum import CategoryListEnum
from cap_alerts_amqp_producer_data.capresource import CapResource
from cap_alerts_amqp_producer_data.caparea import CapArea
from cap_alerts_amqp_producer_data.certaintyenum import CertaintyEnum
import datetime
...
class CapInfo:
    ...
    def create_instance(cls) -> 'CapInfo':
        ...
        """
        return cls(
            language='fvkmdxkkpowuonuksbzx',
            category=[CategoryListEnum.Geo],
            event='coopzmajzoopfadtxelp',
            ...
            sender_name='mkatqqtucxllivesjwyh',
            headline='nqvoticmvphcnlrrutlj',
            description='dwjrebrlanrfkoktnnuw',
            instruction='cjojmxiywyafchcepfkw',
            web='bscbbadtoxqowmrxayll',
            contact='uddxxxanqptfpnsoitxb',

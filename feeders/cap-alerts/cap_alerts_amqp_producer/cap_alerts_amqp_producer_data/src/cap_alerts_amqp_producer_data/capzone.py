...
class CapZone:
    ...
    def create_instance(cls) -> 'CapZone':
        ...
        """
        return cls(
            cap_source_id='upnkjgwqkvwozvjuasox',
            zone_id='pnsaaugsyampbiakbalx',
            name='wndkianeklrjsotsodxg',
            zone_type='phtbugxunpfpzvtvkywd',
            state='wqcbyypovvczsdgwikvy',
            forecast_office='qsptdtfaudawtblrddnw',
            time_zones=['qcyvvbludexxjkzxvxrz', 'zrwbdsttmsnhyjtezogk', 'kdatvywgldokmobiyvkx'],
            geometry='xhgjdnxndwjsxchacdbd',
            provider_url='ebchywpgppkbqjpusvyg'
        )
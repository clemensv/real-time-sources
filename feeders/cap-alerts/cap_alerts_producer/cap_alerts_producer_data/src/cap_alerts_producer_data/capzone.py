...
class CapZone:
    ...
    def create_instance(cls) -> 'CapZone':
        ...
        """
        return cls(
            cap_source_id='gnmlqzslbynogebftohr',
            zone_id='zvwzezlsthgzvlmfnkdt',
            name='mfgbleyemoegcikmducm',
            zone_type='wwbcubukycfytotudihx',
            state='gvzmweqqvqqtxvhmkwyz',
            forecast_office='cysqxyjoluddjduaynau',
            time_zones=['pfrthnltkycircwewaiq'],
            geometry='ifjnzflwwcstbtifzcqq',
            provider_url='uyolhoxiufvkclbawosa'
        )
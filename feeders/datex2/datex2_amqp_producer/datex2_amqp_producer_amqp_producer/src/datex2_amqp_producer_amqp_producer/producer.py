    ...
    def _fail_all(self, exc):
        ...
        for fut in list(self._pending.values()):
            if not fut.done():
                fut.set_exception(exc)
        self._pending.clear()
from datex2_amqp_producer_data import SituationRecord
from datex2_amqp_producer_data import MeasurementSite
from datex2_amqp_producer_data import TrafficMeasurement

class OrgDatex2SituationAmqpProducer:
    """
    Producer class to send messages in the `org.datex2.situation.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_amqp(self,
        ...
        """
        Send the `org.datex2.situation.SituationRecord.amqp` message
        ...
        attributes = {
            ...
            "subject":
            "{supplier_id}/{situation_record_id}".format(supplier_id=_supplier_id, situation_record_id=_situation_record_id),
        }
        ...
        amqp_msg.subject = "{supplier_id}/{situation_record_id}".format(supplier_id=_supplier_id, situation_record_id=_situation_record_id)
        ...
        annotations = {}
        annotation_value = "{supplier_id}/{situation_record_id}".format(supplier_id=_supplier_id, situation_record_id=_situation_record_id)
    ...
    def send_amqp_batch(self,
        data_array: typing.List[SituationRecord],
        _feed_url: str,
        _supplier_id: str,
        _situation_record_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `org.datex2.situation.SituationRecord.amqp` messages
        
        Args:
            data_array (typing.List[SituationRecord]): Array of message data objects
            _feed_url (str): Value for placeholder feed_url in attribute source
            _supplier_id (str): Value for placeholder supplier_id in attribute subject
            _situation_record_id (str): Value for placeholder situation_record_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
...
class OrgDatex2MeasuredSiteAmqpProducer:
    """
    Producer class to send messages in the `org.datex2.measured_site.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_amqp(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `org.datex2.measured.MeasurementSite.amqp` message
        ...
        attributes = {
            ...
            "{feed_url}".format(feed_url=_feed_url),
            "subject":
            "{supplier_id}/{measurement_site_id}".format(supplier_id=_supplier_id, measurement_site_id=_measurement_site_id),
        }
        attributes["time"] = _resolve_cloudevents_time(_time, attributes.get("time"))
        ...
        if amqp_creation_time is not None:
            amqp_msg.creation_time = amqp_creation_time
        # Apply AMQP message properties declared in protocoloptions.properties.
        amqp_msg.subject = "{supplier_id}/{measurement_site_id}".format(supplier_id=_supplier_id, measurement_site_id=_measurement_site_id)
        ...
        annotations = {}
        annotation_value = "{supplier_id}/{measurement_site_id}".format(supplier_id=_supplier_id, measurement_site_id=_measurement_site_id)
        annotation_value = str(annotation_value)[:128]
        annotations[symbol("x-opt-partition-key")] = annotation_value
        if annotations:
            if amqp_msg.annotations is None:
    ...
    def send_amqp_batch(self,
        data_array: typing.List[MeasurementSite],
        _feed_url: str,
        _supplier_id: str,
        _measurement_site_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `org.datex2.measured.MeasurementSite.amqp` messages
        
        Args:
            data_array (typing.List[MeasurementSite]): Array of message data objects
            _feed_url (str): Value for placeholder feed_url in attribute source
            _supplier_id (str): Value for placeholder supplier_id in attribute subject
            _measurement_site_id (str): Value for placeholder measurement_site_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
...
class OrgDatex2TrafficMeasurementAmqpProducer:
    """
    Producer class to send messages in the `org.datex2.traffic_measurement.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_amqp(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `org.datex2.measured.TrafficMeasurement.amqp` message
    ...
    def send_amqp_batch(self,
        data_array: typing.List[TrafficMeasurement],
        _feed_url: str,
        _supplier_id: str,
        _measurement_site_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `org.datex2.measured.TrafficMeasurement.amqp` messages
        
        Args:
            data_array (typing.List[TrafficMeasurement]): Array of message data objects
            _feed_url (str): Value for placeholder feed_url in attribute source
            _supplier_id (str): Value for placeholder supplier_id in attribute subject
            _measurement_site_id (str): Value for placeholder measurement_site_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.

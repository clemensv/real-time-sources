...
class HKGovEPDAQHIEventProducer:
    ...
    def send_hk_gov_epd_aqhi_station(self,_station_id : str, data: Station, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
    ...
    def send_hk_gov_epd_aqhi_aqhireading(self,_station_id : str, data: AQHIReading, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, AQHIReading], str]=None) -> None:
        """

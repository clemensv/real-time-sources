...
from irail_mqtt_producer_data.be.irail.arrivalboard import ArrivalBoard
...
class Test_ArrivalBoard(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = ArrivalBoard(
            station_id='ujnycmijceogzpoyspjc',
            station_name='ooftxjvtaqaytcozlltk',
            retrieved_at='ueljjxeuoxodizzsdant',
            arrival_count=int(12),
            arrivals=[None, None, None, None, None]
        )
        return instance
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'ujnycmijceogzpoyspjc'
    ...
    def test_station_name_property(self):
        ...
        """
        test_value = 'ooftxjvtaqaytcozlltk'
    ...
    def test_retrieved_at_property(self):
        ...
        """
        test_value = 'ueljjxeuoxodizzsdant'

...
from irail_mqtt_producer_data.be.irail.stationboard import StationBoard
...
class Test_StationBoard(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = StationBoard(
            station_id='qvglssmqnixwcyntsskf',
            station_name='updfwekxoznzpruglpta',
            retrieved_at='pgzrnupflwlxmkgkujtt',
            departure_count=int(48),
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'qvglssmqnixwcyntsskf'
    ...
    def test_station_name_property(self):
        ...
        """
        test_value = 'updfwekxoznzpruglpta'
    ...
    def test_retrieved_at_property(self):
        ...
        """
        test_value = 'pgzrnupflwlxmkgkujtt'

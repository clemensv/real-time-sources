...
class BeIrailAmqpProducer:
    """
    Producer class to send messages in the `be.irail.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_station(self,
        ...
        """
        Send the `be.irail.amqp.Station` message
    ...
    def send_station_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `be.irail.amqp.Station` messages
    ...
    def send_station_board(self,
        data: StationBoard,
        _station_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send the `be.irail.amqp.StationBoard` message
    ...
    def send_station_board_batch(self,
        data_array: typing.List[StationBoard],
        _station_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `be.irail.amqp.StationBoard` messages
        
        Args:
            data_array (typing.List[StationBoard]): Array of message data objects
            _station_id (str): Value for placeholder station_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            content_type (str): The content type of the message data
        """
        for data in data_array:
            self.send_station_board(
                data=data,
                _station_id=_station_id,
                _time=_time,
                content_type=content_type)
    ...
    def send_arrival_board(self,
        data: ArrivalBoard,
        _station_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send the `be.irail.amqp.ArrivalBoard` message
    ...
    def send_arrival_board_batch(self,
        data_array: typing.List[ArrivalBoard],
        _station_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `be.irail.amqp.ArrivalBoard` messages
        
        Args:
            data_array (typing.List[ArrivalBoard]): Array of message data objects
            _station_id (str): Value for placeholder station_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            content_type (str): The content type of the message data
        """
        for data in data_array:
            self.send_arrival_board(
                data=data,
                _station_id=_station_id,
                _time=_time,
                content_type=content_type)

...
class StationBoard:
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['StationBoard']:
        """
    ...
    def create_instance(cls) -> 'StationBoard':
        ...
        """
        return cls(
            station_id='plyvfwjgjjiofztzrsqt',
            station_name='uibwknheefljzmoyyedp',
            retrieved_at='hpzgewlvcggesxfwgqgg',
            departure_count=int(14),
            departures=[None]
        )
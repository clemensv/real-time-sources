...
"""
Sample usage of irail_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send StationBoard message
        print("Sending StationBoard message...")
        # TODO: Create a StationBoard instance with actual data
        # data = StationBoard(...)
        # producer.send_station_board(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("StationBoard message sent successfully!")
        
        
        
        # Send ArrivalBoard message
        print("Sending ArrivalBoard message...")
        # TODO: Create a ArrivalBoard instance with actual data
        # data = ArrivalBoard(...)
        # producer.send_arrival_board(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("ArrivalBoard message sent successfully!")

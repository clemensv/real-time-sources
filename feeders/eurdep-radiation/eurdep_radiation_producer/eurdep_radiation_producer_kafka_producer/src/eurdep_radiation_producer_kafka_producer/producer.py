...
class EuJrcEurdepEventProducer:
    ...
    def send_eu_jrc_eurdep_station(self,_feedurl : str, _station_id : str, data: Station, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
    ...
    def send_eu_jrc_eurdep_dose_rate_reading(self,_feedurl : str, _station_id : str, data: DoseRateReading, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, DoseRateReading], str]=None) -> None:
        """

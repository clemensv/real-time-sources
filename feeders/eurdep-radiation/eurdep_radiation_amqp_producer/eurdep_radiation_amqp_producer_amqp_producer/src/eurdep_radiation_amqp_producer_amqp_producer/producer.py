...
class EuJrcEurdepAmqpProducer:
    """
    Producer class to send messages in the `eu.jrc.eurdep.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_station(self,
        ...
        """
        Send the `eu.jrc.eurdep.amqp.Station` message
    ...
    def send_station_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `eu.jrc.eurdep.amqp.Station` messages
    ...
    def send_dose_rate_reading(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `eu.jrc.eurdep.amqp.DoseRateReading` message
    ...
    def send_dose_rate_reading_batch(self,
        data_array: typing.List[DoseRateReading],
        _feedurl: str,
        _station_id: str,
        _country: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `eu.jrc.eurdep.amqp.DoseRateReading` messages
        
        Args:
            data_array (typing.List[DoseRateReading]): Array of message data objects
            _feedurl (str): Value for placeholder feedurl in attribute source
            _station_id (str): Value for placeholder station_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            _country (str): Value for AMQP protocol option placeholder country

...
- API / data documentation: <https://remap.jrc.ec.europa.eu/>
...
|---|---|---|
| `ghcr.io/clemensv/real-time-sources-eurdep-radiation` | Kafka | JSON CloudEvents to one Kafka topic |
| `ghcr.io/clemensv/real-time-sources-eurdep-radiation-mqtt` | MQTT 5.0 | Binary CloudEvents into UNS topic tree from xRegistry |
| `ghcr.io/clemensv/real-time-sources-eurdep-radiation-amqp` | AMQP 1.0 | Binary CloudEvents to one AMQP address |
...
| Default entry point | Kafka: `python -m eurdep_radiation`; MQTT: `python -m eurdep_radiation_mqtt feed`; AMQP: `python -m eurdep_radiation_amqp feed` |
...
docker pull ghcr.io/clemensv/real-time-sources-eurdep-radiation-mqtt:latest
docker pull ghcr.io/clemensv/real-time-sources-eurdep-radiation-amqp:latest
```
...
docker run --rm \
  ...
  -e AMQP_ADDRESS="eurdep-radiation" \
...
| `EURDEP_RADIATION_SAMPLE_MODE` | Optional sampling/test mode flag for development runs. |
...
Use `tools/deploy-fabric/deploy-feeder-notebook.ps1 -Source eurdep-radiation -Workspace <id> -ResourceGroup <azure-rg> -Location <azure-region>` to deploy the notebook in `notebook/`, bind Event Stream/Lakehouse/KQL assets, and schedule poll runs.
...
Use `tools/deploy-fabric/deploy-fabric-aci.ps1 -Source eurdep-radiation -Workspace <id> -ResourceGroup <azure-rg> -Location <azure-region>` for always-on container hosting that publishes to Fabric Event Streams.
...
[![Deploy to Azure](https://aka.ms/deploytoazurebutton)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fclemensv%2Freal-time-sources%2Fmain%2Ffeeders%2Feurdep-radiation%2Fazure-template.json)

### Kafka — provision a new Event Hub

Deploys Kafka plus a new Event Hubs namespace and hub.

[![Deploy to Azure](https://aka.ms/deploytoazurebutton)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fclemensv%2Freal-time-sources%2Fmain%2Ffeeders%2Feurdep-radiation%2Fazure-template-with-eventhub.json)

### MQTT — bring your own broker

Deploys the MQTT image against an existing MQTT 5 broker.

[![Deploy to Azure](https://aka.ms/deploytoazurebutton)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fclemensv%2Freal-time-sources%2Fmain%2Ffeeders%2Feurdep-radiation%2Fazure-template-mqtt.json)

### MQTT — provision Event Grid MQTT broker

Deploys MQTT plus a new Event Grid namespace broker and identity wiring.

[![Deploy to Azure](https://aka.ms/deploytoazurebutton)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fclemensv%2Freal-time-sources%2Fmain%2Ffeeders%2Feurdep-radiation%2Fazure-template-with-eventgrid-mqtt.json)

### AMQP — provision Azure Service Bus

Deploys AMQP plus a new Service Bus namespace/queue and sender identity wiring.

[![Deploy to Azure](https://aka.ms/deploytoazurebutton)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fclemensv%2Freal-time-sources%2Fmain%2Ffeeders%2Feurdep-radiation%2Fazure-template-with-servicebus.json)

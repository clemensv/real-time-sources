# Bluesky_mqtt_producer MQTT Client

This library provides MQTT producer and consumer functionality for the bluesky_mqtt_producer message definitions.

# Bluesky_mqtt_producer Event Dispatcher for Azure Event Hubs
...
```    - BlueskyFirehoseMqttEventDispatcher
...
from bluesky_mqtt_producer_mqtt_client import *This module defines an event processing framework for Azure Event Hubs,
...
client = BlueskyFirehoseMqttMqttClient(mqtt_client, content_mode='structured')

# Connect to broker

await client.connect("mqtt.example.com", 1883)### BlueskyFirehoseMqttEventDispatcher



# Publish message`BlueskyFirehoseMqttEventDispatcher` handles events for the BlueskyFirehose.mqtt message group.
...
from bluesky_mqtt_producer_mqtt_client import *create_processor(self, consumer_group_name: str,
...
client = BlueskyFirehoseMqttMqttClient(mqtt_client, content_mode='structured')- `eventhub_name`: The name of the Event
...
## BuildThe BlueskyFirehoseMqttEventDispatcher defines the following event handler hooks.
...
```##### `bluesky_feed_post_mqtt_async`



## Test```python

bluesky_feed_post_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent, Post], Awaitable[None]]
...
- `data`: The event data of type `bluesky_mqtt_producer_data.Post`.

Example:

```python
async def bluesky_feed_post_mqtt_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent,
data: Post) -> None:
...
```##### `bluesky_feed_like_mqtt_async`



## Test```python

bluesky_feed_like_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent, Like], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `bluesky_mqtt_producer_data.Like`.

Example:

```python
async def bluesky_feed_like_mqtt_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent,
data: Like) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `bluesky_feed_repost_mqtt_async`



## Test```python

bluesky_feed_repost_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent, Repost], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `bluesky_mqtt_producer_data.Repost`.

Example:

```python
async def bluesky_feed_repost_mqtt_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent,
data: Repost) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `bluesky_graph_follow_mqtt_async`



## Test```python

bluesky_graph_follow_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent, Follow], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `bluesky_mqtt_producer_data.Follow`.

Example:

```python
async def bluesky_graph_follow_mqtt_event(partition_context: PartitionContext, event: EventData, cloud_event:
CloudEvent, data: Follow) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `bluesky_graph_block_mqtt_async`



## Test```python

bluesky_graph_block_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent, Block], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `bluesky_mqtt_producer_data.Block`.

Example:

```python
async def bluesky_graph_block_mqtt_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent,
data: Block) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `bluesky_actor_profile_mqtt_async`



## Test```python

bluesky_actor_profile_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent, Profile], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `bluesky_mqtt_producer_data.Profile`.

Example:

```python
async def bluesky_actor_profile_mqtt_event(partition_context: PartitionContext, event: EventData, cloud_event:
CloudEvent, data: Profile) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```

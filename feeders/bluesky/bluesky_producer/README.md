...
- **Scales horizontally** across multiple brokers and partitions### BlueskyFirehoseEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`BlueskyFirehoseEventDispatcher` handles events for the BlueskyFirehose message group.
...
The BlueskyFirehoseEventDispatcher defines the following event handler hooks.
...
producer = BlueskyFirehoseProducer(
    ...
    security_protocol='SASL_SSL',##### `bluesky_feed_post_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'bluesky_feed_post_async:  Callable[[ConsumerRecord, CloudEvent, Post], Awaitable[None]]

)```

```

Asynchronous handler hook for `Bluesky.Feed.Post`:
...
bluesky_firehose_dispatcher.bluesky_feed_post_async = bluesky_feed_post_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `bluesky_feed_like_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'bluesky_feed_like_async:  Callable[[ConsumerRecord, CloudEvent, Like], Awaitable[None]]

)```

```

Asynchronous handler hook for `Bluesky.Feed.Like`:
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `bluesky_feed_repost_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'bluesky_feed_repost_async:  Callable[[ConsumerRecord, CloudEvent, Repost],
Awaitable[None]]
...
Asynchronous handler hook for `Bluesky.Feed.Repost`:
...
bluesky_firehose_dispatcher.bluesky_feed_repost_async = bluesky_feed_repost_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `bluesky_graph_follow_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'bluesky_graph_follow_async:  Callable[[ConsumerRecord, CloudEvent, Follow],
Awaitable[None]]
...
Asynchronous handler hook for `Bluesky.Graph.Follow`:
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `bluesky_graph_block_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'bluesky_graph_block_async:  Callable[[ConsumerRecord, CloudEvent, Block],
Awaitable[None]]
...
Asynchronous handler hook for `Bluesky.Graph.Block`:
...
bluesky_firehose_dispatcher.bluesky_graph_block_async = bluesky_graph_block_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `bluesky_actor_profile_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'bluesky_actor_profile_async:  Callable[[ConsumerRecord, CloudEvent, Profile],
Awaitable[None]]
...
Asynchronous handler hook for `Bluesky.Actor.Profile`:
...
##### `send_bluesky_feed_post`Dispatchers have the following protected methods:



```python### Methods:

async def send_bluesky_feed_post(
...
Send a single `Bluesky.Feed.Post` message.Args:
...
await producer.send_bluesky_feed_post(
...
Send multiple `Bluesky.Feed.Post` messages in a batch.
...
await producer.send_bluesky_feed_post_batch(```
...
##### `send_bluesky_feed_like`Dispatchers have the following protected methods:



```python### Methods:

async def send_bluesky_feed_like(
...
Send a single `Bluesky.Feed.Like` message.Args:
...
await producer.send_bluesky_feed_like(
...
Send multiple `Bluesky.Feed.Like` messages in a batch.
...
await producer.send_bluesky_feed_like_batch(```
...
##### `send_bluesky_feed_repost`Dispatchers have the following protected methods:



```python### Methods:

async def send_bluesky_feed_repost(
...
Send a single `Bluesky.Feed.Repost` message.Args:
...
await producer.send_bluesky_feed_repost(
...
Send multiple `Bluesky.Feed.Repost` messages in a batch.
...
await producer.send_bluesky_feed_repost_batch(```
...
##### `send_bluesky_graph_follow`Dispatchers have the following protected methods:



```python### Methods:

async def send_bluesky_graph_follow(
...
Send a single `Bluesky.Graph.Follow` message.Args:
...
await producer.send_bluesky_graph_follow(
...
Send multiple `Bluesky.Graph.Follow` messages in a batch.
...
await producer.send_bluesky_graph_follow_batch(```
...
##### `send_bluesky_graph_block`Dispatchers have the following protected methods:



```python### Methods:

async def send_bluesky_graph_block(
...
Send a single `Bluesky.Graph.Block` message.Args:
...
await producer.send_bluesky_graph_block(
...
Send multiple `Bluesky.Graph.Block` messages in a batch.
...
await producer.send_bluesky_graph_block_batch(```
...
##### `send_bluesky_actor_profile`Dispatchers have the following protected methods:



```python### Methods:

async def send_bluesky_actor_profile(
...
Send a single `Bluesky.Actor.Profile` message.Args:
...
await producer.send_bluesky_actor_profile(
...
Send multiple `Bluesky.Actor.Profile` messages in a batch.

...
class BlueskyFirehoseAmqpProducer:
    """
    Producer class to send messages in the `BlueskyFirehose.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_post(self,
        ...
        """
        Send the `BlueskyFirehose.amqp.Post` message
        ...
        Args:
            ...
            data (Post): The message data object
        ...
        attributes = {
            ...
            "Bluesky.Feed.Post",
            "source":
            "{firehoseurl}".format(firehoseurl=_firehoseurl),
            "subject":
            "{did}".format(did=_did),
        }
        ...
        amqp_msg.subject = "{did}".format(did=_did)
    ...
    def send_post_batch(self,
        data_array: typing.List[Post],
        _firehoseurl: str,
        _did: str,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `BlueskyFirehose.amqp.Post` messages
        
        Args:
            data_array (typing.List[Post]): Array of message data objects
            _firehoseurl (str): Value for placeholder firehoseurl in attribute source
            _did (str): Value for placeholder did in attribute subject
    ...
    def send_like(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `BlueskyFirehose.amqp.Like` message
        
        Args:
            _firehoseurl (str): Value for placeholder firehoseurl in attribute source
            _did (str): Value for placeholder did in attribute subject
            data (Like): The message data object
            content_type (str): The content type of the message data (default: 'application/json')
        """
        # Build CloudEvent attributes
        attributes = {
    ...
    def send_like_batch(self,
        data_array: typing.List[Like],
        _firehoseurl: str,
        _did: str,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `BlueskyFirehose.amqp.Like` messages
        
        Args:
            data_array (typing.List[Like]): Array of message data objects
            _firehoseurl (str): Value for placeholder firehoseurl in attribute source
            _did (str): Value for placeholder did in attribute subject
            content_type (str): The content type of the message data
        """
    ...
    def send_repost(self,
        data: Repost,
        _firehoseurl: str,
        _did: str,
        content_type: str = 'application/json') -> None:
        """
        Send the `BlueskyFirehose.amqp.Repost` message
        
        Args:
            _firehoseurl (str): Value for placeholder firehoseurl in attribute source
            _did (str): Value for placeholder did in attribute subject
            data (Repost): The message data object
            content_type (str): The content type of the message data (default: 'application/json')
        """
        # Build CloudEvent attributes
        attributes = {
    ...
    def send_repost_batch(self,
        data_array: typing.List[Repost],
        _firehoseurl: str,
        _did: str,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `BlueskyFirehose.amqp.Repost` messages
        
        Args:
            data_array (typing.List[Repost]): Array of message data objects
            _firehoseurl (str): Value for placeholder firehoseurl in attribute source
            _did (str): Value for placeholder did in attribute subject
            content_type (str): The content type of the message data
        """
    ...
    def send_follow(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `BlueskyFirehose.amqp.Follow` message
        
        Args:
            _firehoseurl (str): Value for placeholder firehoseurl in attribute source
            _did (str): Value for placeholder did in attribute subject
            data (Follow): The message data object
            content_type (str): The content type of the message data (default: 'application/json')
        """
        # Build CloudEvent attributes
        attributes = {
    ...
    def send_follow_batch(self,
        data_array: typing.List[Follow],
        _firehoseurl: str,
        _did: str,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `BlueskyFirehose.amqp.Follow` messages
        
        Args:
            data_array (typing.List[Follow]): Array of message data objects
            _firehoseurl (str): Value for placeholder firehoseurl in attribute source
            _did (str): Value for placeholder did in attribute subject
            content_type (str): The content type of the message data
        """
    ...
    def send_block(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `BlueskyFirehose.amqp.Block` message
        
        Args:
            _firehoseurl (str): Value for placeholder firehoseurl in attribute source
            _did (str): Value for placeholder did in attribute subject
            data (Block): The message data object
            content_type (str): The content type of the message data (default: 'application/json')
        """
        # Build CloudEvent attributes
        attributes = {
    ...
    def send_block_batch(self,
        data_array: typing.List[Block],
        _firehoseurl: str,
        _did: str,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `BlueskyFirehose.amqp.Block` messages
        
        Args:
            data_array (typing.List[Block]): Array of message data objects
            _firehoseurl (str): Value for placeholder firehoseurl in attribute source
            _did (str): Value for placeholder did in attribute subject
            content_type (str): The content type of the message data
        """
    ...
    def send_profile(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `BlueskyFirehose.amqp.Profile` message
        
        Args:
            _firehoseurl (str): Value for placeholder firehoseurl in attribute source
            _did (str): Value for placeholder did in attribute subject
            data (Profile): The message data object
            content_type (str): The content type of the message data (default: 'application/json')
        """
        # Build CloudEvent attributes
        attributes = {
    ...
    def send_profile_batch(self,
        data_array: typing.List[Profile],
        _firehoseurl: str,
        _did: str,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `BlueskyFirehose.amqp.Profile` messages
        
        Args:
            data_array (typing.List[Profile]): Array of message data objects
            _firehoseurl (str): Value for placeholder firehoseurl in attribute source
            _did (str): Value for placeholder did in attribute subject
            content_type (str): The content type of the message data
        """

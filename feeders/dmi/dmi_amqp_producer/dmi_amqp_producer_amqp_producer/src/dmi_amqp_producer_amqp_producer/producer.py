...
class DkDmiMetObsAmqpProducer:
    """
    Producer class to send messages in the `dk.dmi.metObs.amqp` message group via AMQP 1.0 protocol.
    """
...
class DkDmiOceanObsAmqpProducer:
    """
    Producer class to send messages in the `dk.dmi.oceanObs.amqp` message group via AMQP 1.0 protocol.
    """
...
class DkDmiLightningAmqpProducer:
    """
    Producer class to send messages in the `dk.dmi.lightning.amqp` message group via AMQP 1.0 protocol.
    """

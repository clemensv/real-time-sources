...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../dmi_amqp_producer_data/tests')))
...
class TestDkDmiMetObsAmqpProducer:
    """Test cases for DkDmiMetObsAmqpProducer"""
...
class TestDkDmiOceanObsAmqpProducer:
    """Test cases for DkDmiOceanObsAmqpProducer"""
...
class TestDkDmiLightningAmqpProducer:
    """Test cases for DkDmiLightningAmqpProducer"""

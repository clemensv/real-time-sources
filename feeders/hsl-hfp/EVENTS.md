...
`Vp` payloads are JSON object. Required fields: `oper`, `veh`, `tst`, `tsi`, `operator_id`, `vehicle_number`, `temporal_type`, `transport_mode`.
...
- **`temporal_type`** (enum, required): Journey temporal type from the MQTT-topic level: `ongoing` (journey in progress) or `upcoming` (journey about to start). The bridge subscribes to both; the `deadrun`/`signoff` trees are not consumed.
- **`transport_mode`** (enum, required): Vehicle transport mode from the MQTT-topic level (`bus`, `tram`, `train`, `ferry`, `metro`, `ubus`, `robot`).
...
- **`dl`** (null or int32, optional): Offset from the scheduled timetable in seconds (s). Negative values indicate the vehicle is lagging behind schedule, positive values indicate running ahead. Sourced from the HFP payload `dl` field. Not populated on `da`,`dout`,`ba`,`bout`.
...
- **`spd`** (null or double, optional): Instantaneous ground speed of the vehicle in metres per second (m/s). Sourced from the HFP payload `spd` field.
...
- **`acc`** (null or double, optional): Acceleration in metres per second squared (m/s^2), derived from the speed delta between this and the previous message. Negative values indicate the vehicle is decelerating. Sourced from the HFP payload `acc` field.
- **`odo`** (null or int32, optional): Odometer reading in metres (m) since the start of the trip. The upstream notes the value is currently not very reliable. Sourced from the HFP payload `odo` field.
...
`Due` payloads are JSON object. Required fields: `oper`, `veh`, `tst`, `tsi`, `operator_id`, `vehicle_number`, `temporal_type`, `transport_mode`.
...
`Arr` payloads are JSON object. Required fields: `oper`, `veh`, `tst`, `tsi`, `operator_id`, `vehicle_number`, `temporal_type`, `transport_mode`.
...
`Dep` payloads are JSON object. Required fields: `oper`, `veh`, `tst`, `tsi`, `operator_id`, `vehicle_number`, `temporal_type`, `transport_mode`.
...
`Ars` payloads are JSON object. Required fields: `oper`, `veh`, `tst`, `tsi`, `operator_id`, `vehicle_number`, `temporal_type`, `transport_mode`.
...
`Pde` payloads are JSON object. Required fields: `oper`, `veh`, `tst`, `tsi`, `operator_id`, `vehicle_number`, `temporal_type`, `transport_mode`.
...
`Pas` payloads are JSON object. Required fields: `oper`, `veh`, `tst`, `tsi`, `operator_id`, `vehicle_number`, `temporal_type`, `transport_mode`.
...
`Wait` payloads are JSON object. Required fields: `oper`, `veh`, `tst`, `tsi`, `operator_id`, `vehicle_number`, `temporal_type`, `transport_mode`.
...
`Doo` payloads are JSON object. Required fields: `oper`, `veh`, `tst`, `tsi`, `operator_id`, `vehicle_number`, `temporal_type`, `transport_mode`.
...
`Doc` payloads are JSON object. Required fields: `oper`, `veh`, `tst`, `tsi`, `operator_id`, `vehicle_number`, `temporal_type`, `transport_mode`.
...
`Vja` payloads are JSON object. Required fields: `oper`, `veh`, `tst`, `tsi`, `operator_id`, `vehicle_number`, `temporal_type`, `transport_mode`.
...
`Vjout` payloads are JSON object. Required fields: `oper`, `veh`, `tst`, `tsi`, `operator_id`, `vehicle_number`, `temporal_type`, `transport_mode`.
...
`Tlr` payloads are JSON object. Required fields: `oper`, `veh`, `tst`, `tsi`, `operator_id`, `vehicle_number`, `temporal_type`, `transport_mode`.
...
`Tla` payloads are JSON object. Required fields: `oper`, `veh`, `tst`, `tsi`, `operator_id`, `vehicle_number`, `temporal_type`, `transport_mode`.
...
`Da` payloads are JSON object. Required fields: `oper`, `veh`, `tst`, `tsi`, `operator_id`, `vehicle_number`, `temporal_type`, `transport_mode`.
...
`Dout` payloads are JSON object. Required fields: `oper`, `veh`, `tst`, `tsi`, `operator_id`, `vehicle_number`, `temporal_type`, `transport_mode`.
...
`Ba` payloads are JSON object. Required fields: `oper`, `veh`, `tst`, `tsi`, `operator_id`, `vehicle_number`, `temporal_type`, `transport_mode`.
...
`Bout` payloads are JSON object. Required fields: `oper`, `veh`, `tst`, `tsi`, `operator_id`, `vehicle_number`, `temporal_type`, `transport_mode`.

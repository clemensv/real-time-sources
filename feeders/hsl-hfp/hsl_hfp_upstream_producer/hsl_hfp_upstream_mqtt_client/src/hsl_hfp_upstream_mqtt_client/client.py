...
def get_default_topic_mappings_fi_hsl_hfp_upstream() -> Dict[str, str]:
    """
    Get the default topic mappings for the fi.hsl.hfp.upstream message group.
    
    Returns:
        Dictionary mapping message identifiers to their default topic patterns.
    """
    return {
        "fi.hsl.hfp.upstream.vp": "/hfp/v2/journey/{temporal_type}/vp/{transport_mode}/{operator_id}/{vehicle_number}/{route_id}/{direction_id}/{headsign}/{start_time}/{next_stop}/{geohash_level}/{geohash}",
        "fi.hsl.hfp.upstream.due": "/hfp/v2/journey/{temporal_type}/due/{transport_mode}/{operator_id}/{vehicle_number}/{route_id}/{direction_id}/{headsign}/{start_time}/{next_stop}/{geohash_level}/{geohash}",
        "fi.hsl.hfp.upstream.arr": "/hfp/v2/journey/{temporal_type}/arr/{transport_mode}/{operator_id}/{vehicle_number}/{route_id}/{direction_id}/{headsign}/{start_time}/{next_stop}/{geohash_level}/{geohash}",
        "fi.hsl.hfp.upstream.dep": "/hfp/v2/journey/{temporal_type}/dep/{transport_mode}/{operator_id}/{vehicle_number}/{route_id}/{direction_id}/{headsign}/{start_time}/{next_stop}/{geohash_level}/{geohash}",
        "fi.hsl.hfp.upstream.ars": "/hfp/v2/journey/{temporal_type}/ars/{transport_mode}/{operator_id}/{vehicle_number}/{route_id}/{direction_id}/{headsign}/{start_time}/{next_stop}/{geohash_level}/{geohash}",
        "fi.hsl.hfp.upstream.pde": "/hfp/v2/journey/{temporal_type}/pde/{transport_mode}/{operator_id}/{vehicle_number}/{route_id}/{direction_id}/{headsign}/{start_time}/{next_stop}/{geohash_level}/{geohash}",
        "fi.hsl.hfp.upstream.pas": "/hfp/v2/journey/{temporal_type}/pas/{transport_mode}/{operator_id}/{vehicle_number}/{route_id}/{direction_id}/{headsign}/{start_time}/{next_stop}/{geohash_level}/{geohash}",
        "fi.hsl.hfp.upstream.wait": "/hfp/v2/journey/{temporal_type}/wait/{transport_mode}/{operator_id}/{vehicle_number}/{route_id}/{direction_id}/{headsign}/{start_time}/{next_stop}/{geohash_level}/{geohash}",
        "fi.hsl.hfp.upstream.doo": "/hfp/v2/journey/{temporal_type}/doo/{transport_mode}/{operator_id}/{vehicle_number}/{route_id}/{direction_id}/{headsign}/{start_time}/{next_stop}/{geohash_level}/{geohash}",
        "fi.hsl.hfp.upstream.doc": "/hfp/v2/journey/{temporal_type}/doc/{transport_mode}/{operator_id}/{vehicle_number}/{route_id}/{direction_id}/{headsign}/{start_time}/{next_stop}/{geohash_level}/{geohash}",
        "fi.hsl.hfp.upstream.vja": "/hfp/v2/journey/{temporal_type}/vja/{transport_mode}/{operator_id}/{vehicle_number}/{route_id}/{direction_id}/{headsign}/{start_time}/{next_stop}/{geohash_level}/{geohash}",
        "fi.hsl.hfp.upstream.vjout": "/hfp/v2/journey/{temporal_type}/vjout/{transport_mode}/{operator_id}/{vehicle_number}/{route_id}/{direction_id}/{headsign}/{start_time}/{next_stop}/{geohash_level}/{geohash}",
        "fi.hsl.hfp.upstream.tlr": "/hfp/v2/journey/{temporal_type}/tlr/{transport_mode}/{operator_id}/{vehicle_number}/{route_id}/{direction_id}/{headsign}/{start_time}/{next_stop}/{geohash_level}/{geohash}/{sid}",
        "fi.hsl.hfp.upstream.tla": "/hfp/v2/journey/{temporal_type}/tla/{transport_mode}/{operator_id}/{vehicle_number}/{route_id}/{direction_id}/{headsign}/{start_time}/{next_stop}/{geohash_level}/{geohash}/{sid}",
        "fi.hsl.hfp.upstream.da": "/hfp/v2/journey/{temporal_type}/da/{transport_mode}/{operator_id}/{vehicle_number}/{route_id}/{direction_id}/{headsign}/{start_time}/{next_stop}/{geohash_level}/{geohash}",
        "fi.hsl.hfp.upstream.dout": "/hfp/v2/journey/{temporal_type}/dout/{transport_mode}/{operator_id}/{vehicle_number}/{route_id}/{direction_id}/{headsign}/{start_time}/{next_stop}/{geohash_level}/{geohash}",
        "fi.hsl.hfp.upstream.ba": "/hfp/v2/journey/{temporal_type}/ba/{transport_mode}/{operator_id}/{vehicle_number}/{route_id}/{direction_id}/{headsign}/{start_time}/{next_stop}/{geohash_level}/{geohash}",
        "fi.hsl.hfp.upstream.bout": "/hfp/v2/journey/{temporal_type}/bout/{transport_mode}/{operator_id}/{vehicle_number}/{route_id}/{direction_id}/{headsign}/{start_time}/{next_stop}/{geohash_level}/{geohash}",
    }


def get_subscription_topics_fi_hsl_hfp_upstream(topic_mappings: Optional[Dict[str, str]] = None) -> List[str]:
    """
    ...
    """
    mappings = topic_mappings or get_default_topic_mappings_fi_hsl_hfp_upstream()
    topics = []
...
class FiHslHfpUpstreamMqttClient(_ClientBase):
    """MQTT Client for producing and consuming messages in the fi.hsl.hfp.upstream message group."""
    ...
    def __init__(
        ...
        self.loop = loop
        self._topic_mappings = topic_mappings or get_default_topic_mappings_fi_hsl_hfp_upstream()
    ...
    async def subscribe(self, topics: Optional[typing.List[str]] = None, qos: int = 0):
        ...
        """
        if topics is None:
            topics = get_subscription_topics_fi_hsl_hfp_upstream(self._topic_mappings)
        for topic in topics:

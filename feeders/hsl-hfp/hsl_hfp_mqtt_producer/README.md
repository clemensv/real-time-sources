# Hsl_hfp_mqtt_producer MQTT Client

This library provides MQTT producer and consumer functionality for the hsl_hfp_mqtt_producer message definitions.

# Hsl_hfp_mqtt_producer Event Dispatcher for Azure Event Hubs
...
```    - FiHslHfpMqttEventDispatcher,

    FiHslGtfsOperatorMqttEventDispatcher,

    FiHslGtfsRouteMqttEventDispatcher,

    FiHslGtfsStopMqttEventDispatcher
...
from hsl_hfp_mqtt_producer_mqtt_client import *This module defines an event processing framework for Azure Event Hubs,
...
client = FiHslHfpMqttMqttClient(mqtt_client, content_mode='structured')

# Connect to broker

await client.connect("mqtt.example.com", 1883)### FiHslHfpMqttEventDispatcher



# Publish message`FiHslHfpMqttEventDispatcher` handles events for the fi.hsl.hfp.mqtt message group.
...
from hsl_hfp_mqtt_producer_mqtt_client import *create_processor(self, consumer_group_name: str,
...
client = FiHslHfpMqttMqttClient(mqtt_client, content_mode='structured')- `eventhub_name`: The name of the Event
...
client = FiHslGtfsOperatorMqttMqttClient(mqtt_client, content_mode='structured')- `eventhub_name`: The name of the Event
Hub.Args:- `consumer_group_name`: The name of the consumer group.- `eventhubs_fully_qualified_namespace`: The fully
qualified namespace of the Event Hub.

client = FiHslGtfsRouteMqttMqttClient(mqtt_client, content_mode='structured')- `eventhub_name`: The name of the Event
Hub.Args:- `consumer_group_name`: The name of the consumer group.- `eventhubs_fully_qualified_namespace`: The fully
qualified namespace of the Event Hub.

client = FiHslGtfsStopMqttMqttClient(mqtt_client, content_mode='structured')- `eventhub_name`: The name of the Event
...
## BuildThe FiHslHfpMqttEventDispatcher defines the following event handler hooks.
...
```##### `fi_hsl_hfp_mqtt_vp_async`



## Test```python

fi_hsl_hfp_mqtt_vp_async:  Callable[[PartitionContext, EventData, CloudEvent, VehicleEvent], Awaitable[None]]
...
- `data`: The event data of type `hsl_hfp_mqtt_producer_data.VehicleEvent`.

Example:

```python
async def fi_hsl_hfp_mqtt_vp_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent, data:
VehicleEvent) -> None:
...
```##### `fi_hsl_hfp_mqtt_due_async`



## Test```python

fi_hsl_hfp_mqtt_due_async:  Callable[[PartitionContext, EventData, CloudEvent, VehicleEvent], Awaitable[None]]
...
```python
async def fi_hsl_hfp_mqtt_due_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent,
...
```##### `fi_hsl_hfp_mqtt_arr_async`



## Test```python

fi_hsl_hfp_mqtt_arr_async:  Callable[[PartitionContext, EventData, CloudEvent, VehicleEvent], Awaitable[None]]
...
```python
async def fi_hsl_hfp_mqtt_arr_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent,
data: VehicleEvent) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `fi_hsl_hfp_mqtt_dep_async`



## Test```python

fi_hsl_hfp_mqtt_dep_async:  Callable[[PartitionContext, EventData, CloudEvent, VehicleEvent], Awaitable[None]]
...
```python
async def fi_hsl_hfp_mqtt_dep_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent,
data: VehicleEvent) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `fi_hsl_hfp_mqtt_ars_async`



## Test```python

fi_hsl_hfp_mqtt_ars_async:  Callable[[PartitionContext, EventData, CloudEvent, VehicleEvent], Awaitable[None]]
...
```python
async def fi_hsl_hfp_mqtt_ars_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent,
data: VehicleEvent) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `fi_hsl_hfp_mqtt_pde_async`



## Test```python

fi_hsl_hfp_mqtt_pde_async:  Callable[[PartitionContext, EventData, CloudEvent, VehicleEvent], Awaitable[None]]
...
```python
async def fi_hsl_hfp_mqtt_pde_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent,
data: VehicleEvent) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `fi_hsl_hfp_mqtt_pas_async`



## Test```python

fi_hsl_hfp_mqtt_pas_async:  Callable[[PartitionContext, EventData, CloudEvent, VehicleEvent], Awaitable[None]]
...
```python
async def fi_hsl_hfp_mqtt_pas_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent,
data: VehicleEvent) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `fi_hsl_hfp_mqtt_wait_async`



## Test```python

fi_hsl_hfp_mqtt_wait_async:  Callable[[PartitionContext, EventData, CloudEvent, VehicleEvent], Awaitable[None]]
...
```python
async def fi_hsl_hfp_mqtt_wait_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent,
data: VehicleEvent) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `fi_hsl_hfp_mqtt_doo_async`



## Test```python

fi_hsl_hfp_mqtt_doo_async:  Callable[[PartitionContext, EventData, CloudEvent, VehicleEvent], Awaitable[None]]
...
```python
async def fi_hsl_hfp_mqtt_doo_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent,
data: VehicleEvent) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `fi_hsl_hfp_mqtt_doc_async`



## Test```python

fi_hsl_hfp_mqtt_doc_async:  Callable[[PartitionContext, EventData, CloudEvent, VehicleEvent], Awaitable[None]]
...
```python
async def fi_hsl_hfp_mqtt_doc_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent,
data: VehicleEvent) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `fi_hsl_hfp_mqtt_vja_async`



## Test```python

fi_hsl_hfp_mqtt_vja_async:  Callable[[PartitionContext, EventData, CloudEvent, VehicleEvent], Awaitable[None]]
...
```python
async def fi_hsl_hfp_mqtt_vja_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent,
data: VehicleEvent) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `fi_hsl_hfp_mqtt_vjout_async`



## Test```python

fi_hsl_hfp_mqtt_vjout_async:  Callable[[PartitionContext, EventData, CloudEvent, VehicleEvent], Awaitable[None]]
...
```python
async def fi_hsl_hfp_mqtt_vjout_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent,
data: VehicleEvent) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `fi_hsl_hfp_mqtt_tlr_async`



## Test```python

fi_hsl_hfp_mqtt_tlr_async:  Callable[[PartitionContext, EventData, CloudEvent, TrafficLightEvent], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `hsl_hfp_mqtt_producer_data.TrafficLightEvent`.

Example:

```python
async def fi_hsl_hfp_mqtt_tlr_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent,
...
```##### `fi_hsl_hfp_mqtt_tla_async`



## Test```python

fi_hsl_hfp_mqtt_tla_async:  Callable[[PartitionContext, EventData, CloudEvent, TrafficLightEvent], Awaitable[None]]
...
```python
async def fi_hsl_hfp_mqtt_tla_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent,
data: TrafficLightEvent) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `fi_hsl_hfp_mqtt_da_async`



## Test```python

fi_hsl_hfp_mqtt_da_async:  Callable[[PartitionContext, EventData, CloudEvent, DriverBlockEvent], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `hsl_hfp_mqtt_producer_data.DriverBlockEvent`.

Example:

```python
async def fi_hsl_hfp_mqtt_da_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent, data:
DriverBlockEvent) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `fi_hsl_hfp_mqtt_dout_async`



## Test```python

fi_hsl_hfp_mqtt_dout_async:  Callable[[PartitionContext, EventData, CloudEvent, DriverBlockEvent], Awaitable[None]]
...
```python
async def fi_hsl_hfp_mqtt_dout_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent,
...
```##### `fi_hsl_hfp_mqtt_ba_async`



## Test```python

fi_hsl_hfp_mqtt_ba_async:  Callable[[PartitionContext, EventData, CloudEvent, DriverBlockEvent], Awaitable[None]]
...
```python
async def fi_hsl_hfp_mqtt_ba_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent, data:
DriverBlockEvent) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `fi_hsl_hfp_mqtt_bout_async`



## Test```python

fi_hsl_hfp_mqtt_bout_async:  Callable[[PartitionContext, EventData, CloudEvent, DriverBlockEvent], Awaitable[None]]

```bash```

make test

```Asynchronous handler hook for `fi.hsl.hfp.mqtt.bout`: A driver signs out from the selected block (usually at a
depot).
...
```python
async def fi_hsl_hfp_mqtt_bout_event(partition_context: PartitionContext, event: EventData, cloud_event: CloudEvent,
data: DriverBlockEvent) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
client = FiHslGtfsOperatorMqttMqttClient(mqtt_client, content_mode='structured')

# Connect to broker

await client.connect("mqtt.example.com", 1883)### FiHslGtfsOperatorMqttEventDispatcher



# Publish message`FiHslGtfsOperatorMqttEventDispatcher` handles events for the fi.hsl.gtfs.operator.mqtt message group.
...
## BuildThe FiHslGtfsOperatorMqttEventDispatcher defines the following event handler hooks.
...
```##### `fi_hsl_gtfs_operator_mqtt_operator_async`



## Test```python

fi_hsl_gtfs_operator_mqtt_operator_async:  Callable[[PartitionContext, EventData, CloudEvent, Operator],
Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `hsl_hfp_mqtt_producer_data.Operator`.

Example:

```python
async def fi_hsl_gtfs_operator_mqtt_operator_event(partition_context: PartitionContext, event: EventData, cloud_event:
...
client = FiHslGtfsRouteMqttMqttClient(mqtt_client, content_mode='structured')

# Connect to broker

await client.connect("mqtt.example.com", 1883)### FiHslGtfsRouteMqttEventDispatcher



# Publish message`FiHslGtfsRouteMqttEventDispatcher` handles events for the fi.hsl.gtfs.route.mqtt message group.
...
## BuildThe FiHslGtfsRouteMqttEventDispatcher defines the following event handler hooks.
...
```##### `fi_hsl_gtfs_route_mqtt_route_async`



## Test```python

fi_hsl_gtfs_route_mqtt_route_async:  Callable[[PartitionContext, EventData, CloudEvent, Route], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `hsl_hfp_mqtt_producer_data.Route`.

Example:

```python
async def fi_hsl_gtfs_route_mqtt_route_event(partition_context: PartitionContext, event: EventData, cloud_event:
CloudEvent, data: Route) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
client = FiHslGtfsStopMqttMqttClient(mqtt_client, content_mode='structured')

# Connect to broker

await client.connect("mqtt.example.com", 1883)### FiHslGtfsStopMqttEventDispatcher



# Publish message`FiHslGtfsStopMqttEventDispatcher` handles events for the fi.hsl.gtfs.stop.mqtt message group.
...
## BuildThe FiHslGtfsStopMqttEventDispatcher defines the following event handler hooks.
...
```##### `fi_hsl_gtfs_stop_mqtt_stop_async`



## Test```python

fi_hsl_gtfs_stop_mqtt_stop_async:  Callable[[PartitionContext, EventData, CloudEvent, Stop], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `hsl_hfp_mqtt_producer_data.Stop`.

Example:

```python
async def fi_hsl_gtfs_stop_mqtt_stop_event(partition_context: PartitionContext, event: EventData, cloud_event:
CloudEvent, data: Stop) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```

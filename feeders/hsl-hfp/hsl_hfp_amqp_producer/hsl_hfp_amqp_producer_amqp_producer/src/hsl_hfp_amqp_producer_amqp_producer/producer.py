...
class FiHslHfpAmqpProducer:
    """
    Producer class to send messages in the `fi.hsl.hfp.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_vp(self,
        ...
        """
        Send the `fi.hsl.hfp.amqp.vp` message
        ...
        Args:
            ...
            _transport_mode (str): Value for AMQP protocol option placeholder transport_mode
            _route_id (str): Value for AMQP protocol option placeholder route_id
        ...
        attributes = {
            ...
            "subject":
            "{operator_id}/{vehicle_number}".format(operator_id=_operator_id, vehicle_number=_vehicle_number),
        }
        ...
        amqp_msg.subject = "{operator_id}/{vehicle_number}".format(operator_id=_operator_id, vehicle_number=_vehicle_number)

        app_properties = {}
        app_properties["event_type"] = "vp"
        app_properties["transport_mode"] = "{transport_mode}".format(transport_mode=_transport_mode)
        app_properties["route_id"] = "{route_id}".format(route_id=_route_id)
        app_properties["operator_id"] = "{operator_id}".format(operator_id=_operator_id)
        app_properties["vehicle_number"] = "{vehicle_number}".format(vehicle_number=_vehicle_number)
        if app_properties:
    ...
    def send_vp_batch(self,
        data_array: typing.List[VehicleEvent],
        _feedurl: str,
        _operator_id: str,
        _vehicle_number: str,
        _transport_mode: str,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.hfp.amqp.vp` messages
        
        Args:
            data_array (typing.List[VehicleEvent]): Array of message data objects
            _feedurl (str): Value for placeholder feedurl in attribute source
            _operator_id (str): Value for placeholder operator_id in attribute subject
            _vehicle_number (str): Value for placeholder vehicle_number in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
        ...
        for data in data_array:
            self.send_vp(
                data=data,
                _feedurl=_feedurl,
                _operator_id=_operator_id,
                _vehicle_number=_vehicle_number,
                _time=_time,
                _transport_mode=_transport_mode,
                _route_id=_route_id,
    ...
    def send_due(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.hsl.hfp.amqp.due` message
    ...
    def send_due_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.hfp.amqp.due` messages
    ...
    def send_arr(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.hsl.hfp.amqp.arr` message
    ...
    def send_arr_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.hfp.amqp.arr` messages
    ...
    def send_dep(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.hsl.hfp.amqp.dep` message
    ...
    def send_dep_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.hfp.amqp.dep` messages
    ...
    def send_ars(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.hsl.hfp.amqp.ars` message
    ...
    def send_ars_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.hfp.amqp.ars` messages
    ...
    def send_pde(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.hsl.hfp.amqp.pde` message
    ...
    def send_pde_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.hfp.amqp.pde` messages
    ...
    def send_pas(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.hsl.hfp.amqp.pas` message
    ...
    def send_pas_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.hfp.amqp.pas` messages
    ...
    def send_wait(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.hsl.hfp.amqp.wait` message
        ...
        app_properties = {}
        app_properties["event_type"] = "wait"
        app_properties["transport_mode"] = "{transport_mode}".format(transport_mode=_transport_mode)
        app_properties["route_id"] = "{route_id}".format(route_id=_route_id)
        app_properties["operator_id"] = "{operator_id}".format(operator_id=_operator_id)
        app_properties["vehicle_number"] = "{vehicle_number}".format(vehicle_number=_vehicle_number)
    ...
    def send_wait_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.hfp.amqp.wait` messages
    ...
    def send_doo(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.hsl.hfp.amqp.doo` message
    ...
    def send_doo_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.hfp.amqp.doo` messages
    ...
    def send_doc(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.hsl.hfp.amqp.doc` message
    ...
    def send_doc_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.hfp.amqp.doc` messages
    ...
    def send_vja(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.hsl.hfp.amqp.vja` message
    ...
    def send_vja_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.hfp.amqp.vja` messages
    ...
    def send_vjout(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.hsl.hfp.amqp.vjout` message
        ...
        app_properties = {}
        app_properties["event_type"] = "vjout"
        app_properties["transport_mode"] = "{transport_mode}".format(transport_mode=_transport_mode)
        app_properties["route_id"] = "{route_id}".format(route_id=_route_id)
        app_properties["operator_id"] = "{operator_id}".format(operator_id=_operator_id)
        app_properties["vehicle_number"] = "{vehicle_number}".format(vehicle_number=_vehicle_number)
    ...
    def send_vjout_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.hfp.amqp.vjout` messages
    ...
    def send_tlr(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.hsl.hfp.amqp.tlr` message
    ...
    def send_tlr_batch(self,
        data_array: typing.List[TrafficLightEvent],
        _feedurl: str,
        _operator_id: str,
        _vehicle_number: str,
        _transport_mode: str,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.hfp.amqp.tlr` messages
        
        Args:
            data_array (typing.List[TrafficLightEvent]): Array of message data objects
            _feedurl (str): Value for placeholder feedurl in attribute source
            _operator_id (str): Value for placeholder operator_id in attribute subject
            _vehicle_number (str): Value for placeholder vehicle_number in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
    ...
    def send_tla(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.hsl.hfp.amqp.tla` message
    ...
    def send_tla_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.hfp.amqp.tla` messages
    ...
    def send_da(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.hsl.hfp.amqp.da` message
    ...
    def send_da_batch(self,
        data_array: typing.List[DriverBlockEvent],
        _feedurl: str,
        _operator_id: str,
        _vehicle_number: str,
        _transport_mode: str,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.hfp.amqp.da` messages
        
        Args:
            data_array (typing.List[DriverBlockEvent]): Array of message data objects
            _feedurl (str): Value for placeholder feedurl in attribute source
            _operator_id (str): Value for placeholder operator_id in attribute subject
            _vehicle_number (str): Value for placeholder vehicle_number in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
    ...
    def send_dout(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.hsl.hfp.amqp.dout` message
        ...
        app_properties = {}
        app_properties["event_type"] = "dout"
        app_properties["transport_mode"] = "{transport_mode}".format(transport_mode=_transport_mode)
        app_properties["route_id"] = "{route_id}".format(route_id=_route_id)
        app_properties["operator_id"] = "{operator_id}".format(operator_id=_operator_id)
        app_properties["vehicle_number"] = "{vehicle_number}".format(vehicle_number=_vehicle_number)
    ...
    def send_dout_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.hfp.amqp.dout` messages
    ...
    def send_ba(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.hsl.hfp.amqp.ba` message
    ...
    def send_ba_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.hfp.amqp.ba` messages
    ...
    def send_bout(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.hsl.hfp.amqp.bout` message
        ...
        app_properties = {}
        app_properties["event_type"] = "bout"
        app_properties["transport_mode"] = "{transport_mode}".format(transport_mode=_transport_mode)
        app_properties["route_id"] = "{route_id}".format(route_id=_route_id)
        app_properties["operator_id"] = "{operator_id}".format(operator_id=_operator_id)
        app_properties["vehicle_number"] = "{vehicle_number}".format(vehicle_number=_vehicle_number)
    ...
    def send_bout_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.hfp.amqp.bout` messages
...
class FiHslGtfsOperatorAmqpProducer:
    """
    Producer class to send messages in the `fi.hsl.gtfs.operator.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_operator(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.hsl.gtfs.operator.amqp.Operator` message
        ...
        attributes = {
            ...
            "{feedurl}".format(feedurl=_feedurl),
            "subject":
            "operator/{operator_id}".format(operator_id=_operator_id),
        }
        attributes["time"] = _resolve_cloudevents_time(_time, attributes.get("time"))
        ...
        if amqp_creation_time is not None:
            amqp_msg.creation_time = amqp_creation_time
        # Apply AMQP message properties declared in protocoloptions.properties.
        amqp_msg.subject = "operator/{operator_id}".format(operator_id=_operator_id)
    ...
    def send_operator_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.gtfs.operator.amqp.Operator` messages
...
class FiHslGtfsRouteAmqpProducer:
    """
    Producer class to send messages in the `fi.hsl.gtfs.route.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_route(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.hsl.gtfs.route.amqp.Route` message
        ...
        attributes = {
            ...
            "{feedurl}".format(feedurl=_feedurl),
            "subject":
            "route/{route_id}".format(route_id=_route_id),
        }
        attributes["time"] = _resolve_cloudevents_time(_time, attributes.get("time"))
        ...
        if amqp_creation_time is not None:
            amqp_msg.creation_time = amqp_creation_time
        # Apply AMQP message properties declared in protocoloptions.properties.
        amqp_msg.subject = "route/{route_id}".format(route_id=_route_id)
    ...
    def send_route_batch(self,
        data_array: typing.List[Route],
        _feedurl: str,
        _route_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.gtfs.route.amqp.Route` messages
        
        Args:
            data_array (typing.List[Route]): Array of message data objects
            _feedurl (str): Value for placeholder feedurl in attribute source
            _route_id (str): Value for placeholder route_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            content_type (str): The content type of the message data
...
class FiHslGtfsStopAmqpProducer:
    """
    Producer class to send messages in the `fi.hsl.gtfs.stop.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_stop(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.hsl.gtfs.stop.amqp.Stop` message
        ...
        attributes = {
            ...
            "{feedurl}".format(feedurl=_feedurl),
            "subject":
            "stop/{stop_id}".format(stop_id=_stop_id),
        }
        attributes["time"] = _resolve_cloudevents_time(_time, attributes.get("time"))
        ...
        if amqp_creation_time is not None:
            amqp_msg.creation_time = amqp_creation_time
        # Apply AMQP message properties declared in protocoloptions.properties.
        amqp_msg.subject = "stop/{stop_id}".format(stop_id=_stop_id)
    ...
    def send_stop_batch(self,
        data_array: typing.List[Stop],
        _feedurl: str,
        _stop_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.hsl.gtfs.stop.amqp.Stop` messages
        
        Args:
            data_array (typing.List[Stop]): Array of message data objects
            _feedurl (str): Value for placeholder feedurl in attribute source
            _stop_id (str): Value for placeholder stop_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            content_type (str): The content type of the message data

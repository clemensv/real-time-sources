...
class Test_SupplementalOrbitMeanElements(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = SupplementalOrbitMeanElements(
            OBJECT_NAME='ngrdwibrldbledviijfv',
            OBJECT_ID='poivaszuywttjeduoscd',
            EPOCH=datetime.datetime.now(datetime.timezone.utc),
            MEAN_MOTION=float(33.64218573246242),
            ECCENTRICITY=float(95.47572162476037),
            INCLINATION=float(57.6273731503099),
            RA_OF_ASC_NODE=float(47.382920357202494),
            ARG_OF_PERICENTER=float(73.80708524019184),
            MEAN_ANOMALY=float(87.96908120080082),
            EPHEMERIS_TYPE=int(47),
            CLASSIFICATION_TYPE=None,
            NORAD_CAT_ID=int(21),
            ELEMENT_SET_NO=int(47),
            REV_AT_EPOCH=int(61),
            BSTAR=float(77.0213495568115),
            MEAN_MOTION_DOT=float(36.54244558344612),
            MEAN_MOTION_DDOT=float(51.618928061552516),
            RMS=float(75.12332578301873),
            DATA_SOURCE='jveznujbqdsbetuolkad'
        )
        return instance
    ...
    def test_OBJECT_NAME_property(self):
        ...
        """
        test_value = 'ngrdwibrldbledviijfv'
    ...
    def test_OBJECT_ID_property(self):
        ...
        """
        test_value = 'poivaszuywttjeduoscd'
    ...
    def test_MEAN_MOTION_property(self):
        ...
        """
        test_value = float(33.64218573246242)
    ...
    def test_ECCENTRICITY_property(self):
        ...
        """
        test_value = float(95.47572162476037)
    ...
    def test_INCLINATION_property(self):
        ...
        """
        test_value = float(57.6273731503099)
    ...
    def test_RA_OF_ASC_NODE_property(self):
        ...
        """
        test_value = float(47.382920357202494)
    ...
    def test_ARG_OF_PERICENTER_property(self):
        ...
        """
        test_value = float(73.80708524019184)
    ...
    def test_MEAN_ANOMALY_property(self):
        ...
        """
        test_value = float(87.96908120080082)
    ...
    def test_BSTAR_property(self):
        ...
        Test BSTAR property
        """
        test_value = float(77.0213495568115)
    ...
    def test_MEAN_MOTION_DOT_property(self):
        ...
        """
        test_value = float(36.54244558344612)
    ...
    def test_MEAN_MOTION_DDOT_property(self):
        ...
        """
        test_value = float(51.618928061552516)
    ...
    def test_RMS_property(self):
        ...
        Test RMS property
        """
        test_value = float(75.12332578301873)
    ...
    def test_DATA_SOURCE_property(self):
        ...
        """
        test_value = 'jveznujbqdsbetuolkad'

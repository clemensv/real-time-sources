...
class OrgCelestrakAmqpProducer:
    """
    Producer class to send messages in the `org.celestrak.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_satellite_catalog_entry(self,
        ...
        """
        Send the `org.celestrak.amqp.SatelliteCatalogEntry` message
        A CelesTrak SATCAT reference record for one catalogued space object. Emitted at start-up and on periodic refresh so consumers can resolve every `NORAD_CAT_ID` to a named, described object.
        
        Args:
            _feedurl (str): Value for placeholder feedurl in attribute source
            _norad_cat_id (str): Value for placeholder NORAD_CAT_ID in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            data (SatelliteCatalogEntry): The message data object
        ...
        attributes = {
            ...
            "subject":
            "{NORAD_CAT_ID}".format(NORAD_CAT_ID=_norad_cat_id),
        }
        ...
        amqp_msg.subject = "{NORAD_CAT_ID}".format(NORAD_CAT_ID=_norad_cat_id)

        app_properties = {}
        app_properties["norad_cat_id"] = "{NORAD_CAT_ID}".format(NORAD_CAT_ID=_norad_cat_id)
        app_properties["data_kind"] = "satcat"
        if app_properties:
    ...
    def send_satellite_catalog_entry_batch(self,
        data_array: typing.List[SatelliteCatalogEntry],
        _feedurl: str,
        _norad_cat_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `org.celestrak.amqp.SatelliteCatalogEntry` messages
        
        Args:
            data_array (typing.List[SatelliteCatalogEntry]): Array of message data objects
            _feedurl (str): Value for placeholder feedurl in attribute source
            _norad_cat_id (str): Value for placeholder NORAD_CAT_ID in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
        ...
        for data in data_array:
            self.send_satellite_catalog_entry(
                data=data,
                _feedurl=_feedurl,
                _norad_cat_id=_norad_cat_id,
                _time=_time,
                content_type=content_type)
    
    
    def send_orbit_mean_elements(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `org.celestrak.amqp.OrbitMeanElements` message
        A CelesTrak GP (General Perturbations) OMM orbital element set for one object. Emitted when a new or refreshed element set is observed.
        
        Args:
            _feedurl (str): Value for placeholder feedurl in attribute source
            _norad_cat_id (str): Value for placeholder NORAD_CAT_ID in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            data (OrbitMeanElements): The message data object
            content_type (str): The content type of the message data (default: 'application/json')
        """
        # Build CloudEvent attributes
        attributes = {
    ...
    def send_orbit_mean_elements_batch(self,
        data_array: typing.List[OrbitMeanElements],
        _feedurl: str,
        _norad_cat_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `org.celestrak.amqp.OrbitMeanElements` messages
        
        Args:
            data_array (typing.List[OrbitMeanElements]): Array of message data objects
            _feedurl (str): Value for placeholder feedurl in attribute source
            _norad_cat_id (str): Value for placeholder NORAD_CAT_ID in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            content_type (str): The content type of the message data
    ...
    def send_supplemental_orbit_mean_elements(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `org.celestrak.amqp.SupplementalOrbitMeanElements` message
        A CelesTrak SupGP (Supplemental GP) OMM element set for one object, from an operator or analysis-centre source. Emitted when supplemental sources are configured.
        
        Args:
            _feedurl (str): Value for placeholder feedurl in attribute source
            _norad_cat_id (str): Value for placeholder NORAD_CAT_ID in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            data (SupplementalOrbitMeanElements): The message data object
            content_type (str): The content type of the message data (default: 'application/json')
        """
        # Build CloudEvent attributes
        attributes = {
            "type":
            "org.celestrak.SupplementalOrbitMeanElements",
            "source":
            "{feedurl}".format(feedurl=_feedurl),
            "subject":
            "{NORAD_CAT_ID}".format(NORAD_CAT_ID=_norad_cat_id),
        ...
        app_properties = {}
        app_properties["norad_cat_id"] = "{NORAD_CAT_ID}".format(NORAD_CAT_ID=_norad_cat_id)
        app_properties["data_kind"] = "supgp"
        if app_properties:
            if amqp_msg.properties is None:
                amqp_msg.properties = {}
            amqp_msg.properties.update(app_properties)
    ...
    def send_supplemental_orbit_mean_elements_batch(self,
        data_array: typing.List[SupplementalOrbitMeanElements],
        _feedurl: str,
        _norad_cat_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `org.celestrak.amqp.SupplementalOrbitMeanElements` messages
        
        Args:
            data_array (typing.List[SupplementalOrbitMeanElements]): Array of message data objects
            _feedurl (str): Value for placeholder feedurl in attribute source
            _norad_cat_id (str): Value for placeholder NORAD_CAT_ID in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            content_type (str): The content type of the message data
        """
        for data in data_array:
            self.send_supplemental_orbit_mean_elements(
                data=data,
                _feedurl=_feedurl,
                _norad_cat_id=_norad_cat_id,
                _time=_time,

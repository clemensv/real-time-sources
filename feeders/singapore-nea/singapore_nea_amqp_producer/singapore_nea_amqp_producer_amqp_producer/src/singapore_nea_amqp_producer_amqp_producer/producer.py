...
class SGGovNEAWeatherAmqpProducer:
    """
    Producer class to send messages in the `SG.Gov.NEA.Weather.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_amqp(self,
        ...
        """
        Send the `SG.Gov.NEA.Weather.Station.amqp` message
    ...
    def send_amqp_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `SG.Gov.NEA.Weather.Station.amqp` messages
    ...
    def send_amqp(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `SG.Gov.NEA.Weather.WeatherObservation.amqp` message
    ...
    def send_amqp_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `SG.Gov.NEA.Weather.WeatherObservation.amqp` messages
...
class SGGovNEAAirQualityAmqpProducer:
    """
    Producer class to send messages in the `SG.Gov.NEA.AirQuality.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_amqp(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `SG.Gov.NEA.AirQuality.Region.amqp` message
        A reference record published by Singapore's National Environment Agency (NEA). It lets consumers label, group, and route the live measurement or forecast events.
        ...
        if amqp_creation_time is not None:
            amqp_msg.creation_time = amqp_creation_time
        # Apply AMQP message properties declared in protocoloptions.properties.
        amqp_msg.subject = "{region}".format(region=_region)
    ...
    def send_amqp_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `SG.Gov.NEA.AirQuality.Region.amqp` messages
        
        Args:
            data_array (typing.List[Region]): Array of message data objects
            _region (str): Value for placeholder region in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            _station_id (str): Value for AMQP protocol option placeholder station_id
            _event (str): Value for AMQP protocol option placeholder event
    ...
    def send_amqp(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `SG.Gov.NEA.AirQuality.PSIReading.amqp` message
        A current environmental measurement from Singapore's National Environment Agency (NEA). It carries weather observations, air-quality readings, and environmental indexes when the upstream feed reports a new or refreshed value.
    ...
    def send_amqp_batch(self,
        data_array: typing.List[PSIReading],
        _region: str,
        _station_id: str,
        _event: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `SG.Gov.NEA.AirQuality.PSIReading.amqp` messages
        
        Args:
            data_array (typing.List[PSIReading]): Array of message data objects
            _region (str): Value for placeholder region in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            _station_id (str): Value for AMQP protocol option placeholder station_id
            _event (str): Value for AMQP protocol option placeholder event
    ...
    def send_amqp(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `SG.Gov.NEA.AirQuality.PM25Reading.amqp` message
        A current environmental measurement from Singapore's National Environment Agency (NEA). It carries weather observations, air-quality readings, and environmental indexes when the upstream feed reports a new or refreshed value.
    ...
    def send_amqp_batch(self,
        data_array: typing.List[PM25Reading],
        _region: str,
        _station_id: str,
        _event: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `SG.Gov.NEA.AirQuality.PM25Reading.amqp` messages
        
        Args:
            data_array (typing.List[PM25Reading]): Array of message data objects
            _region (str): Value for placeholder region in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            _station_id (str): Value for AMQP protocol option placeholder station_id
            _event (str): Value for AMQP protocol option placeholder event

...
class Station:
    ...
    Attributes:
        ...
        latitude (float)
        longitude (float)
        data_types (typing.Optional[str])
    """
    ...
    data_types: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="data_types"))
    ...
    def create_instance(cls) -> 'Station':
        ...
        """
        return cls(
            station_id='preqmqpdtuliykvdcpuz',
            device_id='rvqjuvnoevbofqtvyikx',
            name='bpzwfiawsylflfypvjor',
            latitude=float(62.045096769451945),
            longitude=float(17.651101663611335),
            data_types='oghaposogygjytyxfhri'
        )
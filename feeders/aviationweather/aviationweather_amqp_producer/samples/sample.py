...
"""
Sample usage of aviationweather_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send Metar message
        print("Sending Metar message...")
        # TODO: Create a Metar instance with actual data
        # data = Metar(...)
        # producer.send_metar(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("Metar message sent successfully!")
        
        
        
        # Send Sigmet message
        print("Sending Sigmet message...")
        # TODO: Create a Sigmet instance with actual data
        # data = Sigmet(...)
        # producer.send_sigmet(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("Sigmet message sent successfully!")

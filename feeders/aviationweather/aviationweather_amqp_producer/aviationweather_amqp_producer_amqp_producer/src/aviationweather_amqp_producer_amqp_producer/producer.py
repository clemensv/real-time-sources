...
class GovNoaaAviationweatherAmqpProducer:
    """
    Producer class to send messages in the `gov.noaa.aviationweather.amqp` message group via AMQP 1.0 protocol.
    """

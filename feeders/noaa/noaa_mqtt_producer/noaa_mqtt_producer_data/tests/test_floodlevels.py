...
from noaa_mqtt_producer_data.microsoft.opendata.us.noaa.stationtypes.floodlevels import Floodlevels
...
class Test_Floodlevels(unittest.TestCase):
    ...
    def test_self__property(self):
        ...
        Test self_ property
        """
        test_value = 'liehvaiietefbgtoukpz'
    ...
    def test_to_json(self):
        ...
        new_instance = Floodlevels.from_json(json_data)

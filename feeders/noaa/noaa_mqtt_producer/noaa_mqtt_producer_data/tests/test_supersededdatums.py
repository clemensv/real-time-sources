...
from noaa_mqtt_producer_data.microsoft.opendata.us.noaa.stationtypes.supersededdatums import Supersededdatums
...
class Test_Supersededdatums(unittest.TestCase):
    ...
    def test_self__property(self):
        ...
        Test self_ property
        """
        test_value = 'sahqquojetqkgcxfnsqb'
    ...
    def test_to_json(self):
        ...
        new_instance = Supersededdatums.from_json(json_data)

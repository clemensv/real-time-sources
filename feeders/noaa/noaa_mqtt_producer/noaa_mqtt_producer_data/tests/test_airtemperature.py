...
class Test_AirTemperature(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = AirTemperature(
            station_id='tqmezmaysbhkoptlygtn',
            timestamp='cjjuhknothtcqycitwij',
            value=float(60.67226914315592),
            max_temp_exceeded=True,
            min_temp_exceeded=False,
            rate_of_change_exceeded=True,
            region='ddymdtjmmezobhhjdjvu'
        )
        return instance
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'tqmezmaysbhkoptlygtn'
    ...
    def test_timestamp_property(self):
        ...
        """
        test_value = 'cjjuhknothtcqycitwij'
    ...
    def test_value_property(self):
        ...
        Test value property
        """
        test_value = float(60.67226914315592)
    ...
    def test_region_property(self):
        ...
        """
        test_value = 'ddymdtjmmezobhhjdjvu'

...
class Test_AirTemperature(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = AirTemperature(
            station_id='pyvlepasveayxhyrmcvj',
            timestamp='undcyildotpmdvkqjtto',
            value=float(39.80236575549786),
            max_temp_exceeded=False,
            min_temp_exceeded=True,
            rate_of_change_exceeded=False,
            region='fvlilncxchdcbdpoddqk'
        )
        return instance
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'pyvlepasveayxhyrmcvj'
    ...
    def test_timestamp_property(self):
        ...
        """
        test_value = 'undcyildotpmdvkqjtto'
    ...
    def test_value_property(self):
        ...
        Test value property
        """
        test_value = float(39.80236575549786)
    ...
    def test_region_property(self):
        ...
        """
        test_value = 'fvlilncxchdcbdpoddqk'

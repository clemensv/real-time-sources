...
from noaa_mqtt_producer_data.microsoft.opendata.us.noaa.stationtypes.ofsmapoffsets import OfsMapOffsets
...
class Test_OfsMapOffsets(unittest.TestCase):
    ...
    def test_self__property(self):
        ...
        Test self_ property
        """
        test_value = 'kbrfjcznwklyormduxmh'
    ...
    def test_to_json(self):
        ...
        new_instance = OfsMapOffsets.from_json(json_data)

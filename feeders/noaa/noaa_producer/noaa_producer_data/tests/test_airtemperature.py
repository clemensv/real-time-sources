...
class Test_AirTemperature(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = AirTemperature(
            station_id='hpbmcpwyfdaqhugblyiz',
            timestamp='asibffxmjoujcvtqbsnj',
            value=float(7.679931555580877),
            max_temp_exceeded=False,
            min_temp_exceeded=True,
            rate_of_change_exceeded=False,
            region='xvpkklohqnpcanjiseot'
        )
        return instance
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'hpbmcpwyfdaqhugblyiz'
    ...
    def test_timestamp_property(self):
        ...
        """
        test_value = 'asibffxmjoujcvtqbsnj'
    ...
    def test_value_property(self):
        ...
        Test value property
        """
        test_value = float(7.679931555580877)
    ...
    def test_region_property(self):
        ...
        """
        test_value = 'xvpkklohqnpcanjiseot'

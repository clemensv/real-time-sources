...
from noaa_amqp_producer_data.microsoft.opendata.us.noaa.stationtypes.datums import Datums
...
class Test_Datums(unittest.TestCase):
    ...
    def test_self__property(self):
        ...
        Test self_ property
        """
        test_value = 'enmslgmmnrmatdtgekqy'
    ...
    def test_to_json(self):
        ...
        new_instance = Datums.from_json(json_data)

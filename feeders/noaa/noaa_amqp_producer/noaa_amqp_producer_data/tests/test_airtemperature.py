...
class Test_AirTemperature(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = AirTemperature(
            station_id='lmwaeudgbmrlhdendeqg',
            timestamp='xnqvycbwywgpwzbtsgkh',
            value=float(17.465848461564924),
            max_temp_exceeded=False,
            min_temp_exceeded=False,
            rate_of_change_exceeded=True,
            region='lxolvcvbrhtjqxoqjlzh'
        )
        return instance
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'lmwaeudgbmrlhdendeqg'
    ...
    def test_timestamp_property(self):
        ...
        """
        test_value = 'xnqvycbwywgpwzbtsgkh'
    ...
    def test_value_property(self):
        ...
        Test value property
        """
        test_value = float(17.465848461564924)
    ...
    def test_region_property(self):
        ...
        """
        test_value = 'lxolvcvbrhtjqxoqjlzh'

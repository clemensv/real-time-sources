...
class Test_AirTemperature(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = AirTemperature(
            station_id='lezdyrwsyszpjfflpauk',
            timestamp='rlbkfevlkhzxwtbjrjoa',
            value=float(91.59265169630204),
            max_temp_exceeded=False,
            min_temp_exceeded=True,
            rate_of_change_exceeded=False,
            region='jwfchozuflzeoknmhvzd'
        )
        return instance
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'lezdyrwsyszpjfflpauk'
    ...
    def test_timestamp_property(self):
        ...
        """
        test_value = 'rlbkfevlkhzxwtbjrjoa'
    ...
    def test_value_property(self):
        ...
        Test value property
        """
        test_value = float(91.59265169630204)
    ...
    def test_region_property(self):
        ...
        """
        test_value = 'jwfchozuflzeoknmhvzd'

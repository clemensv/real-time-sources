...
from noaa_amqp_producer_data.microsoft.opendata.us.noaa.stationtypes.harmonicconstituents import HarmonicConstituents
...
class Test_HarmonicConstituents(unittest.TestCase):
    ...
    def test_self__property(self):
        ...
        Test self_ property
        """
        test_value = 'fuxnzjmxacgwaqtxerhe'
    ...
    def test_to_json(self):
        ...
        new_instance = HarmonicConstituents.from_json(json_data)

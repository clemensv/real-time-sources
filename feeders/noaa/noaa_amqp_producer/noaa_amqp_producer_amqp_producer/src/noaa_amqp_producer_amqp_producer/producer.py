...
class MicrosoftOpenDataUSNOAAAmqpProducer:
    """
    Producer class to send messages in the `Microsoft.OpenData.US.NOAA.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_water_level(self,
        data: WaterLevel,
        _station_id: str,
        _region: str,
        content_type: str = 'application/json') -> None:
        """
        Send the `Microsoft.OpenData.US.NOAA.amqp.WaterLevel` message
        ...
        Args:
            ...
            data (WaterLevel): The message data object
        ...
        app_properties = {}
        app_properties["region"] = "{region}".format(region=_region)
        if app_properties:
    ...
    def send_water_level_batch(self,
        data_array: typing.List[WaterLevel],
        _station_id: str,
        _region: str,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `Microsoft.OpenData.US.NOAA.amqp.WaterLevel` messages
        
        Args:
            data_array (typing.List[WaterLevel]): Array of message data objects
            _station_id (str): Value for placeholder station_id in attribute subject
            _region (str): Value for AMQP protocol option placeholder region
            content_type (str): The content type of the message data
        """
        for data in data_array:
            self.send_water_level(
                data=data,
    ...
    def send_predictions(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `Microsoft.OpenData.US.NOAA.amqp.Predictions` message
        
        Args:
            _station_id (str): Value for placeholder station_id in attribute subject
            _region (str): Value for AMQP protocol option placeholder region
            data (Predictions): The message data object
            content_type (str): The content type of the message data (default: 'application/json')
        """
        # Build CloudEvent attributes
        attributes = {
    ...
    def send_predictions_batch(self,
        data_array: typing.List[Predictions],
        _station_id: str,
        _region: str,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `Microsoft.OpenData.US.NOAA.amqp.Predictions` messages
        
        Args:
            data_array (typing.List[Predictions]): Array of message data objects
            _station_id (str): Value for placeholder station_id in attribute subject
            _region (str): Value for AMQP protocol option placeholder region
            content_type (str): The content type of the message data
        """
    ...
    def send_air_pressure(self,
        data: AirPressure,
        _station_id: str,
        _region: str,
        content_type: str = 'application/json') -> None:
        """
        Send the `Microsoft.OpenData.US.NOAA.amqp.AirPressure` message
        
        Args:
            _station_id (str): Value for placeholder station_id in attribute subject
            _region (str): Value for AMQP protocol option placeholder region
            data (AirPressure): The message data object
            content_type (str): The content type of the message data (default: 'application/json')
        """
        # Build CloudEvent attributes
        attributes = {
    ...
    def send_air_pressure_batch(self,
        data_array: typing.List[AirPressure],
        _station_id: str,
        _region: str,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `Microsoft.OpenData.US.NOAA.amqp.AirPressure` messages
        
        Args:
            data_array (typing.List[AirPressure]): Array of message data objects
            _station_id (str): Value for placeholder station_id in attribute subject
            _region (str): Value for AMQP protocol option placeholder region
            content_type (str): The content type of the message data
        """
        for data in data_array:
            self.send_air_pressure(
                data=data,
                _station_id=_station_id,
                _region=_region,
                content_type=content_type)
    ...
    def send_air_temperature(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `Microsoft.OpenData.US.NOAA.amqp.AirTemperature` message
    ...
    def send_air_temperature_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `Microsoft.OpenData.US.NOAA.amqp.AirTemperature` messages
    ...
    def send_water_temperature(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `Microsoft.OpenData.US.NOAA.amqp.WaterTemperature` message
    ...
    def send_water_temperature_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `Microsoft.OpenData.US.NOAA.amqp.WaterTemperature` messages
    ...
    def send_wind(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `Microsoft.OpenData.US.NOAA.amqp.Wind` message
        
        Args:
            _station_id (str): Value for placeholder station_id in attribute subject
            _region (str): Value for AMQP protocol option placeholder region
            data (Wind): The message data object
            content_type (str): The content type of the message data (default: 'application/json')
        """
        # Build CloudEvent attributes
        attributes = {
    ...
    def send_wind_batch(self,
        data_array: typing.List[Wind],
        _station_id: str,
        _region: str,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `Microsoft.OpenData.US.NOAA.amqp.Wind` messages
        
        Args:
            data_array (typing.List[Wind]): Array of message data objects
            _station_id (str): Value for placeholder station_id in attribute subject
            _region (str): Value for AMQP protocol option placeholder region
            content_type (str): The content type of the message data
        """
    ...
    def send_humidity(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `Microsoft.OpenData.US.NOAA.amqp.Humidity` message
        
        Args:
            _station_id (str): Value for placeholder station_id in attribute subject
            _region (str): Value for AMQP protocol option placeholder region
            data (Humidity): The message data object
            content_type (str): The content type of the message data (default: 'application/json')
        """
        # Build CloudEvent attributes
        attributes = {
    ...
    def send_humidity_batch(self,
        data_array: typing.List[Humidity],
        _station_id: str,
        _region: str,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `Microsoft.OpenData.US.NOAA.amqp.Humidity` messages
        
        Args:
            data_array (typing.List[Humidity]): Array of message data objects
            _station_id (str): Value for placeholder station_id in attribute subject
            _region (str): Value for AMQP protocol option placeholder region
            content_type (str): The content type of the message data
        """
    ...
    def send_conductivity(self,
        data: Conductivity,
        _station_id: str,
        _region: str,
        content_type: str = 'application/json') -> None:
        """
        Send the `Microsoft.OpenData.US.NOAA.amqp.Conductivity` message
        
        Args:
            _station_id (str): Value for placeholder station_id in attribute subject
            _region (str): Value for AMQP protocol option placeholder region
            data (Conductivity): The message data object
            content_type (str): The content type of the message data (default: 'application/json')
        """
        # Build CloudEvent attributes
        attributes = {
    ...
    def send_conductivity_batch(self,
        data_array: typing.List[Conductivity],
        _station_id: str,
        _region: str,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `Microsoft.OpenData.US.NOAA.amqp.Conductivity` messages
        
        Args:
            data_array (typing.List[Conductivity]): Array of message data objects
            _station_id (str): Value for placeholder station_id in attribute subject
            _region (str): Value for AMQP protocol option placeholder region
            content_type (str): The content type of the message data
        """
        for data in data_array:
            self.send_conductivity(
                data=data,
                _station_id=_station_id,
                _region=_region,
                content_type=content_type)
    ...
    def send_salinity(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `Microsoft.OpenData.US.NOAA.amqp.Salinity` message
    ...
    def send_salinity_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `Microsoft.OpenData.US.NOAA.amqp.Salinity` messages
    ...
    def send_station(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `Microsoft.OpenData.US.NOAA.amqp.Station` message
    ...
    def send_station_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `Microsoft.OpenData.US.NOAA.amqp.Station` messages
    ...
    def send_visibility(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `Microsoft.OpenData.US.NOAA.amqp.Visibility` message
        
        Args:
            _station_id (str): Value for placeholder station_id in attribute subject
            _region (str): Value for AMQP protocol option placeholder region
            data (Visibility): The message data object
            content_type (str): The content type of the message data (default: 'application/json')
        """
        # Build CloudEvent attributes
        attributes = {
    ...
    def send_visibility_batch(self,
        data_array: typing.List[Visibility],
        _station_id: str,
        _region: str,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `Microsoft.OpenData.US.NOAA.amqp.Visibility` messages
        
        Args:
            data_array (typing.List[Visibility]): Array of message data objects
            _station_id (str): Value for placeholder station_id in attribute subject
            _region (str): Value for AMQP protocol option placeholder region
            content_type (str): The content type of the message data
        """
    ...
    def send_currents(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `Microsoft.OpenData.US.NOAA.amqp.Currents` message
        
        Args:
            _station_id (str): Value for placeholder station_id in attribute subject
            _region (str): Value for AMQP protocol option placeholder region
            data (Currents): The message data object
            content_type (str): The content type of the message data (default: 'application/json')
        """
        # Build CloudEvent attributes
        attributes = {
    ...
    def send_currents_batch(self,
        data_array: typing.List[Currents],
        _station_id: str,
        _region: str,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `Microsoft.OpenData.US.NOAA.amqp.Currents` messages
        
        Args:
            data_array (typing.List[Currents]): Array of message data objects
            _station_id (str): Value for placeholder station_id in attribute subject
            _region (str): Value for AMQP protocol option placeholder region
            content_type (str): The content type of the message data
        """
    ...
    def send_current_predictions(self,
        data: CurrentPredictions,
        _station_id: str,
        _region: str,
        content_type: str = 'application/json') -> None:
        """
        Send the `Microsoft.OpenData.US.NOAA.amqp.CurrentPredictions` message
        
        Args:
            _station_id (str): Value for placeholder station_id in attribute subject
            _region (str): Value for AMQP protocol option placeholder region
            data (CurrentPredictions): The message data object
            content_type (str): The content type of the message data (default: 'application/json')
        """
        # Build CloudEvent attributes
        attributes = {
    ...
    def send_current_predictions_batch(self,
        data_array: typing.List[CurrentPredictions],
        _station_id: str,
        _region: str,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `Microsoft.OpenData.US.NOAA.amqp.CurrentPredictions` messages
        
        Args:
            data_array (typing.List[CurrentPredictions]): Array of message data objects
            _station_id (str): Value for placeholder station_id in attribute subject
            _region (str): Value for AMQP protocol option placeholder region
            content_type (str): The content type of the message data
        """
        for data in data_array:
            self.send_current_predictions(
                data=data,
                _station_id=_station_id,
                _region=_region,
                content_type=content_type)

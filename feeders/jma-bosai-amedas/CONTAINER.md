...
<sub>~1,300 AMeDAS stations, 10-min observations via Bosai JSON API · Kafka · MQTT · AMQP · <a href="https://www.jma.go.jp/bosai/amedas/">upstream</a> · <a href="https://www.jma.go.jp/bosai/amedas/">API docs</a></sub>
...
[🚀 **Deploy to Azure**](https://clemensv.github.io/real-time-sources#jma-bosai-amedas) &nbsp;·&nbsp;
[📓 **Fabric Notebook**](https://clemensv.github.io/real-time-sources#jma-bosai-amedas/fabric-notebook) &nbsp;·&nbsp;
[🐳 **docker pull**](CONTAINER.md) &nbsp;·&nbsp;
[📑 **Event schemas**](EVENTS.md) &nbsp;·&nbsp;
[🗄️ **KQL schema**](kql/jma-bosai-amedas.kql) &nbsp;·&nbsp;
[↗ **Upstream**](https://www.jma.go.jp/bosai/amedas/)
...
|---|---|---|
| `ghcr.io/clemensv/real-time-sources-jma-bosai-amedas` | Kafka | JSON CloudEvents to one Kafka topic |
| `ghcr.io/clemensv/real-time-sources-jma-bosai-amedas-mqtt` | MQTT 5.0 | Binary CloudEvents into UNS topic tree from xRegistry |
| `ghcr.io/clemensv/real-time-sources-jma-bosai-amedas-amqp` | AMQP 1.0 | Binary CloudEvents to one AMQP address |
...
| Default entry point | Kafka: `python -m jma_bosai_amedas`; MQTT: `python -m jma_bosai_amedas_mqtt feed`; AMQP: `python -m jma_bosai_amedas_amqp feed` |
...
```bash
docker pull ghcr.io/clemensv/real-time-sources-jma-bosai-amedas:latest
docker pull ghcr.io/clemensv/real-time-sources-jma-bosai-amedas-mqtt:latest
docker pull ghcr.io/clemensv/real-time-sources-jma-bosai-amedas-amqp:latest
```
...
docker run --rm \
  ...
  -e AMQP_ADDRESS="jma-bosai-amedas" \
...
Use `tools/deploy-fabric/deploy-feeder-notebook.ps1 -Source jma-bosai-amedas -Workspace <id> -ResourceGroup <azure-rg> -Location <azure-region>` to deploy the notebook in `notebook/`, bind Event Stream/Lakehouse/KQL assets, and schedule poll runs.
...
Use `tools/deploy-fabric/deploy-fabric-aci.ps1 -Source jma-bosai-amedas -Workspace <id> -ResourceGroup <azure-rg> -Location <azure-region>` for always-on container hosting that publishes to Fabric Event Streams.
...
### Kafka — bring your own Event Hub / Kafka endpoint

Deploys the Kafka image against an existing Event Hubs, Fabric Event Stream custom endpoint, or another Kafka-compatible broker.

[![Deploy to Azure](https://aka.ms/deploytoazurebutton)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fclemensv%2Freal-time-sources%2Fmain%2Ffeeders%2Fjma-bosai-amedas%2Fazure-template.json)

### Kafka — provision Event Hubs namespace

Deploys Kafka plus a new Event Hubs namespace and event hub.

[![Deploy to Azure](https://aka.ms/deploytoazurebutton)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fclemensv%2Freal-time-sources%2Fmain%2Ffeeders%2Fjma-bosai-amedas%2Fazure-template-with-eventhub.json)

### MQTT — bring your own broker

Deploys the MQTT image against an existing MQTT 5 broker.

[![Deploy to Azure](https://aka.ms/deploytoazurebutton)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fclemensv%2Freal-time-sources%2Fmain%2Ffeeders%2Fjma-bosai-amedas%2Fazure-template-mqtt.json)

### MQTT — provision Event Grid MQTT broker

Deploys MQTT plus a new Event Grid namespace broker and identity wiring.

[![Deploy to Azure](https://aka.ms/deploytoazurebutton)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fclemensv%2Freal-time-sources%2Fmain%2Ffeeders%2Fjma-bosai-amedas%2Fazure-template-with-eventgrid-mqtt.json)

### AMQP — provision Azure Service Bus

Deploys AMQP plus a new Service Bus namespace/queue and sender identity wiring.

[![Deploy to Azure](https://aka.ms/deploytoazurebutton)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fclemensv%2Freal-time-sources%2Fmain%2Ffeeders%2Fjma-bosai-amedas%2Fazure-template-with-servicebus.json)

...
class JPJMAAmedasEventProducer:
    ...
    def send_jp_jma_amedas_station(self,_feedurl : str, _station_code : str, data: Station, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
        Sends the 'JP.JMA.Amedas.Station' event to the Kafka topic
        ...
        Args:
            ...
            key_mapper(Callable[[CloudEvent, Station], str]): A function to map the CloudEvent contents to a Kafka key (default: None).
                The default key is derived from the xRegistry Kafka key declaration 'jp.jma.amedas/{station_code}'
        """
        kafka_key = "jp.jma.amedas/{station_code}".format(station_code=_station_code)
        attributes = {
             "type":"JP.JMA.Amedas.Station",
             "source":"{feedurl}".format(feedurl = _feedurl),
             "subject":"jp.jma.amedas/{station_code}".format(station_code = _station_code)
        }
    ...
    def send_jp_jma_amedas_observation(self,_feedurl : str, _station_code : str, data: Observation, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Observation], str]=None) -> None:
        """
        Sends the 'JP.JMA.Amedas.Observation' event to the Kafka topic
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'JPJMAAmedasEventProducer':
        """

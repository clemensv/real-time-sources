...
"""
Sample usage of wallonia_issep_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send SensorConfiguration message
        print("Sending SensorConfiguration message...")
        # TODO: Create a SensorConfiguration instance with actual data
        # data = SensorConfiguration(...)
        # producer.send_sensor_configuration(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("SensorConfiguration message sent successfully!")

...
from vatsim_amqp_producer_data.net.vatsim.networkstatus import NetworkStatus
...
class Test_NetworkStatus(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = NetworkStatus(
            callsign='dbsbdznhaqzocrffglxy',
            update_timestamp='cvjkuyeeothbjtkvdvgq',
            connected_clients=int(39),
            unique_users=int(70),
            pilot_count=int(37),
            controller_count=int(14),
            facility='vwoognhshouznnqqdjqg'
        )
        return instance
    ...
    def test_callsign_property(self):
        ...
        """
        test_value = 'dbsbdznhaqzocrffglxy'
    ...
    def test_update_timestamp_property(self):
        ...
        """
        test_value = 'cvjkuyeeothbjtkvdvgq'
    ...
    def test_facility_property(self):
        ...
        """
        test_value = 'vwoognhshouznnqqdjqg'

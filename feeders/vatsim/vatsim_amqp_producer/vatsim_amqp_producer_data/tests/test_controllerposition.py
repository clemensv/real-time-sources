...
from vatsim_amqp_producer_data.net.vatsim.controllerposition import ControllerPosition
...
class Test_ControllerPosition(unittest.TestCase):
    ...
    def test_callsign_property(self):
        ...
        """
        test_value = 'qcnwzurajzdiuxtizhej'
    ...
    def test_frequency_property(self):
        ...
        """
        test_value = 'umwlpkanlylnrbakpmix'
    ...
    def test_text_atis_property(self):
        ...
        """
        test_value = 'cfvqflcpqacfzbzmarfv'
    ...
    def test_last_updated_property(self):
        ...
        """
        test_value = 'udhkvvfvowawvfybvhep'

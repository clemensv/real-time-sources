...
class NetVatsimAmqpProducer:
    """
    Producer class to send messages in the `net.vatsim.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_pilot_position(self,
        data: PilotPosition,
        _callsign: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send the `net.vatsim.amqp.PilotPosition` message
        ...
        Args:
            ...
            data (PilotPosition): The message data object
        ...
        attributes = {
            ...
            "subject":
            "{callsign}".format(callsign=_callsign),
        }
        ...
        amqp_msg.subject = "{callsign}".format(callsign=_callsign)
    ...
    def send_pilot_position_batch(self,
        data_array: typing.List[PilotPosition],
        _callsign: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `net.vatsim.amqp.PilotPosition` messages
        
        Args:
            data_array (typing.List[PilotPosition]): Array of message data objects
            _callsign (str): Value for placeholder callsign in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            content_type (str): The content type of the message data
        """
        for data in data_array:
            self.send_pilot_position(
                data=data,
                _callsign=_callsign,
                _time=_time,
    ...
    def send_controller_position(self,
        data: ControllerPosition,
        _callsign: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send the `net.vatsim.amqp.ControllerPosition` message
        Current state and frequency of an air traffic controller connected to the VATSIM virtual aviation network.
        
        Args:
            _callsign (str): Value for placeholder callsign in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            data (ControllerPosition): The message data object
            content_type (str): The content type of the message data (default: 'application/json')
        """
        # Build CloudEvent attributes
        attributes = {
    ...
    def send_controller_position_batch(self,
        data_array: typing.List[ControllerPosition],
        _callsign: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `net.vatsim.amqp.ControllerPosition` messages
        
        Args:
            data_array (typing.List[ControllerPosition]): Array of message data objects
            _callsign (str): Value for placeholder callsign in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            content_type (str): The content type of the message data
        """
        for data in data_array:
            self.send_controller_position(
                data=data,
                _callsign=_callsign,
                _time=_time,
                content_type=content_type)
    ...
    def send_facility_status(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `net.vatsim.amqp.FacilityStatus` message
        Aggregate network status snapshot from the VATSIM data feed, emitted once per poll cycle.
        
        Args:
            _callsign (str): Value for placeholder callsign in attribute subject
            _facility (str): Value for AMQP protocol option placeholder facility
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            data (NetworkStatus): The message data object
            content_type (str): The content type of the message data (default: 'application/json')
        """
        # Build CloudEvent attributes
        attributes = {
        ...
        app_properties = {}
        app_properties["facility"] = "{facility}".format(facility=_facility)
        if app_properties:
            if amqp_msg.properties is None:
                amqp_msg.properties = {}
            amqp_msg.properties.update(app_properties)
    ...
    def send_facility_status_batch(self,
        data_array: typing.List[NetworkStatus],
        _callsign: str,
        _facility: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `net.vatsim.amqp.FacilityStatus` messages
        
        Args:
            data_array (typing.List[NetworkStatus]): Array of message data objects
            _callsign (str): Value for placeholder callsign in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            _facility (str): Value for AMQP protocol option placeholder facility
            content_type (str): The content type of the message data

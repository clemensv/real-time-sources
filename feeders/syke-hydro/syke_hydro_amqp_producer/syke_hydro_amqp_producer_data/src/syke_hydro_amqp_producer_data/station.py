...
class Station:
    ...
    Attributes:
        ...
        water_area_name (typing.Optional[str])
    ...
    water_area_name: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="water_area_name"))

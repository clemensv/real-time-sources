...
class USWAKingCountyMarineEventProducer:
    ...
    def send_us_wa_king_county_marine_station(self,_station_id : str, data: Station, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
    ...
    def send_us_wa_king_county_marine_water_quality_reading(self,_station_id : str, data: WaterQualityReading, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, WaterQualityReading], str]=None) -> None:
        """

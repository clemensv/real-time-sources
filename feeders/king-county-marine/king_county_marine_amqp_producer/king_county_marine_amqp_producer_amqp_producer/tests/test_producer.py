...
"""
Tests for king_county_marine_amqp_producer_amqp_producer
"""
import base64
import json
import os
...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../king_county_marine_amqp_producer_data/src')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../king_county_marine_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../king_county_marine_amqp_producer_amqp_producer/src')))

from king_county_marine_amqp_producer_amqp_producer import *
from king_county_marine_amqp_producer_data import Station
from test_king_county_marine_amqp_producer_data_station import Test_Station
from king_county_marine_amqp_producer_data import WaterQualityReading
from test_king_county_marine_amqp_producer_data_waterqualityreading import Test_WaterQualityReading
...
class TestUSWAKingCountyMarineAmqpProducer:
    """Test cases for USWAKingCountyMarineAmqpProducer"""

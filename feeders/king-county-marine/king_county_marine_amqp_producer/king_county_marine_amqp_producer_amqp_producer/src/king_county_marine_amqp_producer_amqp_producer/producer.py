...
class USWAKingCountyMarineAmqpProducer:
    """
    Producer class to send messages in the `US.WA.KingCounty.Marine.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_station(self,
        ...
        """
        Send the `US.WA.KingCounty.Marine.amqp.Station` message
        ...
        attributes = {
            "type":
            "US.WA.KingCounty.Marine.Station",
            "source":
    ...
    def send_station_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `US.WA.KingCounty.Marine.amqp.Station` messages
    ...
    def send_water_quality_reading(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `US.WA.KingCounty.Marine.amqp.WaterQualityReading` message
    ...
    def send_water_quality_reading_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `US.WA.KingCounty.Marine.amqp.WaterQualityReading` messages

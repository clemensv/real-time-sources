...
class WeatherAlert:
    ...
    sent: datetime.datetime=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="sent"))
    effective: datetime.datetime=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="effective"))
    expires: datetime.datetime=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="expires"))
    ...
    def __post_init__(self):
        ...
        value_sent = self.sent
        self.sent = value_sent
        value_effective = self.effective
        self.effective = value_effective
        value_expires = self.expires
        self.expires = value_expires
        self.status=str(self.status)
        self.message_type=str(self.message_type)
        self.category=str(self.category) if self.category else None
        self.severity=str(self.severity)
        self.certainty=str(self.certainty)
        self.urgency=str(self.urgency)
        self.event=str(self.event)
        self.sender_name=str(self.sender_name) if self.sender_name else None
        self.headline=str(self.headline) if self.headline else None

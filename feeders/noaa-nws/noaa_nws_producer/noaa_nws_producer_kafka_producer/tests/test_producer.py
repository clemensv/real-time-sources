...
def test_microsoft_opendata_us_noaa_nws_alerts_mqtt_microsoftopendatausnoaanwsalertsmqttweatheralert(kafka_emulator):
    """Test the MicrosoftOpenDataUSNOAANWSAlertsMqttWeatherAlert event from the Microsoft.OpenData.US.NOAA.NWS.Alerts.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_microsoft_opendata_us_noaa_nws_alerts_mqtt_microsoftopendatausnoaanwsalertsmqttweatheralert',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
    ...
    kafka_producer = Producer({'bootstrap.servers': bootstrap_servers})
    producer_instance = MicrosoftOpenDataUSNOAANWSAlertsMqttEventProducer(kafka_producer, topic, 'binary')
    # Create valid test data using the test helper
    event_data = Test_WeatherAlert.create_instance()
...
def test_microsoft_opendata_us_noaa_nws_alerts_amqp_microsoftopendatausnoaanwsalertsamqpweatheralert(kafka_emulator):
    """Test the MicrosoftOpenDataUSNOAANWSAlertsAmqpWeatherAlert event from the Microsoft.OpenData.US.NOAA.NWS.Alerts.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_microsoft_opendata_us_noaa_nws_alerts_amqp_microsoftopendatausnoaanwsalertsamqpweatheralert',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
    ...
    kafka_producer = Producer({'bootstrap.servers': bootstrap_servers})
    producer_instance = MicrosoftOpenDataUSNOAANWSAlertsAmqpEventProducer(kafka_producer, topic, 'binary')
    # Create valid test data using the test helper
    event_data = Test_WeatherAlert.create_instance()
...
def test_microsoft_opendata_us_noaa_nws_observations_mqtt_microsoftopendatausnoaanwsobservationsmqttobservationstation(kafka_emulator):
    """Test the MicrosoftOpenDataUSNOAANWSObservationsMqttObservationStation event from the Microsoft.OpenData.US.NOAA.NWS.Observations.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_microsoft_opendata_us_noaa_nws_observations_mqtt_microsoftopendatausnoaanwsobservationsmqttobservationstation',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
    ...
    kafka_producer = Producer({'bootstrap.servers': bootstrap_servers})
    producer_instance = MicrosoftOpenDataUSNOAANWSObservationsMqttEventProducer(kafka_producer, topic, 'binary')
    # Create valid test data using the test helper
    event_data = Test_ObservationStation.create_instance()
...
def test_microsoft_opendata_us_noaa_nws_observations_mqtt_microsoftopendatausnoaanwsobservationsmqttweatherobservation(kafka_emulator):
    """Test the MicrosoftOpenDataUSNOAANWSObservationsMqttWeatherObservation event from the Microsoft.OpenData.US.NOAA.NWS.Observations.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_microsoft_opendata_us_noaa_nws_observations_mqtt_microsoftopendatausnoaanwsobservationsmqttweatherobservation',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_microsoft_opendata_us_noaa_nws_observations_amqp_microsoftopendatausnoaanwsobservationsamqpobservationstation(kafka_emulator):
    """Test the MicrosoftOpenDataUSNOAANWSObservationsAmqpObservationStation event from the Microsoft.OpenData.US.NOAA.NWS.Observations.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_microsoft_opendata_us_noaa_nws_observations_amqp_microsoftopendatausnoaanwsobservationsamqpobservationstation',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
    ...
    kafka_producer = Producer({'bootstrap.servers': bootstrap_servers})
    producer_instance = MicrosoftOpenDataUSNOAANWSObservationsAmqpEventProducer(kafka_producer, topic, 'binary')
    # Create valid test data using the test helper
    event_data = Test_ObservationStation.create_instance()
...
def test_microsoft_opendata_us_noaa_nws_observations_amqp_microsoftopendatausnoaanwsobservationsamqpweatherobservation(kafka_emulator):
    """Test the MicrosoftOpenDataUSNOAANWSObservationsAmqpWeatherObservation event from the Microsoft.OpenData.US.NOAA.NWS.Observations.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_microsoft_opendata_us_noaa_nws_observations_amqp_microsoftopendatausnoaanwsobservationsamqpweatherobservation',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])

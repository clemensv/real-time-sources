...
class SEGovSMHIWeatherAmqpProducer:
    """
    Producer class to send messages in the `SE.Gov.SMHI.Weather.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_station(self,
        ...
        """
        Send the `SE.Gov.SMHI.Weather.amqp.Station` message
        ...
        Args:
            ...
            _lan (str): Value for AMQP protocol option placeholder lan
        ...
        app_properties = {}
        app_properties["lan"] = "{lan}".format(lan=_lan)
        if app_properties:
    ...
    def send_station_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `SE.Gov.SMHI.Weather.amqp.Station` messages
    ...
    def send_weather_observation(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `SE.Gov.SMHI.Weather.amqp.WeatherObservation` message
    ...
    def send_weather_observation_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `SE.Gov.SMHI.Weather.amqp.WeatherObservation` messages

...
class Station:
    """
    Reference station payload from KiWIS getStationList with stable identifiers, optional location, river, and catchment context.
    
    Attributes:
        kiwis_id (str)
        base_url (str)
        station_id (str)
        station_no (typing.Optional[str])
    ...
    station_no: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="station_no"))

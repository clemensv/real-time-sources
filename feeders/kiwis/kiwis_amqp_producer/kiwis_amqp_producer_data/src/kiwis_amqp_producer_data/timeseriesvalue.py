...
class TimeseriesValue:
    """
    Telemetry payload for one KiWIS getTimeseriesValues row with value, quality code, and unit metadata copied from the timeseries catalog.
    ...
    Attributes:
        ...
        quality_code (typing.Optional[int])
    ...
    quality_code: typing.Optional[int]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="quality_code"))
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'TimeseriesValue':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['TimeseriesValue']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return TimeseriesValue.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'TimeseriesValue':
        """
        ...
        """
        return cls(
            kiwis_id='dtjlcksjhinbcgtcxfls',
            base_url='dtjslgclctkmgiiwffyj',
            ts_id='hhboemeowjwrbxxozuhv',
            station_id='cmwvjmrofpqetngwxuiu',
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            value=float(23.140730480884397),
            quality_code=int(98),
            unit_name='qmpqymdxoxnsgsnerlcl',
            unit_symbol='psvtptjhurpcapbhxahz',
            parametertype_name='brkddcogziwxsaypnqxy',
            stationparameter_name='eyrqlqozwtbdexdvzjcd'
        )
...
class Station:
    ...
    Attributes:
        ...
        wmo_id (typing.Optional[int])
        province_territory (typing.Optional[str])
        data_provider (typing.Optional[str])
        dataset_network (typing.Optional[str])
        auto_man (typing.Optional[str])
    ...
    wmo_id: typing.Optional[int]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="wmo_id"))
    province_territory: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="province_territory"))
    data_provider: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="data_provider"))
    dataset_network: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="dataset_network"))
    auto_man: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="auto_man"))
    ...
    def create_instance(cls) -> 'Station':
        ...
        """
        return cls(
            msc_id='fuhqlgnlubjtloqqkgof',
            name='dyxhpixqgenoqkqfdlqb',
            iata_id='yotwgqarpacncoxfmlif',
            wmo_id=int(65),
            province_territory='gkhovgnckpnkxudvpryu',
            data_provider='zcauvxocvhbaddwxvlgv',
            dataset_network='mlwfxvvvjsdljqyohilx',
            auto_man='nlalvuehlidcitiguzhj',
            latitude=float(21.168147986319084),
            longitude=float(28.157060687333846),
            elevation=float(93.10239104400964),
            province='fsvmirmgucrwjwnwfbvz'
        )
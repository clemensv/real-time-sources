...
# Environment_canada_producer Kafka Producer# Environment_canada_producer Event Dispatcher for Apache Kafka
...
3. [Quick Start](#quick-start)    - CAGovECCCWeatherEventDispatcher,

4. [Generated Producer Classes](#generated-producer-classes)    CAGovECCCWeatherMqttEventDispatcher,

4. [Generated Producer Classes](#generated-producer-classes)    CAGovECCCWeatherAmqpEventDispatcher
...
- CAGovECCCWeatherProducersolution for event-driven applications.

It includes both plain Kafka messages and CloudEvents, offering a versatile

- CAGovECCCWeatherMqttProducersolution for event-driven applications.

It includes both plain Kafka messages and CloudEvents, offering a versatile

- CAGovECCCWeatherAmqpProducersolution for event-driven applications.
...
- **Scales horizontally** across multiple brokers and partitions### CAGovECCCWeatherEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`CAGovECCCWeatherEventDispatcher` handles events for the CA.Gov.ECCC.Weather message group.
...
from environment_canada_producer import CAGovECCCWeatherProducer```python
...
await producer.send_ca_gov_eccc_weather_station(```python
...
The CAGovECCCWeatherEventDispatcher defines the following event handler hooks.
...
producer = CAGovECCCWeatherProducer(
    ...
    security_protocol='SASL_SSL',##### `ca_gov_eccc_weather_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'ca_gov_eccc_weather_station_async:  Callable[[ConsumerRecord, CloudEvent, Station],
Awaitable[None]]
...
Asynchronous handler hook for `CA.Gov.ECCC.Weather.Station`: A reference record published by Environment and Climate
Change Canada (ECCC). It lets consumers label, group, and route the live measurement or forecast events.
...
### CAGovECCCWeatherProducer- `data`: The event data of type `environment_canada_producer_data.Station`.



Producer for `CA.Gov.ECCC.Weather` message group.Example:



#### Constructor```python

async def ca_gov_eccc_weather_station_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Station) -> None:

```python    # Process the event data

CAGovECCCWeatherProducer(    await some_processing_function(record, cloud_event, data)
...
ca_gov_eccc_weather_dispatcher.ca_gov_eccc_weather_station_async = ca_gov_eccc_weather_station_event
...
### CAGovECCCWeatherMqttProducer- `data`: The event data of type `environment_canada_producer_data.Station`.



Producer for `CA.Gov.ECCC.Weather.mqtt` message group.Example:
...
CAGovECCCWeatherMqttProducer(    await some_processing_function(record, cloud_event, data)
...
ca_gov_eccc_weather_mqtt_dispatcher.ca_gov_eccc_weather_station_async = ca_gov_eccc_weather_station_event
...
### CAGovECCCWeatherAmqpProducer- `data`: The event data of type `environment_canada_producer_data.Station`.



Producer for `CA.Gov.ECCC.Weather.amqp` message group.Example:
...
CAGovECCCWeatherAmqpProducer(    await some_processing_function(record, cloud_event, data)
...
ca_gov_eccc_weather_amqp_dispatcher.ca_gov_eccc_weather_station_async = ca_gov_eccc_weather_station_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `ca_gov_eccc_weather_weather_observation_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'ca_gov_eccc_weather_weather_observation_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `CA.Gov.ECCC.Weather.WeatherObservation`: A current environmental measurement from
Environment and Climate Change Canada (ECCC). It carries current weather observations when the upstream feed reports a
...
### CAGovECCCWeatherProducer- `data`: The event data of type `environment_canada_producer_data.WeatherObservation`.
...
async def ca_gov_eccc_weather_weather_observation_event(record: ConsumerRecord, cloud_event: CloudEvent, data:
...
ca_gov_eccc_weather_dispatcher.ca_gov_eccc_weather_weather_observation_async =
ca_gov_eccc_weather_weather_observation_event
...
### CAGovECCCWeatherMqttProducer- `data`: The event data of type `environment_canada_producer_data.WeatherObservation`.
...
ca_gov_eccc_weather_mqtt_dispatcher.ca_gov_eccc_weather_weather_observation_async =
ca_gov_eccc_weather_weather_observation_event
...
### CAGovECCCWeatherAmqpProducer- `data`: The event data of type `environment_canada_producer_data.WeatherObservation`.
...
ca_gov_eccc_weather_amqp_dispatcher.ca_gov_eccc_weather_weather_observation_async =
ca_gov_eccc_weather_weather_observation_event
...
##### `send_ca_gov_eccc_weather_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_ca_gov_eccc_weather_station(
...
Send a single `CA.Gov.ECCC.Weather.Station` message. A reference record published by Environment and Climate Change
Canada (ECCC). It lets consumers label, group, and route the live measurement or forecast events.Args:
...
await producer.send_ca_gov_eccc_weather_station(
...
Send multiple `CA.Gov.ECCC.Weather.Station` messages in a batch.
...
await producer.send_ca_gov_eccc_weather_station_batch(```
...
##### `send_ca_gov_eccc_weather_weather_observation`Dispatchers have the following protected methods:



```python### Methods:

async def send_ca_gov_eccc_weather_weather_observation(
...
Send a single `CA.Gov.ECCC.Weather.WeatherObservation` message. A current environmental measurement from Environment and
Climate Change Canada (ECCC). It carries current weather observations when the upstream feed reports a new or refreshed
value.Args:
...
await producer.send_ca_gov_eccc_weather_weather_observation(
...
Send multiple `CA.Gov.ECCC.Weather.WeatherObservation` messages in a batch.
...
await producer.send_ca_gov_eccc_weather_weather_observation_batch(```
...
- **Scales horizontally** across multiple brokers and partitions### CAGovECCCWeatherMqttEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`CAGovECCCWeatherMqttEventDispatcher` handles events for the CA.Gov.ECCC.Weather.mqtt message group.
...
The CAGovECCCWeatherMqttEventDispatcher defines the following event handler hooks.
...
producer = CAGovECCCWeatherProducer(
    ...
    security_protocol='SASL_SSL',##### `ca_gov_eccc_weather_mqtt_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'ca_gov_eccc_weather_mqtt_station_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `CA.Gov.ECCC.Weather.mqtt.Station`: A reference record published by Environment and
Climate Change Canada (ECCC). It lets consumers label, group, and route the live measurement or forecast events.
...
async def ca_gov_eccc_weather_mqtt_station_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Station) ->
None:
...
ca_gov_eccc_weather_dispatcher.ca_gov_eccc_weather_mqtt_station_async = ca_gov_eccc_weather_mqtt_station_event
...
ca_gov_eccc_weather_mqtt_dispatcher.ca_gov_eccc_weather_mqtt_station_async = ca_gov_eccc_weather_mqtt_station_event
...
ca_gov_eccc_weather_amqp_dispatcher.ca_gov_eccc_weather_mqtt_station_async = ca_gov_eccc_weather_mqtt_station_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `ca_gov_eccc_weather_mqtt_weather_observation_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'ca_gov_eccc_weather_mqtt_weather_observation_async:  Callable[[ConsumerRecord,
...
Asynchronous handler hook for `CA.Gov.ECCC.Weather.mqtt.WeatherObservation`: A current environmental measurement from
Environment and Climate Change Canada (ECCC). It carries current weather observations when the upstream feed reports a
new or refreshed value.
...
async def ca_gov_eccc_weather_mqtt_weather_observation_event(record: ConsumerRecord, cloud_event: CloudEvent, data:
WeatherObservation) -> None:
...
ca_gov_eccc_weather_dispatcher.ca_gov_eccc_weather_mqtt_weather_observation_async =
ca_gov_eccc_weather_mqtt_weather_observation_event
...
ca_gov_eccc_weather_mqtt_dispatcher.ca_gov_eccc_weather_mqtt_weather_observation_async =
ca_gov_eccc_weather_mqtt_weather_observation_event
...
ca_gov_eccc_weather_amqp_dispatcher.ca_gov_eccc_weather_mqtt_weather_observation_async =
ca_gov_eccc_weather_mqtt_weather_observation_event
...
##### `send_ca_gov_eccc_weather_mqtt_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_ca_gov_eccc_weather_mqtt_station(
...
Send a single `CA.Gov.ECCC.Weather.mqtt.Station` message. A reference record published by Environment and Climate Change
Canada (ECCC). It lets consumers label, group, and route the live measurement or forecast events.Args:
...
await producer.send_ca_gov_eccc_weather_mqtt_station(
...
Send multiple `CA.Gov.ECCC.Weather.mqtt.Station` messages in a batch.
...
await producer.send_ca_gov_eccc_weather_mqtt_station_batch(```
...
##### `send_ca_gov_eccc_weather_mqtt_weather_observation`Dispatchers have the following protected methods:



```python### Methods:

async def send_ca_gov_eccc_weather_mqtt_weather_observation(
...
Send a single `CA.Gov.ECCC.Weather.mqtt.WeatherObservation` message. A current environmental measurement from
Environment and Climate Change Canada (ECCC). It carries current weather observations when the upstream feed reports a
...
await producer.send_ca_gov_eccc_weather_mqtt_weather_observation(
...
Send multiple `CA.Gov.ECCC.Weather.mqtt.WeatherObservation` messages in a batch.
...
await producer.send_ca_gov_eccc_weather_mqtt_weather_observation_batch(```
...
- **Scales horizontally** across multiple brokers and partitions### CAGovECCCWeatherAmqpEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`CAGovECCCWeatherAmqpEventDispatcher` handles events for the CA.Gov.ECCC.Weather.amqp message group.
...
The CAGovECCCWeatherAmqpEventDispatcher defines the following event handler hooks.
...
producer = CAGovECCCWeatherProducer(
    ...
    security_protocol='SASL_SSL',##### `ca_gov_eccc_weather_amqp_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'ca_gov_eccc_weather_amqp_station_async:  Callable[[ConsumerRecord, CloudEvent,
Station], Awaitable[None]]
...
Asynchronous handler hook for `CA.Gov.ECCC.Weather.amqp.Station`: A reference record published by Environment and
Climate Change Canada (ECCC). It lets consumers label, group, and route the live measurement or forecast events.
...
async def ca_gov_eccc_weather_amqp_station_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Station) ->
None:
...
ca_gov_eccc_weather_dispatcher.ca_gov_eccc_weather_amqp_station_async = ca_gov_eccc_weather_amqp_station_event
...
ca_gov_eccc_weather_mqtt_dispatcher.ca_gov_eccc_weather_amqp_station_async = ca_gov_eccc_weather_amqp_station_event
...
ca_gov_eccc_weather_amqp_dispatcher.ca_gov_eccc_weather_amqp_station_async = ca_gov_eccc_weather_amqp_station_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `ca_gov_eccc_weather_amqp_weather_observation_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'ca_gov_eccc_weather_amqp_weather_observation_async:  Callable[[ConsumerRecord,
CloudEvent, WeatherObservation], Awaitable[None]]
...
Asynchronous handler hook for `CA.Gov.ECCC.Weather.amqp.WeatherObservation`: A current environmental measurement from
Environment and Climate Change Canada (ECCC). It carries current weather observations when the upstream feed reports a
new or refreshed value.
...
async def ca_gov_eccc_weather_amqp_weather_observation_event(record: ConsumerRecord, cloud_event: CloudEvent, data:
WeatherObservation) -> None:
...
ca_gov_eccc_weather_dispatcher.ca_gov_eccc_weather_amqp_weather_observation_async =
ca_gov_eccc_weather_amqp_weather_observation_event
...
ca_gov_eccc_weather_mqtt_dispatcher.ca_gov_eccc_weather_amqp_weather_observation_async =
ca_gov_eccc_weather_amqp_weather_observation_event
...
ca_gov_eccc_weather_amqp_dispatcher.ca_gov_eccc_weather_amqp_weather_observation_async =
ca_gov_eccc_weather_amqp_weather_observation_event
...
##### `send_ca_gov_eccc_weather_amqp_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_ca_gov_eccc_weather_amqp_station(
...
Send a single `CA.Gov.ECCC.Weather.amqp.Station` message. A reference record published by Environment and Climate Change
Canada (ECCC). It lets consumers label, group, and route the live measurement or forecast events.Args:
...
await producer.send_ca_gov_eccc_weather_amqp_station(
...
Send multiple `CA.Gov.ECCC.Weather.amqp.Station` messages in a batch.
...
await producer.send_ca_gov_eccc_weather_amqp_station_batch(```
...
##### `send_ca_gov_eccc_weather_amqp_weather_observation`Dispatchers have the following protected methods:



```python### Methods:

async def send_ca_gov_eccc_weather_amqp_weather_observation(
...
Send a single `CA.Gov.ECCC.Weather.amqp.WeatherObservation` message. A current environmental measurement from
Environment and Climate Change Canada (ECCC). It carries current weather observations when the upstream feed reports a
new or refreshed value.Args:
...
await producer.send_ca_gov_eccc_weather_amqp_weather_observation(
...
Send multiple `CA.Gov.ECCC.Weather.amqp.WeatherObservation` messages in a batch.
...
await producer.send_ca_gov_eccc_weather_amqp_weather_observation_batch(```

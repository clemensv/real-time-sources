...
class WeatherObservation:
    ...
    def create_instance(cls) -> 'WeatherObservation':
        ...
        """
        return cls(
            msc_id='rexspjdbmpcafzqbaadx',
            station_name='tequsxmygoufmukoddbz',
            observation_time=datetime.datetime.now(datetime.timezone.utc),
            air_temperature=float(43.98810442171658),
            dew_point=float(95.06134913471502),
            relative_humidity=int(93),
            station_pressure=float(9.386876802951106),
            wind_speed=float(58.60101319728219),
            wind_direction=int(24),
            wind_gust=float(39.689054689190705),
            precipitation_1hr=float(3.137263072737251),
            mean_sea_level_pressure=float(83.27557254651614),
            visibility=float(51.840443628126856),
            snow_depth=float(39.21538701869339),
            total_cloud_cover=int(75),
            pressure_tendency_3hr=float(90.00598289639566),
            max_temperature_24hr=float(21.744223117589655),
            min_temperature_24hr=float(10.11223539343311),
            wind_speed_1hr=float(16.72861348901078),
            wind_gust_1hr=float(44.049421747852215),
            precipitation_24hr=float(34.933376442608335),
            altimeter_setting=float(7.1467430753777705),
            province='vhbhehpupzwteblbdcvc'
        )
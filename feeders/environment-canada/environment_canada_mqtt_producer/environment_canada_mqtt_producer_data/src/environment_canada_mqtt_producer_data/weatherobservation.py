...
class WeatherObservation:
    ...
    def create_instance(cls) -> 'WeatherObservation':
        ...
        """
        return cls(
            msc_id='xdagqldbzvclqiqspgrp',
            station_name='ouxcppelsyozggtekako',
            observation_time=datetime.datetime.now(datetime.timezone.utc),
            air_temperature=float(24.771043683490003),
            dew_point=float(58.62032539695491),
            relative_humidity=int(55),
            station_pressure=float(3.776291261686504),
            wind_speed=float(65.99834939919249),
            wind_direction=int(87),
            wind_gust=float(74.08064625262533),
            precipitation_1hr=float(27.1674543961696),
            mean_sea_level_pressure=float(66.83968960982979),
            visibility=float(68.4357288961352),
            snow_depth=float(14.587981999528177),
            total_cloud_cover=int(77),
            pressure_tendency_3hr=float(7.056846297001407),
            max_temperature_24hr=float(86.77878710524195),
            min_temperature_24hr=float(57.4079084915945),
            wind_speed_1hr=float(83.88709361156569),
            wind_gust_1hr=float(55.82812129324854),
            precipitation_24hr=float(21.02460390852062),
            altimeter_setting=float(6.154402852924246),
            province='kqggugdzbruyhuwsghjk'
        )
...
async def handle_ca_gov_eccc_weather_mqtt_station(mqtt_msg,cloud_event, ca_gov_eccc_weather_mqtt_station_data):
    """ Handles the CA.Gov.ECCC.Weather.mqtt.Station message """
    print(f"Received CA.Gov.ECCC.Weather.mqtt.Station on topic {mqtt_msg.topic}")
    if cloud_event:
        print(f"  CloudEvent ID: {cloud_event.id}, Source: {cloud_event.source}")
    print(f"  Data: {ca_gov_eccc_weather_mqtt_station_data}")

async def handle_ca_gov_eccc_weather_mqtt_weather_observation(mqtt_msg,cloud_event, ca_gov_eccc_weather_mqtt_weather_observation_data):
    """ Handles the CA.Gov.ECCC.Weather.mqtt.WeatherObservation message """
    print(f"Received CA.Gov.ECCC.Weather.mqtt.WeatherObservation on topic {mqtt_msg.topic}")
    if cloud_event:
        print(f"  CloudEvent ID: {cloud_event.id}, Source: {cloud_event.source}")

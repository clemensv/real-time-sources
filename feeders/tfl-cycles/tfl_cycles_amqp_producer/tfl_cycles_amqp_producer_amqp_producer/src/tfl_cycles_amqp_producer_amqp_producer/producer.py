...
class UKGovTfLCyclesAmqpStationsProducer:
    """
    Producer class to send messages in the `UK.Gov.TfL.Cycles.amqp.stations` message group via AMQP 1.0 protocol.
    """
    ...
    def send_station_information(self,
        ...
        """
        Send the `UK.Gov.TfL.Cycles.amqp.StationInformation` message
    ...
    def send_station_information_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `UK.Gov.TfL.Cycles.amqp.StationInformation` messages
    ...
    def send_station_status(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `UK.Gov.TfL.Cycles.amqp.StationStatus` message
    ...
    def send_station_status_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `UK.Gov.TfL.Cycles.amqp.StationStatus` messages

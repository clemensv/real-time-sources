...
class Test_VolcanicWarning(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = VolcanicWarning(
            volcano_code='snrfksfkhbdrjsnyssta',
            event_id='yzjfxdhghqqedkgumgjk',
            ...
            alert_level_code='jhvyxrlzzbqsvrhicosm',
            alert_level_name='xbmhdajyvpglzkzqklbn',
            previous_level_code='lywrpqizscslzrbehygp',
            condition=ConditionEnum.ISSUED,
            info_type_jp='isiqtubedodhnyxvoimy',
            area_codes=['wrwaxzqwwqvzodefboaq', 'pwoizfdkovttgginaebs'],
            prefecture='hyfjsogcyhbpbkkhdeyd',
    ...
    def test_volcano_code_property(self):
        ...
        """
        test_value = 'snrfksfkhbdrjsnyssta'
    ...
    def test_event_id_property(self):
        ...
        """
        test_value = 'yzjfxdhghqqedkgumgjk'
    ...
    def test_alert_level_code_property(self):
        ...
        """
        test_value = 'jhvyxrlzzbqsvrhicosm'
    ...
    def test_alert_level_name_property(self):
        ...
        """
        test_value = 'xbmhdajyvpglzkzqklbn'
    ...
    def test_previous_level_code_property(self):
        ...
        """
        test_value = 'lywrpqizscslzrbehygp'
    ...
    def test_info_type_jp_property(self):
        ...
        """
        test_value = 'isiqtubedodhnyxvoimy'
    ...
    def test_area_codes_property(self):
        ...
        """
        test_value = ['wrwaxzqwwqvzodefboaq', 'pwoizfdkovttgginaebs']
    ...
    def test_prefecture_property(self):
        ...
        """
        test_value = 'hyfjsogcyhbpbkkhdeyd'

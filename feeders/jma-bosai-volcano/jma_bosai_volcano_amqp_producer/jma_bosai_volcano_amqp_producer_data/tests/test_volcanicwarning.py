...
class Test_VolcanicWarning(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = VolcanicWarning(
            volcano_code='cfnezmtkvskarwcotxfw',
            event_id='ahyykbzdqkmzwheghgbc',
            ...
            alert_level_code='mppuumertnissneugwys',
            alert_level_name='hprxtnfyxivcvwgwvtqd',
            previous_level_code='rhtiikjdrmpmkeljltch',
            condition=ConditionEnum.ISSUED,
            info_type_jp='xqtfpqxhfqrwergsvjzh',
            area_codes=['xrupunzorwxpfnazreby', 'uyesfruhsuyiobmcwkal', 'ziqneeogvtnaqpxohpkv'],
            prefecture='ojxbwqbfxzkrwfzmmymr',
    ...
    def test_volcano_code_property(self):
        ...
        """
        test_value = 'cfnezmtkvskarwcotxfw'
    ...
    def test_event_id_property(self):
        ...
        """
        test_value = 'ahyykbzdqkmzwheghgbc'
    ...
    def test_alert_level_code_property(self):
        ...
        """
        test_value = 'mppuumertnissneugwys'
    ...
    def test_alert_level_name_property(self):
        ...
        """
        test_value = 'hprxtnfyxivcvwgwvtqd'
    ...
    def test_previous_level_code_property(self):
        ...
        """
        test_value = 'rhtiikjdrmpmkeljltch'
    ...
    def test_info_type_jp_property(self):
        ...
        """
        test_value = 'xqtfpqxhfqrwergsvjzh'
    ...
    def test_area_codes_property(self):
        ...
        """
        test_value = ['xrupunzorwxpfnazreby', 'uyesfruhsuyiobmcwkal', 'ziqneeogvtnaqpxohpkv']
    ...
    def test_prefecture_property(self):
        ...
        """
        test_value = 'ojxbwqbfxzkrwfzmmymr'

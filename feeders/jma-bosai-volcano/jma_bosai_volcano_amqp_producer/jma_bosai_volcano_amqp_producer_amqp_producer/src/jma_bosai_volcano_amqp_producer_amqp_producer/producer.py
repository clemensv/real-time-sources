...
class JPJMAVolcanoAmqpProducer:
    """
    Producer class to send messages in the `JP.JMA.Volcano.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_volcanic_warning(self,
    ...
    def send_volcanic_eruption(self,

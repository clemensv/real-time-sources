...
from dwd_pollenflug_mqtt_producer_data.region import Region
...
class Test_Region(unittest.TestCase):
    ...
    def test_region_id_property(self):
        ...
        """
        test_value = 'hglpnlxqmnwemypnsjng'
    ...
    def test_region_name_property(self):
        ...
        """
        test_value = 'utjdndsexvzdtjrqsqxe'
    ...
    def test_partregion_name_property(self):
        ...
        """
        test_value = 'ygnnplciiogafwtbemun'

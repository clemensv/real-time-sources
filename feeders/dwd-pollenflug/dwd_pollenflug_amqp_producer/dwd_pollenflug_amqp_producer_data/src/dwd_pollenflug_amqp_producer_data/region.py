...
class Region:
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'Region':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['Region']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return Region.from_serializer_dict(_record)
            else:
    ...
    def create_instance(cls) -> 'Region':
        ...
        """
        return cls(
            region_id='tpstlhtukytnmpcswnuv',
            region_name='blbzbvswjbqimkuutsbt',
            partregion_id=int(33),
            partregion_name='jgvlbmwpojycnfpfkkrs'
        )
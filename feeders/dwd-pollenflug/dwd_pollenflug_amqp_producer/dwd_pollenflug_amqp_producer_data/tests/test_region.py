...
from dwd_pollenflug_amqp_producer_data.region import Region
...
class Test_Region(unittest.TestCase):
    ...
    def test_region_id_property(self):
        ...
        """
        test_value = 'tpstlhtukytnmpcswnuv'
    ...
    def test_region_name_property(self):
        ...
        """
        test_value = 'blbzbvswjbqimkuutsbt'
    ...
    def test_partregion_name_property(self):
        ...
        """
        test_value = 'jgvlbmwpojycnfpfkkrs'

...
class FRParisOpenDataVeloEventProducer:
    ...
    def send_fr_paris_open_data_velo_counter(self,_counter_id : str, _ce_id : str, data: Counter, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Counter], str]=None) -> None:
        """
        ...
        Args:
            ...
            key_mapper(Callable[[CloudEvent, Counter], str]): A function to map the CloudEvent contents to a Kafka key (default: None).
                The default key is derived from the xRegistry Kafka key declaration '{counter_id}'
        """
        kafka_key = "{counter_id}".format(counter_id=_counter_id)
        attributes = {
    ...
    def send_fr_paris_open_data_velo_bicycle_count(self,_counter_id : str, _ce_id : str, data: BicycleCount, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, BicycleCount], str]=None) -> None:
        """
...
class FRParisOpenDataVeloMqttEventProducer:
    ...
    def send_fr_paris_open_data_velo_mqtt_counter(self,_counter_id : str, _ce_id : str, data: Counter, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Counter], str]=None) -> None:
        """
    ...
    def send_fr_paris_open_data_velo_mqtt_bicycle_count(self,_counter_id : str, _ce_id : str, data: BicycleCount, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, BicycleCount], str]=None) -> None:
        """
...
class FRParisOpenDataVeloAmqpEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    def send_fr_paris_open_data_velo_amqp_counter(self,_counter_id : str, _ce_id : str, data: Counter, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Counter], str]=None) -> None:
        """
        Sends the 'FR.Paris.OpenData.Velo.amqp.Counter' event to the Kafka topic
    ...
    def send_fr_paris_open_data_velo_amqp_bicycle_count(self,_counter_id : str, _ce_id : str, data: BicycleCount, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, BicycleCount], str]=None) -> None:
        """
        Sends the 'FR.Paris.OpenData.Velo.amqp.BicycleCount' event to the Kafka topic
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'FRParisOpenDataVeloAmqpEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.

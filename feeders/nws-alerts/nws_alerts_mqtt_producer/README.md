# Nws_alerts_mqtt_producer MQTT Client

This library provides MQTT producer and consumer functionality for the nws_alerts_mqtt_producer message definitions.

# Nws_alerts_mqtt_producer Event Dispatcher for Azure Event Hubs
...
from nws_alerts_mqtt_producer_mqtt_client import *This module defines an event processing framework for Azure Event
Hubs,
...
client = NWSAlertsMqttMqttClient(mqtt_client, content_mode='structured')

# Connect to broker

await client.connect("mqtt.example.com", 1883)### NWSAlertsMqttEventDispatcher



# Publish message`NWSAlertsMqttEventDispatcher` handles events for the NWS.Alerts.mqtt message group.
...
from nws_alerts_mqtt_producer_mqtt_client import *create_processor(self, consumer_group_name: str,
...
client = NWSAlertsMqttMqttClient(mqtt_client, content_mode='structured')- `eventhub_name`: The name of the Event Hub.-
...
## BuildThe NWSAlertsMqttEventDispatcher defines the following event handler hooks.

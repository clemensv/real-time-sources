...
class NWSAlertsPoller:
    ...
    async def poll_once(self) -> List[WeatherAlert]:
        ...
        for feature in features:
            ...
            sent_str = alert.sent or ""; prev_sent = state.get(alert.alert_id)

...
class Measure:
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['Measure']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return Measure.from_serializer_dict(_record)
            else:
    ...
    def create_instance(cls) -> 'Measure':
        ...
        return cls(
            ...
            scope_id=int(53),
            date_start='gnziojmvmxoldmluxhqj',
            date_end='tjuwlaekofidmhpoxnso',
            value=float(8.402250988119764),
            quality_index='plduxghtqvomxjnqllqg'
        )
...
from uba_airdata_mqtt_producer_data.de.uba.airdata.components.component import Component
...
class Test_Component(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Component(
            component_id=int(82),
            component_code='evqyjtamoxuprkenknhr',
            symbol='bchdfhakymedmrkpigjp',
            unit='hactlfqmczilgopujwbf',
            name='aggyqfenjdbcxndhvnty'
        )
        return instance
    ...
    def test_component_code_property(self):
        ...
        """
        test_value = 'evqyjtamoxuprkenknhr'
    ...
    def test_symbol_property(self):
        ...
        """
        test_value = 'bchdfhakymedmrkpigjp'
    ...
    def test_unit_property(self):
        ...
        Test unit property
        """
        test_value = 'hactlfqmczilgopujwbf'
    ...
    def test_name_property(self):
        ...
        Test name property
        """
        test_value = 'aggyqfenjdbcxndhvnty'

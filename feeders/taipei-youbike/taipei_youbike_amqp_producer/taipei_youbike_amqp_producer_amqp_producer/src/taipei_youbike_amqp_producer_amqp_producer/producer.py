...
class TWYouBikeAmqpStationsProducer:
    """
    Producer class to send messages in the `TW.YouBike.amqp.stations` message group via AMQP 1.0 protocol.
    """
    ...
    def send_station_information(self,
        ...
        """
        Send the `TW.YouBike.amqp.StationInformation` message
    ...
    def send_station_information_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `TW.YouBike.amqp.StationInformation` messages
    ...
    def send_station_status(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `TW.YouBike.amqp.StationStatus` message
    ...
    def send_station_status_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `TW.YouBike.amqp.StationStatus` messages

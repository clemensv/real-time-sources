...
class FeedConfig:
    ...
    def from_env(cls, *, polling_interval: Optional[int] = None,
        ...
        if state_file is None:
            state_file = os.getenv("STATE_FILE", os.path.expanduser("~/.taipei_youbike_state.json"))
        if once is None:
...
def build_kafka_config(
    *,
    ...
    cfg: Dict[str, str] = {"bootstrap.servers": bootstrap_servers, "client.id": "taipei-youbike"}

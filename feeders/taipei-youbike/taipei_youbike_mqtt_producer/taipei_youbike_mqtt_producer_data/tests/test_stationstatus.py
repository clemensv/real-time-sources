...
from taipei_youbike_mqtt_producer_data.tw.youbike.stationstatus import StationStatus
import datetime
...
class Test_StationStatus(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = StationStatus(
            station_id='iuxeahubteszikxbhkzp',
            num_bikes_available=int(82),
            num_bikes_yb1=int(1),
            num_bikes_yb2=int(72),
            num_ebikes_available=int(25),
            num_empty_docks=int(32),
            num_forbidden_docks=int(17),
            availability_level=int(99),
            service_status=int(14),
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'iuxeahubteszikxbhkzp'

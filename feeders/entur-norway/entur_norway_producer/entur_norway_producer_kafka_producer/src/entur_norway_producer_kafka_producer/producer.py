...
class NoEnturJourneysEventProducer:
    ...
    def send_no_entur_dated_service_journey(self,_operating_day : str, _service_journey_id : str, data: DatedServiceJourney, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, DatedServiceJourney], str]=None) -> None:
        """
    ...
    def send_no_entur_estimated_vehicle_journey(self,_operating_day : str, _service_journey_id : str, data: EstimatedVehicleJourney, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, EstimatedVehicleJourney], str]=None) -> None:
        """
    ...
    def send_no_entur_monitored_vehicle_journey(self,_operating_day : str, _service_journey_id : str, data: MonitoredVehicleJourney, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, MonitoredVehicleJourney], str]=None) -> None:
        """
...
class NoEnturSituationsEventProducer:
    ...
    def send_no_entur_pt_situation_element(self,_situation_number : str, data: PtSituationElement, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, PtSituationElement], str]=None) -> None:
        """
...
class NoEnturMqttEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    def send_no_entur_mqtt_estimated_vehicle_journey(self,_operating_day : str, _service_journey_id : str, data: EstimatedVehicleJourney, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, EstimatedVehicleJourney], str]=None) -> None:
        """
        Sends the 'no.entur.mqtt.EstimatedVehicleJourney' event to the Kafka topic
    ...
    def send_no_entur_mqtt_monitored_vehicle_journey(self,_operating_day : str, _service_journey_id : str, data: MonitoredVehicleJourney, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, MonitoredVehicleJourney], str]=None) -> None:
        """
        Sends the 'no.entur.mqtt.MonitoredVehicleJourney' event to the Kafka topic
    ...
    def send_no_entur_mqtt_pt_situation_element(self,_situation_number : str, data: PtSituationElement, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, PtSituationElement], str]=None) -> None:
        """
        Sends the 'no.entur.mqtt.PtSituationElement' event to the Kafka topic
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'NoEnturMqttEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.
...
class NoEnturAmqpEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    def send_no_entur_amqp_estimated_vehicle_journey(self,_operating_day : str, _service_journey_id : str, data: EstimatedVehicleJourney, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, EstimatedVehicleJourney], str]=None) -> None:
        """
        Sends the 'no.entur.amqp.EstimatedVehicleJourney' event to the Kafka topic
    ...
    def send_no_entur_amqp_monitored_vehicle_journey(self,_operating_day : str, _service_journey_id : str, data: MonitoredVehicleJourney, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, MonitoredVehicleJourney], str]=None) -> None:
        """
        Sends the 'no.entur.amqp.MonitoredVehicleJourney' event to the Kafka topic
    ...
    def send_no_entur_amqp_pt_situation_element(self,_situation_number : str, data: PtSituationElement, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, PtSituationElement], str]=None) -> None:
        """
        Sends the 'no.entur.amqp.PtSituationElement' event to the Kafka topic
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'NoEnturAmqpEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.

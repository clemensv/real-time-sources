...
class NoEnturMqttEventProducer:
    ...
    def send_no_entur_mqtt_estimated_vehicle_journey(self,_operating_day : str, _service_journey_id : str, data: EstimatedVehicleJourney, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, EstimatedVehicleJourney], str]=None) -> None:
        """
    ...
    def send_no_entur_mqtt_monitored_vehicle_journey(self,_operating_day : str, _service_journey_id : str, data: MonitoredVehicleJourney, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, MonitoredVehicleJourney], str]=None) -> None:
        """
    ...
    def send_no_entur_mqtt_pt_situation_element(self,_situation_number : str, data: PtSituationElement, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, PtSituationElement], str]=None) -> None:
        """

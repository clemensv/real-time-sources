...
class EstimatedVehicleJourney:
    ...
    Attributes:
        ...
        is_extra_journey (typing.Optional[bool])
        is_complete_stop_sequence (typing.Optional[bool])
        monitored (typing.Optional[bool])
        data_source (typing.Optional[str])
        recorded_at_time (typing.Optional[datetime.datetime])
        estimated_calls (typing.List[EstimatedCall])
    """
    ...
    recorded_at_time: typing.Optional[datetime.datetime]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="recorded_at_time", encoder=lambda d: d.isoformat() if isinstance(d, datetime.datetime) else d if d else None, decoder=lambda d: datetime.datetime.fromisoformat(d) if isinstance(d, str) else d if d else None, mm_field=fields.DateTime(format='iso')))
    ...
    @classmethod
    def create_instance(cls) -> 'EstimatedVehicleJourney':
        """

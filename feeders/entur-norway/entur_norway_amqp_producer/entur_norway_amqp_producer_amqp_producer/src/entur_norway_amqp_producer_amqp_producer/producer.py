...
class NoEnturAmqpProducer:
    """
    Producer class to send messages in the `no.entur.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_estimated_vehicle_journey(self,
        ...
        app_properties = {}
        app_properties["operating_day"] = "{operating_day}".format(operating_day=_operating_day)
        app_properties["service_journey_id"] = "{service_journey_id}".format(service_journey_id=_service_journey_id)
        app_properties["operator_ref"] = "{operator_ref}".format(operator_ref=_operator_ref)
        app_properties["line_ref"] = "{line_ref}".format(line_ref=_line_ref)
        if app_properties:
    ...
    def send_estimated_vehicle_journey_batch(self,
        ...
        for data in data_array:
            self.send_estimated_vehicle_journey(
                data=data,
    ...
    def send_monitored_vehicle_journey(self,
    ...
    def send_monitored_vehicle_journey_batch(self,
        ...
        """
        for data in data_array:
            self.send_monitored_vehicle_journey(
                data=data,
                _operating_day=_operating_day,
                _service_journey_id=_service_journey_id,
                _time=_time,
    ...
    def send_pt_situation_element(self,
        ...
        app_properties = {}
        app_properties["situation_number"] = "{situation_number}".format(situation_number=_situation_number)

...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../entur_norway_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../entur_norway_amqp_producer_amqp_producer/src')))
...
class TestNoEnturAmqpProducer:
    """Test cases for NoEnturAmqpProducer"""

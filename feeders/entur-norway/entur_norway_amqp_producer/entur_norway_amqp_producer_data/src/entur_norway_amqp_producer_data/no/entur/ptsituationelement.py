...
class PtSituationElement:
    ...
    Attributes:
        ...
        affects_line_refs (typing.Optional[typing.List[str]])
        affects_stop_point_refs (typing.Optional[typing.List[str]])
        validity_periods (typing.Optional[typing.List[ValidityPeriod]])
    """
    ...
    creation_time: datetime.datetime=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="creation_time", encoder=lambda d: d.isoformat() if isinstance(d, datetime.datetime) else d if d else None, decoder=lambda d: datetime.datetime.fromisoformat(d) if isinstance(d, str) else d if d else None, mm_field=fields.DateTime(format='iso')))
    ...
    affects_line_refs: typing.Optional[typing.List[str]]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="affects_line_refs"))
    affects_stop_point_refs: typing.Optional[typing.List[str]]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="affects_stop_point_refs"))
    validity_periods: typing.Optional[typing.List[ValidityPeriod]]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="validity_periods"))
    ...
    @classmethod
    def create_instance(cls) -> 'PtSituationElement':
        """
        ...
        """
        return cls(
            situation_number='ajtrtcpinasmysfbpctn',
            version='pnphiqkpqyhbdreyyszq',
            creation_time=datetime.datetime.now(datetime.timezone.utc),
            source_type='avtsbdtqwbbutnytecef',
            source_name='waofbzdeydeikfnrpord',
            progress='krvuxyovmwuwgvurnvqs',
            severity='fqegfkylasuaswaeausi',
            keywords='xznbyenhxrlukhbfrtxo',
            summary='ehczhyetfzepptrjvcmr',
            description='oivovpvlkzoblbszdknd',
            affects_line_refs=['pzsfpzgphdnezwhcrfbf', 'hpsceijwidpjmmaubozc'],
            affects_stop_point_refs=['tyjlfuiuuebiifngyrnj', 'gdzzseqirfwidgvxgfzj', 'rmsmcvtjluadqopioune', 'gilckrylrjdgjdeinyyd', 'wwrzbhfontebyszhqogq'],
            validity_periods=[None, None, None, None]
        )
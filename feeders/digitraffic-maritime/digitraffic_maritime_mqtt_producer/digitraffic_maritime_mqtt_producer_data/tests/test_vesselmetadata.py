...
class Test_VesselMetadata(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = VesselMetadata(
            mmsi=int(66),
            timestamp=int(36),
            name='qlzvhvzcygkeusxtqqvb',
            callSign='oethhvmvsaxurrwbmydd',
            imo=int(66),
            type=int(4),
            draught=int(64),
            eta=int(44),
            destination='mrhhpovwcdqzykfnnaxe',
            posType=int(55),
            refA=int(38),
            refB=int(82),
            refC=int(89),
    ...
    def test_name_property(self):
        ...
        Test name property
        """
        test_value = 'qlzvhvzcygkeusxtqqvb'
    ...
    def test_callSign_property(self):
        ...
        """
        test_value = 'oethhvmvsaxurrwbmydd'
    ...
    def test_destination_property(self):
        ...
        """
        test_value = 'mrhhpovwcdqzykfnnaxe'

...
from digitraffic_maritime_mqtt_producer_data.vesselmetadata import VesselMetadata
...
class Test_VesselMetadata(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = VesselMetadata(
            mmsi=int(75),
            timestamp=int(84),
            name='dwrfyvfrjeabgpuuknwx',
            callSign='luskaitnrjvsqfxgaivy',
            imo=int(0),
            type=int(10),
            draught=int(75),
            eta=int(38),
            destination='cxszvnlofdxphpdaibzg',
            posType=int(10),
            refA=int(66),
            refB=int(65),
            refC=int(57),
    ...
    def test_name_property(self):
        ...
        Test name property
        """
        test_value = 'dwrfyvfrjeabgpuuknwx'
    ...
    def test_callSign_property(self):
        ...
        """
        test_value = 'luskaitnrjvsqfxgaivy'
    ...
    def test_destination_property(self):
        ...
        """
        test_value = 'cxszvnlofdxphpdaibzg'

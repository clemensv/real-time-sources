...
class Test_VesselDimensions(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = VesselDimensions(
            tonnage_certificate_issuer='iyblqvpxzbshkomxuwap',
            date_of_issue=datetime.datetime.now(datetime.timezone.utc),
            gross_tonnage=int(10),
            net_tonnage=int(72),
            dead_weight=int(67),
            length=float(35.76244852300171),
            overall_length=float(95.74325027795537),
            height=float(31.022306076484718),
            breadth=float(67.09092924273234),
            draught=float(1.428668138635214),
            max_speed=float(82.69290895789926),
            engine_power='hpvcguqggzbrwsxonrnb'
        )
        return instance
    ...
    def test_tonnage_certificate_issuer_property(self):
        ...
        """
        test_value = 'iyblqvpxzbshkomxuwap'
    ...
    def test_length_property(self):
        ...
        """
        test_value = float(35.76244852300171)
    ...
    def test_overall_length_property(self):
        ...
        """
        test_value = float(95.74325027795537)
    ...
    def test_height_property(self):
        ...
        """
        test_value = float(31.022306076484718)
    ...
    def test_breadth_property(self):
        ...
        """
        test_value = float(67.09092924273234)
    ...
    def test_draught_property(self):
        ...
        """
        test_value = float(1.428668138635214)
    ...
    def test_max_speed_property(self):
        ...
        """
        test_value = float(82.69290895789926)
    ...
    def test_engine_power_property(self):
        ...
        """
        test_value = 'hpvcguqggzbrwsxonrnb'

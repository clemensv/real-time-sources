...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../digitraffic_maritime_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../digitraffic_maritime_amqp_producer_amqp_producer/src')))
...
class TestFiDigitrafficMarineAisAmqpProducer:
    """Test cases for FiDigitrafficMarineAisAmqpProducer"""
...
class TestFiDigitrafficMarinePortcallAmqpProducer:
    """Test cases for FiDigitrafficMarinePortcallAmqpProducer"""
...
class TestFiDigitrafficMarinePortcallVesseldetailsAmqpProducer:
    """Test cases for FiDigitrafficMarinePortcallVesseldetailsAmqpProducer"""
...
class TestFiDigitrafficMarinePortcallPortlocationAmqpProducer:
    """Test cases for FiDigitrafficMarinePortcallPortlocationAmqpProducer"""

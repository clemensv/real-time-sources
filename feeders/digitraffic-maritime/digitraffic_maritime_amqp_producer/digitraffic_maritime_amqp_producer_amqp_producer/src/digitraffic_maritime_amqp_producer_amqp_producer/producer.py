...
class FiDigitrafficMarineAisAmqpProducer:
    """
    Producer class to send messages in the `fi.digitraffic.marine.ais.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_location(self,
        ...
        """
        Send the `fi.digitraffic.marine.ais.amqp.location` message
        ...
        annotations = {}
        annotation_value = "{mmsi}".format(mmsi=_mmsi)
    ...
    def send_location_batch(self,
        data_array: typing.List[VesselLocation],
        _mmsi: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.digitraffic.marine.ais.amqp.location` messages
    ...
    def send_metadata(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.digitraffic.marine.ais.amqp.metadata` message
    ...
    def send_metadata_batch(self,
        data_array: typing.List[VesselMetadata],
        _mmsi: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.digitraffic.marine.ais.amqp.metadata` messages
        
        Args:
            data_array (typing.List[VesselMetadata]): Array of message data objects
            _mmsi (str): Value for placeholder mmsi in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            content_type (str): The content type of the message data
        """
...
class FiDigitrafficMarinePortcallAmqpProducer:
    """
    Producer class to send messages in the `fi.digitraffic.marine.portcall.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_port_call(self,
        data: PortCall,
        _port_call_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.digitraffic.marine.portcall.amqp.port_call` message
        ...
        attributes = {
            ...
            "subject":
            "{port_call_id}".format(port_call_id=_port_call_id),
        }
        attributes["time"] = _resolve_cloudevents_time(_time, attributes.get("time"))
        ...
        if amqp_creation_time is not None:
            amqp_msg.creation_time = amqp_creation_time
        # Apply AMQP message properties declared in protocoloptions.properties.
        amqp_msg.subject = "{port_call_id}".format(port_call_id=_port_call_id)
        ...
        annotations = {}
        annotation_value = "{port_call_id}".format(port_call_id=_port_call_id)
        annotation_value = str(annotation_value)[:128]
        annotations[symbol("x-opt-partition-key")] = annotation_value
        if annotations:
            if amqp_msg.annotations is None:
    ...
    def send_port_call_batch(self,
        data_array: typing.List[PortCall],
        _port_call_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.digitraffic.marine.portcall.amqp.port_call` messages
        
        Args:
            data_array (typing.List[PortCall]): Array of message data objects
            _port_call_id (str): Value for placeholder port_call_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            content_type (str): The content type of the message data
        """
...
class FiDigitrafficMarinePortcallVesseldetailsAmqpProducer:
    """
    Producer class to send messages in the `fi.digitraffic.marine.portcall.vesseldetails.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_vessel_details(self,
        data: VesselDetails,
        _vessel_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.digitraffic.marine.portcall.vesseldetails.amqp.vessel_details` message
    ...
    def send_vessel_details_batch(self,
        data_array: typing.List[VesselDetails],
        _vessel_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.digitraffic.marine.portcall.vesseldetails.amqp.vessel_details` messages
        
        Args:
            data_array (typing.List[VesselDetails]): Array of message data objects
            _vessel_id (str): Value for placeholder vessel_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            content_type (str): The content type of the message data
        """
        for data in data_array:
            self.send_vessel_details(
                data=data,
...
class FiDigitrafficMarinePortcallPortlocationAmqpProducer:
    """
    Producer class to send messages in the `fi.digitraffic.marine.portcall.portlocation.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_port_location(self,
        data: PortLocation,
        _locode: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send the `fi.digitraffic.marine.portcall.portlocation.amqp.port_location` message
        ...
        if amqp_creation_time is not None:
            amqp_msg.creation_time = amqp_creation_time
        # Apply AMQP message properties declared in protocoloptions.properties.
        amqp_msg.subject = "{locode}".format(locode=_locode)
        ...
        annotations = {}
        annotation_value = "{locode}".format(locode=_locode)
        annotation_value = str(annotation_value)[:128]
        annotations[symbol("x-opt-partition-key")] = annotation_value
        if annotations:
            if amqp_msg.annotations is None:
    ...
    def send_port_location_batch(self,
        data_array: typing.List[PortLocation],
        _locode: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `fi.digitraffic.marine.portcall.portlocation.amqp.port_location` messages
        
        Args:
            data_array (typing.List[PortLocation]): Array of message data objects
            _locode (str): Value for placeholder locode in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            content_type (str): The content type of the message data
        """
        for data in data_array:
            self.send_port_location(
                data=data,
                _locode=_locode,
                _time=_time,
                content_type=content_type)

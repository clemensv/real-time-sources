...
class FiDigitrafficMarineAisEventProducer:
    ...
    def send_fi_digitraffic_marine_ais_vessel_location(self,_mmsi : str, data: VesselLocation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, VesselLocation], str]=None) -> None:
        """
    ...
    def send_fi_digitraffic_marine_ais_vessel_metadata(self,_mmsi : str, data: VesselMetadata, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, VesselMetadata], str]=None) -> None:
        """
...
class FiDigitrafficMarinePortcallEventProducer:
    ...
    def send_fi_digitraffic_marine_portcall_port_call(self,_port_call_id : str, data: PortCall, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, PortCall], str]=None) -> None:
        """
...
class FiDigitrafficMarinePortcallVesseldetailsEventProducer:
    ...
    def send_fi_digitraffic_marine_portcall_vessel_details(self,_vessel_id : str, data: VesselDetails, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, VesselDetails], str]=None) -> None:
        """
...
class FiDigitrafficMarinePortcallPortlocationEventProducer:
    ...
    def send_fi_digitraffic_marine_portcall_port_location(self,_locode : str, data: PortLocation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, PortLocation], str]=None) -> None:
        """

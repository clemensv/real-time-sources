...
class Test_VesselMetadata(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = VesselMetadata(
            mmsi=int(97),
            timestamp=int(39),
            name='gmxtmcweeglkfbnzhihc',
            callSign='nvobifvvlnyscxzvckvs',
            imo=int(54),
            type=int(65),
            draught=int(14),
            eta=int(77),
            destination='plskvhqelulenzmystbj',
            posType=int(86),
            refA=int(75),
            refB=int(48),
            refC=int(68),
    ...
    def test_name_property(self):
        ...
        Test name property
        """
        test_value = 'gmxtmcweeglkfbnzhihc'
    ...
    def test_callSign_property(self):
        ...
        """
        test_value = 'nvobifvvlnyscxzvckvs'
    ...
    def test_destination_property(self):
        ...
        """
        test_value = 'plskvhqelulenzmystbj'

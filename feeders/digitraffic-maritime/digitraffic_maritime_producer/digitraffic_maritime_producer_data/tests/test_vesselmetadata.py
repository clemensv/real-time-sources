...
class Test_VesselMetadata(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = VesselMetadata(
            mmsi=int(12),
            timestamp=int(34),
            name='qegoxwbbsswhxwbojunb',
            callSign='lmaazqrptahsnyrtohlg',
            imo=int(93),
            type=int(89),
            draught=int(73),
            eta=int(61),
            destination='rppjfqhxabcudtpgrxqs',
            posType=int(33),
            refA=int(23),
            refB=int(82),
            refC=int(81),
    ...
    def test_name_property(self):
        ...
        Test name property
        """
        test_value = 'qegoxwbbsswhxwbojunb'
    ...
    def test_callSign_property(self):
        ...
        """
        test_value = 'lmaazqrptahsnyrtohlg'
    ...
    def test_destination_property(self):
        ...
        """
        test_value = 'rppjfqhxabcudtpgrxqs'

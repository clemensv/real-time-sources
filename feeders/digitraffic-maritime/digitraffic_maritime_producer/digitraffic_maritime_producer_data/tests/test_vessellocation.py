...
class Test_VesselLocation(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = VesselLocation(
            mmsi=int(28),
            time=int(60),
            sog=float(69.86871802911892),
            cog=float(6.587862734216654),
            navStat=int(9),
            rot=int(99),
            posAcc=True,
            raim=True,
            heading=int(73),
            lon=float(14.610102842900973),
            lat=float(66.522277526447)
        )
        return instance
    ...
    def test_sog_property(self):
        ...
        Test sog property
        """
        test_value = float(69.86871802911892)
    ...
    def test_cog_property(self):
        ...
        Test cog property
        """
        test_value = float(6.587862734216654)
    ...
    def test_lon_property(self):
        ...
        Test lon property
        """
        test_value = float(14.610102842900973)
    ...
    def test_lat_property(self):
        ...
        Test lat property
        """
        test_value = float(66.522277526447)

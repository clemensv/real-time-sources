...
"""
Sample usage of nextbus_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send Amqp message
        print("Sending Amqp message...")
        # TODO: Create a RouteConfig instance with actual data
        # data = RouteConfig(...)
        # producer.send_amqp(
        #     data=data,
        #     content_type="application/json"
        ...
        # Send Amqp message
        print("Sending Amqp message...")
        # TODO: Create a Schedule instance with actual data
        # data = Schedule(...)
        # producer.send_amqp(
        #     data=data,
        #     content_type="application/json"
        ...
        # Send Amqp message
        print("Sending Amqp message...")
        # TODO: Create a Message instance with actual data
        # data = Message(...)
        # producer.send_amqp(
        #     data=data,
        #     content_type="application/json"

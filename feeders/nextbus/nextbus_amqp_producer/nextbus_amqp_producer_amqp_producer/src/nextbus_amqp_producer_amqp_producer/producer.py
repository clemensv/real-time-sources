...
class NextbusAmqpProducer:
    """
    Producer class to send messages in the `nextbus.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_amqp_batch(self,
        ...
        Args:
            data_array (typing.List[RouteConfig]): Array of message data objects
            _agency_id (str): Value for placeholder agency_id in attribute subject
            _route_tag (str): Value for placeholder route_tag in attribute subject
            _stop_or_vehicle_id (str): Value for placeholder stop_or_vehicle_id in attribute subject
            content_type (str): The content type of the message data
    ...
    def send_amqp_batch(self,
        ...
        Args:
            data_array (typing.List[Schedule]): Array of message data objects
            _agency_id (str): Value for placeholder agency_id in attribute subject
            _route_tag (str): Value for placeholder route_tag in attribute subject
            _stop_or_vehicle_id (str): Value for placeholder stop_or_vehicle_id in attribute subject
            content_type (str): The content type of the message data
    ...
    def send_amqp_batch(self,
        ...
        Args:
            data_array (typing.List[Message]): Array of message data objects
            _agency_id (str): Value for placeholder agency_id in attribute subject
            _route_tag (str): Value for placeholder route_tag in attribute subject
            _stop_or_vehicle_id (str): Value for placeholder stop_or_vehicle_id in attribute subject
            content_type (str): The content type of the message data

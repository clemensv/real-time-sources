...
# Nextbus_producer Kafka Producer# Nextbus_producer Event Dispatcher for Apache Kafka
...
- `data`: Message data of type `RouteConfig`
...
await producer.send_nextbus_kafka_route_config_batch(```
    ...
    messages=[
        ...
        RouteConfig(...),Initializes the runner with a Kafka consumer.
...
- `data`: Message data of type `Schedule`
...
await producer.send_nextbus_kafka_schedule_batch(```
    ...
    messages=[
        ...
        Schedule(...),Initializes the runner with a Kafka consumer.
...
- `data`: Message data of type `Message`
...
await producer.send_nextbus_kafka_message_batch(```
    ...
    messages=[
        ...
        Message(...),Initializes the runner with a Kafka consumer.

...
class ComFientaAmqpProducer:
    """
    Producer class to send messages in the `Com.Fienta.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_event(self,
        ...
        """
        Send the `Com.Fienta.amqp.Event` message
        ...
        attributes = {
            ...
            "Com.Fienta.Event",
            "source":
            "https://fienta.com/api/v1/public/events",
            "subject":
    ...
    def send_event_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `Com.Fienta.amqp.Event` messages
    ...
    def send_event_sale_status(self,
        data: EventSaleStatus,
        _event_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send the `Com.Fienta.amqp.EventSaleStatus` message
    ...
    def send_event_sale_status_batch(self,
        data_array: typing.List[EventSaleStatus],
        _event_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `Com.Fienta.amqp.EventSaleStatus` messages
        
        Args:
            data_array (typing.List[EventSaleStatus]): Array of message data objects
            _event_id (str): Value for placeholder event_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            content_type (str): The content type of the message data
        """
        for data in data_array:
            self.send_event_sale_status(
                data=data,
                _event_id=_event_id,
                _time=_time,
                content_type=content_type)

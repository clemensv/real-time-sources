...
class MicrosoftOpenDataUSNOAANWSForecastsAmqpProducer:
    """
    Producer class to send messages in the `Microsoft.OpenData.US.NOAA.NWS.Forecasts.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_amqp(self,
        ...
        """
        Send the `Microsoft.OpenData.US.NOAA.NWS.Forecasts.ForecastZone.amqp` message
        ...
        Args:
            ...
            data (ForecastZone): The message data object
        ...
        attributes = {
            ...
            "subject":
            "{zone_id}".format(zone_id=_zone_id),
        }
        ...
        amqp_msg.subject = "{zone_id}".format(zone_id=_zone_id)
    ...
    def send_amqp_batch(self,
        data_array: typing.List[ForecastZone],
        _zone_id: str,
        _state: str,
        _zone_type: str,
        _event: str,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `Microsoft.OpenData.US.NOAA.NWS.Forecasts.ForecastZone.amqp` messages
        
        Args:
            data_array (typing.List[ForecastZone]): Array of message data objects
            _zone_id (str): Value for placeholder zone_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            _state (str): Value for AMQP protocol option placeholder state
            _zone_type (str): Value for AMQP protocol option placeholder zone_type
    ...
    def send_amqp(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `Microsoft.OpenData.US.NOAA.NWS.Forecasts.LandZoneForecast.amqp` message
        ...
        Args:
            ...
            _event (str): Value for AMQP protocol option placeholder event
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            data (LandZoneForecast): The message data object
            content_type (str): The content type of the message data (default: 'application/json')
        """
        # Build CloudEvent attributes
        attributes = {
    ...
    def send_amqp_batch(self,
        data_array: typing.List[LandZoneForecast],
        _zone_id: str,
        _state: str,
        _zone_type: str,
        _event: str,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `Microsoft.OpenData.US.NOAA.NWS.Forecasts.LandZoneForecast.amqp` messages
        
        Args:
            data_array (typing.List[LandZoneForecast]): Array of message data objects
            _zone_id (str): Value for placeholder zone_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            _state (str): Value for AMQP protocol option placeholder state
            _zone_type (str): Value for AMQP protocol option placeholder zone_type
    ...
    def send_amqp(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `Microsoft.OpenData.US.NOAA.NWS.Forecasts.MarineZoneForecast.amqp` message
        ...
        Args:
            ...
            _event (str): Value for AMQP protocol option placeholder event
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            data (MarineZoneForecast): The message data object
            content_type (str): The content type of the message data (default: 'application/json')
        """
        # Build CloudEvent attributes
        attributes = {
            ...
            "source":
            "https://tgftp.nws.noaa.gov/data/forecasts/marine/coastal/pz/",
            "subject":
            "{zone_id}".format(zone_id=_zone_id),
        }
        attributes["time"] = _resolve_cloudevents_time(_time, attributes.get("time"))
    ...
    def send_amqp_batch(self,
        data_array: typing.List[MarineZoneForecast],
        _zone_id: str,
        _state: str,
        _zone_type: str,
        _event: str,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `Microsoft.OpenData.US.NOAA.NWS.Forecasts.MarineZoneForecast.amqp` messages
        
        Args:
            data_array (typing.List[MarineZoneForecast]): Array of message data objects
            _zone_id (str): Value for placeholder zone_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            _state (str): Value for AMQP protocol option placeholder state
            _zone_type (str): Value for AMQP protocol option placeholder zone_type

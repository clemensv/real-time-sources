...
"""
Sample usage of nws_forecasts_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # TODO: Create a ForecastZone instance with actual data
        # data = ForecastZone(...)
        # producer.send_amqp(
        #     data=data,
        ...
        # Send Amqp message
        print("Sending Amqp message...")
        # TODO: Create a LandZoneForecast instance with actual data
        ...
        # Send Amqp message
        print("Sending Amqp message...")
        # TODO: Create a MarineZoneForecast instance with actual data

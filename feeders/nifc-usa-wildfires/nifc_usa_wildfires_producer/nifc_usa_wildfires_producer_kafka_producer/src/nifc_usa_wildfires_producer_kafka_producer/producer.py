...
class GovNIFCWildfiresEventProducer:
    ...
    def send_gov_nifc_wildfires_wildfire_incident(self,_source_uri : str, _irwin_id : str, data: WildfireIncident, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, WildfireIncident], str]=None) -> None:
        """

...
"""
Sample usage of uk_ea_flood_monitoring_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        print("Sending Reading message...")
        # TODO: Create a Reading instance with actual data
        # data = Reading(...)
        # producer.send_reading(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("Reading message sent successfully!")

...
class Reading:
    """
    Payload record for reading events in the UK Environment Agency Flood Monitoring source.
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'Reading':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['Reading']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return Reading.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'Reading':
        """
        ...
        """
        return cls(
            station_reference='xpjxplpqkmjgfxvxntup',
            date_time=datetime.datetime.now(datetime.timezone.utc),
            measure='pcdulvdprwkdqooakzfn',
            value=float(19.428753510165354),
            river='aukhzofzyjgjzbcluwwa'
        )
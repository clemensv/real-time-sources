...
class Test_TrafficFlowReading(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = TrafficFlowReading(
            flow_data_id='pmfzzekbkqdbkgdeoidf',
            station_name='zovarslkbcfrstfbjbru',
            region=RegionEnum.Eastern,
            flow_reading=FlowReadingenum.Unknown,
            reading_time='pvnjcokwxwapnunvqaru'
        )
        return instance
    ...
    def test_flow_data_id_property(self):
        ...
        """
        test_value = 'pmfzzekbkqdbkgdeoidf'
    ...
    def test_station_name_property(self):
        ...
        """
        test_value = 'zovarslkbcfrstfbjbru'
    ...
    def test_reading_time_property(self):
        ...
        """
        test_value = 'pvnjcokwxwapnunvqaru'

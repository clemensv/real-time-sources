...
class WSDOTApi:
    ...
    def parse_cv_restriction(raw: Dict[str, Any]) -> CommercialVehicleRestriction:
        ...
        return CommercialVehicleRestriction(
            ...
            restriction_type=str(raw["RestrictionType"]) if raw.get("RestrictionType") is not None else None,
            vehicle_type=str(raw["VehicleType"]) if raw.get("VehicleType") is not None else None,

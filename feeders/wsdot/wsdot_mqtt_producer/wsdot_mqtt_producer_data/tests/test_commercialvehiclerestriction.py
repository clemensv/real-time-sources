...
class Test_CommercialVehicleRestriction(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = CommercialVehicleRestriction(
            state_route_id='yrxdqriydgmnjpgwfijp',
            bridge_number='bzivrrxzmswbsltktmlu',
            bridge_name='rvkbrhyviwzleoexwlni',
            location_name='efzugqimozauiygwuyvt',
            location_description='rxhcmelmtamgvoolqkhq',
            latitude=float(58.83388770194073),
            longitude=float(55.29704524825828),
            state='dhdsyfwpsbsqvrxvdlug',
            restriction_type='ftkkrfcwqnrqdbiwbego',
            vehicle_type='pcvdstscropitwsoobod',
            restriction_weight_in_pounds=int(5),
            maximum_gross_vehicle_weight_in_pounds=int(84),
            restriction_height_in_inches=int(1),
            restriction_width_in_inches=int(54),
            restriction_length_in_inches=int(99),
            is_permanent_restriction=True,
            is_warning=False,
            is_detour_available=True,
            is_exceptions_allowed=False,
            restriction_comment='wwpygdjeomhbmmrbfpvc',
            date_posted='neemymlnxxkfzmnolfho',
            date_effective='veraxysvzgfkhcnunbyq',
            date_expires='bvxgqoqdcbrremkvawpu'
        )
        return instance
    ...
    def test_state_route_id_property(self):
        ...
        """
        test_value = 'yrxdqriydgmnjpgwfijp'
    ...
    def test_bridge_number_property(self):
        ...
        """
        test_value = 'bzivrrxzmswbsltktmlu'
    ...
    def test_bridge_name_property(self):
        ...
        """
        test_value = 'rvkbrhyviwzleoexwlni'
    ...
    def test_location_name_property(self):
        ...
        """
        test_value = 'efzugqimozauiygwuyvt'
    ...
    def test_location_description_property(self):
        ...
        """
        test_value = 'rxhcmelmtamgvoolqkhq'
    ...
    def test_latitude_property(self):
        ...
        """
        test_value = float(58.83388770194073)
    ...
    def test_longitude_property(self):
        ...
        """
        test_value = float(55.29704524825828)
    ...
    def test_state_property(self):
        ...
        Test state property
        """
        test_value = 'dhdsyfwpsbsqvrxvdlug'
    ...
    def test_restriction_type_property(self):
        ...
        """
        test_value = 'ftkkrfcwqnrqdbiwbego'
    ...
    def test_vehicle_type_property(self):
        ...
        """
        test_value = 'pcvdstscropitwsoobod'
    ...
    def test_restriction_comment_property(self):
        ...
        """
        test_value = 'wwpygdjeomhbmmrbfpvc'
    ...
    def test_date_posted_property(self):
        ...
        """
        test_value = 'neemymlnxxkfzmnolfho'
    ...
    def test_date_effective_property(self):
        ...
        """
        test_value = 'veraxysvzgfkhcnunbyq'
    ...
    def test_date_expires_property(self):
        ...
        """
        test_value = 'bvxgqoqdcbrremkvawpu'

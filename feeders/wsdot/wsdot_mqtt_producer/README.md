# Wsdot_mqtt_producer MQTT Client

This library provides MQTT producer and consumer functionality for the wsdot_mqtt_producer message definitions.

# Wsdot_mqtt_producer Event Dispatcher for Azure Event Hubs
...
```    - UsWaWsdotTrafficMqttEventDispatcher,

    UsWaWsdotTraveltimesMqttEventDispatcher,

    UsWaWsdotMountainpassMqttEventDispatcher,

    UsWaWsdotWeatherMqttEventDispatcher,

    UsWaWsdotTollsMqttEventDispatcher,

    UsWaWsdotCvrestrictionsMqttEventDispatcher,
...
from wsdot_mqtt_producer_mqtt_client import *This module defines an event processing framework for Azure Event Hubs,
...
client = UsWaWsdotTrafficMqttMqttClient(mqtt_client, content_mode='structured')

# Connect to broker

await client.connect("mqtt.example.com", 1883)### UsWaWsdotTrafficMqttEventDispatcher



# Publish message`UsWaWsdotTrafficMqttEventDispatcher` handles events for the us.wa.wsdot.traffic.mqtt message group.
...
## BuildThe UsWaWsdotTrafficMqttEventDispatcher defines the following event handler hooks.
...
```##### `us_wa_wsdot_traffic_traffic_flow_station_mqtt_async`



## Test```python

us_wa_wsdot_traffic_traffic_flow_station_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent,
...
```Asynchronous handler hook for `us.wa.wsdot.traffic.TrafficFlowStation.mqtt`: Metadata for a traffic flow sensor
station in the Washington State DOT network. WSDOT deploys approximately 1,400 inductive loop sensors embedded in
highway pavement across four geographic regions.
...
- `data`: The event data of type `wsdot_mqtt_producer_data.TrafficFlowStation`.

Example:

```python
async def us_wa_wsdot_traffic_traffic_flow_station_mqtt_event(partition_context: PartitionContext, event: EventData,
cloud_event: CloudEvent, data: TrafficFlowStation) -> None:
...
```python
us_wa_wsdot_traffic_mqtt_dispatcher.us_wa_wsdot_traffic_traffic_flow_station_mqtt_async =
us_wa_wsdot_traffic_traffic_flow_station_mqtt_event
```
...
```##### `us_wa_wsdot_traffic_traffic_flow_reading_mqtt_async`



## Test```python

us_wa_wsdot_traffic_traffic_flow_reading_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent,
...
```Asynchronous handler hook for `us.wa.wsdot.traffic.TrafficFlowReading.mqtt`: A traffic flow reading from a WSDOT
sensor station. Updated approximately every 90 seconds, each reading reports the current Level of Service.
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `wsdot_mqtt_producer_data.TrafficFlowReading`.

Example:

```python
async def us_wa_wsdot_traffic_traffic_flow_reading_mqtt_event(partition_context: PartitionContext, event: EventData,
cloud_event: CloudEvent, data: TrafficFlowReading) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```python
us_wa_wsdot_traffic_mqtt_dispatcher.us_wa_wsdot_traffic_traffic_flow_reading_mqtt_async =
us_wa_wsdot_traffic_traffic_flow_reading_mqtt_event
```


## Generated Event Dispatchers

client = UsWaWsdotTraveltimesMqttMqttClient(mqtt_client, content_mode='structured')

# Connect to broker

await client.connect("mqtt.example.com", 1883)### UsWaWsdotTraveltimesMqttEventDispatcher



# Publish message`UsWaWsdotTraveltimesMqttEventDispatcher` handles events for the us.wa.wsdot.traveltimes.mqtt message
group.
...
## BuildThe UsWaWsdotTraveltimesMqttEventDispatcher defines the following event handler hooks.
...
```##### `us_wa_wsdot_traveltimes_travel_time_route_mqtt_async`



## Test```python

us_wa_wsdot_traveltimes_travel_time_route_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent,
...
```Asynchronous handler hook for `us.wa.wsdot.traveltimes.TravelTimeRoute.mqtt`: A named travel time route monitored by
WSDOT. Each route has fixed start and end points on Washington State highways with historical average and current real-
time travel times.
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `wsdot_mqtt_producer_data.TravelTimeRoute`.

Example:

```python
async def us_wa_wsdot_traveltimes_travel_time_route_mqtt_event(partition_context: PartitionContext, event: EventData,
cloud_event: CloudEvent, data: TravelTimeRoute) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```python
us_wa_wsdot_traveltimes_mqtt_dispatcher.us_wa_wsdot_traveltimes_travel_time_route_mqtt_async =
us_wa_wsdot_traveltimes_travel_time_route_mqtt_event
```


## Generated Event Dispatchers

client = UsWaWsdotMountainpassMqttMqttClient(mqtt_client, content_mode='structured')

# Connect to broker

await client.connect("mqtt.example.com", 1883)### UsWaWsdotMountainpassMqttEventDispatcher



# Publish message`UsWaWsdotMountainpassMqttEventDispatcher` handles events for the us.wa.wsdot.mountainpass.mqtt message
group.
...
## BuildThe UsWaWsdotMountainpassMqttEventDispatcher defines the following event handler hooks.
...
```##### `us_wa_wsdot_mountainpass_mountain_pass_condition_mqtt_async`



## Test```python

us_wa_wsdot_mountainpass_mountain_pass_condition_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent,
MountainPassCondition], Awaitable[None]]

```bash```

make test

```Asynchronous handler hook for `us.wa.wsdot.mountainpass.MountainPassCondition.mqtt`: Current conditions at a
Washington State mountain pass including temperature, weather, road conditions, travel advisories, and directional
restrictions.
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `wsdot_mqtt_producer_data.MountainPassCondition`.

Example:

```python
async def us_wa_wsdot_mountainpass_mountain_pass_condition_mqtt_event(partition_context: PartitionContext, event:
EventData, cloud_event: CloudEvent, data: MountainPassCondition) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```python
us_wa_wsdot_mountainpass_mqtt_dispatcher.us_wa_wsdot_mountainpass_mountain_pass_condition_mqtt_async =
us_wa_wsdot_mountainpass_mountain_pass_condition_mqtt_event
```


## Generated Event Dispatchers

client = UsWaWsdotWeatherMqttMqttClient(mqtt_client, content_mode='structured')

# Connect to broker

await client.connect("mqtt.example.com", 1883)### UsWaWsdotWeatherMqttEventDispatcher



# Publish message`UsWaWsdotWeatherMqttEventDispatcher` handles events for the us.wa.wsdot.weather.mqtt message group.
...
## BuildThe UsWaWsdotWeatherMqttEventDispatcher defines the following event handler hooks.
...
```##### `us_wa_wsdot_weather_weather_station_mqtt_async`



## Test```python

us_wa_wsdot_weather_weather_station_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent, WeatherStation],
Awaitable[None]]
...
```Asynchronous handler hook for `us.wa.wsdot.weather.WeatherStation.mqtt`: Metadata for a WSDOT road weather
information system (RWIS) station. WSDOT operates approximately 134 stations across Washington State highways.
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `wsdot_mqtt_producer_data.WeatherStation`.

Example:

```python
async def us_wa_wsdot_weather_weather_station_mqtt_event(partition_context: PartitionContext, event: EventData,
cloud_event: CloudEvent, data: WeatherStation) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```python
us_wa_wsdot_weather_mqtt_dispatcher.us_wa_wsdot_weather_weather_station_mqtt_async =
us_wa_wsdot_weather_weather_station_mqtt_event
```
...
```##### `us_wa_wsdot_weather_weather_reading_mqtt_async`



## Test```python

us_wa_wsdot_weather_weather_reading_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent, WeatherReading],
Awaitable[None]]
...
```Asynchronous handler hook for `us.wa.wsdot.weather.WeatherReading.mqtt`: A current weather reading from a WSDOT road
weather station including temperature, wind, precipitation, pressure, humidity, visibility, and sky coverage.
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `wsdot_mqtt_producer_data.WeatherReading`.

Example:

```python
async def us_wa_wsdot_weather_weather_reading_mqtt_event(partition_context: PartitionContext, event: EventData,
cloud_event: CloudEvent, data: WeatherReading) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```python
us_wa_wsdot_weather_mqtt_dispatcher.us_wa_wsdot_weather_weather_reading_mqtt_async =
us_wa_wsdot_weather_weather_reading_mqtt_event
```


## Generated Event Dispatchers

client = UsWaWsdotTollsMqttMqttClient(mqtt_client, content_mode='structured')

# Connect to broker

await client.connect("mqtt.example.com", 1883)### UsWaWsdotTollsMqttEventDispatcher



# Publish message`UsWaWsdotTollsMqttEventDispatcher` handles events for the us.wa.wsdot.tolls.mqtt message group.
...
## BuildThe UsWaWsdotTollsMqttEventDispatcher defines the following event handler hooks.
...
```##### `us_wa_wsdot_tolls_toll_rate_mqtt_async`



## Test```python

us_wa_wsdot_tolls_toll_rate_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent, TollRate], Awaitable[None]]

```bash```

make test

```Asynchronous handler hook for `us.wa.wsdot.tolls.TollRate.mqtt`: Current toll rate for a WSDOT tolled route segment.
WSDOT operates dynamic tolling on SR 99, I-405, and SR 167.
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `wsdot_mqtt_producer_data.TollRate`.

Example:

```python
async def us_wa_wsdot_tolls_toll_rate_mqtt_event(partition_context: PartitionContext, event: EventData, cloud_event:
CloudEvent, data: TollRate) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```python
us_wa_wsdot_tolls_mqtt_dispatcher.us_wa_wsdot_tolls_toll_rate_mqtt_async = us_wa_wsdot_tolls_toll_rate_mqtt_event
```


## Generated Event Dispatchers

client = UsWaWsdotCvrestrictionsMqttMqttClient(mqtt_client, content_mode='structured')

# Connect to broker

await client.connect("mqtt.example.com", 1883)### UsWaWsdotCvrestrictionsMqttEventDispatcher



# Publish message`UsWaWsdotCvrestrictionsMqttEventDispatcher` handles events for the us.wa.wsdot.cvrestrictions.mqtt
message group.
...
## BuildThe UsWaWsdotCvrestrictionsMqttEventDispatcher defines the following event handler hooks.
...
```##### `us_wa_wsdot_cvrestrictions_commercial_vehicle_restriction_mqtt_async`



## Test```python

us_wa_wsdot_cvrestrictions_commercial_vehicle_restriction_mqtt_async:  Callable[[PartitionContext, EventData,
CloudEvent, CommercialVehicleRestriction], Awaitable[None]]

```bash```

make test

```Asynchronous handler hook for `us.wa.wsdot.cvrestrictions.CommercialVehicleRestriction.mqtt`: A commercial vehicle
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `wsdot_mqtt_producer_data.CommercialVehicleRestriction`.

Example:

```python
async def us_wa_wsdot_cvrestrictions_commercial_vehicle_restriction_mqtt_event(partition_context: PartitionContext,
event: EventData, cloud_event: CloudEvent, data: CommercialVehicleRestriction) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```python
us_wa_wsdot_cvrestrictions_mqtt_dispatcher.us_wa_wsdot_cvrestrictions_commercial_vehicle_restriction_mqtt_async =
us_wa_wsdot_cvrestrictions_commercial_vehicle_restriction_mqtt_event
```


## Generated Event Dispatchers

client = UsWaWsdotBorderMqttMqttClient(mqtt_client, content_mode='structured')

# Connect to broker

await client.connect("mqtt.example.com", 1883)### UsWaWsdotBorderMqttEventDispatcher



# Publish message`UsWaWsdotBorderMqttEventDispatcher` handles events for the us.wa.wsdot.border.mqtt message group.
...
## BuildThe UsWaWsdotBorderMqttEventDispatcher defines the following event handler hooks.
...
```##### `us_wa_wsdot_border_border_crossing_mqtt_async`



## Test```python

us_wa_wsdot_border_border_crossing_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent, BorderCrossing],
Awaitable[None]]
...
```Asynchronous handler hook for `us.wa.wsdot.border.BorderCrossing.mqtt`: Current wait time at a US-Canada border
crossing lane in Washington State. Wait times are in minutes, updated approximately every 5 minutes.
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `wsdot_mqtt_producer_data.BorderCrossing`.

Example:

```python
async def us_wa_wsdot_border_border_crossing_mqtt_event(partition_context: PartitionContext, event: EventData,
cloud_event: CloudEvent, data: BorderCrossing) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```python
us_wa_wsdot_border_mqtt_dispatcher.us_wa_wsdot_border_border_crossing_mqtt_async =
us_wa_wsdot_border_border_crossing_mqtt_event
```


## Generated Event Dispatchers

client = UsWaWsdotFerriesMqttMqttClient(mqtt_client, content_mode='structured')

# Connect to broker

await client.connect("mqtt.example.com", 1883)### UsWaWsdotFerriesMqttEventDispatcher



# Publish message`UsWaWsdotFerriesMqttEventDispatcher` handles events for the us.wa.wsdot.ferries.mqtt message group.
...
## BuildThe UsWaWsdotFerriesMqttEventDispatcher defines the following event handler hooks.
...
```##### `us_wa_wsdot_ferries_vessel_location_mqtt_async`



## Test```python

us_wa_wsdot_ferries_vessel_location_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent, VesselLocation],
Awaitable[None]]
...
```Asynchronous handler hook for `us.wa.wsdot.ferries.VesselLocation.mqtt`: Real-time location and status of a
Washington State Ferries vessel. WSF operates approximately 21 vessels across Puget Sound routes.
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `wsdot_mqtt_producer_data.VesselLocation`.

Example:

```python
async def us_wa_wsdot_ferries_vessel_location_mqtt_event(partition_context: PartitionContext, event: EventData,
cloud_event: CloudEvent, data: VesselLocation) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```

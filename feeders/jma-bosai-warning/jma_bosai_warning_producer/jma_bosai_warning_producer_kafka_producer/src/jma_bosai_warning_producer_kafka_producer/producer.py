...
class JPJMAWarningEventProducer:
    ...
    def send_jp_jma_warning_office(self,_feedurl : str, _office_code : str, _area_code : str, data: Office, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Office], str]=None) -> None:
        ...
        """
        kafka_key = "jp.jma.warning/{office_code}/{area_code}".format(office_code=_office_code, area_code=_area_code)
        attributes = {
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'JPJMAWarningEventProducer':
        """
...
class JPJMATsunamiEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    def send_jp_jma_tsunami_tsunami_alert(self,_feedurl : str, _event_id : str, _serial : str, data: TsunamiAlert, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, TsunamiAlert], str]=None) -> None:
        ...
        """
        kafka_key = "jp.jma.tsunami/{event_id}/{serial}".format(event_id=_event_id, serial=_serial)
        attributes = {
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'JPJMATsunamiEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.
...
class JPJMAWarningAmqpEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'JPJMAWarningAmqpEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.

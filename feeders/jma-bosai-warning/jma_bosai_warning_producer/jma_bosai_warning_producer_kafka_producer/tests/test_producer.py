...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../jma_bosai_warning_producer_data/src')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../jma_bosai_warning_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../jma_bosai_warning_producer_kafka_producer/src')))
...
def test_jp_jma_warning_jpjmawarningoffice(kafka_emulator):
    """Test the JPJMAWarningOffice event from the JP.JMA.Warning message group"""
    ...
    consumer = Consumer({
        ...
        'group.id': 'test_jp_jma_warning_jpjmawarningoffice',  # Unique group per test
    ...
    producer_instance = JPJMAWarningEventProducer(kafka_producer, topic, 'binary')
    ...
    for i in range(5):
        ...
        expected_key = "jp.jma.warning/{office_code}/{area_code}".format(office_code=f'test_{i}', area_code=f'test_{i}')
        assert received_key == expected_key, f"Expected Kafka key '{expected_key}' but got '{received_key}'"
    consumer.close()


def test_jp_jma_warning_jpjmawarningweatherwarning(kafka_emulator):
    """Test the JPJMAWarningWeatherWarning event from the JP.JMA.Warning message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_jp_jma_warning_jpjmawarningweatherwarning',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_jp_jma_tsunami_jpjmatsunamitsunamialert(kafka_emulator):
    """Test the JPJMATsunamiTsunamiAlert event from the JP.JMA.Tsunami message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_jp_jma_tsunami_jpjmatsunamitsunamialert',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
    ...
    kafka_producer = Producer({'bootstrap.servers': bootstrap_servers})
    producer_instance = JPJMATsunamiEventProducer(kafka_producer, topic, 'binary')
    # Create valid test data using the test helper
    event_data = Test_TsunamiAlert.create_instance()
...
def test_jp_jma_warning_mqtt_jpjmawarningmqtttsunamialert(kafka_emulator):
    """Test the JPJMAWarningMqttTsunamiAlert event from the JP.JMA.Warning.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_jp_jma_warning_mqtt_jpjmawarningmqtttsunamialert',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_jp_jma_warning_amqp_jpjmawarningamqpoffice(kafka_emulator):
    """Test the JPJMAWarningAmqpOffice event from the JP.JMA.Warning.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_jp_jma_warning_amqp_jpjmawarningamqpoffice',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
    ...
    kafka_producer = Producer({'bootstrap.servers': bootstrap_servers})
    producer_instance = JPJMAWarningAmqpEventProducer(kafka_producer, topic, 'binary')
    # Create valid test data using the test helper
    event_data = Test_Office.create_instance()
...
def test_jp_jma_warning_amqp_jpjmawarningamqpweatherwarning(kafka_emulator):
    """Test the JPJMAWarningAmqpWeatherWarning event from the JP.JMA.Warning.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_jp_jma_warning_amqp_jpjmawarningamqpweatherwarning',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_jp_jma_warning_amqp_jpjmawarningamqptsunamialert(kafka_emulator):
    """Test the JPJMAWarningAmqpTsunamiAlert event from the JP.JMA.Warning.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_jp_jma_warning_amqp_jpjmawarningamqptsunamialert',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_jp_jma_warning_cross_event_type_kafka_key(kafka_emulator):
    """Test that different event types in JP.JMA.Warning produce the same Kafka key for the same placeholder values"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_jp_jma_warning_cross_key',
    ...
    data1 = Test_Office.create_instance()
    data2 = Test_WeatherWarning.create_instance()

    producer_instance.send_jp_jma_warning_office(_feedurl = shared_key_value, _office_code = shared_key_value, _area_code = shared_key_value, data = data1)
    producer_instance.send_jp_jma_warning_weather_warning(_feedurl = shared_key_value, _office_code = shared_key_value, _area_code = shared_key_value, data = data2)
    kafka_producer.flush(timeout=5.0)
    ...
    while len(collected_keys) < 2 and time.time() < timeout:
        ...
        if msg is None or msg.error():
            continue
        cloudevent = parse_cloudevent(msg)
        if cloudevent['type'] in ["JP.JMA.Warning.Office", "JP.JMA.Warning.WeatherWarning"]:
    ...
    expected_key = "jp.jma.warning/{office_code}/{area_code}".format(office_code=shared_key_value, area_code=shared_key_value)

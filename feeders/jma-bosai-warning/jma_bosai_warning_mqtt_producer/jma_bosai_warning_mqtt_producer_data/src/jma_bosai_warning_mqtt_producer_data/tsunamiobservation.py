...
import json
from jma_bosai_warning_mqtt_producer_data.arrivalstatusenum import ArrivalStatusenum
import datetime
...
class TsunamiObservation:
    ...
    def create_instance(cls) -> 'TsunamiObservation':
        ...
        """
        return cls(
            station_code='ytnifvejrmmuysesddsi',
            station_name_jp='ijnkxovqqzgefxfqsivj',
            station_name_en='uiwxozxybmsunchjqump',
            observed_max_wave_height_m=float(54.62996837200815),

...
from jma_bosai_warning_amqp_producer_data.tsunamialert import TsunamiAlert
...
class Test_TsunamiAlert(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = TsunamiAlert(
            ...
            title_jp='fajvbafzdfmpylcmpuvw',
            title_en='qmjtzecfpiacselymsim',
            bulletin_type='fbaskteuoixsizigkvep',
            detail_url='rtojhezbpjfxavhtirna',
            affected_coastal_regions=[None],
            observations=[None, None, None, None, None],
            prefecture='zvkifrzwbfbeacgypqxm',
    ...
    def test_event_id_property(self):
        ...
        """
        test_value = 'jddicnnpanrsvjzjmzfy'
    ...
    def test_title_jp_property(self):
        ...
        """
        test_value = 'fajvbafzdfmpylcmpuvw'
    ...
    def test_title_en_property(self):
        ...
        """
        test_value = 'qmjtzecfpiacselymsim'
    ...
    def test_bulletin_type_property(self):
        ...
        """
        test_value = 'fbaskteuoixsizigkvep'
    ...
    def test_detail_url_property(self):
        ...
        """
        test_value = 'rtojhezbpjfxavhtirna'
    ...
    def test_prefecture_property(self):
        ...
        """
        test_value = 'zvkifrzwbfbeacgypqxm'

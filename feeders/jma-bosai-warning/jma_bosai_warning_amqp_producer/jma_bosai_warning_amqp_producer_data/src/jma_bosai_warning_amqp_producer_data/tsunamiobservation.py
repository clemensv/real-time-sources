...
import json
from jma_bosai_warning_amqp_producer_data.arrivalstatusenum import ArrivalStatusenum
import datetime
...
class TsunamiObservation:
    ...
    Attributes:
        station_code (typing.Optional[str])
        station_name_jp (str)
    ...
    station_code: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="station_code"))
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'TsunamiObservation':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['TsunamiObservation']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return TsunamiObservation.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'TsunamiObservation':
        """
        ...
        """
        return cls(
            station_code='kazrwyxunwbmnnpbblzc',
            station_name_jp='vyiwuabuvbrbgimmlagf',
            station_name_en='bksvfwnzlqxjzehlodki',
            observed_max_wave_height_m=float(26.902626645073312),

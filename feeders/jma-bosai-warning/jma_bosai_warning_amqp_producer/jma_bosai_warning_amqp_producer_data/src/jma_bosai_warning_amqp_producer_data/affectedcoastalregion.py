...
import json
from jma_bosai_warning_amqp_producer_data.categoryenum import CategoryEnum
import datetime
...
class AffectedCoastalRegion:
    ...
    def create_instance(cls) -> 'AffectedCoastalRegion':
        ...
        """
        return cls(
            code='eaintbtzzczltkmbgliw',
            name='ldonoqmrnrpysfvymfki',
            category=CategoryEnum.MAJOR_WARNING,
            expected_max_wave_height_m=float(76.20097384319429),

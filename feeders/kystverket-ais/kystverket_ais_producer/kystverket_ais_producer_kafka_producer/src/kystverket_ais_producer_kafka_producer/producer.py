...
class NOKystverketAISEventProducer:
    ...
    def send_no_kystverket_ais_position_report_class_a(self,_mmsi : str, data: PositionReportClassA, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, PositionReportClassA], str]=None) -> None:
        """
    ...
    def send_no_kystverket_ais_static_voyage_data(self,_mmsi : str, data: StaticVoyageData, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, StaticVoyageData], str]=None) -> None:
        """
    ...
    def send_no_kystverket_ais_position_report_class_b(self,_mmsi : str, data: PositionReportClassB, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, PositionReportClassB], str]=None) -> None:
        """
    ...
    def send_no_kystverket_ais_static_data_class_b(self,_mmsi : str, data: StaticDataClassB, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, StaticDataClassB], str]=None) -> None:
        """
    ...
    def send_no_kystverket_ais_aid_to_navigation(self,_mmsi : str, data: AidToNavigation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, AidToNavigation], str]=None) -> None:
        """
    ...
    def send_no_kystverket_ais_position_report(self,_mmsi : str, data: PositionReport, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, PositionReport], str]=None) -> None:
        """
    ...
    def send_no_kystverket_ais_ship_static(self,_mmsi : str, data: ShipStatic, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, ShipStatic], str]=None) -> None:
        """
...
class NOKystverketAISMqttEventProducer:
    ...
    def send_no_kystverket_ais_mqtt_position_report(self,_mmsi : str, data: PositionReport, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, PositionReport], str]=None) -> None:
        """
    ...
    def send_no_kystverket_ais_mqtt_ship_static(self,_mmsi : str, data: ShipStatic, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, ShipStatic], str]=None) -> None:
        """
    ...
    def send_no_kystverket_ais_mqtt_aid_to_navigation(self,_mmsi : str, data: AidToNavigation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, AidToNavigation], str]=None) -> None:
        """

...
from test_kystverket_ais_producer_data_positionreportclassa import Test_PositionReportClassA
from kystverket_ais_producer_data import StaticVoyageData
from test_kystverket_ais_producer_data_staticvoyagedata import Test_StaticVoyageData
from kystverket_ais_producer_data import PositionReportClassB
from test_kystverket_ais_producer_data_positionreportclassb import Test_PositionReportClassB
from kystverket_ais_producer_data import StaticDataClassB
from test_kystverket_ais_producer_data_staticdataclassb import Test_StaticDataClassB
from kystverket_ais_producer_data import AidToNavigation
from test_kystverket_ais_producer_data_aidtonavigation import Test_AidToNavigation
from kystverket_ais_producer_data import PositionReport
from test_kystverket_ais_producer_data_positionreport import Test_PositionReport
from kystverket_ais_producer_data import ShipStatic
from test_kystverket_ais_producer_data_shipstatic import Test_ShipStatic
...
def test_no_kystverket_ais_nokystverketaispositionreport(kafka_emulator):
    ...
    # Send 5 messages to test message settlement and ordering
    for i in range(5):
        producer_instance.send_no_kystverket_ais_position_report(_mmsi = f'test_{i}', data = event_data)
...
def test_no_kystverket_ais_nokystverketaisshipstatic(kafka_emulator):
    ...
    # Send 5 messages to test message settlement and ordering
    for i in range(5):
        producer_instance.send_no_kystverket_ais_ship_static(_mmsi = f'test_{i}', data = event_data)
...
def test_no_kystverket_ais_mqtt_nokystverketaismqttpositionreport(kafka_emulator):
    ...
    # Send 5 messages to test message settlement and ordering
    for i in range(5):
        producer_instance.send_no_kystverket_ais_mqtt_position_report(_mmsi = f'test_{i}', data = event_data)
...
def test_no_kystverket_ais_mqtt_nokystverketaismqttshipstatic(kafka_emulator):
    ...
    # Send 5 messages to test message settlement and ordering
    for i in range(5):
        producer_instance.send_no_kystverket_ais_mqtt_ship_static(_mmsi = f'test_{i}', data = event_data)
...
def test_no_kystverket_ais_mqtt_nokystverketaismqttaidtonavigation(kafka_emulator):
    ...
    # Send 5 messages to test message settlement and ordering
    for i in range(5):
        producer_instance.send_no_kystverket_ais_mqtt_aid_to_navigation(_mmsi = f'test_{i}', data = event_data)

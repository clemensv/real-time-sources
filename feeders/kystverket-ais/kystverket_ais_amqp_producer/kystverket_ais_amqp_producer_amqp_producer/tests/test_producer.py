...
"""
Tests for kystverket_ais_amqp_producer_amqp_producer
"""
import base64
import json
import os
...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../kystverket_ais_amqp_producer_data/src')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../kystverket_ais_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../kystverket_ais_amqp_producer_amqp_producer/src')))

from kystverket_ais_amqp_producer_amqp_producer import *
from kystverket_ais_amqp_producer_data import PositionReport
from test_kystverket_ais_amqp_producer_data_positionreport import Test_PositionReport
from kystverket_ais_amqp_producer_data import ShipStatic
from test_kystverket_ais_amqp_producer_data_shipstatic import Test_ShipStatic
from kystverket_ais_amqp_producer_data import AidToNavigation
from test_kystverket_ais_amqp_producer_data_aidtonavigation import Test_AidToNavigation
...
class TestNOKystverketAISAmqpProducer:
    """Test cases for NOKystverketAISAmqpProducer"""

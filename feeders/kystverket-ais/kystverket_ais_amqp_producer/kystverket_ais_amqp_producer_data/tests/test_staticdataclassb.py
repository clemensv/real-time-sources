...
from kystverket_ais_amqp_producer_data.staticdataclassb import StaticDataClassB
...
class Test_StaticDataClassB(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = StaticDataClassB(
            mmsi=int(74),
            part_number=int(11),
            ship_name='hzvtycchwyltssjfmlvp',
            ship_type=int(91),
            callsign='lcargpaoalnovfjinicc',
            dimension_to_bow=int(96),
            dimension_to_stern=int(89),
            dimension_to_port=int(68),
            dimension_to_starboard=int(73),
            timestamp='iwapvjolnmgxwaavjwem',
            station_id='ksnelizeepfisbygjgvr'
        )
        return instance
    ...
    def test_ship_name_property(self):
        ...
        """
        test_value = 'hzvtycchwyltssjfmlvp'
    ...
    def test_callsign_property(self):
        ...
        """
        test_value = 'lcargpaoalnovfjinicc'
    ...
    def test_timestamp_property(self):
        ...
        """
        test_value = 'iwapvjolnmgxwaavjwem'
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'ksnelizeepfisbygjgvr'

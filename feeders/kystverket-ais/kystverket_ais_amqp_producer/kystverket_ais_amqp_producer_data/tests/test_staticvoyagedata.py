...
from kystverket_ais_amqp_producer_data.staticvoyagedata import StaticVoyageData
...
class Test_StaticVoyageData(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = StaticVoyageData(
            mmsi=int(42),
            imo_number=int(52),
            callsign='idulsudbjfyhwoicbgkp',
            ship_name='vfmskbcdcxstldngnmze',
            ship_type=int(46),
            dimension_to_bow=int(98),
            dimension_to_stern=int(33),
            dimension_to_port=int(42),
            dimension_to_starboard=int(10),
            draught=float(94.47988015512328),
            destination='vnmvucwnquodtsccmndd',
            eta_month=int(71),
            eta_day=int(71),
            eta_hour=int(82),
            eta_minute=int(100),
            timestamp='frhbppvstlabwmvwnpfc',
            station_id='xpdmbyrzlxqglubolftc'
        )
        return instance
    ...
    def test_callsign_property(self):
        ...
        """
        test_value = 'idulsudbjfyhwoicbgkp'
    ...
    def test_ship_name_property(self):
        ...
        """
        test_value = 'vfmskbcdcxstldngnmze'
    ...
    def test_draught_property(self):
        ...
        """
        test_value = float(94.47988015512328)
    ...
    def test_destination_property(self):
        ...
        """
        test_value = 'vnmvucwnquodtsccmndd'
    ...
    def test_timestamp_property(self):
        ...
        """
        test_value = 'frhbppvstlabwmvwnpfc'
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'xpdmbyrzlxqglubolftc'

...
class PositionReportClassB:
    ...
    @classmethod
    def create_instance(cls) -> 'PositionReportClassB':
        """
        ...
        return cls(
            mmsi=int(69),
            speed_over_ground=float(79.23942350934558),
            position_accuracy=int(80),
            longitude=float(45.27944679705607),
            latitude=float(67.7994166906775),
            course_over_ground=float(7.8411208328741715),
            true_heading=int(67),
            timestamp='edlwkqxrdyrepglgmgzb',
            station_id='qncqqpeswlsjdhpvftzj',
            msg_type=int(47)
        )
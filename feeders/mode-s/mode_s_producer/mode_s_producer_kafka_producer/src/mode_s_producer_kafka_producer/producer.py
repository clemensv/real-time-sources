...
class ModeSKafkaEventProducer:
    ...
    def send_mode_s_kafka_adsb(self,_feedurl : str, _icao24 : str, _receiver_id : str, data: Record, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Record], str]=None) -> None:
        ...
        """
        kafka_key = "{icao24}/{receiver_id}".format(icao24=_icao24, receiver_id=_receiver_id)
        attributes = {
             "specversion":"1.0",
             "type":"Mode_S.ADSB",
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'ModeSKafkaEventProducer':
        """

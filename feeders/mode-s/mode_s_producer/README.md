...
# Mode_s_producer Kafka Producer# Mode_s_producer Event Dispatcher for Apache Kafka
...
3. [Quick Start](#quick-start)    - ModeSKafkaEventDispatcher
...
- ModeSKafkaProducersolution for event-driven applications.
...
- **Scales horizontally** across multiple brokers and partitions### ModeSKafkaEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`ModeSKafkaEventDispatcher` handles events for the Mode_S.kafka message group.
...
from mode_s_producer import ModeSKafkaProducer```python

create_processor(self, bootstrap_servers: str, group_id: str, topics: List[str]) -> EventProcessorRunner

# Create producer```

producer = ModeSKafkaProducer(
...
await producer.send_mode_s_kafka_adsb(```python
...
The ModeSKafkaEventDispatcher defines the following event handler hooks.
...
producer = ModeSKafkaProducer(
    ...
    security_protocol='SASL_SSL',##### `mode_s_kafka_adsb_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'mode_s_kafka_adsb_async:  Callable[[ConsumerRecord, CloudEvent, Record],
Awaitable[None]]
...
Asynchronous handler hook for `Mode_S.kafka.ADSB`:
...
### ModeSKafkaProducer- `data`: The event data of type `mode_s_producer_data.Record`.



Producer for `Mode_S.kafka` message group.Example:



#### Constructor```python

async def mode_s_kafka_adsb_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Record) -> None:

```python    # Process the event data

ModeSKafkaProducer(    await some_processing_function(record, cloud_event, data)
...
mode_s_kafka_dispatcher.mode_s_kafka_adsb_async = mode_s_kafka_adsb_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `mode_s_kafka_altitude_reply_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'mode_s_kafka_altitude_reply_async:  Callable[[ConsumerRecord, CloudEvent, Record],
Awaitable[None]]
...
Asynchronous handler hook for `Mode_S.kafka.AltitudeReply`:
...
async def mode_s_kafka_altitude_reply_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Record) -> None:
...
mode_s_kafka_dispatcher.mode_s_kafka_altitude_reply_async = mode_s_kafka_altitude_reply_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `mode_s_kafka_identity_reply_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'mode_s_kafka_identity_reply_async:  Callable[[ConsumerRecord, CloudEvent, Record],
Awaitable[None]]
...
Asynchronous handler hook for `Mode_S.kafka.IdentityReply`:
...
async def mode_s_kafka_identity_reply_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Record) -> None:
...
mode_s_kafka_dispatcher.mode_s_kafka_identity_reply_async = mode_s_kafka_identity_reply_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `mode_s_kafka_acquisition_reply_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'mode_s_kafka_acquisition_reply_async:  Callable[[ConsumerRecord, CloudEvent, Record],
Awaitable[None]]
...
Asynchronous handler hook for `Mode_S.kafka.AcquisitionReply`:
...
async def mode_s_kafka_acquisition_reply_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Record) -> None:
...
mode_s_kafka_dispatcher.mode_s_kafka_acquisition_reply_async = mode_s_kafka_acquisition_reply_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `mode_s_kafka_comm_baltitude_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'mode_s_kafka_comm_baltitude_async:  Callable[[ConsumerRecord, CloudEvent, Record],
Awaitable[None]]
...
Asynchronous handler hook for `Mode_S.kafka.CommBAltitude`:
...
async def mode_s_kafka_comm_baltitude_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Record) -> None:
...
mode_s_kafka_dispatcher.mode_s_kafka_comm_baltitude_async = mode_s_kafka_comm_baltitude_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `mode_s_kafka_comm_bidentity_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'mode_s_kafka_comm_bidentity_async:  Callable[[ConsumerRecord, CloudEvent, Record],
Awaitable[None]]
...
Asynchronous handler hook for `Mode_S.kafka.CommBIdentity`:
...
async def mode_s_kafka_comm_bidentity_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Record) -> None:
...
mode_s_kafka_dispatcher.mode_s_kafka_comm_bidentity_async = mode_s_kafka_comm_bidentity_event
...
##### `send_mode_s_kafka_adsb`Dispatchers have the following protected methods:



```python### Methods:

async def send_mode_s_kafka_adsb(
...
Send a single `Mode_S.kafka.ADSB` message.Args:
...
await producer.send_mode_s_kafka_adsb(
...
##### `send_mode_s_kafka_adsb_batch`##### `_dispatch_record`



```python```python

async def send_mode_s_kafka_adsb_batch(_dispatch_record(self, record)
...
Send multiple `Mode_S.kafka.ADSB` messages in a batch.
...
await producer.send_mode_s_kafka_adsb_batch(```
...
##### `send_mode_s_kafka_altitude_reply`Dispatchers have the following protected methods:



```python### Methods:

async def send_mode_s_kafka_altitude_reply(
...
Send a single `Mode_S.kafka.AltitudeReply` message.Args:
...
await producer.send_mode_s_kafka_altitude_reply(
...
##### `send_mode_s_kafka_altitude_reply_batch`##### `_dispatch_record`



```python```python

async def send_mode_s_kafka_altitude_reply_batch(_dispatch_record(self, record)
...
Send multiple `Mode_S.kafka.AltitudeReply` messages in a batch.
...
await producer.send_mode_s_kafka_altitude_reply_batch(```
...
##### `send_mode_s_kafka_identity_reply`Dispatchers have the following protected methods:



```python### Methods:

async def send_mode_s_kafka_identity_reply(
...
Send a single `Mode_S.kafka.IdentityReply` message.Args:
...
await producer.send_mode_s_kafka_identity_reply(
...
##### `send_mode_s_kafka_identity_reply_batch`##### `_dispatch_record`



```python```python

async def send_mode_s_kafka_identity_reply_batch(_dispatch_record(self, record)
...
Send multiple `Mode_S.kafka.IdentityReply` messages in a batch.
...
await producer.send_mode_s_kafka_identity_reply_batch(```
...
##### `send_mode_s_kafka_acquisition_reply`Dispatchers have the following protected methods:



```python### Methods:

async def send_mode_s_kafka_acquisition_reply(
...
Send a single `Mode_S.kafka.AcquisitionReply` message.Args:
...
await producer.send_mode_s_kafka_acquisition_reply(
...
##### `send_mode_s_kafka_acquisition_reply_batch`##### `_dispatch_record`



```python```python

async def send_mode_s_kafka_acquisition_reply_batch(_dispatch_record(self, record)
...
Send multiple `Mode_S.kafka.AcquisitionReply` messages in a batch.
...
await producer.send_mode_s_kafka_acquisition_reply_batch(```
...
##### `send_mode_s_kafka_comm_baltitude`Dispatchers have the following protected methods:



```python### Methods:

async def send_mode_s_kafka_comm_baltitude(
...
Send a single `Mode_S.kafka.CommBAltitude` message.Args:
...
await producer.send_mode_s_kafka_comm_baltitude(
...
##### `send_mode_s_kafka_comm_baltitude_batch`##### `_dispatch_record`



```python```python

async def send_mode_s_kafka_comm_baltitude_batch(_dispatch_record(self, record)
...
Send multiple `Mode_S.kafka.CommBAltitude` messages in a batch.
...
await producer.send_mode_s_kafka_comm_baltitude_batch(```
...
##### `send_mode_s_kafka_comm_bidentity`Dispatchers have the following protected methods:



```python### Methods:

async def send_mode_s_kafka_comm_bidentity(
...
Send a single `Mode_S.kafka.CommBIdentity` message.Args:
...
await producer.send_mode_s_kafka_comm_bidentity(
...
##### `send_mode_s_kafka_comm_bidentity_batch`##### `_dispatch_record`



```python```python

async def send_mode_s_kafka_comm_bidentity_batch(_dispatch_record(self, record)
...
Send multiple `Mode_S.kafka.CommBIdentity` messages in a batch.
...
await producer.send_mode_s_kafka_comm_bidentity_batch(```

...
class ModeSAmqpProducer:
    """
    Producer class to send messages in the `Mode_S.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_adsb(self,
        ...
        amqp_msg.subject = "{icao24}/{receiver_id}".format(icao24=_icao24, receiver_id=_receiver_id)

        app_properties = {}
        app_properties["msg_type"] = "{msg_type}".format(msg_type=_msg_type)
        if app_properties:
    ...
    def send_adsb_batch(self,
        ...
        Args:
            data_array (typing.List[Record]): Array of message data objects
            _feedurl (str): Value for placeholder feedurl in attribute source
            _icao24 (str): Value for placeholder icao24 in attribute subject
            _receiver_id (str): Value for placeholder receiver_id in attribute subject
            _msg_type (str): Value for AMQP protocol option placeholder msg_type
    ...
    def send_acquisition_reply(self,
        data: Record,
        _feedurl: str,
        _icao24: str,
        _receiver_id: str,

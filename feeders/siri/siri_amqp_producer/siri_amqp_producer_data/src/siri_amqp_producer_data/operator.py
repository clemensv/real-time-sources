...
class Operator:
    """
    Reference payload for a distinct operator code observed in a configured SIRI feed. The bridge emits these records so telemetry consumers can keep operator identity in-stream instead of consulting a separate registry out of band.
    ...
    def create_instance(cls) -> 'Operator':
        ...
        """
        return cls(
            operator_ref='mxzfipcibnmowapklfgy'
        )
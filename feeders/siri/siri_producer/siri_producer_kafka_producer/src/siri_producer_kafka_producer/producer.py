...
class OrgSiriKafkaEventProducer:
    ...
    def send_org_siri_kafka_vehicle_position(self,_feedurl : str, _operator_ref : str, _vehicle_ref : str, data: VehiclePosition, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, VehiclePosition], str]=None) -> None:
        """
        Sends the 'org.siri.kafka.VehiclePosition' event to the Kafka topic
    ...
    def send_org_siri_kafka_operator(self,_feedurl : str, _operator_ref : str, data: Operator, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Operator], str]=None) -> None:
        """
        Sends the 'org.siri.kafka.Operator' event to the Kafka topic
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'OrgSiriKafkaEventProducer':
        """

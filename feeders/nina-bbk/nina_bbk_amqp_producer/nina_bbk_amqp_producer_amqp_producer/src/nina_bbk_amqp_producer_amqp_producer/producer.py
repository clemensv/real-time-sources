...
class NINAWarningsAmqpProducer:
    """
    Producer class to send messages in the `NINA.Warnings.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_civil_warning(self,
        ...
        """
        Send the `NINA.Warnings.amqp.CivilWarning` message
        ...
        attributes = {
            ...
            "subject":
            "{warning_id}".format(warning_id=_warning_id),
        }
        ...
        amqp_msg.subject = "{warning_id}".format(warning_id=_warning_id)
        ...
        annotations = {}
        annotation_value = "{warning_id}".format(warning_id=_warning_id)
    ...
    def send_civil_warning_batch(self,
        data_array: typing.List[CivilWarning],
        _warning_id: str,
        _state: str,
        _severity: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `NINA.Warnings.amqp.CivilWarning` messages
        
        Args:
            data_array (typing.List[CivilWarning]): Array of message data objects
            _warning_id (str): Value for placeholder warning_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            _state (str): Value for AMQP protocol option placeholder state
            _severity (str): Value for AMQP protocol option placeholder severity

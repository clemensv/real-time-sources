...
class Webcam:
    ...
    def __post_init__(self):
        ...
        self.operator_name=str(self.operator_name) if self.operator_name else None
        self.image_url=str(self.image_url) if self.image_url else None
        self.stream_url=str(self.stream_url) if self.stream_url else None

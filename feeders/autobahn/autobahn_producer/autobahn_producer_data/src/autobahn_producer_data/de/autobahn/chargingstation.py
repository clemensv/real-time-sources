...
class ChargingStation:
    ...
    def __post_init__(self):
        ...
        self.address_line=str(self.address_line) if self.address_line else None
        self.charging_point_count=int(self.charging_point_count) if self.charging_point_count else None
        self.charging_points_json=str(self.charging_points_json) if self.charging_points_json else None

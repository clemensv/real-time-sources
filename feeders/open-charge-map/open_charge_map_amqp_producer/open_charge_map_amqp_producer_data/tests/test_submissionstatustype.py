...
from open_charge_map_amqp_producer_data.io.openchargemap.submissionstatustype import SubmissionStatusType
...
class Test_SubmissionStatusType(unittest.TestCase):
    ...
    def test_reference_type_property(self):
        ...
        """
        test_value = 'srhrmmenasvjaurlsnvn'
    ...
    def test_title_property(self):
        ...
        Test title property
        """
        test_value = 'pmzwebfstwveadqcfusx'

...
from open_charge_map_amqp_producer_data.io.openchargemap.connectiontype import ConnectionType
...
class Test_ConnectionType(unittest.TestCase):
    ...
    def test_reference_type_property(self):
        ...
        """
        test_value = 'thjwlrgkwtqjpmaxtjkt'
    ...
    def test_title_property(self):
        ...
        Test title property
        """
        test_value = 'bluumihizdwhllypmxth'
    ...
    def test_formal_name_property(self):
        ...
        """
        test_value = 'qjxvrvhyoqjeqvpbrejd'

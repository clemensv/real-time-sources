...
"""
Tests for gbfs_bikeshare_amqp_producer_amqp_producer
"""
import base64
import datetime
import json
...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../gbfs_bikeshare_amqp_producer_data/src')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../gbfs_bikeshare_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../gbfs_bikeshare_amqp_producer_amqp_producer/src')))
...
class TestOrgGbfsAmqpSystemProducer:
    """Test cases for OrgGbfsAmqpSystemProducer"""
    ...
    def test_presettled_send_waits_for_queued_delivery_to_drain(self):
        ...
        producer = object.__new__(OrgGbfsAmqpSystemProducer)
    ...
    def test_send_system_information(self, artemis_container):
        """Send and receive a SystemInformation message via ActiveMQ Artemis."""
        # Create valid test data using the test helper
        payload = Test_SystemInformation.create_instance()
    ...
    def test_send_system_information_single_fresh_connection(self, artemis_container):
        """Send exactly one SystemInformation message on a fresh producer connection."""
        payload = Test_SystemInformation.create_instance()
...
class TestOrgGbfsAmqpStationsProducer:
    """Test cases for OrgGbfsAmqpStationsProducer"""
    ...
    def test_presettled_send_waits_for_queued_delivery_to_drain(self):
        ...
        fake_connection = FakeConnection()
        producer = object.__new__(OrgGbfsAmqpStationsProducer)
        producer._sender = fake_sender
        producer._connection = fake_connection
        producer._blocking_sender_is_presettled = True
    ...
    def test_send_station_information(self, artemis_container):
        """Send and receive a StationInformation message via ActiveMQ Artemis."""
        # Create valid test data using the test helper
        payload = Test_StationInformation.create_instance()
    ...
    def test_send_station_information_single_fresh_connection(self, artemis_container):
        """Send exactly one StationInformation message on a fresh producer connection."""
        payload = Test_StationInformation.create_instance()
    ...
    def test_send_station_status(self, artemis_container):
        """Send and receive a StationStatus message via ActiveMQ Artemis."""
        # Create valid test data using the test helper
        payload = Test_StationStatus.create_instance()
    ...
    def test_send_station_status_single_fresh_connection(self, artemis_container):
        """Send exactly one StationStatus message on a fresh producer connection."""
        payload = Test_StationStatus.create_instance()
...
class TestOrgGbfsAmqpFreeBikesProducer:
    """Test cases for OrgGbfsAmqpFreeBikesProducer"""
    ...
    def test_presettled_send_waits_for_queued_delivery_to_drain(self):
        ...
        fake_connection = FakeConnection()
        producer = object.__new__(OrgGbfsAmqpFreeBikesProducer)
        producer._sender = fake_sender
        producer._connection = fake_connection
        producer._blocking_sender_is_presettled = True
    ...
    def test_send_free_bike_status(self, artemis_container):
        """Send and receive a FreeBikeStatus message via ActiveMQ Artemis."""
        # Create valid test data using the test helper
        payload = Test_FreeBikeStatus.create_instance()
    ...
    def test_send_free_bike_status_single_fresh_connection(self, artemis_container):
        """Send exactly one FreeBikeStatus message on a fresh producer connection."""
        payload = Test_FreeBikeStatus.create_instance()

...
class MicrosoftOpenDataUSNOAANDBCAmqpProducer:
    """
    Producer class to send messages in the `Microsoft.OpenData.US.NOAA.NDBC.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_buoy_observation(self,
    ...
    def send_buoy_solar_radiation_observation(self,
    ...
    def send_buoy_oceanographic_observation(self,
    ...
    def send_buoy_dart_measurement(self,
    ...
    def send_buoy_continuous_wind_observation(self,
    ...
    def send_buoy_supplemental_measurement(self,
    ...
    def send_buoy_detailed_wave_summary(self,
    ...
    def send_buoy_hourly_rain_measurement(self,

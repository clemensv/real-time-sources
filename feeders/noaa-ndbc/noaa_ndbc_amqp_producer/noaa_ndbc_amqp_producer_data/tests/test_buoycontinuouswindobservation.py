...
class Test_BuoyContinuousWindObservation(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = BuoyContinuousWindObservation(
            station_id='hkcvtpypfwayjxsqeokr',
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            wind_direction=float(34.72270325359889),
            wind_speed=float(41.728084204862256),
            gust_direction=float(3.023765652086674),
            gust=float(96.93981149236315),
            gust_time_code='uaiwotmraeiwzgyuasig',
            region='owmueisdtujzyfpsrxyo'
        )
        return instance
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'hkcvtpypfwayjxsqeokr'
    ...
    def test_wind_direction_property(self):
        ...
        """
        test_value = float(34.72270325359889)
    ...
    def test_wind_speed_property(self):
        ...
        """
        test_value = float(41.728084204862256)
    ...
    def test_gust_direction_property(self):
        ...
        """
        test_value = float(3.023765652086674)
    ...
    def test_gust_property(self):
        ...
        Test gust property
        """
        test_value = float(96.93981149236315)
    ...
    def test_gust_time_code_property(self):
        ...
        """
        test_value = 'uaiwotmraeiwzgyuasig'
    ...
    def test_region_property(self):
        ...
        """
        test_value = 'owmueisdtujzyfpsrxyo'

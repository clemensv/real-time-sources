...
class Test_BuoyOceanographicObservation(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = BuoyOceanographicObservation(
            station_id='ueasbagoguxiowweotrz',
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            depth=float(63.25923687895922),
            ocean_temperature=float(43.57589717104361),
            conductivity=float(22.90412064223468),
            salinity=float(84.47452890052341),
            oxygen_saturation=float(33.70010187324344),
            oxygen_concentration=float(54.89617868227731),
            chlorophyll_concentration=float(29.719166323390812),
            turbidity=float(5.556731181282859),
            ph=float(92.74214334753222),
            redox_potential=float(2.8522807274415807),
            region='mrroetowkahqanwpdjkc'
        )
        return instance
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'ueasbagoguxiowweotrz'
    ...
    def test_depth_property(self):
        ...
        Test depth property
        """
        test_value = float(63.25923687895922)
    ...
    def test_ocean_temperature_property(self):
        ...
        """
        test_value = float(43.57589717104361)
    ...
    def test_conductivity_property(self):
        ...
        """
        test_value = float(22.90412064223468)
    ...
    def test_salinity_property(self):
        ...
        """
        test_value = float(84.47452890052341)
    ...
    def test_oxygen_saturation_property(self):
        ...
        """
        test_value = float(33.70010187324344)
    ...
    def test_oxygen_concentration_property(self):
        ...
        """
        test_value = float(54.89617868227731)
    ...
    def test_chlorophyll_concentration_property(self):
        ...
        """
        test_value = float(29.719166323390812)
    ...
    def test_turbidity_property(self):
        ...
        """
        test_value = float(5.556731181282859)
    ...
    def test_ph_property(self):
        ...
        Test ph property
        """
        test_value = float(92.74214334753222)
    ...
    def test_redox_potential_property(self):
        ...
        """
        test_value = float(2.8522807274415807)
    ...
    def test_region_property(self):
        ...
        """
        test_value = 'mrroetowkahqanwpdjkc'

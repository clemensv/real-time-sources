# Noaa_ndbc_mqtt_producer MQTT Client

This library provides MQTT producer and consumer functionality for the noaa_ndbc_mqtt_producer message definitions.

# Noaa_ndbc_mqtt_producer Event Dispatcher for Azure Event Hubs
...
```    - MicrosoftOpenDataUSNOAANDBCMqttEventDispatcher
...
from noaa_ndbc_mqtt_producer_mqtt_client import *This module defines an event processing framework for Azure Event Hubs,
...
client = MicrosoftOpenDataUSNOAANDBCMqttMqttClient(mqtt_client, content_mode='structured')

# Connect to broker

await client.connect("mqtt.example.com", 1883)### MicrosoftOpenDataUSNOAANDBCMqttEventDispatcher



# Publish message`MicrosoftOpenDataUSNOAANDBCMqttEventDispatcher` handles events for the
Microsoft.OpenData.US.NOAA.NDBC.mqtt message group.
...
from noaa_ndbc_mqtt_producer_mqtt_client import *create_processor(self, consumer_group_name: str,
...
client = MicrosoftOpenDataUSNOAANDBCMqttMqttClient(mqtt_client, content_mode='structured')- `eventhub_name`: The name of
...
## BuildThe MicrosoftOpenDataUSNOAANDBCMqttEventDispatcher defines the following event handler hooks.
...
```##### `microsoft_open_data_us_noaa_ndbc_mqtt_buoy_observation_async`



## Test```python

microsoft_open_data_us_noaa_ndbc_mqtt_buoy_observation_async:  Callable[[PartitionContext, EventData, CloudEvent,
BuoyObservation], Awaitable[None]]
...
- `data`: The event data of type `noaa_ndbc_mqtt_producer_data.BuoyObservation`.

Example:

```python
async def microsoft_open_data_us_noaa_ndbc_mqtt_buoy_observation_event(partition_context: PartitionContext, event:
EventData, cloud_event: CloudEvent, data: BuoyObservation) -> None:
...
```##### `microsoft_open_data_us_noaa_ndbc_mqtt_buoy_station_async`



## Test```python

microsoft_open_data_us_noaa_ndbc_mqtt_buoy_station_async:  Callable[[PartitionContext, EventData, CloudEvent,
BuoyStation], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `noaa_ndbc_mqtt_producer_data.BuoyStation`.

Example:

```python
async def microsoft_open_data_us_noaa_ndbc_mqtt_buoy_station_event(partition_context: PartitionContext, event:
EventData, cloud_event: CloudEvent, data: BuoyStation) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `microsoft_open_data_us_noaa_ndbc_mqtt_buoy_solar_radiation_observation_async`



## Test```python

microsoft_open_data_us_noaa_ndbc_mqtt_buoy_solar_radiation_observation_async:  Callable[[PartitionContext, EventData,
CloudEvent, BuoySolarRadiationObservation], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `noaa_ndbc_mqtt_producer_data.BuoySolarRadiationObservation`.

Example:

```python
async def microsoft_open_data_us_noaa_ndbc_mqtt_buoy_solar_radiation_observation_event(partition_context:
PartitionContext, event: EventData, cloud_event: CloudEvent, data: BuoySolarRadiationObservation) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `microsoft_open_data_us_noaa_ndbc_mqtt_buoy_oceanographic_observation_async`



## Test```python

microsoft_open_data_us_noaa_ndbc_mqtt_buoy_oceanographic_observation_async:  Callable[[PartitionContext, EventData,
CloudEvent, BuoyOceanographicObservation], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `noaa_ndbc_mqtt_producer_data.BuoyOceanographicObservation`.

Example:

```python
async def microsoft_open_data_us_noaa_ndbc_mqtt_buoy_oceanographic_observation_event(partition_context:
PartitionContext, event: EventData, cloud_event: CloudEvent, data: BuoyOceanographicObservation) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `microsoft_open_data_us_noaa_ndbc_mqtt_buoy_dart_measurement_async`



## Test```python

microsoft_open_data_us_noaa_ndbc_mqtt_buoy_dart_measurement_async:  Callable[[PartitionContext, EventData, CloudEvent,
BuoyDartMeasurement], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `noaa_ndbc_mqtt_producer_data.BuoyDartMeasurement`.

Example:

```python
async def microsoft_open_data_us_noaa_ndbc_mqtt_buoy_dart_measurement_event(partition_context: PartitionContext, event:
EventData, cloud_event: CloudEvent, data: BuoyDartMeasurement) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `microsoft_open_data_us_noaa_ndbc_mqtt_buoy_continuous_wind_observation_async`



## Test```python

microsoft_open_data_us_noaa_ndbc_mqtt_buoy_continuous_wind_observation_async:  Callable[[PartitionContext, EventData,
CloudEvent, BuoyContinuousWindObservation], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `noaa_ndbc_mqtt_producer_data.BuoyContinuousWindObservation`.

Example:

```python
async def microsoft_open_data_us_noaa_ndbc_mqtt_buoy_continuous_wind_observation_event(partition_context:
PartitionContext, event: EventData, cloud_event: CloudEvent, data: BuoyContinuousWindObservation) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `microsoft_open_data_us_noaa_ndbc_mqtt_buoy_supplemental_measurement_async`



## Test```python

microsoft_open_data_us_noaa_ndbc_mqtt_buoy_supplemental_measurement_async:  Callable[[PartitionContext, EventData,
CloudEvent, BuoySupplementalMeasurement], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `noaa_ndbc_mqtt_producer_data.BuoySupplementalMeasurement`.

Example:

```python
async def microsoft_open_data_us_noaa_ndbc_mqtt_buoy_supplemental_measurement_event(partition_context: PartitionContext,
event: EventData, cloud_event: CloudEvent, data: BuoySupplementalMeasurement) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `microsoft_open_data_us_noaa_ndbc_mqtt_buoy_detailed_wave_summary_async`



## Test```python

microsoft_open_data_us_noaa_ndbc_mqtt_buoy_detailed_wave_summary_async:  Callable[[PartitionContext, EventData,
CloudEvent, BuoyDetailedWaveSummary], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `noaa_ndbc_mqtt_producer_data.BuoyDetailedWaveSummary`.

Example:

```python
async def microsoft_open_data_us_noaa_ndbc_mqtt_buoy_detailed_wave_summary_event(partition_context: PartitionContext,
event: EventData, cloud_event: CloudEvent, data: BuoyDetailedWaveSummary) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `microsoft_open_data_us_noaa_ndbc_mqtt_buoy_hourly_rain_measurement_async`



## Test```python

microsoft_open_data_us_noaa_ndbc_mqtt_buoy_hourly_rain_measurement_async:  Callable[[PartitionContext, EventData,
CloudEvent, BuoyHourlyRainMeasurement], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `noaa_ndbc_mqtt_producer_data.BuoyHourlyRainMeasurement`.

Example:

```python
async def microsoft_open_data_us_noaa_ndbc_mqtt_buoy_hourly_rain_measurement_event(partition_context: PartitionContext,
event: EventData, cloud_event: CloudEvent, data: BuoyHourlyRainMeasurement) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```

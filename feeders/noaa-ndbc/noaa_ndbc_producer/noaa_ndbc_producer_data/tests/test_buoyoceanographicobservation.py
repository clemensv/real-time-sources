...
class Test_BuoyOceanographicObservation(unittest.TestCase):
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'onztuxhpikfqvuawjhdl'
    ...
    def test_depth_property(self):
        ...
        Test depth property
        """
        test_value = float(30.4339913797403)
    ...
    def test_ocean_temperature_property(self):
        ...
        """
        test_value = float(68.80153236717761)
    ...
    def test_conductivity_property(self):
        ...
        """
        test_value = float(20.257089938019533)
    ...
    def test_salinity_property(self):
        ...
        """
        test_value = float(14.19049389670498)
    ...
    def test_oxygen_saturation_property(self):
        ...
        """
        test_value = float(14.598649762531778)
    ...
    def test_oxygen_concentration_property(self):
        ...
        """
        test_value = float(37.50767647945443)
    ...
    def test_chlorophyll_concentration_property(self):
        ...
        """
        test_value = float(83.32628320179789)
    ...
    def test_turbidity_property(self):
        ...
        """
        test_value = float(40.662536551922436)
    ...
    def test_ph_property(self):
        ...
        Test ph property
        """
        test_value = float(20.236058102740184)
    ...
    def test_redox_potential_property(self):
        ...
        """
        test_value = float(58.58441304178831)
    ...
    def test_region_property(self):
        ...
        """
        test_value = 'kbxeqgmgiefhlkxmjoav'

...
class BuoySupplementalMeasurement:
    """
    Supplemental hourly extrema from the NDBC .supl realtime2 product.
    Attributes:
        station_id (str): 
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"BuoySupplementalMeasurement\", \"doc\": \"Supplemental hourly extrema from the NDBC .supl realtime2 product.\", \"fields\": [{\"name\": \"station_id\", \"type\": \"string\"}, {\"name\": \"timestamp\", \"type\": {\"type\": \"string\", \"logicalType\": \"timestamp-millis\"}}, {\"name\": \"lowest_pressure\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"lowest_pressure_time_code\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"highest_wind_speed\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"highest_wind_direction\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"highest_wind_time_code\", \"type\": [\"null\", \"string\"], \"default\": null}], \"namespace\": \"Microsoft.OpenData.US.NOAA.NDBC\"}"), avro.name.Names()
    )
    ...
    def __post_init__(self):
        ...
        self.lowest_pressure=float(self.lowest_pressure) if self.lowest_pressure else None
        self.lowest_pressure_time_code=str(self.lowest_pressure_time_code) if self.lowest_pressure_time_code else None
        self.highest_wind_speed=float(self.highest_wind_speed) if self.highest_wind_speed else None
        self.highest_wind_direction=float(self.highest_wind_direction) if self.highest_wind_direction else None
        self.highest_wind_time_code=str(self.highest_wind_time_code) if self.highest_wind_time_code else None

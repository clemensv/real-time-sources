...
class BuoyOceanographicObservation:
    """
    Oceanographic observation from the NDBC .ocean realtime2 product.
    Attributes:
        station_id (str): 
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"BuoyOceanographicObservation\", \"doc\": \"Oceanographic observation from the NDBC .ocean realtime2 product.\", \"fields\": [{\"name\": \"station_id\", \"type\": \"string\"}, {\"name\": \"timestamp\", \"type\": {\"type\": \"string\", \"logicalType\": \"timestamp-millis\"}}, {\"name\": \"depth\", \"type\": \"double\"}, {\"name\": \"ocean_temperature\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"conductivity\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"salinity\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"oxygen_saturation\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"oxygen_concentration\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"chlorophyll_concentration\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"turbidity\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"ph\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"redox_potential\", \"type\": [\"null\", \"double\"], \"default\": null}], \"namespace\": \"Microsoft.OpenData.US.NOAA.NDBC\"}"), avro.name.Names()
    )
    ...
    def __post_init__(self):
        ...
        self.ocean_temperature=float(self.ocean_temperature) if self.ocean_temperature else None
        self.conductivity=float(self.conductivity) if self.conductivity else None
        self.salinity=float(self.salinity) if self.salinity else None
        self.oxygen_saturation=float(self.oxygen_saturation) if self.oxygen_saturation else None
        self.oxygen_concentration=float(self.oxygen_concentration) if self.oxygen_concentration else None
        self.chlorophyll_concentration=float(self.chlorophyll_concentration) if self.chlorophyll_concentration else None
        self.turbidity=float(self.turbidity) if self.turbidity else None
        self.ph=float(self.ph) if self.ph else None
        self.redox_potential=float(self.redox_potential) if self.redox_potential else None

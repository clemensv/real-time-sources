...
from rws_waterwebservices_amqp_producer_data.waterlevelobservation import WaterLevelObservation
import datetime
...
class Test_WaterLevelObservation(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = WaterLevelObservation(
            station_code='ichehnijlrgxddcqcjsk',
            location_name='lgsjuqjmqbqxygpqjagi',
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            value=float(6.965824750330862),
            unit='anqdmgbjzgymggolxinn',
            quality_code='uqudbkxvhrbczxasjxpu',
            status='oqbowmgzmwkqjecppfbu',
            compartment='rpdgxjwvjpjtybcwwzxl',
            parameter='fkxqioyjruylbtabxqqi'
        )
        return instance
    ...
    def test_station_code_property(self):
        ...
        """
        test_value = 'ichehnijlrgxddcqcjsk'
    ...
    def test_location_name_property(self):
        ...
        """
        test_value = 'lgsjuqjmqbqxygpqjagi'
    ...
    def test_value_property(self):
        ...
        Test value property
        """
        test_value = float(6.965824750330862)
    ...
    def test_unit_property(self):
        ...
        Test unit property
        """
        test_value = 'anqdmgbjzgymggolxinn'
    ...
    def test_quality_code_property(self):
        ...
        """
        test_value = 'uqudbkxvhrbczxasjxpu'
    ...
    def test_status_property(self):
        ...
        """
        test_value = 'oqbowmgzmwkqjecppfbu'
    ...
    def test_compartment_property(self):
        ...
        """
        test_value = 'rpdgxjwvjpjtybcwwzxl'
    ...
    def test_parameter_property(self):
        ...
        """
        test_value = 'fkxqioyjruylbtabxqqi'

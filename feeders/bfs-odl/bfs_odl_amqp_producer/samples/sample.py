...
"""
Sample usage of bfs_odl_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send DoseRateMeasurement message
        print("Sending DoseRateMeasurement message...")
        # TODO: Create a DoseRateMeasurement instance with actual data
        # data = DoseRateMeasurement(...)
        # producer.send_dose_rate_measurement(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("DoseRateMeasurement message sent successfully!")

...
class FeedItemAuthor:
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"FeedItemAuthor\", \"namespace\": \"Microsoft.OpenData.RssFeeds\", \"doc\": \"Contains information about the author of the feed item.\", \"fields\": [{\"name\": \"name\", \"type\": [\"null\", \"string\"], \"default\": null, \"doc\": \"The full name of the author.\"}, {\"name\": \"href\", \"type\": [\"null\", \"string\"], \"default\": null, \"doc\": \"A URL associated with the author, such as a personal website or profile.\"}, {\"name\": \"email\", \"type\": [\"null\", \"string\"], \"default\": null, \"doc\": \"The author's email address.\"}]}"), avro.name.Names()
    )
    ...
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['FeedItemAuthor']:
        ...
        if base_content_type in ['avro/binary', 'application/vnd.apache.avro+avro', 'avro/json', 'application/vnd.apache.avro+json']:
            ...
            return FeedItemAuthor.from_serializer_dict(_record)
        if base_content_type == 'application/json':

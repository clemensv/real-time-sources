...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../rssbridge_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../rssbridge_amqp_producer_amqp_producer/src')))

from rssbridge_amqp_producer_amqp_producer import *
from rssbridge_amqp_producer_data import FeedItem
from test_rssbridge_amqp_producer_data_feeditem import Test_FeedItem
...
class TestMicrosoftOpenDataRssFeedsAmqpProducer:
    """Test cases for MicrosoftOpenDataRssFeedsAmqpProducer"""
        ...
        try:
            ...
            for i in range(5):
                ...
                if True:
                    ...
                    assert cloud_event_payload.get("type") == "Microsoft.OpenData.RssFeeds.amqp.FeedItem"

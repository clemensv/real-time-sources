...
class BodsVehiclePosition:
    ...
    Attributes:
        ...
        valid_until_time (typing.Optional[str])
        block_ref (typing.Optional[str])
        vehicle_journey_ref (typing.Optional[str])
        origin_aimed_departure_time (typing.Optional[str])
    ...
    valid_until_time: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="valid_until_time"))
    ...
    origin_aimed_departure_time: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="origin_aimed_departure_time"))
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'BodsVehiclePosition':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['BodsVehiclePosition']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return BodsVehiclePosition.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'BodsVehiclePosition':
        """
        ...
        """
        return cls(
            operator_ref='lypjyaothzjcdyukrljs',
            vehicle_ref='rixfqankmhiydudglfpr',
            line_ref='mpolonuexpfffihyyufo',
            direction_ref='jvrhoqleznajedafppoi',
            published_line_name='wyjmkbqxlxedcqymolke',
            origin_ref='nhjnhjsqaxwbterrvlin',
            origin_name='kkewulawazymuicswumi',
            destination_ref='hefkjnichkrxshdkpuwr',
            destination_name='htixbbyhmcovqvbnkslb',
            longitude=float(33.70293247034136),
            latitude=float(26.096305499497674),
            bearing=int(21),
            recorded_at_time='tkxeoficvncgxwekagdc',
            valid_until_time='vvwriekovgvzexzfluyv',
            block_ref='dgbazhsvxgtpxhwsjcwp',
            vehicle_journey_ref='qgprsejgconfshbqhbbw',
            origin_aimed_departure_time='hbefkewnpiouaewlpglv',
            data_frame_ref='gtjodcvwmnflhnhxozjy',
            dated_vehicle_journey_ref='gzvmfrftunvcngjbynxi',
            item_identifier='szdmaicwczgxoqmfqiab'
        )
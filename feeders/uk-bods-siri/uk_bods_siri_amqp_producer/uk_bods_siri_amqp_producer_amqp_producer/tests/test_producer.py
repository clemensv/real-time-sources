...
"""
Tests for uk_bods_siri_amqp_producer_amqp_producer
"""
import base64
import datetime
import json
...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../uk_bods_siri_amqp_producer_data/src')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../uk_bods_siri_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../uk_bods_siri_amqp_producer_amqp_producer/src')))
...
class TestUkGovDftBodsAmqpProducer:
    """Test cases for UkGovDftBodsAmqpProducer"""
    ...
    def test_presettled_send_waits_for_queued_delivery_to_drain(self):
        ...
        producer = object.__new__(UkGovDftBodsAmqpProducer)

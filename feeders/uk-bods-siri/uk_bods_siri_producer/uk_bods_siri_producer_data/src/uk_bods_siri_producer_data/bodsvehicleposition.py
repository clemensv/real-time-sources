...
class BodsVehiclePosition:
    ...
    def create_instance(cls) -> 'BodsVehiclePosition':
        ...
        """
        return cls(
            operator_ref='ygqoxydbqlufctjquqcg',
            vehicle_ref='plrelacgribnjsnrpdsg',
            line_ref='pslcpgyrohxfgxgtjydy',
            direction_ref='duwhbqdiiboquisgisil',
            published_line_name='uhgixbriipxiyyhytcjs',
            origin_ref='xcoowkzqdnctxcfeblpg',
            origin_name='nexetccqcrmahqpqxpqe',
            destination_ref='eptvtqzwkhutunzmblgv',
            destination_name='yqepyooeqeirvykgqrsm',
            longitude=float(82.72505631856683),
            latitude=float(17.74400685603603),
            bearing=int(40),
            recorded_at_time='mhzepbghtzleyyzytkyx',
            valid_until_time='brtypeziuqzfnbaktjnz',
            block_ref='xwcrafycmshlqxvutafv',
            vehicle_journey_ref='pjxfzpmupbgbdsyqxuey',
            origin_aimed_departure_time='xptkqreypigpjpcipzzz',
            data_frame_ref='refneepjvjakefnozcjh',
            dated_vehicle_journey_ref='exjpoityhscmuhedlqil',
            item_identifier='zblxnnsmxmpdvghqsnfi'
        )
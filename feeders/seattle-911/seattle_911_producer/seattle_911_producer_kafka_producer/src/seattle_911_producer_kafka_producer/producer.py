...
class USWASeattleFire911EventProducer:
    ...
    def send_us_wa_seattle_fire911_incident(self,_incident_number : str, data: Incident, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Incident], str]=None) -> None:
        """
        ...
        Args:
            ...
            key_mapper(Callable[[CloudEvent, Incident], str]): A function to map the CloudEvent contents to a Kafka key (default: None).
                The default key is derived from the xRegistry Kafka key declaration '{incident_number}'
        """
        kafka_key = "{incident_number}".format(incident_number=_incident_number)
        attributes = {
...
class USWASeattleFire911MqttEventProducer:
    ...
    def send_us_wa_seattle_fire911_mqtt_incident(self,_incident_number : str, data: Incident, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Incident], str]=None) -> None:
        """
...
class USWASeattleFire911AmqpEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    def send_us_wa_seattle_fire911_amqp_incident(self,_incident_number : str, data: Incident, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Incident], str]=None) -> None:
        """
        Sends the 'US.WA.Seattle.Fire911.amqp.Incident' event to the Kafka topic
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'USWASeattleFire911AmqpEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.

...
# Seattle-911-producer Kafka Producer# Seattle-911-producer Event Dispatcher for Apache Kafka
...
4. [Generated Producer Classes](#generated-producer-classes)    USWASeattleFire911AmqpEventDispatcher
...
- USWASeattleFire911AmqpProducersolution for event-driven applications.
...
- **Scales horizontally** across multiple brokers and partitions### USWASeattleFire911EventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`USWASeattleFire911EventDispatcher` handles events for the US.WA.Seattle.Fire911 message group.
...
The USWASeattleFire911EventDispatcher defines the following event handler hooks.
...
producer = USWASeattleFire911Producer(
    ...
    security_protocol='SASL_SSL',##### `us_wa_seattle_fire911_incident_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'us_wa_seattle_fire911_incident_async:  Callable[[ConsumerRecord, CloudEvent, Incident],
Awaitable[None]]
...
Asynchronous handler hook for `US.WA.Seattle.Fire911.Incident`:
...
us_wa_seattle_fire911_dispatcher.us_wa_seattle_fire911_incident_async = us_wa_seattle_fire911_incident_event
...
### USWASeattleFire911AmqpProducer- `data`: The event data of type `seattle_911_producer_data.Incident`.



Producer for `US.WA.Seattle.Fire911.amqp` message group.Example:
...
USWASeattleFire911AmqpProducer(    await some_processing_function(record, cloud_event, data)
...
us_wa_seattle_fire911_amqp_dispatcher.us_wa_seattle_fire911_incident_async = us_wa_seattle_fire911_incident_event
...
##### `send_us_wa_seattle_fire911_incident`Dispatchers have the following protected methods:



```python### Methods:

async def send_us_wa_seattle_fire911_incident(
...
Send a single `US.WA.Seattle.Fire911.Incident` message.Args:
...
await producer.send_us_wa_seattle_fire911_incident(
...
Send multiple `US.WA.Seattle.Fire911.Incident` messages in a batch.
...
us_wa_seattle_fire911_amqp_dispatcher.us_wa_seattle_fire911_mqtt_incident_async =
us_wa_seattle_fire911_mqtt_incident_event
...
- **Scales horizontally** across multiple brokers and partitions### USWASeattleFire911AmqpEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`USWASeattleFire911AmqpEventDispatcher` handles events for the US.WA.Seattle.Fire911.amqp message group.
...
The USWASeattleFire911AmqpEventDispatcher defines the following event handler hooks.
...
producer = USWASeattleFire911Producer(
    ...
    security_protocol='SASL_SSL',##### `us_wa_seattle_fire911_amqp_incident_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'us_wa_seattle_fire911_amqp_incident_async:  Callable[[ConsumerRecord, CloudEvent,
Incident], Awaitable[None]]
...
Asynchronous handler hook for `US.WA.Seattle.Fire911.amqp.Incident`:
...
async def us_wa_seattle_fire911_amqp_incident_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Incident) ->
None:
...
us_wa_seattle_fire911_dispatcher.us_wa_seattle_fire911_amqp_incident_async = us_wa_seattle_fire911_amqp_incident_event
...
us_wa_seattle_fire911_mqtt_dispatcher.us_wa_seattle_fire911_amqp_incident_async =
us_wa_seattle_fire911_amqp_incident_event
...
us_wa_seattle_fire911_amqp_dispatcher.us_wa_seattle_fire911_amqp_incident_async =
us_wa_seattle_fire911_amqp_incident_event
...
##### `send_us_wa_seattle_fire911_amqp_incident`Dispatchers have the following protected methods:



```python### Methods:

async def send_us_wa_seattle_fire911_amqp_incident(
...
Send a single `US.WA.Seattle.Fire911.amqp.Incident` message.Args:
...
await producer.send_us_wa_seattle_fire911_amqp_incident(
...
Send multiple `US.WA.Seattle.Fire911.amqp.Incident` messages in a batch.
...
await producer.send_us_wa_seattle_fire911_amqp_incident_batch(```

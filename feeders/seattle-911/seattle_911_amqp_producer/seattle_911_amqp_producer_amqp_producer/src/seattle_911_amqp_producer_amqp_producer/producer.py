...
class USWASeattleFire911AmqpProducer:
    """
    Producer class to send messages in the `US.WA.Seattle.Fire911.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_incident(self,
        ...
        _incident_type_slug: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send the `US.WA.Seattle.Fire911.amqp.Incident` message
        
        Args:
            _incident_number (str): Value for placeholder incident_number in attribute subject
            _incident_type_slug (str): Value for AMQP protocol option placeholder incident_type_slug
        ...
        amqp_msg.subject = "{incident_number}".format(incident_number=_incident_number)

        app_properties = {}
        app_properties["incident_type_slug"] = "{incident_type_slug}".format(incident_type_slug=_incident_type_slug)
        if app_properties:
        ...
        annotations = {}
        annotation_value = "{incident_number}".format(incident_number=_incident_number)
    ...
    def send_incident_batch(self,
        data_array: typing.List[Incident],
        _incident_number: str,
        _incident_type_slug: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `US.WA.Seattle.Fire911.amqp.Incident` messages
        
        Args:
            data_array (typing.List[Incident]): Array of message data objects
            _incident_number (str): Value for placeholder incident_number in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
            _incident_type_slug (str): Value for AMQP protocol option placeholder incident_type_slug
        ...
        for data in data_array:
            self.send_incident(
                data=data,
                _incident_number=_incident_number,
                _time=_time,
                _incident_type_slug=_incident_type_slug,

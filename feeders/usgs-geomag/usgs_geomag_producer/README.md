...
# Usgs-geomag-producer Kafka Producer# Usgs-geomag-producer Event Dispatcher for Apache Kafka
...
3. [Quick Start](#quick-start)    - GovUsgsGeomagEventDispatcher,

4. [Generated Producer Classes](#generated-producer-classes)    GovUsgsGeomagMqttEventDispatcher,

4. [Generated Producer Classes](#generated-producer-classes)    GovUsgsGeomagAmqpEventDispatcher
...
- GovUsgsGeomagProducersolution for event-driven applications.

It includes both plain Kafka messages and CloudEvents, offering a versatile

- GovUsgsGeomagMqttProducersolution for event-driven applications.

It includes both plain Kafka messages and CloudEvents, offering a versatile

- GovUsgsGeomagAmqpProducersolution for event-driven applications.
...
- **Scales horizontally** across multiple brokers and partitions### GovUsgsGeomagEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`GovUsgsGeomagEventDispatcher` handles events for the gov.usgs.geomag message group.
...
from usgs-geomag-producer import GovUsgsGeomagProducer```python

create_processor(self, bootstrap_servers: str, group_id: str, topics: List[str]) -> EventProcessorRunner

# Create producer```

producer = GovUsgsGeomagProducer(
...
await producer.send_gov_usgs_geomag_observatory(```python

    data=Observatory(...),add_consumer(self, consumer: KafkaConsumer)
...
The GovUsgsGeomagEventDispatcher defines the following event handler hooks.
...
producer = GovUsgsGeomagProducer(
    ...
    security_protocol='SASL_SSL',##### `gov_usgs_geomag_observatory_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'gov_usgs_geomag_observatory_async:  Callable[[ConsumerRecord, CloudEvent, Observatory],
Awaitable[None]]
...
Asynchronous handler hook for `gov.usgs.geomag.Observatory`:
...
### GovUsgsGeomagProducer- `data`: The event data of type `usgs_geomag_producer_data.Observatory`.



Producer for `gov.usgs.geomag` message group.Example:



#### Constructor```python

async def gov_usgs_geomag_observatory_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Observatory) -> None:

```python    # Process the event data

GovUsgsGeomagProducer(    await some_processing_function(record, cloud_event, data)
...
gov_usgs_geomag_dispatcher.gov_usgs_geomag_observatory_async = gov_usgs_geomag_observatory_event
...
### GovUsgsGeomagMqttProducer- `data`: The event data of type `usgs_geomag_producer_data.Observatory`.



Producer for `gov.usgs.geomag.mqtt` message group.Example:
...
GovUsgsGeomagMqttProducer(    await some_processing_function(record, cloud_event, data)
...
gov_usgs_geomag_mqtt_dispatcher.gov_usgs_geomag_observatory_async = gov_usgs_geomag_observatory_event
...
### GovUsgsGeomagAmqpProducer- `data`: The event data of type `usgs_geomag_producer_data.Observatory`.



Producer for `gov.usgs.geomag.amqp` message group.Example:
...
GovUsgsGeomagAmqpProducer(    await some_processing_function(record, cloud_event, data)
...
gov_usgs_geomag_amqp_dispatcher.gov_usgs_geomag_observatory_async = gov_usgs_geomag_observatory_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `gov_usgs_geomag_magnetic_field_reading_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'gov_usgs_geomag_magnetic_field_reading_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `gov.usgs.geomag.MagneticFieldReading`:
...
### GovUsgsGeomagProducer- `data`: The event data of type `usgs_geomag_producer_data.MagneticFieldReading`.
...
async def gov_usgs_geomag_magnetic_field_reading_event(record: ConsumerRecord, cloud_event: CloudEvent, data:
MagneticFieldReading) -> None:
...
gov_usgs_geomag_dispatcher.gov_usgs_geomag_magnetic_field_reading_async = gov_usgs_geomag_magnetic_field_reading_event
...
### GovUsgsGeomagMqttProducer- `data`: The event data of type `usgs_geomag_producer_data.MagneticFieldReading`.
...
gov_usgs_geomag_mqtt_dispatcher.gov_usgs_geomag_magnetic_field_reading_async =
gov_usgs_geomag_magnetic_field_reading_event
...
### GovUsgsGeomagAmqpProducer- `data`: The event data of type `usgs_geomag_producer_data.MagneticFieldReading`.
...
gov_usgs_geomag_amqp_dispatcher.gov_usgs_geomag_magnetic_field_reading_async =
gov_usgs_geomag_magnetic_field_reading_event
...
##### `send_gov_usgs_geomag_observatory`Dispatchers have the following protected methods:



```python### Methods:

async def send_gov_usgs_geomag_observatory(
...
Send a single `gov.usgs.geomag.Observatory` message.Args:

- `record`: The Kafka record.

**Parameters:**

- `data`: Message data of type `Observatory`
...
await producer.send_gov_usgs_geomag_observatory(

    data=Observatory(...),Args:
...
Send multiple `gov.usgs.geomag.Observatory` messages in a batch.
...
await producer.send_gov_usgs_geomag_observatory_batch(```

    messages=[

        Observatory(...),Initializes the runner with a Kafka consumer.
...
##### `send_gov_usgs_geomag_magnetic_field_reading`Dispatchers have the following protected methods:



```python### Methods:

async def send_gov_usgs_geomag_magnetic_field_reading(
...
Send a single `gov.usgs.geomag.MagneticFieldReading` message.Args:

- `record`: The Kafka record.

**Parameters:**

- `data`: Message data of type `MagneticFieldReading`
...
await producer.send_gov_usgs_geomag_magnetic_field_reading(

    data=MagneticFieldReading(...),Args:
...
Send multiple `gov.usgs.geomag.MagneticFieldReading` messages in a batch.
...
await producer.send_gov_usgs_geomag_magnetic_field_reading_batch(```

    messages=[

        MagneticFieldReading(...),Initializes the runner with a Kafka consumer.

        MagneticFieldReading(...),

        MagneticFieldReading(...)Args:
...
- **Scales horizontally** across multiple brokers and partitions### GovUsgsGeomagMqttEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`GovUsgsGeomagMqttEventDispatcher` handles events for the gov.usgs.geomag.mqtt message group.
...
The GovUsgsGeomagMqttEventDispatcher defines the following event handler hooks.
...
producer = GovUsgsGeomagProducer(
    ...
    security_protocol='SASL_SSL',##### `gov_usgs_geomag_mqtt_observatory_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'gov_usgs_geomag_mqtt_observatory_async:  Callable[[ConsumerRecord, CloudEvent,
Observatory], Awaitable[None]]
...
async def gov_usgs_geomag_mqtt_observatory_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Observatory) ->
None:
...
gov_usgs_geomag_dispatcher.gov_usgs_geomag_mqtt_observatory_async = gov_usgs_geomag_mqtt_observatory_event
...
gov_usgs_geomag_amqp_dispatcher.gov_usgs_geomag_mqtt_observatory_async = gov_usgs_geomag_mqtt_observatory_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `gov_usgs_geomag_mqtt_magnetic_field_reading_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'gov_usgs_geomag_mqtt_magnetic_field_reading_async:  Callable[[ConsumerRecord,
CloudEvent, MagneticFieldReading], Awaitable[None]]
...
async def gov_usgs_geomag_mqtt_magnetic_field_reading_event(record: ConsumerRecord, cloud_event: CloudEvent, data:
MagneticFieldReading) -> None:
...
gov_usgs_geomag_dispatcher.gov_usgs_geomag_mqtt_magnetic_field_reading_async =
...
gov_usgs_geomag_amqp_dispatcher.gov_usgs_geomag_mqtt_magnetic_field_reading_async =
gov_usgs_geomag_mqtt_magnetic_field_reading_event
...
##### `send_gov_usgs_geomag_mqtt_observatory`Dispatchers have the following protected methods:



```python### Methods:

async def send_gov_usgs_geomag_mqtt_observatory(
...
Send a single `gov.usgs.geomag.mqtt.Observatory` message.Args:
...
await producer.send_gov_usgs_geomag_mqtt_observatory(
...
Send multiple `gov.usgs.geomag.mqtt.Observatory` messages in a batch.
...
await producer.send_gov_usgs_geomag_mqtt_observatory_batch(```
...
##### `send_gov_usgs_geomag_mqtt_magnetic_field_reading`Dispatchers have the following protected methods:



```python### Methods:

async def send_gov_usgs_geomag_mqtt_magnetic_field_reading(
...
Send a single `gov.usgs.geomag.mqtt.MagneticFieldReading` message.Args:
...
await producer.send_gov_usgs_geomag_mqtt_magnetic_field_reading(
...
Send multiple `gov.usgs.geomag.mqtt.MagneticFieldReading` messages in a batch.
...
await producer.send_gov_usgs_geomag_mqtt_magnetic_field_reading_batch(```
...
- **Scales horizontally** across multiple brokers and partitions### GovUsgsGeomagAmqpEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`GovUsgsGeomagAmqpEventDispatcher` handles events for the gov.usgs.geomag.amqp message group.
...
The GovUsgsGeomagAmqpEventDispatcher defines the following event handler hooks.
...
producer = GovUsgsGeomagProducer(
    ...
    security_protocol='SASL_SSL',##### `gov_usgs_geomag_amqp_observatory_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'gov_usgs_geomag_amqp_observatory_async:  Callable[[ConsumerRecord, CloudEvent,
Observatory], Awaitable[None]]
...
Asynchronous handler hook for `gov.usgs.geomag.amqp.Observatory`:
...
async def gov_usgs_geomag_amqp_observatory_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Observatory) ->
None:
...
gov_usgs_geomag_dispatcher.gov_usgs_geomag_amqp_observatory_async = gov_usgs_geomag_amqp_observatory_event
...
gov_usgs_geomag_mqtt_dispatcher.gov_usgs_geomag_amqp_observatory_async = gov_usgs_geomag_amqp_observatory_event
...
gov_usgs_geomag_amqp_dispatcher.gov_usgs_geomag_amqp_observatory_async = gov_usgs_geomag_amqp_observatory_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `gov_usgs_geomag_amqp_magnetic_field_reading_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'gov_usgs_geomag_amqp_magnetic_field_reading_async:  Callable[[ConsumerRecord,
CloudEvent, MagneticFieldReading], Awaitable[None]]
...
Asynchronous handler hook for `gov.usgs.geomag.amqp.MagneticFieldReading`:
...
async def gov_usgs_geomag_amqp_magnetic_field_reading_event(record: ConsumerRecord, cloud_event: CloudEvent, data:
MagneticFieldReading) -> None:
...
gov_usgs_geomag_dispatcher.gov_usgs_geomag_amqp_magnetic_field_reading_async =
gov_usgs_geomag_amqp_magnetic_field_reading_event
...
gov_usgs_geomag_mqtt_dispatcher.gov_usgs_geomag_amqp_magnetic_field_reading_async =
gov_usgs_geomag_amqp_magnetic_field_reading_event
...
gov_usgs_geomag_amqp_dispatcher.gov_usgs_geomag_amqp_magnetic_field_reading_async =
gov_usgs_geomag_amqp_magnetic_field_reading_event
...
##### `send_gov_usgs_geomag_amqp_observatory`Dispatchers have the following protected methods:



```python### Methods:

async def send_gov_usgs_geomag_amqp_observatory(
...
Send a single `gov.usgs.geomag.amqp.Observatory` message.Args:
...
await producer.send_gov_usgs_geomag_amqp_observatory(
...
Send multiple `gov.usgs.geomag.amqp.Observatory` messages in a batch.
...
await producer.send_gov_usgs_geomag_amqp_observatory_batch(```
...
##### `send_gov_usgs_geomag_amqp_magnetic_field_reading`Dispatchers have the following protected methods:



```python### Methods:

async def send_gov_usgs_geomag_amqp_magnetic_field_reading(
...
Send a single `gov.usgs.geomag.amqp.MagneticFieldReading` message.Args:
...
await producer.send_gov_usgs_geomag_amqp_magnetic_field_reading(
...
Send multiple `gov.usgs.geomag.amqp.MagneticFieldReading` messages in a batch.
...
await producer.send_gov_usgs_geomag_amqp_magnetic_field_reading_batch(```

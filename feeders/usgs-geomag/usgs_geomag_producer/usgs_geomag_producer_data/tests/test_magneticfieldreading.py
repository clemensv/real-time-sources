...
from usgs_geomag_producer_data.magneticfieldreading import MagneticFieldReading
import datetime
...
class Test_MagneticFieldReading(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = MagneticFieldReading(
            iaga_code='tbkqkgljcbqjhsuhddpm',
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            h=float(12.842900531415824),
            d=float(83.65144170803302),
            z=float(33.57463106829087),
            f=float(55.03597305942015)
        )
        return instance
    ...
    def test_iaga_code_property(self):
        ...
        """
        test_value = 'tbkqkgljcbqjhsuhddpm'
    ...
    def test_h_property(self):
        ...
        Test h property
        """
        test_value = float(12.842900531415824)
    ...
    def test_d_property(self):
        ...
        Test d property
        """
        test_value = float(83.65144170803302)
    ...
    def test_z_property(self):
        ...
        Test z property
        """
        test_value = float(33.57463106829087)
    ...
    def test_f_property(self):
        ...
        Test f property
        """
        test_value = float(55.03597305942015)

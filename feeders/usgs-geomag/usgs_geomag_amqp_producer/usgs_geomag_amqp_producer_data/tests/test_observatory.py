...
from usgs_geomag_amqp_producer_data.observatory import Observatory
...
class Test_Observatory(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Observatory(
            iaga_code='lrhpsndvmzcfeweqnymy',
            name='tulmpusbftejdkmhzvgf',
            agency='pbeorfybjyzvwmovayvr',
            agency_name='lnxntdqnqpmqxokbyilh',
            latitude=float(15.758462545534979),
            longitude=float(31.310384779662513),
            elevation=float(30.428963987596745),
            sensor_orientation='kfmhcfeeuxcutlltfjrc',
            sensor_sampling_rate=float(95.36687540041329),
            declination_base=float(3.7175740350085418)
        )
        return instance
    ...
    def test_iaga_code_property(self):
        ...
        """
        test_value = 'lrhpsndvmzcfeweqnymy'
    ...
    def test_name_property(self):
        ...
        Test name property
        """
        test_value = 'tulmpusbftejdkmhzvgf'
    ...
    def test_agency_property(self):
        ...
        """
        test_value = 'pbeorfybjyzvwmovayvr'
    ...
    def test_agency_name_property(self):
        ...
        """
        test_value = 'lnxntdqnqpmqxokbyilh'
    ...
    def test_latitude_property(self):
        ...
        """
        test_value = float(15.758462545534979)
    ...
    def test_longitude_property(self):
        ...
        """
        test_value = float(31.310384779662513)
    ...
    def test_elevation_property(self):
        ...
        """
        test_value = float(30.428963987596745)
    ...
    def test_sensor_orientation_property(self):
        ...
        """
        test_value = 'kfmhcfeeuxcutlltfjrc'
    ...
    def test_sensor_sampling_rate_property(self):
        ...
        """
        test_value = float(95.36687540041329)
    ...
    def test_declination_base_property(self):
        ...
        """
        test_value = float(3.7175740350085418)

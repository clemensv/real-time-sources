...
# Kmi_belgium_producer Kafka Producer# Kmi_belgium_producer Event Dispatcher for Apache Kafka
...
3. [Quick Start](#quick-start)    - BEGovKMIWeatherEventDispatcher,

4. [Generated Producer Classes](#generated-producer-classes)    BEGovKMIWeatherMqttEventDispatcher,

4. [Generated Producer Classes](#generated-producer-classes)    BEGovKMIWeatherAmqpEventDispatcher
...
- BEGovKMIWeatherProducersolution for event-driven applications.

It includes both plain Kafka messages and CloudEvents, offering a versatile

- BEGovKMIWeatherMqttProducersolution for event-driven applications.

It includes both plain Kafka messages and CloudEvents, offering a versatile

- BEGovKMIWeatherAmqpProducersolution for event-driven applications.
...
- **Scales horizontally** across multiple brokers and partitions### BEGovKMIWeatherEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`BEGovKMIWeatherEventDispatcher` handles events for the BE.Gov.KMI.Weather message group.
...
from kmi_belgium_producer import BEGovKMIWeatherProducer```python

create_processor(self, bootstrap_servers: str, group_id: str, topics: List[str]) -> EventProcessorRunner

# Create producer```

producer = BEGovKMIWeatherProducer(
...
await producer.send_be_gov_kmi_weather_station(```python
...
The BEGovKMIWeatherEventDispatcher defines the following event handler hooks.
...
producer = BEGovKMIWeatherProducer(
    ...
    security_protocol='SASL_SSL',##### `be_gov_kmi_weather_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'be_gov_kmi_weather_station_async:  Callable[[ConsumerRecord, CloudEvent, Station],
Awaitable[None]]
...
Asynchronous handler hook for `BE.Gov.KMI.Weather.Station`: A reference record published by the Royal Meteorological
Institute of Belgium (KMI/IRM). It lets consumers label, group, and route the live measurement or forecast events.
...
### BEGovKMIWeatherProducer- `data`: The event data of type `kmi_belgium_producer_data.Station`.



Producer for `BE.Gov.KMI.Weather` message group.Example:



#### Constructor```python

async def be_gov_kmi_weather_station_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Station) -> None:

```python    # Process the event data

BEGovKMIWeatherProducer(    await some_processing_function(record, cloud_event, data)
...
be_gov_kmi_weather_dispatcher.be_gov_kmi_weather_station_async = be_gov_kmi_weather_station_event
...
### BEGovKMIWeatherMqttProducer- `data`: The event data of type `kmi_belgium_producer_data.Station`.



Producer for `BE.Gov.KMI.Weather.mqtt` message group.Example:
...
BEGovKMIWeatherMqttProducer(    await some_processing_function(record, cloud_event, data)
...
be_gov_kmi_weather_mqtt_dispatcher.be_gov_kmi_weather_station_async = be_gov_kmi_weather_station_event
...
### BEGovKMIWeatherAmqpProducer- `data`: The event data of type `kmi_belgium_producer_data.Station`.



Producer for `BE.Gov.KMI.Weather.amqp` message group.Example:
...
BEGovKMIWeatherAmqpProducer(    await some_processing_function(record, cloud_event, data)
...
be_gov_kmi_weather_amqp_dispatcher.be_gov_kmi_weather_station_async = be_gov_kmi_weather_station_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `be_gov_kmi_weather_weather_observation_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'be_gov_kmi_weather_weather_observation_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `BE.Gov.KMI.Weather.WeatherObservation`: A current environmental measurement from the
Royal Meteorological Institute of Belgium (KMI/IRM). It carries weather observations when the upstream feed reports a
new or refreshed value.
...
### BEGovKMIWeatherProducer- `data`: The event data of type `kmi_belgium_producer_data.WeatherObservation`.
...
async def be_gov_kmi_weather_weather_observation_event(record: ConsumerRecord, cloud_event: CloudEvent, data:
...
be_gov_kmi_weather_dispatcher.be_gov_kmi_weather_weather_observation_async =
be_gov_kmi_weather_weather_observation_event
...
### BEGovKMIWeatherMqttProducer- `data`: The event data of type `kmi_belgium_producer_data.WeatherObservation`.
...
be_gov_kmi_weather_mqtt_dispatcher.be_gov_kmi_weather_weather_observation_async =
be_gov_kmi_weather_weather_observation_event
...
### BEGovKMIWeatherAmqpProducer- `data`: The event data of type `kmi_belgium_producer_data.WeatherObservation`.
...
be_gov_kmi_weather_amqp_dispatcher.be_gov_kmi_weather_weather_observation_async =
be_gov_kmi_weather_weather_observation_event
...
##### `send_be_gov_kmi_weather_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_be_gov_kmi_weather_station(
...
Send a single `BE.Gov.KMI.Weather.Station` message. A reference record published by the Royal Meteorological Institute
of Belgium (KMI/IRM). It lets consumers label, group, and route the live measurement or forecast events.Args:
...
await producer.send_be_gov_kmi_weather_station(
...
Send multiple `BE.Gov.KMI.Weather.Station` messages in a batch.
...
await producer.send_be_gov_kmi_weather_station_batch(```
...
##### `send_be_gov_kmi_weather_weather_observation`Dispatchers have the following protected methods:



```python### Methods:

async def send_be_gov_kmi_weather_weather_observation(
...
Send a single `BE.Gov.KMI.Weather.WeatherObservation` message. A current environmental measurement from the Royal
Meteorological Institute of Belgium (KMI/IRM). It carries weather observations when the upstream feed reports a new or
...
await producer.send_be_gov_kmi_weather_weather_observation(
...
Send multiple `BE.Gov.KMI.Weather.WeatherObservation` messages in a batch.
...
await producer.send_be_gov_kmi_weather_weather_observation_batch(```
...
- **Scales horizontally** across multiple brokers and partitions### BEGovKMIWeatherMqttEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`BEGovKMIWeatherMqttEventDispatcher` handles events for the BE.Gov.KMI.Weather.mqtt message group.
...
The BEGovKMIWeatherMqttEventDispatcher defines the following event handler hooks.
...
producer = BEGovKMIWeatherProducer(
    ...
    security_protocol='SASL_SSL',##### `be_gov_kmi_weather_mqtt_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'be_gov_kmi_weather_mqtt_station_async:  Callable[[ConsumerRecord, CloudEvent, Station],
Awaitable[None]]
...
Asynchronous handler hook for `BE.Gov.KMI.Weather.mqtt.Station`: A reference record published by the Royal
Meteorological Institute of Belgium (KMI/IRM). It lets consumers label, group, and route the live measurement or
forecast events.
...
async def be_gov_kmi_weather_mqtt_station_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Station) -> None:
...
be_gov_kmi_weather_dispatcher.be_gov_kmi_weather_mqtt_station_async = be_gov_kmi_weather_mqtt_station_event
...
be_gov_kmi_weather_mqtt_dispatcher.be_gov_kmi_weather_mqtt_station_async = be_gov_kmi_weather_mqtt_station_event
...
be_gov_kmi_weather_amqp_dispatcher.be_gov_kmi_weather_mqtt_station_async = be_gov_kmi_weather_mqtt_station_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `be_gov_kmi_weather_mqtt_weather_observation_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'be_gov_kmi_weather_mqtt_weather_observation_async:  Callable[[ConsumerRecord,
...
Asynchronous handler hook for `BE.Gov.KMI.Weather.mqtt.WeatherObservation`: A current environmental measurement from the
Royal Meteorological Institute of Belgium (KMI/IRM). It carries weather observations when the upstream feed reports a
new or refreshed value.
...
async def be_gov_kmi_weather_mqtt_weather_observation_event(record: ConsumerRecord, cloud_event: CloudEvent, data:
WeatherObservation) -> None:
...
be_gov_kmi_weather_dispatcher.be_gov_kmi_weather_mqtt_weather_observation_async =
be_gov_kmi_weather_mqtt_weather_observation_event
...
be_gov_kmi_weather_mqtt_dispatcher.be_gov_kmi_weather_mqtt_weather_observation_async =
be_gov_kmi_weather_mqtt_weather_observation_event
...
be_gov_kmi_weather_amqp_dispatcher.be_gov_kmi_weather_mqtt_weather_observation_async =
be_gov_kmi_weather_mqtt_weather_observation_event
...
##### `send_be_gov_kmi_weather_mqtt_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_be_gov_kmi_weather_mqtt_station(
...
Send a single `BE.Gov.KMI.Weather.mqtt.Station` message. A reference record published by the Royal Meteorological
Institute of Belgium (KMI/IRM). It lets consumers label, group, and route the live measurement or forecast events.Args:
...
await producer.send_be_gov_kmi_weather_mqtt_station(
...
Send multiple `BE.Gov.KMI.Weather.mqtt.Station` messages in a batch.
...
await producer.send_be_gov_kmi_weather_mqtt_station_batch(```
...
##### `send_be_gov_kmi_weather_mqtt_weather_observation`Dispatchers have the following protected methods:



```python### Methods:

async def send_be_gov_kmi_weather_mqtt_weather_observation(
...
Send a single `BE.Gov.KMI.Weather.mqtt.WeatherObservation` message. A current environmental measurement from the Royal
Meteorological Institute of Belgium (KMI/IRM). It carries weather observations when the upstream feed reports a new or
refreshed value.Args:
...
await producer.send_be_gov_kmi_weather_mqtt_weather_observation(
...
Send multiple `BE.Gov.KMI.Weather.mqtt.WeatherObservation` messages in a batch.
...
await producer.send_be_gov_kmi_weather_mqtt_weather_observation_batch(```
...
- **Scales horizontally** across multiple brokers and partitions### BEGovKMIWeatherAmqpEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`BEGovKMIWeatherAmqpEventDispatcher` handles events for the BE.Gov.KMI.Weather.amqp message group.
...
The BEGovKMIWeatherAmqpEventDispatcher defines the following event handler hooks.
...
producer = BEGovKMIWeatherProducer(
    ...
    security_protocol='SASL_SSL',##### `be_gov_kmi_weather_amqp_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'be_gov_kmi_weather_amqp_station_async:  Callable[[ConsumerRecord, CloudEvent, Station],
Awaitable[None]]
...
Asynchronous handler hook for `BE.Gov.KMI.Weather.amqp.Station`: A reference record published by the Royal
Meteorological Institute of Belgium (KMI/IRM). It lets consumers label, group, and route the live measurement or
forecast events.
...
async def be_gov_kmi_weather_amqp_station_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Station) -> None:
...
be_gov_kmi_weather_dispatcher.be_gov_kmi_weather_amqp_station_async = be_gov_kmi_weather_amqp_station_event
...
be_gov_kmi_weather_mqtt_dispatcher.be_gov_kmi_weather_amqp_station_async = be_gov_kmi_weather_amqp_station_event
...
be_gov_kmi_weather_amqp_dispatcher.be_gov_kmi_weather_amqp_station_async = be_gov_kmi_weather_amqp_station_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `be_gov_kmi_weather_amqp_weather_observation_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'be_gov_kmi_weather_amqp_weather_observation_async:  Callable[[ConsumerRecord,
CloudEvent, WeatherObservation], Awaitable[None]]
...
Asynchronous handler hook for `BE.Gov.KMI.Weather.amqp.WeatherObservation`: A current environmental measurement from the
Royal Meteorological Institute of Belgium (KMI/IRM). It carries weather observations when the upstream feed reports a
new or refreshed value.
...
async def be_gov_kmi_weather_amqp_weather_observation_event(record: ConsumerRecord, cloud_event: CloudEvent, data:
WeatherObservation) -> None:
...
be_gov_kmi_weather_dispatcher.be_gov_kmi_weather_amqp_weather_observation_async =
be_gov_kmi_weather_amqp_weather_observation_event
...
be_gov_kmi_weather_mqtt_dispatcher.be_gov_kmi_weather_amqp_weather_observation_async =
be_gov_kmi_weather_amqp_weather_observation_event
...
be_gov_kmi_weather_amqp_dispatcher.be_gov_kmi_weather_amqp_weather_observation_async =
be_gov_kmi_weather_amqp_weather_observation_event
...
##### `send_be_gov_kmi_weather_amqp_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_be_gov_kmi_weather_amqp_station(
...
Send a single `BE.Gov.KMI.Weather.amqp.Station` message. A reference record published by the Royal Meteorological
Institute of Belgium (KMI/IRM). It lets consumers label, group, and route the live measurement or forecast events.Args:
...
await producer.send_be_gov_kmi_weather_amqp_station(
...
Send multiple `BE.Gov.KMI.Weather.amqp.Station` messages in a batch.
...
await producer.send_be_gov_kmi_weather_amqp_station_batch(```
...
##### `send_be_gov_kmi_weather_amqp_weather_observation`Dispatchers have the following protected methods:



```python### Methods:

async def send_be_gov_kmi_weather_amqp_weather_observation(
...
Send a single `BE.Gov.KMI.Weather.amqp.WeatherObservation` message. A current environmental measurement from the Royal
Meteorological Institute of Belgium (KMI/IRM). It carries weather observations when the upstream feed reports a new or
refreshed value.Args:
...
await producer.send_be_gov_kmi_weather_amqp_weather_observation(
...
Send multiple `BE.Gov.KMI.Weather.amqp.WeatherObservation` messages in a batch.
...
await producer.send_be_gov_kmi_weather_amqp_weather_observation_batch(```

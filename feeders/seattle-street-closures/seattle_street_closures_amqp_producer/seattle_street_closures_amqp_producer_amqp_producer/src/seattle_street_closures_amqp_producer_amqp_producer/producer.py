...
class USWASeattleStreetClosuresAmqpProducer:
    """
    Producer class to send messages in the `US.WA.Seattle.StreetClosures.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_amqp(self,
        ...
        """
        Send the `US.WA.Seattle.StreetClosures.StreetClosure.amqp` message
        ...
        attributes = {
            "type":
            "US.WA.Seattle.StreetClosures.StreetClosure",
            "source":
            "https://data.seattle.gov/Built-Environment/Street-Closures/ium9-iqtc",
            "subject":
            "{closure_id}".format(closure_id=_closure_id),
        }
        ...
        amqp_msg.subject = "{closure_id}".format(closure_id=_closure_id)
        ...
        annotations = {}
        annotation_value = "{closure_id}".format(closure_id=_closure_id)
    ...
    def send_amqp_batch(self,
        data_array: typing.List[StreetClosure],
        _closure_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `US.WA.Seattle.StreetClosures.StreetClosure.amqp` messages
        
        Args:
            data_array (typing.List[StreetClosure]): Array of message data objects
            _closure_id (str): Value for placeholder closure_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.

...
def parse_closure(record: dict) -> StreetClosure:
    ...
    return StreetClosure(
        ...
        start_date=str(normalize_date(record.get("start_date"))) if normalize_date(record.get("start_date")) is not None else None,
        end_date=str(normalize_date(record.get("end_date"))) if normalize_date(record.get("end_date")) is not None else None,

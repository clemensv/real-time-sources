...
from irceline_belgium_amqp_producer_data.statusinterval import StatusInterval
...
class Test_StatusInterval(unittest.TestCase):
    ...
    def test_lower_property(self):
        ...
        Test lower property
        """
        test_value = 'zpzkghackdnlnezchytw'
    ...
    def test_upper_property(self):
        ...
        Test upper property
        """
        test_value = 'yoqntdcdcqrlxqninbwc'
    ...
    def test_name_property(self):
        ...
        Test name property
        """
        test_value = 'vzgymqdgyqmflyajycze'
    ...
    def test_color_property(self):
        ...
        Test color property
        """
        test_value = 'zxgajvmrklmgwzjavuyx'

""" EstuaryElevationNGVD29 dataclass. """
...
class EstuaryElevationNGVD29:
    ...
    Attributes:
        ...
        value (typing.Optional[float]): {"description": "Estuary or ocean water surface elevation above NGVD 1929."}
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"EstuaryElevationNGVD29\", \"namespace\": \"USGS.InstantaneousValues\", \"doc\": \"USGS estuary or ocean water surface elevation above NGVD 1929, feet. Parameter code 62619.\", \"fields\": [{\"name\": \"site_no\", \"type\": \"string\", \"doc\": \"{'description': 'USGS site number.'}\"}, {\"name\": \"datetime\", \"type\": \"string\", \"doc\": \"{'description': 'Date and time of the measurement in ISO-8601 format.'}\"}, {\"name\": \"value\", \"type\": [\"double\", \"null\"], \"unit\": \"feet\", \"doc\": \"{'description': 'Estuary or ocean water surface elevation above NGVD 1929.'}\"}, {\"name\": \"exception\", \"type\": [\"string\", \"null\"], \"doc\": \"{'description': 'Exception code when the value is unavailable.'}\"}, {\"name\": \"qualifiers\", \"type\": {\"type\": \"array\", \"items\": \"string\"}, \"doc\": \"{'description': 'Qualifiers for the measurement.'}\"}, {\"name\": \"parameter_cd\", \"type\": \"string\", \"doc\": \"{'description': 'Parameter code.'}\"}, {\"name\": \"timeseries_cd\", \"type\": \"string\", \"doc\": \"{'description': 'Timeseries code.'}\"}]}"), avro.name.Names()
    )
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'EstuaryElevationNGVD29':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['EstuaryElevationNGVD29']:
        """
        ...
        if base_content_type in ['avro/binary', 'application/vnd.apache.avro+avro', 'avro/json', 'application/vnd.apache.avro+json']:
            ...
            return EstuaryElevationNGVD29.from_serializer_dict(_record)
        if base_content_type == 'application/json':

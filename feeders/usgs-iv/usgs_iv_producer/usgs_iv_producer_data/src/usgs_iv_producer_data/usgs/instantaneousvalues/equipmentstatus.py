...
class EquipmentStatus:
    ...
    Attributes:
        ...
        status (typing.Optional[str]): {"description": "Status of equipment alarm as codes."}
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"EquipmentStatus\", \"namespace\": \"USGS.InstantaneousValues\", \"doc\": \"USGS equipment alarm status data. Parameter code 99235.\", \"fields\": [{\"name\": \"site_no\", \"type\": \"string\", \"doc\": \"{'description': 'USGS site number.'}\"}, {\"name\": \"datetime\", \"type\": \"string\", \"doc\": \"{'description': 'Date and time of the measurement in ISO-8601 format.'}\"}, {\"name\": \"status\", \"type\": [\"string\", \"null\"], \"doc\": \"{'description': 'Status of equipment alarm as codes.'}\"}, {\"name\": \"parameter_cd\", \"type\": \"string\", \"doc\": \"{'description': 'Parameter code.'}\"}, {\"name\": \"timeseries_cd\", \"type\": \"string\", \"doc\": \"{'description': 'Timeseries code.'}\"}]}"), avro.name.Names()
    )
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'EquipmentStatus':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['EquipmentStatus']:
        """
        ...
        if base_content_type in ['avro/binary', 'application/vnd.apache.avro+avro', 'avro/json', 'application/vnd.apache.avro+json']:
            ...
            return EquipmentStatus.from_serializer_dict(_record)
        if base_content_type == 'application/json':

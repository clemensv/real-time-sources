...
class EquipmentStatus:
    ...
    @classmethod
    def create_instance(cls) -> 'EquipmentStatus':
        """
        ...
        """
        return cls(
            site_no='opvwqmecimrosydzmbft',
            datetime='iesdnxtazdlggpmxmmhl',
            status='qchkkwmsurgswthhbtxn',
            parameter_cd='flihsagtsnhcgyxfmaqy',
            timeseries_cd='uvouilrfjxbhiutohiij'
        )
...
class Observation:
    ...
    Attributes:
        ...
        measurements (typing.Dict[str, MeasurementValue])
    """
    ...
    measurements: typing.Dict[str, MeasurementValue]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="measurements"))

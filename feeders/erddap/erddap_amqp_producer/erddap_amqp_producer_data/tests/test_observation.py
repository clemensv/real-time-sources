...
from erddap_amqp_producer_data.observation import Observation
...
class Test_Observation(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Observation(
            erddap_id='hmweyksiqlkkjtzsnoow',
            dataset_id='nuquxgawkaluggvgytyu',
            base_url='aphhozfqsheidvvzjjkp',
            station_id='wanzkxzmyfdkrhducrar',
            time='ohvdlrlyigmfypnnlpbd',
            latitude=float(70.7349879194269),
            longitude=float(22.26112985314903),
            depth=float(79.98699821852647),
            measurements={'odpttgmgaxgnbnckynzq': None, 'iuysbuhyhlgnmchbexaf': None, 'pxnvtloztqzqibsbprit': None}
        )
        return instance
    ...
    def test_erddap_id_property(self):
        ...
        """
        test_value = 'hmweyksiqlkkjtzsnoow'
    ...
    def test_dataset_id_property(self):
        ...
        """
        test_value = 'nuquxgawkaluggvgytyu'
    ...
    def test_base_url_property(self):
        ...
        """
        test_value = 'aphhozfqsheidvvzjjkp'
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'wanzkxzmyfdkrhducrar'
    ...
    def test_time_property(self):
        ...
        Test time property
        """
        test_value = 'ohvdlrlyigmfypnnlpbd'
    ...
    def test_latitude_property(self):
        ...
        """
        test_value = float(70.7349879194269)
    ...
    def test_longitude_property(self):
        ...
        """
        test_value = float(22.26112985314903)
    ...
    def test_depth_property(self):
        ...
        Test depth property
        """
        test_value = float(79.98699821852647)
    ...
    def test_measurements_property(self):
        ...
        """
        test_value = {'odpttgmgaxgnbnckynzq': None, 'iuysbuhyhlgnmchbexaf': None, 'pxnvtloztqzqibsbprit': None}

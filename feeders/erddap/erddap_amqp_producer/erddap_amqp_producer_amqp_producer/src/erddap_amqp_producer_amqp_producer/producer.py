...
class OrgErddapAmqpDatasetProducer:
    """
    Producer class to send messages in the `org.erddap.amqp.dataset` message group via AMQP 1.0 protocol.
    """
    ...
    def send_dataset_metadata(self,
        ...
        """
        Send the `org.erddap.amqp.DatasetMetadata` message
        ...
        attributes = {
            ...
            "subject":
            "{erddap_id}/{dataset_id}".format(erddap_id=_erddap_id, dataset_id=_dataset_id),
        }
        ...
        amqp_msg.subject = "{erddap_id}/{dataset_id}".format(erddap_id=_erddap_id, dataset_id=_dataset_id)

        app_properties = {}
        app_properties["erddap_id"] = "{erddap_id}".format(erddap_id=_erddap_id)
        app_properties["dataset_id"] = "{dataset_id}".format(dataset_id=_dataset_id)
        if app_properties:
    ...
    def send_dataset_metadata_batch(self,
        data_array: typing.List[DatasetMetadata],
        _base_url: str,
        _erddap_id: str,
        _dataset_id: str,
        _time: typing.Optional[typing.Union[str, datetime]] = None,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `org.erddap.amqp.DatasetMetadata` messages
        
        Args:
            data_array (typing.List[DatasetMetadata]): Array of message data objects
            _base_url (str): Value for placeholder base_url in attribute source
            _erddap_id (str): Value for placeholder erddap_id in attribute subject
            _dataset_id (str): Value for placeholder dataset_id in attribute subject
            _time (typing.Optional[typing.Union[str, datetime]]): CloudEvents time override. Defaults to current UTC when no catalog time is used.
        ...
        for data in data_array:
            self.send_dataset_metadata(
                data=data,
                _base_url=_base_url,
                _erddap_id=_erddap_id,
...
class OrgErddapAmqpStationProducer:
    """
    Producer class to send messages in the `org.erddap.amqp.station` message group via AMQP 1.0 protocol.
    """
    ...
    def send_station_metadata(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `org.erddap.amqp.StationMetadata` message
        ...
        attributes = {
            ...
            "{base_url}".format(base_url=_base_url),
            "subject":
            "{erddap_id}/{dataset_id}/{station_id}".format(erddap_id=_erddap_id, dataset_id=_dataset_id, station_id=_station_id),
        }
        attributes["time"] = _resolve_cloudevents_time(_time, attributes.get("time"))
        ...
        if amqp_creation_time is not None:
            amqp_msg.creation_time = amqp_creation_time
        # Apply AMQP message properties declared in protocoloptions.properties.
        amqp_msg.subject = "{erddap_id}/{dataset_id}/{station_id}".format(erddap_id=_erddap_id, dataset_id=_dataset_id, station_id=_station_id)
    ...
    def send_station_metadata_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `org.erddap.amqp.StationMetadata` messages
    ...
    def send_observation(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `org.erddap.amqp.Observation` message
    ...
    def send_observation_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `org.erddap.amqp.Observation` messages

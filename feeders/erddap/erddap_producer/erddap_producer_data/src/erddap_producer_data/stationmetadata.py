...
class StationMetadata:
    ...
    attributes: typing.Dict[str, str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="attributes"))
    ...
    @classmethod
    def create_instance(cls) -> 'StationMetadata':
        """

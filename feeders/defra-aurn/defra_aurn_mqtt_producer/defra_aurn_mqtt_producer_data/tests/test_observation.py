...
from defra_aurn_mqtt_producer_data.uk.gov.defra.aurn.observation import Observation
import datetime
...
class Test_Observation(unittest.TestCase):
    ...
    def test_timeseries_id_property(self):
        ...
        """
        test_value = 'mivpxanjluwbxfoicbui'
    ...
    def test_value_property(self):
        ...
        Test value property
        """
        test_value = float(26.530865899865606)
    ...
    def test_uom_property(self):
        ...
        Test uom property
        """
        test_value = 'vzqbjxfkfarawqvhzaqz'

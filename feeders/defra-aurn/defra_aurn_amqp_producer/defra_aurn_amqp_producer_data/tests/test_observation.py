...
from defra_aurn_amqp_producer_data.uk.gov.defra.aurn.observation import Observation
import datetime
...
class Test_Observation(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Observation(
            timeseries_id='otwawixvwtxqaskdndqr',
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            value=float(61.207638072614316),
            uom='kztktcnxoafiwhqlphle'
        )
        return instance
    ...
    def test_timeseries_id_property(self):
        ...
        """
        test_value = 'otwawixvwtxqaskdndqr'
    ...
    def test_value_property(self):
        ...
        Test value property
        """
        test_value = float(61.207638072614316)
    ...
    def test_uom_property(self):
        ...
        Test uom property
        """
        test_value = 'kztktcnxoafiwhqlphle'

...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../defra_aurn_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../defra_aurn_amqp_producer_amqp_producer/src')))
...
class TestUkGovDefraAurnStationsAmqpProducer:
    """Test cases for UkGovDefraAurnStationsAmqpProducer"""
...
class TestUkGovDefraAurnTimeseriesAmqpProducer:
    """Test cases for UkGovDefraAurnTimeseriesAmqpProducer"""

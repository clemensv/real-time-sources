...
class UkGovDefraAurnStationsEventProducer:
    ...
    def send_uk_gov_defra_aurn_station(self,_station_id : str, data: Station, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
...
class UkGovDefraAurnTimeseriesEventProducer:
    ...
    def send_uk_gov_defra_aurn_timeseries(self,_timeseries_id : str, data: Timeseries, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Timeseries], str]=None) -> None:
        """
    ...
    def send_uk_gov_defra_aurn_observation(self,_timeseries_id : str, data: Observation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Observation], str]=None) -> None:
        """
...
class UkGovDefraAurnStationsMqttEventProducer:
    ...
    def send_uk_gov_defra_aurn_stations_mqtt_station(self,_station_id : str, data: Station, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
...
class UkGovDefraAurnStationsAmqpEventProducer:
    ...
    def send_uk_gov_defra_aurn_stations_amqp_station(self,_station_id : str, data: Station, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
...
class UkGovDefraAurnTimeseriesMqttEventProducer:
    ...
    def send_uk_gov_defra_aurn_timeseries_mqtt_timeseries(self,_timeseries_id : str, data: Timeseries, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Timeseries], str]=None) -> None:
        """
    ...
    def send_uk_gov_defra_aurn_timeseries_mqtt_observation(self,_timeseries_id : str, data: Observation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Observation], str]=None) -> None:
        """
...
class UkGovDefraAurnTimeseriesAmqpEventProducer:
    ...
    def send_uk_gov_defra_aurn_timeseries_amqp_timeseries(self,_timeseries_id : str, data: Timeseries, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Timeseries], str]=None) -> None:
        """
    ...
    def send_uk_gov_defra_aurn_timeseries_amqp_observation(self,_timeseries_id : str, data: Observation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Observation], str]=None) -> None:
        """

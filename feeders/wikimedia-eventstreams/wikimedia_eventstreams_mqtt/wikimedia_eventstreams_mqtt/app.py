...
async def _emit_mock_mqtt(client: WikimediaEventStreamsMqttMqttClient) -> None:
    ...
    for i in range(4):
        data = RecentChange.from_serializer_dict({
            ...
            "meta": {
                "uri": f"https://en.wikipedia.org/wiki/Mock_Article_{i}",
                "request_id": f"req-mock-{i}",
                "id": f"mock-{i:08d}",
                ...
                "partition": 0,
                "offset": str(i),
                "dt": datetime(2024, 1, 1, 0, 0, i, tzinfo=timezone.utc).isoformat(),
            },
            "id": str(1000 + i),
            "type": "edit",
            "namespace_id": 0,
            ...
            "title_url": f"https://en.wikipedia.org/wiki/Mock_Article_{i}",
            "comment": "mock edit",
            "timestamp": int(datetime(2024, 1, 1, 0, 0, i, tzinfo=timezone.utc).timestamp()),
            "user": "MockUser",
            "bot": False,
            "minor": False,
            "patrolled": False,
            "length": {"old": 100 + i, "new": 110 + i},
            "revision": {"old": str(1000 + i), "new": str(1001 + i)},
            "server_url": "https://en.wikipedia.org",
            "server_name": "en.wikipedia.org",
            "server_script_path": "/w",
            "wiki": "enwiki",
            "parsedcomment": "mock edit",
            "notify_url": None,
            "log_type": None,
            "log_action": None,
        ...
        await client.publish_wikimedia_event_streams_recent_change_mqtt(
            ...
            namespace="0",
            event_id=f"mock-{i:08d}",
            _time=datetime(2024, 1, 1, 0, 0, i, tzinfo=timezone.utc).isoformat(),
            data=data,
            qos=0,
            retain=False,
        )

...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../energidataservice_dk_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../energidataservice_dk_amqp_producer_amqp_producer/src')))
...
class TestDkEnerginetEnergidataserviceAmqpProducer:
    """Test cases for DkEnerginetEnergidataserviceAmqpProducer"""

"""AMQP companion feeder for energidataservice-dk. Publishes mock/sample CloudEvents for Docker E2E and auth-blocked upstreams."""
...
from energidataservice_dk_amqp_producer_amqp_producer import producer as producer_mod
import energidataservice_dk_amqp_producer_data as data_mod
...
def _val(name, typ):
    ...
    if 'country' in n: return 'gb' if 'energidataservice-dk'=='elexon-bmrs' else ('jp' if 'energidataservice-dk'=='tepco-denkiyoho' else 'dk' if 'energidataservice-dk'=='energidataservice-dk' else 'de' if 'energidataservice-dk'=='energy-charts' else 'nl')

...
class USEPAUVIndexEventProducer:
    ...
    def send_us_epa_uvindex_hourly_forecast(self,_location_id : str, data: HourlyForecast, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, HourlyForecast], str]=None) -> None:
        """
    ...
    def send_us_epa_uvindex_daily_forecast(self,_location_id : str, data: DailyForecast, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, DailyForecast], str]=None) -> None:
        """

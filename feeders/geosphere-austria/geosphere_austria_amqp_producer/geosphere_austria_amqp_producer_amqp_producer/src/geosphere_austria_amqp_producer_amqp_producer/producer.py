...
class AtGeosphereTawesAmqpProducer:
    """
    Producer class to send messages in the `at.geosphere.tawes.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_weather_station(self,
        ...
        """
        Send the `at.geosphere.tawes.amqp.WeatherStation` message
    ...
    def send_weather_station_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `at.geosphere.tawes.amqp.WeatherStation` messages
    ...
    def send_weather_observation(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `at.geosphere.tawes.amqp.WeatherObservation` message
    ...
    def send_weather_observation_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `at.geosphere.tawes.amqp.WeatherObservation` messages

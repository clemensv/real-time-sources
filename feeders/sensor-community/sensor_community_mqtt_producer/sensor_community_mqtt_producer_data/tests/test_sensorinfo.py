...
class Test_SensorInfo(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = SensorInfo(
            ...
            sensor_type_name='ciptxsmmafswgillcgrg',
            sensor_type_manufacturer='wtpviodgjjpqflcismrd',
            pin='cdxkakjjamzjpvmfobbz',
            location_id=int(54),
            latitude=float(71.94749506586868),
            longitude=float(90.31533236378958),
            altitude=float(24.521202969548185),
            country='vbrzshgichgkyvsnrogr',
            indoor=True
        )
        return instance
    ...
    def test_sensor_type_name_property(self):
        ...
        """
        test_value = 'ciptxsmmafswgillcgrg'
    ...
    def test_sensor_type_manufacturer_property(self):
        ...
        """
        test_value = 'wtpviodgjjpqflcismrd'
    ...
    def test_pin_property(self):
        ...
        Test pin property
        """
        test_value = 'cdxkakjjamzjpvmfobbz'
    ...
    def test_latitude_property(self):
        ...
        """
        test_value = float(71.94749506586868)
    ...
    def test_longitude_property(self):
        ...
        """
        test_value = float(90.31533236378958)
    ...
    def test_altitude_property(self):
        ...
        """
        test_value = float(24.521202969548185)
    ...
    def test_country_property(self):
        ...
        """
        test_value = 'vbrzshgichgkyvsnrogr'

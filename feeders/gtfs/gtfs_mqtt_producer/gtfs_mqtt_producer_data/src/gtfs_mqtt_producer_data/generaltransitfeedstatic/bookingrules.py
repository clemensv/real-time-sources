...
class BookingRules:
    ...
    @classmethod
    def create_instance(cls) -> 'BookingRules':
        """
        ...
        """
        return cls(
            bookingRuleId='ccwqxzmusjovyfgnhwkf',
            bookingRuleName='pexpmoijqyzqjqqrvsgs',
            bookingRuleDesc='rphobjvlbzvuuodzgqzb',
            bookingRuleUrl='rmbxaxxypbplvxqutoxn'
        )
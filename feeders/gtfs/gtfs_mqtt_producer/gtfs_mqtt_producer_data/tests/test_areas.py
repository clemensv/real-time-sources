...
from gtfs_mqtt_producer_data.generaltransitfeedstatic.areas import Areas
...
class Test_Areas(unittest.TestCase):
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'funfmjwxmtkxrdgdfedr'
    ...
    def test_areaName_property(self):
        ...
        """
        test_value = 'qaeoyougnyhzgkwnwfza'
    ...
    def test_areaDesc_property(self):
        ...
        """
        test_value = 'ficrrunhzzkuitiwvjbg'
    ...
    def test_areaUrl_property(self):
        ...
        """
        test_value = 'klwheibmcwcfrymnfsvn'

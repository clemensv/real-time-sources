...
from gtfs_mqtt_producer_data.generaltransitfeedstatic.locationgroups import LocationGroups
...
class Test_LocationGroups(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = LocationGroups(
            locationGroupId='gufwihdhjjdrraeedgig',
            locationGroupName='pnjfwhimbjjebpmyxmvp',
            locationGroupDesc='nsaxekbckzvblsjxkkhn',
            locationGroupUrl='xepccplcozffwonnhdjq'
        )
        return instance
    ...
    def test_locationGroupId_property(self):
        ...
        """
        test_value = 'gufwihdhjjdrraeedgig'
    ...
    def test_locationGroupName_property(self):
        ...
        """
        test_value = 'pnjfwhimbjjebpmyxmvp'
    ...
    def test_locationGroupDesc_property(self):
        ...
        """
        test_value = 'nsaxekbckzvblsjxkkhn'
    ...
    def test_locationGroupUrl_property(self):
        ...
        """
        test_value = 'xepccplcozffwonnhdjq'
    ...
    def test_to_json(self):
        ...
        new_instance = LocationGroups.from_json(json_data)

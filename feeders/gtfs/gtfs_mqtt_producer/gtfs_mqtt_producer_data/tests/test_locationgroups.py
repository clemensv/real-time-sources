...
class Test_LocationGroups(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = LocationGroups(
            locationGroupId='zyyxxsaklmvqdisxpelr',
            locationGroupName='otxbavowcctpkbvzrfgs',
            locationGroupDesc='qsrcplkdfnepsulylelr',
            locationGroupUrl='ihfqtvjckdoamyoxsbev'
        )
        return instance
    ...
    def test_locationGroupId_property(self):
        ...
        """
        test_value = 'zyyxxsaklmvqdisxpelr'
    ...
    def test_locationGroupName_property(self):
        ...
        """
        test_value = 'otxbavowcctpkbvzrfgs'
    ...
    def test_locationGroupDesc_property(self):
        ...
        """
        test_value = 'qsrcplkdfnepsulylelr'
    ...
    def test_locationGroupUrl_property(self):
        ...
        """
        test_value = 'ihfqtvjckdoamyoxsbev'

...
class Test_Calendar(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Calendar(
            serviceId='fmmjvwbhzsmvcpwvffjp',
            monday=None,
            tuesday=None,
            wednesday=None,
            thursday=None,
            ...
            saturday=None,
            sunday=None,
            startDate='uxhqmrkqcemurcxffern',
            endDate='kuxwpwkyvkuxnbyqpolh'
        )
        return instance
    ...
    def test_serviceId_property(self):
        ...
        """
        test_value = 'fmmjvwbhzsmvcpwvffjp'
    ...
    def test_startDate_property(self):
        ...
        """
        test_value = 'uxhqmrkqcemurcxffern'
    ...
    def test_endDate_property(self):
        ...
        """
        test_value = 'kuxwpwkyvkuxnbyqpolh'

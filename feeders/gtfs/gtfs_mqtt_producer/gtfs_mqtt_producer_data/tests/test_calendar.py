...
class Test_Calendar(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Calendar(
            serviceId='wxpnqapfdyvredtbgrzs',
            monday=None,
            tuesday=None,
            wednesday=None,
            thursday=None,
            ...
            saturday=None,
            sunday=None,
            startDate='jbngvvgdxhtpxrlwnvmz',
            endDate='uejknkhsqicsarjmnwmu'
        )
        return instance
    ...
    def test_serviceId_property(self):
        ...
        """
        test_value = 'wxpnqapfdyvredtbgrzs'
    ...
    def test_startDate_property(self):
        ...
        """
        test_value = 'jbngvvgdxhtpxrlwnvmz'
    ...
    def test_endDate_property(self):
        ...
        """
        test_value = 'uejknkhsqicsarjmnwmu'

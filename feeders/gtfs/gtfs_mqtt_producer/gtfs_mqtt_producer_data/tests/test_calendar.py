...
class Test_Calendar(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Calendar(
            serviceId='frkcoghyocecejcfhgpn',
            monday=None,
            tuesday=None,
            wednesday=None,
            thursday=None,
            ...
            saturday=None,
            sunday=None,
            startDate='gvynwmdqcoxvrjpehjuw',
            endDate='oixyxczixilbzqpsiomb'
        )
        return instance
    ...
    def test_serviceId_property(self):
        ...
        """
        test_value = 'frkcoghyocecejcfhgpn'
    ...
    def test_startDate_property(self):
        ...
        """
        test_value = 'gvynwmdqcoxvrjpehjuw'
    ...
    def test_endDate_property(self):
        ...
        """
        test_value = 'oixyxczixilbzqpsiomb'

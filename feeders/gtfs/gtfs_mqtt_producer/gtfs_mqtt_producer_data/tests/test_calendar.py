...
class Test_Calendar(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Calendar(
            serviceId='kpfndxknfqzxropdrorb',
            monday=None,
            tuesday=None,
            wednesday=None,
            thursday=None,
            ...
            saturday=None,
            sunday=None,
            startDate='kqgoroglpszyhxlyrtsl',
            endDate='whniyougcxwisqadderg'
        )
        return instance
    ...
    def test_serviceId_property(self):
        ...
        """
        test_value = 'kpfndxknfqzxropdrorb'
    ...
    def test_startDate_property(self):
        ...
        """
        test_value = 'kqgoroglpszyhxlyrtsl'
    ...
    def test_endDate_property(self):
        ...
        """
        test_value = 'whniyougcxwisqadderg'

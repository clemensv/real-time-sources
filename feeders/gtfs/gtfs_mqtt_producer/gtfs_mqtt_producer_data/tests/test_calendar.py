...
class Test_Calendar(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Calendar(
            serviceId='zxelevxieqpyskeklzlq',
            monday=None,
            tuesday=None,
            wednesday=None,
            thursday=None,
            ...
            saturday=None,
            sunday=None,
            startDate='tprogpqrdjdtwkmonpfw',
            endDate='uxtmosqiutuhaxehsauv'
        )
        return instance
    ...
    def test_serviceId_property(self):
        ...
        """
        test_value = 'zxelevxieqpyskeklzlq'
    ...
    def test_startDate_property(self):
        ...
        """
        test_value = 'tprogpqrdjdtwkmonpfw'
    ...
    def test_endDate_property(self):
        ...
        """
        test_value = 'uxtmosqiutuhaxehsauv'

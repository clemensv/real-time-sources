...
class Test_Calendar(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Calendar(
            serviceId='hawhaggfnyfteuvxqpgx',
            monday=None,
            tuesday=None,
            wednesday=None,
            thursday=None,
            ...
            saturday=None,
            sunday=None,
            startDate='cbbcroosmszjxpqvamhx',
            endDate='tkkkokoimvdwjdexyuwg'
        )
        return instance
    ...
    def test_serviceId_property(self):
        ...
        """
        test_value = 'hawhaggfnyfteuvxqpgx'
    ...
    def test_startDate_property(self):
        ...
        """
        test_value = 'cbbcroosmszjxpqvamhx'
    ...
    def test_endDate_property(self):
        ...
        """
        test_value = 'tkkkokoimvdwjdexyuwg'

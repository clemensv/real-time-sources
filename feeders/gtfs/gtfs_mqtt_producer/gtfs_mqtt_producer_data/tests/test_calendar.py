...
class Test_Calendar(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Calendar(
            serviceId='iivbuwijofpqbwjymisj',
            monday=None,
            tuesday=None,
            wednesday=None,
            thursday=None,
            ...
            saturday=None,
            sunday=None,
            startDate='szntfarpqwxmdribytcs',
            endDate='bccsyagtjbowfonzfzkp'
        )
        return instance
    ...
    def test_serviceId_property(self):
        ...
        """
        test_value = 'iivbuwijofpqbwjymisj'
    ...
    def test_startDate_property(self):
        ...
        """
        test_value = 'szntfarpqwxmdribytcs'
    ...
    def test_endDate_property(self):
        ...
        """
        test_value = 'bccsyagtjbowfonzfzkp'

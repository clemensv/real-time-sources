...
class Test_Calendar(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Calendar(
            serviceId='uisbeipuakcdoibaruip',
            monday=None,
            tuesday=None,
            wednesday=None,
            thursday=None,
            ...
            saturday=None,
            sunday=None,
            startDate='orurlllngpuydnpewbyb',
            endDate='fktlviaolnfzgycxpvfa'
        )
        return instance
    ...
    def test_serviceId_property(self):
        ...
        """
        test_value = 'uisbeipuakcdoibaruip'
    ...
    def test_startDate_property(self):
        ...
        """
        test_value = 'orurlllngpuydnpewbyb'
    ...
    def test_endDate_property(self):
        ...
        """
        test_value = 'fktlviaolnfzgycxpvfa'

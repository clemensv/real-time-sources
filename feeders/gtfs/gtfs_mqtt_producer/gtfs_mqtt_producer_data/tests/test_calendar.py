...
class Test_Calendar(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Calendar(
            serviceId='tnncjmjtvrfnvlaaizzk',
            monday=None,
            tuesday=None,
            wednesday=None,
            thursday=None,
            ...
            saturday=None,
            sunday=None,
            startDate='fspcmzponapykorfmmam',
            endDate='zcaqpmsgcsuvehulbaxg'
        )
        return instance
    ...
    def test_serviceId_property(self):
        ...
        """
        test_value = 'tnncjmjtvrfnvlaaizzk'
    ...
    def test_startDate_property(self):
        ...
        """
        test_value = 'fspcmzponapykorfmmam'
    ...
    def test_endDate_property(self):
        ...
        """
        test_value = 'zcaqpmsgcsuvehulbaxg'

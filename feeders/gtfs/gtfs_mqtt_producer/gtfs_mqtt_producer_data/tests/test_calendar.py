...
class Test_Calendar(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Calendar(
            serviceId='sogharnnosaepywrsjav',
            monday=None,
            tuesday=None,
            wednesday=None,
            thursday=None,
            ...
            saturday=None,
            sunday=None,
            startDate='htqcjowhgrmvfelyxxdo',
            endDate='bxhnulpxyaakjtwarfmh'
        )
        return instance
    ...
    def test_serviceId_property(self):
        ...
        """
        test_value = 'sogharnnosaepywrsjav'
    ...
    def test_startDate_property(self):
        ...
        """
        test_value = 'htqcjowhgrmvfelyxxdo'
    ...
    def test_endDate_property(self):
        ...
        """
        test_value = 'bxhnulpxyaakjtwarfmh'

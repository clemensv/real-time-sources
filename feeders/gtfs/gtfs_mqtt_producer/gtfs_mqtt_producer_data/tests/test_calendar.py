...
class Test_Calendar(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Calendar(
            serviceId='sjzfyqfndixvdyhnbwtl',
            monday=None,
            tuesday=None,
            wednesday=None,
            thursday=None,
            ...
            saturday=None,
            sunday=None,
            startDate='owpuxquureivhcbanosa',
            endDate='nkhoxexotostvzvxfurf'
        )
        return instance
    ...
    def test_serviceId_property(self):
        ...
        """
        test_value = 'sjzfyqfndixvdyhnbwtl'
    ...
    def test_startDate_property(self):
        ...
        """
        test_value = 'owpuxquureivhcbanosa'
    ...
    def test_endDate_property(self):
        ...
        """
        test_value = 'nkhoxexotostvzvxfurf'

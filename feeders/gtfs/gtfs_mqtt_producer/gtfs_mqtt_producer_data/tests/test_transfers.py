...
from gtfs_mqtt_producer_data.generaltransitfeedstatic.transfers import Transfers
...
class Test_Transfers(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Transfers(
            fromStopId='uzxqnrxjoldgbudgwkno',
            toStopId='uacblvailxcbuchnwsjk',
            transferType=int(16),
            minTransferTime=int(17)
        )
        return instance
    ...
    def test_fromStopId_property(self):
        ...
        """
        test_value = 'uzxqnrxjoldgbudgwkno'
    ...
    def test_toStopId_property(self):
        ...
        """
        test_value = 'uacblvailxcbuchnwsjk'

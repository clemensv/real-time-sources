...
from gtfs_mqtt_producer_data.generaltransitfeedstatic.farerules import FareRules
...
class Test_FareRules(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = FareRules(
            fareId='eiymajpriboovnqjtgnm',
            routeId='zvnxylstxvxpkvjzbdph',
            originId='wqkygbgjimditvvfjqwt',
            destinationId='kclicwgwmfrdwdygnkpg',
            containsId='hyeezdwplkvxlihhljcf'
        )
        return instance
    ...
    def test_fareId_property(self):
        ...
        """
        test_value = 'eiymajpriboovnqjtgnm'
    ...
    def test_routeId_property(self):
        ...
        """
        test_value = 'zvnxylstxvxpkvjzbdph'
    ...
    def test_originId_property(self):
        ...
        """
        test_value = 'wqkygbgjimditvvfjqwt'
    ...
    def test_destinationId_property(self):
        ...
        """
        test_value = 'kclicwgwmfrdwdygnkpg'
    ...
    def test_containsId_property(self):
        ...
        """
        test_value = 'hyeezdwplkvxlihhljcf'

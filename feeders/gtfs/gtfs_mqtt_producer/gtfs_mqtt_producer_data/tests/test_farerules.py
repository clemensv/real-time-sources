...
class Test_FareRules(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = FareRules(
            fareId='cgxyfszshdhalppfztnb',
            routeId='bwbuwtwyouofwjufjgba',
            originId='yneajzigxjsjgrjwrhht',
            destinationId='shqekycjdalhlaokpthm',
            containsId='esnazzjzozezzyemtvax'
        )
        return instance
    ...
    def test_fareId_property(self):
        ...
        """
        test_value = 'cgxyfszshdhalppfztnb'
    ...
    def test_routeId_property(self):
        ...
        """
        test_value = 'bwbuwtwyouofwjufjgba'
    ...
    def test_originId_property(self):
        ...
        """
        test_value = 'yneajzigxjsjgrjwrhht'
    ...
    def test_destinationId_property(self):
        ...
        """
        test_value = 'shqekycjdalhlaokpthm'
    ...
    def test_containsId_property(self):
        ...
        """
        test_value = 'esnazzjzozezzyemtvax'

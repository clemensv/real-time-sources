...
from gtfs_mqtt_producer_data.generaltransitfeedstatic.frequencies import Frequencies
...
class Test_Frequencies(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Frequencies(
            tripId='uuibysdrfrdtkgfhnbyh',
            startTime='kmpzgmfbyubylavkcacn',
            endTime='fabaswsbqsbrliwqvlas',
            headwaySecs=int(70),
            exactTimes=int(92)
        )
        return instance
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'uuibysdrfrdtkgfhnbyh'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'kmpzgmfbyubylavkcacn'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'fabaswsbqsbrliwqvlas'

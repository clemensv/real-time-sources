...
class Test_Frequencies(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Frequencies(
            tripId='opqluvazphyczdikcncn',
            startTime='kyxobfhfhtvbumyrxrxb',
            endTime='prcjdjafmgutbihrcyrb',
            headwaySecs=int(58),
            exactTimes=int(38)
        )
        return instance
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'opqluvazphyczdikcncn'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'kyxobfhfhtvbumyrxrxb'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'prcjdjafmgutbihrcyrb'

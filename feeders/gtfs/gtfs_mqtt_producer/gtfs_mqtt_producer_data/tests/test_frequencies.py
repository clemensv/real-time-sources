...
class Test_Frequencies(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Frequencies(
            tripId='jmvwwkiomxbcculeotyh',
            startTime='ktntrnxguxaegzungtpr',
            endTime='uzgszybpyoplgauilicq',
            headwaySecs=int(63),
            exactTimes=int(60)
        )
        return instance
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'jmvwwkiomxbcculeotyh'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'ktntrnxguxaegzungtpr'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'uzgszybpyoplgauilicq'

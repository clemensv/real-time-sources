...
class Test_Frequencies(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Frequencies(
            tripId='nbhfzizrlddwukqbvayw',
            startTime='oeywpfihaaptoogkcknw',
            endTime='hztmixhzdwxooxpaerxx',
            headwaySecs=int(93),
            exactTimes=int(24)
        )
        return instance
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'nbhfzizrlddwukqbvayw'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'oeywpfihaaptoogkcknw'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'hztmixhzdwxooxpaerxx'

...
class Test_Frequencies(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Frequencies(
            tripId='cbjesqhfiuhkhppuxquk',
            startTime='stxokgobkkabvqhtucim',
            endTime='jafjpgkdkmybpdumhvtf',
            headwaySecs=int(62),
            exactTimes=int(4)
        )
        return instance
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'cbjesqhfiuhkhppuxquk'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'stxokgobkkabvqhtucim'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'jafjpgkdkmybpdumhvtf'

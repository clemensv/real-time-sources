...
class Test_Frequencies(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Frequencies(
            tripId='jzyjgjatfmyuziwldeyr',
            startTime='koebfiymlrikjggjeoxm',
            endTime='fnrhxanmndheqwnhqzfg',
            headwaySecs=int(97),
            exactTimes=int(19)
        )
        return instance
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'jzyjgjatfmyuziwldeyr'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'koebfiymlrikjggjeoxm'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'fnrhxanmndheqwnhqzfg'

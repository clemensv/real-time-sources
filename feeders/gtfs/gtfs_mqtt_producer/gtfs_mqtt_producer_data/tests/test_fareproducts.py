...
from gtfs_mqtt_producer_data.generaltransitfeedstatic.fareproducts import FareProducts
...
class Test_FareProducts(unittest.TestCase):
    ...
    def test_fareProductId_property(self):
        ...
        """
        test_value = 'ejjtsekylaeaeoyuokyx'
    ...
    def test_fareProductName_property(self):
        ...
        """
        test_value = 'nqmxljxxjnxciwnoskfd'
    ...
    def test_fareProductDesc_property(self):
        ...
        """
        test_value = 'xhzcwxsuplkltqeuiydx'
    ...
    def test_fareProductUrl_property(self):
        ...
        """
        test_value = 'uigwxsixqkbedjxqrbfp'

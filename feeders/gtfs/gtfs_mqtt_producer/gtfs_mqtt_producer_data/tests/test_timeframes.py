...
from gtfs_mqtt_producer_data.generaltransitfeedstatic.timeframes import Timeframes
...
class Test_Timeframes(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Timeframes(
            timeframeGroupId='qofofslefcgrlanhicfl',
            startTime='wwbwqzniixnsmhwnmdax',
            endTime='yorjmxlfrukrnpirzwwg',
            serviceDates=None
        )
        return instance
    ...
    def test_timeframeGroupId_property(self):
        ...
        """
        test_value = 'qofofslefcgrlanhicfl'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'wwbwqzniixnsmhwnmdax'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'yorjmxlfrukrnpirzwwg'

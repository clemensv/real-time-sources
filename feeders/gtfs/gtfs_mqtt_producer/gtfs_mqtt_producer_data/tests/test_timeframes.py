...
class Test_Timeframes(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Timeframes(
            timeframeGroupId='rozagblryoquvggkapql',
            startTime='iudsuglhyghxfkwkfgtd',
            endTime='egvegoqhvjryvdtqhdxp',
            serviceDates=None
        )
        return instance
    ...
    def test_timeframeGroupId_property(self):
        ...
        """
        test_value = 'rozagblryoquvggkapql'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'iudsuglhyghxfkwkfgtd'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'egvegoqhvjryvdtqhdxp'

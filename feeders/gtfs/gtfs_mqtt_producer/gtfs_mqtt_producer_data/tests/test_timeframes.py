...
class Test_Timeframes(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Timeframes(
            timeframeGroupId='fvihyqqgbxaujietvrdk',
            startTime='hkhxoqaxscgskrrocszz',
            endTime='tnaiujcbuwdzrfhchmop',
            serviceDates=None
        )
        return instance
    ...
    def test_timeframeGroupId_property(self):
        ...
        """
        test_value = 'fvihyqqgbxaujietvrdk'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'hkhxoqaxscgskrrocszz'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'tnaiujcbuwdzrfhchmop'

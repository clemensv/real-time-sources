...
from gtfs_mqtt_producer_data.generaltransitfeedstatic.faremedia import FareMedia
...
class Test_FareMedia(unittest.TestCase):
    ...
    def test_fareMediaId_property(self):
        ...
        """
        test_value = 'juhlxqbedhqyyddbxdlq'
    ...
    def test_fareMediaName_property(self):
        ...
        """
        test_value = 'rsplssybrugedpekvwbq'
    ...
    def test_fareMediaDesc_property(self):
        ...
        """
        test_value = 'juygvfwnufmhhgfkqkxe'
    ...
    def test_fareMediaUrl_property(self):
        ...
        """
        test_value = 'zvowesfjkejhhynfwuzj'

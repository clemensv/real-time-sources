...
class Test_EntitySelector(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = EntitySelector(
            agency_id='gxxhxulewcyrvsnwqjiv',
            route_id='qjvuofoijuaygerncejs',
            route_type=int(74),
            trip=None,
            stop_id='mnxjdltojykabxstjodg'
        )
        return instance
    ...
    def test_agency_id_property(self):
        ...
        """
        test_value = 'gxxhxulewcyrvsnwqjiv'
    ...
    def test_route_id_property(self):
        ...
        """
        test_value = 'qjvuofoijuaygerncejs'
    ...
    def test_stop_id_property(self):
        ...
        """
        test_value = 'mnxjdltojykabxstjodg'

...
from gtfs_mqtt_producer_data.generaltransitfeedstatic.networks import Networks
...
class Test_Networks(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Networks(
            networkId='cjmlmyxgeqhfdexrackk',
            networkName='enllideashiwbsuzvyhl',
            networkDesc='axibvzpbsevuckxmunte',
            networkUrl='jthtqmlontoolgirhayu'
        )
        return instance
    ...
    def test_networkId_property(self):
        ...
        """
        test_value = 'cjmlmyxgeqhfdexrackk'
    ...
    def test_networkName_property(self):
        ...
        """
        test_value = 'enllideashiwbsuzvyhl'
    ...
    def test_networkDesc_property(self):
        ...
        """
        test_value = 'axibvzpbsevuckxmunte'
    ...
    def test_networkUrl_property(self):
        ...
        """
        test_value = 'jthtqmlontoolgirhayu'

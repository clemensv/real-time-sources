...
from gtfs_mqtt_producer_data.generaltransitfeedstatic.routenetworks import RouteNetworks
...
class Test_RouteNetworks(unittest.TestCase):
    ...
    def test_routeNetworkId_property(self):
        ...
        """
        test_value = 'hwjdcpikjzqsqizajzvu'
    ...
    def test_routeId_property(self):
        ...
        """
        test_value = 'eqxawjagnqokfbezbnit'
    ...
    def test_networkId_property(self):
        ...
        """
        test_value = 'cvkrqulhjezidkaggnlk'

...
from gtfs_mqtt_producer_data.generaltransitfeedstatic.locationgeojson import LocationGeoJson
...
class Test_LocationGeoJson(unittest.TestCase):
    ...
    def test_locationGeoJsonId_property(self):
        ...
        """
        test_value = 'reibudpwupucwrddgush'
    ...
    def test_locationGeoJsonType_property(self):
        ...
        """
        test_value = 'xmjkbpxidsrinfbflbff'
    ...
    def test_locationGeoJsonData_property(self):
        ...
        """
        test_value = 'knpglcyxjobtvbbwtxoo'
    ...
    def test_to_json(self):
        ...
        new_instance = LocationGeoJson.from_json(json_data)

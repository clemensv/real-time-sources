...
from gtfs_mqtt_producer_data.generaltransitfeedstatic.stopareas import StopAreas
...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='jquqqoomjvqhxvybpccm',
            stopId='qtmiqvrszuovtfwwndol',
            areaId='lsiwyogiphoqpcuuzsfe'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'jquqqoomjvqhxvybpccm'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'qtmiqvrszuovtfwwndol'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'lsiwyogiphoqpcuuzsfe'
    ...
    def test_to_json(self):
        ...
        new_instance = StopAreas.from_json(json_data)

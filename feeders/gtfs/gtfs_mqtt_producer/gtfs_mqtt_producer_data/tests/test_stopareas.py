...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='diooufjcrgwpzlfwriaw',
            stopId='ohfszppprmzetylktlkp',
            areaId='zdeyzegqesxlzdnzshtb'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'diooufjcrgwpzlfwriaw'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'ohfszppprmzetylktlkp'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'zdeyzegqesxlzdnzshtb'

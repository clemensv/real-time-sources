...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='fdwmsnsfruosmbjzynmq',
            stopId='kkfhiphgvlnttjmpcxob',
            areaId='ebudrdhmcgnzmkvwasbq'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'fdwmsnsfruosmbjzynmq'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'kkfhiphgvlnttjmpcxob'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'ebudrdhmcgnzmkvwasbq'

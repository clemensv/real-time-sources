...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='kzkcxdxwtjgtvuvxryjr',
            stopId='ndkkjwpvljxfavzcjteh',
            areaId='mvyhbmaglyuunzqzqdxp'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'kzkcxdxwtjgtvuvxryjr'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'ndkkjwpvljxfavzcjteh'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'mvyhbmaglyuunzqzqdxp'

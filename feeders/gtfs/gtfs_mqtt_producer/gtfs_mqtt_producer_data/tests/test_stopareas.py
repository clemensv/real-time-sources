...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='lxgizzrmnhwlhnbyzrsa',
            stopId='bhhuhrtvvbutkhoxkplj',
            areaId='tebvkzhajgxjqngxfkyv'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'lxgizzrmnhwlhnbyzrsa'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'bhhuhrtvvbutkhoxkplj'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'tebvkzhajgxjqngxfkyv'

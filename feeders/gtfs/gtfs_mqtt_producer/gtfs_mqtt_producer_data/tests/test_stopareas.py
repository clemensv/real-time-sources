...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='hwlflveshgnclmfdifjp',
            stopId='plsvrmjhapvtdcypjpbo',
            areaId='kccvzdgijkrscbaxluyy'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'hwlflveshgnclmfdifjp'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'plsvrmjhapvtdcypjpbo'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'kccvzdgijkrscbaxluyy'

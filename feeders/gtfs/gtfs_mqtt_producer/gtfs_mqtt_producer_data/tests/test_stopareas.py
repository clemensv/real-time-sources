...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='qesbjalfhqagsyhxuztl',
            stopId='bffkqbagwxgyyqbkxqcn',
            areaId='cjjqkyhqbkekizuweiql'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'qesbjalfhqagsyhxuztl'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'bffkqbagwxgyyqbkxqcn'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'cjjqkyhqbkekizuweiql'

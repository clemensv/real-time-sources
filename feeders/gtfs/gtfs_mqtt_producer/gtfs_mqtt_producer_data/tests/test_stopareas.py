...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='csypzmgagowrrmrzsnve',
            stopId='ndvzxngxzjuqgvaqffxm',
            areaId='dmgqaasdoczzeqcqlxjt'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'csypzmgagowrrmrzsnve'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'ndvzxngxzjuqgvaqffxm'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'dmgqaasdoczzeqcqlxjt'

...
class Test_FareAttributes(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = FareAttributes(
            fareId='amxghgyqubtvtcacgaau',
            price=float(52.18626924253894),
            currencyType='brrvrviwcueyrtruxukp',
            paymentMethod=int(19),
            transfers=int(2),
            agencyId='tuclpdqwiasbdvkjftyz',
            transferDuration=int(5)
        )
        return instance
    ...
    def test_fareId_property(self):
        ...
        """
        test_value = 'amxghgyqubtvtcacgaau'
    ...
    def test_price_property(self):
        ...
        Test price property
        """
        test_value = float(52.18626924253894)
    ...
    def test_currencyType_property(self):
        ...
        """
        test_value = 'brrvrviwcueyrtruxukp'
    ...
    def test_agencyId_property(self):
        ...
        """
        test_value = 'tuclpdqwiasbdvkjftyz'

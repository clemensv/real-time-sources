...
class Test_Trips(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Trips(
            routeId='gmxukrcefgfqyalyuwdb',
            serviceDates=None,
            serviceExceptions=[None, None, None, None, None],
            tripId='jafbmlfxfnjhaldytosj',
            tripHeadsign='grsydhcgrxpfwjmcpblv',
            tripShortName='jpnpzoymvipquaaduncs',
            directionId=None,
            blockId='ljuhmqvdxddfmeqvkcjt',
            shapeId='lnqtgfogjjekjuwwlexy',
    ...
    def test_routeId_property(self):
        ...
        """
        test_value = 'gmxukrcefgfqyalyuwdb'
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'jafbmlfxfnjhaldytosj'
    ...
    def test_tripHeadsign_property(self):
        ...
        """
        test_value = 'grsydhcgrxpfwjmcpblv'
    ...
    def test_tripShortName_property(self):
        ...
        """
        test_value = 'jpnpzoymvipquaaduncs'
    ...
    def test_blockId_property(self):
        ...
        """
        test_value = 'ljuhmqvdxddfmeqvkcjt'
    ...
    def test_shapeId_property(self):
        ...
        """
        test_value = 'lnqtgfogjjekjuwwlexy'

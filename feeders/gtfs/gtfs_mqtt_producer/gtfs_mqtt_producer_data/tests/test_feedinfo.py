...
class Test_FeedInfo(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = FeedInfo(
            feedPublisherName='areabiwpcraleqsmgzdy',
            feedPublisherUrl='buqgeryluupeihrwgfkk',
            feedLang='gltqainjutladoggmbbq',
            defaultLang='pyujfphmanujuegrqkvi',
            feedStartDate='qcqlpleqbbfsaxjrqdyd',
            feedEndDate='uafwmeuiwceyyjsqlqzk',
            feedVersion='qjflrasxdxnlqapnokrh',
            feedContactEmail='khzqtlnrpibneakfwbfk',
            feedContactUrl='jkvcvnnrdavehdrnkvoq'
        )
        return instance
    ...
    def test_feedPublisherName_property(self):
        ...
        """
        test_value = 'areabiwpcraleqsmgzdy'
    ...
    def test_feedPublisherUrl_property(self):
        ...
        """
        test_value = 'buqgeryluupeihrwgfkk'
    ...
    def test_feedLang_property(self):
        ...
        """
        test_value = 'gltqainjutladoggmbbq'
    ...
    def test_defaultLang_property(self):
        ...
        """
        test_value = 'pyujfphmanujuegrqkvi'
    ...
    def test_feedStartDate_property(self):
        ...
        """
        test_value = 'qcqlpleqbbfsaxjrqdyd'
    ...
    def test_feedEndDate_property(self):
        ...
        """
        test_value = 'uafwmeuiwceyyjsqlqzk'
    ...
    def test_feedVersion_property(self):
        ...
        """
        test_value = 'qjflrasxdxnlqapnokrh'
    ...
    def test_feedContactEmail_property(self):
        ...
        """
        test_value = 'khzqtlnrpibneakfwbfk'
    ...
    def test_feedContactUrl_property(self):
        ...
        """
        test_value = 'jkvcvnnrdavehdrnkvoq'

...
class Test_FeedInfo(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = FeedInfo(
            feedPublisherName='bjgddiichwnrrimrlqmo',
            feedPublisherUrl='vubvkcobirexfooispmm',
            feedLang='zatnuzjqlfsgqxpzyhvz',
            defaultLang='tberhztxapgejoiszmut',
            feedStartDate='gyfnssakngeitwmdwcxp',
            feedEndDate='qwuzjqdqwcsmddsdjeqp',
            feedVersion='wbyuuzvnddeoqvezuqil',
            feedContactEmail='kizpevdrtjsefzurbtje',
            feedContactUrl='viujeqbbrwzoorxafazo'
        )
        return instance
    ...
    def test_feedPublisherName_property(self):
        ...
        """
        test_value = 'bjgddiichwnrrimrlqmo'
    ...
    def test_feedPublisherUrl_property(self):
        ...
        """
        test_value = 'vubvkcobirexfooispmm'
    ...
    def test_feedLang_property(self):
        ...
        """
        test_value = 'zatnuzjqlfsgqxpzyhvz'
    ...
    def test_defaultLang_property(self):
        ...
        """
        test_value = 'tberhztxapgejoiszmut'
    ...
    def test_feedStartDate_property(self):
        ...
        """
        test_value = 'gyfnssakngeitwmdwcxp'
    ...
    def test_feedEndDate_property(self):
        ...
        """
        test_value = 'qwuzjqdqwcsmddsdjeqp'
    ...
    def test_feedVersion_property(self):
        ...
        """
        test_value = 'wbyuuzvnddeoqvezuqil'
    ...
    def test_feedContactEmail_property(self):
        ...
        """
        test_value = 'kizpevdrtjsefzurbtje'
    ...
    def test_feedContactUrl_property(self):
        ...
        """
        test_value = 'viujeqbbrwzoorxafazo'

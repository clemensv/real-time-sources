...
from gtfs_mqtt_producer_data.generaltransitfeedstatic.levels import Levels
...
class Test_Levels(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Levels(
            levelId='ftkluskfmrnqkeajohiw',
            levelIndex=float(35.258844237433316),
            levelName='xvcmrmpwepgqazxetvnd'
        )
        return instance
    ...
    def test_levelId_property(self):
        ...
        """
        test_value = 'ftkluskfmrnqkeajohiw'
    ...
    def test_levelIndex_property(self):
        ...
        """
        test_value = float(35.258844237433316)
    ...
    def test_levelName_property(self):
        ...
        """
        test_value = 'xvcmrmpwepgqazxetvnd'

...
class Test_TripDescriptor(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = TripDescriptor(
            trip_id='jiebovgdqoebeuwdaanm',
            route_id='bttaekwfagawpizyyaiy',
            direction_id=int(8),
            start_time='mtdknbgubyyilazrlnho',
            start_date='rfxijyqrsgefkxgpbnvo',
    ...
    def test_trip_id_property(self):
        ...
        """
        test_value = 'jiebovgdqoebeuwdaanm'
    ...
    def test_route_id_property(self):
        ...
        """
        test_value = 'bttaekwfagawpizyyaiy'
    ...
    def test_start_time_property(self):
        ...
        """
        test_value = 'mtdknbgubyyilazrlnho'
    ...
    def test_start_date_property(self):
        ...
        """
        test_value = 'rfxijyqrsgefkxgpbnvo'

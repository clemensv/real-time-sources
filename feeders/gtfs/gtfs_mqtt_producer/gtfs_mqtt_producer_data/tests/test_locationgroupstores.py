...
from gtfs_mqtt_producer_data.generaltransitfeedstatic.locationgroupstores import LocationGroupStores
...
class Test_LocationGroupStores(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = LocationGroupStores(
            locationGroupStoreId='gqyluxplkvgrpqnbnegl',
            locationGroupId='npcffnxezhhlvurbsujn',
            storeId='pozistlyavxmqiyzvccn'
        )
        return instance
    ...
    def test_locationGroupStoreId_property(self):
        ...
        """
        test_value = 'gqyluxplkvgrpqnbnegl'
    ...
    def test_locationGroupId_property(self):
        ...
        """
        test_value = 'npcffnxezhhlvurbsujn'
    ...
    def test_storeId_property(self):
        ...
        """
        test_value = 'pozistlyavxmqiyzvccn'
    ...
    def test_to_json(self):
        ...
        new_instance = LocationGroupStores.from_json(json_data)

...
class Test_LocationGroupStores(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = LocationGroupStores(
            locationGroupStoreId='pxlvjsukfitsvecgdhtf',
            locationGroupId='iqvxasuhijdmnfbezpwg',
            storeId='dxwjhzwgzrhmalahdrmu'
        )
        return instance
    ...
    def test_locationGroupStoreId_property(self):
        ...
        """
        test_value = 'pxlvjsukfitsvecgdhtf'
    ...
    def test_locationGroupId_property(self):
        ...
        """
        test_value = 'iqvxasuhijdmnfbezpwg'
    ...
    def test_storeId_property(self):
        ...
        """
        test_value = 'dxwjhzwgzrhmalahdrmu'

...
from gtfs_mqtt_producer_data.generaltransitfeedstatic.bookingrules import BookingRules
...
class Test_BookingRules(unittest.TestCase):
    ...
    def test_bookingRuleId_property(self):
        ...
        """
        test_value = 'cvixwfkbdtkgsziotiss'
    ...
    def test_bookingRuleName_property(self):
        ...
        """
        test_value = 'mktrgqbtcqwazqidzjuj'
    ...
    def test_bookingRuleDesc_property(self):
        ...
        """
        test_value = 'cnebqzzzkzmnvmmttxpl'
    ...
    def test_bookingRuleUrl_property(self):
        ...
        """
        test_value = 'vaegcrhuvinorundnxkz'

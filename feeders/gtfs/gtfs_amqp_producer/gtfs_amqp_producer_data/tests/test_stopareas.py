...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='kcwgmziosgakhkbvlgkb',
            stopId='jffuwghartazysqvfoow',
            areaId='rymhtyrduprjujevqvwr'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'kcwgmziosgakhkbvlgkb'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'jffuwghartazysqvfoow'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'rymhtyrduprjujevqvwr'

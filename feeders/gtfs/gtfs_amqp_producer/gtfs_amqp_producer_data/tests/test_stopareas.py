...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='kzcxyckiuigasvtggzoh',
            stopId='igeskdgixgxwxhxmobnp',
            areaId='fobdrjynrbcoaxyijeqt'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'kzcxyckiuigasvtggzoh'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'igeskdgixgxwxhxmobnp'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'fobdrjynrbcoaxyijeqt'

...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='csycsahlfvxidousvzkl',
            stopId='ccptbkalugxrekdobfri',
            areaId='uecnzluhizkqwflnaaug'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'csycsahlfvxidousvzkl'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'ccptbkalugxrekdobfri'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'uecnzluhizkqwflnaaug'

...
from gtfs_amqp_producer_data.generaltransitfeedstatic.stopareas import StopAreas
...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='kctwjeksonlejmfophkq',
            stopId='efwlpdribvxsiepqsssk',
            areaId='pnmywdqxunsussedurwq'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'kctwjeksonlejmfophkq'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'efwlpdribvxsiepqsssk'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'pnmywdqxunsussedurwq'

...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='ppwpenbfdjlrigtfefnv',
            stopId='lbgsmumsauvpmggaykua',
            areaId='qqopryfcgonxasjpiayo'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'ppwpenbfdjlrigtfefnv'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'lbgsmumsauvpmggaykua'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'qqopryfcgonxasjpiayo'

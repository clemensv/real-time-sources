...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='thsgagndlxwtltherymh',
            stopId='suiscvpcigalvbsarnou',
            areaId='gbtoaikquhjfedwvfrsc'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'thsgagndlxwtltherymh'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'suiscvpcigalvbsarnou'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'gbtoaikquhjfedwvfrsc'

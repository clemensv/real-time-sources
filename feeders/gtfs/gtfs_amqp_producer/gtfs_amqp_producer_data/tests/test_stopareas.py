...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='bvjvipytvbfxjhffwivr',
            stopId='bexkovsbkgccirifrvlz',
            areaId='vihknuelnxrclzgtmtyw'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'bvjvipytvbfxjhffwivr'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'bexkovsbkgccirifrvlz'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'vihknuelnxrclzgtmtyw'

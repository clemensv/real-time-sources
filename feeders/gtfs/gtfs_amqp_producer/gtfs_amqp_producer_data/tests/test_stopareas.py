...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='xipcyowcivsdsjfleyve',
            stopId='axyhtpxtlwjpgghahxiz',
            areaId='gaozerqvemulpqiwjexc'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'xipcyowcivsdsjfleyve'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'axyhtpxtlwjpgghahxiz'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'gaozerqvemulpqiwjexc'

...
class Test_FeedInfo(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = FeedInfo(
            feedPublisherName='hchymyhzcoqbmnrjxbhe',
            feedPublisherUrl='awqroecwyxjzdgilnbyk',
            feedLang='marfhhhbrfjvuqvrmlpp',
            defaultLang='mpjukvyjmxbrwlfyooqm',
            feedStartDate='gzxqdgbpnskfuhvzhqeh',
            feedEndDate='vvrwziaqsggifefezgzd',
            feedVersion='eispzfcugpgepjsenqje',
            feedContactEmail='lxqmklomrknshshsdsjg',
            feedContactUrl='ltkiiyyqervjvldkdjhg'
        )
        return instance
    ...
    def test_feedPublisherName_property(self):
        ...
        """
        test_value = 'hchymyhzcoqbmnrjxbhe'
    ...
    def test_feedPublisherUrl_property(self):
        ...
        """
        test_value = 'awqroecwyxjzdgilnbyk'
    ...
    def test_feedLang_property(self):
        ...
        """
        test_value = 'marfhhhbrfjvuqvrmlpp'
    ...
    def test_defaultLang_property(self):
        ...
        """
        test_value = 'mpjukvyjmxbrwlfyooqm'
    ...
    def test_feedStartDate_property(self):
        ...
        """
        test_value = 'gzxqdgbpnskfuhvzhqeh'
    ...
    def test_feedEndDate_property(self):
        ...
        """
        test_value = 'vvrwziaqsggifefezgzd'
    ...
    def test_feedVersion_property(self):
        ...
        """
        test_value = 'eispzfcugpgepjsenqje'
    ...
    def test_feedContactEmail_property(self):
        ...
        """
        test_value = 'lxqmklomrknshshsdsjg'
    ...
    def test_feedContactUrl_property(self):
        ...
        """
        test_value = 'ltkiiyyqervjvldkdjhg'

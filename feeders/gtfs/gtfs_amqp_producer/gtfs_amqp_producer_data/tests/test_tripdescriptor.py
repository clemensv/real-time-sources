...
class Test_TripDescriptor(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = TripDescriptor(
            trip_id='zircrcddfvacwlvampgn',
            route_id='wniofptgbcvuyiieutgt',
            direction_id=int(63),
            start_time='jxmxvbjrlqkmjvaaxfsy',
            start_date='racdcuxxvhrrdbjgavpi',
    ...
    def test_trip_id_property(self):
        ...
        """
        test_value = 'zircrcddfvacwlvampgn'
    ...
    def test_route_id_property(self):
        ...
        """
        test_value = 'wniofptgbcvuyiieutgt'
    ...
    def test_start_time_property(self):
        ...
        """
        test_value = 'jxmxvbjrlqkmjvaaxfsy'
    ...
    def test_start_date_property(self):
        ...
        """
        test_value = 'racdcuxxvhrrdbjgavpi'
    ...
    def test_to_json(self):
        ...
        new_instance = TripDescriptor.from_json(json_data)

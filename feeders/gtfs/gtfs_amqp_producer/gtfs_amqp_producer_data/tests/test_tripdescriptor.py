...
class Test_TripDescriptor(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = TripDescriptor(
            trip_id='rakfupudepsyrlreahpw',
            route_id='qvcuapmvlypvztbfyfnr',
            direction_id=int(48),
            start_time='jhwwdtdazgquonnrixxx',
            start_date='mqozmizpptxzshnvqsji',
    ...
    def test_trip_id_property(self):
        ...
        """
        test_value = 'rakfupudepsyrlreahpw'
    ...
    def test_route_id_property(self):
        ...
        """
        test_value = 'qvcuapmvlypvztbfyfnr'
    ...
    def test_start_time_property(self):
        ...
        """
        test_value = 'jhwwdtdazgquonnrixxx'
    ...
    def test_start_date_property(self):
        ...
        """
        test_value = 'mqozmizpptxzshnvqsji'

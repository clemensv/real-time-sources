...
class Test_Timeframes(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Timeframes(
            timeframeGroupId='gqmgmqkjlxcviavahlyc',
            startTime='pbdffzwgnrizlpmyzayu',
            endTime='irkzjmfomzqqpgyxsabj',
            serviceDates=None
        )
        return instance
    ...
    def test_timeframeGroupId_property(self):
        ...
        """
        test_value = 'gqmgmqkjlxcviavahlyc'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'pbdffzwgnrizlpmyzayu'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'irkzjmfomzqqpgyxsabj'

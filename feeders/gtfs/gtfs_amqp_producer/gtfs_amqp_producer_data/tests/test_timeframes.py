...
class Test_Timeframes(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Timeframes(
            timeframeGroupId='bqnbwwpktivvbsgcireb',
            startTime='snkizpqinoobzpsnveuk',
            endTime='qiicdmrdqnhkxunpfhxy',
            serviceDates=None
        )
        return instance
    ...
    def test_timeframeGroupId_property(self):
        ...
        """
        test_value = 'bqnbwwpktivvbsgcireb'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'snkizpqinoobzpsnveuk'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'qiicdmrdqnhkxunpfhxy'

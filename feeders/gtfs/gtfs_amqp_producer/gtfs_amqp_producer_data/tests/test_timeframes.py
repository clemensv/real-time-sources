...
class Test_Timeframes(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Timeframes(
            timeframeGroupId='xyfhqidwqyzgsgwrceyc',
            startTime='oojssnowslvltwciadpk',
            endTime='bcrgkkhamtueeodyaxks',
            serviceDates=None
        )
        return instance
    ...
    def test_timeframeGroupId_property(self):
        ...
        """
        test_value = 'xyfhqidwqyzgsgwrceyc'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'oojssnowslvltwciadpk'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'bcrgkkhamtueeodyaxks'

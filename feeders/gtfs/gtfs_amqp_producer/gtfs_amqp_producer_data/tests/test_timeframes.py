...
class Test_Timeframes(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Timeframes(
            timeframeGroupId='rxofoumhzfffhrkcfjfl',
            startTime='njvhnveldtfidugazeoi',
            endTime='sqdymshzeyruglhmgtzx',
            serviceDates=None
        )
        return instance
    ...
    def test_timeframeGroupId_property(self):
        ...
        """
        test_value = 'rxofoumhzfffhrkcfjfl'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'njvhnveldtfidugazeoi'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'sqdymshzeyruglhmgtzx'

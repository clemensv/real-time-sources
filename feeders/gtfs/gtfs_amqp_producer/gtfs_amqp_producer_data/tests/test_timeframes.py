...
class Test_Timeframes(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Timeframes(
            timeframeGroupId='dlaluifmzjdqzawsdbjr',
            startTime='mxkijevpquiybkmqpslc',
            endTime='xpinzppchzmhecrvrpnl',
            serviceDates=None
        )
        return instance
    ...
    def test_timeframeGroupId_property(self):
        ...
        """
        test_value = 'dlaluifmzjdqzawsdbjr'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'mxkijevpquiybkmqpslc'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'xpinzppchzmhecrvrpnl'

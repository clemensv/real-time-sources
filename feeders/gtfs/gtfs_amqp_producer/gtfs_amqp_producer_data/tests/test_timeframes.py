...
class Test_Timeframes(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Timeframes(
            timeframeGroupId='ltwgelzybjgmtajuepjz',
            startTime='kztktnfyrfercbmgimjl',
            endTime='wtuzvpvcolqawzjrfbgj',
            serviceDates=None
        )
        return instance
    ...
    def test_timeframeGroupId_property(self):
        ...
        """
        test_value = 'ltwgelzybjgmtajuepjz'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'kztktnfyrfercbmgimjl'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'wtuzvpvcolqawzjrfbgj'

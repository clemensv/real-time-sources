...
class Test_Timeframes(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Timeframes(
            timeframeGroupId='fhsctxqffhekhepziidk',
            startTime='ijufrkcsjbhknopulioa',
            endTime='wbmmzixuactemqousgpi',
            serviceDates=None
        )
        return instance
    ...
    def test_timeframeGroupId_property(self):
        ...
        """
        test_value = 'fhsctxqffhekhepziidk'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'ijufrkcsjbhknopulioa'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'wbmmzixuactemqousgpi'

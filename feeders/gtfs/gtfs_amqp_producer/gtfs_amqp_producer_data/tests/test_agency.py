...
class Test_Agency(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Agency(
            agencyId='rrvfrjvcitdhuzrllqjm',
            agencyName='rkrbodzutorofkkmqnlq',
            agencyUrl='yiyxmlsbcplkhwzupspg',
            agencyTimezone='tydwzwbxcirfhmzpyqkt',
            agencyLang='ljpicworjolwvbgecpzn',
            agencyPhone='qencjyfycnlmahvuamlb',
            agencyFareUrl='xkqnhlciyvxdsqdlgowf',
            agencyEmail='feugkmtwpwfeivwqfule'
        )
        return instance
    ...
    def test_agencyId_property(self):
        ...
        """
        test_value = 'rrvfrjvcitdhuzrllqjm'
    ...
    def test_agencyName_property(self):
        ...
        """
        test_value = 'rkrbodzutorofkkmqnlq'
    ...
    def test_agencyUrl_property(self):
        ...
        """
        test_value = 'yiyxmlsbcplkhwzupspg'
    ...
    def test_agencyTimezone_property(self):
        ...
        """
        test_value = 'tydwzwbxcirfhmzpyqkt'
    ...
    def test_agencyLang_property(self):
        ...
        """
        test_value = 'ljpicworjolwvbgecpzn'
    ...
    def test_agencyPhone_property(self):
        ...
        """
        test_value = 'qencjyfycnlmahvuamlb'
    ...
    def test_agencyFareUrl_property(self):
        ...
        """
        test_value = 'xkqnhlciyvxdsqdlgowf'
    ...
    def test_agencyEmail_property(self):
        ...
        """
        test_value = 'feugkmtwpwfeivwqfule'

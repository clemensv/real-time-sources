...
class Test_Pathways(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Pathways(
            pathwayId='piwjelhapnduxzrlkezp',
            fromStopId='jrddmcxjtjkqixxyjjie',
            toStopId='zhdkhvmypjaaycbzbnno',
            pathwayMode=int(82),
            isBidirectional=int(24),
            length=float(30.137534623571117),
            traversalTime=int(10),
            stairCount=int(32),
            maxSlope=float(46.333671381028715),
            minWidth=float(42.54988511305371),
            signpostedAs='fxrfsakgdnyddrncttey',
            reversedSignpostedAs='vpktticslpglvlpedfrl'
        )
        return instance
    ...
    def test_pathwayId_property(self):
        ...
        """
        test_value = 'piwjelhapnduxzrlkezp'
    ...
    def test_fromStopId_property(self):
        ...
        """
        test_value = 'jrddmcxjtjkqixxyjjie'
    ...
    def test_toStopId_property(self):
        ...
        """
        test_value = 'zhdkhvmypjaaycbzbnno'
    ...
    def test_length_property(self):
        ...
        """
        test_value = float(30.137534623571117)
    ...
    def test_maxSlope_property(self):
        ...
        """
        test_value = float(46.333671381028715)
    ...
    def test_minWidth_property(self):
        ...
        """
        test_value = float(42.54988511305371)
    ...
    def test_signpostedAs_property(self):
        ...
        """
        test_value = 'fxrfsakgdnyddrncttey'
    ...
    def test_reversedSignpostedAs_property(self):
        ...
        """
        test_value = 'vpktticslpglvlpedfrl'

...
class Test_Pathways(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Pathways(
            pathwayId='pkcruecthmstmmqpkzez',
            fromStopId='rkdmsxvsudtgjxcegrma',
            toStopId='zeckwhaoqvhkofkdalka',
            pathwayMode=int(50),
            isBidirectional=int(83),
            length=float(49.43852052320863),
            traversalTime=int(95),
            stairCount=int(54),
            maxSlope=float(28.23207019801597),
            minWidth=float(53.87442236987996),
            signpostedAs='gikswjravnwrupwpdfkl',
            reversedSignpostedAs='lkkkexswxagiaazwkith'
        )
        return instance
    ...
    def test_pathwayId_property(self):
        ...
        """
        test_value = 'pkcruecthmstmmqpkzez'
    ...
    def test_fromStopId_property(self):
        ...
        """
        test_value = 'rkdmsxvsudtgjxcegrma'
    ...
    def test_toStopId_property(self):
        ...
        """
        test_value = 'zeckwhaoqvhkofkdalka'
    ...
    def test_length_property(self):
        ...
        """
        test_value = float(49.43852052320863)
    ...
    def test_maxSlope_property(self):
        ...
        """
        test_value = float(28.23207019801597)
    ...
    def test_minWidth_property(self):
        ...
        """
        test_value = float(53.87442236987996)
    ...
    def test_signpostedAs_property(self):
        ...
        """
        test_value = 'gikswjravnwrupwpdfkl'
    ...
    def test_reversedSignpostedAs_property(self):
        ...
        """
        test_value = 'lkkkexswxagiaazwkith'

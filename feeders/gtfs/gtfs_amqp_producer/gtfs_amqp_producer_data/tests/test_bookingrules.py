...
from gtfs_amqp_producer_data.generaltransitfeedstatic.bookingrules import BookingRules
...
class Test_BookingRules(unittest.TestCase):
    ...
    def test_bookingRuleId_property(self):
        ...
        """
        test_value = 'ewssesuhkqcgvwuptzqr'
    ...
    def test_bookingRuleName_property(self):
        ...
        """
        test_value = 'eqdtvkwndhskxzshtfjp'
    ...
    def test_bookingRuleDesc_property(self):
        ...
        """
        test_value = 'hobhlljteejxvtnofwwe'
    ...
    def test_bookingRuleUrl_property(self):
        ...
        """
        test_value = 'scqekmvnkaikfacuzugs'

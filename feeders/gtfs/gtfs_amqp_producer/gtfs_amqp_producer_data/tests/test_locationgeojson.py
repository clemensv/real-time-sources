...
from gtfs_amqp_producer_data.generaltransitfeedstatic.locationgeojson import LocationGeoJson
...
class Test_LocationGeoJson(unittest.TestCase):
    ...
    def test_locationGeoJsonId_property(self):
        ...
        """
        test_value = 'tkrktqoeizohuuexbqtr'
    ...
    def test_locationGeoJsonType_property(self):
        ...
        """
        test_value = 'tuyikjjqxdztmgkzoyva'
    ...
    def test_locationGeoJsonData_property(self):
        ...
        """
        test_value = 'sqyviugeazbmazdfyxmy'

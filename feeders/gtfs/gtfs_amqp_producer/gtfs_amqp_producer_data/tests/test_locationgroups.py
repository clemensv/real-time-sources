...
class Test_LocationGroups(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = LocationGroups(
            locationGroupId='zlwmaqfjilzuqgyrhfld',
            locationGroupName='gzratfkpyqdyveuutmny',
            locationGroupDesc='roilignanvfsjnbtfgsg',
            locationGroupUrl='bzqyzsskmkqhnasydggy'
        )
        return instance
    ...
    def test_locationGroupId_property(self):
        ...
        """
        test_value = 'zlwmaqfjilzuqgyrhfld'
    ...
    def test_locationGroupName_property(self):
        ...
        """
        test_value = 'gzratfkpyqdyveuutmny'
    ...
    def test_locationGroupDesc_property(self):
        ...
        """
        test_value = 'roilignanvfsjnbtfgsg'
    ...
    def test_locationGroupUrl_property(self):
        ...
        """
        test_value = 'bzqyzsskmkqhnasydggy'

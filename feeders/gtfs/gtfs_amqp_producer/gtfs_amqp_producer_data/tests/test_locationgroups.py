...
class Test_LocationGroups(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = LocationGroups(
            locationGroupId='wtudekpbzmkchpkmkcla',
            locationGroupName='xvnvbserwsxqyhphrioz',
            locationGroupDesc='wrxjuwgbegthkszbxhcg',
            locationGroupUrl='mqegfwraxghamgcjqpzv'
        )
        return instance
    ...
    def test_locationGroupId_property(self):
        ...
        """
        test_value = 'wtudekpbzmkchpkmkcla'
    ...
    def test_locationGroupName_property(self):
        ...
        """
        test_value = 'xvnvbserwsxqyhphrioz'
    ...
    def test_locationGroupDesc_property(self):
        ...
        """
        test_value = 'wrxjuwgbegthkszbxhcg'
    ...
    def test_locationGroupUrl_property(self):
        ...
        """
        test_value = 'mqegfwraxghamgcjqpzv'

...
class Test_LocationGroups(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = LocationGroups(
            locationGroupId='fjkiebbzfcuhviohigrr',
            locationGroupName='svtqjdiyjzokzaeunzix',
            locationGroupDesc='aczjdakkjgtieqtotrjn',
            locationGroupUrl='znztzooxtngimzszyohp'
        )
        return instance
    ...
    def test_locationGroupId_property(self):
        ...
        """
        test_value = 'fjkiebbzfcuhviohigrr'
    ...
    def test_locationGroupName_property(self):
        ...
        """
        test_value = 'svtqjdiyjzokzaeunzix'
    ...
    def test_locationGroupDesc_property(self):
        ...
        """
        test_value = 'aczjdakkjgtieqtotrjn'
    ...
    def test_locationGroupUrl_property(self):
        ...
        """
        test_value = 'znztzooxtngimzszyohp'

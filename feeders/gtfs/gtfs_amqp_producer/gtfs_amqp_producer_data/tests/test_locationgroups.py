...
class Test_LocationGroups(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = LocationGroups(
            locationGroupId='zuzuxfhawtmuekeujgro',
            locationGroupName='lrcdqfxgrkaltufhnuhq',
            locationGroupDesc='cmhywxmfiisdqqvzhtsj',
            locationGroupUrl='xbkgqttdlwmrqskqqhko'
        )
        return instance
    ...
    def test_locationGroupId_property(self):
        ...
        """
        test_value = 'zuzuxfhawtmuekeujgro'
    ...
    def test_locationGroupName_property(self):
        ...
        """
        test_value = 'lrcdqfxgrkaltufhnuhq'
    ...
    def test_locationGroupDesc_property(self):
        ...
        """
        test_value = 'cmhywxmfiisdqqvzhtsj'
    ...
    def test_locationGroupUrl_property(self):
        ...
        """
        test_value = 'xbkgqttdlwmrqskqqhko'

...
from gtfs_amqp_producer_data.generaltransitfeedstatic.locationgroups import LocationGroups
...
class Test_LocationGroups(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = LocationGroups(
            locationGroupId='mfpxfvmlwgzehlnzlzhf',
            locationGroupName='ugjqvrlpiacxkifmcfau',
            locationGroupDesc='ttutehgzufpamybpviux',
            locationGroupUrl='spetjnarfhkcmzgxwrea'
        )
        return instance
    ...
    def test_locationGroupId_property(self):
        ...
        """
        test_value = 'mfpxfvmlwgzehlnzlzhf'
    ...
    def test_locationGroupName_property(self):
        ...
        """
        test_value = 'ugjqvrlpiacxkifmcfau'
    ...
    def test_locationGroupDesc_property(self):
        ...
        """
        test_value = 'ttutehgzufpamybpviux'
    ...
    def test_locationGroupUrl_property(self):
        ...
        """
        test_value = 'spetjnarfhkcmzgxwrea'

...
class Test_EntitySelector(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = EntitySelector(
            agency_id='xbbqbrxkakpvxgmohqyt',
            route_id='qomfofegfsligydxruba',
            route_type=int(14),
            trip=None,
            stop_id='uicukgwhnbsnacxpxwkq'
        )
        return instance
    ...
    def test_agency_id_property(self):
        ...
        """
        test_value = 'xbbqbrxkakpvxgmohqyt'
    ...
    def test_route_id_property(self):
        ...
        """
        test_value = 'qomfofegfsligydxruba'
    ...
    def test_stop_id_property(self):
        ...
        """
        test_value = 'uicukgwhnbsnacxpxwkq'

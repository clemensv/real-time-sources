...
class Test_EntitySelector(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = EntitySelector(
            agency_id='jphmoowxoqyjbvvomyem',
            route_id='vhtsnrhizhofoqbhrkqy',
            route_type=int(89),
            trip=None,
            stop_id='hvayauurbgsfyplsovwx'
        )
        return instance
    ...
    def test_agency_id_property(self):
        ...
        """
        test_value = 'jphmoowxoqyjbvvomyem'
    ...
    def test_route_id_property(self):
        ...
        """
        test_value = 'vhtsnrhizhofoqbhrkqy'
    ...
    def test_stop_id_property(self):
        ...
        """
        test_value = 'hvayauurbgsfyplsovwx'

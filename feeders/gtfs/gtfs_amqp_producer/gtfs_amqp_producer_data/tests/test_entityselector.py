...
class Test_EntitySelector(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = EntitySelector(
            agency_id='crzdurtfyjrzgcusvalp',
            route_id='ydiuedgpymiqkarmviss',
            route_type=int(99),
            trip=None,
            stop_id='ojwbgedqywaheywyokvy'
        )
        return instance
    ...
    def test_agency_id_property(self):
        ...
        """
        test_value = 'crzdurtfyjrzgcusvalp'
    ...
    def test_route_id_property(self):
        ...
        """
        test_value = 'ydiuedgpymiqkarmviss'
    ...
    def test_stop_id_property(self):
        ...
        """
        test_value = 'ojwbgedqywaheywyokvy'

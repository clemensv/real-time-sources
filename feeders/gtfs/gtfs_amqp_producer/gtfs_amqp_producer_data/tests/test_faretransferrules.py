...
class Test_FareTransferRules(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = FareTransferRules(
            fareTransferRuleId='hgzzbtjazbfpfrwwyodd',
            fareProductId='glmzkquzuqfadabjzdih',
            transferCount=int(93),
            fromLegGroupId='zgdnfcdntvusukuhniar',
            toLegGroupId='xhsiysxhbphamegtumzv',
            duration=int(96),
            durationType='jctrpggekptxnazzerdq'
        )
        return instance
    ...
    def test_fareTransferRuleId_property(self):
        ...
        """
        test_value = 'hgzzbtjazbfpfrwwyodd'
    ...
    def test_fareProductId_property(self):
        ...
        """
        test_value = 'glmzkquzuqfadabjzdih'
    ...
    def test_fromLegGroupId_property(self):
        ...
        """
        test_value = 'zgdnfcdntvusukuhniar'
    ...
    def test_toLegGroupId_property(self):
        ...
        """
        test_value = 'xhsiysxhbphamegtumzv'
    ...
    def test_durationType_property(self):
        ...
        """
        test_value = 'jctrpggekptxnazzerdq'

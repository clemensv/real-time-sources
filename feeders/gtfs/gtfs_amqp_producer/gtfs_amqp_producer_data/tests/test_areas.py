...
from gtfs_amqp_producer_data.generaltransitfeedstatic.areas import Areas
...
class Test_Areas(unittest.TestCase):
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'splmbocbrlasmqiomhoy'
    ...
    def test_areaName_property(self):
        ...
        """
        test_value = 'sntpognczybrhbwuqbla'
    ...
    def test_areaDesc_property(self):
        ...
        """
        test_value = 'etahjpdkzkpijwabzqpt'
    ...
    def test_areaUrl_property(self):
        ...
        """
        test_value = 'hqehmyforbhyyuwgqfpu'

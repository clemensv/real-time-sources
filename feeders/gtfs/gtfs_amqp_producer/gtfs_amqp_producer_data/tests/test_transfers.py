...
from gtfs_amqp_producer_data.generaltransitfeedstatic.transfers import Transfers
...
class Test_Transfers(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Transfers(
            fromStopId='haklweiyimzegpcarvfa',
            toStopId='eertrfclkmbcnckknqmo',
            transferType=int(93),
            minTransferTime=int(52)
        )
        return instance
    ...
    def test_fromStopId_property(self):
        ...
        """
        test_value = 'haklweiyimzegpcarvfa'
    ...
    def test_toStopId_property(self):
        ...
        """
        test_value = 'eertrfclkmbcnckknqmo'

...
from gtfs_amqp_producer_data.generaltransitfeedstatic.stoptimes import StopTimes
...
class Test_StopTimes(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopTimes(
            tripId='hcnguhxnvnfxunzceyed',
            arrivalTime='rnecouvzqjocsxrgqlra',
            departureTime='npsbebxfhnnrpykhanqh',
            stopId='oweytmesriozedlfazhm',
            stopSequence=int(81),
            stopHeadsign='nvuxuzzhuhwdkicfkhrd',
            pickupType=None,
            dropOffType=None,
            continuousPickup=None,
            continuousDropOff=None,
            shapeDistTraveled=float(17.694264021431216),
            timepoint=None
        )
        return instance
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'hcnguhxnvnfxunzceyed'
    ...
    def test_arrivalTime_property(self):
        ...
        """
        test_value = 'rnecouvzqjocsxrgqlra'
    ...
    def test_departureTime_property(self):
        ...
        """
        test_value = 'npsbebxfhnnrpykhanqh'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'oweytmesriozedlfazhm'
    ...
    def test_stopHeadsign_property(self):
        ...
        """
        test_value = 'nvuxuzzhuhwdkicfkhrd'
    ...
    def test_shapeDistTraveled_property(self):
        ...
        """
        test_value = float(17.694264021431216)

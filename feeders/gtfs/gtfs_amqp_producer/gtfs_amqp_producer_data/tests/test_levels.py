...
from gtfs_amqp_producer_data.generaltransitfeedstatic.levels import Levels
...
class Test_Levels(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Levels(
            levelId='jovgncjkdbqoynraqwem',
            levelIndex=float(10.815286506493738),
            levelName='aaxmfgoqgkfvudvxtfsq'
        )
        return instance
    ...
    def test_levelId_property(self):
        ...
        """
        test_value = 'jovgncjkdbqoynraqwem'
    ...
    def test_levelIndex_property(self):
        ...
        """
        test_value = float(10.815286506493738)
    ...
    def test_levelName_property(self):
        ...
        """
        test_value = 'aaxmfgoqgkfvudvxtfsq'

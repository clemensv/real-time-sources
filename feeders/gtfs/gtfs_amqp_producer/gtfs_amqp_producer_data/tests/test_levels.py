...
class Test_Levels(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Levels(
            levelId='msvpmlakdmzncgkkifjb',
            levelIndex=float(94.7351650499952),
            levelName='qlqnaskgbkcxgmqwyqxh'
        )
        return instance
    ...
    def test_levelId_property(self):
        ...
        """
        test_value = 'msvpmlakdmzncgkkifjb'
    ...
    def test_levelIndex_property(self):
        ...
        """
        test_value = float(94.7351650499952)
    ...
    def test_levelName_property(self):
        ...
        """
        test_value = 'qlqnaskgbkcxgmqwyqxh'

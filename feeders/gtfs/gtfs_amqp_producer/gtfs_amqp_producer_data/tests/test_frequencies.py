...
from gtfs_amqp_producer_data.generaltransitfeedstatic.frequencies import Frequencies
...
class Test_Frequencies(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Frequencies(
            tripId='qfgscacotqarfqcnsmni',
            startTime='yilwklygakhyqjeiegds',
            endTime='zqcedcovkpzrzlrggktv',
            headwaySecs=int(20),
            exactTimes=int(77)
        )
        return instance
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'qfgscacotqarfqcnsmni'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'yilwklygakhyqjeiegds'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'zqcedcovkpzrzlrggktv'

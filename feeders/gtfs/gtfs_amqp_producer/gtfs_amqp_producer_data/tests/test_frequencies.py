...
class Test_Frequencies(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Frequencies(
            tripId='uasvglebsvvgkcwevqyk',
            startTime='nslwwdqwpqqmninrkgya',
            endTime='hoevscpnueunvtoxoanz',
            headwaySecs=int(97),
            exactTimes=int(18)
        )
        return instance
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'uasvglebsvvgkcwevqyk'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'nslwwdqwpqqmninrkgya'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'hoevscpnueunvtoxoanz'

...
class Test_Frequencies(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Frequencies(
            tripId='yswzmzxxwlkiohodqeoz',
            startTime='cpmjlyvuyxbltnpszeul',
            endTime='regjqnfflklimgnhrepm',
            headwaySecs=int(86),
            exactTimes=int(40)
        )
        return instance
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'yswzmzxxwlkiohodqeoz'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'cpmjlyvuyxbltnpszeul'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'regjqnfflklimgnhrepm'

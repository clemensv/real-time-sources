...
class Test_Frequencies(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Frequencies(
            tripId='rubnkhcrzjcdiawnweyq',
            startTime='suaypkbxhnrnnggpkvjb',
            endTime='qeomrypqtpmljiddtuie',
            headwaySecs=int(81),
            exactTimes=int(83)
        )
        return instance
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'rubnkhcrzjcdiawnweyq'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'suaypkbxhnrnnggpkvjb'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'qeomrypqtpmljiddtuie'

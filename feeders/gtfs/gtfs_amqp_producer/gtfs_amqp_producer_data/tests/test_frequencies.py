...
class Test_Frequencies(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Frequencies(
            tripId='qxbqibgpywmmkxmoidxd',
            startTime='taobctlpgktrehktopga',
            endTime='fybhlsekpzgqzcafajbw',
            headwaySecs=int(85),
            exactTimes=int(45)
        )
        return instance
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'qxbqibgpywmmkxmoidxd'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'taobctlpgktrehktopga'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'fybhlsekpzgqzcafajbw'

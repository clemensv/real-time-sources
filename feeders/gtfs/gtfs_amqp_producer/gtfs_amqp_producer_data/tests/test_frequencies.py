...
class Test_Frequencies(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Frequencies(
            tripId='pltgljmuaipimxspaman',
            startTime='sygllvxlwqlanmgudqut',
            endTime='sczmrcrhojhloxpdvdqk',
            headwaySecs=int(7),
            exactTimes=int(90)
        )
        return instance
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'pltgljmuaipimxspaman'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'sygllvxlwqlanmgudqut'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'sczmrcrhojhloxpdvdqk'

...
class Test_Frequencies(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Frequencies(
            tripId='ctwsrnkpszssvkoxoxhr',
            startTime='bqgpfvuzmqiysedfwyko',
            endTime='bnsbzeplehamprqskhka',
            headwaySecs=int(30),
            exactTimes=int(16)
        )
        return instance
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'ctwsrnkpszssvkoxoxhr'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'bqgpfvuzmqiysedfwyko'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'bnsbzeplehamprqskhka'

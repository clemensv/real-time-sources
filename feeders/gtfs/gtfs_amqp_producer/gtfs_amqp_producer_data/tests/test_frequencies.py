...
class Test_Frequencies(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Frequencies(
            tripId='uomxgsstkltvzevwgdkk',
            startTime='tbxkdkgyeqncvsyqlkxk',
            endTime='wgiwzjckqjwufongioam',
            headwaySecs=int(72),
            exactTimes=int(78)
        )
        return instance
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'uomxgsstkltvzevwgdkk'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'tbxkdkgyeqncvsyqlkxk'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'wgiwzjckqjwufongioam'

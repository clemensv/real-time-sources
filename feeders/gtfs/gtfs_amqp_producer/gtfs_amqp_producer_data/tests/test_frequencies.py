...
class Test_Frequencies(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Frequencies(
            tripId='htxyzyqfkgfwpuqbnbsy',
            startTime='rjylgtmwrvuzfyvkztcb',
            endTime='uiewzfwhlcmwkysditlh',
            headwaySecs=int(71),
            exactTimes=int(30)
        )
        return instance
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'htxyzyqfkgfwpuqbnbsy'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'rjylgtmwrvuzfyvkztcb'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'uiewzfwhlcmwkysditlh'

...
from gtfs_amqp_producer_data.generaltransitfeedstatic.locationgroupstores import LocationGroupStores
...
class Test_LocationGroupStores(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = LocationGroupStores(
            locationGroupStoreId='ulucslncypiwbcfngrca',
            locationGroupId='waqspjgiigoelxnuueeo',
            storeId='wiownnqscqhayhqiolft'
        )
        return instance
    ...
    def test_locationGroupStoreId_property(self):
        ...
        """
        test_value = 'ulucslncypiwbcfngrca'
    ...
    def test_locationGroupId_property(self):
        ...
        """
        test_value = 'waqspjgiigoelxnuueeo'
    ...
    def test_storeId_property(self):
        ...
        """
        test_value = 'wiownnqscqhayhqiolft'

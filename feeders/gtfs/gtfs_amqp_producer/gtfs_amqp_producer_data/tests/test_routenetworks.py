...
from gtfs_amqp_producer_data.generaltransitfeedstatic.routenetworks import RouteNetworks
...
class Test_RouteNetworks(unittest.TestCase):
    ...
    def test_routeNetworkId_property(self):
        ...
        """
        test_value = 'paboatoacpuzgenbqrpp'
    ...
    def test_routeId_property(self):
        ...
        """
        test_value = 'qxmxssokbythuxyefvco'
    ...
    def test_networkId_property(self):
        ...
        """
        test_value = 'vnxhqukvmvimjpponemj'

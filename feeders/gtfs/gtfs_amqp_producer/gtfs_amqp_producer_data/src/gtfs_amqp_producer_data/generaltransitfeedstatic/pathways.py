...
class Pathways:
    ...
    Attributes:
        ...
        traversalTime (typing.Optional[int])
        stairCount (typing.Optional[int])
        maxSlope (typing.Optional[float])
        minWidth (typing.Optional[float])
        signpostedAs (typing.Optional[str])
        reversedSignpostedAs (typing.Optional[str])
    """
    ...
    @classmethod
    def create_instance(cls) -> 'Pathways':
        """

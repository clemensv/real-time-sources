...
class CalendarDates:
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['CalendarDates']:
        """
    ...
    def create_instance(cls) -> 'CalendarDates':
        ...
        """
        return cls(
            serviceId='mdkxrnfyzjscpigebued',
            date='qalvfaosmcbjzxjltteo',
            exceptionType=None
        )
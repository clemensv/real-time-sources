...
from gtfs_producer_data.generaltransitfeedstatic.farerules import FareRules
...
class Test_FareRules(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = FareRules(
            fareId='vvtjvfoqyuntvhmhntbm',
            routeId='curzfrknweygqdrnfcek',
            originId='lrpgzpbiihfbxeckszxq',
            destinationId='ypkraynjglgoondhjuiq',
            containsId='cksmwxinbktzytjychgx'
        )
        return instance
    ...
    def test_fareId_property(self):
        ...
        """
        test_value = 'vvtjvfoqyuntvhmhntbm'
    ...
    def test_routeId_property(self):
        ...
        """
        test_value = 'curzfrknweygqdrnfcek'
    ...
    def test_originId_property(self):
        ...
        """
        test_value = 'lrpgzpbiihfbxeckszxq'
    ...
    def test_destinationId_property(self):
        ...
        """
        test_value = 'ypkraynjglgoondhjuiq'
    ...
    def test_containsId_property(self):
        ...
        """
        test_value = 'cksmwxinbktzytjychgx'

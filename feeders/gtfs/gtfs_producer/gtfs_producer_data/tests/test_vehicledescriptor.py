...
class Test_VehicleDescriptor(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = VehicleDescriptor(
            id='tlxhastodkegmbjrsuso',
            label='ymzsqptbmbojnckhuyud',
            license_plate='ianoclqtukuwluxdujmn'
        )
        return instance
    ...
    def test_id_property(self):
        ...
        Test id property
        """
        test_value = 'tlxhastodkegmbjrsuso'
    ...
    def test_label_property(self):
        ...
        Test label property
        """
        test_value = 'ymzsqptbmbojnckhuyud'
    ...
    def test_license_plate_property(self):
        ...
        """
        test_value = 'ianoclqtukuwluxdujmn'

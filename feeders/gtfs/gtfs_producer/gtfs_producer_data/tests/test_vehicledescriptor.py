...
class Test_VehicleDescriptor(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = VehicleDescriptor(
            id='rwjgbknlsrfojvefzajf',
            label='xdmfshgqhoympcasryzi',
            license_plate='njofisfvepiiwvjkknal'
        )
        return instance
    ...
    def test_id_property(self):
        ...
        Test id property
        """
        test_value = 'rwjgbknlsrfojvefzajf'
    ...
    def test_label_property(self):
        ...
        Test label property
        """
        test_value = 'xdmfshgqhoympcasryzi'
    ...
    def test_license_plate_property(self):
        ...
        """
        test_value = 'njofisfvepiiwvjkknal'

...
from gtfs_producer_data.generaltransitfeedstatic.locationgeojson import LocationGeoJson
...
class Test_LocationGeoJson(unittest.TestCase):
    ...
    def test_locationGeoJsonId_property(self):
        ...
        """
        test_value = 'cqxikwhspblzfwfoxojb'
    ...
    def test_locationGeoJsonType_property(self):
        ...
        """
        test_value = 'rofinqqeevuqbjvllzby'
    ...
    def test_locationGeoJsonData_property(self):
        ...
        """
        test_value = 'bsihvzajmvblgvzarqqr'

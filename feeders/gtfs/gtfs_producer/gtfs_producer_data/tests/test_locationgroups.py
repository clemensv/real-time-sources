...
class Test_LocationGroups(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = LocationGroups(
            locationGroupId='wxsabdjavtfsbsxviyoq',
            locationGroupName='rrxczocqkqonzqhwdipk',
            locationGroupDesc='empffqoaiezvdfyajnxe',
            locationGroupUrl='lmofegghfgucykumqxqj'
        )
        return instance
    ...
    def test_locationGroupId_property(self):
        ...
        """
        test_value = 'wxsabdjavtfsbsxviyoq'
    ...
    def test_locationGroupName_property(self):
        ...
        """
        test_value = 'rrxczocqkqonzqhwdipk'
    ...
    def test_locationGroupDesc_property(self):
        ...
        """
        test_value = 'empffqoaiezvdfyajnxe'
    ...
    def test_locationGroupUrl_property(self):
        ...
        """
        test_value = 'lmofegghfgucykumqxqj'

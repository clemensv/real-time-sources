...
class Test_LocationGroups(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = LocationGroups(
            locationGroupId='emqflwqqupjvuljfsisa',
            locationGroupName='fesugtshjmhduadzrwwe',
            locationGroupDesc='nqfrxdafnztuuzxenjck',
            locationGroupUrl='eiyucdvxvdtskwdvljpo'
        )
        return instance
    ...
    def test_locationGroupId_property(self):
        ...
        """
        test_value = 'emqflwqqupjvuljfsisa'
    ...
    def test_locationGroupName_property(self):
        ...
        """
        test_value = 'fesugtshjmhduadzrwwe'
    ...
    def test_locationGroupDesc_property(self):
        ...
        """
        test_value = 'nqfrxdafnztuuzxenjck'
    ...
    def test_locationGroupUrl_property(self):
        ...
        """
        test_value = 'eiyucdvxvdtskwdvljpo'

...
from gtfs_producer_data.generaltransitfeedstatic.locationgroups import LocationGroups
...
class Test_LocationGroups(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = LocationGroups(
            locationGroupId='cloomywjdqjcpipqgbkh',
            locationGroupName='oyrrsexeojewwgddbtlk',
            locationGroupDesc='tpvjoyccwdhlfodjreqr',
            locationGroupUrl='ucrbiekxhjgnjebxcgni'
        )
        return instance
    ...
    def test_locationGroupId_property(self):
        ...
        """
        test_value = 'cloomywjdqjcpipqgbkh'
    ...
    def test_locationGroupName_property(self):
        ...
        """
        test_value = 'oyrrsexeojewwgddbtlk'
    ...
    def test_locationGroupDesc_property(self):
        ...
        """
        test_value = 'tpvjoyccwdhlfodjreqr'
    ...
    def test_locationGroupUrl_property(self):
        ...
        """
        test_value = 'ucrbiekxhjgnjebxcgni'

...
from gtfs_producer_data.generaltransitfeedstatic.fareproducts import FareProducts
...
class Test_FareProducts(unittest.TestCase):
    ...
    def test_fareProductId_property(self):
        ...
        """
        test_value = 'fqsvsvbeerdegcnqrpzr'
    ...
    def test_fareProductName_property(self):
        ...
        """
        test_value = 'xpriqftmzpmhypwfvebq'
    ...
    def test_fareProductDesc_property(self):
        ...
        """
        test_value = 'iptgkdmyhmhpwkbrsrie'
    ...
    def test_fareProductUrl_property(self):
        ...
        """
        test_value = 'avhvjlvbelsihzujaecr'

...
from gtfs_producer_data.generaltransitfeedstatic.stoptimes import StopTimes
...
class Test_StopTimes(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopTimes(
            tripId='wtpamfggatdkjrbiiwmq',
            arrivalTime='jtzavphmdzobhbsgvvvd',
            departureTime='xjgtynlerzgwuscckhuf',
            stopId='kpuwcjcxnpytcdhgzbtx',
            stopSequence=int(70),
            stopHeadsign='oncviwjrkutvcnxzpdtg',
            pickupType=None,
            dropOffType=None,
            continuousPickup=None,
            continuousDropOff=None,
            shapeDistTraveled=float(57.763255446218345),
            timepoint=None
        )
        return instance
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'wtpamfggatdkjrbiiwmq'
    ...
    def test_arrivalTime_property(self):
        ...
        """
        test_value = 'jtzavphmdzobhbsgvvvd'
    ...
    def test_departureTime_property(self):
        ...
        """
        test_value = 'xjgtynlerzgwuscckhuf'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'kpuwcjcxnpytcdhgzbtx'
    ...
    def test_stopHeadsign_property(self):
        ...
        """
        test_value = 'oncviwjrkutvcnxzpdtg'
    ...
    def test_shapeDistTraveled_property(self):
        ...
        """
        test_value = float(57.763255446218345)

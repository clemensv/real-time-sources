...
class Test_EntitySelector(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = EntitySelector(
            agency_id='patpuoaaouakdqqkiesm',
            route_id='udiytyarjtsaqadzvqkw',
            route_type=int(47),
            trip=None,
            stop_id='xczecbwhldfukcddhysu'
        )
        return instance
    ...
    def test_agency_id_property(self):
        ...
        """
        test_value = 'patpuoaaouakdqqkiesm'
    ...
    def test_route_id_property(self):
        ...
        """
        test_value = 'udiytyarjtsaqadzvqkw'
    ...
    def test_stop_id_property(self):
        ...
        """
        test_value = 'xczecbwhldfukcddhysu'

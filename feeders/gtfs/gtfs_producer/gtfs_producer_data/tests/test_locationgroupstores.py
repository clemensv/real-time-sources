...
from gtfs_producer_data.generaltransitfeedstatic.locationgroupstores import LocationGroupStores
...
class Test_LocationGroupStores(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = LocationGroupStores(
            locationGroupStoreId='scdysdbrihthlplyfoxz',
            locationGroupId='ofegjycxzdvykwsazcld',
            storeId='txzrlpjajrrzzkstfzau'
        )
        return instance
    ...
    def test_locationGroupStoreId_property(self):
        ...
        """
        test_value = 'scdysdbrihthlplyfoxz'
    ...
    def test_locationGroupId_property(self):
        ...
        """
        test_value = 'ofegjycxzdvykwsazcld'
    ...
    def test_storeId_property(self):
        ...
        """
        test_value = 'txzrlpjajrrzzkstfzau'

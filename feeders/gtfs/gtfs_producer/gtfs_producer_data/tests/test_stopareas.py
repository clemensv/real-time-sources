...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='jsstybpcwcethwqpgtbg',
            stopId='rinakrxrfdmlhnnxixsr',
            areaId='dgifihppjntulqaopmqf'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'jsstybpcwcethwqpgtbg'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'rinakrxrfdmlhnnxixsr'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'dgifihppjntulqaopmqf'

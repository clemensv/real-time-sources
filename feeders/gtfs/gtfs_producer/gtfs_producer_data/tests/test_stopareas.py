...
from gtfs_producer_data.generaltransitfeedstatic.stopareas import StopAreas
...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='astqudanxndodyzgydey',
            stopId='layvffzxppbdatfimemd',
            areaId='penerujpdmdxisezrtlj'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'astqudanxndodyzgydey'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'layvffzxppbdatfimemd'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'penerujpdmdxisezrtlj'

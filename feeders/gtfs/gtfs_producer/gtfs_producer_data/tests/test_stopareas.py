...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='jouzqwoukvtqfqkroqdr',
            stopId='vqmqldwgayplzvtkoiwc',
            areaId='qqhpodxdjlsiqqywppdx'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'jouzqwoukvtqfqkroqdr'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'vqmqldwgayplzvtkoiwc'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'qqhpodxdjlsiqqywppdx'

...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='whdquotapbrxtrwjhdri',
            stopId='zrhlatlugjftkmlrbwgb',
            areaId='eziknsqzsgaagrliyadd'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'whdquotapbrxtrwjhdri'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'zrhlatlugjftkmlrbwgb'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'eziknsqzsgaagrliyadd'

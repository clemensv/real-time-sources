...
class Test_StopAreas(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = StopAreas(
            stopAreaId='otasaqptbtpbuheryzri',
            stopId='eejwegshsiinwvomnajz',
            areaId='bnavalmslwischjhyivy'
        )
        return instance
    ...
    def test_stopAreaId_property(self):
        ...
        """
        test_value = 'otasaqptbtpbuheryzri'
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'eejwegshsiinwvomnajz'
    ...
    def test_areaId_property(self):
        ...
        """
        test_value = 'bnavalmslwischjhyivy'

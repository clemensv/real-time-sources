...
class Test_Stops(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Stops(
            stopId='yimihnuinbqczqieacih',
            stopCode='dhxfyazxqrnmrlctsdzh',
            stopName='lcjssqhcrnhdixpighks',
            ttsStopName='rvhjzmzclqjebvlblpgi',
            stopDesc='bfcrotxajkgpklgrvpxm',
            stopLat=float(92.41937777452928),
            stopLon=float(94.13492200145616),
            zoneId='ldlszuumcapiayzuxfdo',
            stopUrl='cpyntarqmuzgzoqqzdwb',
            locationType=None,
            parentStation='ppkhovhgmhceqimdhrsy',
            stopTimezone='rvltwclqtxpnhruqvahp',
            wheelchairBoarding=None,
            levelId='ytkqjmhghxxdqpwnguvg',
            platformCode='tijieasvvbqobpvugbgc'
        )
        return instance
    ...
    def test_stopId_property(self):
        ...
        """
        test_value = 'yimihnuinbqczqieacih'
    ...
    def test_stopCode_property(self):
        ...
        """
        test_value = 'dhxfyazxqrnmrlctsdzh'
    ...
    def test_stopName_property(self):
        ...
        """
        test_value = 'lcjssqhcrnhdixpighks'
    ...
    def test_ttsStopName_property(self):
        ...
        """
        test_value = 'rvhjzmzclqjebvlblpgi'
    ...
    def test_stopDesc_property(self):
        ...
        """
        test_value = 'bfcrotxajkgpklgrvpxm'
    ...
    def test_stopLat_property(self):
        ...
        """
        test_value = float(92.41937777452928)
    ...
    def test_stopLon_property(self):
        ...
        """
        test_value = float(94.13492200145616)
    ...
    def test_zoneId_property(self):
        ...
        """
        test_value = 'ldlszuumcapiayzuxfdo'
    ...
    def test_stopUrl_property(self):
        ...
        """
        test_value = 'cpyntarqmuzgzoqqzdwb'
    ...
    def test_parentStation_property(self):
        ...
        """
        test_value = 'ppkhovhgmhceqimdhrsy'
    ...
    def test_stopTimezone_property(self):
        ...
        """
        test_value = 'rvltwclqtxpnhruqvahp'
    ...
    def test_levelId_property(self):
        ...
        """
        test_value = 'ytkqjmhghxxdqpwnguvg'
    ...
    def test_platformCode_property(self):
        ...
        """
        test_value = 'tijieasvvbqobpvugbgc'

...
class Test_Pathways(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Pathways(
            pathwayId='cehucwckrchehtrmvsnz',
            fromStopId='waajwgmxleexpxgftceb',
            toStopId='ytdhwbwcjqxnpthhawrg',
            pathwayMode=int(28),
            isBidirectional=int(94),
            length=float(85.23860308323447),
            traversalTime=int(82),
            stairCount=int(72),
            maxSlope=float(78.47862135057517),
            minWidth=float(87.82449209630104),
            signpostedAs='zijzfswumefjfwfkapvd',
            reversedSignpostedAs='vmdlpvtjmapnkoqxienf'
        )
        return instance
    ...
    def test_pathwayId_property(self):
        ...
        """
        test_value = 'cehucwckrchehtrmvsnz'
    ...
    def test_fromStopId_property(self):
        ...
        """
        test_value = 'waajwgmxleexpxgftceb'
    ...
    def test_toStopId_property(self):
        ...
        """
        test_value = 'ytdhwbwcjqxnpthhawrg'
    ...
    def test_length_property(self):
        ...
        """
        test_value = float(85.23860308323447)
    ...
    def test_maxSlope_property(self):
        ...
        """
        test_value = float(78.47862135057517)
    ...
    def test_minWidth_property(self):
        ...
        """
        test_value = float(87.82449209630104)
    ...
    def test_signpostedAs_property(self):
        ...
        """
        test_value = 'zijzfswumefjfwfkapvd'
    ...
    def test_reversedSignpostedAs_property(self):
        ...
        """
        test_value = 'vmdlpvtjmapnkoqxienf'

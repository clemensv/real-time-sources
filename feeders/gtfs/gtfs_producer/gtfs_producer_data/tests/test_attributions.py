...
class Test_Attributions(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Attributions(
            attributionId='gcyfujqrridnxsgycmwt',
            agencyId='szoosvomrvlvwpaahjcc',
            routeId='jggjvwiazxjlwakvhcgm',
            tripId='uqspgfinykvvnlqcrrkn',
            organizationName='rwjkretdwwjalxaparsg',
            isProducer=int(0),
            isOperator=int(27),
            isAuthority=int(85),
            attributionUrl='gjlgaqnpswxaamubfmno',
            attributionEmail='idnzzuwhlyexkxryrcij',
            attributionPhone='ljggiputhqodgmxbwong'
        )
        return instance
    ...
    def test_attributionId_property(self):
        ...
        """
        test_value = 'gcyfujqrridnxsgycmwt'
    ...
    def test_agencyId_property(self):
        ...
        """
        test_value = 'szoosvomrvlvwpaahjcc'
    ...
    def test_routeId_property(self):
        ...
        """
        test_value = 'jggjvwiazxjlwakvhcgm'
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'uqspgfinykvvnlqcrrkn'
    ...
    def test_organizationName_property(self):
        ...
        """
        test_value = 'rwjkretdwwjalxaparsg'
    ...
    def test_attributionUrl_property(self):
        ...
        """
        test_value = 'gjlgaqnpswxaamubfmno'
    ...
    def test_attributionEmail_property(self):
        ...
        """
        test_value = 'idnzzuwhlyexkxryrcij'
    ...
    def test_attributionPhone_property(self):
        ...
        """
        test_value = 'ljggiputhqodgmxbwong'

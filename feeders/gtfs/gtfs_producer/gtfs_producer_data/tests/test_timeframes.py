...
class Test_Timeframes(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Timeframes(
            timeframeGroupId='fqeavwsstidaeamdexsu',
            startTime='sbubzcxyhpdkrmjcexgh',
            endTime='ajwwvzepbgmwqjybpsjw',
            serviceDates=None
        )
        return instance
    ...
    def test_timeframeGroupId_property(self):
        ...
        """
        test_value = 'fqeavwsstidaeamdexsu'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'sbubzcxyhpdkrmjcexgh'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'ajwwvzepbgmwqjybpsjw'

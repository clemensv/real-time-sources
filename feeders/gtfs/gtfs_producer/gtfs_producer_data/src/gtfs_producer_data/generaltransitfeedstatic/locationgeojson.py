...
class LocationGeoJson:
    ...
    Attributes:
        locationGeoJsonId (str)
        locationGeoJsonType (str)
        locationGeoJsonData (str)
    """
    ...
    @classmethod
    def create_instance(cls) -> 'LocationGeoJson':
        """
        ...
        """
        return cls(
            locationGeoJsonId='enxbjihaveidmynkrnjn',
            locationGeoJsonType='jsuhmybifdhzwrmseabb',
            locationGeoJsonData='fuvwvoclexzeuvlsoqpq'
        )
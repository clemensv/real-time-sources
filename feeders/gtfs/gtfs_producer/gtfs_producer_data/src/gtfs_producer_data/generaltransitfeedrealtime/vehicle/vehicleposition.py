...
import json
from gtfs_producer_data.generaltransitfeedrealtime.vehicle.vehicledescriptor import VehicleDescriptor
from typing import Any
from gtfs_producer_data.generaltransitfeedrealtime.vehicle.position import Position
from gtfs_producer_data.generaltransitfeedrealtime.vehicle.tripdescriptor import TripDescriptor
...
class VehiclePosition:
    ...
    Attributes:
        ...
        current_stop_sequence (typing.Optional[int])
        stop_id (typing.Optional[str])
        current_status (typing.Optional[Any])
        timestamp (typing.Optional[int])
        congestion_level (typing.Optional[Any])
        occupancy_status (typing.Optional[Any])
    """
    ...
    def create_instance(cls) -> 'VehiclePosition':
        ...
        return cls(
            ...
            vehicle=None,
            position=None,
            current_stop_sequence=int(61),
            stop_id='gqwckjgyavtxjuhkewah',
            current_status=None,
            timestamp=int(5),

...
from gtfs_producer_data.generaltransitfeedrealtime.alert.translatedstring import TranslatedString
...
class Alert:
    ...
    Attributes:
        active_period (typing.List[TimeRange])
        informed_entity (typing.List[EntitySelector])
        cause (typing.Optional[Any])
        effect (typing.Optional[Any])
        url (typing.Optional[TranslatedString])
        header_text (typing.Optional[TranslatedString])
        description_text (typing.Optional[TranslatedString])
    """
    ...
    effect: typing.Optional[Any]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="effect"))

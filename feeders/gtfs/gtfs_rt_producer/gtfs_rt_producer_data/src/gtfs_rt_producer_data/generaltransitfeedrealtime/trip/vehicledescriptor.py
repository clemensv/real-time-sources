...
class VehicleDescriptor:
    ...
    Attributes:
        id (typing.Optional[str]): Internal system identification of the vehicle. Should be unique per vehicle, and can be used for tracking the vehicle as it proceeds through the system. User visible label, i.e., something that must be shown to the passenger to
        label (typing.Optional[str]): help identify the correct vehicle.
        license_plate (typing.Optional[str]): The license plate of the vehicle."""
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['VehicleDescriptor']:
        """

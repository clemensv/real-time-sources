...
class Position:
    ...
    def create_instance(cls) -> 'Position':
        ...
        """
        return cls(
            latitude=float(37.739659230473535),
            longitude=float(27.044566585761885),
            bearing=float(51.147575862000195),
            odometer=float(88.48337506205473),
            speed=float(95.03194458971957)
        )
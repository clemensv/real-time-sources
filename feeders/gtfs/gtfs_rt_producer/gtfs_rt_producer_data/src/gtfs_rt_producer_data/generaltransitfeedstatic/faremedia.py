...
class FareMedia:
    ...
    @classmethod
    def create_instance(cls) -> 'FareMedia':
        """
        ...
        """
        return cls(
            fareMediaId='ihyikxcaiupdehebjeds',
            fareMediaName='ohupjnodajtggqmwxjtg',
            fareMediaDesc='szhikwgmnjghqskbobgo',
            fareMediaUrl='uzwseymvzxgfhqitowqz'
        )
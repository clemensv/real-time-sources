...
class FareProducts:
    ...
    @classmethod
    def create_instance(cls) -> 'FareProducts':
        """
        ...
        """
        return cls(
            fareProductId='mtehkhfrlzdfnawzzqvz',
            fareProductName='dogbektphpojbwhtnjpc',
            fareProductDesc='xgxhoinrztvvuxgxkzpk',
            fareProductUrl='apikrpbgyaayidywuita'
        )
...
class Shapes:
    ...
    def create_instance(cls) -> 'Shapes':
        ...
        """
        return cls(
            shapeId='hfdsmquqzamjwsbzfbuf',
            shapePtLat=float(50.87122333048709),
            shapePtLon=float(64.5739316102707),
            shapePtSequence=int(20),
            shapeDistTraveled=float(58.247268564193675)
        )
...
class Test_Translations(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Translations(
            tableName='frhhgkmtfynxcjfmnafc',
            fieldName='blgjarhbrfbyxxykgyoh',
            language='gzhzbzwcttqyzosmcgcf',
            translation='utnyipynfztbwxbalzyq'
        )
        return instance
    ...
    def test_tableName_property(self):
        ...
        """
        test_value = 'frhhgkmtfynxcjfmnafc'
    ...
    def test_fieldName_property(self):
        ...
        """
        test_value = 'blgjarhbrfbyxxykgyoh'
    ...
    def test_language_property(self):
        ...
        """
        test_value = 'gzhzbzwcttqyzosmcgcf'
    ...
    def test_translation_property(self):
        ...
        """
        test_value = 'utnyipynfztbwxbalzyq'

...
class Test_LocationGroups(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = LocationGroups(
            locationGroupId='wgmewjbgrgdydqghjajc',
            locationGroupName='mufguhfgpawxtavmeajy',
            locationGroupDesc='hnnjinyvlmlrnwacmvoz',
            locationGroupUrl='dpdihtugypdmrfpcetpl'
        )
        return instance
    ...
    def test_locationGroupId_property(self):
        ...
        """
        test_value = 'wgmewjbgrgdydqghjajc'
    ...
    def test_locationGroupName_property(self):
        ...
        """
        test_value = 'mufguhfgpawxtavmeajy'
    ...
    def test_locationGroupDesc_property(self):
        ...
        """
        test_value = 'hnnjinyvlmlrnwacmvoz'
    ...
    def test_locationGroupUrl_property(self):
        ...
        """
        test_value = 'dpdihtugypdmrfpcetpl'

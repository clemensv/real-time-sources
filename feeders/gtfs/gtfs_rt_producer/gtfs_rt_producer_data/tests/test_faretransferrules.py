...
class Test_FareTransferRules(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = FareTransferRules(
            fareTransferRuleId='yobzrgplfphojoomhoan',
            fareProductId='uxgrlvsubnupppiaamhm',
            transferCount=int(67),
            fromLegGroupId='ucpfhauumqyzvnibhlul',
            toLegGroupId='srbphoujkdwsnlfqnzfo',
            duration=int(15),
            durationType='mjoqkmhbjnykpyqyjbwu'
        )
        return instance
    ...
    def test_fareTransferRuleId_property(self):
        ...
        """
        test_value = 'yobzrgplfphojoomhoan'
    ...
    def test_fareProductId_property(self):
        ...
        """
        test_value = 'uxgrlvsubnupppiaamhm'
    ...
    def test_fromLegGroupId_property(self):
        ...
        """
        test_value = 'ucpfhauumqyzvnibhlul'
    ...
    def test_toLegGroupId_property(self):
        ...
        """
        test_value = 'srbphoujkdwsnlfqnzfo'
    ...
    def test_durationType_property(self):
        ...
        """
        test_value = 'mjoqkmhbjnykpyqyjbwu'

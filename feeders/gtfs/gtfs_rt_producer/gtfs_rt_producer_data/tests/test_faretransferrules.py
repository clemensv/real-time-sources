...
class Test_FareTransferRules(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = FareTransferRules(
            fareTransferRuleId='wyjtoejnckrtplbugbmq',
            fareProductId='vhqlfhtxuuykgauhjcpq',
            transferCount=int(40),
            fromLegGroupId='zucxbnkosktcyshzbqay',
            toLegGroupId='wtdjiajezdzenixkvoji',
            duration=int(57),
            durationType='bcrttdrvvevssjppcgjq'
        )
        return instance
    ...
    def test_fareTransferRuleId_property(self):
        ...
        """
        test_value = 'wyjtoejnckrtplbugbmq'
    ...
    def test_fareProductId_property(self):
        ...
        """
        test_value = 'vhqlfhtxuuykgauhjcpq'
    ...
    def test_fromLegGroupId_property(self):
        ...
        """
        test_value = 'zucxbnkosktcyshzbqay'
    ...
    def test_toLegGroupId_property(self):
        ...
        """
        test_value = 'wtdjiajezdzenixkvoji'
    ...
    def test_durationType_property(self):
        ...
        """
        test_value = 'bcrttdrvvevssjppcgjq'

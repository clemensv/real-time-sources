...
from gtfs_rt_producer_data.generaltransitfeedrealtime.vehicledescriptor import VehicleDescriptor
...
class Test_VehicleDescriptor(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = VehicleDescriptor(
            id='pyhftmecfvgkdqlsvkhy',
            label='oxixusifwygvnxfkvvrw',
            license_plate='rrfbwcogenlvotzpimkz'
        )
        return instance
    ...
    def test_id_property(self):
        ...
        Test id property
        """
        test_value = 'pyhftmecfvgkdqlsvkhy'
    ...
    def test_label_property(self):
        ...
        Test label property
        """
        test_value = 'oxixusifwygvnxfkvvrw'
    ...
    def test_license_plate_property(self):
        ...
        """
        test_value = 'rrfbwcogenlvotzpimkz'

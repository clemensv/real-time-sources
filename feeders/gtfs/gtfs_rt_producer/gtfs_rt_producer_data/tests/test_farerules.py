...
class Test_FareRules(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = FareRules(
            fareId='cxkitedyhdjyfciertdk',
            routeId='ifzcmapxvjlfhtcvukno',
            originId='jeupuiuzbnyusmcgfdil',
            destinationId='fjqrudckcjfmoxagzbxi',
            containsId='txclsrxmrcvqfyenffob'
        )
        return instance
    ...
    def test_fareId_property(self):
        ...
        """
        test_value = 'cxkitedyhdjyfciertdk'
    ...
    def test_routeId_property(self):
        ...
        """
        test_value = 'ifzcmapxvjlfhtcvukno'
    ...
    def test_originId_property(self):
        ...
        """
        test_value = 'jeupuiuzbnyusmcgfdil'
    ...
    def test_destinationId_property(self):
        ...
        """
        test_value = 'fjqrudckcjfmoxagzbxi'
    ...
    def test_containsId_property(self):
        ...
        """
        test_value = 'txclsrxmrcvqfyenffob'

...
class Test_Frequencies(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Frequencies(
            tripId='bnwfagecwigvjxxxkypu',
            startTime='tlzxstywzzcoyimgjmld',
            endTime='xnrwkyouyrqhxxuskwcy',
            headwaySecs=int(93),
            exactTimes=int(12)
        )
        return instance
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'bnwfagecwigvjxxxkypu'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'tlzxstywzzcoyimgjmld'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'xnrwkyouyrqhxxuskwcy'

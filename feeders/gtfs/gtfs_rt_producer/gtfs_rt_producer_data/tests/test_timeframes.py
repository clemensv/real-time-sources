...
class Test_Timeframes(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Timeframes(
            timeframeGroupId='tkbnhxrgozdpoqrxfynb',
            startTime='tzfgfxnuhqqqdcajskxc',
            endTime='dqnehbqywomnwjhnfpzw',
            serviceDates=None
        )
        return instance
    ...
    def test_timeframeGroupId_property(self):
        ...
        """
        test_value = 'tkbnhxrgozdpoqrxfynb'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'tzfgfxnuhqqqdcajskxc'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'dqnehbqywomnwjhnfpzw'

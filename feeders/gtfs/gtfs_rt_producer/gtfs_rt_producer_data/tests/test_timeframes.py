...
class Test_Timeframes(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Timeframes(
            timeframeGroupId='sdyouaqmsibynnbotmhq',
            startTime='vfwzpgwkonsegkzssecw',
            endTime='stmnhtzchzmbjmzjgxiv',
            serviceDates=None
        )
        return instance
    ...
    def test_timeframeGroupId_property(self):
        ...
        """
        test_value = 'sdyouaqmsibynnbotmhq'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'vfwzpgwkonsegkzssecw'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'stmnhtzchzmbjmzjgxiv'

...
class Test_Timeframes(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Timeframes(
            timeframeGroupId='eaxwllsdhiuldbjucoow',
            startTime='flbwamglurybsufoxrfc',
            endTime='zkmzwifmistjxfmutxbu',
            serviceDates=None
        )
        return instance
    ...
    def test_timeframeGroupId_property(self):
        ...
        """
        test_value = 'eaxwllsdhiuldbjucoow'
    ...
    def test_startTime_property(self):
        ...
        """
        test_value = 'flbwamglurybsufoxrfc'
    ...
    def test_endTime_property(self):
        ...
        """
        test_value = 'zkmzwifmistjxfmutxbu'

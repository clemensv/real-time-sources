...
from test_gtfs_rt_producer_data_generaltransitfeed_alert_tripdescriptor_types_schedulerelationship import Test_ScheduleRelationship
...
class Test_TripDescriptor(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = TripDescriptor(
            trip_id='jtzbhoerwhqrorcutkmo',
            route_id='mfddizvjjrnuiijfkbeb',
            direction_id=int(15),
            start_time='ssepnytdeinwiwbnnbpy',
            start_date='qrzvwuleaohceyhrygga',
    ...
    def test_trip_id_property(self):
        ...
        """
        test_value = 'jtzbhoerwhqrorcutkmo'
    ...
    def test_route_id_property(self):
        ...
        """
        test_value = 'mfddizvjjrnuiijfkbeb'
    ...
    def test_start_time_property(self):
        ...
        """
        test_value = 'ssepnytdeinwiwbnnbpy'
    ...
    def test_start_date_property(self):
        ...
        """
        test_value = 'qrzvwuleaohceyhrygga'

...
from gtfs_rt_producer_data.generaltransitfeedrealtime.tripupdate_types.stoptimeupdate import StopTimeUpdate
from test_gtfs_rt_producer_data_generaltransitfeedrealtime_tripupdate_types_stoptimeevent import Test_StopTimeEvent
from test_gtfs_rt_producer_data_generaltransitfeedrealtime_tripupdate_types_stoptimeupdate_types_schedulerelationship import Test_ScheduleRelationship
...
class Test_StopTimeUpdate(unittest.TestCase):
    ...
    def test_stop_id_property(self):
        ...
        """
        test_value = 'nuiriaxxeoqbydohbbis'

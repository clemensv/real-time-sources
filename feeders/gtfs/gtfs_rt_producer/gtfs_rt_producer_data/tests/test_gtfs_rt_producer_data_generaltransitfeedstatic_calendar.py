...
class Test_Calendar(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Calendar(
            serviceId='vmooriwlnbcsxmummpre',
            ...
            startDate='evihvxjbrfhlyvbmpajk',
            endDate='ieodelzdpxxbtbvyzzfu'
        )
        return instance
    ...
    def test_serviceId_property(self):
        ...
        """
        test_value = 'vmooriwlnbcsxmummpre'
    ...
    def test_startDate_property(self):
        ...
        """
        test_value = 'evihvxjbrfhlyvbmpajk'
    ...
    def test_endDate_property(self):
        ...
        """
        test_value = 'ieodelzdpxxbtbvyzzfu'

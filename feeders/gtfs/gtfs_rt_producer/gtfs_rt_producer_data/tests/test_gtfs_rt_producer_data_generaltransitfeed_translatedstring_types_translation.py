...
from gtfs_rt_producer_data.generaltransitfeed.translatedstring_types.translation import Translation
...
class Test_Translation(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Translation(
            text='yxmcdahtroyklmguozgc',
            language='gueamjpvnibzxxhknflg'
        )
        return instance
    ...
    def test_text_property(self):
        ...
        Test text property
        """
        test_value = 'yxmcdahtroyklmguozgc'
    ...
    def test_language_property(self):
        ...
        """
        test_value = 'gueamjpvnibzxxhknflg'

...
class Test_TripDescriptor(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = TripDescriptor(
            trip_id='icrbwklumltxehuoiqta',
            route_id='xuirpnpnqrgkvwvvxtzh',
            direction_id=int(31),
            start_time='hccnjktcnmzunpmlgqrb',
            start_date='povehlwhzinlmzwpxeap',
    ...
    def test_trip_id_property(self):
        ...
        """
        test_value = 'icrbwklumltxehuoiqta'
    ...
    def test_route_id_property(self):
        ...
        """
        test_value = 'xuirpnpnqrgkvwvvxtzh'
    ...
    def test_start_time_property(self):
        ...
        """
        test_value = 'hccnjktcnmzunpmlgqrb'
    ...
    def test_start_date_property(self):
        ...
        """
        test_value = 'povehlwhzinlmzwpxeap'

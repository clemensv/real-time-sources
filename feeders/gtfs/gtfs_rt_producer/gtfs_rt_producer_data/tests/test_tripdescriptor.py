...
class Test_TripDescriptor(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = TripDescriptor(
            trip_id='jrhifzrsssnglivblitk',
            route_id='uiistwvwsigavetaotdh',
            direction_id=int(96),
            start_time='kdwybtrmqqprpjoxfxuv',
            start_date='pbgoqyrgozobcymznrda',
    ...
    def test_trip_id_property(self):
        ...
        """
        test_value = 'jrhifzrsssnglivblitk'
    ...
    def test_route_id_property(self):
        ...
        """
        test_value = 'uiistwvwsigavetaotdh'
    ...
    def test_start_time_property(self):
        ...
        """
        test_value = 'kdwybtrmqqprpjoxfxuv'
    ...
    def test_start_date_property(self):
        ...
        """
        test_value = 'pbgoqyrgozobcymznrda'

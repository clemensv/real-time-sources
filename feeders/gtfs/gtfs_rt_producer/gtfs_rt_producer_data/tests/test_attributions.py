...
class Test_Attributions(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Attributions(
            attributionId='mukiekkgpwwlbmnkbegc',
            agencyId='bpdwtbbtjveyedmajgxq',
            routeId='xfvbfcrqnnlaaumikygv',
            tripId='ncclyatwwzwuveeijpze',
            organizationName='szbdrgwghhhvshmycflj',
            isProducer=int(40),
            isOperator=int(5),
            isAuthority=int(44),
            attributionUrl='htrxxojwmveawrthzvst',
            attributionEmail='qfctkvfkjdbtovqyuyex',
            attributionPhone='kxzadcmfmsfmjckrhzfh'
        )
        return instance
    ...
    def test_attributionId_property(self):
        ...
        """
        test_value = 'mukiekkgpwwlbmnkbegc'
    ...
    def test_agencyId_property(self):
        ...
        """
        test_value = 'bpdwtbbtjveyedmajgxq'
    ...
    def test_routeId_property(self):
        ...
        """
        test_value = 'xfvbfcrqnnlaaumikygv'
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'ncclyatwwzwuveeijpze'
    ...
    def test_organizationName_property(self):
        ...
        """
        test_value = 'szbdrgwghhhvshmycflj'
    ...
    def test_attributionUrl_property(self):
        ...
        """
        test_value = 'htrxxojwmveawrthzvst'
    ...
    def test_attributionEmail_property(self):
        ...
        """
        test_value = 'qfctkvfkjdbtovqyuyex'
    ...
    def test_attributionPhone_property(self):
        ...
        """
        test_value = 'kxzadcmfmsfmjckrhzfh'

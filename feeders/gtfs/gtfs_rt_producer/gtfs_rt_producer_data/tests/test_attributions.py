...
class Test_Attributions(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Attributions(
            attributionId='wvqthsmycjdwmunrkmcz',
            agencyId='rllzciutlmnvzduduhpp',
            routeId='maebwzackvooyptspgin',
            tripId='gnjhdbzrvsovfketgzok',
            organizationName='splzfcuinphlrxnwcznk',
            isProducer=int(90),
            isOperator=int(34),
            isAuthority=int(58),
            attributionUrl='whxohrwgeesleqkvnoul',
            attributionEmail='ubrjfzxcxrtxtixupvlt',
            attributionPhone='efnayutsqznyhsoaamex'
        )
        return instance
    ...
    def test_attributionId_property(self):
        ...
        """
        test_value = 'wvqthsmycjdwmunrkmcz'
    ...
    def test_agencyId_property(self):
        ...
        """
        test_value = 'rllzciutlmnvzduduhpp'
    ...
    def test_routeId_property(self):
        ...
        """
        test_value = 'maebwzackvooyptspgin'
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'gnjhdbzrvsovfketgzok'
    ...
    def test_organizationName_property(self):
        ...
        """
        test_value = 'splzfcuinphlrxnwcznk'
    ...
    def test_attributionUrl_property(self):
        ...
        """
        test_value = 'whxohrwgeesleqkvnoul'
    ...
    def test_attributionEmail_property(self):
        ...
        """
        test_value = 'ubrjfzxcxrtxtixupvlt'
    ...
    def test_attributionPhone_property(self):
        ...
        """
        test_value = 'efnayutsqznyhsoaamex'

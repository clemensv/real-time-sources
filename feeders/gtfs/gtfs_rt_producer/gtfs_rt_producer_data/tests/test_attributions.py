...
class Test_Attributions(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Attributions(
            attributionId='fqtkyuezgqozzegaskhj',
            agencyId='vzlxlohghiagkwtgdbza',
            routeId='mmishjcupbtkxsshuvkk',
            tripId='pgarnyeopyblcgxpffaj',
            organizationName='mifdvmwripetrjqlpndz',
            isProducer=int(60),
            isOperator=int(7),
            isAuthority=int(89),
            attributionUrl='ohfplailcjyygtfdpzll',
            attributionEmail='hchwktnildkglrrbiajh',
            attributionPhone='kqeqylpefprpaaosfdtg'
        )
        return instance
    ...
    def test_attributionId_property(self):
        ...
        """
        test_value = 'fqtkyuezgqozzegaskhj'
    ...
    def test_agencyId_property(self):
        ...
        """
        test_value = 'vzlxlohghiagkwtgdbza'
    ...
    def test_routeId_property(self):
        ...
        """
        test_value = 'mmishjcupbtkxsshuvkk'
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'pgarnyeopyblcgxpffaj'
    ...
    def test_organizationName_property(self):
        ...
        """
        test_value = 'mifdvmwripetrjqlpndz'
    ...
    def test_attributionUrl_property(self):
        ...
        """
        test_value = 'ohfplailcjyygtfdpzll'
    ...
    def test_attributionEmail_property(self):
        ...
        """
        test_value = 'hchwktnildkglrrbiajh'
    ...
    def test_attributionPhone_property(self):
        ...
        """
        test_value = 'kqeqylpefprpaaosfdtg'

...
class Test_Attributions(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Attributions(
            attributionId='zweojxlmrtlkkfujuicx',
            agencyId='bmqpstkfgkzdybxogbpf',
            routeId='rnvvvlsxkfmkeownkkau',
            tripId='fvkruyiclmelqorncqlp',
            organizationName='rigabkjgadwogmyuenyc',
            isProducer=int(39),
            isOperator=int(28),
            isAuthority=int(50),
            attributionUrl='aieentndtlruyniehthn',
            attributionEmail='iejfzhxklpjyaiwzokzy',
            attributionPhone='igrqeopqvniqsdaqdtxw'
        )
        return instance
    ...
    def test_attributionId_property(self):
        ...
        """
        test_value = 'zweojxlmrtlkkfujuicx'
    ...
    def test_agencyId_property(self):
        ...
        """
        test_value = 'bmqpstkfgkzdybxogbpf'
    ...
    def test_routeId_property(self):
        ...
        """
        test_value = 'rnvvvlsxkfmkeownkkau'
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'fvkruyiclmelqorncqlp'
    ...
    def test_organizationName_property(self):
        ...
        """
        test_value = 'rigabkjgadwogmyuenyc'
    ...
    def test_attributionUrl_property(self):
        ...
        """
        test_value = 'aieentndtlruyniehthn'
    ...
    def test_attributionEmail_property(self):
        ...
        """
        test_value = 'iejfzhxklpjyaiwzokzy'
    ...
    def test_attributionPhone_property(self):
        ...
        """
        test_value = 'igrqeopqvniqsdaqdtxw'

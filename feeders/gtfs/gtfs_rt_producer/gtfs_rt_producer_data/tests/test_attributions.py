...
class Test_Attributions(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Attributions(
            attributionId='jistpufizytcatpeinos',
            agencyId='nfgooivedjodlswyvhte',
            routeId='nrgsaluqjtsybtzipknp',
            tripId='uoxndgjydvzwfcqvwwjd',
            organizationName='zelmefwjugehwwhkbbah',
            isProducer=int(97),
            isOperator=int(51),
            isAuthority=int(53),
            attributionUrl='czldxmetwdkonlkiaerd',
            attributionEmail='wcssnqvotelaqyxgbkoc',
            attributionPhone='kqzdproqzjtjqrdxihbr'
        )
        return instance
    ...
    def test_attributionId_property(self):
        ...
        """
        test_value = 'jistpufizytcatpeinos'
    ...
    def test_agencyId_property(self):
        ...
        """
        test_value = 'nfgooivedjodlswyvhte'
    ...
    def test_routeId_property(self):
        ...
        """
        test_value = 'nrgsaluqjtsybtzipknp'
    ...
    def test_tripId_property(self):
        ...
        """
        test_value = 'uoxndgjydvzwfcqvwwjd'
    ...
    def test_organizationName_property(self):
        ...
        """
        test_value = 'zelmefwjugehwwhkbbah'
    ...
    def test_attributionUrl_property(self):
        ...
        """
        test_value = 'czldxmetwdkonlkiaerd'
    ...
    def test_attributionEmail_property(self):
        ...
        """
        test_value = 'wcssnqvotelaqyxgbkoc'
    ...
    def test_attributionPhone_property(self):
        ...
        """
        test_value = 'kqzdproqzjtjqrdxihbr'

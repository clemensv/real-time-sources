...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../bom_australia_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../bom_australia_amqp_producer_amqp_producer/src')))
...
class TestAUGovBOMWeatherAmqpProducer:
    """Test cases for AUGovBOMWeatherAmqpProducer"""
...
class TestAUGovBOMWarningAmqpProducer:
    """Test cases for AUGovBOMWarningAmqpProducer"""

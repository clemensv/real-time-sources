...
class Test_WarningBulletin(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = WarningBulletin(
            warning_id='pnesrzznoykbnpmcibpw',
            warning_url='oitelfxglkllhivziblz',
            feed_url='uiqnkdgvdpbyohtbsvta',
            feed_title='emwoniyqqsuhvfxhngxa',
            title='zcnvohoohbqxeemfzvaf',
            published_at=datetime.datetime.now(datetime.timezone.utc),
            issued_local_time_text='zbtoarlfgasskwlrqryy',
            warning_type='dcjhcshudfdxpiswmrjw',
            affected_area_text='jcxgjebchvkngkhfgpon',
            severity='exisumiczeexiickikny',
            state='silrsrtgwwcxhdqtclqc'
        )
        return instance
    ...
    def test_warning_id_property(self):
        ...
        """
        test_value = 'pnesrzznoykbnpmcibpw'
    ...
    def test_warning_url_property(self):
        ...
        """
        test_value = 'oitelfxglkllhivziblz'
    ...
    def test_feed_url_property(self):
        ...
        """
        test_value = 'uiqnkdgvdpbyohtbsvta'
    ...
    def test_feed_title_property(self):
        ...
        """
        test_value = 'emwoniyqqsuhvfxhngxa'
    ...
    def test_title_property(self):
        ...
        Test title property
        """
        test_value = 'zcnvohoohbqxeemfzvaf'
    ...
    def test_issued_local_time_text_property(self):
        ...
        """
        test_value = 'zbtoarlfgasskwlrqryy'
    ...
    def test_warning_type_property(self):
        ...
        """
        test_value = 'dcjhcshudfdxpiswmrjw'
    ...
    def test_affected_area_text_property(self):
        ...
        """
        test_value = 'jcxgjebchvkngkhfgpon'
    ...
    def test_severity_property(self):
        ...
        """
        test_value = 'exisumiczeexiickikny'
    ...
    def test_state_property(self):
        ...
        Test state property
        """
        test_value = 'silrsrtgwwcxhdqtclqc'

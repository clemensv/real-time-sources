...
xrcg generate --style kafkaproducer --language py --definitions $xregFile --endpoint 'JP.ODPT.DocomoBikeshare.System.Kafka' --projectname tokyo_docomo_bikeshare_producer --output (Join-Path $scriptDir 'tokyo_docomo_bikeshare_producer')

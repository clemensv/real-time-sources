...
class JPODPTDocomoBikeshareSystemAmqpProducer:
    """
    Producer class to send messages in the `JP.ODPT.DocomoBikeshare.System.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_amqp(self,
        ...
        attributes = {
            ...
            "source":
            "https://api-public.odpt.org/api/v4/gbfs/docomo-cycle-tokyo",
            "subject":
...
class JPODPTDocomoBikeshareStationsAmqpProducer:
    """
    Producer class to send messages in the `JP.ODPT.DocomoBikeshare.Stations.amqp` message group via AMQP 1.0 protocol.
    """

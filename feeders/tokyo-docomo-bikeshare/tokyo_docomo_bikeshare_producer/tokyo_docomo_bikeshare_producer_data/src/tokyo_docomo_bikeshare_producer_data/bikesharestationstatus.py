""" BikeshareStationStatus dataclass. """
...
class BikeshareStationStatus:
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'BikeshareStationStatus':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['BikeshareStationStatus']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return BikeshareStationStatus.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'BikeshareStationStatus':
        """
        ...
        """
        return cls(
            system_id='dorrtjangxrcqnnophss',
            station_id='osowfpdrmykekjgaddzh',
            num_bikes_available=int(35),
            num_bikes_disabled=int(51),
            num_docks_available=int(87),
            num_docks_disabled=int(20),
            is_installed=False,
            is_renting=True,
            is_returning=False,
            last_reported=int(77)
        )
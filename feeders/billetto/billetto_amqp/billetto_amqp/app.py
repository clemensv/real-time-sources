"""AMQP companion feeder for billetto. Publishes mock/sample CloudEvents for Docker E2E and auth-blocked upstreams."""
...
from billetto_amqp_producer_amqp_producer import producer as producer_mod
import billetto_amqp_producer_data as data_mod
...
def _val(name, typ):
    ...
    if 'country' in n: return 'gb' if 'billetto'=='elexon-bmrs' else ('jp' if 'billetto'=='tepco-denkiyoho' else 'dk' if 'billetto'=='energidataservice-dk' else 'de' if 'billetto'=='energy-charts' else 'nl')

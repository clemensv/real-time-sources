...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../billetto_producer_data/src')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../billetto_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../billetto_producer_kafka_producer/src')))
...
def test_billetto_events_billettoeventsevent(kafka_emulator):
    """Test the BillettoEventsEvent event from the Billetto.Events message group"""
    ...
    consumer = Consumer({
        ...
        'group.id': 'test_billetto_events_billettoeventsevent',  # Unique group per test
...
def test_billetto_events_mqtt_billettoeventsmqttevent(kafka_emulator):
    """Test the BillettoEventsMqttEvent event from the Billetto.Events.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_billetto_events_mqtt_billettoeventsmqttevent',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_billetto_events_amqp_billettoeventsamqpevent(kafka_emulator):
    """Test the BillettoEventsAmqpEvent event from the Billetto.Events.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_billetto_events_amqp_billettoeventsamqpevent',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])

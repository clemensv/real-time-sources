...
async def main(connection_string: Optional[str], producer_config: Optional[str], topic: Optional[str]):
    ...
    if connection_string:
        ...
        billetto_events_event_producer = BillettoEventsEventProducer.from_connection_string(connection_string, topic, 'binary')
    else:
        # use a Kafka producer configuration provided as JSON text
        kafka_producer = KafkaProducer(json.loads(producer_config))
        billetto_events_event_producer = BillettoEventsEventProducer(kafka_producer, topic, 'binary')

    # ---- Billetto.Events.Event ----
    # TODO: Supply event data for the Billetto.Events.Event event
    _event = Event()

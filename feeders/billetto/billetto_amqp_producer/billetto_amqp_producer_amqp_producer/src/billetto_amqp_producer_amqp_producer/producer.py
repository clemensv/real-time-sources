...
class BillettoEventsAmqpProducer:
    """
    Producer class to send messages in the `Billetto.Events.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_event(self,
        ...
        """
        Send the `Billetto.Events.amqp.Event` message
    ...
    def send_event_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `Billetto.Events.amqp.Event` messages

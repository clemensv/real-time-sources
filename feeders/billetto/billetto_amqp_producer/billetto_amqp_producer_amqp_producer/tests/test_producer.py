...
"""
Tests for billetto_amqp_producer_amqp_producer
"""
import base64
import json
import os
...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../billetto_amqp_producer_data/src')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../billetto_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../billetto_amqp_producer_amqp_producer/src')))

from billetto_amqp_producer_amqp_producer import *
from billetto_amqp_producer_data import Event
from test_billetto_amqp_producer_data_event import Test_Event
...
class TestBillettoEventsAmqpProducer:
    """Test cases for BillettoEventsAmqpProducer"""

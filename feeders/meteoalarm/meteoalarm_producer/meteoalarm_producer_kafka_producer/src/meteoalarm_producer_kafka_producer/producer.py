...
class MeteoalarmWarningsEventProducer:
    ...
    def send_meteoalarm_weather_warning(self,_identifier : str, data: WeatherWarning, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, WeatherWarning], str]=None) -> None:
        """
        Sends the 'Meteoalarm.WeatherWarning' event to the Kafka topic
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'MeteoalarmWarningsEventProducer':
        """
...
class MeteoalarmWarningsMqttEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    def send_meteoalarm_warnings_mqtt_weather_warning(self,_identifier : str, data: WeatherWarning, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, WeatherWarning], str]=None) -> None:
        """
        Sends the 'Meteoalarm.Warnings.mqtt.WeatherWarning' event to the Kafka topic
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'MeteoalarmWarningsMqttEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.
...
class MeteoalarmWarningsAmqpEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    def send_meteoalarm_warnings_amqp_weather_warning(self,_identifier : str, data: WeatherWarning, content_type: str = "application/json", _time: typing.Optional[typing.Union[str, datetime]] = None, flush_producer=True, key_mapper: typing.Callable[[CloudEvent, WeatherWarning], str]=None) -> None:
        """
        Sends the 'Meteoalarm.Warnings.amqp.WeatherWarning' event to the Kafka topic
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'MeteoalarmWarningsAmqpEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.

...
class BaseStationReport:
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'BaseStationReport':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['BaseStationReport']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return BaseStationReport.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'BaseStationReport':
        """
        ...
        return cls(
            ...
            Longitude=float(26.72747528598619),
            Latitude=float(12.938111343577008),
            FixType=int(62),
            LongRangeEnable=True,
            Spare=int(86),
            Raim=True,
            CommunicationState=int(65)
        )
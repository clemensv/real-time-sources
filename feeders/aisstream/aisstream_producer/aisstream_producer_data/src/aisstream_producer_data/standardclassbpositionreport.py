""" StandardClassBPositionReport dataclass. """
...
class StandardClassBPositionReport:
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'StandardClassBPositionReport':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['StandardClassBPositionReport']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return StandardClassBPositionReport.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'StandardClassBPositionReport':
        """
        ...
        return cls(
            ...
            Valid=False,
            Spare1=int(20),
            Sog=float(52.821584565717785),
            PositionAccuracy=True,
            Longitude=float(77.18482865465499),
            Latitude=float(37.60999692061247),
            Cog=float(10.89826020654937),
            TrueHeading=int(51),
            Timestamp=int(73),
            Spare2=int(15),
            ClassBUnit=False,

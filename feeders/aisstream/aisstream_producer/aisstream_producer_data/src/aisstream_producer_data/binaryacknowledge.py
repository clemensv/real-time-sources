...
class BinaryAcknowledge:
    ...
    Attributes:
        ...
        Destinations (typing.Optional[typing.Dict[str, str]])
    """
    ...
    Destinations: typing.Optional[typing.Dict[str, str]]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="Destinations"))

    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'BinaryAcknowledge':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['BinaryAcknowledge']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return BinaryAcknowledge.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'BinaryAcknowledge':
        """
        ...
        return cls(
            ...
            Valid=False,
            Spare=int(50),
            Destinations={'hkuutxvdyiqgjacdfonh': 'muvxvmztqqvzuqnflbtv', 'vzzyvelfhkynylqzqdwb': 'ijkiqcjmqsfectsvjgrh', 'gmsjpbgenykyeiatqwdz': 'zagrsdtfxohmrashaumm', 'hypwixgpeedsnnicxzle': 'zkcxmdevkutngxnmwzhk'}
        )
""" StandardSearchAndRescueAircraftReport dataclass. """
...
class StandardSearchAndRescueAircraftReport:
    ...
    Attributes:
        ...
        AltFromBaro (typing.Optional[bool])
    ...
    Altitude: typing.Optional[int]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="Altitude"))
    ...
    AltFromBaro: typing.Optional[bool]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="AltFromBaro"))
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'StandardSearchAndRescueAircraftReport':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['StandardSearchAndRescueAircraftReport']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return StandardSearchAndRescueAircraftReport.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'StandardSearchAndRescueAircraftReport':
        """
        ...
        return cls(
            ...
            Valid=True,
            Altitude=int(61),
            Sog=float(65.6481909986249),
            PositionAccuracy=False,
            Longitude=float(65.80195056393498),
            Latitude=float(81.34450569785018),
            Cog=float(63.13717441127649),
            Timestamp=int(26),
            AltFromBaro=True,
            Spare1=int(22),
            Dte=False,

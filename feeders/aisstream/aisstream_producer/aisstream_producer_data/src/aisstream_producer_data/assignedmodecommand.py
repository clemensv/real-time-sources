...
class AssignedModeCommand:
    ...
    Attributes:
        ...
        Commands (typing.Optional[typing.Dict[str, str]])
    """
    ...
    Commands: typing.Optional[typing.Dict[str, str]]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="Commands"))

    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'AssignedModeCommand':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['AssignedModeCommand']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return AssignedModeCommand.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'AssignedModeCommand':
        """
        ...
        return cls(
            ...
            Valid=True,
            Spare=int(12),
            Commands={'tqpqvvmicmkgpbxjrrwv': 'qtorpsvixjxpqgznmciq', 'kefagkbthdegwnwmqwzj': 'ycggekjzcwokbhhfsrum', 'iuctpcnfoovauugudvpy': 'nnbyyhcgisrckchfasfw', 'ewkirhvcxaosgtlabfwl': 'owooeodjwxexujpueqmi', 'apbbpzopyftadyvhcdnp': 'vmjnofoibsbnnsslvncw'}
        )
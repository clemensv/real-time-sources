""" DataLinkManagementMessage dataclass. """
...
class DataLinkManagementMessage:
    ...
    Data: typing.Optional[typing.Dict[str, str]]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="Data"))

    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'DataLinkManagementMessage':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['DataLinkManagementMessage']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return DataLinkManagementMessage.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'DataLinkManagementMessage':
        """
        ...
        return cls(
            ...
            Valid=True,
            Spare=int(100),
            Data={'hywinhrnhwgwrwvbyzlj': 'akzhhuukqcowyrdsglra', 'warvpoukiutlptbytqkm': 'qmzalnahzmvdccrdbxgi', 'krlchdvyodizbhmzrfzz': 'kzuwxsexdmlqkvaqqcph', 'zoepfuxorjbouvnpheiz': 'tskxymijfgfhiazdxjgn', 'ihugkfuckyzvmbihpprn': 'pkvpxpuisnjnshjnuamx'}
        )
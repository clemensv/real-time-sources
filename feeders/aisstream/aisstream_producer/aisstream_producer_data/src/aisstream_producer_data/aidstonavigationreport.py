""" AidsToNavigationReport dataclass. """
...
class AidsToNavigationReport:
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'AidsToNavigationReport':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['AidsToNavigationReport']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return AidsToNavigationReport.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'AidsToNavigationReport':
        """
        ...
        return cls(
            ...
            Valid=True,
            Type=int(36),
            Name='ejopshlqdxtscvfgmwjj',
            PositionAccuracy=True,
            Longitude=float(87.01362724306598),
            Latitude=float(15.643276802826367),
            Dimension=None,
            Fixtype=int(80),
            Timestamp=int(84),
            OffPosition=True,
            ...
            AssignedMode=True,
            Spare=False,
            NameExtension='glxxtsqniypunnktkqty'
        )
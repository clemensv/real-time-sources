...
from aisstream_amqp_producer_data.shipstaticdata import ShipStaticData
...
class Test_ShipStaticData(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = ShipStaticData(
            ...
            AisVersion=int(87),
            ImoNumber=int(4),
            CallSign='knovaerxljjqmaicxscw',
            Name='oesphszbfgfqcttmctcx',
            Type=int(58),
            Dimension=None,
            FixType=int(39),
            Eta=None,
            MaximumStaticDraught=float(28.143966283293153),
            Destination='zhttshdykuqnysjamroj',
            Dte=True,
            Spare=False
        )
        return instance
    ...
    def test_CallSign_property(self):
        ...
        """
        test_value = 'knovaerxljjqmaicxscw'
    ...
    def test_Name_property(self):
        ...
        Test Name property
        """
        test_value = 'oesphszbfgfqcttmctcx'
    ...
    def test_MaximumStaticDraught_property(self):
        ...
        """
        test_value = float(28.143966283293153)
    ...
    def test_Destination_property(self):
        ...
        """
        test_value = 'zhttshdykuqnysjamroj'

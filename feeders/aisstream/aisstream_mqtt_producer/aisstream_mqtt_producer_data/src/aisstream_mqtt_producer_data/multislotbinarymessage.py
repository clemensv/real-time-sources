""" MultiSlotBinaryMessage dataclass. """
...
class MultiSlotBinaryMessage:
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'MultiSlotBinaryMessage':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['MultiSlotBinaryMessage']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return MultiSlotBinaryMessage.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'MultiSlotBinaryMessage':
        """
        ...
        return cls(
            ...
            Spare1=int(87),
            ApplicationID=None,
            Payload='mboqxqbsjnkdhnkahbxl',
            Spare2=int(19),
            CommunicationStateIsItdma=True,
            CommunicationState=int(31)
        )
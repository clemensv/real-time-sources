""" GnssBroadcastBinaryMessage dataclass. """
...
class GnssBroadcastBinaryMessage:
    ...
    Data: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="Data"))

    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'GnssBroadcastBinaryMessage':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['GnssBroadcastBinaryMessage']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return GnssBroadcastBinaryMessage.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'GnssBroadcastBinaryMessage':
        """
        ...
        return cls(
            ...
            Valid=False,
            Spare1=int(24),
            Longitude=float(46.78426183599527),
            Latitude=float(64.78881750123756),
            Spare2=int(50),
            Data='xfgnryzcufjfxkqofcjd'
        )
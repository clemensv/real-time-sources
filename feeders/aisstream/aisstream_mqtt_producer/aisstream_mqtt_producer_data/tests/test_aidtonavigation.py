...
from aisstream_mqtt_producer_data.aidtonavigation import AidToNavigation
...
class Test_AidToNavigation(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = AidToNavigation(
            mmsi='pymrclytbaukwoookkma',
            flag='tahjzpdiesomkygkpkzl',
            ship_type='huuwzdhageafnmmmgqnu',
            geohash5='xiosenrtlsxupjqckeia',
            msg_type=MsgTypeenum.position_report,
            user_id=int(11),
            name='akomuckcprqogbjunovv',
            type=int(79),
            latitude=float(48.85614600352365),
            longitude=float(97.11181675583798),
            off_position=False,
            virtual_atoN=True,
            message_id=int(52)
        )
    ...
    def test_mmsi_property(self):
        ...
        Test mmsi property
        """
        test_value = 'pymrclytbaukwoookkma'
    ...
    def test_flag_property(self):
        ...
        Test flag property
        """
        test_value = 'tahjzpdiesomkygkpkzl'
    ...
    def test_ship_type_property(self):
        ...
        """
        test_value = 'huuwzdhageafnmmmgqnu'
    ...
    def test_geohash5_property(self):
        ...
        """
        test_value = 'xiosenrtlsxupjqckeia'
    ...
    def test_name_property(self):
        ...
        Test name property
        """
        test_value = 'akomuckcprqogbjunovv'
    ...
    def test_latitude_property(self):
        ...
        """
        test_value = float(48.85614600352365)
    ...
    def test_longitude_property(self):
        ...
        """
        test_value = float(97.11181675583798)

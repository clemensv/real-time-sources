...
from aisstream_mqtt_producer_data.assignedmodecommand import AssignedModeCommand
...
class Test_AssignedModeCommand(unittest.TestCase):
    ...
    def test_Commands_property(self):
        ...
        """
        test_value = {'zfrxckzuuwlcygitjejj': 'ksbpisjenhcuftbotkrv', 'wqklakvmkpoboodxubvp': 'uvgnhwraestnqtouewvu', 'lsboojdkgrnigxogbtul': 'nugclfzwdfxzlayjytar', 'zfejhymlspepqaduvexg': 'duvpxvjezdubstwyjoai'}

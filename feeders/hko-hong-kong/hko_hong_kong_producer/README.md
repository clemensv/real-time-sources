...
# Hko_hong_kong_producer Kafka Producer# Hko_hong_kong_producer Event Dispatcher for Apache Kafka
...
3. [Quick Start](#quick-start)    - HKGovHKOWeatherEventDispatcher,

4. [Generated Producer Classes](#generated-producer-classes)    HKGovHKOWeatherMqttEventDispatcher,

4. [Generated Producer Classes](#generated-producer-classes)    HKGovHKOWeatherAmqpEventDispatcher
...
- HKGovHKOWeatherProducersolution for event-driven applications.

It includes both plain Kafka messages and CloudEvents, offering a versatile

- HKGovHKOWeatherMqttProducersolution for event-driven applications.

It includes both plain Kafka messages and CloudEvents, offering a versatile

- HKGovHKOWeatherAmqpProducersolution for event-driven applications.
...
- **Scales horizontally** across multiple brokers and partitions### HKGovHKOWeatherEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`HKGovHKOWeatherEventDispatcher` handles events for the HK.Gov.HKO.Weather message group.
...
from hko_hong_kong_producer import HKGovHKOWeatherProducer```python

create_processor(self, bootstrap_servers: str, group_id: str, topics: List[str]) -> EventProcessorRunner

# Create producer```

producer = HKGovHKOWeatherProducer(
...
await producer.send_hk_gov_hko_weather_station(```python
...
The HKGovHKOWeatherEventDispatcher defines the following event handler hooks.
...
producer = HKGovHKOWeatherProducer(
    ...
    security_protocol='SASL_SSL',##### `hk_gov_hko_weather_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'hk_gov_hko_weather_station_async:  Callable[[ConsumerRecord, CloudEvent, Station],
Awaitable[None]]
...
Asynchronous handler hook for `HK.Gov.HKO.Weather.Station`: A reference record published by the Hong Kong Observatory.
It lets consumers label, group, and route the live measurement or forecast events.
...
### HKGovHKOWeatherProducer- `data`: The event data of type `hko_hong_kong_producer_data.Station`.



Producer for `HK.Gov.HKO.Weather` message group.Example:



#### Constructor```python

async def hk_gov_hko_weather_station_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Station) -> None:

```python    # Process the event data

HKGovHKOWeatherProducer(    await some_processing_function(record, cloud_event, data)
...
hk_gov_hko_weather_dispatcher.hk_gov_hko_weather_station_async = hk_gov_hko_weather_station_event
...
### HKGovHKOWeatherMqttProducer- `data`: The event data of type `hko_hong_kong_producer_data.Station`.



Producer for `HK.Gov.HKO.Weather.mqtt` message group.Example:
...
HKGovHKOWeatherMqttProducer(    await some_processing_function(record, cloud_event, data)
...
hk_gov_hko_weather_mqtt_dispatcher.hk_gov_hko_weather_station_async = hk_gov_hko_weather_station_event
...
### HKGovHKOWeatherAmqpProducer- `data`: The event data of type `hko_hong_kong_producer_data.Station`.



Producer for `HK.Gov.HKO.Weather.amqp` message group.Example:
...
HKGovHKOWeatherAmqpProducer(    await some_processing_function(record, cloud_event, data)
...
hk_gov_hko_weather_amqp_dispatcher.hk_gov_hko_weather_station_async = hk_gov_hko_weather_station_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `hk_gov_hko_weather_weather_observation_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'hk_gov_hko_weather_weather_observation_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `HK.Gov.HKO.Weather.WeatherObservation`: A current environmental measurement from the Hong
Kong Observatory. It carries weather observations when the upstream feed reports a new or refreshed value.
...
### HKGovHKOWeatherProducer- `data`: The event data of type `hko_hong_kong_producer_data.WeatherObservation`.
...
async def hk_gov_hko_weather_weather_observation_event(record: ConsumerRecord, cloud_event: CloudEvent, data:
...
hk_gov_hko_weather_dispatcher.hk_gov_hko_weather_weather_observation_async =
hk_gov_hko_weather_weather_observation_event
...
### HKGovHKOWeatherMqttProducer- `data`: The event data of type `hko_hong_kong_producer_data.WeatherObservation`.
...
hk_gov_hko_weather_mqtt_dispatcher.hk_gov_hko_weather_weather_observation_async =
hk_gov_hko_weather_weather_observation_event
...
### HKGovHKOWeatherAmqpProducer- `data`: The event data of type `hko_hong_kong_producer_data.WeatherObservation`.
...
hk_gov_hko_weather_amqp_dispatcher.hk_gov_hko_weather_weather_observation_async =
hk_gov_hko_weather_weather_observation_event
...
##### `send_hk_gov_hko_weather_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_hk_gov_hko_weather_station(
...
Send a single `HK.Gov.HKO.Weather.Station` message. A reference record published by the Hong Kong Observatory. It lets
consumers label, group, and route the live measurement or forecast events.Args:
...
await producer.send_hk_gov_hko_weather_station(
...
Send multiple `HK.Gov.HKO.Weather.Station` messages in a batch.
...
await producer.send_hk_gov_hko_weather_station_batch(```
...
##### `send_hk_gov_hko_weather_weather_observation`Dispatchers have the following protected methods:



```python### Methods:

async def send_hk_gov_hko_weather_weather_observation(
...
Send a single `HK.Gov.HKO.Weather.WeatherObservation` message. A current environmental measurement from the Hong Kong
Observatory. It carries weather observations when the upstream feed reports a new or refreshed value.Args:
...
await producer.send_hk_gov_hko_weather_weather_observation(
...
Send multiple `HK.Gov.HKO.Weather.WeatherObservation` messages in a batch.
...
await producer.send_hk_gov_hko_weather_weather_observation_batch(```
...
- **Scales horizontally** across multiple brokers and partitions### HKGovHKOWeatherMqttEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`HKGovHKOWeatherMqttEventDispatcher` handles events for the HK.Gov.HKO.Weather.mqtt message group.
...
The HKGovHKOWeatherMqttEventDispatcher defines the following event handler hooks.
...
producer = HKGovHKOWeatherProducer(
    ...
    security_protocol='SASL_SSL',##### `hk_gov_hko_weather_mqtt_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'hk_gov_hko_weather_mqtt_station_async:  Callable[[ConsumerRecord, CloudEvent, Station],
Awaitable[None]]
...
Asynchronous handler hook for `HK.Gov.HKO.Weather.mqtt.Station`: A reference record published by the Hong Kong
Observatory. It lets consumers label, group, and route the live measurement or forecast events.
...
async def hk_gov_hko_weather_mqtt_station_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Station) -> None:
...
hk_gov_hko_weather_dispatcher.hk_gov_hko_weather_mqtt_station_async = hk_gov_hko_weather_mqtt_station_event
...
hk_gov_hko_weather_mqtt_dispatcher.hk_gov_hko_weather_mqtt_station_async = hk_gov_hko_weather_mqtt_station_event
...
hk_gov_hko_weather_amqp_dispatcher.hk_gov_hko_weather_mqtt_station_async = hk_gov_hko_weather_mqtt_station_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `hk_gov_hko_weather_mqtt_weather_observation_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'hk_gov_hko_weather_mqtt_weather_observation_async:  Callable[[ConsumerRecord,
...
Asynchronous handler hook for `HK.Gov.HKO.Weather.mqtt.WeatherObservation`: A current environmental measurement from the
Hong Kong Observatory. It carries weather observations when the upstream feed reports a new or refreshed value.
...
async def hk_gov_hko_weather_mqtt_weather_observation_event(record: ConsumerRecord, cloud_event: CloudEvent, data:
WeatherObservation) -> None:
...
hk_gov_hko_weather_dispatcher.hk_gov_hko_weather_mqtt_weather_observation_async =
hk_gov_hko_weather_mqtt_weather_observation_event
...
hk_gov_hko_weather_mqtt_dispatcher.hk_gov_hko_weather_mqtt_weather_observation_async =
hk_gov_hko_weather_mqtt_weather_observation_event
...
hk_gov_hko_weather_amqp_dispatcher.hk_gov_hko_weather_mqtt_weather_observation_async =
hk_gov_hko_weather_mqtt_weather_observation_event
...
##### `send_hk_gov_hko_weather_mqtt_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_hk_gov_hko_weather_mqtt_station(
...
Send a single `HK.Gov.HKO.Weather.mqtt.Station` message. A reference record published by the Hong Kong Observatory. It
lets consumers label, group, and route the live measurement or forecast events.Args:
...
await producer.send_hk_gov_hko_weather_mqtt_station(
...
Send multiple `HK.Gov.HKO.Weather.mqtt.Station` messages in a batch.
...
await producer.send_hk_gov_hko_weather_mqtt_station_batch(```
...
##### `send_hk_gov_hko_weather_mqtt_weather_observation`Dispatchers have the following protected methods:



```python### Methods:

async def send_hk_gov_hko_weather_mqtt_weather_observation(
...
Send a single `HK.Gov.HKO.Weather.mqtt.WeatherObservation` message. A current environmental measurement from the Hong
Kong Observatory. It carries weather observations when the upstream feed reports a new or refreshed value.Args:
...
await producer.send_hk_gov_hko_weather_mqtt_weather_observation(
...
Send multiple `HK.Gov.HKO.Weather.mqtt.WeatherObservation` messages in a batch.
...
await producer.send_hk_gov_hko_weather_mqtt_weather_observation_batch(```
...
- **Scales horizontally** across multiple brokers and partitions### HKGovHKOWeatherAmqpEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`HKGovHKOWeatherAmqpEventDispatcher` handles events for the HK.Gov.HKO.Weather.amqp message group.
...
The HKGovHKOWeatherAmqpEventDispatcher defines the following event handler hooks.
...
producer = HKGovHKOWeatherProducer(
    ...
    security_protocol='SASL_SSL',##### `hk_gov_hko_weather_amqp_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'hk_gov_hko_weather_amqp_station_async:  Callable[[ConsumerRecord, CloudEvent, Station],
Awaitable[None]]
...
Asynchronous handler hook for `HK.Gov.HKO.Weather.amqp.Station`: A reference record published by the Hong Kong
Observatory. It lets consumers label, group, and route the live measurement or forecast events.
...
async def hk_gov_hko_weather_amqp_station_event(record: ConsumerRecord, cloud_event: CloudEvent, data: Station) -> None:
...
hk_gov_hko_weather_dispatcher.hk_gov_hko_weather_amqp_station_async = hk_gov_hko_weather_amqp_station_event
...
hk_gov_hko_weather_mqtt_dispatcher.hk_gov_hko_weather_amqp_station_async = hk_gov_hko_weather_amqp_station_event
...
hk_gov_hko_weather_amqp_dispatcher.hk_gov_hko_weather_amqp_station_async = hk_gov_hko_weather_amqp_station_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `hk_gov_hko_weather_amqp_weather_observation_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'hk_gov_hko_weather_amqp_weather_observation_async:  Callable[[ConsumerRecord,
CloudEvent, WeatherObservation], Awaitable[None]]
...
Asynchronous handler hook for `HK.Gov.HKO.Weather.amqp.WeatherObservation`: A current environmental measurement from the
Hong Kong Observatory. It carries weather observations when the upstream feed reports a new or refreshed value.
...
async def hk_gov_hko_weather_amqp_weather_observation_event(record: ConsumerRecord, cloud_event: CloudEvent, data:
WeatherObservation) -> None:
...
hk_gov_hko_weather_dispatcher.hk_gov_hko_weather_amqp_weather_observation_async =
hk_gov_hko_weather_amqp_weather_observation_event
...
hk_gov_hko_weather_mqtt_dispatcher.hk_gov_hko_weather_amqp_weather_observation_async =
hk_gov_hko_weather_amqp_weather_observation_event
...
hk_gov_hko_weather_amqp_dispatcher.hk_gov_hko_weather_amqp_weather_observation_async =
hk_gov_hko_weather_amqp_weather_observation_event
...
##### `send_hk_gov_hko_weather_amqp_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_hk_gov_hko_weather_amqp_station(
...
Send a single `HK.Gov.HKO.Weather.amqp.Station` message. A reference record published by the Hong Kong Observatory. It
lets consumers label, group, and route the live measurement or forecast events.Args:
...
await producer.send_hk_gov_hko_weather_amqp_station(
...
Send multiple `HK.Gov.HKO.Weather.amqp.Station` messages in a batch.
...
await producer.send_hk_gov_hko_weather_amqp_station_batch(```
...
##### `send_hk_gov_hko_weather_amqp_weather_observation`Dispatchers have the following protected methods:



```python### Methods:

async def send_hk_gov_hko_weather_amqp_weather_observation(
...
Send a single `HK.Gov.HKO.Weather.amqp.WeatherObservation` message. A current environmental measurement from the Hong
Kong Observatory. It carries weather observations when the upstream feed reports a new or refreshed value.Args:
...
await producer.send_hk_gov_hko_weather_amqp_weather_observation(
...
Send multiple `HK.Gov.HKO.Weather.amqp.WeatherObservation` messages in a batch.
...
await producer.send_hk_gov_hko_weather_amqp_weather_observation_batch(```

...
Asynchronous handler hook for `HK.Gov.HKO.Weather.Station`:
...
Asynchronous handler hook for `HK.Gov.HKO.Weather.WeatherObservation`:
...
Send a single `HK.Gov.HKO.Weather.Station` message.Args:
...
Send a single `HK.Gov.HKO.Weather.WeatherObservation` message.Args:

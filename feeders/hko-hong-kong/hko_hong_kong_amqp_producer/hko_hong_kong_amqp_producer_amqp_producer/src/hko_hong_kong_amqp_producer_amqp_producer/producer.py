...
class HKGovHKOWeatherAmqpProducer:
    """
    Producer class to send messages in the `HK.Gov.HKO.Weather.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_station(self,
        ...
        amqp_msg.subject = "{place_id}".format(place_id=_place_id)

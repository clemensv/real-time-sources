...
class WeatherObservation:
    ...
    Attributes:
        ...
        rainfall_max (typing.Optional[float])
    ...
    place_name: str=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="place_name"))
    ...
    rainfall_max: typing.Optional[float]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="rainfall_max"))
    ...
    def create_instance(cls) -> 'WeatherObservation':
        ...
        """
        return cls(
            place_id='bvjzpuvxvwaczvstuske',
            place_name='ffytakgyoodvdjzfalvf',
            observation_time=datetime.datetime.now(datetime.timezone.utc),
            temperature=float(58.989780361179164),
            rainfall_max=float(61.366031553173904),
            humidity=int(10),
            uv_index=float(25.871014375467826),
            uv_description='zgrxklnzuqxcifeisprv',
            district='sdrhvvhpdnouqwfblvuz'
        )
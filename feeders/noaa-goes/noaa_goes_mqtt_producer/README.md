# Noaa_goes_mqtt_producer MQTT Client

This library provides MQTT producer and consumer functionality for the noaa_goes_mqtt_producer message definitions.

# Noaa_goes_mqtt_producer Event Dispatcher for Azure Event Hubs
...
```    - MicrosoftOpenDataUSNOAASWPCGOESMqttEventDispatcher
...
from noaa_goes_mqtt_producer_mqtt_client import *This module defines an event processing framework for Azure Event Hubs,
...
client = MicrosoftOpenDataUSNOAASWPCGOESMqttMqttClient(mqtt_client, content_mode='structured')

# Connect to broker

await client.connect("mqtt.example.com", 1883)### MicrosoftOpenDataUSNOAASWPCGOESMqttEventDispatcher



# Publish message`MicrosoftOpenDataUSNOAASWPCGOESMqttEventDispatcher` handles events for the
Microsoft.OpenData.US.NOAA.SWPC.GOES.mqtt message group.
...
from noaa_goes_mqtt_producer_mqtt_client import *create_processor(self, consumer_group_name: str,
...
client = MicrosoftOpenDataUSNOAASWPCGOESMqttMqttClient(mqtt_client, content_mode='structured')- `eventhub_name`: The
...
## BuildThe MicrosoftOpenDataUSNOAASWPCGOESMqttEventDispatcher defines the following event handler hooks.
...
```##### `microsoft_open_data_us_noaa_swpc_goes_xray_flux_mqtt_async`



## Test```python

microsoft_open_data_us_noaa_swpc_goes_xray_flux_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent,
GoesXrayFlux], Awaitable[None]]
...
- `data`: The event data of type `noaa_goes_mqtt_producer_data.GoesXrayFlux`.

Example:

```python
async def microsoft_open_data_us_noaa_swpc_goes_xray_flux_mqtt_event(partition_context: PartitionContext, event:
EventData, cloud_event: CloudEvent, data: GoesXrayFlux) -> None:
...
```##### `microsoft_open_data_us_noaa_swpc_goes_proton_flux_mqtt_async`



## Test```python

microsoft_open_data_us_noaa_swpc_goes_proton_flux_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent,
GoesProtonFlux], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `noaa_goes_mqtt_producer_data.GoesProtonFlux`.

Example:

```python
async def microsoft_open_data_us_noaa_swpc_goes_proton_flux_mqtt_event(partition_context: PartitionContext, event:
EventData, cloud_event: CloudEvent, data: GoesProtonFlux) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `microsoft_open_data_us_noaa_swpc_goes_electron_flux_mqtt_async`



## Test```python

microsoft_open_data_us_noaa_swpc_goes_electron_flux_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent,
GoesElectronFlux], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `noaa_goes_mqtt_producer_data.GoesElectronFlux`.

Example:

```python
async def microsoft_open_data_us_noaa_swpc_goes_electron_flux_mqtt_event(partition_context: PartitionContext, event:
EventData, cloud_event: CloudEvent, data: GoesElectronFlux) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `microsoft_open_data_us_noaa_swpc_goes_magnetometer_mqtt_async`



## Test```python

microsoft_open_data_us_noaa_swpc_goes_magnetometer_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent,
GoesMagnetometer], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `noaa_goes_mqtt_producer_data.GoesMagnetometer`.

Example:

```python
async def microsoft_open_data_us_noaa_swpc_goes_magnetometer_mqtt_event(partition_context: PartitionContext, event:
EventData, cloud_event: CloudEvent, data: GoesMagnetometer) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `microsoft_open_data_us_noaa_swpc_space_weather_alert_mqtt_async`



## Test```python

microsoft_open_data_us_noaa_swpc_space_weather_alert_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent,
SpaceWeatherAlert], Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `noaa_goes_mqtt_producer_data.SpaceWeatherAlert`.

Example:

```python
async def microsoft_open_data_us_noaa_swpc_space_weather_alert_mqtt_event(partition_context: PartitionContext, event:
EventData, cloud_event: CloudEvent, data: SpaceWeatherAlert) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```
...
```##### `microsoft_open_data_us_noaa_swpc_xray_flare_mqtt_async`



## Test```python

microsoft_open_data_us_noaa_swpc_xray_flare_mqtt_async:  Callable[[PartitionContext, EventData, CloudEvent, XrayFlare],
Awaitable[None]]
...
- `event`: The event data.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `noaa_goes_mqtt_producer_data.XrayFlare`.

Example:

```python
async def microsoft_open_data_us_noaa_swpc_xray_flare_mqtt_event(partition_context: PartitionContext, event: EventData,
cloud_event: CloudEvent, data: XrayFlare) -> None:
    # Process the event data
    await partition_context.update_checkpoint(event)
```

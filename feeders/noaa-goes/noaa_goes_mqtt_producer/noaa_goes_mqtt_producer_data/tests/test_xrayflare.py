...
class Test_XrayFlare(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = XrayFlare(
            time_tag='nfqrnwvzielmthubxztm',
            begin_time='uayplgxypgjfahgywnsu',
            begin_class='xxzoffsjsyfpthachhlb',
            max_time='nvgcnhtlyrwgmyymmuvt',
            max_class='oaeebxmktfhrcgnwrbit',
            max_xrlong=float(0.5729372395232968),
            max_ratio=float(88.2311010066366),
            max_ratio_time='geacsgctrmzhpgqcwvxo',
            current_int_xrlong=float(57.92969370833758),
            end_time='cnjviaxbiyaivrvtogcn',
            end_class='rorsrxslajcmlssjpbrn',
            satellite=int(42)
        )
        return instance
    ...
    def test_time_tag_property(self):
        ...
        """
        test_value = 'nfqrnwvzielmthubxztm'
    ...
    def test_begin_time_property(self):
        ...
        """
        test_value = 'uayplgxypgjfahgywnsu'
    ...
    def test_begin_class_property(self):
        ...
        """
        test_value = 'xxzoffsjsyfpthachhlb'
    ...
    def test_max_time_property(self):
        ...
        """
        test_value = 'nvgcnhtlyrwgmyymmuvt'
    ...
    def test_max_class_property(self):
        ...
        """
        test_value = 'oaeebxmktfhrcgnwrbit'
    ...
    def test_max_xrlong_property(self):
        ...
        """
        test_value = float(0.5729372395232968)
    ...
    def test_max_ratio_property(self):
        ...
        """
        test_value = float(88.2311010066366)
    ...
    def test_max_ratio_time_property(self):
        ...
        """
        test_value = 'geacsgctrmzhpgqcwvxo'
    ...
    def test_current_int_xrlong_property(self):
        ...
        """
        test_value = float(57.92969370833758)
    ...
    def test_end_time_property(self):
        ...
        """
        test_value = 'cnjviaxbiyaivrvtogcn'
    ...
    def test_end_class_property(self):
        ...
        """
        test_value = 'rorsrxslajcmlssjpbrn'

...
from noaa_goes_mqtt_producer_data.goesprotonflux import GoesProtonFlux
...
class Test_GoesProtonFlux(unittest.TestCase):
    ...
    def test_time_tag_property(self):
        ...
        """
        test_value = 'pyghrfsysazfdffwhima'
    ...
    def test_flux_property(self):
        ...
        Test flux property
        """
        test_value = float(17.023086611117154)
    ...
    def test_energy_property(self):
        ...
        """
        test_value = 'jrceuuneopxsahhqbaqx'

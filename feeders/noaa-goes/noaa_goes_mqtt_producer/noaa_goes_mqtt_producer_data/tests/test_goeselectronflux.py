...
from noaa_goes_mqtt_producer_data.goeselectronflux import GoesElectronFlux
...
class Test_GoesElectronFlux(unittest.TestCase):
    ...
    def test_time_tag_property(self):
        ...
        """
        test_value = 'vgkjhpokhxkklkoirkzc'
    ...
    def test_flux_property(self):
        ...
        Test flux property
        """
        test_value = float(20.012502186037317)
    ...
    def test_energy_property(self):
        ...
        """
        test_value = 'fpomqwdfsvkeualjfuhu'

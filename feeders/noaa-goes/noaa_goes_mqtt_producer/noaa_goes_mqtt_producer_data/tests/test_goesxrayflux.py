...
from noaa_goes_mqtt_producer_data.goesxrayflux import GoesXrayFlux
...
class Test_GoesXrayFlux(unittest.TestCase):
    ...
    def test_time_tag_property(self):
        ...
        """
        test_value = 'yvznnhnoukgmipwdmaqp'
    ...
    def test_flux_property(self):
        ...
        Test flux property
        """
        test_value = float(58.729013960102414)
    ...
    def test_energy_property(self):
        ...
        """
        test_value = 'dmjtffsxorhifujhczpw'

...
class Test_XrayFlare(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = XrayFlare(
            time_tag='gdpenxkbxaphnlxhovfz',
            begin_time='iirorhluvvzxbvughuvo',
            begin_class='xwtzursvohdhujwccwhx',
            max_time='phypcnecluvphdqvqdcw',
            max_class='vdcfybqyucyvdlnokhaw',
            max_xrlong=float(72.41363183679154),
            max_ratio=float(52.37055082682984),
            max_ratio_time='rifoafcgqcihtphvvcsa',
            current_int_xrlong=float(60.998519187484604),
            end_time='zjsdimyyclemcxgrnnbb',
            end_class='mrfwimtrryzmananwmrh',
            satellite=int(27)
        )
        return instance
    ...
    def test_time_tag_property(self):
        ...
        """
        test_value = 'gdpenxkbxaphnlxhovfz'
    ...
    def test_begin_time_property(self):
        ...
        """
        test_value = 'iirorhluvvzxbvughuvo'
    ...
    def test_begin_class_property(self):
        ...
        """
        test_value = 'xwtzursvohdhujwccwhx'
    ...
    def test_max_time_property(self):
        ...
        """
        test_value = 'phypcnecluvphdqvqdcw'
    ...
    def test_max_class_property(self):
        ...
        """
        test_value = 'vdcfybqyucyvdlnokhaw'
    ...
    def test_max_xrlong_property(self):
        ...
        """
        test_value = float(72.41363183679154)
    ...
    def test_max_ratio_property(self):
        ...
        """
        test_value = float(52.37055082682984)
    ...
    def test_max_ratio_time_property(self):
        ...
        """
        test_value = 'rifoafcgqcihtphvvcsa'
    ...
    def test_current_int_xrlong_property(self):
        ...
        """
        test_value = float(60.998519187484604)
    ...
    def test_end_time_property(self):
        ...
        """
        test_value = 'zjsdimyyclemcxgrnnbb'
    ...
    def test_end_class_property(self):
        ...
        """
        test_value = 'mrfwimtrryzmananwmrh'

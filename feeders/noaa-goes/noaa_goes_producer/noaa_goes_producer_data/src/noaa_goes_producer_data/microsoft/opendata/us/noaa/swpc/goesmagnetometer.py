...
class GoesMagnetometer:
    """
    One-minute GOES magnetometer field measurement at geostationary orbit in HEN coordinates.
    Attributes:
        time_tag (str): 
        satellite (int): 
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"GoesMagnetometer\", \"namespace\": \"Microsoft.OpenData.US.NOAA.SWPC\", \"doc\": \"One-minute GOES magnetometer field measurement at geostationary orbit in HEN coordinates.\", \"fields\": [{\"name\": \"time_tag\", \"type\": \"string\"}, {\"name\": \"satellite\", \"type\": \"int\"}, {\"name\": \"he\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"hp\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"hn\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"total\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"arcjet_flag\", \"type\": [\"null\", \"boolean\"], \"default\": null}]}"), avro.name.Names()
    )
    ...
    def __post_init__(self):
        ...
        self.he=float(self.he) if self.he else None
        self.hp=float(self.hp) if self.hp else None
        self.hn=float(self.hn) if self.hn else None
        self.total=float(self.total) if self.total else None
        self.arcjet_flag=bool(self.arcjet_flag) if self.arcjet_flag else None

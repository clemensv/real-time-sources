...
from noaa_goes_amqp_producer_data.planetarykindex import PlanetaryKIndex
...
class Test_PlanetaryKIndex(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = PlanetaryKIndex(
            observation_time='diydxljbgelripeqzaan',
            kp=float(42.65107986909848),
            a_running=float(58.02379150440628),
            station_count=int(0)
        )
        return instance
    ...
    def test_observation_time_property(self):
        ...
        """
        test_value = 'diydxljbgelripeqzaan'
    ...
    def test_kp_property(self):
        ...
        Test kp property
        """
        test_value = float(42.65107986909848)
    ...
    def test_a_running_property(self):
        ...
        """
        test_value = float(58.02379150440628)

...
from noaa_goes_amqp_producer_data.solarwindsummary import SolarWindSummary
...
class Test_SolarWindSummary(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = SolarWindSummary(
            observation_time='vfnoacayjsijjzqibzjl',
            wind_speed=float(98.74264219839831),
            bt=float(57.465486038538785),
            bz=float(3.9203072967419095)
        )
        return instance
    ...
    def test_observation_time_property(self):
        ...
        """
        test_value = 'vfnoacayjsijjzqibzjl'
    ...
    def test_wind_speed_property(self):
        ...
        """
        test_value = float(98.74264219839831)
    ...
    def test_bt_property(self):
        ...
        Test bt property
        """
        test_value = float(57.465486038538785)
    ...
    def test_bz_property(self):
        ...
        Test bz property
        """
        test_value = float(3.9203072967419095)

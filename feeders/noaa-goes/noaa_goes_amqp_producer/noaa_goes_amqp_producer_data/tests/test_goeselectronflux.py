...
from noaa_goes_amqp_producer_data.goeselectronflux import GoesElectronFlux
...
class Test_GoesElectronFlux(unittest.TestCase):
    ...
    def test_time_tag_property(self):
        ...
        """
        test_value = 'hyxzqyxcyzjppdlokoff'
    ...
    def test_flux_property(self):
        ...
        Test flux property
        """
        test_value = float(56.339902715910824)
    ...
    def test_energy_property(self):
        ...
        """
        test_value = 'ogrhfxvdtgaovasqjgcg'

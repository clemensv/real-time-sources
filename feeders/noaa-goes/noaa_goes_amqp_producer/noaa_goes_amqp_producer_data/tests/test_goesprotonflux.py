...
from noaa_goes_amqp_producer_data.goesprotonflux import GoesProtonFlux
...
class Test_GoesProtonFlux(unittest.TestCase):
    ...
    def test_time_tag_property(self):
        ...
        """
        test_value = 'kbwwjnywzfqagbqlqgyh'
    ...
    def test_flux_property(self):
        ...
        Test flux property
        """
        test_value = float(4.7662351226348765)
    ...
    def test_energy_property(self):
        ...
        """
        test_value = 'ujsxbrgpceofusevdxmy'

...
from noaa_goes_amqp_producer_data.spaceweatheralert import SpaceWeatherAlert
...
class Test_SpaceWeatherAlert(unittest.TestCase):
    ...
    def test_product_id_property(self):
        ...
        """
        test_value = 'xtbdvfyzflrqzhllwfoz'
    ...
    def test_issue_datetime_property(self):
        ...
        """
        test_value = 'jnwvoxlkjaqjycizgwyf'
    ...
    def test_message_property(self):
        ...
        """
        test_value = 'kziadwddlamdrpobflxz'
    ...
    def test_to_json(self):
        ...
        new_instance = SpaceWeatherAlert.from_json(json_data)

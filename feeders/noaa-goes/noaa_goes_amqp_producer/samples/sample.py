...
"""
Sample usage of noaa_goes_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # TODO: Create a GoesXrayFlux instance with actual data
        # data = GoesXrayFlux(...)
        # producer.send_amqp(
        #     data=data,
        ...
        # Send Amqp message
        print("Sending Amqp message...")
        # TODO: Create a GoesProtonFlux instance with actual data
        # data = GoesProtonFlux(...)
        # producer.send_amqp(
        #     data=data,
        #     content_type="application/json"
        ...
        # Send Amqp message
        print("Sending Amqp message...")
        # TODO: Create a GoesElectronFlux instance with actual data
        ...
        # Send Amqp message
        print("Sending Amqp message...")
        # TODO: Create a GoesMagnetometer instance with actual data
        ...
        # Send Amqp message
        print("Sending Amqp message...")
        # TODO: Create a SpaceWeatherAlert instance with actual data
        ...
        # Send Amqp message
        print("Sending Amqp message...")
        # TODO: Create a XrayFlare instance with actual data
        # data = XrayFlare(...)
        # producer.send_amqp(
        #     data=data,
        #     content_type="application/json"

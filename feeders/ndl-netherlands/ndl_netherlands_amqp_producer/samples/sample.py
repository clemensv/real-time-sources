...
"""
Sample usage of ndl_netherlands_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # TODO: Create a TrafficSpeed instance with actual data
        # data = TrafficSpeed(...)
        # producer.send_amqp(
        #     data=data,
        ...
        # Send Amqp message
        print("Sending Amqp message...")
        # TODO: Create a TravelTime instance with actual data
        # data = TravelTime(...)
        # producer.send_amqp(
        #     data=data,
        #     content_type="application/json"
    ...
    try:
        ...
        # Send Amqp message
        print("Sending Amqp message...")
        # TODO: Create a TrafficSituation instance with actual data

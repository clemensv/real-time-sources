...
from ndl_netherlands_mqtt_producer_data.nl.ndw.traffic.trafficspeed import TrafficSpeed
...
class Test_TrafficSpeed(unittest.TestCase):
    ...
    def test_site_id_property(self):
        ...
        """
        test_value = 'yisblzffibvrigksldgy'
    ...
    def test_measurement_time_property(self):
        ...
        """
        test_value = 'egeshsgabgtfxhepyoaq'
    ...
    def test_average_speed_property(self):
        ...
        """
        test_value = float(75.60799679585291)

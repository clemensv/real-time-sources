...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../laqn_london_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../laqn_london_amqp_producer_amqp_producer/src')))
...
class TestUkKclLaqnAmqpProducer:
    """Test cases for UkKclLaqnAmqpProducer"""
...
class TestUkKclLaqnSpeciesAmqpProducer:
    """Test cases for UkKclLaqnSpeciesAmqpProducer"""

...
import json
from laqn_london_amqp_producer_data.uk.kcl.laqn.indexsourceenum import IndexSourceenum
...
class DailyIndex:
    ...
    Attributes:
        ...
        air_quality_band (AirQualityBandenum)
        index_source (IndexSourceenum)
    """
    ...
    air_quality_band: AirQualityBandenum=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="air_quality_band"))
    index_source: IndexSourceenum=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="index_source"))
    ...
    @classmethod
    def create_instance(cls) -> 'DailyIndex':
        """
        ...
        """
        return cls(
            site_code='idqdfsktdpaxnbdzquyx',
            bulletin_date='ccgqngobdqamfwrthvwj',
            species_code='kirvpnfwqnvywgzqjjib',
            air_quality_index=int(65),

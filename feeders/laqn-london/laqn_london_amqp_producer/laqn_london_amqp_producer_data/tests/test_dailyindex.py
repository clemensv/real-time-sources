...
from laqn_london_amqp_producer_data.uk.kcl.laqn.dailyindex import DailyIndex
...
class Test_DailyIndex(unittest.TestCase):
    ...
    def test_site_code_property(self):
        ...
        """
        test_value = 'idqdfsktdpaxnbdzquyx'
    ...
    def test_bulletin_date_property(self):
        ...
        """
        test_value = 'ccgqngobdqamfwrthvwj'
    ...
    def test_species_code_property(self):
        ...
        """
        test_value = 'kirvpnfwqnvywgzqjjib'

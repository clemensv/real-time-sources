...
from laqn_london_amqp_producer_data.uk.kcl.laqn.measurement import Measurement
...
class Test_Measurement(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = Measurement(
            site_code='nabkqgxfysoddnrqnitd',
            species_code='grlzerotihjwsshzrxat',
            measurement_date_gmt='xdpqnasjiisgfefpbggh',
            value=float(37.92426829118997)
        )
        return instance
    ...
    def test_site_code_property(self):
        ...
        """
        test_value = 'nabkqgxfysoddnrqnitd'
    ...
    def test_species_code_property(self):
        ...
        """
        test_value = 'grlzerotihjwsshzrxat'
    ...
    def test_measurement_date_gmt_property(self):
        ...
        """
        test_value = 'xdpqnasjiisgfefpbggh'
    ...
    def test_value_property(self):
        ...
        Test value property
        """
        test_value = float(37.92426829118997)

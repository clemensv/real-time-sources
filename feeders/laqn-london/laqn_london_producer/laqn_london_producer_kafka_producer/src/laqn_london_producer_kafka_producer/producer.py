...
class UkKclLaqnEventProducer:
    ...
    def send_uk_kcl_laqn_site(self,_site_code : str, data: Site, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Site], str]=None) -> None:
        ...
        """
        kafka_key = "{site_code}".format(site_code=_site_code)
        attributes = {
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'UkKclLaqnEventProducer':
        """
...
class UkKclLaqnSpeciesEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    def send_uk_kcl_laqn_species(self,_species_code : str, data: Species, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Species], str]=None) -> None:
        ...
        """
        kafka_key = "{species_code}".format(species_code=_species_code)
        attributes = {
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'UkKclLaqnSpeciesEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.
...
class UkKclLaqnMqttEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'UkKclLaqnMqttEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.
...
class UkKclLaqnAmqpEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'UkKclLaqnAmqpEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.
...
class UkKclLaqnSpeciesMqttEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'UkKclLaqnSpeciesMqttEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.
...
class UkKclLaqnSpeciesAmqpEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'UkKclLaqnSpeciesAmqpEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.

...
class Test_EventAdmission(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = EventAdmission(
            event_id='ayaqjndhvdvqguwybgup',
            admission_id='vqeroepyonnknxejknod',
            admission_type='yfjquuhkfqruicryngce',
            name='slarzrvfiydispzzbmfr',
            is_sold_out=True,
            is_sales_closed=True,
            price=float(49.39226395116162),
            currency='eucntrypxfisjvmwpbph',
            remaining=int(0)
        )
        return instance
    ...
    def test_event_id_property(self):
        ...
        """
        test_value = 'ayaqjndhvdvqguwybgup'
    ...
    def test_admission_id_property(self):
        ...
        """
        test_value = 'vqeroepyonnknxejknod'
    ...
    def test_admission_type_property(self):
        ...
        """
        test_value = 'yfjquuhkfqruicryngce'
    ...
    def test_name_property(self):
        ...
        Test name property
        """
        test_value = 'slarzrvfiydispzzbmfr'
    ...
    def test_price_property(self):
        ...
        Test price property
        """
        test_value = float(49.39226395116162)
    ...
    def test_currency_property(self):
        ...
        """
        test_value = 'eucntrypxfisjvmwpbph'

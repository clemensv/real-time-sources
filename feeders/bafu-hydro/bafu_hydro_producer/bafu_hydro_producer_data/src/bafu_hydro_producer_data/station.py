...
class Station:
    ...
    Attributes:
        station_id (str)
        name (str)
        water_body_name (typing.Optional[str])
        water_body_type (typing.Optional[str])
        latitude (float)
        longitude (float)
    """
    
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.parse(
        "{\"type\": \"record\", \"name\": \"Station\", \"doc\": \"Station\", \"fields\": [{\"name\": \"station_id\", \"type\": \"string\"}, {\"name\": \"name\", \"type\": \"string\"}, {\"name\": \"water_body_name\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"water_body_type\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"latitude\", \"type\": \"double\"}, {\"name\": \"longitude\", \"type\": \"double\"}]}"
    )
    
    
    station_id: str=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="station_id"))
    name: str=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="name"))
    water_body_name: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="water_body_name"))
    water_body_type: typing.Optional[str]=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="water_body_type"))
    ...
    def from_avro_dict(cls, data: dict) -> 'Station':
        ...
        if 'water_body_type' in converted and converted['water_body_type'] is not None:
            value = converted['water_body_type']
    ...
    def create_instance(cls) -> 'Station':
        ...
        """
        return cls(
            station_id='dygwmmhglcwfwherqnxr',
            name='marfsoxmxxblagpgmemv',
            water_body_name='fywsrhmgybypuwdsvjjw',
            water_body_type='idsucuaqmnmzzhxvemsh',
            latitude=float(19.82042995553145),
            longitude=float(43.92200923720139)
        )
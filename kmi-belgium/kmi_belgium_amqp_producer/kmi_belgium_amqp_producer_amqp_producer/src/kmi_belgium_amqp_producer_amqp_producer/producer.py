...
class BEGovKMIWeatherAmqpProducer:
    """
    Producer class to send messages in the `BE.Gov.KMI.Weather.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_station(self,
        ...
        """
        Send the `BE.Gov.KMI.Weather.amqp.Station` message
    ...
    def send_station_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `BE.Gov.KMI.Weather.amqp.Station` messages
    ...
    def send_weather_observation(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `BE.Gov.KMI.Weather.amqp.WeatherObservation` message
    ...
    def send_weather_observation_batch(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send multiple `BE.Gov.KMI.Weather.amqp.WeatherObservation` messages

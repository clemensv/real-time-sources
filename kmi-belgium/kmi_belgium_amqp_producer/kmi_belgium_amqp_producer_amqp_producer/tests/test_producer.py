...
from test_kmi_belgium_amqp_producer_data_station import Test_Station
from kmi_belgium_amqp_producer_data import WeatherObservation
from test_kmi_belgium_amqp_producer_data_weatherobservation import Test_WeatherObservation

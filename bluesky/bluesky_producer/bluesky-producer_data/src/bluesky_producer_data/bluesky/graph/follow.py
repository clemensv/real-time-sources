...
class Follow:
    ...
    Attributes:
        uri (str): AT-URI of the follow record
        cid (str): Content Identifier of the follow
        did (str): DID of the follower
        handle (typing.Optional[str]): Handle of the follower
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['Follow']:
        """
        ...
        if base_content_type in ['avro/binary', 'application/vnd.apache.avro+avro', 'avro/json', 'application/vnd.apache.avro+json']:
            ...
            return Follow.from_serializer_dict(_record)
        if base_content_type == 'application/json':

...
# Bluesky-producer Event Dispatcher for Apache Kafka
...
2. [Generated Event Dispatchers](#generated-event-dispatchers)
    - BlueskyFirehoseEventDispatcher
...
##### `bluesky_feed_post_async`

```python
bluesky_feed_post_async:  Callable[[ConsumerRecord, CloudEvent, Post], Awaitable[None]]
```
...
- `data`: The event data of type `bluesky-producer_data.bluesky.feed.Post`.
...
##### `bluesky_feed_like_async`

```python
bluesky_feed_like_async:  Callable[[ConsumerRecord, CloudEvent, Like], Awaitable[None]]
```
...
- `record`: The Kafka record.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `bluesky-producer_data.bluesky.feed.Like`.
...
##### `bluesky_feed_repost_async`

```python
bluesky_feed_repost_async:  Callable[[ConsumerRecord, CloudEvent, Repost], Awaitable[None]]
```
...
- `record`: The Kafka record.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `bluesky-producer_data.bluesky.feed.Repost`.
...
##### `bluesky_graph_follow_async`

```python
bluesky_graph_follow_async:  Callable[[ConsumerRecord, CloudEvent, Follow], Awaitable[None]]
```
...
- `record`: The Kafka record.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `bluesky-producer_data.bluesky.graph.Follow`.
...
##### `bluesky_graph_block_async`

```python
bluesky_graph_block_async:  Callable[[ConsumerRecord, CloudEvent, Block], Awaitable[None]]
```
...
- `record`: The Kafka record.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `bluesky-producer_data.bluesky.graph.Block`.
...
##### `bluesky_actor_profile_async`

```python
bluesky_actor_profile_async:  Callable[[ConsumerRecord, CloudEvent, Profile], Awaitable[None]]
```
...
- `record`: The Kafka record.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `bluesky-producer_data.bluesky.actor.Profile`.

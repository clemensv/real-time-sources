...
def _build_data(point: TimeSeriesPoint):
    ...
    if dt == 'A65': return ActualTotalLoad(inDomain=point.in_domain, quantity=point.quantity or 0.0, resolution=point.resolution, outDomain=point.out_domain, documentType=dt)

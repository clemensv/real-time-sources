...
$templateParameters = @{
    ...
    "parameters" = @{
        ...
        "entsoeSecurityToken" = @{
            "type" = "securestring"
            "metadata" = @{
                "description" = "The ENTSO-E Transparency Platform API security token."
            }
        }
        "appName" = @{
            "type" = "string"
                    ...
                    "properties" = @{
                        ...
                        "environmentVariables" = @(
                            ...
                            @{
                                ...
                                "secureValue" = "[parameters('entsoeSecurityToken')]"
                            },
                            @{
                                "name" = "STATE_FILE"

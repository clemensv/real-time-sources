...
class Test_ActualGenerationPerType(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = ActualGenerationPerType(
            inDomain='nfhipyieqatdpbwhbash',
            psrType='fbvcqcwjzhnenqdayast',
            quantity=float(19.263163420274097),
            resolution='qezvaemutfneooatmize',
            businessType='mnfhyllhukynawfaoaaz',
            documentType='naerrldqhaxlrhafqyuy',
            unitName='orngksasrjgzavrzaigz'
        )
        return instance
    ...
    def test_inDomain_property(self):
        ...
        """
        test_value = 'nfhipyieqatdpbwhbash'
    ...
    def test_psrType_property(self):
        ...
        """
        test_value = 'fbvcqcwjzhnenqdayast'
    ...
    def test_quantity_property(self):
        ...
        """
        test_value = float(19.263163420274097)
    ...
    def test_resolution_property(self):
        ...
        """
        test_value = 'qezvaemutfneooatmize'
    ...
    def test_businessType_property(self):
        ...
        """
        test_value = 'mnfhyllhukynawfaoaaz'
    ...
    def test_documentType_property(self):
        ...
        """
        test_value = 'naerrldqhaxlrhafqyuy'
    ...
    def test_unitName_property(self):
        ...
        """
        test_value = 'orngksasrjgzavrzaigz'

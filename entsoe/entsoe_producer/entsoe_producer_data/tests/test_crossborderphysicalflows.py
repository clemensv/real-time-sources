...
class Test_CrossBorderPhysicalFlows(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = CrossBorderPhysicalFlows(
            inDomain='huftbaboinjuhwlflxrl',
            outDomain='tabghukkbdohtycfbedl',
            quantity=float(70.58258511975548),
            resolution='hjjwkfewwfuyspxjjrct',
            documentType='trovminyaflpjeykfwwe',
            unitName='tqpzuchjyigvwygkzfze'
        )
        return instance
    ...
    def test_inDomain_property(self):
        ...
        """
        test_value = 'huftbaboinjuhwlflxrl'
    ...
    def test_outDomain_property(self):
        ...
        """
        test_value = 'tabghukkbdohtycfbedl'
    ...
    def test_quantity_property(self):
        ...
        """
        test_value = float(70.58258511975548)
    ...
    def test_resolution_property(self):
        ...
        """
        test_value = 'hjjwkfewwfuyspxjjrct'
    ...
    def test_documentType_property(self):
        ...
        """
        test_value = 'trovminyaflpjeykfwwe'
    ...
    def test_unitName_property(self):
        ...
        """
        test_value = 'tqpzuchjyigvwygkzfze'

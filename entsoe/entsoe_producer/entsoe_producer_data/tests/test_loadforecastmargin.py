...
class Test_LoadForecastMargin(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = LoadForecastMargin(
            inDomain='qmdonvzdwgeizngrphif',
            quantity=float(88.69559632413826),
            resolution='hcikrwknzbqsngacrehn',
            documentType='kagtxdwpysncunlnvvwi',
            unitName='xujjhpdjvsgqhzqsqhpq'
        )
        return instance
    ...
    def test_inDomain_property(self):
        ...
        """
        test_value = 'qmdonvzdwgeizngrphif'
    ...
    def test_quantity_property(self):
        ...
        """
        test_value = float(88.69559632413826)
    ...
    def test_resolution_property(self):
        ...
        """
        test_value = 'hcikrwknzbqsngacrehn'
    ...
    def test_documentType_property(self):
        ...
        """
        test_value = 'kagtxdwpysncunlnvvwi'
    ...
    def test_unitName_property(self):
        ...
        """
        test_value = 'xujjhpdjvsgqhzqsqhpq'

...
class Test_ActualGeneration(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = ActualGeneration(
            inDomain='semaknmiptktuvzkcfgq',
            quantity=float(88.98294829076806),
            resolution='wwccxzqtrubwpsmwgllq',
            documentType='vawcxyqjnjcqovcaiybw',
            unitName='qxlmquvwmjkvnjzzmeou'
        )
        return instance
    ...
    def test_inDomain_property(self):
        ...
        """
        test_value = 'semaknmiptktuvzkcfgq'
    ...
    def test_quantity_property(self):
        ...
        """
        test_value = float(88.98294829076806)
    ...
    def test_resolution_property(self):
        ...
        """
        test_value = 'wwccxzqtrubwpsmwgllq'
    ...
    def test_documentType_property(self):
        ...
        """
        test_value = 'vawcxyqjnjcqovcaiybw'
    ...
    def test_unitName_property(self):
        ...
        """
        test_value = 'qxlmquvwmjkvnjzzmeou'

...
class Test_WaterLevelObservation(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = WaterLevelObservation(
            station_id='bhouvhubhnfeqqgucnty',
            water_level=float(58.462296702788805),
            water_level_unit='ckjbgciopcbmjdbxzemx',
            water_level_timestamp='mfhnxynyodazfijtxwoo',
            discharge=float(14.32293095227256),
            discharge_unit='eutueubbqkbxgtuwtlwk',
            discharge_timestamp='otmptapcluqgoqfhjodx'
        )
        return instance
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'bhouvhubhnfeqqgucnty'
    ...
    def test_water_level_property(self):
        ...
        """
        test_value = float(58.462296702788805)
    ...
    def test_water_level_unit_property(self):
        ...
        """
        test_value = 'ckjbgciopcbmjdbxzemx'
    ...
    def test_water_level_timestamp_property(self):
        ...
        """
        test_value = 'mfhnxynyodazfijtxwoo'
    ...
    def test_discharge_property(self):
        ...
        """
        test_value = float(14.32293095227256)
    ...
    def test_discharge_unit_property(self):
        ...
        """
        test_value = 'eutueubbqkbxgtuwtlwk'
    ...
    def test_discharge_timestamp_property(self):
        ...
        """
        test_value = 'otmptapcluqgoqfhjodx'

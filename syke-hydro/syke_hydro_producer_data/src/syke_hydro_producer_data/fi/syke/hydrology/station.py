...
class Station:
    ...
    water_area_name: str=dataclasses.field(kw_only=True, metadata=dataclasses_json.config(field_name="water_area_name"))
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"Station\", \"namespace\": \"FI.SYKE.Hydrology\", \"fields\": [{\"name\": \"station_id\", \"type\": \"string\"}, {\"name\": \"name\", \"type\": \"string\"}, {\"name\": \"river_name\", \"type\": \"string\"}, {\"name\": \"water_area_name\", \"type\": \"string\"}, {\"name\": \"municipality\", \"type\": \"string\"}, {\"name\": \"latitude\", \"type\": \"double\"}, {\"name\": \"longitude\", \"type\": \"double\"}]}"), avro.name.Names()
    )
    ...
    def __post_init__(self):
        ...
        self.water_area_name=str(self.water_area_name)

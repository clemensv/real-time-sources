...
Asynchronous handler hook for `FI.SYKE.Hydrology.Station`:
...
Asynchronous handler hook for `FI.SYKE.Hydrology.WaterLevelObservation`:
...
Send a single `FI.SYKE.Hydrology.Station` message.Args:
...
Send a single `FI.SYKE.Hydrology.WaterLevelObservation` message.Args:

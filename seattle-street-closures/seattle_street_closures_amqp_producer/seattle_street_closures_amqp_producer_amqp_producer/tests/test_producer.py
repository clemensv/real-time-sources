...
"""
Tests for seattle_street_closures_amqp_producer_amqp_producer
"""
import base64
import json
import os
...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../seattle_street_closures_amqp_producer_data/src')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../seattle_street_closures_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../seattle_street_closures_amqp_producer_amqp_producer/src')))

from seattle_street_closures_amqp_producer_amqp_producer import *
from seattle_street_closures_amqp_producer_data import StreetClosure
from test_seattle_street_closures_amqp_producer_data_streetclosure import Test_StreetClosure
...
class TestUSWASeattleStreetClosuresAmqpProducer:
    """Test cases for USWASeattleStreetClosuresAmqpProducer"""
    ...
    def test_send_amqp(self, artemis_container):
        ...
        payload = Test_StreetClosure.create_instance()

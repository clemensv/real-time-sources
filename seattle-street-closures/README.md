...
`tools/deploy-fabric/deploy-feeder-notebook.ps1 -Source seattle-street-closures -ResourceGroup <rg> -Location <azure-region> -Workspace <fabric-workspace>`
...
`tools/deploy-fabric/deploy-fabric-aci.ps1 -Source seattle-street-closures -ResourceGroup <rg> -Location <azure-region> -Workspace <fabric-workspace>`

...
```
hydro/no/nve/nve-hydro/{river_name}/{station_id}/info
hydro/no/nve/nve-hydro/{river_name}/{station_id}/water-level
```
...
state per station. The `{river_name}` segment is normalized to lowercase

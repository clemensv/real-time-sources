...
class Test_WaterLevelObservation(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = WaterLevelObservation(
            station_id='rahdztqbtseurwuphckz',
            water_level=float(7.235346780978425),
            water_level_unit='nvfegvrlsduybyxnevaz',
            water_level_timestamp='hzkqyaayjvircxkudgts',
            discharge=float(82.33221042049517),
            discharge_unit='ibtadlzmomcfiatptjvv',
            discharge_timestamp='krktwmlsyumafxhkndny'
        )
        return instance
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'rahdztqbtseurwuphckz'
    ...
    def test_water_level_property(self):
        ...
        """
        test_value = float(7.235346780978425)
    ...
    def test_water_level_unit_property(self):
        ...
        """
        test_value = 'nvfegvrlsduybyxnevaz'
    ...
    def test_water_level_timestamp_property(self):
        ...
        """
        test_value = 'hzkqyaayjvircxkudgts'
    ...
    def test_discharge_property(self):
        ...
        """
        test_value = float(82.33221042049517)
    ...
    def test_discharge_unit_property(self):
        ...
        """
        test_value = 'ibtadlzmomcfiatptjvv'
    ...
    def test_discharge_timestamp_property(self):
        ...
        """
        test_value = 'krktwmlsyumafxhkndny'

...
class Test_WaterLevelObservation(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = WaterLevelObservation(
            station_id='axhsznsxrizsfhlqwkuw',
            river_name='ftjhmlkouplhdvxszekw',
            water_level=float(71.57437231295744),
            water_level_unit='oousbplksxkdpufqkuwo',
            water_level_timestamp=datetime.datetime.now(datetime.timezone.utc),
            discharge=float(48.42282061532286),
            discharge_unit='oatuhvuajjfapesftfhb',
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'axhsznsxrizsfhlqwkuw'
    ...
    def test_river_name_property(self):
        ...
        """
        test_value = 'ftjhmlkouplhdvxszekw'
    ...
    def test_water_level_property(self):
        ...
        """
        test_value = float(71.57437231295744)
    ...
    def test_water_level_unit_property(self):
        ...
        """
        test_value = 'oousbplksxkdpufqkuwo'
    ...
    def test_discharge_property(self):
        ...
        """
        test_value = float(48.42282061532286)
    ...
    def test_discharge_unit_property(self):
        ...
        """
        test_value = 'oatuhvuajjfapesftfhb'

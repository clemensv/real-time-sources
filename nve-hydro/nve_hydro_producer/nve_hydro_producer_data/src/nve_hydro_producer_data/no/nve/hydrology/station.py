...
class Station:
    ...
    def __post_init__(self):
        ...
        self.masl=float(self.masl) if self.masl else None
        self.council_name=str(self.council_name) if self.council_name else None
        self.county_name=str(self.county_name) if self.county_name else None
        self.drainage_basin_area=float(self.drainage_basin_area) if self.drainage_basin_area else None

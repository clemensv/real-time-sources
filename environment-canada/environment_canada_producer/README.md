...
Asynchronous handler hook for `CA.Gov.ECCC.Weather.Station`:
...
Asynchronous handler hook for `CA.Gov.ECCC.Weather.WeatherObservation`:
...
Send a single `CA.Gov.ECCC.Weather.Station` message.Args:
...
Send a single `CA.Gov.ECCC.Weather.WeatherObservation` message.Args:

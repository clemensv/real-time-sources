# Copy generated producer files to the main noaa_ndbc package

$scriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$generatedProducerSrc = Join-Path $scriptDir "noaa_ndbc_producer\noaa-ndbc-producer_kafka_producer\src\noaa-ndbc-producer_kafka_producer"
$generatedDataSrc = Join-Path $scriptDir "noaa_ndbc_producer\noaa-ndbc-producer_data\src\noaa-ndbc-producer_data"
$targetProducerDir = Join-Path $scriptDir "noaa_ndbc\noaa_ndbc_producer"

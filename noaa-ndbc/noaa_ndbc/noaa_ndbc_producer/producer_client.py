...
class MicrosoftOpenDataUSNOAANDBCEventProducer:
    ...
    def send_microsoft_open_data_us_noaa_ndbc_buoy_observation(self,data: BuoyObservation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, BuoyObservation], str]=None) -> None:
        """
    ...
    def send_microsoft_open_data_us_noaa_ndbc_buoy_station(self,data: BuoyStation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, BuoyStation], str]=None) -> None:
        """

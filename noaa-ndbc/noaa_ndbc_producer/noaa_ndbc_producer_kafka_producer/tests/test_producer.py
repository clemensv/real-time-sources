...
def test_microsoft_opendata_us_noaa_ndbc_microsoftopendatausnoaandbcbuoysolarradiationobservation(kafka_emulator):
    """Test the MicrosoftOpenDataUSNOAANDBCBuoySolarRadiationObservation event from the Microsoft.OpenData.US.NOAA.NDBC message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_microsoft_opendata_us_noaa_ndbc_microsoftopendatausnoaandbcbuoysolarradiationobservation',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_microsoft_opendata_us_noaa_ndbc_microsoftopendatausnoaandbcbuoyoceanographicobservation(kafka_emulator):
    """Test the MicrosoftOpenDataUSNOAANDBCBuoyOceanographicObservation event from the Microsoft.OpenData.US.NOAA.NDBC message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_microsoft_opendata_us_noaa_ndbc_microsoftopendatausnoaandbcbuoyoceanographicobservation',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_microsoft_opendata_us_noaa_ndbc_microsoftopendatausnoaandbcbuoydartmeasurement(kafka_emulator):
    """Test the MicrosoftOpenDataUSNOAANDBCBuoyDartMeasurement event from the Microsoft.OpenData.US.NOAA.NDBC message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_microsoft_opendata_us_noaa_ndbc_microsoftopendatausnoaandbcbuoydartmeasurement',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_microsoft_opendata_us_noaa_ndbc_microsoftopendatausnoaandbcbuoycontinuouswindobservation(kafka_emulator):
    """Test the MicrosoftOpenDataUSNOAANDBCBuoyContinuousWindObservation event from the Microsoft.OpenData.US.NOAA.NDBC message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_microsoft_opendata_us_noaa_ndbc_microsoftopendatausnoaandbcbuoycontinuouswindobservation',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_microsoft_opendata_us_noaa_ndbc_microsoftopendatausnoaandbcbuoysupplementalmeasurement(kafka_emulator):
    """Test the MicrosoftOpenDataUSNOAANDBCBuoySupplementalMeasurement event from the Microsoft.OpenData.US.NOAA.NDBC message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_microsoft_opendata_us_noaa_ndbc_microsoftopendatausnoaandbcbuoysupplementalmeasurement',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_microsoft_opendata_us_noaa_ndbc_microsoftopendatausnoaandbcbuoydetailedwavesummary(kafka_emulator):
    """Test the MicrosoftOpenDataUSNOAANDBCBuoyDetailedWaveSummary event from the Microsoft.OpenData.US.NOAA.NDBC message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_microsoft_opendata_us_noaa_ndbc_microsoftopendatausnoaandbcbuoydetailedwavesummary',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_microsoft_opendata_us_noaa_ndbc_microsoftopendatausnoaandbcbuoyhourlyrainmeasurement(kafka_emulator):
    """Test the MicrosoftOpenDataUSNOAANDBCBuoyHourlyRainMeasurement event from the Microsoft.OpenData.US.NOAA.NDBC message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_microsoft_opendata_us_noaa_ndbc_microsoftopendatausnoaandbcbuoyhourlyrainmeasurement',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_microsoft_opendata_us_noaa_ndbc_cross_event_type_kafka_key(kafka_emulator):
    """Test that different event types in Microsoft.OpenData.US.NOAA.NDBC produce the same Kafka key for the same placeholder values"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_microsoft_opendata_us_noaa_ndbc_cross_key',
    ...
    data1 = Test_BuoyObservation.create_instance()
    data2 = Test_BuoyStation.create_instance()

    producer_instance.send_microsoft_open_data_us_noaa_ndbc_buoy_observation(_station_id = shared_key_value, data = data1)
    producer_instance.send_microsoft_open_data_us_noaa_ndbc_buoy_station(_station_id = shared_key_value, data = data2)
    kafka_producer.flush(timeout=5.0)
    ...
    while len(collected_keys) < 2 and time.time() < timeout:
        ...
        if msg is None or msg.error():
            continue
        cloudevent = parse_cloudevent(msg)
        if cloudevent['type'] in ["Microsoft.OpenData.US.NOAA.NDBC.BuoyObservation", "Microsoft.OpenData.US.NOAA.NDBC.BuoyStation"]:

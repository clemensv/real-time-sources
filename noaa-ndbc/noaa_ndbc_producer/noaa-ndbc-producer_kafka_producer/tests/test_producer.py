...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../noaa-ndbc-producer_data/src')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../noaa-ndbc-producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../noaa-ndbc-producer_kafka_producer/src')))
...
from noaa-ndbc-producer_data import BuoyObservation
from test_noaa-ndbc-producer_data_microsoft_opendata_us_noaa_ndbc_buoyobservation import Test_BuoyObservation

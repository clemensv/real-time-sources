...
class BuoyObservation:
    ...
    def __post_init__(self):
        ...
        self.wave_height=float(self.wave_height) if self.wave_height else None
        self.dominant_wave_period=float(self.dominant_wave_period) if self.dominant_wave_period else None

...
class BuoyDetailedWaveSummary:
    """
    Detailed wave-summary record from the NDBC .spec realtime2 product.
    Attributes:
        station_id (str): 
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"BuoyDetailedWaveSummary\", \"doc\": \"Detailed wave-summary record from the NDBC .spec realtime2 product.\", \"fields\": [{\"name\": \"station_id\", \"type\": \"string\"}, {\"name\": \"timestamp\", \"type\": {\"type\": \"string\", \"logicalType\": \"timestamp-millis\"}}, {\"name\": \"significant_wave_height\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"swell_height\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"swell_period\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"wind_wave_height\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"wind_wave_period\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"swell_direction\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"wind_wave_direction\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"steepness\", \"type\": [\"null\", \"string\"], \"default\": null}, {\"name\": \"average_wave_period\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"mean_wave_direction\", \"type\": [\"null\", \"double\"], \"default\": null}], \"namespace\": \"Microsoft.OpenData.US.NOAA.NDBC\"}"), avro.name.Names()
    )
    ...
    def __post_init__(self):
        ...
        self.significant_wave_height=float(self.significant_wave_height) if self.significant_wave_height else None
        self.swell_height=float(self.swell_height) if self.swell_height else None
        self.swell_period=float(self.swell_period) if self.swell_period else None
        self.wind_wave_height=float(self.wind_wave_height) if self.wind_wave_height else None
        self.wind_wave_period=float(self.wind_wave_period) if self.wind_wave_period else None
        self.swell_direction=str(self.swell_direction) if self.swell_direction else None
        self.wind_wave_direction=str(self.wind_wave_direction) if self.wind_wave_direction else None
        self.steepness=str(self.steepness) if self.steepness else None
        self.average_wave_period=float(self.average_wave_period) if self.average_wave_period else None
        self.mean_wave_direction=float(self.mean_wave_direction) if self.mean_wave_direction else None

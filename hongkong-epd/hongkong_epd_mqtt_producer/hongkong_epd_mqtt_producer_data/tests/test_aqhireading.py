...
from hongkong_epd_mqtt_producer_data.aqhireading import AQHIReading
import datetime
...
class Test_AQHIReading(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = AQHIReading(
            station_id='laptfdmcurjxmxobfeou',
            station_name='iypiryfjvryelupfkvni',
            station_type='pqsmcjckgouefujjnftn',
            district='qozboyngxdvnjejltemk',
            reading_time=datetime.datetime.now(datetime.timezone.utc),
            aqhi=int(29),
            health_risk_category='lnixaynanymfphroksbw'
        )
        return instance
    ...
    def test_station_id_property(self):
        ...
        """
        test_value = 'laptfdmcurjxmxobfeou'
    ...
    def test_station_name_property(self):
        ...
        """
        test_value = 'iypiryfjvryelupfkvni'
    ...
    def test_station_type_property(self):
        ...
        """
        test_value = 'pqsmcjckgouefujjnftn'
    ...
    def test_district_property(self):
        ...
        """
        test_value = 'qozboyngxdvnjejltemk'
    ...
    def test_health_risk_category_property(self):
        ...
        """
        test_value = 'lnixaynanymfphroksbw'

...
async def main(connection_string: Optional[str], producer_config: Optional[str], topic: Optional[str]):
    ...
    if connection_string:
        ...
        ninawarnings_event_producer = NINAWarningsEventProducer.from_connection_string(connection_string, topic, 'binary')
    else:
        # use a Kafka producer configuration provided as JSON text
        kafka_producer = KafkaProducer(json.loads(producer_config))
        ninawarnings_event_producer = NINAWarningsEventProducer(kafka_producer, topic, 'binary')

    # ---- NINA.CivilWarning ----
    # TODO: Supply event data for the NINA.CivilWarning event

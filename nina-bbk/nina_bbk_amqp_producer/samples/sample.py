...
"""
Sample usage of nina_bbk_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send CivilWarning message
        print("Sending CivilWarning message...")
        # TODO: Create a CivilWarning instance with actual data
        # data = CivilWarning(...)
        # producer.send_civil_warning(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("CivilWarning message sent successfully!")

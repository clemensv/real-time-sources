...
# Canada_aqhi_producer Kafka Producer# Canada_aqhi_producer Event Dispatcher for Apache Kafka
...
- **Scales horizontally** across multiple brokers and partitions### CaGcWeatherAqhiEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`CaGcWeatherAqhiEventDispatcher` handles events for the ca.gc.weather.aqhi message group.
...
The CaGcWeatherAqhiEventDispatcher defines the following event handler hooks.
...
producer = CaGcWeatherAqhiProducer(
    ...
    security_protocol='SASL_SSL',##### `ca_gc_weather_aqhi_community_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'ca_gc_weather_aqhi_community_async:  Callable[[ConsumerRecord, CloudEvent, Community],
Awaitable[None]]
...
Asynchronous handler hook for `ca.gc.weather.aqhi.Community`: Reference data for a Canadian Air Quality Health Index
reporting community, including its stable CGNDB identifier and current upstream feed URLs.
...
ca_gc_weather_aqhi_dispatcher.ca_gc_weather_aqhi_community_async = ca_gc_weather_aqhi_community_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `ca_gc_weather_aqhi_observation_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'ca_gc_weather_aqhi_observation_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `ca.gc.weather.aqhi.Observation`: Latest AQHI observation for a reporting community.
...
ca_gc_weather_aqhi_dispatcher.ca_gc_weather_aqhi_observation_async = ca_gc_weather_aqhi_observation_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `ca_gc_weather_aqhi_forecast_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'ca_gc_weather_aqhi_forecast_async:  Callable[[ConsumerRecord, CloudEvent, Forecast],
Awaitable[None]]
...
Asynchronous handler hook for `ca.gc.weather.aqhi.Forecast`: Public AQHI forecast for one of the four standard Canadian
forecast periods published for an AQHI community.
...
##### `send_ca_gc_weather_aqhi_community`Dispatchers have the following protected methods:



```python### Methods:

async def send_ca_gc_weather_aqhi_community(
...
Send a single `ca.gc.weather.aqhi.Community` message. Reference data for a Canadian Air Quality Health Index reporting
community, including its stable CGNDB identifier and current upstream feed URLs.Args:
...
await producer.send_ca_gc_weather_aqhi_community(
...
Send multiple `ca.gc.weather.aqhi.Community` messages in a batch.
...
await producer.send_ca_gc_weather_aqhi_community_batch(```
...
##### `send_ca_gc_weather_aqhi_observation`Dispatchers have the following protected methods:



```python### Methods:

async def send_ca_gc_weather_aqhi_observation(
...
Send a single `ca.gc.weather.aqhi.Observation` message. Latest AQHI observation for a reporting community. Observations
are published hourly and may include decimal AQHI values.Args:
...
await producer.send_ca_gc_weather_aqhi_observation(
...
Send multiple `ca.gc.weather.aqhi.Observation` messages in a batch.
...
await producer.send_ca_gc_weather_aqhi_observation_batch(```
...
##### `send_ca_gc_weather_aqhi_forecast`Dispatchers have the following protected methods:



```python### Methods:

async def send_ca_gc_weather_aqhi_forecast(
...
Send a single `ca.gc.weather.aqhi.Forecast` message. Public AQHI forecast for one of the four standard Canadian forecast
periods published for an AQHI community.Args:
...
await producer.send_ca_gc_weather_aqhi_forecast(
...
Send multiple `ca.gc.weather.aqhi.Forecast` messages in a batch.

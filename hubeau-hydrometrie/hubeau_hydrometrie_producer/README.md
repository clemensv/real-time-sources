...
# Hubeau-hydrometrie-producer Kafka Producer# Hubeau-hydrometrie-producer Event Dispatcher for Apache Kafka
...
from hubeau-hydrometrie-producer import FRGovEaufranceHubEauHydrometrieProducer```python
...
Asynchronous handler hook for `FR.Gov.Eaufrance.HubEau.Hydrometrie.Station`:
...
Asynchronous handler hook for `FR.Gov.Eaufrance.HubEau.Hydrometrie.Observation`:
...
Send a single `FR.Gov.Eaufrance.HubEau.Hydrometrie.Station` message.Args:
...
Send a single `FR.Gov.Eaufrance.HubEau.Hydrometrie.Observation` message.Args:

...
class FRGovEaufranceHubEauHydrometrieEventProducer:
    ...
    def send_fr_gov_eaufrance_hub_eau_hydrometrie_station(self,_code_station : str, data: Station, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
    ...
    def send_fr_gov_eaufrance_hub_eau_hydrometrie_observation(self,_code_station : str, data: Observation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Observation], str]=None) -> None:
        """
...
class FRGovEaufranceHubEauHydrometrieMqttEventProducer:
    ...
    def send_fr_gov_eaufrance_hub_eau_hydrometrie_mqtt_station(self,_code_station : str, data: Station, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
    ...
    def send_fr_gov_eaufrance_hub_eau_hydrometrie_mqtt_observation(self,_code_station : str, data: Observation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Observation], str]=None) -> None:
        """
...
class FRGovEaufranceHubEauHydrometrieAmqpEventProducer:
    ...
    def send_fr_gov_eaufrance_hub_eau_hydrometrie_amqp_station(self,_code_station : str, data: Station, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
    ...
    def send_fr_gov_eaufrance_hub_eau_hydrometrie_amqp_observation(self,_code_station : str, data: Observation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Observation], str]=None) -> None:
        """

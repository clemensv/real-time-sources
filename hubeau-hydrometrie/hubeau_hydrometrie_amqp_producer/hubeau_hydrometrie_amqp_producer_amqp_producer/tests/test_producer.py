...
from test_hubeau_hydrometrie_amqp_producer_data_station import Test_Station
from hubeau_hydrometrie_amqp_producer_data import Observation
from test_hubeau_hydrometrie_amqp_producer_data_observation import Test_Observation

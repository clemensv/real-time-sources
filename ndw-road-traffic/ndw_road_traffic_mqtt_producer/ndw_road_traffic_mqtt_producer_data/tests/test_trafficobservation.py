...
from ndw_road_traffic_mqtt_producer_data.trafficobservation import TrafficObservation
...
class Test_TrafficObservation(unittest.TestCase):
    ...
    def test_measurement_site_id_property(self):
        ...
        """
        test_value = 'shxfakahmibietekjjqw'
    ...
    def test_measurement_time_property(self):
        ...
        """
        test_value = 'zresgzfgdipmiwrbfcxw'
    ...
    def test_average_speed_property(self):
        ...
        """
        test_value = float(24.960993758125717)

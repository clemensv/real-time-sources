...
`tools/deploy-fabric/deploy-feeder-notebook.ps1 -Source paris-bicycle-counters -Workspace <id> -ResourceGroup <azure-rg> -Location <azure-region>`
...
`tools/deploy-fabric/deploy-fabric-aci.ps1 -Source paris-bicycle-counters -Workspace <id> -ResourceGroup <azure-rg> -Location <azure-region>`

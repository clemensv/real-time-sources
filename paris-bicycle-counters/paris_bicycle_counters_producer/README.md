...
Asynchronous handler hook for `FR.Paris.OpenData.Velo.Counter`:
...
Asynchronous handler hook for `FR.Paris.OpenData.Velo.BicycleCount`:
...
Send a single `FR.Paris.OpenData.Velo.Counter` message.Args:
...
Send a single `FR.Paris.OpenData.Velo.BicycleCount` message.Args:

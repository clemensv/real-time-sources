...
async def main(connection_string: Optional[str], producer_config: Optional[str], topic: Optional[str]):
    ...
    if connection_string:
        ...
        be_irail_event_producer = BeIrailEventProducer.from_connection_string(connection_string, topic, 'binary')
    else:
        # use a Kafka producer configuration provided as JSON text
        kafka_producer = KafkaProducer(json.loads(producer_config))
        be_irail_event_producer = BeIrailEventProducer(kafka_producer, topic, 'binary')

    # ---- be.irail.Station ----
    # TODO: Supply event data for the be.irail.Station event
    _station = Station()
    ...
    # TODO: Supply event data for the be.irail.StationBoard event

...
from irail_mqtt_producer_data.be.irail.arrival import Arrival
...
class Test_Arrival(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Arrival(
            origin_station_id='fzmamrgpkehqsohpzqkz',
            origin_name='ldlukegyycwxjqvvbdvz',
            scheduled_time='ngrimaosupwopqbjszho',
            delay_seconds=int(82),
            is_canceled=False,
            has_arrived=False,
            is_extra_stop=True,
            vehicle_id='zlrxwpalaufckyotepfn',
            vehicle_short_name='cxgsarlzcabajpwockyi',
            vehicle_type='bwnzpcgyahooqcwvwlzu',
            vehicle_number='vmhcdildhceigeuufblu',
            platform='zuzatmikzpsjdyfzrsck',
            is_normal_platform=True,
            occupancy=OccupancyEnum.low,
            connection_uri='wxgsbtmqktmdxkjxztuo'
        )
        return instance
    ...
    def test_origin_station_id_property(self):
        ...
        """
        test_value = 'fzmamrgpkehqsohpzqkz'
    ...
    def test_origin_name_property(self):
        ...
        """
        test_value = 'ldlukegyycwxjqvvbdvz'
    ...
    def test_scheduled_time_property(self):
        ...
        """
        test_value = 'ngrimaosupwopqbjszho'
    ...
    def test_vehicle_id_property(self):
        ...
        """
        test_value = 'zlrxwpalaufckyotepfn'
    ...
    def test_vehicle_short_name_property(self):
        ...
        """
        test_value = 'cxgsarlzcabajpwockyi'
    ...
    def test_vehicle_type_property(self):
        ...
        """
        test_value = 'bwnzpcgyahooqcwvwlzu'
    ...
    def test_vehicle_number_property(self):
        ...
        """
        test_value = 'vmhcdildhceigeuufblu'
    ...
    def test_platform_property(self):
        ...
        """
        test_value = 'zuzatmikzpsjdyfzrsck'
    ...
    def test_connection_uri_property(self):
        ...
        """
        test_value = 'wxgsbtmqktmdxkjxztuo'

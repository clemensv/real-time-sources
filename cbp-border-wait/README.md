...
`tools/deploy-fabric/deploy-feeder-notebook.ps1 -Source cbp-border-wait -Workspace <id> -ResourceGroup <azure-rg> -Location <azure-region>`
...
`tools/deploy-fabric/deploy-fabric-aci.ps1 -Source cbp-border-wait -Workspace <id> -ResourceGroup <azure-rg> -Location <azure-region>`

...
`tools/deploy-fabric/deploy-feeder-notebook.ps1 -Source cbp-border-wait -Workspace <fabric-workspace>`
...
`tools/deploy-fabric/deploy-fabric-aci.ps1 -Source cbp-border-wait -Workspace <fabric-workspace>`

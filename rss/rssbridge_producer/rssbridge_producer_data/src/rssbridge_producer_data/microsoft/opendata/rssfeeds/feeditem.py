...
class FeedItem:
    ...
    Attributes:
        feed_slug (str): Topic-safe stable slug derived from the configured feed URL.
        item (str): Topic-safe stable item token derived from the feed entry id/link/title.
    ...
    feed_slug: str=dataclasses.field(default="", kw_only=True, metadata=dataclasses_json.config(field_name="feed_slug"))
    item: str=dataclasses.field(default="", kw_only=True, metadata=dataclasses_json.config(field_name="item"))

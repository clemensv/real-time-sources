...
class FeedItemPublisher:
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"FeedItemPublisher\", \"namespace\": \"Microsoft.OpenData.RssFeeds\", \"doc\": \"Contains information about the publisher of the feed item.\", \"fields\": [{\"name\": \"name\", \"type\": [\"null\", \"string\"], \"default\": null, \"doc\": \"The name of the publisher.\"}, {\"name\": \"href\", \"type\": [\"null\", \"string\"], \"default\": null, \"doc\": \"A URL associated with the publisher.\"}, {\"name\": \"email\", \"type\": [\"null\", \"string\"], \"default\": null, \"doc\": \"The publisher's email address.\"}]}"), avro.name.Names()
    )
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'FeedItemPublisher':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['FeedItemPublisher']:
        """
        ...
        if base_content_type in ['avro/binary', 'application/vnd.apache.avro+avro', 'avro/json', 'application/vnd.apache.avro+json']:
            ...
            return FeedItemPublisher.from_serializer_dict(_record)
        if base_content_type == 'application/json':

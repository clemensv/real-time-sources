...
class OceanObservation:
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'OceanObservation':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['OceanObservation']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return OceanObservation.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'OceanObservation':
        """
        ...
        """
        return cls(
            observation_id='ckpbrmdmltprljgffqkn',
            station_id='hatsftxjergbzxzqjfjw',
            parameter_id='cneanludxglsjjgwecls',
            observed='hjdpcchnzmfuwbjdtobf',
            value=float(91.24486617818125),
            latitude=float(53.166072480489255),
            longitude=float(73.93145805719857)
        )
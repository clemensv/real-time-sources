...
class TidewaterPrediction:
    ...
    @classmethod
    def from_serializer_dict(cls, data: dict) -> 'TidewaterPrediction':
        """
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['TidewaterPrediction']:
        """
        ...
        if base_content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return TidewaterPrediction.from_serializer_dict(_record)
            else:
                raise NotImplementedError('Data is not of a supported type for JSON deserialization')
        raise NotImplementedError(f'Unsupported media type {content_type}')

    @classmethod
    def create_instance(cls) -> 'TidewaterPrediction':
        """
        ...
        """
        return cls(
            prediction_id='gsobewmckmalrdimppip',
            station_id='tcibcrizocdbtyumsdxl',
            prediction_type='rcoohnoglxafbvqyeuhj',
            prediction_time='mgrxfgsffnargowbpkqw',
            value=float(22.159669329717204),
            latitude=float(75.3255480572944),
            longitude=float(23.426082200380762)
        )
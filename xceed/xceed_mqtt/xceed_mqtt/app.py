"""MQTT companion feeder for xceed. Publishes mock/sample CloudEvents for Docker E2E and auth-blocked upstreams."""
...
from xceed_mqtt_producer_mqtt_client import client as client_mod
import xceed_mqtt_producer_data as data_mod
...
def _val(name, typ):
    ...
    if 'country' in n: return 'gb' if 'xceed'=='elexon-bmrs' else ('jp' if 'xceed'=='tepco-denkiyoho' else 'dk' if 'xceed'=='energidataservice-dk' else 'de' if 'xceed'=='energy-charts' else 'nl')

...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../xceed_producer_data/src')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../xceed_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../xceed_producer_kafka_producer/src')))
...
def test_xceed_xceedevent(kafka_emulator):
    """Test the XceedEvent event from the Xceed message group"""
    ...
    consumer = Consumer({
        ...
        'group.id': 'test_xceed_xceedevent',  # Unique group per test
...
def test_xceed_admissions_xceedeventadmission(kafka_emulator):
    """Test the XceedEventAdmission event from the Xceed.Admissions message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_xceed_admissions_xceedeventadmission',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
    ...
    for i in range(5):
        received_key = on_event()
        assert received_key is not None, f"Failed to receive message {i+1} of 5"
        expected_key = "{event_id}/{admission_id}".format(event_id=f'test_{i}', admission_id=f'test_{i}')
        assert received_key == expected_key, f"Expected Kafka key '{expected_key}' but got '{received_key}'"
    consumer.close()


def test_xceed_mqtt_xceedmqttevent(kafka_emulator):
    """Test the XceedMqttEvent event from the Xceed.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_xceed_mqtt_xceedmqttevent',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_xceed_amqp_xceedamqpevent(kafka_emulator):
    """Test the XceedAmqpEvent event from the Xceed.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_xceed_amqp_xceedamqpevent',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_xceed_admissions_mqtt_xceedadmissionsmqtteventadmission(kafka_emulator):
    """Test the XceedAdmissionsMqttEventAdmission event from the Xceed.Admissions.Mqtt message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_xceed_admissions_mqtt_xceedadmissionsmqtteventadmission',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])
...
def test_xceed_admissions_amqp_xceedadmissionsamqpeventadmission(kafka_emulator):
    """Test the XceedAdmissionsAmqpEventAdmission event from the Xceed.Admissions.Amqp message group"""
    ...
    consumer = Consumer({
        'bootstrap.servers': bootstrap_servers,
        'group.id': 'test_xceed_admissions_amqp_xceedadmissionsamqpeventadmission',  # Unique group per test
        'auto.offset.reset': 'earliest'
    })
    consumer.subscribe([topic])

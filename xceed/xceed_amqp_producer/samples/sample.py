...
"""
Sample usage of xceed_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send EventAdmission message
        print("Sending EventAdmission message...")
        # TODO: Create a EventAdmission instance with actual data
        # data = EventAdmission(...)
        # producer.send_event_admission(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("EventAdmission message sent successfully!")

...
"""
Sample usage of smhi_hydro_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send DischargeObservation message
        print("Sending DischargeObservation message...")
        # TODO: Create a DischargeObservation instance with actual data
        # data = DischargeObservation(...)
        # producer.send_discharge_observation(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("DischargeObservation message sent successfully!")

...
class SEGovSMHIHydroEventProducer:
    ...
    def send_se_gov_smhi_hydro_station(self,_station_id : str, data: Station, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
    ...
    def send_se_gov_smhi_hydro_discharge_observation(self,_station_id : str, data: DischargeObservation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, DischargeObservation], str]=None) -> None:
        """
...
class SEGovSMHIHydroMqttEventProducer:
    ...
    def send_se_gov_smhi_hydro_mqtt_station(self,_station_id : str, data: Station, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
    ...
    def send_se_gov_smhi_hydro_mqtt_discharge_observation(self,_station_id : str, data: DischargeObservation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, DischargeObservation], str]=None) -> None:
        """

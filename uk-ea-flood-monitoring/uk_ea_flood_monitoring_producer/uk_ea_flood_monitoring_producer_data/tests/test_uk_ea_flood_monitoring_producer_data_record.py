...
from uk_ea_flood_monitoring_producer_data.record import Record
...
class Test_Record(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = Record(
            station_reference='ugqocpoiprnkvxpqwizq',
            date_time='yucmbbfofwrwedbhbcsl',
            measure='ibtldkduzqghqkkiylsc',
            value=float(13.171819691639197)
        )
        return instance
    ...
    def test_station_reference_property(self):
        ...
        """
        test_value = 'ugqocpoiprnkvxpqwizq'
    ...
    def test_date_time_property(self):
        ...
        """
        test_value = 'yucmbbfofwrwedbhbcsl'
    ...
    def test_measure_property(self):
        ...
        """
        test_value = 'ibtldkduzqghqkkiylsc'
    ...
    def test_value_property(self):
        ...
        Test value property
        """
        test_value = float(13.171819691639197)

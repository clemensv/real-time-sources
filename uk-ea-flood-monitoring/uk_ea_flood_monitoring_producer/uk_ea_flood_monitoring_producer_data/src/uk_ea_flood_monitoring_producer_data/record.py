...
class Record:
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"Record\", \"namespace\": \"\", \"fields\": [{\"name\": \"station_reference\", \"type\": \"string\"}, {\"name\": \"date_time\", \"type\": \"string\"}, {\"name\": \"measure\", \"type\": \"string\"}, {\"name\": \"value\", \"type\": \"double\"}]}"), avro.name.Names()
    )

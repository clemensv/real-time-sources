...
- **Scales horizontally** across multiple brokers and partitions### UKGovEnvironmentEAFloodMonitoringEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`UKGovEnvironmentEAFloodMonitoringEventDispatcher` handles events for the UK.Gov.Environment.EA.FloodMonitoring message
group.
...
The UKGovEnvironmentEAFloodMonitoringEventDispatcher defines the following event handler hooks.
...
producer = UKGovEnvironmentEAFloodMonitoringProducer(
    ...
    security_protocol='SASL_SSL',##### `uk_gov_environment_ea_flood_monitoring_station_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'uk_gov_environment_ea_flood_monitoring_station_async:  Callable[[ConsumerRecord,
...
uk_gov_environment_ea_flood_monitoring_dispatcher.uk_gov_environment_ea_flood_monitoring_station_async =
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `uk_gov_environment_ea_flood_monitoring_reading_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'uk_gov_environment_ea_flood_monitoring_reading_async:  Callable[[ConsumerRecord,
...
uk_gov_environment_ea_flood_monitoring_dispatcher.uk_gov_environment_ea_flood_monitoring_reading_async =
...
##### `send_uk_gov_environment_ea_flood_monitoring_station`Dispatchers have the following protected methods:



```python### Methods:

async def send_uk_gov_environment_ea_flood_monitoring_station(
...
await producer.send_uk_gov_environment_ea_flood_monitoring_station(
...
Send multiple `UK.Gov.Environment.EA.FloodMonitoring.Station` messages in a batch.
...
await producer.send_uk_gov_environment_ea_flood_monitoring_station_batch(```
...
##### `send_uk_gov_environment_ea_flood_monitoring_reading`Dispatchers have the following protected methods:



```python### Methods:

async def send_uk_gov_environment_ea_flood_monitoring_reading(
...
await producer.send_uk_gov_environment_ea_flood_monitoring_reading(
...
Send multiple `UK.Gov.Environment.EA.FloodMonitoring.Reading` messages in a batch.

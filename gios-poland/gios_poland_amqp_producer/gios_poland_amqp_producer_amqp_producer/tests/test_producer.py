...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../gios_poland_amqp_producer_data/tests')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../gios_poland_amqp_producer_amqp_producer/src')))
...
class TestPlGovGiosAirqualityAmqpProducer:
    """Test cases for PlGovGiosAirqualityAmqpProducer"""

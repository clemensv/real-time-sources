...
class PlGovGiosAirqualityMqttEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    def send_pl_gov_gios_airquality_mqtt_station(self,_station_id : str, data: Station, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
        Sends the 'pl.gov.gios.airquality.mqtt.Station' event to the Kafka topic
    ...
    def send_pl_gov_gios_airquality_mqtt_sensor(self,_station_id : str, _sensor_id : str, data: Sensor, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Sensor], str]=None) -> None:
        """
        Sends the 'pl.gov.gios.airquality.mqtt.Sensor' event to the Kafka topic
    ...
    def send_pl_gov_gios_airquality_mqtt_measurement(self,_station_id : str, _sensor_id : str, data: Measurement, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Measurement], str]=None) -> None:
        """
        Sends the 'pl.gov.gios.airquality.mqtt.Measurement' event to the Kafka topic
    ...
    def send_pl_gov_gios_airquality_mqtt_air_quality_index(self,_station_id : str, data: AirQualityIndex, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, AirQualityIndex], str]=None) -> None:
        """
        Sends the 'pl.gov.gios.airquality.mqtt.AirQualityIndex' event to the Kafka topic
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'PlGovGiosAirqualityMqttEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.
...
class PlGovGiosAirqualityAmqpEventProducer:
    def __init__(self, producer: Producer, topic: str, content_mode:typing.Literal['structured','binary']='structured'):
        """
        Initializes the Kafka producer
    ...
    def send_pl_gov_gios_airquality_amqp_station(self,_station_id : str, data: Station, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Station], str]=None) -> None:
        """
        Sends the 'pl.gov.gios.airquality.amqp.Station' event to the Kafka topic
    ...
    def send_pl_gov_gios_airquality_amqp_sensor(self,_station_id : str, _sensor_id : str, data: Sensor, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Sensor], str]=None) -> None:
        """
        Sends the 'pl.gov.gios.airquality.amqp.Sensor' event to the Kafka topic
    ...
    def send_pl_gov_gios_airquality_amqp_measurement(self,_station_id : str, _sensor_id : str, data: Measurement, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Measurement], str]=None) -> None:
        """
        Sends the 'pl.gov.gios.airquality.amqp.Measurement' event to the Kafka topic
    ...
    def send_pl_gov_gios_airquality_amqp_air_quality_index(self,_station_id : str, data: AirQualityIndex, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, AirQualityIndex], str]=None) -> None:
        """
        Sends the 'pl.gov.gios.airquality.amqp.AirQualityIndex' event to the Kafka topic
    ...
    @classmethod
    def from_connection_string(cls, connection_string: str, topic: typing.Optional[str]=None, content_mode: typing.Literal['structured','binary']='structured') -> 'PlGovGiosAirqualityAmqpEventProducer':
        """
        Create a Kafka producer from a connection string and a topic name.

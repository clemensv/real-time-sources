...
async def main(connection_string: Optional[str], producer_config: Optional[str], topic: Optional[str]):
    ...
    if connection_string:
        ...
        jp_go_jma_weather_bulletins_event_producer = JpGoJmaWeatherBulletinsEventProducer.from_connection_string(connection_string, topic, 'binary')
    else:
        # use a Kafka producer configuration provided as JSON text
        kafka_producer = KafkaProducer(json.loads(producer_config))
        jp_go_jma_weather_bulletins_event_producer = JpGoJmaWeatherBulletinsEventProducer(kafka_producer, topic, 'binary')

    # ---- jp.go.jma.WeatherBulletin ----
    # TODO: Supply event data for the jp.go.jma.WeatherBulletin event

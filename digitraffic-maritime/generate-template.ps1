...
$templateParameters = @{
    ...
    "parameters" = @{
        ...
        "imageName" = @{
            "type" = "string"
            "defaultValue" = "ghcr.io/clemensv/real-time-sources-digitraffic-maritime:latest"
            "metadata" = @{
...
# Define resources in the ARM template (no storage needed for streaming bridge)
$templateResources = @(
    @{

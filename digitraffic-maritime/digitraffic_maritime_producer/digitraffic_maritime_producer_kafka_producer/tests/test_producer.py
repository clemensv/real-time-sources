...
from test_digitraffic_maritime_producer_data_fi_digitraffic_marine_ais_vessellocation import Test_VesselLocation
from digitraffic_maritime_producer_data import VesselMetadata
from test_digitraffic_maritime_producer_data_fi_digitraffic_marine_ais_vesselmetadata import Test_VesselMetadata
...
def test_fi_digitraffic_marine_ais_fidigitrafficmarineaisvessellocation(kafka_emulator):
    ...
    for i in range(5):
        producer_instance.send_fi_digitraffic_marine_ais_vessel_location(data = event_data)
...
def test_fi_digitraffic_marine_ais_fidigitrafficmarineaisvesselmetadata(kafka_emulator):
    ...
    # Send 5 messages to test message settlement and ordering
    for i in range(5):
        producer_instance.send_fi_digitraffic_marine_ais_vessel_metadata(data = event_data)

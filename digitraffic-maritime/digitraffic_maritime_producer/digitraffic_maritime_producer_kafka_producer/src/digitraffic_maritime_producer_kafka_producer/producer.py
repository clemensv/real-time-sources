...
class FiDigitrafficMarineAisEventProducer:
    ...
    def send_fi_digitraffic_marine_ais_vessel_location(self,data: VesselLocation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, VesselLocation], str]=None) -> None:
        """
    ...
    def send_fi_digitraffic_marine_ais_vessel_metadata(self,data: VesselMetadata, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, VesselMetadata], str]=None) -> None:
        """

...
Asynchronous handler hook for `US.EPA.UVIndex.HourlyForecast`:
...
Asynchronous handler hook for `US.EPA.UVIndex.DailyForecast`:
...
Send a single `US.EPA.UVIndex.HourlyForecast` message.Args:
...
Send a single `US.EPA.UVIndex.DailyForecast` message.Args:

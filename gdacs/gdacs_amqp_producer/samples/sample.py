...
"""
Sample usage of gdacs_amqp_producer_amqp_producer
...
def main():
    ...
    try:
        ...
        # Send DisasterAlert message
        print("Sending DisasterAlert message...")
        # TODO: Create a DisasterAlert instance with actual data
        # data = DisasterAlert(...)
        # producer.send_disaster_alert(
        #     data=data,
        #     content_type="application/json"
        # )
        # print("DisasterAlert message sent successfully!")

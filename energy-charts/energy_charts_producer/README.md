...
- **Scales horizontally** across multiple brokers and partitions### InfoEnergyChartsEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`InfoEnergyChartsEventDispatcher` handles events for the info.energy_charts message group.
...
The InfoEnergyChartsEventDispatcher defines the following event handler hooks.
...
producer = InfoEnergyChartsProducer(
    ...
    security_protocol='SASL_SSL',##### `info_energy_charts_public_power_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'info_energy_charts_public_power_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `info.energy_charts.PublicPower`:
...
info_energy_charts_dispatcher.info_energy_charts_public_power_async = info_energy_charts_public_power_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `info_energy_charts_spot_price_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'info_energy_charts_spot_price_async:  Callable[[ConsumerRecord, CloudEvent, SpotPrice],
Awaitable[None]]
...
Asynchronous handler hook for `info.energy_charts.SpotPrice`:
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `info_energy_charts_grid_signal_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'info_energy_charts_grid_signal_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `info.energy_charts.GridSignal`:
...
##### `send_info_energy_charts_public_power`Dispatchers have the following protected methods:



```python### Methods:

async def send_info_energy_charts_public_power(
...
Send a single `info.energy_charts.PublicPower` message.Args:
...
await producer.send_info_energy_charts_public_power(
...
Send multiple `info.energy_charts.PublicPower` messages in a batch.
...
await producer.send_info_energy_charts_public_power_batch(```
...
##### `send_info_energy_charts_spot_price`Dispatchers have the following protected methods:



```python### Methods:

async def send_info_energy_charts_spot_price(
...
Send a single `info.energy_charts.SpotPrice` message.Args:
...
await producer.send_info_energy_charts_spot_price(
...
Send multiple `info.energy_charts.SpotPrice` messages in a batch.
...
await producer.send_info_energy_charts_spot_price_batch(```
...
##### `send_info_energy_charts_grid_signal`Dispatchers have the following protected methods:



```python### Methods:

async def send_info_energy_charts_grid_signal(
...
Send a single `info.energy_charts.GridSignal` message.Args:
...
await producer.send_info_energy_charts_grid_signal(
...
Send multiple `info.energy_charts.GridSignal` messages in a batch.
...
await producer.send_info_energy_charts_grid_signal_batch(```

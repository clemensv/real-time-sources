...
from energy_charts_producer_data.info.energy_charts.gridsignal import GridSignal
import datetime
...
class Test_GridSignal(unittest.TestCase):
    ...
    def create_instance():
        ...
        """
        instance = GridSignal(
            country='msxbnbcoquclaobnotmq',
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            unix_seconds=int(78),
            signal=int(29),
            renewable_share_pct=float(64.93951721693163),
            substitute=True
        )
        return instance
    ...
    def test_country_property(self):
        ...
        """
        test_value = 'msxbnbcoquclaobnotmq'
    ...
    def test_renewable_share_pct_property(self):
        ...
        """
        test_value = float(64.93951721693163)

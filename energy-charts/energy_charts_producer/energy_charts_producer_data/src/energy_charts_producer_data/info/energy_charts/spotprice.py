...
class SpotPrice:
    ...
    AvroType: typing.ClassVar[avro.schema.Schema] = avro.schema.make_avsc_object(
        json.loads("{\"type\": \"record\", \"name\": \"SpotPrice\", \"namespace\": \"info.energy_charts\", \"fields\": [{\"name\": \"country\", \"type\": \"string\"}, {\"name\": \"bidding_zone\", \"type\": \"string\"}, {\"name\": \"timestamp\", \"type\": {\"type\": \"long\", \"logicalType\": \"timestamp-millis\"}}, {\"name\": \"unix_seconds\", \"type\": \"long\"}, {\"name\": \"price_eur_per_mwh\", \"type\": [\"null\", \"double\"], \"default\": null}, {\"name\": \"unit\", \"type\": [\"null\", \"string\"], \"default\": null}]}"), avro.name.Names()
    )

    def __post_init__(self):
        """ Initializes the dataclass with the provided keyword arguments."""
        self.country=str(self.country)
        self.bidding_zone=str(self.bidding_zone)
        value_timestamp = self.timestamp
        self.timestamp = value_timestamp
        self.unix_seconds=int(self.unix_seconds)
        self.price_eur_per_mwh=float(self.price_eur_per_mwh) if self.price_eur_per_mwh else None

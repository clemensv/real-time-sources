...
from usgs_geomag_amqp_producer_data.magneticfieldreading import MagneticFieldReading
import datetime
...
class Test_MagneticFieldReading(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = MagneticFieldReading(
            iaga_code='mluyfhrjscaassqqrjsa',
            timestamp=datetime.datetime.now(datetime.timezone.utc),
            h=float(60.630365023191345),
            d=float(46.55840135704037),
            z=float(56.98413380810541),
            f=float(45.567324825798835)
        )
        return instance
    ...
    def test_iaga_code_property(self):
        ...
        """
        test_value = 'mluyfhrjscaassqqrjsa'
    ...
    def test_h_property(self):
        ...
        Test h property
        """
        test_value = float(60.630365023191345)
    ...
    def test_d_property(self):
        ...
        Test d property
        """
        test_value = float(46.55840135704037)
    ...
    def test_z_property(self):
        ...
        Test z property
        """
        test_value = float(56.98413380810541)
    ...
    def test_f_property(self):
        ...
        Test f property
        """
        test_value = float(45.567324825798835)

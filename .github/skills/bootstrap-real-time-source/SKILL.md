...
10. Treat the source as incomplete until its expected repo-level Docker E2E coverage is passing **and the mandatory expert review (xRegistry, JSON Structure, Avro Schema) defined in [`stream-bridge-implementation`](../stream-bridge-implementation/SKILL.md) has signed off.**

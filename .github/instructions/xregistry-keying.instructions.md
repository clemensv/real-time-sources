...
- After changing key or subject modeling, regenerate the affected producers with `xrcg` `0.10.8` so the generated Kafka producers and tests pick up the current default key behavior.

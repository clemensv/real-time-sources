...
class Water:
    ...
    Attributes:
        shortname (str): Short name of the water body (maximum 40 characters).
        longname (str): Full name of the water body (maximum 255 characters)."""
    ...
    @classmethod
    def from_data(cls, data: typing.Any, content_type_string: typing.Optional[str] = None) -> typing.Optional['Water']:
        """
        ...
        if content_type == 'application/json':
            if isinstance(data, (bytes, str)):
                ...
                return Water.from_serializer_dict(_record)
            else:

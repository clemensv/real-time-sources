...
# Pegelonline_producer Event Dispatcher for Apache Kafka
...
2. [Generated Event Dispatchers](#generated-event-dispatchers)
    - DeWsvPegelonlineEventDispatcher
...
##### `de_wsv_pegelonline_station_async`
...
- `data`: The event data of type `pegelonline_producer_data.de.wsv.pegelonline.Station`.
...
##### `de_wsv_pegelonline_current_measurement_async`

```python
de_wsv_pegelonline_current_measurement_async:  Callable[[ConsumerRecord, CloudEvent, CurrentMeasurement],
Awaitable[None]]
```
...
- `record`: The Kafka record.
- `cloud_event`: The CloudEvent.
- `data`: The event data of type `pegelonline_producer_data.de.wsv.pegelonline.CurrentMeasurement`.

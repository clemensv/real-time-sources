...
xregistry manifest cloudevent add --groupid "de.wsv.pegelonline" --id "de.wsv.pegelonline.Station" --dataschemaformat Avro --schemagroup "de.wsv.pegelonline" --schemaid "de.wsv.pegelonline.Station" xreg\pegelonline.xreg.json
...
xregistry manifest cloudevent add --groupid "de.wsv.pegelonline" --id "de.wsv.pegelonline.CurrentMeasurement" --dataschemaformat Avro --schemagroup "de.wsv.pegelonline" --schemaid "de.wsv.pegelonline.CurrentMeasurement" xreg\pegelonline.xreg.json

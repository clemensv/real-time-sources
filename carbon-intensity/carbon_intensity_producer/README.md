...
# Carbon-intensity-producer Kafka Producer# Carbon-intensity-producer Event Dispatcher for Apache Kafka
...
3. [Quick Start](#quick-start)    - UkOrgCarbonintensityEventDispatcher,
...
- UkOrgCarbonintensityProducersolution for event-driven applications.

It includes both plain Kafka messages and CloudEvents, offering a versatile

- UkOrgCarbonintensityRegionalProducersolution for event-driven applications.
...
- **Scales horizontally** across multiple brokers and partitions### UkOrgCarbonintensityEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`UkOrgCarbonintensityEventDispatcher` handles events for the uk.org.carbonintensity message group.
...
The UkOrgCarbonintensityEventDispatcher defines the following event handler hooks.
...
producer = UkOrgCarbonintensityProducer(
    ...
    security_protocol='SASL_SSL',##### `uk_org_carbonintensity_intensity_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'uk_org_carbonintensity_intensity_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `uk.org.carbonintensity.Intensity`:
...
uk_org_carbonintensity_dispatcher.uk_org_carbonintensity_intensity_async = uk_org_carbonintensity_intensity_event
...
uk_org_carbonintensity_regional_dispatcher.uk_org_carbonintensity_intensity_async =
uk_org_carbonintensity_intensity_event
...
uk_org_carbonintensity_mqtt_dispatcher.uk_org_carbonintensity_intensity_async = uk_org_carbonintensity_intensity_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `uk_org_carbonintensity_generation_mix_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'uk_org_carbonintensity_generation_mix_async:  Callable[[ConsumerRecord, CloudEvent,
...
Asynchronous handler hook for `uk.org.carbonintensity.GenerationMix`:
...
uk_org_carbonintensity_dispatcher.uk_org_carbonintensity_generation_mix_async =
...
uk_org_carbonintensity_regional_dispatcher.uk_org_carbonintensity_generation_mix_async =
uk_org_carbonintensity_generation_mix_event
...
##### `send_uk_org_carbonintensity_intensity`Dispatchers have the following protected methods:



```python### Methods:

async def send_uk_org_carbonintensity_intensity(
...
Send a single `uk.org.carbonintensity.Intensity` message.Args:
...
await producer.send_uk_org_carbonintensity_intensity(
...
Send multiple `uk.org.carbonintensity.Intensity` messages in a batch.
...
await producer.send_uk_org_carbonintensity_intensity_batch(```
...
##### `send_uk_org_carbonintensity_generation_mix`Dispatchers have the following protected methods:



```python### Methods:

async def send_uk_org_carbonintensity_generation_mix(
...
Send a single `uk.org.carbonintensity.GenerationMix` message.Args:
...
await producer.send_uk_org_carbonintensity_generation_mix(
...
Send multiple `uk.org.carbonintensity.GenerationMix` messages in a batch.
...
await producer.send_uk_org_carbonintensity_generation_mix_batch(```
...
- **Scales horizontally** across multiple brokers and partitions### UkOrgCarbonintensityRegionalEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`UkOrgCarbonintensityRegionalEventDispatcher` handles events for the uk.org.carbonintensity.Regional message group.
...
The UkOrgCarbonintensityRegionalEventDispatcher defines the following event handler hooks.
...
producer = UkOrgCarbonintensityProducer(
    ...
    security_protocol='SASL_SSL',##### `uk_org_carbonintensity_regional_intensity_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'uk_org_carbonintensity_regional_intensity_async:  Callable[[ConsumerRecord, CloudEvent,
RegionalIntensity], Awaitable[None]]

)```

```

Asynchronous handler hook for `uk.org.carbonintensity.RegionalIntensity`:
...
uk_org_carbonintensity_dispatcher.uk_org_carbonintensity_regional_intensity_async =
...
uk_org_carbonintensity_regional_dispatcher.uk_org_carbonintensity_regional_intensity_async =
uk_org_carbonintensity_regional_intensity_event
...
uk_org_carbonintensity_mqtt_dispatcher.uk_org_carbonintensity_regional_intensity_async =
uk_org_carbonintensity_regional_intensity_event
...
##### `send_uk_org_carbonintensity_regional_intensity`Dispatchers have the following protected methods:



```python### Methods:

async def send_uk_org_carbonintensity_regional_intensity(
...
Send a single `uk.org.carbonintensity.RegionalIntensity` message.Args:
...
await producer.send_uk_org_carbonintensity_regional_intensity(
...
Send multiple `uk.org.carbonintensity.RegionalIntensity` messages in a batch.
...
await producer.send_uk_org_carbonintensity_regional_intensity_batch(```
...
- **Scales horizontally** across multiple brokers and partitions### UkOrgCarbonintensityMqttEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`UkOrgCarbonintensityMqttEventDispatcher` handles events for the uk.org.carbonintensity.mqtt message group.
...
The UkOrgCarbonintensityMqttEventDispatcher defines the following event handler hooks.
...
producer = UkOrgCarbonintensityProducer(
    ...
    security_protocol='SASL_SSL',##### `uk_org_carbonintensity_mqtt_intensity_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'uk_org_carbonintensity_mqtt_intensity_async:  Callable[[ConsumerRecord, CloudEvent,
Intensity], Awaitable[None]]
...
Asynchronous handler hook for `uk.org.carbonintensity.mqtt.Intensity`:
...
uk_org_carbonintensity_dispatcher.uk_org_carbonintensity_mqtt_intensity_async =
...
uk_org_carbonintensity_regional_dispatcher.uk_org_carbonintensity_mqtt_intensity_async =
uk_org_carbonintensity_mqtt_intensity_event
...
uk_org_carbonintensity_mqtt_dispatcher.uk_org_carbonintensity_mqtt_intensity_async =
uk_org_carbonintensity_mqtt_intensity_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `uk_org_carbonintensity_mqtt_generation_mix_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'uk_org_carbonintensity_mqtt_generation_mix_async:  Callable[[ConsumerRecord,
...
Asynchronous handler hook for `uk.org.carbonintensity.mqtt.GenerationMix`:
...
uk_org_carbonintensity_dispatcher.uk_org_carbonintensity_mqtt_generation_mix_async =
...
uk_org_carbonintensity_regional_dispatcher.uk_org_carbonintensity_mqtt_generation_mix_async =
uk_org_carbonintensity_mqtt_generation_mix_event
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `uk_org_carbonintensity_mqtt_regional_intensity_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'uk_org_carbonintensity_mqtt_regional_intensity_async:  Callable[[ConsumerRecord,
...
Asynchronous handler hook for `uk.org.carbonintensity.mqtt.RegionalIntensity`:
...
uk_org_carbonintensity_dispatcher.uk_org_carbonintensity_mqtt_regional_intensity_async =
...
uk_org_carbonintensity_regional_dispatcher.uk_org_carbonintensity_mqtt_regional_intensity_async =
uk_org_carbonintensity_mqtt_regional_intensity_event
...
##### `send_uk_org_carbonintensity_mqtt_intensity`Dispatchers have the following protected methods:



```python### Methods:

async def send_uk_org_carbonintensity_mqtt_intensity(
...
Send a single `uk.org.carbonintensity.mqtt.Intensity` message.Args:
...
await producer.send_uk_org_carbonintensity_mqtt_intensity(
...
Send multiple `uk.org.carbonintensity.mqtt.Intensity` messages in a batch.
...
await producer.send_uk_org_carbonintensity_mqtt_intensity_batch(```
...
##### `send_uk_org_carbonintensity_mqtt_generation_mix`Dispatchers have the following protected methods:



```python### Methods:

async def send_uk_org_carbonintensity_mqtt_generation_mix(
...
Send a single `uk.org.carbonintensity.mqtt.GenerationMix` message.Args:
...
await producer.send_uk_org_carbonintensity_mqtt_generation_mix(
...
Send multiple `uk.org.carbonintensity.mqtt.GenerationMix` messages in a batch.
...
await producer.send_uk_org_carbonintensity_mqtt_generation_mix_batch(```
...
##### `send_uk_org_carbonintensity_mqtt_regional_intensity`Dispatchers have the following protected methods:



```python### Methods:

async def send_uk_org_carbonintensity_mqtt_regional_intensity(
...
Send a single `uk.org.carbonintensity.mqtt.RegionalIntensity` message.Args:
...
await producer.send_uk_org_carbonintensity_mqtt_regional_intensity(
...
Send multiple `uk.org.carbonintensity.mqtt.RegionalIntensity` messages in a batch.

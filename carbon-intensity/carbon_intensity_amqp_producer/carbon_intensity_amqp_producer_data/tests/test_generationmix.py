...
from carbon_intensity_amqp_producer_data.generationmix import GenerationMix
import datetime
...
class Test_GenerationMix(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = GenerationMix(
            ...
            biomass_pct=float(43.79780498847805),
            coal_pct=float(35.76275765430989),
            gas_pct=float(64.12181432158499),
            hydro_pct=float(54.655538026802965),
            imports_pct=float(98.67406953179025),
            nuclear_pct=float(61.781235459405245),
            oil_pct=float(23.858866829917414),
            other_pct=float(95.71608264228779),
            solar_pct=float(25.159062797981147),
            wind_pct=float(65.13893164218146),
            region='ggvupqphfczhantfkkfa',
            ce_id='kasujjqxcxynkbgrrbpc'
        )
        return instance
    ...
    def test_biomass_pct_property(self):
        ...
        """
        test_value = float(43.79780498847805)
    ...
    def test_coal_pct_property(self):
        ...
        """
        test_value = float(35.76275765430989)
    ...
    def test_gas_pct_property(self):
        ...
        """
        test_value = float(64.12181432158499)
    ...
    def test_hydro_pct_property(self):
        ...
        """
        test_value = float(54.655538026802965)
    ...
    def test_imports_pct_property(self):
        ...
        """
        test_value = float(98.67406953179025)
    ...
    def test_nuclear_pct_property(self):
        ...
        """
        test_value = float(61.781235459405245)
    ...
    def test_oil_pct_property(self):
        ...
        """
        test_value = float(23.858866829917414)
    ...
    def test_other_pct_property(self):
        ...
        """
        test_value = float(95.71608264228779)
    ...
    def test_solar_pct_property(self):
        ...
        """
        test_value = float(25.159062797981147)
    ...
    def test_wind_pct_property(self):
        ...
        """
        test_value = float(65.13893164218146)
    ...
    def test_region_property(self):
        ...
        """
        test_value = 'ggvupqphfczhantfkkfa'
    ...
    def test_ce_id_property(self):
        ...
        Test ce_id property
        """
        test_value = 'kasujjqxcxynkbgrrbpc'

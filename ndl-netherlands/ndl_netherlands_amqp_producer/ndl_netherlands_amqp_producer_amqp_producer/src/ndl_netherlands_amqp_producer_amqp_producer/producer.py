...
class NLNDWTrafficMeasurementsAmqpProducer:
    """
    Producer class to send messages in the `NL.NDW.Traffic.Measurements.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_amqp(self,
        ...
        """
        Send the `NL.NDW.Traffic.TrafficSpeed.amqp` message
        ...
        amqp_msg.subject = "{site_id}".format(site_id=_site_id)
    ...
    def send_amqp_batch(self,
        data_array: typing.List[TrafficSpeed],
        _site_id: str,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `NL.NDW.Traffic.TrafficSpeed.amqp` messages
        
        Args:
            data_array (typing.List[TrafficSpeed]): Array of message data objects
            _site_id (str): Value for placeholder site_id in attribute subject
    ...
    def send_amqp(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `NL.NDW.Traffic.TravelTime.amqp` message
    ...
    def send_amqp_batch(self,
        data_array: typing.List[TravelTime],
        _site_id: str,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `NL.NDW.Traffic.TravelTime.amqp` messages
        
        Args:
            data_array (typing.List[TravelTime]): Array of message data objects
            _site_id (str): Value for placeholder site_id in attribute subject
            content_type (str): The content type of the message data
        """
        for data in data_array:
...
class NLNDWTrafficSituationsAmqpProducer:
    """
    Producer class to send messages in the `NL.NDW.Traffic.Situations.amqp` message group via AMQP 1.0 protocol.
    """
    ...
    def send_amqp(self,
        ...
        content_type: str = 'application/json') -> None:
        """
        Send the `NL.NDW.Traffic.TrafficSituation.amqp` message
    ...
    def send_amqp_batch(self,
        data_array: typing.List[TrafficSituation],
        _situation_id: str,
        content_type: str = 'application/json') -> None:
        """
        Send multiple `NL.NDW.Traffic.TrafficSituation.amqp` messages
        
        Args:
            data_array (typing.List[TrafficSituation]): Array of message data objects
            _situation_id (str): Value for placeholder situation_id in attribute subject
            content_type (str): The content type of the message data
        """
        for data in data_array:

...
async def main(connection_string: Optional[str], producer_config: Optional[str], topic: Optional[str]):
    ...
    if connection_string:
        ...
        wikimedia_event_streams_event_producer = WikimediaEventStreamsEventProducer.from_connection_string(connection_string, topic, 'binary')
    else:
        # use a Kafka producer configuration provided as JSON text
        kafka_producer = KafkaProducer(json.loads(producer_config))
        wikimedia_event_streams_event_producer = WikimediaEventStreamsEventProducer(kafka_producer, topic, 'binary')

    # ---- Wikimedia.EventStreams.RecentChange ----
    # TODO: Supply event data for the Wikimedia.EventStreams.RecentChange event

...
class WikimediaEventStreamsEventProducer:
    ...
    def send_wikimedia_event_streams_recent_change(self,_event_id : str, _event_time : str, data: RecentChange, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, RecentChange], str]=None) -> None:
        """

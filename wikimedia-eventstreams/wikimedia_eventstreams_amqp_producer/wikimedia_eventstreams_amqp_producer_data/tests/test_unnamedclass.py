...
class Test_UnnamedClass(unittest.TestCase):
    ...
    def create_instance():
        ...
        instance = UnnamedClass(
            uri='lbjuosqifizjtfpqqbzc',
            request_id='sbtfgpcxljtzudwubgop',
            id='acxpqonfezthbovafnco',
            domain='mffqdyqocvmhldosidef',
            stream='hfanvsldqgmmkkewouur',
            topic='yyilvujnpaeefwdrmoah',
            partition=int(51),
            offset='fdkzwkoryonvuucyknds',
            dt='bgxhvcpanfvpuiaqyajp'
        )
        return instance
    ...
    def test_uri_property(self):
        ...
        Test uri property
        """
        test_value = 'lbjuosqifizjtfpqqbzc'
    ...
    def test_request_id_property(self):
        ...
        """
        test_value = 'sbtfgpcxljtzudwubgop'
    ...
    def test_id_property(self):
        ...
        Test id property
        """
        test_value = 'acxpqonfezthbovafnco'
    ...
    def test_domain_property(self):
        ...
        """
        test_value = 'mffqdyqocvmhldosidef'
    ...
    def test_stream_property(self):
        ...
        """
        test_value = 'hfanvsldqgmmkkewouur'
    ...
    def test_topic_property(self):
        ...
        Test topic property
        """
        test_value = 'yyilvujnpaeefwdrmoah'
    ...
    def test_offset_property(self):
        ...
        """
        test_value = 'fdkzwkoryonvuucyknds'
    ...
    def test_dt_property(self):
        ...
        Test dt property
        """
        test_value = 'bgxhvcpanfvpuiaqyajp'

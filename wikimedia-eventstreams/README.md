# Wikimedia EventStreams RecentChange feeder
...
```powershell
tools/deploy-fabric/deploy-fabric-aci.ps1 -Source wikimedia-eventstreams -ResourceGroup <rg> -Location <azure-region> -Workspace <fabric-workspace>
```

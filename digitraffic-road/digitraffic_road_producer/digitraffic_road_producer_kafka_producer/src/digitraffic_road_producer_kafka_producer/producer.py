...
class FiDigitrafficRoadStationsEventProducer:
    ...
    def send_fi_digitraffic_road_stations_tms_station(self,_station_id : str, data: TmsStation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, TmsStation], str]=None) -> None:
        """
    ...
    def send_fi_digitraffic_road_stations_weather_station(self,_station_id : str, data: WeatherStation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, WeatherStation], str]=None) -> None:
        """
...
class FiDigitrafficRoadMaintenanceTasksEventProducer:
    ...
    def send_fi_digitraffic_road_maintenance_tasks_maintenance_task_type(self,_task_id : str, data: MaintenanceTaskType, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, MaintenanceTaskType], str]=None) -> None:
        """

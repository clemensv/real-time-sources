...
# Wallonia_issep_producer Kafka Producer# Wallonia_issep_producer Event Dispatcher for Apache Kafka
...
- **Scales horizontally** across multiple brokers and partitions### BeIssepAirqualitySensorsEventDispatcher

- **Enables pub/sub messaging** with topic-based routing

`BeIssepAirqualitySensorsEventDispatcher` handles events for the be.issep.airquality.Sensors message group.
...
The BeIssepAirqualitySensorsEventDispatcher defines the following event handler hooks.
...
producer = BeIssepAirqualitySensorsProducer(
    ...
    security_protocol='SASL_SSL',##### `be_issep_airquality_sensor_configuration_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'be_issep_airquality_sensor_configuration_async:  Callable[[ConsumerRecord, CloudEvent,
...
be_issep_airquality_sensors_dispatcher.be_issep_airquality_sensor_configuration_async =
...
- `**kwargs`: Additional Kafka producer configuration
    ...
    security_protocol='SASL_SSL',##### `be_issep_airquality_observation_async`

    sasl_mechanism='PLAIN',

    sasl_username='your-username',```python

    sasl_password='your-password'be_issep_airquality_observation_async:  Callable[[ConsumerRecord, CloudEvent,
...
##### `send_be_issep_airquality_sensor_configuration`Dispatchers have the following protected methods:



```python### Methods:

async def send_be_issep_airquality_sensor_configuration(
...
await producer.send_be_issep_airquality_sensor_configuration(
...
Send multiple `be.issep.airquality.SensorConfiguration` messages in a batch.
...
await producer.send_be_issep_airquality_sensor_configuration_batch(```
...
##### `send_be_issep_airquality_observation`Dispatchers have the following protected methods:



```python### Methods:

async def send_be_issep_airquality_observation(
...
await producer.send_be_issep_airquality_observation(
...
Send multiple `be.issep.airquality.Observation` messages in a batch.

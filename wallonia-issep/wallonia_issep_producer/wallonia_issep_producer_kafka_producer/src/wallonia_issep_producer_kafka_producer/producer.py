...
class BeIssepAirqualitySensorsEventProducer:
    ...
    def send_be_issep_airquality_sensor_configuration(self,_configuration_id : str, data: SensorConfiguration, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, SensorConfiguration], str]=None) -> None:
        """
    ...
    def send_be_issep_airquality_observation(self,_configuration_id : str, data: Observation, content_type: str = "application/json", flush_producer=True, key_mapper: typing.Callable[[CloudEvent, Observation], str]=None) -> None:
        """
